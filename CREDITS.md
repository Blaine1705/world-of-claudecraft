...
| Book of Deeds achievement icons (`public/ui/deeds/*.webp`, excluding the five generated additions listed next; downscaled from reviewed 512px sources to 128px WebP via `scripts/convert_deed_icons_webp.mjs`) | World of ClaudeCraft | Maintainer-commissioned bespoke art, owned by the project | Project asset, rights reserved | **No, permission required** |
| Generated Book of Deeds additions (`chr_peaks_gatherer`, `chr_marsh_rares_ii`, `chr_peaks_rares_ii`, `chr_gleamstag`, and `chr_hollow_rares` under `public/ui/deeds/`) | World of ClaudeCraft | Project-generated with OpenAI built-in image generation from project-owned/project-generated references plus the licensed CraftPix Premium `grubjaw_tusk` and `old_cragmaws_pelt` item icons; reviewed, keyed, centered, and optimized locally; prompt and lineage record in `docs/achievements/professions-tuning-art-provenance.md` | Project asset, rights reserved | **No, permission required** |
