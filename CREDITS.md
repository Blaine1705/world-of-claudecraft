...
| Generated creature models (hoard_emberforge_tyrant, hoard_archon_nyxaris, hoard_tempest_vharok) | World of ClaudeCraft | Project-generated via scripts/asset_pipeline (Tripo AI 3D), edited in Blender (`scripts/assets/hoard_bosses/`: Nyxaris legs removed so he floats; Emberforge two generated textures mixed and hands enlarged; Vharok arms lengthened), then rigged locally onto the KayKit skeleton with `rig-manual`, carrying the KayKit (Kay Lousberg, CC0) clips | Project asset | With the project only |
