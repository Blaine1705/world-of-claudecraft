...
| Lanternback Troll stride (`mount_run_lanternback_troll.mp3`) | World of ClaudeCraft | Synthesised for this game from a deterministic four-layer additive/noise script (sub body drop, impact knock, scuff, lantern-chain partials); no sampled source | Project asset, rights reserved | **No, permission required** |
| Chimeglass Tortoise stride (`mount_run_chimeglass_tortoise.mp3`) | World of ClaudeCraft | Synthesised for this game from a deterministic four-layer additive/noise script (body settle, claw tick, five inharmonic bell partials, strap creak); no sampled source | Project asset, rights reserved | **No, permission required** |
