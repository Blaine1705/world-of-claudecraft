...
- **Commercial and prestige art owned by the project.** The Season 1 Armory
  ...
  Professions 2.0 art set, the v0.36 placeholder-art completion paintings, and
...
| v0.36 painted per-item weapon inventory icons (`public/ui/items/*.webp`, the exact 119 base-weapon IDs in the `placeholder-art-completion-weapons-2026-08-09` generated batch in `public/ui/items/mapping.json`; Heroic items intentionally reuse their base item painting) | World of ClaudeCraft | Original weapon paintings generated with OpenAI built-in image generation and optimized locally; exact per-weapon prompts, ordered reference roles, hashes, and review evidence are retained in the [v0.36 placeholder-art completion lineage](docs/achievements/placeholder-art-completion-2026-08-09/). Repository references remain governed by their existing mapping and credit records, and reference use does not transfer or reclassify authorship | Project asset, rights reserved | **No, permission required** |
