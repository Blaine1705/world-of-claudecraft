...
| Generated creature model + animations (hoard_abyssal_maw, hoard_hoarfrost_warden) | World of ClaudeCraft | Project-generated via scripts/asset_pipeline (Tripo AI 3D, auto-rig + preset retargets) | Project asset | With the project only |
| Generated creature models (hoard_emberforge_tyrant, hoard_archon_nyxaris, hoard_tempest_vharok) | World of ClaudeCraft | Project-generated via scripts/asset_pipeline (Tripo AI 3D), edited in Blender (Nyxaris: legs removed so he floats; Emberforge: two generated textures mixed), then rigged locally onto the KayKit skeleton with `rig-manual`, carrying the KayKit (Kay Lousberg, CC0) clips | Project asset | With the project only |
