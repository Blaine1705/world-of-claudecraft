...
| Ignivar raid forge decoration set (`public/models/props/ignivar_*.glb`) | World of ClaudeCraft | Maintainer-provided Tripo AI 3D models, normalized through the checked-in Ignivar raid prop spec and finalized locally with meshopt and KTX2/Basis | Project asset | With the project only |
