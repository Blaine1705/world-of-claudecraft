...
| Contributor-provided animated raid add models (crucible_warden, ember_sentinel) | World of ClaudeCraft contributor | Original rigged GLBs supplied to the project, locally finalized with meshopt and 512px KTX2/Basis textures without changing geometry or animation data | Project asset | With the project only |
...
| Generated creature model + animations (ignivar_heart_of_the_end) | World of ClaudeCraft | Project-generated via scripts/asset_pipeline (Tripo AI 3D, auto-rig + preset retargets) | Project asset | With the project only |
