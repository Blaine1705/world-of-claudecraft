...
| Owner-provided Druid artwork (`public/ui/skills/druid/cat_form.webp`, the Cat Form lynx head) | Levy Street account | Owner-provided artwork, re-encoded to 128px WebP via `scripts/convert_skill_icons_webp.mjs` | Used with permission (Levy Street) | **No, permission required** |
...
| Generated hoard room creatures (hoard_tide_thrall, hoard_deep_lurker) | World of ClaudeCraft | Models project-generated via scripts/asset_pipeline (Tripo AI 3D) from project concept images. The Tide Thrall is rigged locally onto the KayKit skeleton with `rig-manual`, carrying the KayKit (Kay Lousberg, CC0) clips; the Deep Lurker is rigged and animated by the project in Blender (`scripts/assets/hoard_mobs/quadruped_rig.py`) | Project asset | With the project only |
