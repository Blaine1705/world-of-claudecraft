...
- **The CraftPix-sourced class ability icons** (the files recorded as CraftPix
  sources in `public/ui/skills/<class>/mapping.json`, excluding the
  project-generated batches recorded there). These were **purchased by the Levy Street account**
...
| CraftPix-sourced class ability icons (the subset of `public/ui/skills/<class>/*.webp` whose per-class mapping entry records a CraftPix source pack, i.e. the IDs recorded outside `generatedBatches`; all 9 classes) | CraftPix | https://craftpix.net | CraftPix premium (royalty-free commercial), purchased by Levy Street account (callum@levystreet.com) | **No, permission required** |
| v0.29 Hunter, Shaman, and Priest class rework ability icons (43 files recorded as project-generated in the corresponding `public/ui/skills/<class>/mapping.json`) | World of ClaudeCraft | Project-generated with OpenAI image generation through Codex, matched against existing class art, and normalized locally to 128px WebP | Project asset, rights reserved | **No, permission required** |
