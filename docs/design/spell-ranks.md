...
| | **3** | **18** | 90 | 3s chan | **18**/missile ×3 |
| | **4** | **20** | 105 | 3s chan | **22**/missile ×3 |
...
| `temporal_barrier` | 5 (R2 12, R3 18, R4 20) | 50 / 75 / 105 / 120 | inst, 12cd | absorb 55 / 100 / 160 / 232 + 25% Spell Power, 10s (friendly) |
