...
Necromancy commands one persistent guardian and a small wave of temporary undead or
spectral minions. The Warlock prepares souls, spends them on summons, and coordinates a
...
- Spend fragments on temporary skeletons, spirits, or a stronger champion.
...
- Limit temporary active summons to a visually and technically safe amount.
- Army of the Dead is the level-20 assault summon. It tears open a grave portal and
...
- Several weaker temporary minions.
- One empowered guardian or champion.
- Sacrificing minions to empower the Warlock.

### Technical limits

Avoid an unlimited permanent army. Start with one persistent guardian and a controlled
maximum of two to four temporary summons. Confirm pathfinding, target selection,
despawning, owner death behavior, threat, network snapshots, and entity cleanup in tests.
