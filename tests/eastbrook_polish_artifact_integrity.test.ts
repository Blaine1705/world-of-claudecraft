...
// Re-minted for the Cluckwork Mech Bird store mount (PR #3464): the renderer's
// stride accumulator moved to src/render/stride_audio_core.ts and the mounted
// audio branch gained the idle-hum poll. No capture was retaken.
const ACCEPTED_POLISH_V2_METADATA_SHA256 =
  'f312ed9d871700c3163ea31f45888a8632efaf49244170b7cd7da98c0bd4b499';
const ACCEPTED_POLISH_V2_COMPOSITE_PROVENANCE =
  'e9ef106e9b9360758416acefccf908e06ff11b0873ac641f3e940752c98d07d7';
...
describe('Eastbrook polish performance and contact evidence', () => {
  it('pins the accepted matched performance evidence byte for byte', () => {
    ...
    expect(
      ...
      // Re-minted for the Cluckwork Mech Bird store mount (PR #3464): the
      // composite first, then this seal. No capture was retaken.
    ).toBe('233861208d6f8987fc5d4ef10460466f9c9d8284866cbb7713b35da60aca4abc');
  });
