...
// Re-minted again for the retarget onto release/v0.36.0 (v0.35.0 shipped to
// main without this PR merging): the release moved the rendererIntegration
// leaf further, plus this branch's own rift ambience wiring. No Eastbrook
// input, geometry value, or capture moved.
const ACCEPTED_POLISH_V2_METADATA_SHA256 =
  'a43a547a96ad50171900d16ddc443773ada55e39275baa4f13729cadd9e11c0b';
const ACCEPTED_POLISH_V2_COMPOSITE_PROVENANCE =
  'affd44ca899db4418744df258939f57bf09060ab9b06afd19ba1b3e42dee0291';
...
describe('Eastbrook polish performance and contact evidence', () => {
  it('pins the accepted matched performance evidence byte for byte', () => {
    ...
    // Re-pinned again for the retarget onto release/v0.36.0 (v0.35.0 shipped
    // to main without this PR merging): the release moved the
    // rendererIntegration leaf further, plus this branch's own rift ambience
    // wiring.
    expect(
      fingerprint.digest('hex'),
      `the second-order performance digest moved; if every input moved legitimately, re-mint with: ${REMINT_COMMAND} (it recomputes this literal LAST, from the swept files)`,
    ).toBe('2697732f571ea4ea0b2bff4481a38fbe4b74474a793c3b83d3a86c540ef8c412');
  });
