...
// Re-minted for the merged self-spirit prewarm: renderer.ts now observes and
// warms the local player's ghost shader variants, while the PR also extracted
// src/render/prewarm_depth_material.ts. No capture was retaken.
const ACCEPTED_POLISH_V2_METADATA_SHA256 =
  '8e0e4da9184ebe3ee4f2671e39357f647c85302626b351ce94fe6cef46a88fd5';
...
describe('Eastbrook polish performance and contact evidence', () => {
  it('pins the accepted matched performance evidence byte for byte', () => {
    ...
    ).toBe('b99a60731252385f4e6a0d8f269fc0003c1b97e14b5d4bffb02aaf356017f30f');
  });
