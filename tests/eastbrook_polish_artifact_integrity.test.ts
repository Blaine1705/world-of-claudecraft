...
const ACCEPTED_POLISH_V2_METADATA_SHA256 =
  '81a18004877e34eca60e603edd2a09048abb892481aa45961e33c237ec17a36d';
...
describe('Eastbrook polish performance and contact evidence', () => {
  it('pins the accepted matched performance evidence byte for byte', () => {
    ...
    // prewarm_policy.ts. No capture was retaken.
    // Re-minted after the healGlowAt eviction fix changed renderer.ts (issue
    // #3289): the first-order composite follows renderer.ts, then this
    // second-order performance seal follows the swept evidence bytes. No
    // capture was retaken.
    expect(
      fingerprint.digest('hex'),
      `the second-order performance digest moved; if every input moved legitimately, re-mint with: ${REMINT_COMMAND} (it recomputes this literal LAST, from the swept files)`,
    ).toBe('5e42660f060fe1577e64f1ed0d0e25df5d1865e98fa6a9215d45268034499602');
  });
