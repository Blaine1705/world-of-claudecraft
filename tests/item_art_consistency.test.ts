...
describe('item-art consistency accepted-art provenance', () => {
  it('pins the exact scope, style contract, and byte-identical generation reports', () => {
    ...
    expect(value.sourceEvidence).toEqual([
      ...
      },
      {
        ...
        acceptedSha256: '1ef451aa73f18d01dc50b34e468ffa82c0dc9b6e8a8c48bbc2bab0b5d721ff71',
        acceptedBytes: 109_694,
      },
    ]);
  ...
  it('pins the final 817-item visual audit, Heroic accounting, and evidence digests', () => {
    ...
    expect(verdictBytes.length).toBe(109_694);
    expect(sha256(verdictBytes)).toBe(
      '1ef451aa73f18d01dc50b34e468ffa82c0dc9b6e8a8c48bbc2bab0b5d721ff71',
    );
    ...
    expect(verdict.evidence.catalog).toEqual({
      ...
      sha256: '2c07feabe3c173f63296c3189895f38373e17d303e3b004819ead32d5c485c8f',
      bytes: 455_895,
    });
    ...
    expect(verdict.evidence.sheetSetSha256).toBe(
      '12d00e850b3b824b58512ef4791ff2910390c5abf4cf6a0c3744d7f7acb17139',
    );
    ...
    expect(verdict.evidence.shippingCatalogSha256).toBe(
      '232ed65a14b786f1904948476fb5119a670b760b12ff3f057c87c85632fb7e61',
    );
