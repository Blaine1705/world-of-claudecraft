...
describe('item-art consistency accepted-art provenance', () => {
  it('pins the exact scope, style contract, and byte-identical generation reports', () => {
    ...
    expect(value.sourceEvidence).toEqual([
      ...
      },
      {
        ...
        acceptedSha256: '99dac3e53989c7ebf3f6a5e5c5bb38690156eab780276d0f22eb829a902a7402',
        acceptedBytes: 121_117,
      },
    ]);
  ...
  it('pins the final item-art visual audit, Heroic accounting, and evidence digests', () => {
    ...
    expect(verdictBytes.length).toBe(121_117);
    expect(sha256(verdictBytes)).toBe(
      '99dac3e53989c7ebf3f6a5e5c5bb38690156eab780276d0f22eb829a902a7402',
    );
    ...
    expect(verdict.evidence.catalog).toEqual({
      ...
      sha256: 'a976a74ec51fb30147de125109c4d535dfb0dc63b2694fa68592b727b7b72ea8',
      bytes: 568_213,
    });
    ...
    expect(verdict.evidence.sheetSetSha256).toBe(
      '083099b22f7dc72a52c3998ee5ead61433aba31d4d7d454980cea0df0b5b7973',
    );
    ...
    expect(verdict.evidence.shippingCatalogSha256).toBe(
      '15357ed30e7f92dc747352e4c2b57cc9af427a4dc1c1fe81deff5dc933ce17c6',
    );
