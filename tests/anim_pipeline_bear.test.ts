...
describe('bear family bespoke attack (issue #2889 round 2)', () => {
  ...
  it('gives mob_bear its own ClipMap instead of mutating the shared BIPED14 constant', () => {
    ...
    // Exactly 3 remaining direct `clips: BIPED14,` usages (6 originally:
    ...
    // migrated to TROLL_BIPED14 by mob_troll's own bespoke attack, and the
    // one already migrated to YETI_BIPED14 by mob_yeti's own bespoke
    // attack, #2889).
