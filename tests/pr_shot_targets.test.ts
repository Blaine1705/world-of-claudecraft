...
describe('classifyDiff', () => {
  ...
  it('maps an options_view change to the graphics dial, interface tab, and confirm-vendor-sell targets, in order', () => {
    // All three targets key on 'ui/options_view'; registry order is the
    // capture order (graphics dial, then interface tabs, then the
    // confirm-vendor-sell toggle row, the last one added). An ordering or
    // selector regression here silently drops or duplicates the
