...
// reintroduce the redundant pad-connected module.
...
describe('main.ts syncs xhb-mode alone on every pad connection-state change', () => {
  ...
  it('calls crossHotbar.syncPadMode from GamepadManager.onConnectionChange with nothing else pad-connected-shaped alongside it', () => {
