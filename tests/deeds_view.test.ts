...
describe('real catalog integration', () => {
  it('pins the fresh-character completion denominator of the live catalog', () => {
    ...
    // 291 deeds - 4 feats - 9 hidden = 278 visible to a fresh character (the
    ...
    // Proving Shore graduation deed, the five Crucible raid deeds, the two
    // calligraphy deeds, forging/barricade/investigation/glider/shadow, and
    // the three combat expedition completion deeds;
