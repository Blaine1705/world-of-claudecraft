// Frozen release44 resolver, used only to prove Warrior integration preserves other kits.
import type { AbilityVfxFullSpec, AbilityVfxSpec } from '../../src/render/ability_vfx_core';
...
import {
  ...
  PIN_VFX_FULL_SPEC,
  PIN_VFX_SPEC,
} from '../../src/render/druid_vfx_specs';
import {
...
import {
  ...
  ABYSSAL_RIFT_VFX_SPEC,
} from '../../src/render/warlock_vfx_specs';
