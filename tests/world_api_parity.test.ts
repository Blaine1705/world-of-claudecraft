...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  it('pins total / data / method counts', () => {
    ...
    // (methods), leaving 299 on the v0.35.0 base. The controlled Warlock pet's
    // signature-skill command and autocast toggle add two methods, and its
    // pet-bar mirror adds one data read, leaving 302.
