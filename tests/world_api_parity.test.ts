...
//
// `IWorld` (src/world_api.ts, 206 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (206 / 56 / 150)
...
// The 206 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 56 `data` + 150 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 150', () => {
