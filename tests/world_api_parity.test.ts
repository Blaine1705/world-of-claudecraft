...
//
// `IWorld` (src/world_api.ts, 212 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (212 / 57 / 155)
...
// The 212 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 57 `data` + 155 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the full sorted member set is exactly the pinned 212', () => {
...
//   (4) their union, sorted, equals the pinned 212-name IWORLD_MEMBERS set (a member
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 25 facets', () => {
  ...
  it('the union of the 25 facets equals the pinned 212-member IWORLD_MEMBERS set', () => {
