...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  it('pins total / data / method counts', () => {
    ...
    // 397/113/284 at the second release/v0.43.0 merge into feature/world-quests:
    // the release's 378/107/271 plus the branch's world-quest, vehicle and
    // minigame members, counted off the resolved IWORLD_MEMBERS literal.
    expect(DATA_MEMBERS.length).toBe(113);
    expect(METHOD_MEMBERS.length).toBe(284);
  });
