...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  it('pins total / data / method counts', () => {
    ...
    // reactiveAbilityWindowRemaining, leaving 277; third-person camera
    // collision removes the renderer-only riftCollisionToken, leaving 276.
    // This branch's Paladin Consecration ground-state projection leaves 277.
