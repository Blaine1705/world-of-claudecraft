...
//
// `IWorld` (src/world_api.ts, 238 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (238 / 64 / 174)
...
// Partition: 64 `data` + 174 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  it('pins total / data / method counts', () => {
    // The latest release surface plus the mage line's seven additive members.
  ...
  it('the full sorted member set is exactly the pinned 238', () => {
