...
//
// `IWorld` (src/world_api.ts, 211 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (211 / 57 / 154)
...
// The 211 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 57 `data` + 154 `method` (read-returning + command-void + async).
...
//   (4) their union, sorted, equals the pinned 211-name IWORLD_MEMBERS set (a member
