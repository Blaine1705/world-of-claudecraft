// mob_treant's bespoke attack (issue #2889 round 2). Authored by
// pose-sample-and-blend (scripts/anim/pose_blend.mjs,
// scripts/build_treant_anims.mjs), the same technique documented in
...
describe('mob_treant bespoke attack (issue #2889 round 2)', () => {
  it('ships Treant_Attack in a mesh-free donor GLB', () => {
