...
describe('approved Thundercall Chain Lightning follow-up', () => {
  it('grants Skybranch only to Thundercall and lets Primal Mastery make it instant', () => {
    ...
    // v0.44.0 Thundercall rework: the spec bonus drops 0.13 -> 0.07 to pay for
    // Lightning Mastery, Arc Overload and Magma Burst (dmgMult 1.22), so the
    // band is 63 to 73 (52 * 1.22 = 63.44 -> 63, 60 * 1.22 = 73.2 -> 73).
    expect(
