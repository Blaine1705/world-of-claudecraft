...
describe('v0.42.0 offense-only package: real combat-path packets', () => {
  describe('Thundercall (shaman/elemental): Earthen Jolt complete hit, Earthen Jolt vent', () => {
    ...
    // + 0.07 (offense-only, 0.13 before the v0.44 Thundercall rework) = 1.40.
    ...
    it('a low-Spell-Power Earthen Jolt (authored base dominates) scales by the literal 1.40 elemental total (mastery 0.15 + ability 0.18 + offense-only 0.07, lowered from 0.13 by the v0.44 Thundercall rework)', () => {
    ...
    it('a high-Spell-Power Earthen Jolt (the SP rider dominates) ALSO scales by 1.40, proving the rider moved with the base', () => {
