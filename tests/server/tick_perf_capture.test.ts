...
describe('tick perf capture lifecycle', () => {
  ...
  it('registers the 34 base lap names first, then the 13 mob-family buckets', () => {
    ...
    expect(SIM_LAP_PHASES.slice(0, 34)).toEqual(base);
    expect(SIM_LAP_PHASES.slice(34)).toEqual(buckets);
