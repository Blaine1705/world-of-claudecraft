...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  },
  {
    ...
    handler: 'cheaterMarkMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/moderation\/accounts\/(\d+)\/cheater-mark$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/moderation/accounts/:id/lift-cheater-mark',
    handler: 'liftCheaterMarkMatch',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/moderation\/accounts\/(\d+)\/lift-cheater-mark$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
