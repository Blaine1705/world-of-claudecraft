...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // Merging release/v0.39.0 into the rickshaw: upstream pinned 13689, this side
    // carried the jump-attitude wiring, and the merge lands at 13706. Pinned to
    // that exact merged count per the ratchet's rule. The attitude application
    // already lives in mount_jump_attitude.ts; the remainder is call glue.
    ceiling: 13706,
