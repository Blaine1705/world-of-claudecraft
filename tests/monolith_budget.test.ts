...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // Merging release/v0.41.0: the release's own extractions land the merged
    // file below both parent pins, and this branch's voice-clip key resolvers
    // stay out in src/ui/hud_voice_cues.ts. Pinned to the exact merged count,
    // keeping the zero-headroom posture.
    ceiling: 18479,
