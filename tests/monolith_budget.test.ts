...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // Merging release/v0.40.0 into the rickshaw: the merge lands at 13609, below
    // both pins. Upstream's prewarm depth-material refactor and texture-sweep
    // extraction were taken wholesale, which is most of the drop. Pinned to the
    // exact merged count, the rule both parents already follow.
    ceiling: 13609,
