...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // Merging release/v0.40.0 into the rickshaw: the merged file lands at 13602,
    // below both parent pins (upstream's prewarm depth-material refactor and
    // texture-sweep extraction are taken wholesale, which is most of the drop).
    // Pinned to the exact merged count, the zero-slack rule both parents follow.
    ceiling: 13602,
