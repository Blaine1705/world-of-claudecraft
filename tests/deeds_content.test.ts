...
describe('audited launch totals (literals: update deliberately with the catalog)', () => {
  it('ships exactly 226 deeds worth 2765 total Renown', () => {
    expect(DEED_ORDER.length).toBe(226);
    expect(ALL.reduce((sum, d) => sum + d.renown, 0)).toBe(2765);
  });
...
describe('frozen trigger + renown catalog (design rule 9: never retro-edit a trigger)', () => {
  ...
  // trigger or renown changed.
  const FROZEN_CATALOG_SHA256 = 'a535f993a9183dc4b9714ad1c55ab00344e1d21b372d02af09cae58ffda798d8';
