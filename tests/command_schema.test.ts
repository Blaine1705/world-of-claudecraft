...
const EXPECTED_SEND_COUNT = 135; // +four authoritative Rift item-progression commands
const EXPECTED_DISPATCH_COUNT = 144; // client commands plus the 9 dispatch-only commands
