...
// dispatch pair, the exact sibling of deed_set_title. This branch's neutral
// trade close adds trade_close as a send + dispatch pair, the sibling of
// trade_cancel. NOTE (merge trap): both
