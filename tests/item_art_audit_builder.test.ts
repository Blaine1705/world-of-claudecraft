...
describe('item-art audit builder', () => {
  ...
  it('exposes the fresh-checkout rebuild and explicit verdict-refresh CLI', () => {
    ...
    expect(verified).toMatchObject({
      ...
      catalogSha256: 'fc4b0477cc8fd64be4c82056ca0c03a7767458305d52141571f60645f7850826',
      catalogBytes: 458_446,
      ...
      sheetSetSha256: null,
      shippingCatalogSha256: '3aec6f3e8a1319f6c07f1a63c816a62ea582afb5b941a9c4a83feaea807268ab',
