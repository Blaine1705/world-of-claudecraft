...
describe('Book of Deeds webp icons', () => {
  ...
  it('an artless deed card resolves to a procedural crest (no committed image)', () => {
    ...
    // pair and Reliquary Curator rank bridges ship artless per docs/design/deeds.md step 6
    // ("art can trail the deed"), enumerated in DEED_ART_PENDING like the other pending debt
    // rather than a bespoke exception here.
    ...
    expect(DEED_ORDER, 'the merged live deed catalog').toHaveLength(251);
