...
| `world_quests.ts` | level-10 overworld area auto-start, kill credit, realm-reset rollover, automatic rewards, persistence sanitizing, and downgrade-safe completion claims; runs after player movement and draws zero RNG |
