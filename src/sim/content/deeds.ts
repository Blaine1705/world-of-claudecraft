...
export const DEEDS: Record<string, DeedDef> = {
  ...
  // Vale-fallback catch table), just never wired to a deed. Drakelands is
  // deliberately skipped: it is under active rework on open PR #2811, so its
  // pair lands with that work instead of ahead of it. Copied line-for-line
  // from the template above; renown 5 each.
