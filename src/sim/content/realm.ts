...
export const REALM_PROPS: ZonePropsDef = {
  ...
  decorProps: [
    ...
    // cobbled stone paths (KayKit dungeon floor tiles): the town square ring,
    // the lane to the great tree, and the crystal cave plaza walk
    { key: 'kkFloorLarge', x: -42.25, z: 1039.75, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: -42.25, z: 1042, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: -42.25, z: 1044.25, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: -40, z: 1039.75, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1044.25, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: -37.75, z: 1039.75, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: -37.75, z: 1042, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: -37.75, z: 1044.25, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1038.4, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1036.15, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1033.9, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: -40, z: 1031.65, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1029.4, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1027.15, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1024.9, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: -40, z: 1022.65, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1020.4, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1018.15, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: -40, z: 1015.9, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: -43.4, z: 1043.2, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: -45.7, z: 1044.1, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: 93.0, z: 1159.75, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: 93.0, z: 1162, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: 93.0, z: 1164.25, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: 95.25, z: 1159.75, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: 95.25, z: 1162, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: 95.25, z: 1164.25, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: 97.5, z: 1159.75, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: 97.5, z: 1162, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: 97.5, z: 1164.25, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: 95, z: 1164.5, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: 92.8, z: 1166, rot: 4.71, scale: 0.55 },
    { key: 'kkFloorLarge', x: 90.5, z: 1167.5, rot: 0.0, scale: 0.55 },
    { key: 'kkFloorLarge', x: 88.2, z: 1169, rot: 1.57, scale: 0.55 },
    { key: 'kkFloorLarge', x: 85.9, z: 1170.5, rot: 3.14, scale: 0.55 },
    { key: 'kkFloorRocks', x: 83.6, z: 1172, rot: 4.71, scale: 0.55 },
