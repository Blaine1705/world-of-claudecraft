...
const IGNIVAR_FORGE_APPROACH_SPAWN_LIST: DungeonSpawn[] = [
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -7, z: -29, packId: 'hub' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 7, z: -29, packId: 'hub' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -49, z: -20, packId: 'west_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -41, z: -18, packId: 'west_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -49, z: 18, packId: 'west_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -40, z: 20, packId: 'west_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 41, z: -2, packId: 'east_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 49, z: 0, packId: 'east_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 40, z: 23, packId: 'east_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 49, z: 25, packId: 'east_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -8, z: 55, packId: 'final' },
  {
...
const IGNIVAR_MOLTEN_ASSEMBLY_SPAWN_LIST: DungeonSpawn[] = [
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -7, z: -29, packId: 'intake' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 7, z: -29, packId: 'intake' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -22, z: 0, packId: 'west_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -17, z: 7, packId: 'west_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -44, z: 28, packId: 'west_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -35, z: 31, packId: 'west_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 22, z: 0, packId: 'east_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 17, z: 7, packId: 'east_lower' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 44, z: 28, packId: 'east_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: 35, z: 31, packId: 'east_upper' },
  { mobId: IGNIVAR_EMBER_SENTINEL_ID, x: -10, z: 65, packId: 'final' },
  {
    mobId: IGNIVAR_CRUCIBLE_WARDEN_ID,
    x: -8,
    z: 72,
...
export const DUNGEON_DEFS: Record<string, DungeonDef> = {
  ...
  [IGNIVAR_FORGE_APPROACH_ID]: {
    ...
    npcs: [{ npcId: IGNIVAR_MAELIN_NPC_ID, x: 0, z: -55 }],
    objects: [
      {
