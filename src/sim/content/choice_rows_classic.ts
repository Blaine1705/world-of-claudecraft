      ...
      options: [
        {
          ...
          name: 'Deep Reservoir',
          description:
            'After Earthen Jolt or Faultwake consumes a full bank of 5 Thunder, retain 2 Thunder. After a spell consumes Stormcast, retain 1 Warspirit Cadence step. After Cascading Mend consumes Mending Current, restore 25% of the amount consumed.',
          icon: 'lightning_bolt',
        ...
        },
        {
          ...
          description:
            'After Earthen Jolt or Faultwake consumes a full bank of 5 Thunder, repeat 40% of its damage after 1 sec. A spell that consumes Stormcast repeats at 40% strength. Healing from consumed Mending Current repeats at 40% strength after 2 sec. These repeats cannot trigger other effects.',
        ...
        },
        {
          ...
          name: 'Living Weapon',
          description:
            "After Earthen Jolt or Faultwake consumes a full bank of 5 Thunder, Pyrebrand makes the next Arc Bolt instant. Galeheart's echoes each deal 40% damage to up to 2 enemies within 8 yards. A Stonebound spell that consumes Stormcast grants an absorb equal to 8% of your maximum health. With Lifespring active, Tidecall also adds 50% of its full heal to the most injured ally within 10 yards.",
          icon: 'rockbiter_weapon',
          effect: {
            runtime: {
              cleavePercent: 40,
