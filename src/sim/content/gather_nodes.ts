...
export const GATHER_NODES: GatherNodeDef[] = [
  ...
  { id: 'ore_veiled_hollow_1', zoneId: 'veiled_hollow', type: 'ore', pos: { x: -2, z: 1004 }, level: 18 },
  { id: 'ore_veiled_hollow_2', zoneId: 'veiled_hollow', type: 'ore', pos: { x: 6, z: 1044 }, level: 18 },
  { id: 'wood_veiled_hollow_1', zoneId: 'veiled_hollow', type: 'wood', pos: { x: -82, z: 1052 }, level: 18 },
  { id: 'wood_veiled_hollow_2', zoneId: 'veiled_hollow', type: 'wood', pos: { x: -70, z: 992 }, level: 18 },
  { id: 'herb_veiled_hollow_1', zoneId: 'veiled_hollow', type: 'herb', pos: { x: -22, z: 1074 }, level: 18 },
  { id: 'herb_veiled_hollow_2', zoneId: 'veiled_hollow', type: 'herb', pos: { x: -54, z: 1082 }, level: 18 },

  // The Drakelands, around Wyrmwatch: hub-outskirt veins, stands, and patches so every
  // profession can gather without backtracking to an older zone.
  { id: 'ore_drakelands_1', zoneId: 'drakelands', type: 'ore', pos: { x: 442, z: 1874 }, level: 18 },
  { id: 'ore_drakelands_2', zoneId: 'drakelands', type: 'ore', pos: { x: 450, z: 1914 }, level: 18 },
  { id: 'wood_drakelands_1', zoneId: 'drakelands', type: 'wood', pos: { x: 362, z: 1922 }, level: 18 },
  { id: 'wood_drakelands_2', zoneId: 'drakelands', type: 'wood', pos: { x: 374, z: 1862 }, level: 18 },
  { id: 'herb_drakelands_1', zoneId: 'drakelands', type: 'herb', pos: { x: 422, z: 1944 }, level: 18 },
  { id: 'herb_drakelands_2', zoneId: 'drakelands', type: 'herb', pos: { x: 390, z: 1952 }, level: 18 },
  ...
  { id: 'wood_frostveil_1', zoneId: 'frostveil', type: 'wood', pos: { x: -72, z: 1582 }, level: 19 },
  { id: 'wood_frostveil_2', zoneId: 'frostveil', type: 'wood', pos: { x: -60, z: 1522 }, level: 19 },
  { id: 'herb_frostveil_1', zoneId: 'frostveil', type: 'herb', pos: { x: -12, z: 1604 }, level: 19 },
  { id: 'herb_frostveil_2', zoneId: 'frostveil', type: 'herb', pos: { x: -44, z: 1612 }, level: 19 },
  ...
  { id: 'wood_amberfall_1', zoneId: 'amberfall', type: 'wood', pos: { x: -402, z: 2094 }, level: 19 },
  { id: 'wood_amberfall_2', zoneId: 'amberfall', type: 'wood', pos: { x: -390, z: 2034 }, level: 19 },
  { id: 'herb_amberfall_1', zoneId: 'amberfall', type: 'herb', pos: { x: -342, z: 2116 }, level: 19 },
  { id: 'herb_amberfall_2', zoneId: 'amberfall', type: 'herb', pos: { x: -374, z: 2124 }, level: 19 },
  ...
  { id: 'wood_willowfen_1', zoneId: 'willowfen', type: 'wood', pos: { x: -402, z: 384 }, level: 20 },
  { id: 'wood_willowfen_2', zoneId: 'willowfen', type: 'wood', pos: { x: -390, z: 324 }, level: 20 },
  { id: 'herb_willowfen_1', zoneId: 'willowfen', type: 'herb', pos: { x: -342, z: 406 }, level: 20 },
  { id: 'herb_willowfen_2', zoneId: 'willowfen', type: 'herb', pos: { x: -374, z: 414 }, level: 20 },

  // The Nightbloom, around Moonrest: hub-outskirt veins, stands, and patches so every
  // profession can gather without backtracking to an older zone.
  { id: 'ore_nightbloom_1', zoneId: 'nightbloom', type: 'ore', pos: { x: -332, z: 1394 }, level: 20 },
  { id: 'ore_nightbloom_2', zoneId: 'nightbloom', type: 'ore', pos: { x: -324, z: 1434 }, level: 20 },
  { id: 'wood_nightbloom_1', zoneId: 'nightbloom', type: 'wood', pos: { x: -412, z: 1442 }, level: 20 },
  { id: 'wood_nightbloom_2', zoneId: 'nightbloom', type: 'wood', pos: { x: -400, z: 1382 }, level: 20 },
  { id: 'herb_nightbloom_1', zoneId: 'nightbloom', type: 'herb', pos: { x: -352, z: 1464 }, level: 20 },
  { id: 'herb_nightbloom_2', zoneId: 'nightbloom', type: 'herb', pos: { x: -384, z: 1472 }, level: 20 },

  // The Wraithwood, around Gallowmere: hub-outskirt veins, stands, and patches so every
  // profession can gather without backtracking to an older zone.
  { id: 'ore_wraithwood_1', zoneId: 'wraithwood', type: 'ore', pos: { x: 398, z: 1404 }, level: 20 },
  { id: 'ore_wraithwood_2', zoneId: 'wraithwood', type: 'ore', pos: { x: 406, z: 1444 }, level: 20 },
  { id: 'wood_wraithwood_1', zoneId: 'wraithwood', type: 'wood', pos: { x: 318, z: 1452 }, level: 20 },
  { id: 'wood_wraithwood_2', zoneId: 'wraithwood', type: 'wood', pos: { x: 330, z: 1392 }, level: 20 },
  { id: 'herb_wraithwood_1', zoneId: 'wraithwood', type: 'herb', pos: { x: 378, z: 1474 }, level: 20 },
  { id: 'herb_wraithwood_2', zoneId: 'wraithwood', type: 'herb', pos: { x: 346, z: 1482 }, level: 20 },
  ...
  { id: 'wood_palmreach_1', zoneId: 'palmreach', type: 'wood', pos: { x: -342, z: 842 }, level: 20 },
  { id: 'wood_palmreach_2', zoneId: 'palmreach', type: 'wood', pos: { x: -330, z: 782 }, level: 20 },
  { id: 'herb_palmreach_1', zoneId: 'palmreach', type: 'herb', pos: { x: -282, z: 864 }, level: 20 },
  { id: 'herb_palmreach_2', zoneId: 'palmreach', type: 'herb', pos: { x: -314, z: 872 }, level: 20 },
  ...
  { id: 'wood_evergarden_1', zoneId: 'evergarden', type: 'wood', pos: { x: 278, z: 832 }, level: 20 },
  { id: 'wood_evergarden_2', zoneId: 'evergarden', type: 'wood', pos: { x: 290, z: 772 }, level: 20 },
  { id: 'herb_evergarden_1', zoneId: 'evergarden', type: 'herb', pos: { x: 338, z: 854 }, level: 20 },
  { id: 'herb_evergarden_2', zoneId: 'evergarden', type: 'herb', pos: { x: 306, z: 862 }, level: 20 },

  // The Farshore, around Gullhaven: hub-outskirt veins, stands, and patches so every
  // profession can gather without backtracking to an older zone.
  { id: 'ore_farshore_isle_1', zoneId: 'farshore_isle', type: 'ore', pos: { x: 343, z: 44 }, level: 5 },
  { id: 'ore_farshore_isle_2', zoneId: 'farshore_isle', type: 'ore', pos: { x: 351, z: 84 }, level: 5 },
  { id: 'wood_farshore_isle_1', zoneId: 'farshore_isle', type: 'wood', pos: { x: 263, z: 92 }, level: 5 },
  { id: 'wood_farshore_isle_2', zoneId: 'farshore_isle', type: 'wood', pos: { x: 275, z: 32 }, level: 5 },
  { id: 'herb_farshore_isle_1', zoneId: 'farshore_isle', type: 'herb', pos: { x: 323, z: 114 }, level: 5 },
  { id: 'herb_farshore_isle_2', zoneId: 'farshore_isle', type: 'herb', pos: { x: 291, z: 122 }, level: 5 },
