...
// Shared by the sim's role normalization (normalizeRole / ensureSideKeeper in
// src/sim/social/vale_cup.ts) and the window's small-bracket role note
// (src/ui/vale_cup_window_view.ts), so the two can never drift (issue 2767).
