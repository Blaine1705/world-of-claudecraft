...
// Eastbrook, Draven Kole in Highwatch, the Crucible vendor, the Wyrmwatch
// harbormaster, and authored practice dummies). A singleton NPC takes a reserved id AND
