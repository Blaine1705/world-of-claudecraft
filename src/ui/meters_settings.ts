...
export const FONT_OPTIONS: readonly MeterFontOption[] = [
  {
    id: 'expressway',
    name: 'Modern Gothic (Details! Standard)',
    family: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", sans-serif',
    desc: 'Limpia, alta legibilidad y contraste. La tipografia clasica de Details! y ElvUI.',
  ...
  },
  {
    ...
    family: 'var(--font-ui)',
    desc: 'Tipografia canonica de la interfaz de World of ClaudeCraft.',
    sample: '1. Chronomancer 138.9k (13.5k, 26%)',
  },
  {
    id: 'classic_serif',
    name: 'Classic Friz (WoW Clasico)',
    family: 'Georgia, "Palatino Linotype", Palatino, serif',
    desc: 'Elegante con serifa inspirada en los addons de la era clasica de World of Warcraft.',
    sample: '1. Paladin 124.6k (12.1k, 24%)',
  },
  {
    id: 'cinzel',
    name: 'Cinzel (Fantasia Heraldica)',
    family: 'var(--font-display)',
    desc: 'Estilo epico medieval para inmersion rolera en pergamino.',
    sample: '1. Mage 118.4k (11.6k, 22%)',
  },
  {
    id: 'monospace',
    name: 'Mono Tabular (Cero Jitter)',
    family: 'ui-monospace, "Cascadia Mono", "Segoe UI Mono", Menlo, Consolas, monospace',
    desc: 'Ancho fijo perfecto: los numeros y columnas no tiemblan jamas en combate.',
    sample: '1. Rogue 152.0k (15.0k, 29%)',
  },
  {
    id: 'futura',
    name: 'Futura Bold (Impacto y Sala)',
    family: '"Trebuchet MS", "Arial Black", system-ui, sans-serif',
    desc: 'Trazo grueso de alto impacto para pantallas grandes o mayor distancia.',
