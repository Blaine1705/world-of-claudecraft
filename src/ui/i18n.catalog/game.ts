...
export const gameStrings = {
  ...
  talents: {
    ...
    spent: 'Spent',
    pointSource:
      'Earn 1 talent point each level from level {first} to {cap}. Level up to get more points.',
    apply: 'Apply changes',
    clear: 'Reset points',
    reset: 'Reset',
    ...
    deleteBuild: 'Delete',
    currentBuildHint:
      'Choose a saved build, then Save current to update it. Export shares the selected build.',
    createBuildHint:
      'New build saves your current points as a separate build. Import pastes a shared build string.',
    buildHint:
      'Choose a saved build, update it with Save current, or create another with New build.',
    ...
    deleteBuildBody:
      'Delete “{name}”? This removes only the saved build; your current talents stay unchanged.',
    ...
    comingSoonBody:
      'This class does not have talent trees yet. You can keep playing normally; full trees will arrive in a future update.',
    readout: {
...
export const gameStringsFrFR: typeof gameStrings = {
  ...
  talents: {
    ...
    readout: {
      ...
      locked: "Vous n'avez pas encore débloqué les talents ; ils débutent au niveau {level}.",
...
export const gameStringsKoKR: typeof gameStrings = {
  ...
  talents: {
    ...
    readout: {
      noTree: '당신의 직업에는 아직 특성 트리가 없습니다.',
      locked: '아직 특성을 해금하지 않았습니다. 특성은 {level} 레벨부터 시작됩니다.',
      noSpec: '전문화 없음',
      summary: '특성: {head} — {spent}/{total} 포인트 사용 ({breakdown}).',
...
export const gameStringsJaJP: typeof gameStrings = {
  ...
  talents: {
    ...
    readout: {
      ...
      locked: 'タレントはまだ解放されていません。レベル {level} から始まります。',
      noSpec: '専門化なし',
      summary: 'タレント: {head} — {spent}/{total} ポイント使用 ({breakdown})。',
...
export const gameStringsPtBR: typeof gameStrings = {
  ...
  talents: {
    ...
    readout: {
      ...
      locked: 'Você ainda não desbloqueou os talentos; eles começam no nível {level}.',
      noSpec: 'sem especialização',
      summary: 'Talentos: {head} — {spent}/{total} pontos gastos ({breakdown}).',
      breakdownClass: 'Classe {classPts}',
      breakdownSpec: 'Classe {classPts}, {spec} {specPts}',
      unspent: ' {count} não gastos.',
    },
  },
};
...
export const gameStringsRuRU: typeof gameStrings = {
  ...
  talents: {
    ...
    readout: {
      noTree: 'У вашего класса пока нет древа талантов.',
      locked: 'Вы ещё не открыли таланты; они становятся доступны на {level} уровне.',
      noSpec: 'без специализации',
      summary: 'Таланты: {head} — потрачено {spent}/{total} очков ({breakdown}).',
      breakdownClass: 'Класс {classPts}',
      breakdownSpec: 'Класс {classPts}, {spec} {specPts}',
      unspent: ' {count} не распределено.',
    },
  },
};
