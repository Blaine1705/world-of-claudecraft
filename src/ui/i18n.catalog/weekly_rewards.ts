export const weeklyRewardStrings = {
  ...
  poolRule:
    'Select one or more tables before opening. Dungeon tables combine bosses you have cleared at this difficulty. Rolls exclude duplicates, legendary items and equipment requiring more than 3 levels above your level.',
  rare: 'Rare',
  uncommon: 'Uncommon',
  epic: 'Epic',
