...
export const guideStrings = {
  ...
  worldPvpPage: {
    ...
    hillBody:
      'Once an hour a hill rises somewhere in one of the free-for-all zones: a wide circle on open ground, announced to the whole realm and drawn on the ground where it stands. The group with the most players standing inside it contests the hill, and after a minute of unbroken majority the hill is theirs; a party or raid counts as one group, and a lone player is a group of one. While a group holds the hill, each of its members standing inside earns a little Honor every minute, to a handful of them at once, so a full party holding an uncontested hill for the whole hour earns about what one battleground win pays. A bar over the field shows who holds it, your numbers against theirs, and the contest clock; /hill in chat says where it stands.',
    limitsBodyHour:
