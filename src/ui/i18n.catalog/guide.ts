...
export const guideStrings = {
  ...
  economy: {
    ...
    buyingBody:
      'Speak to a merchant and choose to browse their goods, and their shop opens as a single panel: everything they stock in one list, yours with a click if you can afford it. A quantity strip above the goods sets how many each click buys, one, five, or ten at a time, or a custom count, and stackable wares also carry a Buy Stack offer that takes as many as your coin covers, up to a full stack, in a single purchase. Selling is just as direct: while the shop is open, click an item in your bags to sell it on the spot. If you part with something you regret, the Buyback list at the bottom of the shop holds your recent sales so you can buy them back for the coin you were paid.',

    // Offloading junk.
    junkTitle: 'Clearing out junk',
    junkBody:
      "Drops you have no use for still sell to any vendor, so empty your bags whenever you pass through town rather than letting them fill up. Every merchant's window even keeps a one-click Sell Junk button that sells every Poor-quality oddment at once. Truly worthless odds and ends can also be discarded outright to make room.",
