...
export const hudChromeStrings = {
  ...
  raidBossGuide: {
    ...
    ignivar: {
      ...
      judgment:
        'Judgment of the Forge: remember the unique refuge during the warning, then stack inside its marked boundary when the floor ignites.',
      finale:
        'Last Inferno: below 20%, kill Ignivar within 45 sec while faster meteors, frontals, and Revolving Inferno continue.',
      heroic:
        'Heroic: paired players must remain close during Chains of the Forge; Brand also punishes nearby players during Judgment.',
    },
    varkhul: {
      ...
      forge:
        'Forge pillars: block active beams before they reach the forge. Rotate blockers as exposure grows; at 100% heat the forge melts down.',
      ...
      heroic:
        'Heroic: waves overlap if killed slowly, forge heat never cools, Shared Pyre needs five players, and Worldfire closes the room from 20%.',
    },
  },
  auraEffect: {
    sharedPyre:
