...
export const hudChromeStrings = {
  ...
  options: {
    ...
    frameRateCapNote:
      'Limits how many images the game draws each second. On a computer that cannot keep up with its display, a lower limit gives a steadier picture and keeps the computer cooler. The limit follows your display, so the real rate can differ a little from the number. Display: no limit. Auto: for now the same as Display.',
