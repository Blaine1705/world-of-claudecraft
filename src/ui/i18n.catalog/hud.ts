  ...
  fr_FR: {
    hud: {
      ...
      core: {
        ...
        deathRecap: 'Récapitulatif',
        deathRecapTitle: 'Récapitulatif de mort',
        deathRecapKiller: 'Coup de grâce: {killer} ({ability})',
        deathRecapNoKiller: 'Événements ayant mené à la mort',
        deathRecapLethal: 'Coup mortel',
      ...
      meters: {
        ...
        selectSegment: 'Sélectionner le combat',
  ...
  it_IT: {
    hud: {
      ...
      core: {
        ...
        deathRecapTitle: 'Riepilogo della morte',
        deathRecapKiller: 'Colpo di grazia: {killer} ({ability})',
        deathRecapNoKiller: 'Eventi di combattimento prima della morte',
      ...
      meters: {
        ...
        deaths: 'Morti',
        deathsShort: 'Morti',
        reset: 'Azzera misuratori',
        resetHint: 'Azzera dati di combattimento',
        ...
        selectSegment: 'Seleziona combattimento',
        selectMode: 'Seleziona modalità',
        back: 'Indietro',
        resetFight: 'Reimposta combattimento attuale',
  ...
  de_DE: {
    hud: {
      ...
      core: {
        ...
        deathRecapKiller: 'Todesstoß: {killer} ({ability})',
        deathRecapNoKiller: 'Kampfereignisse vor dem Tod',
        deathRecapLethal: 'Todesstoß',
        deathRecapClose: 'Schließen',
        deathRecapNoEvents: 'Keine Kampfereignisse aufgezeichnet.',
        deathRecapCrit: 'Kritisch',
  ...
  zh_CN: {
    hud: {
      ...
      core: {
        ...
        deathRecapKiller: '最后一击：{killer} ({ability})',
        deathRecapNoKiller: '死亡前的战斗事件',
        deathRecapLethal: '致命一击',
        deathRecapClose: '关闭',
        deathRecapNoEvents: '无战斗记录。',
        deathRecapCrit: '爆击',
        deathRecapDamage: '伤害',
        deathRecapHeal: '治疗',
        chatTab: '聊天',
  ...
  ko_KR: {
    hud: {
      ...
      core: {
        ...
        deathRecap: '전투 요약',
        deathRecapTitle: '사망 요약',
        deathRecapKiller: '결정타: {killer} ({ability})',
        deathRecapNoKiller: '사망 직전 전투 기록',
        deathRecapLethal: '치명타',
        deathRecapClose: '닫기',
  ...
  ja_JP: {
    hud: {
      ...
      core: {
        ...
        releaseSpirit: '霊魂を解放',
        deathRecap: '概要',
        deathRecapTitle: '死亡の概要',
        deathRecapKiller: 'とどめの一撃: {killer} ({ability})',
        deathRecapNoKiller: '死亡直前の戦闘ログ',
        deathRecapLethal: 'とどめの一撃',
        deathRecapClose: '閉じる',
  ...
  pt_BR: {
    hud: {
      ...
      core: {
        ...
        deathRecapKiller: 'Golpe de misericórdia: {killer} ({ability})',
        deathRecapNoKiller: 'Eventos de combate antes da morte',
      ...
      meters: {
        ...
        selectSegment: 'Selecionar combate',
        selectMode: 'Selecionar modo do medidor',
        back: 'Voltar',
        resetFight: 'Redefinir combate atual',
  ...
  ru_RU: {
    hud: {
      ...
      core: {
        ...
        deathRecap: 'Обзор',
        deathRecapTitle: 'Обзор смерти',
        deathRecapKiller: 'Смертельный удар: {killer} ({ability})',
        deathRecapNoKiller: 'События перед смертью',
        deathRecapLethal: 'Смертельный удар',
        deathRecapClose: 'Закрыть',
        deathRecapNoEvents: 'Событий боя не записано.',
        deathRecapCrit: 'Крит',
