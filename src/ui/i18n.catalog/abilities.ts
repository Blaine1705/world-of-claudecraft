  ...
  entities: {
    abilities: abilityTranslations([
      ...
      [
        'triumph_rush',
        'Triumph Rush',
        'After killing an enemy, strike for weapon damage plus {damage} and heal yourself for 20% of maximum health within 20 sec. (Warrior talent)',
      ],
      [
        'razor_howl',
        'Razor Howl',
        'A shout that slows enemies within 15 yd by 50% for 8 sec. (Warrior talent)',
      ],
  ...
  zh_CN: {
    entities: {
      abilities: abilityTranslations([
        ...
        ['swordguard', '剑卫', '受到的伤害降低 10%，持续 8 秒；生命值低于 30% 时提高到 20%。'],
        [
          'triumph_rush',
          '凯旋奔袭',
          '击杀敌人后，20 秒内可造成武器伤害加 {damage}，并恢复最大生命值的 20%。',
        ],
  ...
  zh_TW: {
    entities: {
      abilities: abilityTranslations([
        ...
        ['swordguard', '劍衛', '受到的傷害降低 10%，持續 8 秒；生命值低於 30% 時提高到 20%。'],
        [
          'triumph_rush',
          '凱旋奔襲',
          '擊殺敵人後，20 秒內可造成武器傷害加 {damage}，並恢復最大生命值的 20%。',
        ],
    ...
    entities: {
      abilities: abilityTranslations([
        ...
        [
          'swordguard',
          '검의 수호',
          '8초 동안 받는 피해가 10% 감소하며, 생명력이 30% 미만이면 20% 감소합니다.',
        ],
        [
          'triumph_rush',
          '승전 돌격',
          '적을 처치한 뒤 20초 안에 무기 피해에 {damage}를 더해 입히고 최대 생명력의 20%를 회복합니다.',
        ],
    ...
    entities: {
      abilities: abilityTranslations([
        ...
        [
          'swordguard',
          '剣の守り',
          '8秒間、受けるダメージが10%減少します。体力が30%未満なら20%減少します。',
        ],
        [
          'triumph_rush',
          '凱旋突撃',
          '敵を倒した後20秒以内に、武器ダメージに {damage} を加えて与え、最大体力の20%を回復します。',
        ],
    ...
    entities: {
      abilities: abilityTranslations([
        ...
        [
          'swordguard',
          'Защита клинка',
          'Снижает получаемый урон на 10% на 8 сек.; если здоровья меньше 30%, снижение становится 20%.',
        ],
        [
          'triumph_rush',
          'Триумфальный натиск',
          'После убийства врага в течение 20 сек. наносит урон оружием плюс {damage} и исцеляет вас на 20% максимального здоровья.',
        ],
