    ...
    worldQuest: {
      ...
      combat: {
        ...
        restless_company: {
          ...
          objective:
            'Survive three revenant waves. Choose which captain to defeat first, then defeat their commander.',
        },
        hold_highwatch: {
          title: 'Hold Highwatch',
          objective:
            'Defend Highwatch through three assaults, each followed by a recovery pause and sappers. Stop the sappers before they reach the expedition post, then defeat the commander.',
        },
