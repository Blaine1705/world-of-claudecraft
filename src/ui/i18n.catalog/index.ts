...
export const en = {
  ...
  entities: {
    ...
    items: {
      ...
      deathless_warguard_gauntlets: { name: 'Deathless Warguard Gauntlets' },
      soulrend_diadem: { name: 'Soulrend Diadem' },
      soulrend_handwraps: { name: 'Soulrend Handwraps' },
      scourgehide_carapace: { name: 'Scourgehide Carapace' },
      scourgehide_grips: { name: 'Scourgehide Grips' },
      soulforged_gauntlets: { name: 'Soulforged Gauntlets' },
