...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "worldPvp": {
      ...
      "groupLine": "隊伍、團隊和公會成員之間永遠不會互相敵對。",
  ...
  "guide": {
    ...
    "worldPvpPage": {
      ...
      "introZones": "開放世界的玩家對戰需要主動開啟，而你腳下的土地決定了這意味著什麼。升起你的 PvP 旗幟後，所有不在你的隊伍、團隊或公會中且同樣開啟了旗幟的玩家都會在爭奪地帶成為敵人；降下旗幟後，稍作等待你就會重新成為旁觀者。有兩座區域是完全不會發生世界戰鬥的聖域，而三座滿級區域是自由混戰地帶，無論是否開啟旗幟，身處其中的每個人都可以被攻擊。隊伍、團隊和公會的夥伴在任何地方都不會成為你的敵人。",
