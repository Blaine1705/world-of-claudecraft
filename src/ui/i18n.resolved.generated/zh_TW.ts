...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "strafeBody": "側向移動還有另一種辦法。按一下 {strafeKey}，側步跨進最後一條跑道，然後按住 {forwardKey}，再用 {strafeKey} 橫移，直到紅旗被你甩在身後。橫移能讓你移動時視線始終鎖在目標上：總有一天你會這樣作戰。",
      ...
      "taskStrikeTrueBodyCaster": "走到一個草人跟前，按 {targetKey}，或用滑鼠左鍵點擊它，把它設為目標。然後按 {attackKey}，或點擊動作列上的第二個按鈕，施放你的法術。一直施放到一個散架為止。",
      ...
      "taskShellBodyCaster": "掠蟹是會回擊的。按 {targetKey}，或用滑鼠左鍵點擊一隻，把牠設為目標，然後按 {attackKey} 施放法術，保持距離不停施放。要是一次有太多隻撲上來，就沿小路往回撤：牠們很快就會放棄追趕，休息時你的生命值也會慢慢回滿。",
      "taskShellBodyCasterTouch": "掠蟹是會回擊的。點按一隻把牠設為目標，然後點按動作列上的第二個按鈕施放法術，保持距離不停施放。要是一次有太多隻撲上來，就沿小路往回撤：牠們很快就會放棄追趕，休息時你的生命值也會慢慢回滿。",
      "taskShellBodyCasterPad": "掠蟹是會回擊的。按下目標鍵，再按下第二個動作鍵施放法術，保持距離不停施放。要是一次有太多隻撲上來，就沿小路往回撤：牠們很快就會放棄追趕，休息時你的生命值也會慢慢回滿。",
