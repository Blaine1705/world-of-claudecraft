...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "這張面孔我可沒見過，朋友。如果這是你第一次踏上這些路，有一個地方可以讓你先磨練身手、熟悉這個世界，再去迎接它的挑戰：試煉之濱，海峽對面的一座安靜小島。渡船來回都通，去或不去都沒人會小看你。",
      "bodyRefresher": "又換了一副新面孔回來了？那你知道該怎麼做。不過，出發前若想溫習一遍，試煉之濱從不拒絕回爐的學生，渡船隨時候著你。",
      "play": "進行新手教學",
      "skip": "跳過新手教學",
      "declineNote": "隨你的意，朋友。哪天改了主意，我身旁這口鈴隨時都能送你去試煉之濱，不分晝夜。狼群不等人，它等。",
      "bellHomeNote": "這麼快就從海濱回來了？你剛才敲響的正是渡船鈴。它的孿生兄弟就立在我身旁：想回試煉之濱，隨時敲響它，渡航就會送你過去。敲錯了也不打緊。",
      "noteClose": "明白了"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人布琳",
        "title": "港口嚮導",
        "greeting": "東溪谷來者不拒，朋友。而對腳下還不穩的人來說，總還有試煉之濱：我身旁這口鈴一年到頭隨時送你過去，島上那口孿生鈴再送你回家。"
      },
      "instructor_maren": {
        "name": "教官瑪倫",
        "title": "試煉導師",
      ...
      "ferryman_odo": {
        "name": "渡船人奧多",
        "title": "渡口看守",
        "greeting": "剛下渡船嗎，{playerName}？那就沿著岸邊的路往上走：教官瑪倫在晨憩營地主持操練，她想先跟你說上幾句。等谷地召喚你回去時，敲響我碼頭盡頭的鈴，渡航會把你送到東溪鎮上。"
      },
      "bursar_wick": {
        "name": "司庫威克",
        "title": "鍍金保險箱",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "擊中要害",
        "text": "歡迎來到試煉之濱，{playerName}。這裡的每一課都從同一件事開始：站穩腳，握好刃。營地西南練武場上的草人生來就是挨打的。挑一個，站穩，砍到三個散架為止。它們不會還手。這片海濱之外的東西可會。",
        "completion": "三個倒下，你的手也穩多了。記住這種感覺，{playerName}：站穩腳，抬起眼，全力揮出。谷地的狼比稻草快，但同樣的算術也能放倒牠們。",
        "objectives": {
          "0": {
            "label": "擊倒訓練草人"
          }
      ...
      "q_ps_the_wreck_line": {
        "title": "沉船灘",
        "text": "潮水用海貨支付這座島：舊沉船上的漂流貨箱，被沖上面向谷地的那片海灘。翻揀它們的掠蟹夾起人來比看上去疼，所以腳下留神。撬開三只貨箱，把大海留給我們的東西帶回來。",
        "completion": "繩子、焦油，還有半輪大海竟然放過的乳酪。世上到處都是值得彎腰去撿的東西，{playerName}。保持這個習慣：看見，打開，拿走。",
        "objectives": {
          "0": {
            "label": "開啟漂流貨箱"
          }
      ...
      "q_ps_a_path_of_your_own": {
        "title": "專屬之路",
        "text": "揮劍是一回事，{playerName}，明白為什麼而揮又是另一回事。到了五級，世界會請你選擇一門專精：你這行當的三條道路之一，各有所長。從那以後，每隔幾級就會開啟一排天賦，一排三選一。再擊倒兩個草人，趁稻草飛揚的時候，想想你要走哪一條路。",
        "completion": "又倒下兩個，揮砍背後也多了幾分沉穩。最要緊的是記住這一點，{playerName}：你的任何選擇都不是牢籠。天賦面板隨時可以打開；等你在五級做出選擇之後，只要站在安全的地方，天賦和專精都可以隨時重置、重新選擇，分文不取。大膽去選，學到了新東西就再選一次。",
        "objectives": {
          "0": {
            "label": "擊倒訓練草人"
          }
      ...
      "q_ps_the_wheel_of_trades": {
        "title": "百業環輪",
        "text": "一柄劍只能餵飽你一頓，{playerName}，一門手藝卻能餵養你一生。每個冒險者在刀劍之外都操持著專業：採礦、伐木、採藥、釣魚，還有把這一切變成價值的製作技藝。軍需官芬奇擺過的攤子比我帶過的操練還多。去問問她，一門手藝是怎麼立起來的。",
        "completion": "瑪倫總算給我送來一個值得費口舌的學生。聽好了，{playerName}，只說一遍：採集從一件工具開始，礦鎬、斧子、鐮刀、釣竿，谷地的商人那裡都有得賣。你的技藝構成一個環輪：鑽研你喜歡的那些，當你調諧到相鄰的一對，這兩門便成為無上限的主修，環輪對面的一門是你的嗜好，其餘的則休眠，直到你重新拾起。你學會的東西永遠不會失去，等你準備好了，城鎮裡的技藝大師會向你提供調諧。",
        "objectives": {
          "0": {
            "label": "向軍需官芬奇請教百業"
          }
      ...
      "q_ps_pouch_and_purse": {
        "title": "錢囊與背袋",
        "text": "去谷地之前還有最後一課，{playerName}，也是保住冒險者性命的一課：你隨身帶的東西。你的背包有十六格，旁邊還空著四個袋扣；每繫上一只袋子，它的空間就併入總容量。去軍需官芬奇那裡買一只亞麻小袋，把它繫上，然後回來找我。",
      ...
      "q_ps_set_sail": {
        "title": "揚帆起航",
        "text": "這片海濱上已經沒有你沒打倒過、沒打開過、沒買下過的東西了，{playerName}。你準備好了，而東溪谷有真正的差事在等著。走到舊碼頭去，告訴渡船人奧多，就說是我說的，你掙到了這趟航程。",
        "completion": "瑪倫這麼說了？能從一個曾讓我練了一星期繫纜繩的女人嘴裡說出來，這可是極高的評價。等你準備好了就敲響我碼頭盡頭的鈴，{playerName}，渡航會把你送到東溪鎮的正中央。當心狼群。",
        "objectives": {
          "0": {
            "label": "向渡船人奧多報到"
          }
