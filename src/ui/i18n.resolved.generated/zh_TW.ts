...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "veilbound_march": "穿過敵群施加印記，削弱其對你的傷害並穩固仇恨。",
      "holy_shield": "消耗奉獻，獲得主動格擋、吸收護盾和仇恨脈衝。",
      "consecration": "以持續的神聖傷害和仇恨佔據周圍地面。",
      "hammer_of_justice": "用短暫而可靠的昏迷阻止一個敵人。",
  ...
  "entities": {
    "abilities": {
      ...
      "bastion_sweep": {
        "name": "壁壘橫掃",
        "description": "用盾牌橫掃附近敵人，造成 {damage} 點神聖傷害並產生大量仇恨，同時獲得 1 點奉獻。昇華使傷害提高 30%，半徑擴大至 8 公尺。"
      },
      "oath_chain": {
        "name": "誓約鎖鏈",
      ...
      "veilbound_march": {
        "name": "帷光行軍",
        "description": "進入虛靈狀態4秒，移動速度提高40%、護甲提高30%，並免疫定身、減速和位移。被你穿過的敵人會受到持續6秒的帷光印記，每秒受到神聖傷害，對你造成的傷害降低20%，並對你產生額外仇恨。首次施加印記獲得1點奉獻。行軍結束時，附近被標記的敵人受到一次終結爆發。昇華使該爆發傷害提高50%，並將敵人輕微拉向你。"
      },
      "veilbound_mark": {
        "name": "帷光印記",
        "description": "每秒受到神聖傷害，對施加印記的聖騎士造成的傷害降低20%，並對該聖騎士產生額外仇恨。"
      },
      "righteous_fury": {
        "name": "燃燒誓言",
