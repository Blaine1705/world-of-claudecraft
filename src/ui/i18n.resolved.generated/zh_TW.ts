...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "currencies": {
      ...
      "riftWatchMark": "裂隙守望印記",
      "riftWatchMarkNote": "裂隙守望區域的世界任務",
      "churchOrderCrest": "教會徽記",
    ...
    "enchantName": {
      ...
      "enchant_feet_shadowstride": "長靴蝕刻：暗影漫步",
      "enchant_gloves_forged_might": "手套蝕刻：鍛造力量"
    },
    "enchantDescription": {
    ...
    "factionRewards": {
      "alliedHearthstoneUse": "使用：將你傳送至已協調的陣營據點。（10秒施法時間，15分鐘冷卻時間）",
      "alliedHearthstoneAttuned": "已協調至：{hub}",
      "hub_none": "無（在陣營據點附近使用以進行協調）",
      "hub_rift_watch": "漂流港（裂隙守望）",
      "hub_church_order": "東溪谷（聖光教會修會）",
      "hub_automatons": "南境（機械鑄造廠）",
      "riftGliderUse": "使用：展開滑翔器，減緩墜落速度，持續30秒。著陸或受到傷害會取消此效果。（2分鐘冷卻時間）",
      "targetDummyUse": "使用：在野外放置一個機械訓練假人，持續2分鐘，用於練習戰鬥技能。（5分鐘冷卻時間）",
      "battleStandardUse": "使用：放置神聖晨曦戰旗，持續5分鐘，顯著提高附近所有盟友的非戰鬥生命與法力回復速度。在其附近停留10秒還會獲得晨曦祝福（所有屬性提高5%，持續30分鐘）。（5分鐘冷卻時間）",
      "shockBombUse": "使用：向最多30碼的目標投擲一枚震擊炸彈，對5碼內的所有敵人造成120至160點自然傷害。（1分鐘冷卻時間）",
      "invisibilityUse": "使用：使你進入潛行狀態，持續6秒。（2分鐘冷卻時間）",
      "armorKitUse": "使用：加固你的胸甲，使其護甲值提高12點，持續1小時。",
      "sharpeningStoneUse": "使用：打磨你的主手武器，使其攻擊強度提高6點，持續30分鐘。",
      "manaElixirUse": "使用：使精神提高6點，持續1小時。"
    },
    "professions": {
      "title": "專業",
      "close": "關閉專業",
