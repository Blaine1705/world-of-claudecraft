  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人布琳",
        "title": "港口嚮導",
        "greeting": "東溪谷來者不拒，朋友。而對腳下還不穩的人來說，總還有試煉之濱：西岸的渡送法陣一年到頭雙向通行。"
      },
      "instructor_maren": {
        "name": "教官瑪倫",
        "title": "試煉導師",
      ...
      "ferryman_odo": {
        "name": "渡船人奧多",
        "title": "渡口看守",
        "greeting": "海峽風平浪靜，船也結實，{playerName}。等你準備好去谷地了，碼頭盡頭的渡送法陣隨時送你過去。"
      },
      "bursar_wick": {
        "name": "司庫威克",
        "title": "鍍金保險箱",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "錢囊與背袋",
        "text": "說說你身上背的東西，{playerName}。你的背包有十六格，旁邊還空著四個袋扣：每繫上一只袋子，它的空間就併入總容量。背不下的，交給鍍金保險箱：任何城鎮的任何司庫都為你打開同一座金庫，等你的錢袋鼓起來，還能購買更多金庫空間。現在來練練這個習慣：去軍需官芬奇那裡買一只亞麻小袋，把它繫上。",
        "completion": "好袋子，又多出六格用來裝麻煩。貴重的存進金庫，袋子留出空當，{playerName}。塞滿的行囊斷送過的冒險，比任何狼都多。",
        "objectives": {
          "0": {
            "label": "購買亞麻小袋"
          }
      ...
      "q_ps_set_sail": {
        ...
        "completion": "瑪倫這麼說了？能從一個曾讓我練了一星期繫纜繩的女人嘴裡說出來，這可是極高的評價。碼頭盡頭的法陣隨時送你去谷地，{playerName}，走進去就行。當心狼群。",
        "objectives": {
          "0": {
            "label": "向渡船人奧多報到"
          }
