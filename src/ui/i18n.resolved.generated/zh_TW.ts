...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "qtyRowAria": "製作數量",
      "qtyDecreaseAria": "減少製作數量",
      "qtyIncreaseAria": "增加製作數量",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "econ": {
        ...
        "castPaceBody": "專業動作需要真實讀條時間：簡單的野外配方大約一秒半，高階階梯配方則需要數秒；分解、附魔、拆解與工具效果充能各自有固定的短讀條。中途取消不會損失材料。每次成功製作還會依物品預算支付銅幣費用。加上材料、工作台與技能上限，這種節奏在不設額外動作配額的情況下，也能讓市場保持健康。",
