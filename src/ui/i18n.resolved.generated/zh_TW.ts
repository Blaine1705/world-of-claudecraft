...
export const zh_TW: EnTranslations = {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "擊中要害",
        "text": "歡迎來到試煉之濱，{playerName}。這裡的每一課都從同一件事開始：站穩腳，握好刃。以 W、A、S、D 行走，按住滑鼠右鍵轉動視角。營地西南練武場上的草人生來就是挨打的：走到一個草人跟前，按 Tab 或用滑鼠左鍵點擊它，把它設為目標。接著按 1，或點擊畫面底部動作列上的第一個圖示，揮出這一刀。一直打到三個散架為止。它們的還擊不痛不癢。這片海濱之外的東西下手可重得多。",
