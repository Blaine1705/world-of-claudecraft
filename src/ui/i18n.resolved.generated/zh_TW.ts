...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "剛下渡船嗎？歡迎來到試煉之濱。教官瑪倫在我身後這條路盡頭的晨憩營地主持操練：她想先跟你說上幾句。等你準備離開時，敲響我碼頭盡頭的這口鈴，渡航就會送你回東溪鎮。",
      "noteClose": "明白了"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "擊中要害",
        "text": "歡迎來到試煉之濱，{playerName}。這裡的每一課都從同一件事開始：站穩腳，握好刃。營地西南練武場上的草人生來就是挨打的。挑一個，站穩，砍到三個散架為止。它們的還擊不痛不癢。這片海濱之外的東西下手可重得多。",
