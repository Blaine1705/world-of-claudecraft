...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "剛下渡船嗎？歡迎來到試煉之濱。看守塔姆就在你正前方的海灘上守著試煉跑道：先去找他，他的跑道會把你雙腿該會的都教給你。等紅旗被你甩在身後，就沿碼頭北邊的路上去晨憩營地找教官瑪倫領第一件差事：走到她跟前，直到她的名字顯示出來，然後按 F，或用滑鼠左鍵點擊她交談。等你準備離開時，敲響立在我碼頭旁的那口鈴，渡航就會送你回東溪鎮。",
      "noteClose": "明白了"
    },
    "tutorial": {
    ...
    "bootcamp": {
      ...
      "forwardBody": "穿過面前的試煉跑道大門，按住 {forwardKey} 沿第一條跑道向西走到旗幟處。",
      "forwardBodyTouch": "穿過面前的試煉跑道大門，把移動搖桿推向上方，沿第一條跑道向西走到旗幟處。",
      "forwardBodyPad": "穿過面前的試煉跑道大門，把左搖桿推向上方，沿第一條跑道向西走到旗幟處。",
      "cameraTitle": "轉動視角",
      "cameraBody": "第一面旗到手。現在按住滑鼠右鍵並拖動來轉動視角：看看向南延伸的圍欄跑道，然後轉回原來的朝向。",
      "cameraBodyTouch": "第一面旗到手。現在用手指拖動世界畫面（不是移動搖桿）來轉動視角：看看向南延伸的圍欄跑道。",
      "cameraBodyPad": "第一面旗到手。現在推動右搖桿來轉動視角：看看向南延伸的圍欄跑道。",
      "leftTitle": "向左滑步",
      "leftBody": "保持朝向不變，按住 {strafeKey} 沿南邊的跑道向左橫移，走到旗幟處。橫移能讓你移動時視線始終鎖在目標上：總有一天你會這樣作戰。",
      "leftBodyTouch": "把移動搖桿推向左邊，沿南邊的跑道橫移到旗幟處。",
      "leftBodyPad": "把左搖桿推向左邊，沿南邊的跑道橫移到旗幟處。",
      "camera2Title": "再看一次",
      "camera2Body": "第二面旗到手。再按住右鍵轉動一次視角，對準向西延伸的最後一條跑道。",
      "camera2BodyTouch": "第二面旗到手。再用手指拖動一次畫面，對準向西延伸的最後一條跑道。",
      "camera2BodyPad": "第二面旗到手。再推動一次右搖桿，對準向西延伸的最後一條跑道。",
      "forward2Title": "一口氣跑完",
      "forward2Body": "再次按住 {forwardKey}，沿最後一條跑道跑到紅旗處。",
      "forward2BodyTouch": "再次把移動搖桿推向上方，沿最後一條跑道跑到紅旗處。",
      "forward2BodyPad": "再次把左搖桿推向上方，沿最後一條跑道跑到紅旗處。",
      "courseProgress": "旗幟 {current}/{total}",
      "doneTitle": "可以受訓了",
      "doneBody": "腿上的功夫就這些了。教官瑪倫在碼頭沿路而上的晨憩營地主持操練，她的第一件差事正等著你。"
    },
    "widgets": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "warden_tam": {
        "name": "看守塔姆",
        "title": "試煉跑道的看守",
        "greeting": "這幾條跑道就是試煉跑道，{playerName}，谷地敬重的每一位冒險者都跑過它。沿第一條跑道向西走到旗幟處，好好環顧四周，再沿第二條跑道向左滑步下去，再看一圈，最後沿末尾的跑道跑到紅旗處。火盆整夜不熄。等紅旗被你甩在身後，晨憩營地的教官瑪倫會交給你第一件差事。"
      },
      "tidewatcher_ondrel": {
        "name": "翁德瑞爾·韋恩",
        "title": "守潮者",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "擊中要害",
        "text": "歡迎來到試煉之濱，{playerName}。這裡的每一課都從同一件事開始：站穩腳，握好刃。營地西南練武場上的草人生來就是挨打的。要是找不到練武場，按 M 打開地圖：你身上的每件差事都會標在上面，用不著亂繞。走到一個草人跟前，按 Tab 或用滑鼠左鍵點擊它，把它設為目標，接著按 1，或點擊畫面底部動作列上的第一個圖示，揮出這一刀。一直打到三個散架為止。它們的還擊不痛不癢，這片海濱之外的東西下手可重得多。第三個倒下之後，走回我這兒來，按 F 交還任務、領取報酬：這世上每一件差事，都是這樣收尾的。",
        "completion": "三個倒下，你的手也穩多了。記住這種感覺，{playerName}：選定目標，揮出一刀，然後一直打下去。谷地的狼比稻草快，但同樣的算術也能放倒牠們。",
        "objectives": {
          "0": {
            "label": "擊倒訓練草人"
          }
      ...
      "q_ps_the_wreck_line": {
        "title": "沉船灘",
        "text": "潮水用海貨支付這座島：舊沉船上的漂流貨箱，被沖上練習場再往前的那片遠灘。從木靶那裡沿小路繼續走，它會一直把你領到水邊。開箱很簡單，{playerName}。走到貨箱跟前，直到它的名字顯示出來，然後按 F，或用滑鼠左鍵點擊貨箱本身，它就會把裡面的東西交出來。開三只就夠了。翻揀殘骸的掠蟹夾起人來比看上去疼，所以腳下留神；另外記住，你今後遇到的每一只箱子、每一處採集點、每一道門扉，用的都是同一個 F 鍵。",
        "completion": "繩子、焦油，還有半輪大海竟然放過的乳酪。世上到處都是值得彎腰去撿的東西，{playerName}。保持這個習慣：走近，按 F，拿走屬於你的東西。",
        "objectives": {
          "0": {
            "label": "開啟漂流貨箱"
          }
      ...
      "q_ps_pouch_and_purse": {
        "title": "錢囊與背袋",
        "text": "去谷地之前還有最後一課，{playerName}，也是保住冒險者性命的一課：你隨身帶的東西。你的背包有十六格，旁邊還空著四個袋扣；每繫上一只袋子，它的空間就併入總容量。所以：對著軍需官芬奇按 F，打開她的貨攤，在她的貨品裡用滑鼠左鍵點擊亞麻小袋買下它，然後按 B 打開背包，再用滑鼠左鍵點擊袋中的亞麻小袋，把它繫進一個空著的袋扣。等它掛上腰帶，就回來找我。",
        "completion": "好袋子，又多出六格用來裝麻煩。接下來是任何袋子都裝不下的另一半課，{playerName}：背不下的，交給鍍金保險箱。我身後桌前的司庫威克，為你打開的正是每座城鎮每位司庫共用的同一座金庫，等你的錢袋鼓起來，還能購買更多金庫空間。貴重的存進金庫，袋子留出空當。塞滿的行囊斷送過的冒險，比任何狼都多。",
        "objectives": {
          "0": {
            "label": "購買亞麻小袋"
          }
      ...
      "q_ps_set_sail": {
        "title": "揚帆起航",
        "text": "這片海濱上已經沒有你沒打倒過、沒打開過、沒買下過的東西了，{playerName}。你準備好了，而東溪谷有真正的差事在等著。沿路走到舊碼頭，對著渡船人奧多按 F，告訴他，就說是我說的，你掙到了這趟航程。什麼時候記不清自己欠了誰什麼，隨時按 L：那是你的任務日誌。",
