  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人布琳",
        "title": "港口嚮導",
        "greeting": "東溪谷來者不拒，朋友。而對腳下還不穩的人來說，總還有試煉之濱：西岸的渡船鈴一年到頭兩個方向都響。"
      },
      "instructor_maren": {
        "name": "教官瑪倫",
        "title": "試煉導師",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "錢囊與背袋",
        "text": "去谷地之前還有最後一課，{playerName}，也是保住冒險者性命的一課：你隨身帶的東西。你的背包有十六格，旁邊還空著四個袋扣；每繫上一只袋子，它的空間就併入總容量。去軍需官芬奇那裡買一只亞麻小袋繫上，然後把這一課帶去保險箱桌前的司庫威克那裡。他掌管的，是任何袋子都裝不下的另一半。",
        "completion": "瑪倫總算把她的學生送到我這兒來了。小袋歸你了，這一課的另一半在這裡，{playerName}：背不下的，交給鍍金保險箱。任何城鎮的任何司庫都為你打開同一座金庫，等你的錢袋鼓起來，還能購買更多金庫空間。貴重的存進金庫，袋子留出空當。塞滿的行囊斷送過的冒險，比任何狼都多。",
        "objectives": {
          "0": {
            "label": "購買亞麻小袋"
          }
