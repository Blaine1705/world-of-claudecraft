...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "coachNextBody": "跟著箭頭去找{npc}。走到跟前直到名字顯示出來，然後按 {interactKey}，或用滑鼠左鍵點擊對方，接下你的下一件差事。",
      "coachNextBodyTouch": "跟著箭頭去找{npc}。走到跟前直到名字顯示出來，然後點按對方，或點按使用按鈕，接下你的下一件差事。",
      "coachNextBodyPad": "跟著箭頭去找{npc}。走到跟前直到名字顯示出來，然後按下互動鍵，接下你的下一件差事。",
      "coachTaskBody": "跟著箭頭去完成差事。右側的追蹤欄隨時記著進度，迷了路就按 {mapKey} 打開地圖。",
      "coachTaskBodyTouch": "跟著箭頭去完成差事。右側的追蹤欄隨時記著進度，迷了路就點按地圖按鈕看路。",
      "coachTaskBodyPad": "跟著箭頭去完成差事。右側的追蹤欄隨時記著進度，迷了路就按下地圖按鈕看路。",
    ...
    "noticeboard": {
      "empty": "看起來沒有張貼任何內容。",
      "listingsBanner": "告示板上貼著 {count} 張告示。",
