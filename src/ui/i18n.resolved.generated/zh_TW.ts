...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "interfacePage": {
      ...
      "winTalentsBody": "你的天賦樹、你手上可以分配的點數，以及每一列在每個等階各有什麼效果。",
    ...
    "commandsPage": {
      ...
      "abilities": "你已學會的技能。",
      "talents": "你的專精，以及你的天賦點如何分配在職業樹與專精樹之間。",
    ...
    "riftsPage": {
      ...
      "floorsHeading": "一層層向下",
      "floorsBody": "一道裂隙有數層樓，每一層都是現場生成的，而通往下層的路要等這一層放你走才會開啟：清掉層上還活著的東西，解開它橫在你路上的一切封鎖，向下的通道便會撕裂開來。最後一層以一場首領戰作結。每一層都有自己的性格，因此單單一趟旅程就可能帶你從嚴霜走進餘燼，而每當你抵達新的一層，聊天視窗都會念出它的名字。你螢幕上的追蹤條，正是你得知這一道有幾層的地方。有些裂隙開啟的則是一座手工打造的場景，名為煉獄城塞，它有自己固定的長度，而非生成出來的下潛之路。",
      "boundHeading": "一旦見血",
