...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "taskLongWalkBody": "沿著海岸路往南走到往生石前，按 {interactKey} 跪下。這裡沒有任何東西能傷到你，這麼做也不會讓你損失什麼。",
      ...
      "taskShellBody": "掠蟹是會回擊的。用滑鼠左鍵點擊一隻，把牠設為目標，然後按 {attackKey} 揮刀，不停攻擊。要是一次有太多隻撲上來，就沿小路往回撤：牠們很快就會放棄追趕，休息時你的生命值也會慢慢回滿。",
      ...
      "taskShellBodyCaster": "掠蟹是會回擊的。用滑鼠左鍵點擊一隻，把牠設為目標，然後按 {attackKey} 施放法術，保持距離不停施放。要是一次有太多隻撲上來，就沿小路往回撤：牠們很快就會放棄追趕，休息時你的生命值也會慢慢回滿。",
