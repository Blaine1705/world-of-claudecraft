...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "notInstant": "$WOC 交易並非即時完成。賣家接受後物品進入託管，付款核實後送達買家。",
        ...
        "hintAcceptLocked": "該物品已鎖定。出售前請先在背包中解鎖。",
        ...
        "closeSellerHold": "你的物品仍為買家的付款保留中。如果改變主意，可在交易所的活動頁籤取消出售。",
        "closePaymentContinuesBuyer": "你的付款仍在確認中。配送會自行完成。",
        "closePaymentContinuesSeller": "買家的付款仍在確認中。出售會自行完成。",
        "p2pBindingNote": "雙方接受後，須在 {duration} 內付款。未付款會記一次市場違約。",
        "p2pBindingNoteUntimed": "雙方接受後，須在短時間內付款。未付款會記一次市場違約。",
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC 價格恢復期間交易暫停。拍賣倒數照常進行；新的出價和付款需等價格恢復健康後再進行，已送出的付款仍會照常結算。",
      "walletBanner": "綁定並驗證錢包後即可在交易所出價、購買或出售。",
      "rateNote": "目前匯率：約每美元 {tokens} $WOC，取自外部交易市場最新成交價（{time}）。",
      "estimateNote": "按目前匯率約 {tokens} $WOC。最終數額在請求付款時才會確定。",
      ...
      "bidBondNote": "出價時會凍結 {usd} 的可退還保證金（以 $WOC 支付）。被超越時退還（除非二次機會轉讓讓你成為買家）；只有當你得標卻未付款時才會被沒收。",
      "bidBindingNote": "一旦簽署保證金交易，出價即具有約束力：出價無法撤回；若你得標卻未付款，保證金將被沒收，且你的帳號會記一次市場違約。",
      "bidCloseNote": "在拍賣臨近結束的幾分鐘內保證金獲得確認的出價，可能使拍賣延長幾分鐘。拍賣結束後，遲到的付款不會重新開啟拍賣，而是會被退款。",
      "offerNextNote": "若得標者未付款，你可能按自己的出價成為買家：保證金會再次被凍結，且須在結算期限內付款。屆時未付款將沒收保證金並記一次違約。",
      "buyNowNote": "「立即購買」會為你短暫保留這份掛單。若未付款就離開，你的「立即購買」會暫停一段時間。",
      ...
      "sellOfferNext": "若得標者未付款，將物品轉售給下一位出價者。",
      "sellSubmit": "上架物品",
      "sellSubmitAria": "將 {item} 上架到交易所",
      "sellFeeNote": "成交後收取約 10% 手續費：3% 銷毀、7% 進入國庫，兩項均向上取整，你收到扣除後的確切餘額（約 90%）。收益隨結算交易直接進入你綁定的錢包。",
      "activityListings": "我的掛單",
      "activityBids": "我的出價",
      "activitySettlements": "我的結算",
      "activityEmpty": "暫無紀錄。出價、掛單和結算會顯示在這裡。",
      "activityPayNow": "立即付款",
      "activityPayNowAria": "立即支付結算 {id}",
      "activityDeadline": "付款截止：{duration} 內",
      "activityStrikes": "交易所警告次數：{count}",
      "activitySuspended": "因未付款結算，競標資格暫停 {duration}。",
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "suspended": "因未支付結算款項，你的交易所競標資格已被暫停。",
