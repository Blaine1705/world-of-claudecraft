  ...
  "hudChrome": {
    ...
    "raidBossGuide": {
      ...
      "ignivar": {
        ...
        "apocalypse": "末日: 在終焉之心完成20秒施法前將其擊殺。",
        "judgment": "熔爐審判: 預警時記住不同的庇護點，地面燃燒後在標記邊界內集合。",
        "finale": "最終煉獄: 生命值低於20%後，在45秒內擊殺伊格尼瓦爾，同時應對加速的隕石、正面攻擊與旋轉煉獄。",
        "heroic": "英雄: 熔爐鎖鏈期間成對玩家必須保持靠近；審判期間印記也會懲罰附近玩家。"
      },
      "varkhul": {
        "tanks": "坦克: 製作者印記達到2層時換坦，並讓瓦爾庫爾保持在近戰範圍內。",
        "orbs": "燼火寶珠: 被標記者分散到房間邊緣。火池會持續整場戰鬥，釋放的寶珠會穿過房間。",
        "pyre": "共享柴堆: 只選擇沒有熾熱金屬的玩家。在移動圓圈內，普通需要4人，英雄需要5人。",
        "ray": "淬火射線: 另一名玩家站在瓦爾庫爾與目標之間攔截。承受傷害者會獲得持續30秒的傷口。",
        "forge": "熔爐柱: 在射線抵達熔爐前阻擋。暴露疊加後輪換阻擋者；熱量達到100%時熔爐會崩毀。",
        "adds": "組裝階段: 擊殺每波傳送門敵人並打斷坩堝震擊。在重新校準治療瓦爾庫爾前控制或減速燼火工匠。",
        "heroic": "英雄: 擊殺太慢會使波次重疊，熔爐熱量不會下降，共享柴堆需要5人，20%起世界之火會封鎖房間。"
      }
    },
    "auraEffect": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ignivar_echoes_in_iron": {
        "title": "鐵中回響",
        "text": "這些自動機械不是士兵，而是草稿。當末泉在瓦爾庫爾身邊衰竭時，他一具又一具地淬鍊外殼。閱讀三份記錄，並摧毀守衛它們的構造體。每一具失敗的軀殼都可能藏著部分答案。",
        "completion": "記錄彼此吻合。瓦爾庫爾將垂死末泉的水束縛進活體金屬。這些自動機械是他失敗的淬鍊品，只有一種設計撐了下來。",
        "objectives": {
          "0": {
            "label": "閱讀「首次淬鍊」記錄"
          },
      ...
      "q_ignivar_heralds_heart": {
        "title": "先驅之心",
        "text": "每份記錄都提到了唯一的幸存者——伊格尼瓦爾。瓦爾庫爾稱他為先驅、封印和鑰匙。擊敗伊格尼瓦爾，然後檢查留下的核心。它應該能告訴我們，先驅原本要守護什麼。",
        "completion": "伊格尼瓦爾從來不只是守護者。他的心臟是一把鑰匙，最後的甲片指向下方封閉的熔爐。",
        "objectives": {
          "0": {
            "label": "擊敗伊格尼瓦爾"
          },
