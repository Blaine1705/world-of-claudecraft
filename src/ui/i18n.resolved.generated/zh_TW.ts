...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "在這片土地上，初次踏上冒險之路的人照傳統都會去試煉之濱走一趟，那是海峽對面的一座安靜小島。在那裡你可以先磨練身手、熟悉這個世界，再去迎接它的挑戰。渡船來回都通，去或不去都沒人會小看你。",
      ...
      "islandArrivalNote": "剛下渡船嗎？歡迎來到試煉之濱。教官瑪倫在我身後這條路盡頭的晨憩營地主持操練：走到她跟前，直到她的名字顯示出來，然後按 F，或用滑鼠左鍵點擊她，就能與她交談，她會交給你第一件差事。等你準備離開時，敲響立在我碼頭旁的那口鈴，渡航就會送你回東溪鎮。",
      "noteClose": "明白了"
    },
    "tutorial": {
    ...
    "bootcamp": {
      "title": "最初的腳步",
      "moveTitle": "活動雙腿",
      "moveBody": "用 {moveKeys} 朝任意方向走上幾步。",
      "moveBodyTouch": "拖動螢幕下方的移動搖桿，朝任意方向走上幾步。",
      "moveBodyPad": "推動左搖桿，朝任意方向走上幾步。",
      "cameraTitle": "轉動視角",
      "cameraBody": "按住滑鼠右鍵並拖動來轉動視角。往左右兩邊好好看一圈。",
      "cameraBodyTouch": "用手指拖動世界畫面（不是移動搖桿）來轉動視角。",
      "cameraBodyPad": "推動右搖桿來轉動視角。",
      "courseTitle": "跑過試煉跑道",
      "courseBody": "現在把兩樣合起來：沿碼頭以南海灘上的旗列跑一趟。用 {jumpKey} 躍過欄杆，爬過木箱，依次碰到每一面旗，直到紅旗為止。",
      "courseBodyTouch": "現在把兩樣合起來：沿碼頭以南海灘上的旗列跑一趟。用跳躍按鈕躍過欄杆，爬過木箱，依次碰到每一面旗，直到紅旗為止。",
      "courseBodyPad": "現在把兩樣合起來：沿碼頭以南海灘上的旗列跑一趟。用跳躍按鈕躍過欄杆，爬過木箱，依次碰到每一面旗，直到紅旗為止。",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "ferryman_odo": {
        "name": "渡船人奧多",
        "title": "渡口看守",
        "greeting": "剛下渡船嗎，{playerName}？那就沿著岸邊的路往上走：教官瑪倫在晨憩營地主持操練。走到她跟前，按 F，或用滑鼠左鍵點擊她，她就會交給你第一件差事。等谷地召喚你回去時，敲響立在我碼頭旁的那口鈴，渡航會把你送到東溪鎮上。"
      },
      "bursar_wick": {
        "name": "司庫威克",
        "title": "鍍金保險箱",
