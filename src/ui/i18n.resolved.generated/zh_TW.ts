...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "doneTitle": "跑完全程",
      "doneBody": "腿上的功夫就這些了。走回大門處的看守塔姆那裡交差：他有話要對你說，還有你的第一份報酬。"
    },
    "widgets": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_the_gauntlet": {
        "title": "跑過試煉跑道",
        "text": "谷地敬重的每一雙腿，都是先從這幾條跑道跑出來的，{playerName}。沿第一條跑道向西走到旗幟處，好好環顧四周，再沿南邊的跑道向左滑步走到第二面旗，再看一圈，最後沿末尾的跑道跑到紅旗處。旗幟要按順序經過；螢幕上方的卡片會隨時告訴你該按哪個鍵。等紅旗被你甩在身後，回到大門處找我。",
        "completion": "跑得乾淨俐落，{playerName}。你的雙腿已經記住了跑道，剩下的就該幹真正的活了：教官瑪倫在碼頭北邊沿路而上的晨憩營地主持操練。走到她跟前，直到她的名字顯示出來，然後按 F，或用滑鼠左鍵點擊她，她會交給你第一件差事。",
        "objectives": {
          "0": {
            "label": "經過試煉跑道旗幟"
          }
