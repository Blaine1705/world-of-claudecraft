...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC 價格恢復期間交易暫停。拍賣倒數照常進行；價格恢復健康之前不會有任何成交。",
      "walletBanner": "綁定並驗證錢包後即可在交易所出價、購買或出售。",
      "rateNote": "目前匯率：約每美元 {tokens} $WOC（{time} 更新）。",
      ...
      "confirming": "正在鏈上確認...",
      "bidBondConfirming": "保證金已支付。正在網路上確認；確認完成後你的出價即生效。",
      ...
      "sellFeeNote": "成交後收取 10% 手續費：90% 歸你，3% 銷毀，7% 進入國庫。收益隨結算交易直接進入你綁定的錢包。",
