...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "剛下渡船嗎？歡迎來到試煉之濱。用 W、A、S、D 走路，按住滑鼠右鍵轉動視角。教官瑪倫在我身後這條路盡頭的晨憩營地主持操練：走到她跟前，直到她的名字顯示出來，然後按 F，或用滑鼠左鍵點擊她，就能與她交談，她會交給你第一件差事。等你準備離開時，敲響立在我碼頭旁的那口鈴，渡航就會送你回東溪鎮。",
      "noteClose": "明白了"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "擊中要害",
        "text": "歡迎來到試煉之濱，{playerName}。這裡的每一課都從同一件事開始：站穩腳，握好刃。營地西南練武場上的草人生來就是挨打的。要是找不到練武場，按 M 打開地圖：你身上的每件差事都會標在上面，用不著亂繞。走到一個草人跟前，按 Tab 或用滑鼠左鍵點擊它，把它設為目標，接著按 1，或點擊畫面底部動作列上的第一個圖示，揮出這一刀。一直打到三個散架為止。它們的還擊不痛不癢。這片海濱之外的東西下手可重得多。",
      ...
      "q_ps_the_wreck_line": {
        "title": "沉船灘",
        "text": "潮水用海貨支付這座島：舊沉船上的漂流貨箱，被沖上營地東南、面向谷地的那片海灘。開箱很簡單，{playerName}。走到貨箱跟前，直到它的名字顯示出來，然後按 F，或用滑鼠左鍵點擊貨箱本身，它就會把裡面的東西交出來。開三只就夠了。翻揀殘骸的掠蟹夾起人來比看上去疼，所以腳下留神；另外記住，你今後遇到的每一只箱子、每一處採集點、每一道門扉，用的都是同一個 F 鍵。",
