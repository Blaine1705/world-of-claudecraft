  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人布琳",
        "title": "港口嚮導",
        "greeting": "東溪谷來者不拒，朋友。而對腳下還不穩的人來說，總還有試煉之濱：東岸的渡送法陣一年到頭雙向通行。"
      },
      "instructor_maren": {
        "name": "教官瑪倫",
        "title": "試煉導師",
      ...
      "quartermaster_finch": {
        "name": "軍需官芬奇",
        "title": "營地補給商",
        "greeting": "麵包、清水，還有一瓶練過頭時救急的藥劑。銅板能買下它們，而銅板要靠幹活掙來。這就是全部的經濟學，{playerName}，它永遠不會變得更複雜。只會變得更大。"
      },
      "ferryman_odo": {
        "name": "渡船人奧多",
        "title": "渡口看守",
    ...
    "quests": {
      ...
      "q_ps_find_your_feet": {
        "title": "站穩腳跟",
        "text": "歡迎來到試煉之濱，{playerName}。這座島上沒有什麼東西會主動咬人，所以趁著安靜：在營地裡走走，認認這裡的面孔。軍需官芬奇管著補給，渡船人奧多守著回家的路。去拜訪他們倆，然後回來找我。",
        "completion": "腳步俐落，水壺還沒燒開你就回來了。現在你熟悉了營地，{playerName}，也就知道真有東西咬人的時候該往哪兒跑了。",
        "objectives": {
          "0": {
            "label": "拜訪軍需官芬奇"
          },
      ...
      "q_ps_strike_true": {
        "title": "擊中要害",
        "text": "從沒揮過的劍不過是根沉棍子，{playerName}。營地以南練武場上的草人生來就是挨打的：挑一個，站穩，砍到三個散架為止。它們不會還手。這片海濱之外的東西可會。",
      ...
      "q_ps_tools_of_the_trade": {
        "title": "謀生之道",
        "text": "銅板就是拿來花的，{playerName}，而我這攤子童叟無欺。從我這兒買一瓶治療藥劑，我會退給你比價錢更多的錢，就當學費：找到商販，掂量價錢，數清找零。等你到了谷地，把剩下的錢花在那裡商人的採集工具上。古往今來鑄出的每一筆財富，都是從這麼小的一步開始的。",
        "completion": "一瓶藥劑，錢貨兩訖，退款如約奉上：這樣的好買賣你以後可不常見。留著它以備不時之需，{playerName}，也記住谷地的商人向任何拿著正當銅板的人出售礦鎬、斧子和鐮刀。",
        "objectives": {
          "0": {
            "label": "購買初級治療藥水"
          }
