...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "battleStance": "戰鬥姿態：怒氣生成提高 10%",
      "berserkerStance": "狂暴姿態：爆擊機率提高 3%，爆擊傷害提高 3%",
  ...
  "entities": {
    "abilities": {
      ...
      "chain_heal": {
        "name": "治療鏈",
        "description": "治療目標 {damage}，隨後躍向至多 2 名附近的盟友，每次跳躍的治療量減半。"
      },
      "heroic_strike": {
        "name": "劫掠打擊",
      ...
      "bloodrage": {
        "name": "血之代價",
        "description": "以生命值為代價產生 {rage} 點怒氣。"
      },
      "overpower": {
        "name": "血手",
      ...
      "defensive_stance": {
        "name": "戒備姿態",
        "description": "防禦戰鬥姿態：你產生的威脅值提高 30%，但造成和受到的傷害降低 10%。施放戰鬥姿態可回到進攻狀態。"
      },
      "battle_stance": {
        "name": "戰鬥姿態",
        "description": "具有攻擊性的戰鬥姿態：你的怒氣生成提高 10%。這是武器和防護的預設姿態。"
      },
      "berserker_stance": {
        "name": "狂暴姿態",
        "description": "魯莽的戰鬥姿態：你的爆擊機率提高 3%，爆擊傷害提高 3%。狂怒戰士始終以這種姿態戰鬥。"
      },
      "sunder_armor": {
        "name": "削甲",
      ...
      "enrage_passive": {
        "name": "狂怒",
        "description": "被動：處於狂怒時，你造成的傷害提高11%，攻擊速度提高25%，移動速度提高10%，持續4秒。嗜血有30%機率觸發，浴血則必定觸發。（狂怒）"
      },
      "bloodthirst": {
        "name": "放血",
      ...
      "raging_gale": {
        "name": "雙斬",
        "description": "立即用武器連續攻擊兩次，每次造成 60% 武器傷害外加 {damage} 點傷害，並產生 {rage} 點怒氣。最多儲存 2 次使用次數。（狂怒）"
      },
      "red_harvest": {
        "name": "血色收割",
      ...
      "storm_bolt": {
        "name": "風暴之錘",
        "description": "將武器擲向目標，造成 {damage}，並使其昏迷 3 秒。"
      },
      "piercing_howl": {
        "name": "刺耳怒吼",
        "description": "發出刺耳的吼聲，使 15 碼內所有敵人減速 50%，持續 8 秒。"
      },
      "die_by_sword": {
        "name": "劍在人在",
      ...
      "recklessness": {
        "name": "魯莽",
        "description": "激怒：怒氣獲取提高 50%，爆擊機率提高 20%，持續 12 秒。"
      },
      "avatar": {
        "name": "天神下凡",
        "description": "變身為巨像，持續 20 秒，解除自身所有控制效果，造成的傷害提高 20%。"
      },
      "sanguine_aura": {
        "name": "血色光環",
        "description": "以敵人之血浸染你的武器：你和近戰盟友獲得 10% 攻擊速度和 10% 傷害加成，持續 20 秒。"
      },
      "victory_rush": {
        "name": "乘勝追擊",
        "description": "發動打擊，造成武器傷害加 {damage}，並為你恢復最大生命值的 20%。只能在擊殺敵人後 20 秒內使用。"
      },
      "bladestorm": {
        "name": "劍刃風暴",
        "description": "化身鋼鐵旋風，每秒對 8 碼內所有敵人造成 {damage}，持續 4 秒。"
      },
      "intimidating_shout": {
        "name": "破膽怒吼",
        "description": "發出駭人的怒吼，使 8 碼內最多 5 名敵人驚懼逃竄 8 秒。受到傷害可能打破該效果。"
      },
      "pummel": {
        "name": "拳擊",
        "description": "打斷施法，並使該系法術在 4 秒內無法施放。成功打斷施法時產生 10 點怒氣。"
      },
      "heroic_leap": {
        "name": "英勇飛躍",
        "description": "躍向目標區域，對附近敵人造成 {damage} 點傷害。"
      },
      "rallying_cry": {
        "name": "集結吶喊",
        "description": "發出集結吶喊，使你和 40 碼內的隊伍成員獲得 20% 的額外最大生命值，持續 10 秒。"
      },
      "summon_imp": {
        "name": "召喚燼裔",
