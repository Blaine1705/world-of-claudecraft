...
export const tr_TR: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsNote": "Her düğüm, kademe 1 dahil, o mesleğin aletinin çantanda olmasını ister: kazma yoksa cevher de yok, olta kamışı yoksa balık da yok. Satıcı merdiveni kademe 1'den 3'e kadar uzanır ve her bölge merkezi yalnızca kendi arazisinin kullandığı kademeleri bulundurur: kademe 1 aleti her bölge merkezinde satılır, üstündeki basamaklar ise onları gerektiren damarların bulunduğu yerde satılır. O basamaklar için satıcılar ayrıca aletin kendi mesleğinde yeterlilik ister, kademe 2 için {tier2Prof}, kademe 3 için {tier3Prof}; bu koşul ilgili satırda belirtilir. Bir aletin yalnızca çantanda olması yeterlidir, ekipman yuvası veya dayanıklılık yoktur; bu nedenle her biri tek seferlik bir satın alımdır ve halihazırda sahip olduğun her şey çalışmaya devam eder. Geçiş için yalnızca kademe önemlidir: aletin nadirlik rengi kozmetiktir.\n\nSatıcı merdiveninin üzerinde, kademe 4 ve kademe 5 olmak üzere iki üretilmiş alet vardır; bunlar mühendisler tarafından alet atölyesinde yapılır ve hiçbir NPC tarafından satılmaz. Bugün hiçbir düğüm kademe 3'ten fazlasını gerektirmez; bu nedenle şu anki değerleri hızdır: üst düzey bir alet, daha düşük kademeli düğümlerde toplama süresini tabanına sabitler ve daha yüksek kademeli arazi geldiğinde giriş bileti olacak.",
