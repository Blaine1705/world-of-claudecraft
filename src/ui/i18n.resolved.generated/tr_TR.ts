...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Eylem çubuğu tuşlarını düzenleyin",
      "editKeysHint": "Eylem çubuğunda bir yuvayı tıklayın, ardından onu bağlamak için bir tuşa basın.",
      "bannerHint": "Bir yuvayı tıklayın ve ardından bağlamak için bir tuşa basın. Bitirdiğinizde Bitti'yi tıklayın.",
      "bannerCapturing": "Bu yuvayı bağlamak için bir tuşa basın...",
      "boundToKey": "{key}'a bağlı.",
      "reset": "Sıfırla",
      "done": "Tamamlamak",
      "cancel": "İptal etmek",
      "resetConfirmTitle": "Eylem çubuğu tuşları sıfırlansın mı?",
      "resetConfirmBody": "İlk çubuk varsayılan tuşlarına döner. İkinci ve üçüncü çubuklar bağlanmaz. Bu geri alınamaz."
    },
    "mounts": {
      "title": "Binekler",
      "close": "Kapat",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "1v1 ve 2v2 braketlerinde her dövüşçü Çok Yönlü formayı oynar. 3v3 veya daha fazlasını gerektiren işler burada kazanılamaz.",
      "role": {
        "allrounder": {
          "name": "Çok Yönlü",
      ...
      "practiceUnratedNote": "Alıştırma maçları derecelendirilmez: sıralamalar ve Tapu Kitabı ilerlemesi sayılmaz.",
      ...
      "briefing": {
        ...
        "unratedNote": "Botlar sahada olduğundan bu maç derecelendirilmiyor: sıralamalar değişmiyor ve goller, kurtarışlar ve gol yememeler sayılmıyor.",
        "practiceUnratedNote": "Bu bir antrenman maçı olduğundan derecelendirilmez: sıralamalar değişmez ve Tapu Kitabı ilerlemesi sayılmaz.",
    ...
    "materialHint": {
      "fineGrade": "İyi derece. Malzemenin üstünde bir aletle tam katmanlı bir damardan toplanır ve ihtiyaç duyulan her yerde sıradan versiyon olarak sayılır.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Bu sularda balık tutmak için {tier} seviyeli bir oltaya ihtiyacınız var."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Zaten çantanızda bulunan seçimi sallamak için Madencilik {skill}'ye ihtiyacınız var.",
        "logging": "Zaten çantanızda bulunan baltayı sallamak için Günlüğe Kaydetmeye {skill} ihtiyacınız var.",
        "herbalism": "Zaten çantanızda bulunan orağı çalıştırmak için Herbalism {skill}'e ihtiyacınız var."
      },
      "wieldUnmetCorpse": "En iyi aletinizi işe koymak için {skill} toplama becerisine ihtiyacınız var.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "{tier} kademesine kadar olan sularda balık tutmak için gereklidir."
        },
        "use": {
      ...
      "emptyHookNote": "Kancada hiçbir şey yok",
      "stateReady": "Hazır",
      "stateCooldown": "Yeniden Oluşuyor",
      "stateCooldownTimed": "{time}'da yeniden doğar",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Takımınız bu verimi hassas bir seviyeye kadar hassaslaştırır."
    },
    "archetypeTitle": {
      "label": "Unvan",
      "none": "Yok",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} / {max} ödeme",
      "toolEffectSpent": "Harcandı, yeniden şarj edilmesi gerekiyor",
      "toolEffectDepleted": "Harcanan araç efekti",
      ...
      "toolEffectConfirmBody": "Bu hasat için bir ücret harcansın mı? Bonus olmadan düşüş hala devam ediyor. Kalan ücretler: {charges}.",
      "toolEffectConfirmAccept": "Bir Ücret Kullan",
      "toolEffectConfirmDecline": "Olmadan Topla",
      "toolEffectName": {
        "gatherersCache": "Toplayıcı Önbelleği",
        "artisansEye": "Zanaatkarın Gözü",
        "quickeningCharm": "Geri Yaylanma Cazibesi"
      },
      "toolEffectSlotButton": "Yuva {effect}",
      "toolEffectRechargeButton": "Yeniden şarj et",
      "toolEffectSlotted": "{effect}, {profession}'ye yerleştirildi.",
      "toolEffectSlotInvalid": "{effect} oraya yerleştirilemez.",
      "toolEffectNoTool": "Öncelikle gerçek bir {profession} aracına ihtiyacınız var.",
      "toolEffectNoCharm": "Çantalarınızda el yapımı bir {effect} charmına ihtiyacınız var.",
      "toolEffectNoGain": "{effect} zaten yuvaya yerleştirilmiş ve tamamen şarj edilmiş durumda.",
      "toolEffectRecharged": "{effect} şarj edildi: {material} x{count} tüketildi.",
      "toolEffectRechargeNoSlot": "{profession} üzerinde herhangi bir efekt yerleştirilmemiştir.",
      "toolEffectRechargeFull": "{effect} zaten tamamen şarj oldu.",
      "toolEffectRechargeToolCapped": "{effect}'yi daha fazla şarj etmek için daha iyi bir {profession} aleti taşıyın.",
      "toolEffectRechargeMaterials": "{effect}'nin şarj edilmesi için {material} x{count} gerekiyor.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "({count} iyi dereceli harcar)",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Tapu kilitlerini lonca arkadaşları ve takipçilerle, tapu ve şaheser kartlarını ise Discord akışıyla paylaşın",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "Bildiri müebbet hapis cezası da değildir. Daha önce hiç tutmadığınız bir çift, yalnızca yeni bir uyum arayışıdır; uzaklaştığınız bir çifte geri döndüğünüzde ise öncelikle düzeltmeler yapmanız istenir: ilk seferde beş görev ve daha önce yaptığınız her dönüş için üç görev daha eklenir (yepyeni bir çift almak hiçbir zaman sayıyı artırmaz). Seçim, hiçbir kapıyı tamamen kilitlemeden anlamlı kalır.",
      "whatHeading": "Kılıcın yanında bir meslek",
      "whatBody": "Meslekler dünyanın çalışma hayatıdır: Hammaddeyi doğrudan topraktan çeken dört toplama işi ve onu teçhizata, yemeğe, iksirlere ve aletlere dönüştüren on zanaattan oluşan bir halka. Burada her şey başka bir şeyi besliyor. Çıkardığınız cevher bir bıçağa dönüşür, bıçak bir büyüyü alır ve büyücünün eski teçhizattan kırılmış toza ihtiyacı vardır; dolayısıyla bir toplayıcı, bir zanaatkar ve bir tamircinin hepsi tek bir zincirin halkalarıdır.\n\nAcı çekecek bir meslek sınırı yok. Her karakter, günümüzde içeriği olan sekiz zanaattan yedisini ve dört mesleğin tamamını yan yana yükseltebilir (Mühendislik tek engeldir: tariflerinin tümü serbest tavanın üstünden başlar, bu nedenle merdiveni Bombardier'in yeminini bekler); tek ayrıcalıklı seçim arketipinizdir, sonunda yemin edeceğiniz kimliğinizdir, ancak arkasında hareketsiz kalan zanaatlara uyum sağladığınızda yalnızca ortak tariflere göre tırmanır ve 75. beceriyi geçmezsiniz. Beceri asla azalmaz ve öğrendiğiniz hiçbir şey elinizden alınmaz.",
      ...
      "archetypesBody": "On zanaat sabit bir çarkın üzerinde duruyor ve bu çarkın üzerindeki coğrafya önemli. Her iki komşu bir isim çifti oluşturur: Silah Üretimi ve Zırh Üretimi için Smith, Deri İşleme ve Terzilik için Donatıcı, Simya ve Aşçılık için Eczacı, Mühendislik ve Simya için Bombardier ve ringin etrafında altı kişi daha.\n\nBir çifte uyum sağlamak bir menü tıklaması değil, bir arayıştır. Bugün dört çift birleştirilebilir (Smith, Outfitter, Apothecary ve Bombardier), her biri Eastbrook'ta yerleşik bir usta tarafından demirlenir ve bu ustanın kabul arayışı, siz daha almadan önce tüm pazarlığı önceden belirtir. Siz beyan edene kadar, her zanaat, nadir aşamaya (74 veya daha az beceri gerektiren herhangi bir tarif) kadar tariflerde serbestçe ilerler, böylece seçmeden önce hemen hemen her şeyi deneyebilirsiniz (Mühendisliğin tek başına bu kadar düşük bir tarifi yoktur, bu nedenle sayısı bekler).\n\nBir kez uyum sağladığınızda, iki çift zanaatınız ana dalınız haline gelir ve tavanın kapağın altında kalması gerekmez. Çarkın geri kalanı kararmaz: ana dallarınızın karşısındaki bir zanaat, nadir kademede tırmanmaya devam eden bir hobi olarak açık kalır (Smith Haldren'in demirhanesinde tekrarlanabilir bir görev, hangisinin değiştirilebilmesini sağlar) ve diğer tüm zanaatlar hareketsiz kalır. Uyuyan bir zanaat, 75'te grileşene kadar normal eğri üzerinde öğretmeye devam eden becerisini ve ortak tariflerini korur; ortak olanın üstünde olan her şey bir anda ödeme yapmayı bırakır ve hareketsiz bir zanaat, dinlenirken asla bir şaheser haline gelmez.",
      "pairFmt": "{a} ve {b}",
      ...
      "startBody": "Eastbrook'ta yola yeni mi çıktınız? Foreman Odell'i bulun ve Her El İçin Bir Ticaret Yapın: sizi şehrin güneydoğusundaki Bakır Kazısı çevresindeki cevher damarlarına yönlendirecek ve size ilk nasırlarınızı verecektir. Kazmaya dikkat edin: Üzerinde kamp kuran Deeprock Diggers, yeni gelenlerden birkaç seviye yukarıda duruyor, bu yüzden önce uzaktaki damarları çalışın ve kampın kalbini biraz seviye atladığınız zamana saklayın. O andan itibaren, arayış sırasında geçtiğiniz her damarı, keresteyi ve bitki parçasını hasat edin; Yeterlilik gezginlere doğal olarak gelir.\n\nKasabaya döndüğünüzde, üretim penceresini açmak ve her karakterin en başından beri bildiği ortak tarifleri uygulamak için T tuşuna basın. Ne öğrettiklerini görmek için demirhanedeki, mutfaklardaki, tezgahlardaki ve alet işlerindeki ustaları ziyaret edin ve sabit para karşılığında iş emirlerini alın. Loncanın mektubu size ulaştığında, hangi çiftin kendinizi evinizde gibi hissettiğini zaten bileceksiniz.",
      "colStation": "İstasyon",
      "colHub": "Merkez",
      "colMaster": "Usta",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Mühendislik, her ciddi toplayıcının sonunda ihtiyaç duyacağı araçları üretir: hiçbir tezgahın para karşılığında satamayacağı 4. ve 5. aşama kazmalar, baltalar, oraklar ve oltalar; her biri altındaki aleti tüketir.",
        "enchanting": "Enchanting, teçhizatı parçalara ayırır ve gücü geri verir: İstenmeyen parçaları gizemli malzemelere bölün, ardından bunları, saklamayı düşündüğünüz bir parça için kalıcı bir istatistik bonusu için harcayın. Kırıcı ve büyüleyici olmanın herhangi bir istasyona veya eğitmene ihtiyacı yoktur ve herkes ilk günden başlayabilir; yalnızca alet atölyesinde öğretilen iki çekicilik tarifi daha fazlasını ister."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "Madencilik omurgadır. Bakır cevheri Eastbrook Vale'in 1. kademe damarlarından, demir cevheri Mirefen Bataklığı'ndan ve osmiyum cevheri Thornpeak Heights'tan çıkıyor ve merdivenin her basamağı aynı şekilde çıkıyor. Ağaç kesimi beklediğinizden daha önemlidir: demir kabuğu domuz mızrağını saplar, dişbudak ağacı tokmağı omuzlar ve tek bir yüksek çam kütüğü savaş asasını oluşturur.\n\nGerisi avdan ve tezgahtan gelir. Kavramalar için kaba deri doğrudan kurt ve yaban domuzu cesetlerinden toplanır, huzursuz ölülerden veya kurtarılan sıradan teçhizattan kemik parçaları çıkar ve demirci merdiveni Darva'nın kendisinden kavanoz başına 20 bakır olan Smithing Flux'u yakar. Eğer kendi madenciliğiniz geride kalırsa, hiçbir sayaç sizi cevherin kendisinden kurtaramaz: Osmiyum Thornpeak damarlarından, Farshore (damarları demir kazıyan) dışındaki her genç bölgenin başlangıç ​​damarlarından veya başka bir oyuncunun yığınından ticaret yoluyla veya Dünya Pazarından gelir. Yalnızca Glyphsteel Bar, alet atölyesindeki Tinker Gizzel'den veya Highwatch'taki Malzeme Sorumlusu Bree'den jeton karşılığında satın alınır.",
          ...
          "routeBody": "Bu merdivende demir basamak ve yukarısı anlamına gelen gerçek bir stat çizgisine sahip herhangi bir parça, daha iyi kalite seviyenizin tavanına uyduğu sürece örsten bir şaheser olarak çıkabilir; statüsüz bakır ortak alanları hiçbir zaman tetiklenmez çünkü bunların iyileştirilecek hiçbir yanı yoktur. Demir ve osmiyum şaheserlik bonusu için 1. kademe malzemeler olarak sayılır, yüksek çam ve glif çeliği 2. kademe olarak sayılır ve bir tarifin kendi kademesinin üzerinde yer alan beceri, kademe başına kendi puanını ekler; dolayısıyla osmiyum üçlüsü arasında maddi üstünlüğü taşıyan şey savaş baltası ve savaş asası olur ve bir basamak siz onu aştıktan sonra daha iyi ilerlemeye devam eder.\n\nBakır basamağı 25'e kadar sürün, demir basamağı açıldığı gün 50'ye, ardından osmiyum basamağı 75'e sürün. 75'i geçtikten sonra henüz daha yüksek bir şey yok, bu nedenle osmiyum tarifleri yarıya iner ve ardından kazancı dörtte bir oranında artırır: 125 sınırına ulaşmak için kabaca 150 zanaat daha bütçeleyin ve toplu iş yapmaya oturduğunuzda dakikada on zanaat eyleminin paylaşılan kısılmasını hatırlayın.\n\nİlerledikçe tırmanışı finanse edin: Darva'nın demirhane iş emri, her 30 dakikada bir, biraz para ve XP karşılığında sekiz bakır cevherini elinizden alır ve demir ve osmiyum basamakları, yakın dövüşü dengelemek için dürüstçe satılır. Book of Deeds, Edge and Temper'ı 50. beceriyle işaretliyor ve Büyük Usta Silah İşçiliği'ni 125. beceriyle taçlandırıyor."
        },
        "armorcrafting": {
          "identityHeading": "Ön cephe için zırh",
          "identityBody": "Zırh işçiliği merdiveni bir askerin kariyerine benziyor: başlangıç ​​için sade perçinli bakır kuşak, sabatonlar ve eldivenler, ilk gerçek istatistik çizgileriyle demir bağlantılı zırh, bacak korumaları ve kürekler ve bir zanaatkar sanatının en tepesinde yer alan nadir osmiyum ölçekli büyük miğfer, zırh ve tozluklar, Güç ve Dayanıklılık parçaları.\n\nDaha sessiz bir tarafı da var: Büyücü tarafından belirlenen bir alan olan Eastbrook Warded Tayt ve 75. beceride nadir bir Intellect ve Spirit posta omuzu olan Kilnscale Mantle, büyü meraklısı posta kullanıcılarını müşteri listesinde tutuyor. Halkada Silah Üretimi ile Mühendislik arasında yer alır; Weaponcrafting'li Smith çifti, Forgemistress Darva'nın önünde yemin ederken, Engineering'li Gearwright çiftinin adı belli ancak henüz bir yemin görevi yok.",
          "materialsHeading": "Çuval dolusu cevher",
          "materialsBody": "Hiçbir zanaat cevheri bu kadar hızlı yemez. Demir bağlantılı zırh tek başına beş demir cevheri alır ve osmiyum ölçekli her parça üç veya dört osmiyum artı bir glifçelik çubuk ister, bu nedenle ciddi bir zırh ustası Mirefen Bataklığı ve Thornpeak Tepeleri'ni çıkarır veya bunu yapan birine para öder. Bakır, Copper Dig'in damarlarından doğrudan ilk basamağı besler.\n\nMetalin etrafında yumuşak parçalar bulunur: kurt ve yaban domuzu cesetlerinden toplanan kaba deriler, huzursuz ölülerden kemik parçaları (veya sıradan teçhizattan kurtarılmış) ve neredeyse her tarifte Smithing Flux kavanozları (dövme ocağında her biri 20 bakır). Hiçbir sayaç osmiyum satmaz: sabırsızlar onu diğer oyunculardan satın alır veya Thornpeak'te veya on bir genç bölgenin onunun başlangıç ​​​​damarlarında (yalnızca Farshore demir kazar) kendileri çıkarır.",
          "ladderHeading": "Darva'nın ocağında öğrenmek",
          "ladderBody": "İki ortak alan, Eastbrook Zincirli Zırh Yeleği ve Korumalı Tayt, en başından beri bilinir ve her yerde zanaat yapılır. Eğitmen merdiveni, Eastbrook demir ocağındaki üç basamakta dokuz tariften oluşur: bakır basamak, beceri 0'da ücretsizdir, demir bağlantı basamağı, beceri 25'te, bir tarif için 25 gümüştür ve osmium ölçekli basamak, beceri 50'de, her biri 1 altındır; her basamak, seviyenize ulaştığı anda öğretilebilir.\n\nMerdivenin arkasında iki özel ürün var. Boundstone Miğferi, Smith'in iki kombinasyon tarifinden biridir (Gravewyrm Eldivenleri onun silah işçiliği tarafındaki kardeşidir), eğitmen tarafından öğretilir, istasyon gerektirmez ve yalnızca her iki zanaatta da beceri 25'te olan uyumlu bir Smith tarafından uygulanabilir. Kilnscale Manto'nun hiçbir öğretmene ihtiyacı yoktur: onu en başından beri herkes bilir ve demir ocağı ve onu çalıştıran malzeme kapılarından başka bir şey yoktur. Listelenen 75 becerisi izinle değil kazançla ilgilidir: Armorcrafting'in ana dal olması durumunda, ilk çekiç darbesinden 99'a kadar tam beceri kazanımı öder, böylece yedek osmiyuma sahip bir Smith buna erkenden güvenebilir. Bir binbaşının tavanının altında 3. aşama tarif hiçbir şey öğretmez, bu nedenle beyan edilmemiş veya hobi zırh ustası bunu puanlar için değil parça için kullanır.",
        ...
        "leatherworking": {
          ...
          "materialsBody": "Deri işçiliği, tesviye rotanız ile tedarik hattınızın aynı şey olduğu bir zanaattır: kaba deri, deri taşıyan cesetlerden, özellikle kurtlar ve domuzlardan doğrudan hasat edilir ve her ceset yalnızca bir hasat makinesine hizmet eder, ilk gelen ilk alır. Nadir veya daha iyi bir hasat rulosu aynı zamanda Mirewarden Jerkin'in istediği imzalı bir örnek olan Bozulmamış Postu da verir, bu yüzden bulduğunuz her şeyi bankaya yatırın.\n\nDestekleyici kalıp küçüktür: örümcek bacakları ve ipek, insansılardan elde dokunmuş ev yapımı kumaş, her bir mirewarden nadir parçasında tek bir osmiyum cevheri (Duskhide Wraps kapak taşında altı adet) ve tabakhane tezgâhından 16 bakırda bir Tabaklama Maddesi. Osmiyumun kendisi hiçbir zaman karşıdan satın alınmaz: onu Thornpeak'te veya hemen hemen herhangi bir genç bölgenin başlangıç ​​damarlarında (yalnızca Farshore demir kazar) kendiniz çıkarın veya başka bir oyuncudan satın alın.",
          "ladderHeading": "Fenbridge'de öğrenilir",
          "ladderBody": "Buruşukluk şu: Tabakhane, Mirefen Bataklığı yolu üzerindeki Fenbridge'de bulunuyor ve Leatherworking'i bataklıkta eğitim verilen tek derin zanaat haline getiriyor. Tanner Hesk, fıçılarında merdiveni öğretiyor: Fenbridge derisi 0. beceride serbest basamakta, yol avcısı 25 gümüşte, 25. beceride bir tarif ve mirewarden'ın her biri 50. beceride 1 altınla çaldı; her basamak, seviyenize ulaştıkça açılır.\n\nÜç tarif eğiticiyi atlıyor: saha ortak eşyaları (Tabaklanmış Deri Jerkin ve Eastbrook Druid'in Derisi) başlangıçtan itibaren herhangi bir yerde zanaat yapıyor ve Duskhide Sargıları herkes tarafından biliniyor ancak tabakhaneye bağlı 75. beceride oturuyor. Kıyafetçi yemininin Eastbrook'ta Ottilie ile birlikte verildiğini unutmayın; yalnızca öğreti bataklıkta gerçekleşir.",
          "routeHeading": "Şaheserler ve 125'e giden işleyen bir yol",
          "routeBody": "Gerçek istatistiklere sahip herhangi bir parça, daha yüksek kalite seviyenizin tavanına uyduğu sürece, şaheserlik şansını artırır; belirtilen Eastbrook Druid Postu dahil ve Mirewarden Jerkin'deki imzalı Bozulmamış Post, imzalı reaktif bonusunu otomatik olarak sağlar; osmiyum işlem için 1. kademe malzeme olarak sayılır. Statüsüz gizleme ortak alanları tetiklenemez.\n\nDoğal yoldan dengeleyin: birinci seviyeden itibaren öldürdüğünüz her kurdu ve yaban domuzunu hasat edin, iki ortak alanın sizi nerede olursanız olun sizi 25'e taşımasına izin verin, sonra görevler sizi yine de bataklığa çektiğinde fıçılarda deriyi eğitin. Marshstalker sizi 50'ye, mirewarden ise 75'e taşır; Bunu geçtikten sonra, altı osmiyum cevheri, üç Bozulmamış Deri, iki kaba deri ve bir Tabaklama Ajanından oluşan 3. kademe bir tarif olan Duskhide Wraps, uyumlu bir Outfitter'a 99 buçuk puana kadar tam kazanç, 125 sınırına kadar son elli puan için yaklaşık 75 zanaat ödüyor; bir binbaşının tavanının altında 3. kademe tarifi hiçbir şey öğretmez.\n\nGezici tabakhane bu zanaat için diğerlerinden daha önemli: 75'te uzmanlaşın ve Fenbridge'e geri dönmek yerine, kamp ateşinde bir sırt çantasındaki derilerin bitmiş teçhizatı haline gelin. Hesk'in tabakhane iş emri her 30 dakikada bir sekiz kaba deri satın alıyor, ne olursa olsun topladığınız derilerden düzenli bir geri dönüş alıyor ve Tapu Kitabı, Tanner'ın Ticaretini, Büyük Usta Deri İşçiliği ile 50. beceri olarak işaretliyor."
        },
        "cooking": {
          "identityHeading": "Grubu besleyen kazan",
          "identityBody": "Pişmiş bir yemek yiyin ve 18 saniyelik dinlenmeyle sizi iyileştirir, bu da oyundaki en ucuz şifadır. Merdiven, 90 sağlıklı Pan-Seared River Levrek'ten 980'deki Marlow's Grand Roast'a kadar uzanıyor; oyunda hiçbir şey yenemez.\n\nHalkada Aşçılık, Simya ve Deri İşçiliği arasında yer alır. Onun yaşayan çifti, çömlek için dört yaban domuzu avladıktan sonra Eastbrook mutfaklarında Cook Marlow'un huzurunda yemin eden Eczacı, Simya ve Aşçılıktır; Leatherworking'li Trapper çiftinin adı yüzüğün üzerinde yazıyor ancak henüz bir yemin görevi yok.",
          "materialsHeading": "Olta ve bıçakla beslenen bir kiler",
          "materialsBody": "Balıkçılık, bölge bölge özel malzemeleri stoklamaktadır: Eastbrook Vale'nin sularından aynalı alabalık ve nehir levreği, Mirefen Bataklığı'ndan bataklık turna balığı ve bataklık yılan balığı, Thornpeak Heights'tan donma alabalığı ve kayrak yüzgeçli sazan. Basamaklar bölgeleri özgürce karıştırır (serbest basamak zaten bataklık turna balığı ister, orta basamak Thornpeak'in donmuş solungaçını ister ve nadir akşam yemeği Vale'nin ayna alabalığını tekrar içeri katlar), böylece yol nereye giderse gitsin balık tutan bir aşçı asla kuru kalmaz.\n\nKasap tarafı hasat edilmiş cesetlerden çıkıyor: domuzlardan ve onların akrabalarından elde edilen av etleri ve nadir veya daha iyi bir hasat rulosunda, büyük kızartmanın en önemli parçası olan imzalı bir Prime Cut. Otlar daha iyi yemekleri baharatlıyor, bir dişbudak kütüğü yılan balığını tütsülüyor ve Pişirme Tuzu, Marlow'un kendi tezgâhından kese başına 8 bakır alıyor.",
        ...
        "alchemy": {
          ...
          "identityBody": "Zanaat, tarif merdivenini öğreten, Cam Şişeleri 12 bakıra satan ve iş emri aracılığıyla şifalı bitkiler için para ödeyen Eczacı Ustası Simyacı Verane'nin evi olan Highwatch'taki eczacıda çalışılıyor.\n\nZanaat halkasında Alchemy, deneme-yanılma işlemleriyle birlikte bir yanda Mühendislik, diğer yanda Aşçılık'ın yanında yer alıyor. Bu ona iki çift kimlik kazandırıyor: Bombardier (Mühendislik ve Simya, Eastbrook'ta Tinker Gizzel'den önce devralındı) ve Eczacı (Simya ve Aşçılık, Cook Marlow'un önünde yemin etti). Simya'yı ana dal yapmak için her iki çifte de uyum sağlayın ve kendi imzalı çalışmanızın size geri öğretmesine izin verin; Bombardier çifti aynı zamanda kendi kombinasyon demlemesi olan Ayı İksiri'ni de açarken, Apothecary çifti henüz herhangi bir kombinasyon tarifi göndermiyor. Ancak merdivenin kendisi asla beklemez, çünkü her Simya tarifi, beyan edilmemiş zanaatların altında çalıştığı nadir kademenin içinde yer alır, bu nedenle, herhangi bir yemin etmeden önce başlığa olan tüm tırmanış açıktır.",
          ...
          "ladderBody": "Herkes Küçük Şifa İksiri'ni en başından beri bilir ve onu her yerde karıştırabilir, istasyona gerek yoktur. Gerçek merdiven, Verane tarafından eczacıda öğretilen dokuz tariften oluşur; her basamakta üç tane vardır: 0 beceri tarifi ücretsizdir, 25 basamak becerisi tarif başına 25 gümüşe mal olur ve 50 basamak becerisinin maliyeti tarif başına 1 altındır. Her basamak bir iyileştirme iksiri, bir mana iksiri ve bir dayanıklılık iksiri olup, sıradan parlak yapraklı şişelerden (120 sağlık, 160 mana) sıra dışı altın yaprağa (200 sağlık, 260 mana) ve nadir güneş yaprağına (280 sağlık, 360 mana) doğru ilerler.\n\nİksirler aynı şekilde tırmanır: Domuz İksiri 10 dakika boyunca 6 Dayanıklılık sağlar, Engereksar İksiri 15 dakika boyunca 9 ve Yılan İksiri 15 dakika boyunca 12, Yılan tek başına zanaat başına iki şişe hazırlar. Bir kenarda başka bir tarif daha var: Ayı İksiri, Verane'nin Alchemy'niz 25'e ulaştığında 25 gümüş karşılığında öğrettiği bir kombinasyon karışımı, her yerde karıştırılabilir, ancak yalnızca hem Alchemy hem de Engineering'e uyumlu bir Bombardier tarafından 25'te.",
          "routeHeading": "Bir simyacının 125'e giden yolu",
          "routeBody": "Taslaklar ve iksirler asla şaheserleri ortaya çıkarmaz; bu işlem stat taşıyan donanıma aittir. Ancak adınız hala dolaşıyor: Nadir güneş yaprağı taslakları bir yapımcının işaretiyle imzalanmış olarak geliyor ve çift partili Yılan İksiri'nin her şişesi de öyle, yani bu zanaattaki nadir hiçbir şey tezgahta imzasız kalmıyor. 75. beceride uzmanlaşırsınız ve bundan sonra her Alchemy tarifinin maliyeti yüzde 20 daha az olur.\n\nHerbalism'i erkenden alın ve seviye ilerledikçe seçim yapın: Sheenleaf Vadi'nin her yerindedir ve Verane'in bankına ulaştığınızda serbest basamak sizi zaten seçeceğiniz şifalı bitkiler konusunda temiz bir şekilde 25. beceriye taşıyacaktır. Açıldığı anda 25. basamağı öğrenin, altın yaprak için seçiminizi bataklığa taşıyın ve Verane'nin iş emrinin (45 bakır karşılığında altı Altın Yaprak Bitkisi, her 30 dakikada bir tekrarlanabilir) siz giderken biraz parayı geri vermesine izin verin.\n\n50'den itibaren, biraz Vale ve bataklık yeşilliklerini hala karışımda bulundurarak, Thornpeak güneş yaprağından güneş yaprağı taslakları ve Yılan partileri hazırlayın. 100'den 125'e kadar olan son aralık kasıtlı bir damlamadır, bu nedenle sayı için şifalı bitkiler yakmak yerine gerçekten satan şeyleri hazırlayın ve sarf malzemelerinin herkesin sonsuza kadar yeniden satın alacağı hazırlanmış iyi hazırlanmış ürünler olduğunu unutmayın. Book of Deeds, Strange Brews'u 50. beceride ve Büyük Usta Alchemy'yi zirvede işaretliyor."
        },
        "engineering": {
          "identityHeading": "Alet yapımcısının tekeli",
          "identityBody": "Zanaat, Alet İşlerinin Ustası Tinker Gizzel'in evi olan Eastbrook Meydanı'nın güneybatı köşesindeki alet atölyesinde çalışılıyor. Her takım serisinin 1'den 3'e kadar olan kademeleri sıradan satıcı stoğudur; 4. ve 5. kademeler bir mühendis masasından veya Boğulmuş Litany'nin temiz kapılarının ardındaki Delve İşaretleri için araştırma tezgahından çıkar ve asla para için kasadan çıkmaz.\n\nHalkada deneme-yanılma ticaretleriyle birlikte, Alchemy ve Armorcrafting'in yanında yer alıyor ve ona iki çift kimlik veriyor: Bombardier (Mühendislik ve Alchemy, Gizzel'den önce ele alındı) ve Gearwright (Zırh Üretimi ve Mühendislik, adı verildi ancak henüz yemin edilemez). Burada bir uyarı her yerde olduğundan daha önemli: Mühendislik'in tarif basamaklarının her biri, hobilerin ve beyan edilmemiş zanaatkarların altında çalıştığı nadir kademe tavanının üzerinde yer alıyor, bu nedenle beceri sayısı yalnızca ana dalları Mühendislik olan, bugün Bombardier anlamına gelen bir zanaatkar için geçerli. Arazi aletlerini hâlâ herkes yapabilir; Uyumsuz bir zanaatkar bunu yapmaktan hiçbir şey öğrenemez ve iki çubuk tarifi ayrıca Gizzel'in öğretisini ister.",
          "materialsHeading": "Bileşenler ve önceki aletler",
          "materialsBody": "Her arazi aleti tarifi, aletin bir kademe altındaki artı bir FINE malzemesini tüketir ve bu eşleştirme, tüm arazi merdivenini oluşturur: dört İnce Demir Cevheri ve bir Skysilver Madencilik Kazması, Osmiyum Madencilik Kazması olur, ardından iki Glif Çelik Çubuk, iki İnce Osmiyum Cevheri ve o osmiyum kazma, Glif Çelik Madencilik Kazması olur. Balta ve orak çizgileri, İnce Dişbudak ve İnce Highpine Kütükler, İnce Altınyaprak ve İnce Günyaprağı Otları ile ince artı-önceki alet şeklini yansıtır, ancak 5. kademe basamakları Glif Çelik Çubuk gerektirmez: kazma, en üstte daha pahalı hale gelen tek çizgidir. İki kamış tarifi bu modeli kasıtlı olarak bozuyor: Stormreel dört Sunglint Koi ve bir Silverstream kamışını, Tidewrought iki Koi'yi, sekiz Ham Slatefin Sazanı ve bir Stormreel'i alıyor, böylece balıkçı merdiveninin tepesi damardan ziyade su üzerinden ödeniyor.\n\nİyi bir malzeme hiçbir yerde satılmaz ve sıradan bir hasattan düşmez: bunu, bir bölgenin tam dereceli damarlarından birini, malzemenin kendisinden daha üst sıralarda yer alan bir aletle çalıştırarak elde edersiniz; bu, pratikte, inşa etmeye çalıştığınız aletin bir basamak altında alet anlamına gelir (bir bölgenin gezginler için tuttuğu daha kolay damarlar, ne yaparsanız yapın, düz malzemeyi verir). Bu kasıtlı. Zanaat rotasında, 5. seviye bir araç, bir alışveriş gezisinden değil, 4. seviye aracı gerçekten sallamaktan gelir; Delve Marks sayacı bunun tek yoludur. Bunun tek istisnası, rafine edilmiş ve yalnızca satıcıya özel olan, Highwatch'taki Malzeme Sorumlusu Bree'den veya Gizzel'in kendi tezgahından külçe başına 1 gümüş 60 bakır olan Glyphsteel Bar'dır, bu nedenle Glyphsteel Mining Pick tek başına maliyetine sabit bir madeni para tabanı taşır.",
          "ladderHeading": "Alet merdiveni",
          "ladderBody": "Merdiven, tamamı alet istasyonuna bağlı sekiz tariften oluşuyor. Altı arazi aleti tarifi otomatik olarak bilinir, eğitmen ücreti alınmaz: 75. seviyedeki kazma, balta ve orak ve 150. seviyedeki 5. seviye versiyonları. Bu ikinci sayı bir yazım hatası değildir ve mevcut 125 sınırının üzerinde bilerek yer alır: beceri gereksinimleri burada hiçbir zaman bir geminin kapısını açmaz, sadece beceri kazanımını şekillendirir, böylece reaktiflerini ve 4. kademe öncülünü tuttuğunuz gün 5. kademe bir araç inşa edebilirsiniz. İki el yapımı çubuk öğretilen istisnadır: Gizzel, Stormreel'e 75 becerisinde 4 altın karşılığında ve Tidewrought'a 16 altın karşılığında 125 becerisinde eğitim verir, her biri zanaattaki seviyeniz kendi seviyesine ulaştığında.\n\nTamamlanan her alet nadir veya destansı kalitededir ve imzalı olarak çıkar, böylece adınız diğer oyuncuların alet kemerlerindeki bölgelerde yer alır. Mühendislik aynı zamanda bir kombinasyon tarifinin yarısını da elinde tutuyor: 25 yaşında hem Mühendislik hem de Alchemy ile uyumlu bir Bombardier tarafından hazırlanan Ayı İksiri.",
        ...
        "enchanting": {
          ...
          "identityBody": "Her büyü en başından beri bilinir, herkes büyüyü ilk günden itibaren çözebilir ve ikisinin de bir istasyona ihtiyacı yoktur; Her zanaatta olduğu gibi beceri sınırı 125'tir. Ticaretin öğretilen bir yönü de tılsım tarifleridir: Tinker Gizzel, Enchanting'iniz 25'e ulaştığında sıradan bir kademe ücreti karşılığında Eastbrook Meydanı'nın güneybatı köşesindeki alet atölyesinde Toplayıcının Önbelleğini ve Zanaatkarın Gözü'nü öğretir ve tılsımlar onun istasyonunda işlenir.\n\nYüzüğün üzerinde Yazıt ve Mücevher İşçiliği arasında yer alır, dolayısıyla iki çift kimliği Arcanist (Yazıt ve Büyüleyici) ve Gembinder'dir (Büyüleyici ve Mücevher İşçiliği). Her iki komşu da ilk tariflerini beklediğinden ikisi de henüz yemin edemiyor, bu nedenle bugün Büyüleyicilik herkesin zanaatı olarak tırmanıyor: herhangi bir yeminden önce nadir seviyeye ücretsiz ve bir Bombardier veya Eczacı için doğal bir hobi seçimi. Büyücüler aynı zamanda toplama dünyasını çalışır halde tutar: takılabilir iki araç efekti Büyücü işidir ve orijinal bir zanaatkar kendi efektlerini indirimli olarak yeniden doldurur, uzmanlaştığında daha da derinleşir.",
          "levelingHeading": "Büyüleme nasıl seviye kazanır",
          "levelingBody": "Üç eylem beceriyi harekete geçirir: bir parçanın büyüsünü bozmak, bir büyü uygulamak ve sıradan işçilik eğrisini tırmanan iki tılsımı işlemek. Her başarı, işin ciddiyetine göre ölçeklendirilen bir puan değerindedir: kırdığınız parçanın nadirliği veya uyguladığınız büyünün reaktif seviyesi. Yaygın büyü bozma büyüleri ve yalnızca toz büyüleri ortak iş olarak kabul edilir; sıradışı büyü bozmalar ve öz büyüleri alışılmadık derecede; nadir büyü bozmalar ve tüm Runed veya Greater büyüler de nadirdir; destansı ve efsanevi hayal kırıklığı yaratanlar masada hala daha üst sıralarda yer alıyor, ancak günümüzde hiçbir büyüleyici kimlik nadir basamağın ötesine geçemiyor, bu yüzden pratikte nadir çalışmalarla aynı parayı ödüyorlar. Kırma tezgahına tek bir dürüstlük hakimdir: Bir oyuncu tezgahından çıkan bir parça (işlenmiş, imzalı veya ustalıkla işlenmiş) hâlâ malzemeleri işliyor ama hiçbir şey öğretmiyor, dolayısıyla bir el işi ve kırma döngüsü kimseyi altüst etmiyor ve dersler dünyanın her yerinde bulunan ekipmanlarla veriliyor.\n\nTanıdık ustalık zayıflaması 25 puanlık kademelerde geçerlidir, bu nedenle ortak dereceli çalışmalar beceri 75'te, sıra dışı işler 100'de ve nadir kademe işler tam olarak 125'lik sınırda griye döner. Büyülemenin kendine has bir özelliği de var: arketip tavanınızın üzerindeki girdiler sıfırlanmak yerine o tavana yuvarlanır, bu nedenle uyum sağlamadan önce destansı bir hayal kırıklığı hiçbir şey öğretmemek yerine nadir olarak puanlanır. Enchanting, başka bir kimliğin arkasında uykuda kalırsa, ortak çalışma olarak kırılma ve puan uygulanması ve tırmanma 75'te dururken, iki tılsım, ortak tavanın üzerindeki işçilik eğrisini sürdürerek, hareketsiz bir büyücüye hiçbir şey öğretmez; Hobiniz ve nadir seviye çalışmalarınız hala işe yaradığı için bunu sürdürün, sadece 75'i biraz geç.",
          "marketHeading": "Büyülenmiş kopyalar, köken ve pazar",
          "marketBody": "Büyü uygulamak reaktifleri harcar ve öğenin belirli bir kopyasını işaretler. Torbalı bir kopyaya doğrultun ve farklı, büyülü bir kopyayı geri alın; halihazırda giydiğiniz bir parçaya doğrultun ve giyip çıkarma dansı olmadan, tam oturduğu yerde büyülenir. Her iki durumda da bonus, donanımdan çıkarmalar, banka gezileri ve takaslar yoluyla bu parçayı sonsuza kadar takip eder. Parça başına bir büyü: Büyülü bir kopyaya farklı bir büyü uygulamak onay ister, ardından eski büyüyü tamamen değiştirir ve malzemeleri iade edilmeden onu yok eder. Satmak, atmak ve büyüyü bozmak, öncelikle düz kopyaları tercih eder, böylece bitmiş parçanız kazara yenmez.\n\nUsta işi teçhizat ve büyüleyicilik arkadaştır: Bir şaheser parçası tamamen büyülenebilir kalır ve sihir, onu veya yapımcısının imzasını bozmadan şaheser bonusunun üzerine eklenir. Her kaynağı istifleyen, Büyük bir büyü taşıyan imzalı bir şaheser, hazırlanmış bir parçanın elde edebileceği en iyi şeydir ve tasarım gereği hâlâ baskın ganimetinin altında yer alır.\n\nPiyasada, büyülü veya imzalı bir parça, diğer herhangi bir şey gibi listelenir: kendi tek kopya listesi olarak yükselir, araç ipucu, büyüyü ve yapıcının işaretini gösterir ve Ravenpost onu aynı sadakatle taşır. Malzemeler zanaatın değişmez yarısı olmaya devam ediyor: Toz, Öz ve Parçalar serbestçe listelenir, listelemenin hiçbir maliyeti yoktur ve Tüccar tamamlanan bir satışın yalnızca yüzde 5'ini alır. Bu, iki klasik büyücünün gelirini malzeme satarak ve bitmiş işi satarak elde eder: piyasada, kuzgunla veya bir ticaret penceresinde yüz yüze."
        }
      },
      "howHeading": "Üretim nasıl çalışır",
      "howBody": "Üretim penceresini açın (varsayılan T tuşu) ve bildiğiniz her tarif, neye ihtiyaç duyduğu ve elinizde ne olduğuyla birlikte listelenir. İstasyona bağlı tarifler sizden şehirdeki doğru istasyonun 20 metre yakınında durmanızı ister, saha tarifleri her yerde yapılır ve Enchanting'in kırma ve büyüleme işlemlerinin hiçbir istasyona ihtiyacı yoktur (yalnızca iki cazibe tarifi, alet atölyesindeki istasyon işidir). Başarısızlık diye bir şey yoktur: Malzemelerin elinde olduğu bir zanaat her zaman başarılı olur.\n\nİki küçük sürtüşme ekonomiyi dürüst tutuyor. Her başarılı zanaat, öğenin istatistik bütçesinin puanı başına 2 bakır ücret öder ve zanaat türü eylemler aynı hızı paylaşır: her 60 saniyelik pencerede en fazla 10 zanaat, büyü bozma, büyüleme, kurtarma veya alet şarjı. İkisi de normal bir oturumu rahatsız etmeyecektir; her ikisi de maksimum düzeydeki bir uzmanın piyasaya akın etmesini engeller.",
      ...
      "masterworkBody": "Her başarılı zanaat, tarifin tam olarak vaat ettiği şeydir ve bazen biraz daha fazlasıdır: bir şaheser, aynı parçayı, zanaat zamanında eklenen bonus istatistiklerle, bir kalite kademesi daha iyi bir şekilde bitirir. Yalnızca eklentidir, asla sürüm düşürmez ve baskın tabanının altında kalır, böylece hazırlanmış donanım, baskın düşüşünü değiştirmeden mükemmel olabilir.\n\nŞans, mistik değil, yayınlanır: %{base} temel, artı becerinizin tarifin üzerinde olduğu seviye başına %{perTier}, artı herhangi bir imzalı reaktif girdiğinde %{signed}, artı uzmanlaştıktan sonra %{spec}, daha yüksek seviyeli malzemeler %1 ila %2 daha fazla ekler, tümü %{cap} ile sınırlıdır. Yalnızca gerçek istatistiklere sahip bir parça gelişebilir, bu nedenle durumu olmayan ortak alanlar, araçlar ve sarf malzemeleri asla tetiklenmez; hareketsiz bir zanaat asla bir tane üretmez ve bir hobi zanaatı, nadir tavanını aşan bir ustalık eseri yapamaz.\n\nİnce iş, yaratıcısını taşır. Nadir ve daha iyi çıktılar imzalanır, her kopya (Hazırlayan; toplanan malzemeler Toplananları taşır), kalitesi ne olursa olsun her zaman bir şaheser imzalanır. İmza, kilit değil, menşedir: İmzalı malların Dünya Pazarında serbestçe ticareti, postalanması ve listelenmesi.",
      "trainingHeading": "Eğitim",
      "trainingBody": "Eğitmen tarifleri, istasyonlarda öğretilen yerleşik ustalardan geliyor. Kural tek satırdır: Bir usta, zanaattaki seviyeniz tarifin kendi seviyesine ulaştığında bir tarif öğretir ve onu başka hiçbir şey, sizin seviyeniz veya arketipiniz engelleyemez. Donanım ve sarf malzemesi merdivenleri basamaklarını 0, 25 ve 50. beceride yürütür; Engineering'in iki çubuk dersi, merdiveni 75 ve 125'te devam ettiriyor ve Enchanting'in iki cazibe tarifi 25. basamakta yer alıyor, böylece seviyeleriniz yükseldikçe yeni bir basamak açılıyor.\n\nÜcretler tek seferliktir ve basamak bazında sabittir: başlangıç ​​basamağı ücretsizdir, 25 basamaklı becerinin maliyeti {tier1} bir tariftir, 50 basamaklı beceri {tier2} ve bunların üzerindeki çubuk derslerinin kendi ücretleri vardır ve bunlar tablodaki her tarifin yanında listelenmiştir. Eğitim almak için ustanın asıl istasyonunda durmalısınız ve mobil istasyon asla sayılmaz. Ortak tarla tarifleri ve hazırlanmış altı arazi aleti tarifi hiçbir eğitim gerektirmez; her karakter onları başından beri biliyor.",
      ...
      "ench": {
        ...
        "enchantsNote": "Büyücüler üç aşamada gelir. Temel katman, Chime Dust üzerinde çalışır (üst uçta küçük bir Essence ile) ve silah yuvasının yanı sıra, her yapının her yuva için bir şeyler bulmasına yetecek kadar istatistik ekseni seçeneğiyle, ikinci el dışındaki tüm zırh yuvalarını kapsar. Büyük kademenin maliyeti bir Chime Shard artı Essence'dır: en yüksek etkili slotlarda daha güçlü bonuslar. Parçalar ayrıca iki lavaboyu daha besler, her biri beşer adet olmak üzere iki tılsım tarifi ve alet etkisi yüklemelerinin en üst basamağı, bu yüzden harcamadan önce birkaç tane biriktirin.\n\nAralarında beş Runed efsun bulunur, her yazılan ikincil tüketici için, yani frezelediğiniz hiçbir şey asla bir çıkmaz sokak değildir: Runed Edge (silah, Güç, Rezonant Çelik tüketir), Runed Sigil (silah, Zeka, Rezonant Kereste), Runed Weave (göğüs, Ruh, Rezonant İplik), Runed Hide (bacaklar, Çeviklik, Rezonant Post) ve Runed Links (kask, Dayanıklılık, Rezonant Bağlantılar). Her biri ayrıca iki Çan Özü alır; bir slot ve stat'ın hem bir tabanı hem de bir Büyük büyüsü olduğu durumlarda, Runed bonusu bunların arasına girer, Runed Weave ise en güçlü sandık Ruh büyüsüdür ve Runed Hide, Çeviklik büyüsü yapan tek bacaktır. Kesin bonusların tümü aşağıdaki tabloda yer almaktadır.",
        "colEnchant": "Büyü",
        "colSlot": "Yuva",
        "colTier": "Kademe",
        "colBonus": "Bonus",
      ...
      "gatherIntro": {
        "mining": "Madencilik, dünyanın kayalarından cevheri doğrudan çekiyor: Eastbrook Vale'den bakır, Mirefen Bataklığı'ndan demir ve Thornpeak Heights'tan osmiyum; başlangıç ​​damarları, bunların ötesindeki her genç bölgeye dağılmış ve demirci zanaatını besliyor. 1. seviyeden itibaren herkese açıktır: Eastbrook, Fenbridge veya Highwatch tezgahından alınan 20 bakır madenciliği seçimi tüm başlangıç ​​damarlarını açar ve kendi tezgahınız kazandıkça seçim merdiveninin üst basamakları uyanır. Kendi sayacında 100 sınırına kadar takip edildi.",
        "logging": "Tomruk, tüm dünyadaki ağaç stantlarından kereste kesiyor: Eastbrook Vale'de demir kabuğu, Mirefen Bataklığı'nda dişbudak, Thornpeak Heights'ta yüksek çam ve her genç bölgede başlangıç ​​stantları, saplar, çıtalar ve mühendis tezgahı için ham stok. Çantanızda bir tomruk baltası bulunan (Eastbrook, Fenbridge ve Highwatch gişelerinde 20 bakır), kendi tezgahında 100 sınırına kadar takip edilen, seviye 1'den itibaren herkese açıktır.",
        "herbalism": "Bitkiselcilik yabani olarak yetişenleri toplar: Eastbrook Vale'de parlak yaprak, Mirefen Bataklığı'nda altın yaprak, Thornpeak Heights'ta güneş yaprağı ve her genç bölgede başlangıç ​​yamaları, eczacılık mesleğini canlı tutan yaprak ve gövde. Çantanızda şifalı bitkiler orağı bulunan (Eastbrook, Fenbridge ve Highwatch gişelerinde 20 bakır), kendi sayacında 100 sınırına kadar takip edilen, seviye 1'den itibaren herkese açıktır.",
        "fishing": "Balıkçılık, toplanan meslekler arasında en tuhaf olanı ve en derin olanıdır: gerçek bir ısır-ve-reel mini oyunu, üç ana bölgenin her birinde kendi yakalama tabloları (bunların ötesindeki genç sular şimdilik Vadi'nin masasına hizmet ediyor) ve diğerlerinin iki katı olan 200'lük bir yeterlilik sınırı. Bir direk satın alın, açık suya bakın ve döküm yapın."
      },
      "rhythmHeading": "Toplama ritmi",
      "rhythmBody": "Hasat kısa görünür bir atıştır, anlık bir kapma değildir: {base} saniye tabanı, asla {floor} ikinci katın altına inmez. Yetkinliğinizin kullanmanıza izin verdiği düğüm seviyesinin üzerinde bir araç taşımak, üzerindeki seviye başına sizi {tool} saniye hızlandırır ve geçtiğiniz her yeterlilik bandı, bir {band} saniye daha kısaltır; yalnızca düğümün kademesini eşleştirmek sizi kapıya götürür; sizi hızlı yapan şey onun üstündeki kademelerdir.\n\nDolu bir çanta, başlamadan önce oyuncuyu kibarca reddeder, bu nedenle vuruşun ortasında hiçbir şey israf edilmez ve her hasat, düğümün seviyesine göre kendi seviyenize göre ölçeklenen, öldürme XP'sinin ölçeklenmesine göre ölçeklenen küçük bir karakter XP dilimi öder: önemsiz bir gri düğüm, sınırlı bir karaktere hiçbir şey öğretmez.",
      "gainBody": "Kazanç deterministiktir, asla beceri geliştirme atımı değildir: Kazanç seviyenizdeki veya üzerindeki bir düğüm, hasat başına tam puan öğretir ve her {step} yeterliliği, düğüme karşı puanlanan bir aşamadır. 1. Seviye düğümler 25'in altında tam ödeme yapar, 49'a kadar yarısı, 74'e kadar çeyreklik ve 75'ten itibaren hiçbir şey ödemez; 2. kademe düğümler 49'a kadar tam ödeme yapar; her ticaretin iki 3. kademe düğümü, {cap} sınırına kadar tam 74 ve yarı yarıya ödeme yapar.\n\nAmaçlanan rota basit: Vadi'nin başlangıç ​​noktalarını öğrenin, bataklığa doğru ilerleyin ve tırmanışı Thornpeak Heights'ın yüksek zemininde tamamlayın. Üst sınırda öğrenme durur ancak getiriler durmaz: Sınırlı bir toplayıcı, takasın sunduğu en iyi oranları sonsuza kadar yuvarlamaya devam eder.",
      ...
      "toolsNote": "Her bağlantı noktasının kendi ticaret aracını çantanızda taşıması gerekir; 1. aşama dahil: kazma yok, cevher yok, sırık yok, balık yok. Satıcı merdiveni, üç ana merkezde 1'den 3'e kadar olan aşamaları kapsar: 1. aşama araç üçünde de satılır, üstündeki basamaklar onları kullanan zeminin başladığı yerdedir (Fenbridge, 2. aşamayı, Highwatch 3. aşamayı ekler) ve bunların ötesindeki daha genç yerleşimlerde hiçbir alet stoklanmaz, bu nedenle seyahate çıkmadan önce donanımınızı hazırlayın. Her tezgah, stokladığı her basamağı serbestçe satar ve her alet doğrudan ticaretten geçer; 20 bakırlı üç kara başlangıç ​​hariç her basamak aynı zamanda Market'te listelenir ve postayla seyahat eder: bunlar bir tezgahtan satın alınır veya elden ele geçirilir ve asla geri satılmaz, postayla gönderilmez veya listelenmez. Kapılı olan şey kullanımdır. 1. seviyenin üzerindeki bir arazi aracı, yalnızca kendi işindeki yeterliliğiniz onu kazandığında çalışır; 2. seviye için {tier2Prof}, 3. seviye için {tier3Prof} ve hazırlanmış iki basamak için 85 ve 100 ve satıcı satırı, ipucu ve aşağıdaki tablo, gereksinimi baştan belirtir. O zamana kadar, önceden satın aldığınız bir alet çantanızda bekler, hiçbir zemin açmaz, hız satın almaz ve ince kaliteler basmaz, sonra tezgahınız numarasına dokunduğu anda kullanmaya başlar. Oltalar tek istisnadır: hiçbir kamışın kullanım gereksinimi yoktur ve Eastbrook'taki Trader Wilkes, önceden satın alan balıkçılar için 2. ve 3. kademe kamışları bilinçli olarak stoklamaktadır. Bir alet hiçbir zaman bir donatma yuvasını doldurmaz ve asla eskimez, dolayısıyla her biri tek seferlik satın alınır ve kapı için yalnızca seviye önemlidir: aynı seviyedeki daha nadir bir alet ekstra hiçbir şey açmaz. Nadirlik sadece renk değildir. Oluklu alet etkisinin daha uzun süre dayanmasını sağlar ve çubuk üzerinde makara penceresini genişletir.\n\nDaha iyi bir araç iki değil üç şey satın alır. Daha yüksek seviyeli zemini açar, alçıyı kısaltır ve ortaya çıkanı iyileştirir: Bölgenin kendi malzemesinin ÜSTÜNDE yer alan bir aletle bir damar işleyin ve hasat, düz olanın yerine onun iyi derecesini verir. Damarın bölgenin tam dereceli damarlarından biri olması gerekir, böylece bir bölgenin gezginler için tuttuğu daha kolay damarlar yine de sıradan malzemeyi verir. İnce malzemeler, hazırlanmış alet tariflerinin tükettiği şeylerdir ve ince kalite, bir tarifin veya iş emrinin gerektirdiği her yerde normal versiyon olarak sayılır; bu nedenle yükseltme sizi asla zora sokmaz: bu sadece bakır cevherinizin İnce Bakır Cevheri olarak ulaşması anlamına gelir.\n\nSatıcı merdiveninin üzerinde her ticarette, alet atölyesinde yapılmış (her karakter arazi tariflerini bilir; iş için tırmanan beceri Mühendislik'e aittir) veya temizleme kapıları karşılandığında Boğulmuş Litany tezgahından Delve Markları ile satın alınan, seviye 4 ve seviye 5 olmak üzere iki hazırlanmış alet bulunur: aşağıdaki tablo Mark fiyatlarını ve her basamağın istediği temizleme işlemlerini taşır. Hiçbir tüccar onları para karşılığında satmaz. Balıkçılığın kendi çifti vardır ve bunlar başlangıçta bilinmek yerine alet yapımcısından öğrenilir. Bugün hiçbir bağlantı noktası ve hiçbir suyun 3. seviyeden fazlasına ihtiyacı yoktur, bu nedenle en üstteki iki basamak erişim yerine hız, derece ve daha iyi bir makara penceresi satın alır ve daha yüksek seviyeli zemin geldiğinde giriş bileti olacaklar.",
      "toolCrafted": "Üretilmiş ({craft})",
      "toolCraftedOrMarks": "Üç Boğulmuş Litany temizliğinden sonra hazırlanmış ({craft}) veya {marks} Delve İşaretleri",
      "toolCraftedOrMarksHeroic": "Kahramanca Boğulma Ayini temizliğinden sonra hazırlanmış ({craft}) veya {marks} Delve İşaretleri",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Satılmaz",
      "priceNone": "Para karşılığında satılmaz",
      "toolTierReq": "Kademe {tier} alet",
      "colWield": "Şu tarihte kullanın:",
      "wieldNone": "Herhangi",
      ...
      "bandsBody": "Yeterlilik bantları, bir ticaret tezgahının üzerindeki paylaşılan 0/100/200 merdivenidir. Arazi ticaretinde bant 100'de geçer ve toplayıcı alçıyı tıraş eder ve şapkaları bant 1'i tavan yapar. Balıkçılık grupları hiçbir şeyi tıraş etmezler: Yakalama masalarını seçerler (eşleşecek bir oltayla), yalnızca balık tutmak 2. gruba ulaşır ve bir balıkçıyı daha iyi masaların ve daha sonraki derslerin yaşadığı daha derin sulara çeken şey tırmanışın kendisidir.",
      ...
      "specimenBody": "Çiftçilik yaparken çantanızda küçük bir yer bırakın: işaretli bir umulmadık yağışın inmek için kendine ait bir alana veya eşleşen bir imzalı yığına ihtiyacı vardır ve hiçbir şey uymuyorsa verim yine de gelir ancak imza kaybolur. Ceset hasadının da kendi büyük ikramiye kolu var: hasat edilen her bileşenin yaklaşık %{pct}'si nadir veya daha iyi çıkıyor. Verebilecekleri mükemmel bir örneği (deri, ipek, zehir, et) olan bir aile, sıradan ürününü sade tutar ve imzalı örneği de yanına basar; diğer her aile hasılatı kendisi imzalar.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "100 kilometre taşı Eski Tuz'u, 200 kilometre taşı ise balıkçı sanatının en üst noktası olan Usta Balıkçı'yı başlığıyla yazar; Balıkçılık aynı zamanda herhangi üç toplama ticaretinde 100 kazanılan Usta Toplayıcı için de sayılır. Altı bölgenin her birindeki sulardan gelen ilk balık, kendi sayfasını, üç ana bölgeyi ve bunların ötesindeki Willowfen, Galecrest ve Uzak Kıyı'yı doldurur ve Sunglint Koi, Glimmer of Hope'u kaydeder, böylece çantalarında bir sırık olan gezginler kitaplarını beklediklerinden daha hızlı doldururlar."
      },
      "fish": {
        "startHeading": "Başlangıç",
        "startBody": "Basit bir oltanın fiyatı Eastbrook'taki Fisherman Brandt'tan 20 bakırdır (kasabanın doğu ucunda, Mirror Lake yolunun yanındaki Eski Tuz'u arayın); Tinker Gizzel, Fenbridge'deki Tedarikçi Hale ve Highwatch stok direklerinden Malzeme Sorumlusu Bree de. Balığı tutacak kadar derin suya bakarken, önünüzde yaklaşık 24 metreye kadar direği kullanın ve bobber'ınız dışarı doğru yelken açsın.\n\nSavaş sırasında, yüzerken veya ölüyken atış yapamazsınız: amaçlanan duruş kıyıdan atış yapmaktır. Ancak arazi sertleştikçe su da sertleşiyor: bataklık en azından 2. seviye Ironreel'i ve zirveler 3. seviye Silverstream'i istiyor ve suyun aldığı çubuk olmadan yapılan bir halat asla elinizden çıkmıyor. Bunların üzerinde iki çubuk bulunur, Stormreel ve Tidewrought: mühendisler bunları bir hattın çektiği alet atölyesinde işliyor ve Boğulmuş Litany'nin araştırma tezgahı bunları açık kapılarının ardında Delve İşaretleri karşılığında satıyor, ama asla para karşılığında değil. Onlara su gerekmiyor, bu yüzden erişim yerine daha kısa bir bekleme ve daha geniş bir makara penceresi satın alıyorlar, bu da en üst basamakta üç saniye içinde bir ısırık anlamına geliyor.",
        "biteHeading": "Isırma ve çekme",
        "biteBody": "Aldıktan sonra, {min} ile {max} saniyeler arasında gizli bir anda bir ısırık gelir; Gecikmeye çizgi indiğinde karar verilir, bu nedenle hiçbir iki atış birbirine benzemez. Bobber ısırdığında, direğe tekrar basmak ve sarmak için {reel} ikinci bir pencereniz vardır: direğe sarın ve av yere iner, tereddüt ederek yanından geçin ve balık gösterecek hiçbir şey olmadan uzaklaşır. Bütün bir oturumun sınırı {cap} saniyedir, bu nedenle sessiz bir oyuncu seçimi bile hızla çözümlenir.\n\nDaha iyi kamışlar mini oyunun her iki ucunu da keskinleştirir: ilk kesimlerin üzerindeki her kamış kademesi mümkün olan en uzun bekleme süresinden {rod} saniye uzakta, hiçbir zaman üç saniyelik katın altına düşmez, üst çubuk zaten sıyırır ve makara penceresine {reelRod} saniye ekler, böylece Ironreel en kötü beklemeyi 3,25 saniyelik bir pencere ile 6,5 saniyeye çeker ve Silverstream 4'ü aşan bir pencere ile 5'e çeker, nadirliği makarayı biraz daha genişletir tek başına katman öder. En hızlı ısırıklar, tuttuğunuz şeyi asla değiştirmez ve sayılabilmesi için oltanın çantanızda olması yeterlidir.",
        "scheduleHeading": "Yetkinlik kazanımı",
        "scheduleNote": "Balıkçılık kazancı zarsız sabit bir programı takip eder: 50'nin altında avlanma başına tam puan, 100'ün altında yarım puan, 150'nin onda biri ve 150'den 200'e yavaş yavaş 0,02'lik bir damlama. Bu son bölüm binlerce avlamanın kasıtlı olduğu bir yolculuktur: 200 bir açıklamadır, başka bir şeye giden yolda bir durak değil.\n\nJunk, {cutoff}'da öğretmeyi tamamen bırakıyor: o andan itibaren yabani otlar ve çizmeler yalnızca yabani otlar ve çizmeler olarak kalacak. Suyun kendisi de bu dersi kapsıyor: Vadi'nin 1. kademe suları (ve ana bölgenin ötesindeki tüm genç kıyılar) 100'ü geçmiyor, bataklığın durağı 150'de ve yalnızca Thornpeak'in okulu 200'e kadar bir balıkçı okulu. Aksi takdirde karaya çıkan her av, planlanan oranda kazanç sağlar, bu nedenle sayaç durduğunda program size daha derin su aramanızı söyler.",
        "colProficiency": "Yetkinlik",
        "colGain": "Av başına kazanım",
        "belowFmt": "{below} altında",
        "tablesHeading": "Av tabloları",
        "tablesNote": "Uzmanlığınız üç yakalama bandından birini seçer: başlangıçtan itibaren bant 0, 100'de bant 1, 200'de bant 2, her biri ağırlığı hurdadan ve boş kancalardan bölge bölge gerçek balıklara kaydırır. İlkinin üzerindeki her bant ayrıca bir çubuk gerektirir: grup 1, kademe 2 Ironreel'i, grup 2 ise kademe 3 Silverstream'i ister. Etkin bandınız, becerinizin kazandığı ve oltanızın desteklediğinden daha düşük olanıdır ve kapak sessizdir: daha küçük bir kamışla, alt grubun masasının hemen dışında yakalayabilirsiniz, bu nedenle, beceriniz tırmanırken yakaladığınız şeyler sıkışmış hissederse, önce kamışınızı kontrol edin.\n\nHer bölgenin suları kendi yiyecek balık çiftini barındırır, bölge ne kadar derin olursa o kadar iyileşir, hepsi pişirme girdileri ve hattan uzakta oturarak yiyebileceğiniz mükemmel yiyeceklerdir. Masanın geri kalanı balıkçının vergisidir: ot, ara sıra çizme ve hiçbir zaman tamamen kaybolmayan boş kanca. Ne kadar ödeyeceğiniz, durduğunuz yere değil, bobber'inizin düştüğü suya bağlıdır: bir atış 24 yardaya kadar ulaşır ve suyun talep ettiği çubuk, çektiği masa, kredilendirdiği senet ve suyun ait olduğu bölgeye ne kadar uzaklık öğrettiği, hattın indiği anda belirlenir. Her bölgenin suyu kendine ait bir bant için yazılmıştır, Vadi bant 0 için, bataklık bant 1 için, zirveler bant 2 için ve bir bant altında balık avlamak, atışlarınızın kabaca üçte birini boş kancalara, iki bant da yarısından fazlasına dönüştürür. Çubuk sizi suya götürür; para kazandıran şey beceridir ve balıkçıyı daha derine çeken şey de tırmanıştır, çünkü daha iyi gruplar sadece daha iyi maaş anlamına gelmez: Vadi'yi geçtikten sonra öğretmeye devam eden tek sular onlardır. {rare}, yakalama bandınıza cevap veren tek satırdır ve başka hiçbir şeye cevap vermez: her bölgede aynı oranlar ve bant 2'de bant 0'a göre altı kat daha olasıdır, yani iskeledeki en nadir şey, Usta Balıkçının gerçekten daha iyi olduğu şeydir.",
        ...
        "koiBody": "Oyundaki her su birikintisi aynı ödülü saklıyor: Sunglint Koi, bir satıcı için 75 bakır değerinde, sizin gururunuz için ise çok daha fazla değere sahip, sıra dışı bir parıltı. Oranların yakalama bandınıza cevabı ve başka hiçbir şeye cevabı yoktur, her bölgede aynıdır: 0. bantta yakalama masasının yüzde 1'lik bir sırası, 1. bantta 3 ve 2. bantta 6, her makaralı atışta çizilir, böylece koi derin masaları kazanan balıkçıya gelir. Bunlardan birini indirmek, Sıfır Ünlü bir koleksiyoncu işareti olan Tapu Kitabınıza Umut Parıltısı'nı kaydeder. Bu gerçekleştiğinde, günlük bunu bilmenizi sağlar."
      },
      "econ": {
        ...
        "trainingNote": "Bir usta öğrettiğinde bir kez tahsil edilen, tarif basamağı başına bir sabit ücret; Ücretsiz başlangıç ​​tariflerinden üstteki alet üreticisinin olta derslerine kadar aşağıdaki tablonun her basamağı bugün canlı olarak kullanılıyor.",
        ...
        "provenanceBody": "Bazı öğeler bir isim taşır. Birinin üzerine geldiğinizde araç ipucunda bir ham madde üzerinde falanca tarafından toplandı veya bitmiş bir parça üzerinde falanca tarafından hazırlandı yazıyor: aynı işaret, öğenin nasıl ortaya çıktığını ifade ediyor. İmza, ürünün kendisinin bir parçasıdır; ticarette, bankada, postada, Dünya Pazarında ve hatta satıcının geri alımında onunla birlikte seyahat eder ve asla kaybolmaz.\n\nToplama, en iyi sonucunu otomatik olarak imzalar: nadir veya daha iyi gelen her hasat imzalı olarak ulaşır ve nadir buluntular, beklenmedik beş katının tamamının imzasını atar. Ceset hasadının uğurlu rulosu, ailenin verecek numunesinin olmadığı durumlarda verimini imzalar, olduğu yerde ise verimi sade tutar ve imzalı bozulmamış numuneyi yanına darp eder. Tabelaların aynı çizgide işlenmesi: Nadir veya daha iyi bir çıktının her kopyası imzalanır ve bir şaheser, kalitesi ne olursa olsun daima imzalar; dolayısıyla herhangi bir parçanın en iyi versiyonu, her zaman yapımcısının adını verir. Size bir imzaya mal olabilecek tek şey dolu bir çantadır: İmzalı bir birimin yerleşebilmesi için kendine ait bir alana veya eşleşen bir imzalı yığına ihtiyacı vardır.\n\nBir öğe yığını aynı kimliği paylaşır, bu nedenle iki kopya yalnızca her işaret tam olarak eşleştiğinde birleşir: aynı öğe, aynı imzalayan, aynı şaheser istatistikleri, aynı büyü, aynı bağ. İmzalı bir kütük hiçbir zaman düz bir yığına her iki yönde de katılmaz (birleştirme birinin adını siler), ancak aynı yükler mutlu bir şekilde birleşir, böylece aynı toplayıcı tarafından imzalanan yirmi cevher tek bir yığında durur ve beklenmedik bir düşüş çantalarınızı parçalamaz.\n\nİmzalar zanaatkarlara karşılığını verir: gerekli bir reaktifin imzalı herhangi bir kopyasını, kim imzalamış olursa olsun, tezgahta tutmak, yüzde 2 puanlık şaheser şansı ekler ve kendi eliniz tarafından imzalanmış bir reaktifi tutmak, reaktifin gerekli miktarını bir oranında azaltır (asla birin altına düşmez). Kendi imzalı nadir veya daha iyi çalışmanız, bugün yalnızca şişe aracılığıyla size öğretmeye devam ediyor: İmzaladığınız bir iksiri içersiniz ve küçük bir beceri damlaması, onu üreten zanaata geri akar, yeter ki o zanaat sizin aktif dallarınızdan biri olsun.",
        ...
        "throttleBody": "Çıktının bir tavanı vardır: üretim, büyüyü bozma, büyüleme, kurtarma ve alet etkisi yüklemeleri, her {seconds} saniyelik pencerede {actions} başarılı eylemlerden oluşan bir bütçeyi paylaşır. Reddedilen bir girişimin hiçbir maliyeti yoktur ve bütçe harcamaz. Normal oyunda bunu asla hissetmezsiniz; Bu, tam bir bankaya sahip maksimum bir uzmanın, becerileri veya stokları ne olursa olsun Piyasayı dolduramaması için mevcuttur.",
      ...
      "faq": {
        ...
        "a4": "Beklenmedik bir olaya çarptın. Yaklaşık 90'da 1 hasat, nadir bir toplama olayını tetikler (bir ağaçtaki eski öz odun, cevherdeki bozulmamış bir damar, şifalı bitkilerde ay ışığının aydınlattığı bir çiçek): verimi beş kat artırır, her birimi adınızla imzalar ve bulguyu tüm bölgeye duyurur. Sıradan bir hasattaki nadir veya daha iyi nadirlik, aynı zamanda verime de işaret eder.\n\nİmzalı materyaller saklanmaya veya pahalıya satılmaya değerdir: gerekli bir reaktifin imzalı herhangi bir kopyasını tezgahta tutmak, şaheser şansına yüzde 2 puan ekler. Sadece aynı imzalı kopyalarla istiflendiklerini unutmayın, böylece kendi çanta yuvalarını korurlar.",
        ...
        "a6": "Dokuz ortak saha tarifi ve altı hazırlanmış arazi aleti tarifi en başından beri herkes tarafından bilinmektedir ve aynı şekilde istasyona bağlı üç kapak taşı da (Kilnscale Manto, Wardweave Cowl ve Duskhide Wraps) eğiticiye ihtiyaç duymaz, yalnızca kendi istasyonlarına ihtiyaç duyar. Diğer her şey yerleşik ustalar tarafından üç merkez kasabadaki istasyonlarında öğretiliyor: çoğu Eastbrook'ta, tabakçı Fenbridge'de tabakhaneyi işletiyor ve simyacı Highwatch'ta eczacıyı çalıştırıyor.\n\nEğitmen tarifleri basamaklar halinde yürütülür: ekipman ve sarf malzemeleri için beceri 0, 25 ve 50, ücretsiz olarak fiyatlandırılır, tek seferlik ücret olarak 25 gümüş ve 1 altın; Enchanting'in iki çekicilik tarifi 25. basamakta yer alıyor ve alet yapımcısı, 4 ve 16 altın için 75 ve 125'te iki hazırlanmış oltayı öğretiyor. Bir usta, o gemideki grubunuz tarifin kendi grubuna ulaştığında bir tarif öğretir ve öğrenmek için onların istasyonunda durmanız gerekir: mobil istasyon sayılmaz.",
        "q7": "Toplamam neden aniden yavaşladı?",
        "a7": "Toplama kullanımı 2,5 saniyede başlar ve iki şekilde kısaltılır: Taşıdığınız ve düğümün kendi kademesinin üzerinde kullanabildiğiniz her alet kademesi için 0,4 saniye ve ticaretinizin sayacı 1,5 saniyelik bir tabanla 100 bandını geçtiğinde 0,15 saniye. 1. kademe düğümlerden 3. kademe düğümlere geçtiğinizde fazlalıklarınız ortadan kalkar, böylece aynı seçim tekrar daha yavaş hareket eder. Tam olarak gerekli seviyeyi tutmak hız satın almaz; yalnızca düğümü açar.\n\nBeceri kazanımı, zanaatkarlık ile aynı şekilde kaybolur: uzmanlığınız kendi kademesini aştıkça bir düğüm grileşir (1. kademe düğümler, yeterlilik 75'ten itibaren hiçbir şey öğretmez), dolayısıyla yavaş kazanımların cevabı daha yüksek seviyeli düğümlerdir. Bunların çantalarında en azından kendi seviyelerinde bir alete ihtiyacı var (hiçbir düğüm hiçbir zaman çıplak elle çalıştırılmaz, 1. Kademe dahil) ve 1. Kademe'nin üzerindeki bir kara aracı da kendi ticaretinde 2'den 5'e kadar kendi ticaretinde 40/70/85/100 olmak üzere ilk önce kullanım işaretini ister. Balıkçılık kendi daralmasını takip eder: 50 yeterliliğinin altında tam kazanç, 100'ün altında yarısı, 150'nin altında 0,1 damlama ve 200'ün altında 0,02, hurda avları 100'den itibaren hiçbir şey öğretmez ve suyun kendisi dersi sınırlar (1. kademe sular 100'de öğretmeyi bırakır, bataklık 150'de durur), dolayısıyla durmuş bir sayaç aynı zamanda suyu aştığınız anlamına da gelebilir.",
        "q8": "Kasabadan uzakta zanaat yapabilir miyim?",
        "a8": "Kısmen. Dokuz ortak saha tarifi (başlangıç ​​silahı, zırh, yiyecek ve iksir malzemeleri) her yerde, her zaman hazırlanır ve yeminli çiftlerin üç kombinasyon tarifi de öyle. Üstlerindeki diğer her şey bir istasyon türüne bağlıdır: demirhane, mutfaklar, eczacı, tabakhane, tezgah veya alethane ve geminin geçmesi için istasyonun 20 metre yakınında olmanız gerekir.\n\nUzmanlaştığınız bir zanaatta 75 beceriye ulaştığınızda ve yüzde 20'lik malzeme indirimiyle birlikte bir mobil istasyon kazanırsınız: onu sahaya yerleştirin ve 10 dakika boyunca öylece durur, sanki gerçekte oradaymışsınız gibi o zanaatın tariflerini sunar. Mobil istasyon yalnızca üretim içindir: tarifleri öğrenmek ve bağlayıcı olmayan komisyonlar her zaman şehirdeki gerçek istasyonu gerektirir."
      }
    },
    "economy": {
  ...
  "questUi": {
    ...
    "log": {
      ...
      "cooldownStatus": "Yakında tekrar kullanılabilir",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Bilinmeyen öğe {id}, miktar {count}",
      "unknownItemAriaMasterwork": "Bilinmeyen öğe {id}, miktar {count}, şaheser",
      "unknownItemAriaEnchanted": "Bilinmeyen öğe {id}, miktar {count}, büyülü kopya",
      "unknownItemAriaBound": "Bilinmeyen öğe {id}, miktar {count}, ciltli kopya",
      "unknownItemAriaInstanced": "Bilinmeyen öğe {id}, miktar {count}, üretici markalı kopya"
    },
    "equipment": {
      "empty": "Boş",
    ...
    "vendor": {
      ...
      "buyAriaWithRequirement": "{price} karşılığında {item} satın alın. {requirement}",
      ...
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Tek seferde {count} satın alın",
      "qtyCustom": "Gelenek",
      "qtyCustomAria": "Satın almak için özel bir miktar seçin",
      "buyCountAria": "{price} karşılığında {count} / {item} satın alın",
      "buyCountAriaWithRequirement": "{price} karşılığında {count} veya {item} satın alın. {requirement}",
      "buyQuantityTitle": "Kaç tane {item} satın alın? {max}'e kadar.",
      "buyQuantityInput": "Satın alınacak miktar",
      "buyQuantityConfirm": "Satın almak",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_copper_ore": {
        "name": "İnce Bakır Cevheri"
      },
      "fine_iron_ore": {
        "name": "İnce Demir Cevheri"
      },
      "fine_thorium_ore": {
        "name": "İnce Osmiyum Cevheri"
      },
      "fine_ironbark_log": {
        "name": "İnce Demir Kabuğu Günlüğü"
      },
      "fine_ashwood_log": {
        "name": "İnce Dişbudak Kütüğü"
      },
      "fine_elderwood_log": {
        "name": "İnce Yüksek Çam Kütüğü"
      },
      "fine_silverleaf_herb": {
        "name": "İnce Yapraklı Bitki"
      },
      "fine_goldleaf_herb": {
        "name": "İnce Altınyaprak Bitkisi"
      },
      "fine_sunpetal_herb": {
        "name": "Güzel Günçiçeği Bitkisi"
      },
      "stormreel_fishing_rod": {
        "name": "Stormreel Olta"
      },
      "tidewrought_fishing_rod": {
        "name": "Tidewrought Olta"
      },
      "duskwisp_essence": {
      ...
      "gatherers_cache": {
        "name": "Toplayıcı Önbelleği"
      },
      "artisans_eye": {
        "name": "Zanaatkarın Gözü"
      },
    ...
    "quests": {
      ...
      "q_the_codfather": {
        "title": "Codfather",
        "text": "Morina Baba sadece bir balık değil, {playerName}, o soğukkanlı bir katil. Eskiler onun kahvaltıda Mire Prowlers'ı yediğine yemin ederler ve Mirefen Dulları bile sırf korkudan Deepfen Sığlıkları yakınında ağlarını öremezler. Bu suları o yönetiyor ve bataklık suyu bir Demir Makara Oltasını alıyor; tezgahım onları satıyor. Eline bir tane al, o yaşlı şeytanı sularından çıkar, ben de aileye katıldığını kabul edeceğim.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Bu işaretleri daha önce kuzeydeki savaş alanının çevresindeki üç eski mezarda görmüştüm. Yüzbaşı Aldren batıdaki yükselişte, Baş Rahip Malric batı kenarı boyunca daha güneyde ve Kraliyet Suikastçısı Voss doğudaki uçurumun yanında yatıyor. Her mezara dokunun ve dinleyin, {playerName}. Yaşayanların unuttuğunu ölüler hatırlayabilir.",
