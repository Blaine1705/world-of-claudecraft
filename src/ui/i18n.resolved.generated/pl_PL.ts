...
export const pl_PL: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsNote": "Każdy węzeł wymaga narzędzia swojego fachu w twoich torbach, także na poziomie 1: bez kilofa nie ma rudy, bez wędki nie ma ryb. Drabina sprzedawców obejmuje poziomy od 1 do 3, a każdy ośrodek trzyma tylko te poziomy, których używa jego własny teren: narzędzie 1 poziomu sprzedaje się w ośrodku każdej strefy, a wyższe szczeble sprzedaje się tam, gdzie leżą złoża, które ich wymagają. Przy tych szczeblach sprzedawcy wymagają też biegłości we własnym fachu narzędzia, {tier2} dla poziomu 2 i {tier3} dla poziomu 3, a wiersz podaje wymaganie. Wystarczy, że narzędzie leży w twoich torbach, nie ma slotu na ekwipunek ani trwałości, więc każde to jednorazowy zakup, a to, co już masz, działa dalej. Liczy się tylko poziom przy bramce: kolor rzadkości narzędzia jest kosmetyczny.\n\nPowyżej drabiny sprzedawców są dwa wytwarzane narzędzia, poziomy 4 i 5, produkowane w warsztacie przez inżynierów i nigdy niesprzedawane przez żadnego BNP. Żaden dzisiejszy węzeł nie wymaga więcej niż poziomu 3, więc ich wartość teraz to szybkość: najlepsze narzędzie sprowadza rzucanie do dolnej granicy na niższych węzłach i będzie biletem wstępu, gdy pojawi się wyższy poziom terenu.",
