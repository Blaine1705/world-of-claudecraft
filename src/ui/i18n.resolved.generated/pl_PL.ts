...
export const pl_PL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "deeds": {
      ...
      "lbDeedsCol": "Czyny",
      "lbTitleCol": "Tytuł",
      "lbSelf": "Twoja pozycja: miejsce {rank}, czołowe {percent} procent",
  ...
  "guide": {
    ...
    "deedsPage": {
      ...
      "standingsNote": "Królestwa prowadzą bieżący rachunek Renomy na wszystkich kontach. Aby zobaczyć, kto jak stoi, otwórz Ranking w grze i przejdź do jego zakładki Renomy; zestawienie żyje tam, nie na wiki.",
  ...
  "entities": {
    "abilities": {
      ...
      "bladestorm": {
        "name": "Burza Ostrzy",
        "description": "Stajesz się wirującą burzą stali i przez 4 sek. co sekundę zadajesz {damage} pkt. obrażeń wszystkim wrogom w promieniu 8 m."
      },
      "blink": {
        "name": "Migotliwy Krok",
