...
export const fr_FR: EnTranslations = {
  ...
  "devCommand": {
    "dialogLabel": "Centre de commandes de développement",
    "kicker": "Outils de développement",
    "title": "Centre de commandes",
    "subtitle": "Commandes de test autoritatives pour le monde actif.",
    "closeAria": "Fermer les commandes de développement",
    "categoryNavAria": "Catégories de commandes de développement",
    "categories": {
      "player": "Joueur",
      "spawns": "Apparitions",
    ...
    "actions": {
      "heal": {
        "label": "Rétablir les points de vie",
        "description": "Restaure tous les points de vie."
      },
      "resource": {
        "label": "Rétablir la ressource",
        "description": "Restaure le mana, la rage ou l’énergie."
      },
      "cooldowns": {
        "label": "Réinitialiser les temps de recharge",
      ...
      "revive": {
        "label": "Réanimer",
        "description": "Réanime en suivant le processus normal de résurrection."
      },
      "kill": {
        "label": "Tuer le joueur",
        "description": "Teste les séquences de mort, de fantôme et de cadavre."
      },
      "combatreset": {
        "label": "Réinitialiser le combat",
        "description": "Efface l’état de combat et la menace hostile."
      },
      "level": {
        "label": "Définir le niveau",
        "description": "Définit le niveau du personnage actuel."
      },
      "spawn": {
        "label": "Faire apparaître une créature",
        "description": "Fait apparaître une créature précise près du joueur."
      },
      "killtarget": {
        "label": "Tuer la cible",
        "description": "Tue la créature vivante sélectionnée."
      },
      "despawntarget": {
        "label": "Faire disparaître la cible",
        "description": "Supprime une créature sélectionnée créée avec cet outil."
      },
      "despawnall": {
        "label": "Supprimer mes créatures",
        "description": "Supprime toutes les créatures invoquées par ce développeur."
      },
      "give": {
      ...
      "quest": {
        ...
        "description": "Accomplit une quête précise par son ID."
      },
      "quests": {
        "label": "Accomplir les quêtes actives",
        "description": "Accomplit toutes les quêtes du journal actuel."
      },
      "attune": {
        "label": "Déverrouiller les harmonisations",
        "description": "Marque toutes les conditions d’harmonisation comme remplies."
      },
      "gather": {
      ...
      "dungeon": {
        ...
        "description": "Entre dans un donjon sans tenir compte de la restriction de développement."
      },
      "raid": {
      ...
      "raidreset": {
        ...
        "description": "Efface les verrouillages de raid actuels."
      },
      "bot": {
        "label": "Faire apparaître un bot social",
        "description": "Crée un joueur immobile auquel il est possible de chuchoter."
      },
      "lfgqueue": {
        "label": "Préparer la file de recherche",
        "description": "Crée un scénario de file de recherche de donjons."
      },
      "lfgraid": {
        "label": "Préparer la recherche de raids",
        "description": "Crée un scénario de recherche de raids."
      },
      "lfgboard": {
  ...
  "hudChrome": {
    ...
    "tutorial": {
      ...
      "slayTargetHint": "Vous découvrez le combat ? Appuyez sur {targetKey} ou cliquez sur un loup pour le cibler, puis utilisez une technique de la barre d’action pour l’attaquer.",
      "slayTargetHintTouch": "Vous découvrez le combat ? Touchez un loup pour le cibler, puis touchez une technique de la barre d’action pour l’attaquer.",
      "nextTipsTitle": "Et maintenant ?",
    ...
    "actionBar": {
      ...
      "editKeysHint": "Cliquez sur un emplacement de la barre d'action, puis appuyez sur une touche pour le lier.",
      "bannerHint": "Cliquez sur un emplacement, puis appuyez sur une touche pour le lier. Cliquez sur Terminé lorsque vous avez terminé.",
      "bannerCapturing": "Appuyez sur une touche pour lier cet emplacement...",
      "boundToKey": "Lié à {key}.",
      "reset": "Réinitialiser",
      "done": "Fait",
      "cancel": "Annuler",
      "resetConfirmTitle": "Réinitialiser les touches de la barre d'action ?",
      "resetConfirmBody": "La première barre revient à ses touches par défaut. Les deuxième et troisième barres ne sont plus liées. Cela ne peut pas être annulé."
    },
    "mounts": {
      "title": "Montures",
      "close": "Fermer",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "Dans les tranches 1v1 et 2v2, chaque combattant joue le kit All-Rounder. Les exploits qui nécessitent le support 3v3 ou plus ne peuvent pas être gagnés ici.",
      "role": {
        "allrounder": {
          "name": "Polyvalent",
      ...
      "practiceUnratedNote": "Les combats d'entraînement ne sont pas classés : le classement et la progression du Livre des Actes ne comptent pas.",
      ...
      "briefing": {
        ...
        "unratedNote": "Les robots sont sur le terrain, donc ce combat n'est pas classé : le classement ne bouge pas, et les actes de buts, les arrêts et les feuilles blanches ne comptent pas.",
        "practiceUnratedNote": "Il s'agit d'un combat d'entraînement, il n'est donc pas classé : le classement ne bouge pas et la progression du Livre des Actes ne compte pas.",
    ...
    "talentRows": {
      ...
      "readoutSummary": "Talents : {head}, {spent}/{total} rangées sélectionnées."
    },
    "abilityError": {
      "shieldRequired": "Vous devez équiper un bouclier."
    },
    "specPanel": {
      "primaryAttr": "Caractéristique principale",
    ...
    "auraEffect": {
      ...
      "dieBySword": "Réduit les dégâts subis de {pct}%",
      ...
      "powerEchoNext": "Votre prochain sort direct se répète à {pct} % de puissance sur la même cible",
      ...
      "imbueRange": "Arme imprégnée : {min} à {max} dégâts bonus au Verdict",
    ...
    "partyFrames": {
      ...
      "styleAutomatic": "Automatique",
      "styleClassic": "Cadres de groupe classiques",
      "styleRaid": "Cadres de raid",
      "scale": "Échelle du cadre",
      "width": "Largeur du cadre",
      "height": "Hauteur du cadre",
      "spacing": "Espacement des cadres",
      "columns": "Colonnes de raid",
      "healthText": "Texte des points de vie",
      "healthNone": "Aucun",
    ...
    "materialHint": {
      "fineGrade": "Belle qualité. Réuni à partir d'une veine de niveau complet avec un outil classé au-dessus du matériau, et compte comme la version ordinaire partout où on en a besoin.",
    ...
    "discord": {
      ...
      "roleTagChatTitle": "Rôle de serveur vérifié : {role}",
    ...
    "mailbox": {
      ...
      "parcelQtyAria": "Quantité de {item} à envoyer",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Vous avez besoin d'une canne à pêche de niveau {tier} pour pêcher ces eaux."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Vous avez besoin de Mining {skill} pour balancer la pioche déjà dans vos sacs.",
        "logging": "Vous avez besoin de Logging {skill} pour balancer la hache déjà dans vos sacs.",
        "herbalism": "Vous avez besoin d'Herboristerie {skill} pour travailler la faucille déjà dans vos sacs."
      },
      "wieldUnmetCorpse": "Vous avez besoin de rassembler la compétence {skill} pour mettre en œuvre votre meilleur outil.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Nécessaire pour pêcher les eaux jusqu’au niveau {tier}."
        },
        "use": {
      ...
      "emptyHookNote": "Rien sur le crochet",
      "stateReady": "Disponible",
      "stateCooldown": "En repoussement",
      "stateCooldownTimed": "Réapparaît dans {time}",
      "respawnClock": "{minutes} :{seconds}",
      "fineGradePreview": "Votre outil affine ce rendement jusqu'à obtenir une qualité fine."
    },
    "archetypeTitle": {
      "label": "Titre",
      "none": "Aucun",
    ...
    "archetypePair": {
      ...
      "alchemy+cooking": "Apothicaire",
      "cooking+leatherworking": "Trappeur",
      "leatherworking+tailoring": "Équipementier",
      "tailoring+inscription": "Tisserand des arcanes",
      "inscription+enchanting": "Arcaniste",
      "enchanting+jewelcrafting": "Pierrelier",
      "jewelcrafting+weaponcrafting": "Maître-lame",
      "weaponcrafting+armorcrafting": "Forgeron",
      "armorcrafting+engineering": "Rouagier"
    },
    "craftName": {
      "armorcrafting": "Fabrication d'armures",
    ...
    "enchantName": {
      ...
      "enchant_chest_stamina": "Enchantement Torse - Endurance",
      "enchant_waist_stamina": "Enchantement Ceinture - Endurance",
      "enchant_legs_stamina": "Enchantement Jambières - Endurance",
      "enchant_gloves_agility": "Enchantement Gants - Agilité",
      "enchant_gloves_intellect": "Enchantement Gants - Puissance des sorts",
      "enchant_feet_agility": "Enchantement Bottes - Agilité",
      "enchant_ring_spirit": "Enchantement Anneau - Esprit",
      "enchant_weapon_agility": "Enchantement Arme - Agilité",
      "enchant_helmet_intellect": "Enchantement Casque - Intellect",
      "enchant_helmet_armor": "Enchantement Casque - Renforcement",
      "enchant_neck_intellect": "Enchantement Collier - Intellect",
      "enchant_neck_agility": "Enchantement Collier - Agilité",
      "enchant_shoulder_strength": "Enchantement Épaulières - Force",
      "enchant_shoulder_intellect": "Enchantement Épaulières - Intellect",
      "enchant_chest_spirit": "Enchantement Torse - Esprit",
      "enchant_chest_armor": "Enchantement Torse - Renforcement",
      "enchant_waist_strength": "Enchantement Ceinture - Force",
      "enchant_waist_agility": "Enchantement Ceinture - Agilité",
      "enchant_legs_intellect": "Enchantement Jambières - Intellect",
      "enchant_gloves_strength": "Enchantement Gants - Force",
      "enchant_feet_strength": "Enchantement Bottes - Force",
      "enchant_feet_stamina": "Enchantement Bottes - Endurance",
      "enchant_ring_strength": "Enchantement Anneau - Force",
      "enchant_ring_agility": "Enchantement Anneau - Agilité",
      "enchant_ring_intellect": "Enchantement Anneau - Intellect",
      "enchant_weapon_greater_might": "Enchantement Arme - Puissance supérieure",
      "enchant_weapon_greater_spellpower": "Enchantement Arme - Puissance de sorts supérieure",
      "enchant_helmet_greater_fortitude": "Enchantement Casque - Fortitude supérieure",
      "enchant_chest_greater_stamina": "Enchantement Torse - Endurance supérieure",
      "enchant_legs_greater_stamina": "Enchantement Jambières - Endurance supérieure",
      "enchant_gloves_greater_agility": "Enchantement Gants - Agilité supérieure",
      "enchant_weapon_runed_edge": "Enchantement Arme - Tranchant runique",
    ...
    "professions": {
      "title": "Métiers",
      "close": "Fermer les métiers",
      "ringAria": "Roue artisanale",
      "skillsHeader": "Compétences artisanales",
      "gatheringHeader": "Rassemblement",
      "perksHeader": "Avantages",
      "identityHeader": "Identité",
      "roleMajor": "Majeur",
      "roleHobby": "Passe-temps",
      "roleDormant": "Dormant",
      "roleUnattuned": "Inadapté",
      "ceilingUnlimited": "Sans plafond de renforcement",
      "ceilingRare": "Plafond rare",
      "ceilingCommon": "Plafond commun",
      "skillValue": "{skill} / {max}",
      "toolEffectCharges": "{charges} sur {max} frais",
      "toolEffectSpent": "Dépensé, doit être rechargé",
      "toolEffectDepleted": "Effet d'outil dépensé",
      "toolEffectRechargePrice": "Recharge : {count} x {material}",
      "toolEffectModeAsk": "Poser à chaque utilisation",
      "toolEffectModePrompt": "Demande à chaque utilisation",
      "toolEffectConfirmTitle": "Utiliser {effect} ?",
      "toolEffectConfirmBody": "Dépenser une charge pour cette récolte ? Le déclin rassemble toujours, sans le bonus. Charges restantes : {charges}.",
      "toolEffectConfirmAccept": "Utiliser une charge",
      "toolEffectConfirmDecline": "Rassemblez-vous sans",
      "toolEffectName": {
        "gatherersCache": "Cache du récolteur",
        "artisansEye": "Oeil de l'artisan",
        "quickeningCharm": "Charme élastique"
      },
      "toolEffectSlotButton": "Emplacement {effect}",
      "toolEffectRechargeButton": "Recharger",
      "toolEffectSlotted": "{effect} inséré sur {profession}.",
      "toolEffectSlotInvalid": "{effect} ne peut pas y être inséré.",
      "toolEffectNoTool": "Vous avez d’abord besoin d’un véritable outil {profession}.",
      "toolEffectNoCharm": "Vous avez besoin d’une breloque {effect} artisanale dans vos sacs.",
      "toolEffectNoGain": "{effect} est déjà inséré et complètement chargé.",
      "toolEffectRecharged": "{effect} rechargé : {material} x{count} consommé.",
      "toolEffectRechargeNoSlot": "Aucun effet n'est placé sur {profession}.",
      "toolEffectRechargeFull": "{effect} est déjà complètement chargé.",
      "toolEffectRechargeToolCapped": "Emportez un meilleur outil {profession} pour charger davantage {effect}.",
      "toolEffectRechargeMaterials": "La recharge de {effect} nécessite {material} x{count}.",
      ...
      "nextUnlockMastered": "Maîtrisé, pour l'instant",
      ...
      "syncing": "En attente de vos données professionnelles du royaume.",
      ...
      "ctaRaiseSpecialized": "Continuez à augmenter {craft} : encore {points} points jusqu'à Spécialisé, et les coûts en matériaux baissent.",
      ...
      "nudgeDormant": "Vos connaissances {craft} sont en sommeil",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(dépense {count} en qualité fine)",
      ...
      "comboMet": "Prêt.",
      "comboSyncing": "Vérification de la communion du royaume.",
      "comboNotAttuned": "Choisissez d'abord une paire d'archétype.",
      "comboWrongPair": "Activez cette paire exacte pour le fabriquer.",
      "comboTierUnmet": "Élevez les deux métiers majeurs au palier requis.",
      "comboTierUnmetNamed": "Augmentez {crafts} au niveau {tier}.",
      "professionChoice": "Choix de profession",
      "noProfessionChoice": "Aucun choix de profession valide n'est disponible en ce moment.",
      "pairOptionLabel": "{pair} ({craftA} + {craftB})",
      "attunementPreview": "Résultat : titre {title} ; {majorA} et {majorB} deviennent des majeures sans plafond ; {hobby} devient le passe-temps plafonné rare ; toutes les autres connaissances de métier sont conservées mais plafonnées à commun tant qu'elles sont dormantes.",
      "hobbyPreview": "Résultat : {hobby} devient le passe-temps plafonné rare. Les deux majeures et toutes les valeurs de compétences conservées restent inchangées.",
      "attunementReturnCost": "Si vous quittez cette paire, y revenir plus tard vous coûte {cost} tâches d'amende.",
      "identity": {
        "title": "Identité d'artisan",
        "syncing": "En attente de votre identité d'artisan du royaume.",
        "unattuned": "Aucune paire d'archétype n'est active. Vos connaissances sont conservées, mais les recettes combinées nécessitent une paire communiée.",
        "titleLabel": "Titre",
        "majorsLabel": "Majeures",
        "hobbyLabel": "Passe-temps",
        "historyLabel": "Historique",
        "history": "{pairs} paires découvertes, {returns} retours effectués",
        "roleMajor": "Majeure",
        "roleHobby": "Passe-temps",
        "roleDormant": "Connaissance dormante",
        "roleUnattuned": "Non-communié",
        "ceilingUnlimited": "Sans plafond de renforcement",
        "ceilingRare": "Plafond rare",
        "ceilingCommon": "Plafond commun",
        "skillAria": "{craft}, compétence {skill}, palier {tier}, {role}, {ceiling}",
        "colCraft": "Métier",
        "colSkill": "Compétence",
        "colRole": "Rôle",
        "colCap": "Plafond",
        "allCrafts": "Tous les métiers",
        "skillListAria": "Compétences artisanales",
      ...
      "difficultyMinimal": "Gain de compétence minimal",
      "difficultyNone": "Aucun gain de compétence",
      "stationBadge": "Poste",
      "stationOutOfRangeNamed": "Déplacez-vous vers le {station} pour le fabriquer.",
      "learnMoreAtStation": "{master} à {station} peut vous enseigner d'autres recettes de {craft}.",
    ...
    "training": {
      ...
      "close": "Fermer la formation",
      "empty": "Ce maître n'a rien à enseigner.",
      "free": "Gratuit",
      "stateKnown": "Connu",
      ...
      "tierUnmet": "Vous avez besoin de {craft} {skill} pour apprendre cette recette.",
      "cannotAfford": "Vous ne pouvez pas vous permettre cette formation.",
      "notTaughtHere": "Cette recette n'est pas enseignée ici.",
    ...
    "unbind": {
      ...
      "intro": "Le maître peut libérer une pièce de commande de son lien, contre une somme.",
      "empty": "Vous ne portez aucune pièce de commande liée.",
      "rowSub": "Libère le lien ; la pièce se lie à nouveau lors de son prochain échange.",
      "unbindAria": "Délier {name} pour {fee}",
      "dialogOption": "Déliage",
      "dialogOptionAria": "Délier une pièce de commande avec {name}",
      "confirmTitle": "Délier la pièce de commande",
      "confirmBody": "Délier {name} pour {fee} ?",
      "confirmOk": "Délier",
      "confirmCancel": "Annuler",
      "unbound": "{name} délié pour {fee}. Il se liera à nouveau lors de son prochain échange.",
    ...
    "deeds": {
      ...
      "close": "Fermer le Livre des hauts faits",
      "searchPlaceholder": "Rechercher un haut fait",
      "searchAria": "Rechercher des hauts faits par nom",
      "renownLabel": "Renommée",
      ...
      "filterUnearned": "À obtenir",
      "filterNearly": "Presque finis",
      "categoriesAria": "Catégories de hauts faits",
      "catProgression": "Progression",
      "catCombat": "Combat",
      "catDungeon": "Donjons",
      "catDelve": "Plongées",
      "catChronicle": "Chroniques",
      "catCollection": "Collection",
      "catPvp": "JcJ et sport",
      "catSocial": "Social",
      "catExploration": "Exploration",
      "catFeat": "Prouesses",
      "categoryCountAria": "{category}: {earned} hauts faits obtenus sur {visible}",
      "emptyCategory": "Aucun haut fait ne correspond ici.",
      ...
      "watchFull": "Liste de suivi pleine ({cap} max)",
      "watchAria": "Ajouter {name} au suivi à l'écran",
      "unwatchAria": "Ne plus suivre {name}",
      "titlesSection": "Titres",
      "titlesAria": "Choisissez le titre à afficher",
      "titlesNone": "Aucun titre",
      "titlesEmpty": "Obtenez un haut fait qui confère un titre pour débloquer cette étagère.",
      "unlockedBanner": "Haut fait accompli: {name}",
      "unlockedTitleHint": "Nouveau titre obtenu: {title}. Choisissez-le dans le Livre des hauts faits.",
      "retroSummary": "Votre chronique rattrape son retard: {count} hauts faits consignés.",
      ...
      "openBookHint": "Ouvrir le Livre des hauts faits",
      "charTitleLabel": "Titre",
      "charTitleNone": "Aucun titre choisi",
      "charOpenBook": "Livre des hauts faits",
      "lbTab": "Renommée",
      "lbTitleCol": "Titre",
      "lbScopeNote": "Comptes classés par Renommée à vie. Chaque haut fait est comptabilisé une seule fois sur tous les personnages d'un compte.",
      ...
      "broadcastsLabel": "Partagez les exploits déverrouillés avec les membres de la guilde et les adeptes, ainsi que les cartes d'exploits et de chefs-d'œuvre avec le flux Discord.",
  ...
  "gatherEvent": {
    "pristineVein": "{finder} a touché une veine vierge !",
    "ancientHeartwood": "{finder} a abattu un bois de cœur ancien !",
    "moonlitBloom": "{finder} a découvert une floraison au clair de lune !"
  },
  "apiError": {
    "validation": {
    ...
    "steam": {
      ...
      "banned": "Ce compte Steam ne peut pas être lié.",
  ...
  "guide": {
    ...
    "nav": {
      ...
      "sidebarLabel": "Rubriques du guide",
    ...
    "howToPlay": {
      ...
      "step2Body": "Le maréchal Redbrook vous attend dans la ville de départ avec Les loups à nos portes, et le contremaître Odell, tout près, a lui aussi du travail. Parlez à l'un ou à l'autre pour accepter votre première quête.",
      ...
      "reassure": "Les talents se débloquent au niveau 10 et peuvent être réinitialisés à tout moment hors combat, donc vos premiers choix ne sont jamais définitifs. Expérimentez librement.",
      "controlsLink": "Voir la référence complète des commandes"
    },
    "controls": {
      "intro": "Touches par défaut sur ordinateur. Chaque raccourci peut être modifié dans les options du jeu, sauf Échap, qui ouvre toujours le menu du jeu, et un raccourci peut être une combinaison avec modificateur comme Maj+Z.",
      "keyHeader": "Touche",
      "actionHeader": "Action",
      ...
      "groupPet": "Commandes du familier",
      "petBar": "Barre du familier : Attaquer, Arrêter, Provoquer, Défensif, Agressif (avec un familier de chasseur ou de démoniste sorti)",
      "attackMoveNote": "Une de plus, désactivée par défaut : activez le Déplacement d'attaque dans les options pour réserver une touche (A, tant que l'option est active) qui vous fait marcher vers votre curseur et ouvre le feu sur l'ennemi qui s'y trouve, ou sur le premier rencontré en chemin.",
      "mobileHeading": "Sur mobile",
      "mobileBody": "Les commandes tactiles apparaissent automatiquement sur téléphones et tablettes : un joystick de déplacement à gauche, un glissement n'importe où ailleurs pour regarder, un pincement à deux doigts pour zoomer la caméra, et des boutons à l'écran pour vos capacités et vos menus. Une petite flèche dans le coin supérieur gauche affiche ou masque les boutons de menu, et le bouton Plus qui s'y trouve renferme le reste de vos fenêtres.",
    ...
    "settingsPage": {
      ...
      "factSearchTitle": "La recherche le trouve d'abord",
      "factSearchBody": "Vous ne savez pas où se trouve une option ? Tapez dans la barre de recherche en haut du menu. Elle comprend aussi les tournures courantes, si bien que fps trouve l'affichage des FPS, et choisir un résultat vous amène droit au réglage en le laissant en surbrillance.",
      ...
      "tableHeading": "Chaque option graphique, expliquée",
      ...
      "touchBody": "Sur écran tactile, les options se dotent en plus de tout un groupe de confort : taille et sensibilité du joystick, taille et opacité des boutons à l'écran, une disposition inversée pour gauchers, un stick de caméra optionnel et une visée tactile inversée, pour que l'écran s'adapte à vos mains plutôt que l'inverse.",
      "audioTitle": "Son et langue",
      "audioBody": "La fenêtre d'options n'est pas faite que de pixels. Une catégorie Audio réunit des réglages de volume distincts pour les effets, la musique et les voix, et la catégorie Interface propose un sélecteur de langue qui relocalise toute l'interface sur-le-champ, sans rechargement, ainsi qu'un sélecteur de thème pour l'habillage des fenêtres. La langue est aussi épinglée en tête de l'Aperçu, à un pas de l'ouverture du menu.",
      "autolootBody": "Vous préférez ne pas cliquer sur chaque cadavre ? Une option d'interface, désactivée par défaut, ramasse le butin de vos propres éliminations lorsque vous passez à côté."
    },
    "combat": {
      ...
      "growBody": "Chaque niveau vous rend plus robuste et débloque de nouvelles capacités, jusqu'au plafond de niveau {cap}. Les quêtes sont le moyen le plus rapide de progresser ; la chasse, les donjons et les gouffres complètent le tableau.",
    ...
    "glossary": {
      ...
      "deedTerm": "Haut fait",
      "deedDef": "Un haut fait consigné dans le Livre des hauts faits. En obtenir un accorde de la Renommée, et certains octroient un titre cosmétique ou une bordure de plaque d'identification.",
      "renownTerm": "Renommée",
      "renownDef": "Le score cumulé que totalisent vos hauts faits. Il ne fait que grimper, et le royaume en conserve les rangs sur le Classement.",
      "heroicTerm": "Héroïque",
      "heroicDef": "La version plus difficile d'un donjon ou du raid, calibrée pour les groupes de fin de partie bien équipés. Les boss héroïques lâchent un butin amélioré, et le boss final paie en Marques héroïques.",
      "lockoutTerm": "Verrouillage",
      "lockoutDef": "Un plafond quotidien sur les plus grosses récompenses répétables. Chaque donjon héroïque n'accorde qu'un nettoyage par jour, le raid suit le normal et l'héroïque séparément, et piller un boss de monde déclenche le vôtre. Une expédition à cinq joueurs déjà nettoyée reste ouverte à son propre groupe ; la porte verrouillée du raid ne se rouvre qu'à la réinitialisation.",
      "restedTerm": "Reposé",
      "restedDef": "L'expérience bonus que votre personnage met en réserve en se reposant à l'auberge, hors combat. Vos prochaines éliminations rapportent un surplus d'expérience jusqu'à épuisement de la réserve.",
      ...
      "loadoutDef": "Une configuration de talents enregistrée. Gardez-en plusieurs et passez d'un build à l'autre sans redépenser vos points un par un.",
      "readyCheckTerm": "Vérification de préparation",
      "readyCheckDef": "Un chef de groupe qui tape /ready pour sonder le groupe ou le raid : chacun confirme Prêt ou Pas prêt, et le groupe voit le décompte.",
      "soulboundTerm": "Lié à l'âme",
      "soulboundDef": "Un objet lié à votre personnage dès l'instant où vous l'acquérez. Il ne peut être échangé, envoyé par courrier, vendu à un marchand ni mis en vente sur le marché.",
      "spiritHealerTerm": "Le Veilleur pâle",
      "spiritHealerDef": "Le guérisseur d'esprit du royaume, planant au-dessus de chaque cimetière : il peut relever votre esprit sur place au prix d'une faiblesse passagère.",
    ...
    "faqPage": {
      ...
      "a2": "Non. Le jeu est entièrement jouable sans cela. Le jeton communautaire optionnel n'ajoute que des fioritures cosmétiques et une part de la cagnotte des récompenses quotidiennes, et il n'affecte jamais la puissance ni la progression.",
      ...
      "a4": "Oui. Il existe un mode solo hors ligne instantané, et le monde en ligne est entièrement réalisable en solo, hormis les donjons, le raid et le boss de monde.",
    ...
    "classPage": {
      ...
      "fullKitNote": "La panoplie que cette classe apprend en montant en niveau, dans l'ordre où elle se débloque. Les talents accordent quelques capacités de plus et décident lesquelles portent votre build.",
      "petsHeading": "Démons",
    ...
    "abilityHook": {
      ...
      "brain_freeze": "Vos éclairs de givre créent parfois le prochain instant Flurry et sautent son temps de recharge.",
    ...
    "bestiary": {
      "heading": "Bestiaire",
      "intro": "Les créatures du monde, regroupées par famille. Voici les adversaires ordinaires que vous croisez à ciel ouvert. Les ennemis d'élite et leurs seigneurs de guerre se tiennent à l'écart de ces pages, et les plus redoutables de tous attendent derrière les portes des donjons.",
      "rare": "Rare",
      "levels": "Niveaux {min} à {max}",
      ...
      "flavor": {
        ...
        "sethrael_palecoil": "Un serpent d'une pâleur d'os qui glisse dans les profondeurs du Glimmermere, gardien silencieux de l'eau qu'il a faite sienne. Les nageurs qui partagent le lac avec lui refont rarement surface.",
    ...
    "questsPage": {
      ...
      "acceptBody": "Les personnages arborant un marqueur au-dessus de la tête ont du travail pour vous. Parlez-leur pour accepter une quête. À Eastbrook, le maréchal Redbrook vous attend avec Les loups à nos portes, l'une des premières quêtes que vous puissiez accepter.",
      ...
      "typeSlayTitle": "Tuer",
      "typeSlayBody": "Éclaircissez une meute de bêtes ou brisez l'emprise d'un culte en vainquant un nombre donné d'un ennemi désigné. L'une de vos premières quêtes, débarrasser la route d'Eastbrook de ses loups, est de celles-là.",
      "typeGatherTitle": "Récolter",
      "typeGatherBody": "Récoltez des objets dans le monde ou sur ce que lâchent les ennemis : herbes, minerai, sinistres réactifs d'un culte. Certaines pièces ne tombent que d'un adversaire précis, si bien que la chasse et la récolte vont de pair.",
    ...
    "dungeonsPage": {
      ...
      "heroicBody": "Chaque donjon à cinq joueurs, et le raid lui-même, possède une version héroïque qui vous attend au-delà du plafond de niveau. Les mêmes salles, refaçonnées pour un groupe de fin de partie bien équipé : tout frappe plus fort, plus rien ne se distance à la course, et les boss ignorent complètement étourdissements et entraves. Dépassez d'abord les versions normales ; l'héroïque suppose que c'est fait.",
      "heroicHowBody": "Choisissez la difficulté avant que votre groupe ne réserve l'instance : tapez /dungeon heroic, ou basculez l'option Difficulté du donjon dans le menu de groupe. Le choix est partagé par tout le groupe et se verrouille à la porte, si bien qu'une expédition reste ce pour quoi elle a été lancée.",
    ...
    "delvesPage": {
      ...
      "whereBody": "La première plongée, le Reliquaire effondré, s'ouvre à la colline du Reliquaire, dans la vallée de départ du Val d'Eastbrook. Frère Halven y tient le tableau, et il vous enverra en bas dès que vous serez prêt. Sa tournée ne s'arrête pas là : au-delà des Tertres des trolls, à la lisière nord du marais de Mirefen, le même gardien ouvre La Litanie noyée aux plongeurs qui ont trouvé leurs marques."
    },
    "talentsPage": {
      ...
      "choiceNote": "Quelques points de chaque arbre sont un carrefour plutôt qu'un achat : le nœud propose deux ou trois options et vous vous engagez sur l'une d'elles. Votre prochaine réinitialisation rouvre le choix, comme tout le reste de l'arbre.",
      "resetTitle": "Rien n'est définitif",
      "resetNote": "Vous pouvez réinitialiser vos talents à tout moment hors combat et hors match d'arène : un choix précoce n'est donc jamais un piège. Essayez des choses, voyez ce qui vous plaît, et changez d'avis librement.",
      "specsHeading": "Spécialisations par classe",
      "specsBody": "Chaque classe possède une poignée de spécialisations, chacune avec son propre rôle et une orientation emblématique. En choisir une dans le panneau de talents accorde une capacité emblématique et une maîtrise durable qui lui est propre. Voici à quoi elles ressemblent toutes. Ouvrez une classe pour voir sa panoplie complète."
    },
    "arenaPage": {
    ...
    "deedsPage": {
      ...
      "renownBody": "La Renommée est le score qui sous-tend le Livre. Chaque haut fait que vous obtenez vaut un montant défini, et votre total ne fait que croître, si bien qu'une semaine calme ne vous coûte jamais de terrain. Une poignée de hauts faits repose sur la chance plutôt que sur le talent, et les Prouesses sont un honneur à part entière : ces deux catégories ne rapportent donc aucune Renommée. Les hauts faits sans Renommée comptent quand même dans votre Livre au titre de la complétion ; ils ne rapportent simplement jamais de points.",
      ...
      "standingsNote": "Les royaumes tiennent un décompte permanent de la Renommée sur tous les comptes : le classement regroupe les comptes entiers par Renommée à vie, comptant chaque haut fait une seule fois sur tous vos personnages, et il affiche uniquement la Renommée, de sorte que les hauts faits sans Renommée ne font jamais bouger le classement même s'ils comptent dans votre Livre. Pour voir qui se situe où, ouvrez le Classement en jeu et consultez son onglet Renommée ; le classement s'y trouve, pas sur le wiki.",
      "catHeading": "{label} ({count})",
      "colName": "Haut fait",
      "colRenown": "Renommée",
      "colReward": "Récompense",
      "featTag": "Prouesse",
      "rewardBorder": "Bordure",
      "cat": {
    ...
    "professions": {
      ...
      "craftMasteryTitle": "Combien de temps dure la maîtrise",
      ...
      "archetypeSwitchBody": "Une déclaration n’est pas non plus une condamnation à perpétuité. Une paire que vous n'avez jamais détenue est simplement une nouvelle quête d'harmonisation, tandis que revenir à une paire dont vous vous êtes éloigné vous demande d'abord de faire amende honorable : cinq tâches la première fois, et trois autres ajoutées pour chaque retour que vous avez déjà effectué (prendre une toute nouvelle paire n'augmente jamais le décompte). Le choix reste significatif sans jamais verrouiller définitivement une porte.",
      "whatHeading": "Un métier à côté de l'épée",
      "whatBody": "Les professions constituent la vie active du monde : quatre métiers de collecte qui extraient la matière première directement de la terre, et un ensemble de dix métiers qui la transforment en équipement, repas, potions et outils. Ici, tout nourrit autre chose. Le minerai que vous extrayez devient une lame, la lame subit un enchantement et l'enchantement a besoin de poussière extraite du vieil équipement, donc un cueilleur, un artisan et un bricoleur sont tous des maillons d'une même chaîne.\n\nIl n’y a pas de limite professionnelle sur laquelle s’inquiéter. Chaque personnage peut exercer sept des huit métiers qui ont du contenu aujourd'hui et les quatre professions rassemblées côte à côte (l'ingénierie est la seule à résister : ses recettes commencent toutes au-dessus du plafond libre, donc son échelle attend le serment du Bombardier) ; le seul choix exclusif est votre archétype, l'identité que vous avez finalement juré, mais une fois que vous avez harmonisé les métiers qui dorment derrière lui, vous ne grimpez que sur leurs recettes communes, et la compétence passée 75 ne le fait pas du tout. Les compétences ne diminuent jamais et rien de ce que vous apprenez ne vous est jamais retiré.",
      ...
      "capFmt": "Plafond {cap}",
      "comingSoon": "Pas encore de recettes",
      ...
      "archetypesBody": "Les dix embarcations reposent sur une roue fixe, et la géographie sur cette roue compte. Tous les deux voisins forment une paire nommée : Smith pour la fabrication d'armes et d'armures, pourvoyeur pour le travail du cuir et la couture, apothicaire pour l'alchimie et la cuisine, Bombardier pour l'ingénierie et l'alchimie, et six autres autour du ring.\n\nS'accorder à une paire est une quête, pas un clic de menu. Quatre paires peuvent être rejointes aujourd'hui (Smith, Outfitter, Apothecary et Bombardier), chacune étant ancrée par un maître résident à Eastbrook dont la quête d'acceptation indique l'intégralité du marché avant que vous ne l'acceptiez. Jusqu'à ce que vous le déclariez, chaque métier avance librement sur les recettes jusqu'au niveau rare (toute recette demandant une compétence de 74 ou moins), vous pouvez donc presque tout essayer avant de choisir (l'ingénierie seule n'a pas de recette aussi basse, donc son nombre attend).\n\nUne fois que vous vous êtes accordé, vos deux métiers en paire deviennent vos spécialités, sans plafond avant le plafond. Le reste de la roue ne s'éteint pas : un vaisseau opposé à vos spécialités reste un passe-temps qui continue de gravir les niveaux rares (une quête répétable à la forge de Smith Haldren vous permet d'échanger lequel), et tous les autres métiers restent en sommeil. Un métier en sommeil conserve son savoir-faire et ses recettes communes, qui continuent de lui enseigner la courbe normale jusqu'à ce qu'ils grisissent à 75 ; tout ce qui est au-dessus du commun cesse de payer d'un seul coup, et un vaisseau endormi ne se révèle jamais un chef-d'œuvre pendant qu'il se repose.",
      "pairFmt": "{a} et {b}",
      ...
      "provenanceBody": "Le beau travail dans ce monde se souvient de son créateur : les récoltes et fabrications de qualité rare ou supérieure arrivent signées (Collecté par, Fabriqué par), un chef-d'oeuvre s'achève un palier de qualité supérieur avec le nom du créateur toujours dessus, et une pièce de commande se lie à son destinataire par le Lien du Créateur. La page de l'Économie d'artisanat contient les règles complètes, des signatures et de l'empilement aux frais de déliaison.",
      "stationsHeading": "Stations et les trois camps de base",
      "stationsBody": "Six stations spécialisées servent les sept métiers liés à une station, réparties dans les trois camps de base. Eastbrook abrite la forge (la Fabrication d'armes et la Fabrication d'armures la partagent), les cuisines, le métier à tisser et l'outillage ; Fenbridge dispose de la tannerie, et Highwatch de l'apothicaire. Chaque station possède un maître résident à côté qui enseigne des recettes, publie des bons de travail et propose le service de déliaison.\n\nLe rayon de travail est de 20 mètres, soit à peu près la cour de la station, donc vous fabriquez en vous tenant à l'enclume plutôt que depuis l'autre côté de la ville. La Joaillerie, l'Inscription et l'Enchantement n'ont pas de station : les deux premières attendent leurs recettes, et l'Enchantement fonctionne partout par conception.",
      ...
      "startBody": "Vous venez de sortir de la route à Eastbrook ? Trouvez le contremaître Odell et prenez Un métier pour chaque main : il vous indiquera les veines de minerai autour de la mine de cuivre au sud-est de la ville et vous remettra vos premières callosités. Faites attention aux fouilles elles-mêmes : les Deeprock Diggers qui y campent se trouvent quelques niveaux au-dessus d'une nouvelle arrivée, alors travaillez d'abord sur les veines périphériques et conservez le cœur du camp pour une fois que vous aurez un peu nivelé. À partir de là, récoltez chaque veine, chaque peuplement de bois et chaque parcelle d’herbes que vous traversez au cours de votre quête ; la compétence vient naturellement aux voyageurs.\n\nDe retour en ville, appuyez sur T pour ouvrir la fenêtre de fabrication et travailler les recettes communes que chaque personnage connaît depuis le début. Rendez visite aux maîtres à la forge, aux cuisines, au métier à tisser et à l'outillage pour voir ce qu'ils enseignent et prenez leurs bons de travail contre de l'argent. Au moment où la lettre de la Guilde vous trouvera, vous saurez déjà quel couple se sent comme chez lui.",
      "colStation": "Station",
      "colHub": "Camp de base",
      "colMaster": "Maître",
    ...
    "profPages": {
      "back": "Retour aux métiers",
      "capLabel": "Plafond de compétence",
      "stationLabel": "Station",
      "stationNone": "Aucune station requise",
      "stationAnywhere": "Partout",
      "mastersLabel": "Maîtres",
      "masterFmt": "{name} ({hub})",
      "specializationLabel": "Spécialisation",
      "specializationFact": "Compétence {at} : {pct}% de réduction sur les matériaux",
      "matFmt": "{name} x{count}",
      ...
      "colSource": "Source",
      "colStation": "Station",
      "colMaterials": "Matériaux",
      "colQuality": "Qualité",
      "colGain": "Gain s'estompe à",
      ...
      "colZone": "Zone",
      "colNodes": "Nœuds",
      "colNodeTier": "Palier du nœud",
      "colToolNeeded": "Outil requis",
      "craftIntro": {
        "weaponcrafting": "La Fabrication d'armes est l'établi de la forge d'Eastbrook : haches, masses, lames, lances et même un bâton de lanceur de sorts, des débuts en cuivre jusqu'aux rares travaux en osmium et glypheacier. Une arme est l'amélioration la plus ressentie qu'un niveau puisse offrir, si bien qu'un forgeron d'armes est l'ami dont tout le monde se souvient de faire la connaissance.",
        "armorcrafting": "La Fabrication d'armures forge du mailles, l'armure la plus lourde qu'un artisan puisse créer, des simples plaques de cuivre rivetées jusqu'au rare ensemble d'écailles d'osmium, avec quelques pièces aux statistiques de lanceur de sorts en prime. Sa clientèle, ce sont ceux qui se tiennent là où les coups tombent.",
        "tailoring": "La Couture tisse les habits d'Intellect et d'Esprit dans lesquels vivent les lanceurs de sorts en tissu, des simples toiles jusqu'à l'ensemble tissedor et aux rares pièces en soie de soleil, et confectionne la Besace en soie filée, un sac à dix emplacements que personne ne refuse jamais.",
        ...
        "engineering": "L'ingénierie construit les outils que tout collectionneur sérieux finit par vouloir : les pioches, les haches, les faucilles et les cannes à pêche de niveau 4 et 5 qu'aucun compteur ne vendra jamais contre de l'argent, chacun consommant l'outil en dessous.",
        "enchanting": "L'enchantement démonte l'équipement et redonne le pouvoir : brisez les pièces indésirables en matériaux arcaniques, puis dépensez-les en bonus de statistiques permanent pour une pièce que vous souhaitez conserver. Le cassage et l'enchantement n'ont besoin d'aucune station ni d'aucun entraîneur, et n'importe qui peut commencer dès le premier jour ; seules les deux recettes de charmes demandent plus, enseignées à l'atelier d'outillage."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "L’exploitation minière est l’épine dorsale. Le minerai de cuivre provient des veines de niveau 1 d'Eastbrook Vale, le minerai de fer de Mirefen Marsh et le minerai d'osmium de Thornpeak Heights, et chaque échelon de l'échelle monte de la même manière. L'exploitation forestière est plus importante que vous ne le pensez : l'écorce de fer tient la lance de sanglier, le frêne épaule le maillet et une seule bûche de pin élevé forme le bâton de combat.\n\nLe reste vient de la chasse et du contre. La peau brute pour les poignées est récoltée directement sur les cadavres de loups et de sangliers, des fragments d'os se détachent des morts agités ou de l'équipement commun récupéré, et l'échelle de la forge brûle du Flux de forge, 20 cuivres par pot de Darva elle-même. Si votre propre exploitation minière est à la traîne, aucun pion ne vous sauvera sur le minerai lui-même : l'osmium provient des veines de Thornpeak, des veines de départ de chaque zone plus jeune à l'exception de Farshore (dont les veines extraient le fer), ou de la pile d'un autre joueur, par le commerce ou le marché mondial. Seule la barre de Glyphsteel est achetée contre pièce, auprès de Tinker Gizzel à l'usine d'outils ou du quartier-maître Bree à Highwatch.",
          ...
          "routeBody": "Toute pièce avec une véritable ligne de statistiques, ce qui sur cette échelle signifie l'échelon de fer et plus, peut se détacher de l'enclume comme un chef-d'œuvre à condition que la qualité la plus fine s'adapte à l'intérieur de votre plafond ; les communs de cuivre sans état ne se déclenchent jamais, car ils n’ont rien à améliorer. Le fer et l'osmium comptent comme matériaux de niveau 1 pour le bonus de chef-d'œuvre, le highpine et le glyphsteel comme niveau 2, et les compétences situées au-dessus du niveau d'une recette ajoutent son propre point par niveau, donc parmi les trois osmium, c'est la hache de guerre et le bâton de combat qui portent l'avantage matériel, et un barreau continue de mieux fonctionner une fois que vous l'avez dépassé.\n\nMontez sur l'échelon de cuivre jusqu'à 25, entraînez l'échelon de fer le jour de son ouverture et montez-le jusqu'à 50, puis sur l'échelon d'osmium jusqu'à 75. Au-delà de 75, rien de plus élevé pour l'instant, les recettes d'osmium s'estompent de moitié, puis d'un quart de gain : prévoyez environ 150 artisanats supplémentaires pour atteindre le plafond de 125, et rappelez-vous la limitation partagée de dix actions d'artisanat par minute lorsque vous vous asseyez pour lotir.\n\nFinancez l'ascension au fur et à mesure : l'ordre de travail de la forge de Darva vous enlève huit minerais de cuivre toutes les 30 minutes pour un peu de pièce et d'XP, et les barreaux de fer et d'osmium se vendent honnêtement au nivellement en mêlée. Le Livre des exploits marque Edge et Temper à une compétence de 50 et couronne Grandmaster Weaponcrafting à 125."
        },
        "armorcrafting": {
          "identityHeading": "La maille pour les premières lignes",
          "identityBody": "L'échelle de fabrication d'armures se lit comme la carrière d'un soldat : ​​la ceinture, les sabatons et les gantelets en cuivre rivetés pour commencer, le haubert en maillons de fer, les garde-jambes et les épaulières avec leurs premières véritables lignes de statistiques, et le rare grand casque, cuirasse et jambières en écailles d'osmium, les pièces de force et d'endurance avec des numéros d'armure au sommet de l'art d'un artisan.\n\nIl a aussi un côté plus calme : les Eastbrook Warded Leggings, un objet commun de terrain déclaré par un lanceur de sorts, et le Kilnscale Mantle, une rare épaule de maille d'Intelligence et d'Esprit de compétence 75, maintiennent les porteurs de mailles envoûtés sur la liste des clients. Sur le ring, il se situe entre la fabrication d'armes et l'ingénierie ; le couple Smith avec Weaponcrafting prête serment devant la Forgemistress Darva, tandis que le couple Gearwright avec Engineering est nommé mais n'a pas encore de quête de serment.",
          "materialsHeading": "Du minerai par sac entier",
          "materialsBody": "Aucun vaisseau ne mange le minerai plus vite. Le haubert Ironlink nécessite à lui seul cinq minerais de fer, et chaque morceau d'écailles d'osmium nécessite trois ou quatre osmium plus une barre d'acier glyphe, donc un armureur sérieux exploite Mirefen Marsh et Thornpeak Heights ou paie quelqu'un qui le fait. Le cuivre alimente le premier échelon, directement depuis les veines du Copper Dig.\n\nAutour du métal se trouvent les parties molles : des peaux brutes récoltées sur des cadavres de loups et de sangliers, des fragments d'os de morts agités (ou récupérés dans des équipements communs) et des pots Smithing Flux (20 cuivre chacun à la forge) dans presque toutes les recettes. Aucun comptoir ne vend de l'osmium : les impatients l'achètent à d'autres joueurs ou l'exploitent eux-mêmes, sur Thornpeak ou dans les veines de départ de dix des onze zones plus jeunes (le Farshore seul extrait du fer).",
          "ladderHeading": "L'apprentissage à la forge de Darva",
          "ladderBody": "Deux objets communs de terrain, le Eastbrook Chainmail Vest et les Warded Leggings, sont connus depuis le début et fabriqués n'importe où. L'échelle d'entraîneur comprend neuf recettes réparties sur trois échelons à la forge d'Eastbrook : l'échelon de cuivre est gratuit à la compétence 0, l'échelon de lien de fer coûte 25 pièces d'argent par recette à la compétence 25, et l'échelon d'osmium coûte 1 or chacun à la compétence 50, chaque échelon pouvant être enseigné dès que votre niveau l'atteint.\n\nAu-delà de l’échelle se trouvent deux promotions. Le Heaume de Boundstone est l'une des deux recettes combinées des Smith (les Gantelets du Wyrm du Tombeau sont ses frères du côté de la fabrication d'armes), enseigné par un entraîneur, sans station et utilisable uniquement par un Smith à l'écoute avec les deux métiers à la compétence 25. Le Manteau d'écailles de four n'a besoin d'aucun professeur : tout le monde le connaît depuis le début, et rien que la forge et les portes de matériaux qui le font fonctionner. Sa compétence répertoriée de 75 est une question de gain, pas de permission : avec la fabrication d'armures comme majeure, elle rapporte l'intégralité du gain de compétence du tout premier coup de marteau à 99, donc un Smith avec de l'osmium en réserve peut s'appuyer dessus dès le début. En dessous du plafond d'un major, la recette de niveau 3 n'enseigne rien, donc un armurer non déclaré ou amateur la travaille pour la pièce, pas pour les points.",
        ...
        "tailoring": {
          "identityHeading": "Le tissu pour les lanceurs de sorts, les sacs pour tout le monde",
          "identityBody": "L'échelle monte des simples toiles jusqu'à l'ensemble tissedor, puis jusqu'à l'échelon rare : le Vêtement du lieur de soie et les pièces en soie de soleil. Son second métier est universel : la Besace en soie filée est un sac à dix emplacements, et il n'existe aucune classe, spécialisation ou niveau qui ne veuille pas plus d'espace dans les sacs.\n\nSur la roue, la Couture se trouve entre le Travail du cuir et l'Inscription. Sa paire vivante est l'Équipementier, Travail du cuir et Couture ensemble, juré devant la Tisserand Ottilie au métier à tisser d'Eastbrook après avoir abattu quatre araignées des bois pour leur soie ; la paire du Tisserand des encres avec l'Inscription est nommée sur la roue mais attend les premières recettes de l'Inscription avant de pouvoir être jurée.",
          "materialsHeading": "Fil, soie, et oui, des herbes",
          "materialsBody": "Le métier à tisser fonctionne avec ce que la chasse laisse tomber et ce que les champs font pousser. Les chutes de lin et le tissu de toile viennent des tués humanoïdes, la soie d'araignée est récoltée sur les cadavres d'araignées, et la pièce maîtresse de l'échelon rare, le Vêtement du lieur de soie, requiert une Soie immaculée, le spécimen signé qu'une récolte chanceuse sur un cadavre peut fournir.\n\nL'Herboristerie alimente la Couture plus que tout autre métier d'équipement : la feuilleclat taille les chaussons, la feuille d'or colore l'ensemble tissedor, et le pétale de soleil fil tout l'échelon rare ; un tailleur qui cueille ses propres herbes économise régulièrement. Une Bobine de fil coûte 12 cuivres chez Ottilie, et le métier à tisser ne demande aucun métal : même la pièce maîtresse du Capuchon en tissu gardé est tissée à partir d'herbes de qualité supérieure, de Soie immaculée, de soie d'araignée et de fil.",
          "ladderHeading": "L'apprentissage au métier à tisser d'Ottilie",
          "ladderBody": "Deux pièces de terrain communes, le Pantalon en laine d'Eastbrook et les Vêtements rituels, sont connues dès le départ et se fabriquent n'importe où. L'échelle du formateur se déroule au métier à tisser au sud du puits d'Eastbrook : l'échelon toile (capuchon, mitaines, chaussons) est gratuit à la compétence 0, l'échelon tissedor (robe, jambières et la Besace en soie filée) coûte 25 pièces d'argent par recette à la compétence 25, et l'échelon rare (vêtement, manteau, chausses) coûte 1 pièce d'or chacune à la compétence 50.\n\nLe Capuchon en tissu gardé n'a pas besoin de formateur : tout le monde le connaît, mais il est placé à la compétence 75, lié au métier à tisser, comme pièce maîtresse de palier 3 du métier. Comme partout, Ottilie enseigne une recette dès que votre palier en Couture atteint le propre palier de la recette.",
          "routeHeading": "Les chefs-d'oeuvre, et un parcours vers 125",
          "routeBody": "Une Soie immaculée dans le vêtement couvre à elle seule le bonus de réactif signé pour le chef-d'oeuvre, et la feuille d'or et le pétale de soleil comptent comme matériaux de palier 1 et palier 2 pour le jet ; c'est donc à l'échelon rare que les chances culminent. Le travail ordinaire et sans statistiques comme le sac ne déclenche jamais ce résultat : un chef-d'oeuvre améliore les statistiques, et un sac n'en a aucune.\n\nCousez l'échelon toile jusqu'à 25, apprenez le tissedor le jour où il se débloque et montez jusqu'à 50, puis l'échelon rare jusqu'à 75. À partir de 75, le Capuchon en tissu gardé prend le relais : une recette de palier 3, gain complet jusqu'à 99 et la moitié au-delà, environ 75 fabrications pour les cinquante derniers points, chacune coûtant deux Soies immaculées, quatre soies d'araignée, une paire de pétale de soleil et de feuille d'or chacune, et deux fils.\n\nFaites rentrer l'argent pendant la progression : les sacs se vendent à littéralement tout le monde, et le bon de travail du métier à tisser d'Ottilie achète six soies d'araignée toutes les 30 minutes. Le Livre des hauts faits marque Une belle couture à la compétence 50, avec Grand Maître Couture qui attend au plafond de 125."
        },
        "leatherworking": {
          ...
          "materialsBody": "Le travail du cuir est le métier où votre parcours de progression et votre ligne de ravitaillement sont la même chose : la peau brute est récoltée directement sur les cadavres porteurs de peau, les loups et les sangliers avant tout, et chaque cadavre ne sert qu'à un seul moissonneur, premier arrivé, premier servi. Un jet de récolte rare ou meilleur accorde également une peau immaculée, un spécimen signé que le Mirewarden Jerkin demande, alors mettez en banque tous ceux que vous trouvez.\n\nLe casting de soutien est petit : des pattes d'araignée et de la soie, du tissu fait maison provenant d'humanoïdes, un seul minerai d'osmium dans chaque pièce rare de mirewarden (six dans la pierre angulaire de Duskhide Wraps) et un agent de bronzage à 16 cuivre du comptoir de la tannerie. L'osmium lui-même n'est jamais contre-acheté : extrayez-le vous-même, sur Thornpeak ou dans presque toutes les veines de départ de toute zone plus jeune (le Farshore seul extrait le fer), ou achetez-le à un autre joueur.",
          "ladderHeading": "Formé à Fenbridge",
          "ladderBody": "Voici le problème : la tannerie se trouve à Fenbridge, sur la route du marais de Mirefen, faisant du travail du cuir le seul métier profond formé dans le marais. Tanner Hesk enseigne l'échelle dans ses cuves : la peau de Fenbridge a sonné gratuitement à la compétence 0, le traqueur des marais a sonné à 25 pièces d'argent une recette de la compétence 25 et le mirewarden a sonné à 1 or chacun à partir de la compétence 50, chaque échelon s'ouvrant à mesure que votre niveau l'atteint.\n\nTrois recettes ignorent l'entraîneur : les biens communs de terrain (le pourpoint en cuir tanné et la peau de druide d'Eastbrook) sont fabriqués n'importe où depuis le début, et les enveloppes en peau de crépuscule sont connues de tous mais se situent à la compétence 75, liées à la tannerie. Notez que le serment de la Pourvoirie lui-même est prêté à Eastbrook avec Ottilie ; seul l'enseignement a lieu dans le marais.",
          "routeHeading": "Les chefs-d'oeuvre, et un parcours vers 125",
          "routeBody": "Toute pièce avec de vraies statistiques lance la chance de chef-d'œuvre tant que la qualité la plus fine correspond à votre plafond de niveau, la peau de druide d'Eastbrook incluse et une peau immaculée signée dans un pourpoint Mirewarden fournit automatiquement le bonus de réactif signé ; l'osmium compte comme un matériau de niveau 1 pour le processus. Les caches communs sans état ne peuvent pas se déclencher.\n\nNivelez-le de manière naturelle : récoltez tous les loups et sangliers que vous tuez à partir du niveau un, laissez les deux champs communs vous transporter jusqu'à 25 où que vous soyez, puis entraînez la peau aux cuves lorsque les quêtes vous entraînent de toute façon dans le marais. Marshstalker vous porte à 50 et Mirewarden à 75 ; au-delà de cela, les Duskhide Wraps, une recette de niveau 3 contenant six minerais d'osmium, trois peaux immaculées, deux peaux rugueuses et un agent de bronzage, rapportent à un pourvoyeur adapté un gain complet à 99 et demi après, environ 75 artisanats pour les cinquante derniers points jusqu'au plafond de 125 ; en dessous du plafond d'un major, la recette de niveau 3 n'enseigne rien.\n\nLa tannerie mobile compte plus pour ce métier que pour tout autre : se spécialiser à 75 ans et une sacoche de peaux devient un équipement fini au feu de camp au lieu d'un retour à pied à Fenbridge. Le bon de travail de la tannerie de Hesk achète huit peaux brutes toutes les 30 minutes, un joli retour sur les peaux que vous collectiez malgré tout, et le Livre des actes marque le métier de tanneur à la compétence 50 avec le grand maître du travail du cuir au plafond."
        },
        "cooking": {
          "identityHeading": "La marmite qui nourrit le groupe",
          "identityBody": "Mangez un repas cuisiné et il vous guérit en 18 secondes de repos, ce qui entre les tirages est la guérison la moins chère du jeu. L'échelle va d'une perche de rivière poêlée à 90 points de vie jusqu'au Grand Roast de Marlow à 980, un rien de mieux dans le jeu.\n\nSur le ring La Cuisine se situe entre l'Alchimie et le Travail du Cuir. Son couple vivant est l'Apothicaire, l'Alchimie et la Cuisine, assermenté devant Cook Marlow dans les cuisines d'Eastbrook après avoir chassé quatre sangliers pour le pot ; le couple Trapper avec Leatherworking est nommé sur le ring mais n'a pas encore de quête de serment.",
          "materialsHeading": "Un garde-manger alimenté par la canne et le couteau",
          "materialsBody": "La pêche stocke les ingrédients phares, zone par zone : truite miroir et perche de rivière des eaux d'Eastbrook Vale, brochet des marais et anguille des tourbières du marais de Mirefen, truite givrée et carpe ardoise de Thornpeak Heights. Les échelons mélangent librement les zones (l'échelon libre veut déjà le brochet des marais, l'échelon intermédiaire les givres de Thornpeak et le rare souper replie la truite miroir de Vale), de sorte qu'un cuisinier qui pêche partout où va la route ne se tarit jamais.\n\nLe côté boucher se compose de cadavres récoltés : viande de gibier de sangliers et de leurs proches, et, sur un rouleau de récolte rare ou meilleur, un Prime Cut signé, pièce maîtresse du grand rôti. Les herbes assaisonnent les meilleurs plats, une bûche de frêne fume l'anguille et du sel de cuisine contient 8 cuivres par sachet provenant du propre étal de Marlow.",
        ...
        "alchemy": {
          ...
          "identityBody": "Le métier est travaillé à l'apothicairerie de Highwatch, la maison de l'alchimiste Verane, maître de l'apothicaire, qui enseigne l'échelle de recettes, vend des flacons en verre à 12 cuivres et paie des pièces pour les herbes via son bon de travail.\n\nSur le ring de l'artisanat, l'alchimie se situe aux côtés des métiers d'essais et d'erreurs, à côté de l'ingénierie d'un côté et de la cuisine de l'autre. Cela lui donne deux identités de couple : le Bombardier (Ingénierie et Alchimie, repris avant Tinker Gizzel à Eastbrook) et l'Apothicaire (Alchimie et Cuisine, assermenté devant Cook Marlow). Harmonisez-vous avec l'une ou l'autre paire pour faire de l'alchimie une spécialité et laissez votre propre travail signé vous apprendre en retour ; le duo Bombardier ouvre également sa bière combinée, l'Elixir de l'Ours, tandis que le duo Apothicaire n'expédie pas encore de recette combinée. L'échelle elle-même n'attend jamais, cependant, car chaque recette d'alchimie se situe à l'intérieur du niveau rare sous lequel travaillent les métiers non déclarés, de sorte que toute la montée vers le plafond est ouverte avant tout serment.",
          ...
          "ladderBody": "Tout le monde connaît la potion de guérison mineure depuis le début et peut la mélanger n'importe où, sans avoir besoin de station. La véritable échelle est constituée de neuf recettes enseignées par Verane chez l'apothicaire, trois à chaque échelon : les recettes de compétence 0 sont gratuites, la compétence 25 échelon coûte 25 pièces d'argent par recette et la compétence 50 échelon coûte 1 pièce d'or par recette. Chaque barreau est une potion de guérison, une potion de mana et un élixir d'endurance, allant des bouteilles de feuilles de soleil communes (120 points de vie, 160 points de mana) aux feuilles d'or peu communes (200 points de vie, 260 points de mana) jusqu'aux rares pétales de soleil (280 points de vie, 360 points de mana).\n\nLes élixirs montent de la même manière : l'Elixir du Sanglier confère 6 Endurance pendant 10 minutes, l'Elixir Vipersear 9 pendant 15 minutes, et l'Elixir du Serpent 12 pendant 15 minutes, le Serpent brassant seul deux bouteilles par craft. Une autre recette est de côté : l'élixir de l'ours, une boisson combinée que Verane enseigne pour 25 pièces d'argent une fois que votre alchimie atteint 25, pouvant être mélangée n'importe où, mais uniquement par un Bombardier à l'écoute avec à la fois l'alchimie et l'ingénierie à 25.",
          "routeHeading": "Le parcours d'un brasseur jusqu'à 125",
          "routeBody": "Les brouillons et les élixirs ne lancent jamais de chefs-d’œuvre ; ce processus appartient à l'équipement porteur de statistiques. Cependant, votre nom voyage toujours : les rares brouillons de pétales de soleil arrivent signés d'une marque de fabricant, tout comme chaque bouteille de l'Élixir du Serpent en double lot, donc rien de rare dans cet artisanat ne laisse le banc non signé. À la compétence 75, vous vous spécialisez, et chaque recette d'alchimie coûte désormais 20 % de matériaux en moins.\n\nPrenez l'herboristerie tôt et choisissez au fur et à mesure de votre progression : les feuilles de feuilles sont partout dans le Val, et une fois que vous atteignez le banc de Verane, l'échelon libre vous mènera proprement à la compétence 25 sur les herbes que vous auriez cueillies de toute façon. Apprenez les 25 échelons dès qu'il s'allume, déplacez votre cueillette vers le marais pour la feuille d'or et laissez l'ordre de travail de Verane (six herbes de feuille d'or pour 45 cuivre, répétables toutes les 30 minutes) vous rendre une petite pièce au fur et à mesure.\n\nÀ partir de 50 ans, préparez des brouillons de pétales de soleil et des lots de Serpent à partir de pétales de soleil de Thornpeak, avec un peu de verdure du Val et des marais encore dans le mélange. Le dernier tronçon de 100 à 125 est un filet délibéré, alors préparez ce qui se vend réellement plutôt que de brûler des herbes pour le nombre, et rappelez-vous que les consommables sont ceux que tout le monde achète pour toujours. Le Livre des Actes marque Strange Brews à la compétence 50 et Grandmaster Alchemy au plafond."
        },
        "engineering": {
          "identityHeading": "Le monopole du fabricant d'outils",
          "identityBody": "L'artisanat est travaillé dans les ateliers d'outillage situés dans le coin sud-ouest d'Eastbrook Square, la maison de Tinker Gizzel, maître des ateliers d'outillage. Les niveaux 1 à 3 de chaque gamme d'outils correspondent au stock ordinaire du fournisseur ; les niveaux 4 et 5 sortent du banc d'un ingénieur, ou du comptoir de fouille de la Litanie Noyée pour Marques de Gouffre derrière ses portes claires, et jamais d'aucune caisse pour de l'argent.\n\nSur le ring, il fait partie des métiers d'essais et d'erreurs, à côté de l'alchimie et de la fabrication d'armures, ce qui lui donne deux identités : le Bombardier (ingénierie et alchimie, repris avant Gizzel lui-même) et le Gearwright (fabrication d'armures et ingénierie, nommé mais pas encore jurable). Un avertissement compte plus ici que partout ailleurs : chacun des échelons de recette de l'ingénierie se situe au-dessus du plafond de niveau rare sous lequel travaillent les passe-temps et les artisans non déclarés, de sorte que le nombre de compétences ne bouge que pour un artisan dont les spécialités incluent l'ingénierie, ce qui signifie aujourd'hui le Bombardier. N’importe qui peut toujours construire les outils terrestres ; un artisan non averti n'apprend rien en le faisant, et les deux recettes de tiges demandent en outre l'enseignement de Gizzel.",
          "materialsHeading": "Réactifs et outils précédents",
          "materialsBody": "Chaque recette d'outil terrestre consomme l'outil situé un niveau en dessous plus un matériau FINE, et cette association constitue l'ensemble de l'échelle terrestre : quatre minerais de fer fins et une pioche minière Skysilver deviennent la pioche minière d'osmium, puis deux barres de Glyphsteel, deux minerais d'osmium fins et cette pioche d'osmium deviennent la pioche minière de Glyphsteel. Les lignes de hache et de faucille reflètent la forme de l'outil fin plus antérieur avec des bûches fines de frêne et de pin élevé, de la feuille d'or fine et des herbes fines de pétale de soleil, bien que leurs échelons de niveau 5 ne demandent pas de barres de Glyphsteel : la pioche est la seule ligne qui devient la plus chère au sommet. Les deux recettes de cannes brisent volontairement le modèle : le Stormreel prend quatre cannes Sunglint Koi et une canne Silverstream, le Tidewrought deux Koi, huit Raw Slatefin Carp et ce Stormreel, de sorte que le haut de l'échelle du pêcheur est payé sur l'eau plutôt que dans une veine.\n\nUn matériau fin n'est vendu nulle part et ne provient pas d'une récolte ordinaire : vous l'obtenez en travaillant l'une des veines de qualité supérieure d'une zone avec un outil classé au-dessus du matériau lui-même, ce qui en pratique signifie l'outil situé un échelon en dessous de celui que vous essayez de construire (plus une zone garde de veines faciles pour les voyageurs, donne du matériau ordinaire quoi que vous fassiez). C'est délibéré. Sur la route de l'artisanat, un outil de niveau 5 vient du fait de balancer celui de niveau 4, et non d'une virée shopping ; le comptoir Marques de Gouffre est le seul moyen de contourner ce lieu. La seule exception est le lingot de Glyphsteel, raffiné et réservé aux vendeurs, 1 argent 60 cuivre par lingot du quartier-maître Bree à Highwatch ou du propre comptoir de Gizzel, de sorte que le pic de minage de Glyphsteel comporte à lui seul un plancher de pièces fixe intégré à son coût.",
          "ladderHeading": "L'échelle d'outils",
          "ladderBody": "L'échelle comprend huit recettes, toutes liées à la station d'outillage. Les six recettes d'outils terrestres sont connues automatiquement, sans frais d'entraînement : la pioche, la hache et la faucille de niveau 4 à la compétence 75, et les versions de niveau 5 à la compétence 150. Ce deuxième chiffre n'est pas une faute de frappe, et il se situe volontairement au-dessus du plafond actuel de 125 : les exigences de compétence ne déclenchent jamais un métier ici, elles ne font que façonner le gain de compétence, vous pouvez donc construire un outil de niveau 5 le jour où vous détenez ses réactifs et son prédécesseur de niveau 4. Les deux cannes fabriquées sont l'exception enseignée : Gizzel enseigne le Stormreel à la compétence 75 pour 4 pièces d'or et le Tidewrought à la compétence 125 pour 16 pièces d'or, chacun au moment où votre niveau dans l'artisanat atteint le sien.\n\nChaque outil fini est d'une qualité rare ou épique et est signé, de sorte que votre nom figure sur les zones sur les ceintures à outils des autres joueurs. L'ingénierie contient également la moitié d'une recette combinée : l'élixir de l'ours, brassé par un Bombardier à l'écoute avec à la fois l'ingénierie et l'alchimie au niveau 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Chaque enchantement est connu dès le départ, n'importe qui peut désenchanter dès le premier jour, et aucun des deux n'a jamais besoin d'une station ; la compétence est plafonnée à 125 comme tous les métiers. Le seul aspect enseigné du métier est sa paire de recettes de charmes : Tinker Gizzel enseigne la Cache du récolteur et l'Oeil de l'artisan dans l'atelier d'outillage situé dans le coin sud-ouest d'Eastbrook Square, pour le tarif ordinaire une fois que votre enchantement atteint 25, et les charmes eux-mêmes sont travaillés à sa station.\n\nSur l'anneau, il se situe entre l'inscription et la joaillerie, ses deux identités sont donc l'arcaniste (inscription et enchantement) et le gemminder (enchantement et joaillerie). Ni l'un ni l'autre ne peuvent encore prêter serment, puisque les deux voisins attendent leurs premières recettes, donc aujourd'hui l'Enchantement grimpe comme le métier de chacun : gratuit au niveau rare avant tout serment, et un choix de passe-temps naturel pour un Bombardier ou un Apothicaire. Les enchanteurs font également fonctionner le monde de la collecte : les deux effets d'outils insérables sont le travail des enchanteurs, et un artisan original recharge ses propres effets à un prix réduit, encore plus profond une fois spécialisé.",
          "levelingHeading": "Comment l'Enchantement progresse",
          "levelingBody": "Trois actions déplacent la compétence : désenchanter une pièce, appliquer un enchantement et fabriquer les deux charmes, qui gravissent la courbe de fabrication ordinaire. Chaque succès vaut jusqu'à un point, fonction du sérieux du travail : la rareté de la pièce que vous cassez ou le niveau de réactif de l'enchantement que vous appliquez. Les désenchantements communs et les enchantements de poussière uniquement constituent un travail commun ; peu commun désenchante et essence enchante comme peu commun ; les désenchantements rares et chaque enchantement runique ou supérieur comme rare ; Les désenchantements épiques et légendaires occupent encore une place plus élevée sur la table, bien qu'aucune identité enchanteresse ne dépasse aujourd'hui le barreau rare, ils paient donc le même prix qu'un travail rare dans la pratique. Une honnêteté règne sur le banc de rupture : une pièce qui est sortie d'un banc de joueur (fabriquée, signée ou travaillée par un chef d'œuvre) est toujours transformée en matériaux mais n'enseigne rien, donc une boucle de fabrication et de rupture ne nivelle personne, et les leçons sont dans un équipement trouvé dans le monde.\n\nLe fondu de maîtrise familier s'applique aux niveaux de 25 points, de sorte que le travail de niveau commun devient gris à la compétence 75, le travail inhabituel à 100 et le travail de niveau rare exactement au plafond de 125. L'enchantement a également une gentillesse qui lui est propre : les entrées au-dessus de votre plafond d'archétype sont arrondies à ce plafond au lieu d'être mises à zéro, donc avant de vous harmoniser, un désenchantement épique est simplement considéré comme rare plutôt que de n'apprendre rien. Si l'enchantement finit par dormir derrière une autre identité, briser et appliquer le score comme travail commun et la montée s'arrête à 75, tandis que les deux charmes, chevauchant la courbe de fabrication au-dessus du plafond commun, n'apprennent rien du tout à un enchanteur endormi ; gardez-le car votre passe-temps et votre travail de niveau rare sont toujours payants, juste plus lentement après 75 ans.",
          "marketHeading": "Les copies enchantées, la provenance et le marché",
          "marketBody": "L'application d'un enchantement dépense les réactifs et marque une copie spécifique de l'objet. Pointez-le vers une copie dans un sac et vous obtenez une copie enchantée distincte ; pointez-le vers une pièce que vous portez déjà et elle est enchantée sur place, là où elle se trouve, sans danse de déséquipement et de rééquipement. Quoi qu'il en soit, le bonus suit cette pièce pour toujours, à travers les déséquipements, les déplacements bancaires et les échanges. Un enchantement par pièce : appliquer un enchantement différent à une copie enchantée demande une confirmation, puis remplace purement et simplement l'ancien enchantement, le détruisant sans remboursement de ses matériaux. Vendre, jeter et désenchanter préfèrent tous d'abord les copies simples, afin que votre pièce finie ne soit pas mangée par accident.\n\nL'équipement de chef-d'œuvre et l'enchantement sont amis : une pièce de chef-d'œuvre reste entièrement enchantable, et l'enchantement s'ajoute au bonus du chef-d'œuvre sans le perturber ni la signature de son créateur. En empilant toutes les sources, un chef-d'œuvre signé portant un enchantement supérieur est le meilleur qu'une pièce fabriquée puisse obtenir, et il se situe toujours en dessous du butin du raid, de par sa conception.\n\nSur le marché, une pièce enchantée ou signée se répertorie comme n'importe quelle autre chose : elle apparaît comme sa propre liste en un seul exemplaire, l'info-bulle montre l'enchantement et la marque du fabricant, et le Ravenpost la porte tout aussi fidèlement. Les matériaux restent la moitié stable de l'artisanat : la poussière, l'essence et les éclats sont répertoriés librement, l'inscription ne coûte rien et le marchand ne prend que 5 % de la vente finalisée. Cela fait que les deux enchanteurs classiques gagnent des revenus en vendant des matériaux et en vendant des travaux finis : sur le marché, par corbeau ou face à face dans une vitrine commerciale."
        }
      },
      "howHeading": "Comment fonctionne l'artisanat",
      "howBody": "Ouvrez la fenêtre de fabrication (touche par défaut T) et chaque recette que vous connaissez est répertoriée avec ce dont elle a besoin et ce que vous avez sous la main. Les recettes liées à la station vous demandent de vous tenir à moins de 20 mètres de la bonne station en ville, les recettes sur le terrain sont fabriquées n'importe où, et le bris et l'enchantement d'Enchanting n'ont pas besoin de station du tout (seules ses deux recettes de charme sont du travail en station, à l'usine d'outils). Il n’y a pas de jet d’échec : un artisanat avec les matériaux en main réussit toujours.\n\nDeux petites frictions maintiennent l’honnêteté de l’économie. Chaque artisanat réussi paie des frais de 2 cuivres par point du budget statistique de l'objet, et les actions de type artisanat partagent un même rythme : au maximum 10 artisanats, désenchantements, enchantements, récupérations ou recharges d'outils dans chaque fenêtre de 60 secondes. Ni l’un ni l’autre ne perturbera une séance normale ; les deux empêchent un spécialiste au maximum d’inonder le marché.",
      ...
      "masterworkBody": "Chaque création réussie correspond exactement à ce que promet la recette, et parfois un peu plus : un chef-d'œuvre termine la même pièce avec un niveau de qualité plus fin, avec des statistiques bonus intégrées au moment de la fabrication. Il s'agit d'un module complémentaire uniquement, jamais d'une rétrogradation, et il reste en dessous du plancher du raid, donc l'équipement fabriqué peut être excellent sans remplacer un drop de raid.\n\nLa chance est publiée, pas mystique : {base}% de base, plus {perTier}% par niveau où votre compétence se situe au-dessus de la recette, plus {signed}% lorsqu'un réactif signé entre, plus {spec}% une fois que vous êtes spécialisé, avec des matériaux de niveau supérieur ajoutant 1 à 2% de plus, le tout plafonné à {cap}%. Seule une pièce avec de vraies statistiques peut s'améliorer, donc les communs, les outils et les consommables sans état ne se déclenchent jamais ; un vaisseau dormant n’en produit jamais, et un métier de loisir ne peut pas dépasser son plafond rare.\n\nLe beau travail porte son créateur. Les productions rares et meilleures sont signées, chaque exemplaire (Fabriqué par ; les matériaux rassemblés portent Rassemblés par), un chef-d'œuvre est toujours signé quelle que soit sa qualité. Une signature est une provenance, pas un verrou : les marchandises signées sont échangées, envoyées par courrier et répertoriées librement sur le marché mondial.",
      "trainingHeading": "Formation",
      "trainingBody": "Les recettes des formateurs proviennent des maîtres résidents, enseignées dans leurs stations. La règle est une ligne : un maître enseigne une recette une fois que votre niveau dans le métier a atteint le niveau de la recette, et rien d'autre ne la contrôle, ni votre niveau, ni votre archétype. Les échelles d'équipement et de consommables exécutent leurs échelons aux compétences 0, 25 et 50 ; Les deux leçons de tige d'ingénierie continuent l'échelle à 75 et 125, et les deux recettes de charme d'Enchanting se situent sur le 25 échelon, donc un nouvel échelon s'ouvre à mesure que vos niveaux grimpent.\n\nLes frais sont uniques et fixes par échelon : l'échelon de départ est gratuit, la compétence 25 échelon coûte {tier1} une recette, la compétence 50 échelon {tier2}, et les leçons de tige au-dessus d'elles comportent leurs propres frais, indiqués à côté de chaque recette dans le tableau. Vous devez vous tenir à la station réelle du maître pour vous entraîner, et une station mobile ne compte jamais. Les recettes de terrain communes et les six recettes d'outils de terrain élaborées ne nécessitent aucune formation ; chaque personnage les connaît depuis le début.",
      ...
      "ench": {
        ...
        "enchantsNote": "Les enchantements sont répartis en trois niveaux. Le niveau de base fonctionne avec Chime Dust (avec un peu d'essence en haut de gamme) et couvre l'emplacement d'arme ainsi que tous les emplacements d'armure, à l'exception de la main secondaire, avec suffisamment d'options d'axe de statistiques pour que chaque construction trouve quelque chose pour chaque emplacement. Le niveau supérieur coûte un fragment de carillon plus de l'essence : des bonus plus importants sur les emplacements à plus fort impact. Les éclats alimentent en outre deux autres puits, les deux recettes de charme à cinq chacune et l'échelon supérieur des recharges d'effets d'outils, alors mettez-en quelques-unes avant de dépenser.\n\nEntre eux se trouvent les cinq enchantements runiques, un consommateur par secondaire typé, donc rien de ce que vous broyez n'est jamais une impasse : Runed Edge (arme, force, consomme de l'acier résonant), Runed Sigil (arme, intelligence, bois résonant), Runed Weave (poitrine, esprit, fil résonant), peau runique (jambes, agilité, peau résonante) et liens runiques (casque, endurance, liens résonants). Chacun prend également deux essences de carillon ; où un emplacement et une statistique ont à la fois une base et un enchantement supérieur, le bonus Runed atterrit entre eux, tandis que Runed Weave est l'enchantement spirituel de poitrine le plus puissant et Runed Hide est le seul enchantement d'Agilité des jambes. Les bonus exacts sont tous dans le tableau ci-dessous.",
      ...
      "gatherIntro": {
        "mining": "L'exploitation minière extrait le minerai directement de la roche du monde : le cuivre dans la vallée d'Eastbrook, le fer dans le marais de Mirefen et l'osmium dans les hauteurs de Thornpeak, avec des veines de démarrage dispersées dans chaque zone plus jeune au-delà d'elles, alimentant les forges. Ouvert à tous à partir du niveau 1 : une sélection de 20 mines de cuivre provenant d'un compteur Eastbrook, Fenbridge ou Highwatch ouvre chaque veine de départ, et les échelons supérieurs de l'échelle de sélection se réveillent au fur et à mesure que votre propre compteur les gagne. Suivi sur son propre compteur jusqu'à un plafond de 100.",
        "logging": "L'exploitation forestière permet d'abattre le bois des peuplements d'arbres du monde entier : l'écorce de fer à Eastbrook Vale, le frêne dans le marais de Mirefen, le pin élevé à Thornpeak Heights et les peuplements de démarrage dans chaque zone plus jeune, le stock brut pour les manches, les douves et l'établi de l'ingénieur. Ouvert à tous à partir du niveau 1 avec une hache forestière dans vos sacs (20 cuivres aux comptoirs Eastbrook, Fenbridge et Highwatch), suivi sur son propre compteur jusqu'à un plafond de 100.",
        "herbalism": "L'herboristerie rassemble ce qui pousse à l'état sauvage : la feuille de sheenleaf dans la vallée d'Eastbrook, la feuille d'or dans le marais de Mirefen, le pétale solaire à Thornpeak Heights et les parcelles de départ dans chaque zone plus jeune, la feuille et la tige qui maintiennent le métier d'apothicaire en activité. Ouvert à tous à partir du niveau 1 avec une faucille d'herboristerie dans vos sacs (20 cuivres aux comptoirs Eastbrook, Fenbridge et Highwatch), suivi sur son propre compteur jusqu'à un plafond de 100.",
        "fishing": "La pêche est le métier le plus rare parmi les métiers de collecte, et le plus profond : un véritable mini-jeu de type morsure et moulinet, ses propres tables de capture dans chacune des trois zones centrales (les jeunes eaux au-delà d'elles servent toutes la table du Vale pour l'instant) et un plafond de compétence de 200, soit le double des autres. Achetez un bâton, affrontez l’eau libre et lancez."
      },
      "rhythmHeading": "Le rythme de la récolte",
      "rhythmBody": "Une récolte est un court lancer visible, pas une saisie instantanée : {base} secondes de base, jamais en dessous d'un {floor} deuxième étage. En portant un outil au-dessus du niveau du nœud, celui que votre maîtrise vous permet de manier, vous accélère de {tool} secondes par niveau au-dessus, et chaque bande de compétence que vous traversez réduit encore {band} secondes ; le simple fait de faire correspondre le niveau du nœud vous ouvre la porte, ce sont les niveaux au-dessus qui vous rendent rapide.\n\nUn sac plein refuse poliment le lancement avant qu'il ne commence, donc rien n'est gaspillé à mi-parcours, et chaque récolte rapporte une petite tranche d'XP de personnage, mise à l'échelle en fonction du niveau du nœud par rapport au vôtre, de la même manière que Kill XP évolue : un nœud gris trivial n'apprend rien à un personnage plafonné.",
      "gainBody": "Le gain est déterministe, jamais un jet de compétence : un nœud égal ou supérieur à votre niveau de gain enseigne un point complet par récolte, et chaque compétence {step} est un niveau marqué contre le nœud. Les nœuds de niveau 1 paient intégralement en dessous de 25, la moitié à 49, un quart à 74 et rien à partir de 75 ; les nœuds de niveau 2 paient intégralement jusqu'à 49 ; les deux nœuds de niveau 3 de chaque échange paient intégralement à 74 et demi jusqu'au plafond de {cap}.\n\nL'itinéraire prévu est simple : découvrez les nœuds de départ du Val, déplacez-vous vers le marais et terminez l'ascension sur les hauteurs de Thornpeak Heights. Au plafond, l'apprentissage s'arrête, mais pas les rendements : un collecteur plafonné continue à générer les meilleures cotes offertes par le commerce pour toujours.",
      ...
      "toolsHeading": "Outils",
      "toolsNote": "Chaque nœud a besoin de son outil de métier dans vos sacs, niveau 1 inclus : pas de pioche, pas de minerai, pas de canne, pas de poisson. L'échelle des vendeurs couvre les niveaux 1 à 3 dans les trois centres du cœur du pays : l'outil de niveau 1 est vendu dans les trois, les échelons au-dessus où commence le sol qui les utilise (Fenbridge ajoute le niveau 2, Highwatch le niveau 3), et les colonies plus jeunes au-delà d'elles ne stockent aucun outil, alors préparez-vous avant de voyager. Chaque comptoir vend librement tous les échelons qu'il stocke, et tout outil passe par le commerce direct ; chaque échelon est également répertorié sur le marché et voyage par courrier, à l'exception des trois entrées terrestres de 20 cuivre : celles-ci sont achetées au comptoir ou passées de main en main, et ne sont jamais revendues, postées ou répertoriées. Ce qui est bloqué, c'est le maniement. Un outil terrestre au-dessus du niveau 1 ne fonctionne qu'une fois que votre maîtrise de son propre métier l'a gagné, {tier2Prof} pour le niveau 2, {tier3Prof} pour le niveau 3, et 85 et 100 pour les deux échelons fabriqués, et la ligne du vendeur, l'info-bulle et le tableau ci-dessous nomment tous l'exigence à l'avance. En attendant, un outil acheté à l'avance attend simplement dans vos sacs, n'ouvrant aucun terrain, n'achetant aucune vitesse et ne frappant aucune qualité fine, puis s'utilise au moment où votre compteur touche son numéro. Les cannes à pêche sont la seule exception : aucune canne ne nécessite de maniement, et Trader Wilkes à Eastbrook stocke délibérément les cannes de niveau 2 et de niveau 3 pour les pêcheurs qui achètent à l'avance. Un outil n'occupe jamais un emplacement d'équipement et ne s'use jamais, chacun est donc un achat unique, et seul le niveau compte pour la porte : un outil plus rare du même niveau n'ouvre rien de plus. Mais la rareté n’est pas seulement une question de couleur. Il prolonge la durée de l'effet d'outil à fente et, sur une canne, il élargit la fenêtre du moulinet.\n\nUn meilleur outil achète trois choses, pas deux. Cela ouvre un terrain de niveau supérieur, cela raccourcit la coulée et améliore ce qui en sort : travaillez une veine avec un outil classé AU-DESSUS du matériau de la zone et la récolte en donne la qualité fine au lieu de la qualité ordinaire. La veine doit être l'une des veines de qualité supérieure de la zone, de sorte que les veines les plus faciles qu'une zone réserve aux voyageurs produisent toujours le matériau ordinaire. Les matériaux fins sont ce que consomment les recettes d'outils fabriqués, et une qualité fine compte comme sa version ordinaire partout où une recette ou un bon de travail en demande une, donc la mise à niveau ne vous laisse jamais en rade : cela signifie simplement que votre minerai de cuivre arrive sous forme de minerai de cuivre fin.\n\nAu-dessus de l'échelle des vendeurs, chaque métier dispose de deux outils fabriqués, de niveau 4 et de niveau 5, fabriqués à l'atelier d'outillage (chaque personnage connaît les recettes du terrain ; la compétence qui grimpe pour le travail est celle de l'ingénierie), ou achetés avec Marques de Gouffre au comptoir Litanie Noyée une fois ses portes d'autorisation franchies : le tableau ci-dessous indique le prix des marques et les effacements demandés à chaque échelon. Aucun marchand ne les vend jamais contre de l’argent. La pêche a sa propre paire, et elles sont apprises par le fabricant d'outils plutôt que connues dès le départ. Aucun nœud ni aucune eau n'ont aujourd'hui besoin de plus que le niveau 3, donc les deux échelons supérieurs achètent de la vitesse, de la qualité et une fenêtre de bobine plus douce plutôt que l'accès, et ils constitueront le ticket d'entrée lorsque le terrain de niveau supérieur arrivera.",
      "toolCrafted": "Fabriqué ({craft})",
      "toolCraftedOrMarks": "Crafted ({craft}) or {marks} Marques de Gouffre after three Litanie Noyée clears",
      "toolCraftedOrMarksHeroic": "Crafted ({craft}) or {marks} Marques de Gouffre after a Heroic Litanie Noyée clear",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Non vendu",
      "priceNone": "Non vendu pour une pièce",
      "toolTierReq": "Outil de palier {tier}",
      "colWield": "Utiliser à",
      "wieldNone": "N'importe lequel",
      ...
      "bandsBody": "Les bandes de compétence sont l'échelle partagée 0/100/200 sur le comptoir d'un métier. Pour les échanges fonciers la bande franchit à 100 rases le casting de collecte, et leur calotte fait bande 1 le plafond. Les groupes de pêche ne rasent rien : ils sélectionnent les tables de capture (avec une canne assortie), seule la pêche atteint la bande 2, et la montée elle-même est ce qui attire le pêcheur vers des eaux plus profondes, où vivent les meilleures tables et les leçons ultérieures.",
      ...
      "specimenBody": "Gardez un peu d'espace pour vos sacs lorsque vous cultivez : une aubaine signée a besoin de son propre espace ou d'une pile signée correspondante pour y atterrir, et si rien ne correspond, le rendement arrive quand même mais la signature est perdue. La récolte de cadavres a également son propre jackpot : environ {pct} % de chaque composant récolté est rare ou meilleur. Une famille ayant un spécimen parfait à donner (peau, soie, venin, viande) maintient son rendement ordinaire et frappe le spécimen signé à côté ; une famille sur deux signe elle-même le rendement.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "Le jalon 100 inscrit Old Salt et le 200 inscrit Master Angler avec son titre, le summum de l'art du pêcheur à la ligne ; La pêche compte également pour le Master Gatherer, gagné à 100 dans trois métiers de collecte. Un premier poisson de chacune des eaux de six zones remplit sa propre page, les trois zones centrales et le Willowfen, le Galecrest et le Farshore au-delà d'elles, et le Sunglint Koi enregistre Glimmer of Hope, de sorte que les voyageurs avec une perche dans leur sac remplissent leur livre plus rapidement que prévu."
      },
      "fish": {
        "startHeading": "Premiers pas",
        "startBody": "Une canne à pêche simple coûte 20 cuivres auprès du pêcheur Brandt à Eastbrook (recherchez le Old Salt à l'extrémité est de la ville, près de la route menant à Mirror Lake) ; Tinker Gizzel, le provisionneur Hale à Fenbridge et l'intendant Bree à Highwatch stockent également des poteaux. Utilisez la canne face à une eau suffisamment profonde pour contenir des poissons, jusqu'à environ 24 mètres devant vous, et votre bobber s'en va.\n\nVous ne pouvez pas lancer pendant un combat, en nageant ou en étant mort : lancer depuis le rivage est la posture prévue. Cependant, l'eau devient plus dure à mesure que la terre : le marais veut au moins le Ironreel de niveau 2 et les sommets le Silverstream de niveau 3, et une ligne lancée sans la canne que l'eau prend ne quitte jamais votre main. Deux cannes se trouvent au-dessus de celles-ci, la Stormreel et la Tidewrought : les ingénieurs les fabriquent à l'usine d'outils à partir de ce qu'une ligne tire, et le comptoir de fouille de Litanie Noyée les vend pour Marques de Gouffre derrière ses portes claires, mais jamais contre de l'argent. Aucune eau ne les demande, alors ils achètent une attente plus courte et une fenêtre de dévidoir plus large au lieu d'un accès, ce qui, au niveau supérieur, signifie une bouchée en trois secondes.",
        "biteHeading": "Touche et remontée",
        "biteBody": "Après le lancer, une morsure intervient à un moment caché entre {min} et {max} secondes ; le délai est décidé lorsque la ligne atterrit, donc il n'y a pas deux lancers identiques. Lorsque le bobber mord, vous disposez d'une seconde fenêtre de {reel} pour appuyer à nouveau sur la canne et l'enrouler : enroulez-le à l'intérieur et la capture atterrit, hésitez devant elle et le poisson s'en va sans rien montrer. Une session entière se termine à {cap} secondes, donc même une incantation silencieuse se résout rapidement.\n\nDe meilleures cannes affûtent les deux extrémités du mini-jeu : chaque niveau de canne au-dessus du premier coupe {rod} secondes de l'attente la plus longue possible, jamais en dessous du niveau de trois secondes, la canne supérieure effleure déjà, et ajoute {reelRod} secondes à la fenêtre du moulinet, de sorte que l'Ironreel réduit la pire attente à 6,5 secondes avec une fenêtre de 3,25 secondes, et le Silverstream à 5 avec une fenêtre au-delà de 4, sa rareté élargissant le moulinet un peu au-delà de ce que le seul le niveau paie. Les touches les plus rapides ne changent jamais ce que vous tenez, et il suffit qu'une canne soit dans votre sac pour compter.",
        "scheduleHeading": "Progression de la maîtrise",
        "scheduleNote": "Le gain de pêche suit un calendrier fixe sans dés : un point complet par capture en dessous de 50 de compétence, un demi-point en dessous de 100, un dixième en dessous de 150 et un lent filet de 0,02 de 150 à 200. Ce dernier tronçon est un voyage de milliers de captures volontairement : 200 est une déclaration, pas un arrêt sur le chemin vers autre chose.\n\nJunk arrête complètement d'enseigner à {cutoff} : à partir de là, les mauvaises herbes et les bottes ne sont plus que des mauvaises herbes et des bottes. L'eau elle-même couronne également la leçon : les eaux de niveau 1 de la Vale (et chaque jeune rivage au-delà du cœur du pays) n'enseignent rien au-delà de 100, l'arrêt du marais à 150, et seule l'école de Thornpeak est un pêcheur à la ligne jusqu'à 200. Autrement, chaque prise débarquée gagne au rythme prévu, donc lorsque le compteur cale, le programme vous dit de chercher des eaux plus profondes.",
        "colProficiency": "Compétence",
        "colGain": "Gain par prise",
        "belowFmt": "En dessous de {below}",
        "tablesHeading": "Tables de prises",
        "tablesNote": "Votre compétence sélectionne l'une des trois bandes de capture : bande 0 dès le début, bande 1 à 100, bande 2 à 200, chacune déplaçant le poids des déchets et des hameçons vides vers de vrais poissons, zone par zone. Chaque groupe au-dessus du premier nécessite également une canne : le groupe 1 veut le Ironreel de niveau 2, le groupe 2 le Silverstream de niveau 3. Votre bande efficace est la valeur inférieure de ce que votre compétence a gagné et de ce que supporte votre canne, et le capuchon est silencieux : avec une canne inférieure, vous attrapez toujours, juste à côté de la table de la bande inférieure, donc si vos prises semblent coincées pendant que votre compétence grimpe, vérifiez d'abord votre canne.\n\nLes eaux de chaque zone contiennent leur propre paire de poissons comestibles, guérissant d'autant plus que la zone est profonde, tous étant des intrants de cuisson et des aliments parfaitement bons à manger crus. Le reste du tableau est la taxe du pêcheur : l'herbe, la botte occasionnelle et l'hameçon vide, qui ne disparaît jamais complètement. Le montant que vous payez dépend de l'eau dans laquelle votre flotteur atterrit, et non de l'endroit où vous vous situez : un lancer atteint jusqu'à 24 mètres, et la canne à pêche demandée par l'eau, la table d'où elle tire, l'acte qu'elle crédite et jusqu'où elle enseigne toutes les réponses à la zone à laquelle l'eau appartient, décident du moment où la ligne atterrit. L'eau de chaque zone est écrite pour une bande qui lui est propre, la vallée pour la bande 0, le marais pour la bande 1, les pics pour la bande 2, et pêcher une bande en dessous transforme environ un tiers de vos lancers en hameçons vides, deux bandes en dessous plus de la moitié. La canne vous amène à l'eau ; c'est l'habileté qui le rend payant, et la montée est ce qui attire le pêcheur plus profondément, car de meilleurs groupes ne sont pas seulement mieux payés : au-delà de la vallée, ce sont les seules eaux qui continuent d'enseigner. Le {rare} est la seule ligne qui répond à votre bande de capture et rien d'autre : les mêmes chances dans chaque zone, et six fois plus probable dans la bande 2 que dans la bande 0, donc la chose la plus rare sur le quai est celle pour laquelle un maître pêcheur est vraiment meilleur.",
        ...
        "koiBody": "Chaque plan d'eau du jeu cache le même prix : le Sunglint Koi, une lueur rare sur la ligne qui vaut 75 cuivres pour un vendeur et bien plus pour votre fierté. Ses cotes dépendent de votre bande de capture et de rien d'autre, les mêmes dans chaque zone : une ligne de 1 % de la table de capture dans la bande 0, 3 dans la bande 1 et 6 dans la bande 2, tirée sur chaque lancer enroulé, de sorte que le koi arrive au pêcheur qui a gagné les tables profondes. En atterrissant, vous enregistrez Glimmer of Hope dans votre Book of Deeds, une marque de collection sans renommée. Lorsque cela se produit, le journal vous en informe."
      },
      "econ": {
        "title": "Économie de l'artisanat",
        "intro": "Comment la pièce circule dans les métiers : les frais et gouffres exacts, ce qui se vend vraiment, les règles du Marché mondial, les commandes de travail, les pièces de commande, et pourquoi la puissance fabriquée s'arrête en dessous du plancher de raid.",
        "feesHeading": "Frais et gouffres",
        "feesNote": "Une économie de joueurs saine a besoin que des pièces quittent le monde, et les métiers assurent plusieurs de ces drains. Apprendre une recette auprès d'un maître coûte un forfait unique selon son échelon, chaque fabrication réussie paie un petit frais proportionnel au budget de caractéristiques de la pièce, et s'y ajoutent les frais de déliaison et la commission du Marché.\n\nAucune de ces pièces ne va à un autre joueur : elles quittent le jeu entièrement, ce qui maintient la valeur des pièces que vous gagnez par ailleurs.",
        "feeCraft": "Frais de fabrication",
        "feeCraftValue": "{fee} par point de budget d'objet",
        "feeMarket": "Commission du marché",
        "feeMarketValue": "{pct}% d'une vente conclue",
        "feeDeposit": "Caution d'annonce",
        "feeDepositValue": "Aucune",
        "feeUnbind": "Frais de déliaison",
        "feeUnbindValue": "{uncommon} inhabituel, {rare} rare, {epic} épique",
        "trainingHeading": "Frais de formation",
        "trainingNote": "Un forfait par ligne de recette, facturé une fois lorsqu'un maître l'enseigne ; chaque échelon du tableau ci-dessous est utilisé en direct aujourd'hui, depuis les recettes de démarrage gratuites jusqu'aux leçons de tiges de l'outilleur en haut.",
        "trainingTierFmt": "Palier {tier} : {fee}",
        "free": "Gratuit",
        "sellsHeading": "Ce qui se vend, et pourquoi",
        "sellsBody": "L'activité la plus régulière concerne les consommables, car ils s'épuisent et sont rachetés. Les élixirs, la nourriture cuisinée et les enchantements disparaissent tous à l'usage : un combattant qui achète une épée une fois achetera des élixirs de soins pour toujours, et chaque nouvelle pièce d'équipement est une nouvelle occasion de vendre un enchantement.\n\nLes pièces chefs-d'oeuvre sont le haut de gamme. Elles ne peuvent pas être fabriquées sur commande, donc un exemplaire d'une pièce recherchée commande une vraie majoration, et votre signature dessus est une publicité ambulante. Les réactifs constituent le troisième pilier : les matériaux arcaniques issus du désenchantement, les secondaires Résonants typés qui passent directement du démanteleur à l'enchanteur, et les matériaux collectés signés, que les artisans cherchant à déclencher des chefs-d'oeuvre payent au-dessus du marché.",
        "marketHeading": "Le Marché mondial et sa commission",
        "marketBody": "Le Marché mondial est l'échange à l'échelle du royaume, tenu par le Marchand à Eastbrook et le Commissaire-priseur Voss à Highwatch. L'annonce est gratuite : il n'y a pas de caution, et une annonce invendue vous revient simplement. La maison ne prend sa commission que lorsque quelque chose se vend effectivement : 5 pour cent du prix de vente, et le reste vous attend pour être récupéré.\n\nUne limite importante : le Marché ne gère que les marchandises ordinaires. Un exemplaire signé, chef-d'oeuvre, enchanté ou lié n'est jamais inclus dans une annonce, si bien que les pièces spéciales changent de mains face à face dans une fenêtre d'échange, qui transporte l'identité complète d'un objet, signature comprise. Fixez ces prix vous-même ; le Marché vous indique seulement ce que la version ordinaire rapporte.",
        "workOrdersHeading": "Commandes de travail",
        "workOrdersNote": "Chaque maître d'atelier affiche une commande de travail permanente : apportez une pile de la matière première de son métier et soyez payé sur-le-champ, plus un peu d'expérience de quête. La rémunération est délibérément à {pct}% de ce qu'un marchand vous donnerait pour la même pile, arrondi à l'inférieur, de sorte qu'une commande de travail n'est jamais le moyen rentable de vendre des matériaux, juste une raison de passer à l'atelier.\n\nChaque commande tourne sur son propre chrono de {minutes} minutes par personnage : remettez-en une et ce maître n'a plus rien pour vous jusqu'à ce que le minuteur recommence. Traitez-les comme un petit bonus sur les matériaux que vous collectiez de toute façon, non comme un commerce.",
        "colOrder": "Commande de travail",
        "colMaster": "Maître",
        "colAsks": "Demande",
        "colPays": "Paie",
        ...
        "provenanceBody": "Certains objets portent un nom. Survolez-en un et l'info-bulle indique Réuni par un tel sur une matière première, ou Fabriqué par un tel sur une pièce finie : la même marque, formulée pour expliquer comment l'objet est né. Une signature fait partie de l'objet lui-même, voyage avec lui à travers les échanges, la banque, le courrier, le marché mondial et même lors d'un rachat par un fournisseur, et ne s'efface jamais.\n\nLa récolte signe automatiquement son meilleur travail : toute récolte qui roule rare ou meilleure arrive signée, et les trouvailles rares signent la totalité de leur quintuple aubaine. Le rouleau porte-bonheur d'une récolte de cadavres signe son rendement là où la famille n'a pas de spécimen à donner, et lorsqu'elle en a, garde le rendement clair et frappe le spécimen vierge signé à côté. L'artisanat signe le même principe : chaque exemplaire d'une pièce rare ou de meilleure qualité est signé, et un chef-d'œuvre est toujours signé, quelle que soit sa qualité, de sorte que la plus belle version d'une pièce nomme toujours son créateur. La seule chose qui peut vous coûter une signature est un sac plein : une unité signée a besoin de sa propre place, ou d'une pile signée correspondante, pour y atterrir.\n\nUne pile d'objets partage une identité, donc deux copies fusionnent uniquement lorsque chaque marque correspond exactement : même objet, même signataire, mêmes statistiques de chef-d'œuvre, même enchantement, même lien. Un journal signé ne rejoint jamais une pile ordinaire dans les deux sens (la fusion effacerait le nom de quelqu'un), mais des charges utiles identiques fusionnent joyeusement, donc vingt minerais signés par le même ramasseur se trouvent dans une pile et une aubaine ne déchiquette pas vos sacs.\n\nLes signatures rémunèrent les artisans : détenir n'importe quelle copie signée d'un réactif nécessaire sur le banc, quel que soit celui qui l'a signé, ajoute 2 points de pourcentage de chance de chef-d'œuvre, et détenir un réactif signé de votre propre main réduit la quantité requise de ce réactif d'un (jamais en dessous d'un). Votre propre travail signé rare ou meilleur continue même de vous apprendre, aujourd'hui, grâce au seul flacon : buvez une potion que vous avez signée et un petit filet de compétence revient au métier qui l'a brassé, tant que ce métier est l'un de vos majors actifs.",
        ...
        "throttleBody": "Le rendement est plafonné : les recharges de fabrication, de désenchantement, d'enchantement, de récupération et d'effets d'outils se partagent un budget de {actions} actions réussies dans chaque fenêtre de {seconds} seconde. Une tentative refusée ne coûte rien et ne dépense aucun budget. Vous ne le ressentirez jamais en jeu normal ; il existe donc un spécialiste au maximum avec une banque pleine ne peut pas inonder le marché, quels que soient ses compétences ou son stock.",
      ...
      "faq": {
        ...
        "q1": "Pourquoi mes objets signés ne se pilent-ils pas ?",
        "a1": "Un objet signé est un objet instancié : il porte son propre petit registre (le signataire, toute qualité tirée, les caractéristiques de chef-d'oeuvre, un enchantement, un lien) au lieu d'être un exemplaire anonyme. Deux exemplaires ne fusionnent en une pile que lorsque ces registres correspondent exactement.\n\nEn pratique : du minerai rare que vous avez collecté vous-même se pile avec plus de minerai rare que vous avez collecté vous-même, car les deux disent Collecté par vous et rien d'autre ne diffère. Le même matériau signé par un ami occupe son propre emplacement, et un exemplaire ordinaire non signé ne fusionne jamais dans une pile signée. Sacs, banque et échange suivent tous cette règle unique.",
        "q2": "Les recettes communes améliorent-elles ma compétence indéfiniment ?",
        "a2": "Non. Chaque recette est évaluée selon la distance qui la sépare de votre tranche actuelle dans ce métier, la lecture classique orange, jaune, vert, gris : gain complet à votre tranche ou au-dessus, moitié un palier en dessous, un quart deux paliers en dessous, et rien à trois paliers ou plus en dessous. Les tranches sont tous les 25 points de compétence, donc les recettes gratuites de compétence 0 cessent de vous enseigner quoi que ce soit à 75 de compétence.\n\nLes plafonds sont aussi inférieurs au 300 classique que vous pourriez attendre : chacun des huit métiers praticables plafonne à 125, l'Extraction minière, la Bûcheronnerie et l'Herboristerie plafonnent à 100, et la Pêche monte haut à 200. Progresser signifie passer à des recettes à votre propre tranche, non broyer la moins chère.",
        ...
        "a4": "Vous avez touché une aubaine. Environ 1 récolte sur 90 déclenche un événement de récolte rare (un vieux bois de cœur sur un arbre, une veine immaculée sur un minerai, une floraison au clair de lune sur des herbes) : il multiplie le rendement par cinq, signe chaque unité de votre nom et annonce la découverte à toute la zone. Un résultat rare ou de meilleure rareté sur une récolte ordinaire signe également le rendement.\n\nLes documents signés valent la peine d'être conservés ou vendus cher : détenir toute copie signée d'un réactif nécessaire sur le banc ajoute 2 points de pourcentage aux chances de chef-d'œuvre. N'oubliez pas qu'ils ne s'empilent qu'avec des copies signées à l'identique, ils conservent donc leur propre emplacement pour sac.",
        ...
        "a6": "Les neuf recettes de terrain communes et les six recettes d'outils terrestres élaborés sont connues de tous depuis le début, tout comme les trois pierres angulaires liées à la station (le manteau Kilnscale, le Wardweave Cowl et les Duskhid Wraps), qui n'ont besoin d'aucun entraîneur, seulement de leur station. Tout le reste est enseigné par les maîtres résidents dans leurs stations réparties dans les trois villes principales : la plupart se trouvent à Eastbrook, le tanneur tient la tannerie à Fenbridge et l'alchimiste tient l'apothicaire à Highwatch.\n\nLes recettes des entraîneurs se déroulent par échelons : compétence 0, 25 et 50 pour l'équipement et les objets artisanaux consommables, au prix gratuit, 25 pièces d'argent et 1 pièce d'or en tant que frais uniques ; Les deux recettes de charme d'Enchanting se situent au 25e échelon, et le fabricant d'outils enseigne les deux cannes à pêche fabriquées à 75 et 125 pour 4 et 16 pièces d'or. Un maître enseigne une recette une fois que votre tranche dans ce métier a atteint la tranche de la recette, et vous devez vous tenir à sa station pour apprendre : une station mobile ne compte pas.",
        "q7": "Pourquoi ma récolte a-t-elle soudainement ralenti ?",
        "a7": "Le lancement de la collecte commence à 2,5 secondes et est réduit de deux manières : 0,4 seconde pour chaque niveau d'outil que vous portez et que vous pouvez utiliser au-dessus du niveau du nœud, et 0,15 seconde une fois que le compteur de votre échange franchit sa bande de 100, avec un plancher de 1,5 seconde. Passez des nœuds de niveau 1 aux nœuds de niveau 3 et votre surplus disparaît, donc le même choix oscille à nouveau plus lentement. Détenir exactement le niveau requis n’achète aucune vitesse ; il ouvre uniquement le nœud.\n\nLe gain de compétence s'estompe de la même manière que l'artisanat : un nœud devient grisé à mesure que votre compétence dépasse son niveau (les nœuds de niveau 1 n'enseignent rien à partir de la compétence 75), donc la réponse aux gains lents est des nœuds de niveau supérieur. Ceux-ci ont besoin d'un outil d'au moins leur niveau dans vos sacs (aucun nœud n'est jamais travaillé à mains nues, niveau 1 inclus), et un outil terrestre au-dessus du niveau 1 veut également sa marque de maniement en premier, 40/70/85/100 dans son propre commerce pour les niveaux 2 à 5. La pêche suit son propre cône : gain total en dessous de 50 de compétence, moitié en dessous de 100, un filet de 0,1 en dessous de 150 et 0,02 en dessous 200, les captures indésirables n'enseignent plus rien à partir de 100, et l'eau elle-même termine la leçon (les eaux de niveau 1 cessent d'enseigner à 100, le marais à 150), donc un compteur bloqué peut aussi signifier que vous êtes devenu trop grand pour l'eau.",
        "q8": "Puis-je fabriquer loin de la ville ?",
        "a8": "En partie. Les neuf recettes de terrain communes (l'arme de départ, l'armure, la nourriture et les potions de base) sont fabriquées n'importe où et à tout moment, tout comme les trois recettes combinées des paires assermentées. Tout le reste au-dessus d'eux est lié à un type de station : forge, cuisines, apothicaire, tannerie, métier à tisser ou usine d'outillage, et vous devez être à moins de 20 mètres de la station pour que le métier puisse passer.\n\nAvec 75 compétences dans un métier que vous spécialisez, et avec une réduction de 20 pour cent sur les matériaux, vous gagnez une station mobile : placez-la sur le terrain et elle reste debout pendant 10 minutes, servant les recettes de ce métier comme si vous étiez sur le terrain. La station mobile est uniquement destinée à l'artisanat : l'apprentissage de recettes et les commissions non contraignantes nécessitent toujours la véritable station en ville."
      }
    },
    "economy": {
    ...
    "social": {
      ...
      "chanGuildBody": "Les canaux de votre guilde. Le canal de guilde atteint chaque membre ; le canal des officiers est réservé aux officiers et au chef de guilde.",
      ...
      "lootCommonBody": "Les butins ordinaires peuvent circuler à tour de rôle dans le groupe ou revenir à qui les ramasse, tandis que les meilleurs sont mis en jeu pour un tirage, pour que chacun ait une chance équitable.",
    ...
    "stats": {
      ...
      "spiTitle": "Esprit",
      "spiBody": "L'Esprit régit la vitesse à laquelle le mana d'un lanceur de sorts se régénère chaque fois qu'il cesse d'incanter, c'est-à-dire le plus clair du temps entre les combats. Comme l'Intelligence, il sert les classes à mana et ne signifie pas grand-chose pour les autres.",
      "armorTitle": "Armure",
      ...
      "critBody": "Votre chance de coup critique, c'est la fréquence à laquelle une attaque frappe pour des dégâts supplémentaires. Tout le monde part avec une petite chance de base, et l'Agilité (plus quelques talents et l'équipement) vient s'y ajouter. Votre feuille de personnage affiche à la fois la chance elle-même et le score de coup critique que votre équipement y apporte.",
      "dodgeTitle": "Esquive",
    ...
    "progression": {
      ...
      "xpBody": "Vous gagnez de l'expérience en accomplissant des quêtes, en vainquant des ennemis et en nettoyant des gouffres. Les quêtes en donnent de loin le plus, alors suivre le fil des quêtes est le moyen le plus rapide de grimper. Les éliminations et les incursions en gouffre croisées en chemin comblent le reste.",
      ...
      "restedBody": "Entrez dans une auberge et restez hors combat : votre personnage accumule de l'expérience reposée pendant que vous patientez. Chaque ville en possède une. La prochaine fois que vous repartez vous battre, cette réserve donne un surplus à vos éliminations jusqu'à épuisement. Une pause à l'auberge n'est jamais du temps perdu : elle accélère votre prochaine série de niveaux.",
      "capTitle": "Atteindre le niveau {cap}",
      "capJourneyBody": "Le niveau {cap} est le plafond, la fin des niveaux mais pas de la progression. À partir de là, vous parcourez les donjons et le raid en normal et en héroïque, faites face au boss de monde quand il se dresse, courez après un meilleur équipement et vous mesurez dans l'arène.",
  ...
  "stats": {
    ...
    "charactersCreated": "Personnages créés",
  ...
  "cardDuel": {
    ...
    "joinAria": "Rejoindre la file du Duel de cartes",
    "leave": "Quitter la file",
    "leaveAria": "Quitter la file du Duel de cartes",
    "forfeit": "Abandonner",
    "forfeitAria": "Abandonner le Duel de cartes",
    "queued": "En attente d'un adversaire...",
    "unavailable": "Le Duel de cartes nécessite un autre joueur en ligne.",
    "vsOpponent": "contre {name}",
    "round": "Score de la manche : {mine} - {theirs}",
    "counts": "Deck : {deck} · Défausse : {discard}",
    "playCardAria": "Jouer la carte {value}",
  ...
  "delveUi": {
    ...
    "shop": {
      ...
      "empty": "Rien en stock.",
      "buyConfirmTitle": "Confirmer l'achat",
      "buyConfirmBody": "Achetez {item} pour {marks} Marques de plongée ? Les achats de marques ne peuvent pas être remboursés.",
      "buyConfirmAccept": "Acheter",
      "buyConfirmCancel": "Annuler"
    },
    "tracker": {
  ...
  "entryGuard": {
    "title": "Graphismes réduits",
    "body": "Le jeu s'est fermé de manière inattendue en entrant dans le monde, les graphismes sont donc maintenant réglés sur {preset}. Vous pouvez modifier cela dans le sélecteur de graphismes ci-dessous ou dans les options en jeu.",
    "dismiss": "Fermer"
  },
  "loading": {
  ...
  "hud": {
    ...
    "prompts": {
      ...
      "resurrectionOffer": "{name} souhaite vous ramener à la vie. Acceptez-vous ?",
      "acceptResurrection": "Accepter la résurrection",
      "decline": "Refuser"
    },
    "combat": {
      "floatingMiss": "Raté",
    ...
    "logs": {
      ...
      "keptBoundOne": "Conservé {count} exemplaire lié.",
      "keptBoundMany": "Conservé {count} exemplaires liés.",
  ...
  "questUi": {
    "tracker": {
      ...
      "unknownQuest": "Quête inconnue ({id})"
    },
    "log": {
      ...
      "repeatableStatus": "Répétable",
      "cooldownStatus": "Bientôt à nouveau disponible",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Article inconnu {id}, quantité {count}",
      "unknownItemAriaMasterwork": "Article inconnu {id}, quantité {count}, chef-d'œuvre",
      "unknownItemAriaEnchanted": "Objet inconnu {id}, quantité {count}, copie enchantée",
      "unknownItemAriaBound": "Article inconnu {id}, quantité {count}, copie reliée",
      "unknownItemAriaInstanced": "Article inconnu {id}, quantité {count}, copie marquée par le fabricant"
    },
    "equipment": {
      "empty": "Vide",
      "levelClass": "Niveau {level} {className}"
    ...
    "vendor": {
      ...
      "qtyRowAria": "Quantité achetée",
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Achetez {count} à la fois",
      "qtyCustom": "Coutume",
      "qtyCustomAria": "Choisissez un montant personnalisé à acheter",
      "buyCountAria": "Achetez {count} sur {item} pour {price}",
      "buyCountAriaWithRequirement": "Achetez {count} sur {item} pour {price}. {requirement}",
      "buyQuantityTitle": "Acheter combien de {item} ? Jusqu'à {max}.",
      "buyQuantityInput": "Quantité à acheter",
      "buyQuantityConfirm": "Acheter",
      "buybackTitle": "Rachat",
  ...
  "entities": {
    "abilities": {
      ...
      "fireball_form": {
        "name": "Forme de braise",
        "description": "Vous vous transformez en braise ardente, augmentant votre vitesse de déplacement de {buff} %. Vous ne pouvez pas attaquer ni lancer de sorts sous cette forme. Réactivez pour reprendre votre forme normale."
      },
      "frost_armor": {
      ...
      "rallying_cry": {
        "name": "Rugissement de vaillance",
        "description": "Pousse un rugissement vaillant qui vous confère, ainsi qu’aux membres du groupe à moins de 40 mètres, 20% de points de vie maximum supplémentaires pendant 10 s. Protection : ils subissent également 5% de dégâts en moins pendant la durée."
      },
      "aspect_of_the_wild": {
      ...
      "berserk": {
        "name": "Brume rouge",
        "description": "Augmente votre puissance d'attaque de 70 pendant 15 s. (talent de Druide)"
      },
      "bladestorm": {
      ...
      "bloodlust": {
        ...
        "description": "Plonge les alliés à moins de 30 m dans une frénésie, augmentant leur vitesse d'attaque de 30 % pendant 15 s. (talent de Chaman)"
      },
      "chain_lightning": {
        "name": "Éclair fourchu",
      ...
      "curse_of_exhaustion": {
        ...
        "description": "Maudit la cible et réduit sa vitesse de déplacement de 30 % pendant 12 s. (talent de Démoniste)"
      },
      "death_coil": {
        "name": "Spirale funèbre",
        "description": "Frappe l'ennemi et lui inflige {damage} points de dégâts d'Ombre, puis l'horrifie pendant 3 s. (talent de Démoniste)"
      },
      "deep_freeze": {
        "name": "Gel mort",
      ...
      "frost_trap": {
        "name": "Piège de givre",
        "description": "Gèle les ennemis dans la zone ciblée pendant 3 s, les empêchant de se déplacer et d'agir. (talent de Chasseur)"
      },
      "ghostly_strike": {
      ...
      "hammer_of_wrath": {
        ...
        "description": "Lance un marteau sacré sur un ennemi blessé et lui inflige {damage} points de dégâts du Sacré. Utilisable uniquement sous 20 % de points de vie. (talent de Paladin)"
      },
      "healing_stream": {
      ...
      "innervate": {
        "name": "Sève vitale",
        "description": "De la sève vivante afflue en vous pendant 10 s et restaure par vagues 20 points de votre ressource actuelle : mana, rage ou énergie. Changer de forme ne l'interrompt pas. Le sommeil, l'étourdissement ou la stase immobilisent la sève. (talent de Druide)"
      },
      "pummel": {
        "name": "Casse-mâchoire",
        "description": "Interrompt l’incantation de la cible et l’empêche de lancer des sorts de cette école de magie pendant 4 s."
      },
      "kick": {
        "name": "Coup de pied",
        "description": "Interrompt l’incantation de la cible et l’empêche de lancer des sorts de cette école de magie pendant 4 s."
      ...
      "meteor": {
        "name": "Pierre du ciel",
        "description": "Fait tomber un météore sur la zone ciblée et inflige {damage} points de dégâts de Feu, puis brûle les ennemis qui s'y trouvent de 12 à 18 points de dégâts de Feu toutes les 2 s pendant 6 s. (talent de Mage)"
      },
      "temporal_mend": {
        "name": "Soin temporel",
        "description": "Propulse un allié un instant vers l'avenir, soignant {damage} points de vie tandis que son corps s'installe dans un futur plus sain. (Signature de Chromancie)"
      },
      "temporal_barrier": {
        "name": "Barrière temporelle",
        "description": "Décale la cible d'un battement de coeur hors du présent, une coquille temporelle absorbant {damage} points de dégâts pendant 10 s avant que la chronologie ne se rétablisse."
      },
      "temporal_echo": {
        "name": "Écho temporel",
      ...
      "temporal_rewind": {
        ...
        "description": "Envoie une vague d'arcane à travers votre groupe ou raid, remontant le temps pour restaurer 30 % des dégâts que chaque allié à moins de 40 mètres a subis au cours des 5 dernières secondes (jusqu'à 35 % de leur vie maximale). Ne peut pas être un effet critique. (Chromancie)"
      },
      "temporal_hourglass": {
        "name": "Sablier de Suspension",
        "description": "Placez un sablier temporel à l'emplacement sélectionné. Sous un ennemi, il le suspend pendant {hostilePveDuration} s en JcE ou {hostilePvpDuration} s en JcJ et empêche toutes ses actions ; les dégâts brisent l'effet. À vos pieds ou sous un allié de groupe, il accorde une stase pendant {duration} s, empêche les dégâts et les actions, restaure {healing} % de la vie maximale, et accélère la récupération des temps de recharge de {selfCooldownRecovery} % pour vous ou de {allyCooldownRecovery} % pour un allié. Sur un sol vide, le sablier attend {groundDuration} s et affecte la première unité valide qui le traverse. L'aura bénéfique peut être annulée manuellement."
      },
      "temporal_acceleration": {
        "name": "Accélération temporelle",
        "description": "Accélère le flux du temps pour votre groupe ou raid, augmentant la vitesse d'attaque, d'incantation et de canalisation de 30 % pendant 15 s. Les alliés récemment affectés par Accélération temporelle ou Tambours de guerre sont trop épuisés pour en bénéficier. (Chromancie)"
      },
      "perfect_moment": {
        "name": "Moment parfait",
      ...
      "prayer_of_healing": {
        "name": "Soin du chœur",
        "description": "Rend {damage} points de vie aux alliés proches. (talent de Prêtre)"
      },
      "preparation": {
        "name": "Contingence",
      ...
      "psychic_scream": {
        "name": "Cri psychique",
        "description": "Effraie les ennemis proches pendant un maximum de 4 s. Les dégâts peuvent interrompre l'effet. (talent de Prêtre)"
      },
      "counter_shot": {
        "name": "Tir muselant",
        "description": "Un tir vif qui interrompt l’incantation de la cible et bloque cette école de magie pendant 4 s."
      },
      "rebuke": {
        "name": "Réprimande",
        "description": "Interrompt l’incantation de la cible et l’empêche de lancer des sorts de cette école de magie pendant 4 s."
      ...
      "silence": {
        "name": "Silence",
        "description": "Réduit la cible au silence pendant 4 s. (talent de Prêtre)"
      },
      "smoke_screen": {
        "name": "Écran de fumée",
      ...
      "startle_shot": {
        "name": "Tir de stupeur",
        "description": "Un tir sauvage qui désoriente la cible pendant {duration} s. Tout dégât interrompt cet effet."
      },
      "skull_bash": {
        "name": "Coup de tête",
        "description": "Un coup de tête porté en bondissant qui interrompt l’incantation de la cible et bloque cette école de magie pendant 4 s."
      },
      "spell_lock": {
      ...
      "typhoon": {
        "name": "Typhon",
        "description": "Une rafale de vent repousse tous les ennemis dans un rayon de 8 m et les hébète, réduisant leur vitesse de déplacement de 50 % pendant 4 s."
      },
      "voidfeast": {
        "name": "Festin du Vide",
    ...
    "items": {
      ...
      "eastbrook_ritual_vestments": {
        "name": "Habits rituels d’Eastbrook"
      },
      "eastbrook_druids_hide": {
        "name": "Peau du druide d’Eastbrook"
      },
      "eastbrook_warded_leggings": {
        "name": "Jambières protégées d’Eastbrook"
      },
      "wardweave_cowl": {
        "name": "Capuche de tissage protecteur"
      },
      "duskhide_wraps": {
        "name": "Bandelettes en cuir crépusculaire"
      },
      "sootscale_mantle": {
        "name": "Mantelet d'écailles de suie"
      },
      "gravecaller_blade": {
      ...
      "arcane_dust": {
        "name": "Poussière arcaniste"
      },
      "arcane_essence": {
        "name": "Essence arcaniste"
      },
      "arcane_shard": {
        "name": "Éclat arcaniste"
      },
      "fen_muster_order": {
      ...
      "stalkerhide_jerkin": {
        "name": "Justaucorps en peau de rôdeur"
      },
      "cragwalker_boots": {
      ...
      "furyforged_warhelm": {
        "name": "Heaume de guerre forgé par la fureur"
      },
      "furyforged_warspaulders": {
        "name": "Spallières de guerre forgées par la fureur"
      },
      "furyforged_warplate": {
        "name": "Cuirasse de guerre forgée par la fureur"
      },
      "furyforged_girdle": {
        "name": "Ceinturon forgé par la fureur"
      },
      "furyforged_legguards": {
        "name": "Garde-jambes forgés par la fureur"
      },
      "furyforged_gauntlets": {
        "name": "Gantelets forgés par la fureur"
      },
      "furyforged_sabatons": {
        "name": "Solerets forgés par la fureur"
      },
      "stormbound_crown": {
        "name": "Couronne liée à l’orage"
      },
      "stormbound_spaulders": {
        "name": "Spallières liées à l’orage"
      },
      "stormbound_hauberk": {
        "name": "Haubert lié à l’orage"
      },
      "stormbound_waistguard": {
        "name": "Garde-taille lié à l’orage"
      },
      "stormbound_legmail": {
        "name": "Jambières de mailles liées à l’orage"
      },
      "stormbound_handguards": {
        "name": "Garde-mains liés à l’orage"
      },
      "stormbound_greaves": {
        "name": "Grèves liées à l’orage"
      },
      "ashstalker_cowl": {
        "name": "Capuche du traque-cendres"
      },
      "ashstalker_shoulderguards": {
        "name": "Garde-épaules du traque-cendres"
      },
      "ashstalker_harness": {
        "name": "Harnais du traque-cendres"
      },
      "ashstalker_waistband": {
        "name": "Ceinture du traque-cendres"
      },
      "ashstalker_legguards": {
        "name": "Garde-jambes du traque-cendres"
      },
      "ashstalker_grips": {
        "name": "Gants du traque-cendres"
      },
      "ashstalker_treads": {
        "name": "Bottines du traque-cendres"
      },
      "cinderweave_cowl": {
        "name": "Capuche tissebraise"
      },
      "cinderweave_mantle": {
        "name": "Mantelet tissebraise"
      },
      "cinderweave_raiment": {
        "name": "Atours tissebraise"
      },
      "cinderweave_cord": {
        "name": "Cordon tissebraise"
      },
      "cinderweave_legwraps": {
        "name": "Bandelettes tissebraise"
      },
      "cinderweave_handwraps": {
        "name": "Protège-mains tissebraise"
      },
      "cinderweave_slippers": {
        "name": "Pantoufles tissebraise"
      },
      "final_oath_medallion": {
        "name": "Médaillon du dernier carré"
      },
      "razorwind_torque": {
        "name": "Torque du vent-rasoir"
      },
      "cinder_sigil_pendant": {
        "name": "Pendentif au sceau de braise"
      },
      "iron_vow_band": {
        "name": "Anneau du serment de fer"
      },
      "unbroken_circle": {
        "name": "Le cercle invaincu"
      },
      "fleetblood_band": {
        "name": "Anneau sang-vif"
      },
      "last_step_signet": {
        "name": "Chevalière du dernier pas"
      },
      "ashen_focus_ring": {
        "name": "Anneau de concentration cendrée"
      },
      "spellbreakers_seal": {
        "name": "Sceau du Brise-sort"
      },
      "final_argument_greatblade": {
        "name": "Grande lame de l’ultime argument"
      },
      "first_blood_razor": {
        "name": "Rasoir du premier sang"
      },
      "emberglass_warstaff": {
      ...
      "ironbark_log": {
        "name": "Bûche d'écorce de fer"
      },
      "silverleaf_herb": {
        "name": "Herbe Feuille d'Argent"
      },
      "rough_hide": {
        "name": "Peau brute"
      },
      ...
      "pristine_venom_gland": {
        "name": "Glande à venin vierge"
      },
      "prime_cut": {
        "name": "Coupe privilégiée"
      },
      "smithing_flux": {
        "name": "Flux de forge"
      },
      ...
      "tanning_agent": {
        "name": "Agent de tannage"
      },
      "cooking_salt": {
        "name": "Sel de cuisine"
      },
      "glass_vial": {
        "name": "Flacon en verre"
      },
      "copper_bearded_axe": {
        "name": "Hache barbue en cuivre"
      },
      "copper_flanged_mace": {
        "name": "Masse à bride en cuivre"
      },
      "ironbark_boar_spear": {
        "name": "Lance de sanglier en écorce de fer"
      },
      "ironedge_longsword": {
        "name": "Épée longue Ironedge"
      },
      "ironshod_maul": {
        "name": "Marteau de guerre ferré"
      },
      "whetted_iron_dirk": {
      ...
      "riveted_copper_girdle": {
        "name": "Ceinture en cuivre rivetée"
      },
      "coppermail_sabatons": {
        "name": "Solerets en maille de cuivre"
      },
      "coppermail_gauntlets": {
        "name": "Gantelets en maille de cuivre"
      },
      "ironlink_hauberk": {
        "name": "Haubert Ligefer"
      },
      "ironlink_legguards": {
        "name": "Garde-jambes Ironlink"
      },
      "ironlink_spaulders": {
      ...
      "homespun_mitts": {
        "name": "Mitaines faites maison"
      },
      "silverthread_slippers": {
        "name": "Chaussons en fil d'argent"
      },
      "goldweave_robe": {
        "name": "Robe tissée d'or"
      },
      "goldweave_leggings": {
        "name": "Jambières tissées d'or"
      },
      "silkspun_satchel": {
        "name": "Sacoche en soie filée"
      },
      "silkbinders_raiment": {
        "name": "Grande tenue du relieur de soie"
      },
      "sunweave_mantle": {
        "name": "Mantelet en tisse-soleil"
      },
      "sunweave_treads": {
        "name": "Bandes de roulement Sunweave"
      },
      "fenbridge_hide_leggings": {
        "name": "Jambières en peau Fenbridge"
      },
      "fenbridge_hide_boots": {
        "name": "Bottes en peau Fenbridge"
      },
      "fenbridge_hide_belt": {
        "name": "Ceinture en peau Fenbridge"
      },
      "marshstalker_jerkin": {
        "name": "Pourpoint de traqueur des marais"
      },
      "marshstalker_hood": {
        "name": "Capuche de traqueur des marais"
      },
      "marshstalker_spaulders": {
        "name": "Spallières de traqueur des marais"
      },
      "mirewarden_jerkin": {
        "name": "Pourpoint de Mirewarden"
      },
      "mirewarden_leggings": {
        "name": "Jambières de Gardien de Mire"
      },
      "mirewarden_treads": {
        "name": "Marches de Mirewarden"
      },
      "pan_seared_perch": {
        "name": "Perche de rivière poêlée"
      },
      "hunters_game_skewer": {
        "name": "Brochette de gibier du chasseur"
      },
      "herbed_marsh_pike": {
        "name": "Brochet des marais aux herbes"
      },
      "ashwood_smoked_eel": {
        "name": "Anguille Fumée Au Frêne"
      },
      "goldleaf_game_stew": {
        "name": "Ragoût de gibier à la feuille d'or"
      },
      "frostgill_chowder": {
        "name": "Chaudrée de Frostgill"
      },
      "silvered_carp_supper": {
        "name": "Souper de carpes argentées"
      },
      "anglers_feast_platter": {
        "name": "Assiette de festin du pêcheur"
      },
      "marlows_grand_roast": {
        "name": "Grand rôti de Marlow"
      },
      "silverleaf_healing_draught": {
        "name": "Potion de soins Feuille-d'Argent"
      },
      "silverleaf_mana_draught": {
        "name": "Potion de mana Feuille-d'Argent"
      },
      "elixir_of_the_boar": {
        "name": "Élixir du Sanglier"
      },
      "goldleaf_healing_draught": {
        "name": "Potion de soins Feuille-d’Or"
      },
      "goldleaf_mana_draught": {
        "name": "Potion de mana Feuille-d’Or"
      },
      "venomfire_elixir": {
        "name": "Élixir du Venin de Feu"
      },
      "sunpetal_healing_draught": {
        "name": "Potion de soins Pétale-de-Soleil"
      },
      "sunpetal_mana_draught": {
        "name": "Potion de mana Pétale-de-Soleil"
      },
      "elixir_of_the_serpent": {
        "name": "Élixir du Serpent"
      },
      "mosshide_vest": {
        "name": "Gilet en peau moussue"
      },
      "thornling_grips": {
        "name": "Gantelets épineux"
      },
      "acolyte_chain_grips": {
        "name": "Gantelets de mailles de l'acolyte"
      },
      "votive_chain_belt": {
        "name": "Ceinture de mailles votive"
      },
      "briarroot_staff": {
        "name": "Bâton de racine épineuse"
      },
      "valefire_lantern": {
        "name": "Lanterne de feu du Val"
      },
      "fenbark_leggings": {
        "name": "Jambières en écorce des marais"
      },
      "mirebloom_treads": {
        "name": "Semelles de la fleur des bourbiers"
      },
      "fenwarden_sabatons": {
        "name": "Solerets du gardien des marais"
      },
      "marshlight_hauberk": {
        "name": "Haubert de la lumière des marais"
      },
      "duskthorn_mantle": {
        "name": "Manteau des épines du crépuscule"
      },
      "fenshadow_maul": {
      ...
      "cragward_pauldrons": {
        "name": "Épaulières de la garde des rochers"
      },
      "cragthorn_greatstaff": {
        "name": "Grand bâton des épines rocheuses"
      },
      "moonbark_vestments": {
        "name": "Vêtements d'écorce lunaire"
      },
      "peaksong_helm": {
        "name": "Heaume du chant des cimes"
      },
      "stormchant_gauntlets": {
        "name": "Gantelets du chant de la tempête"
      },
      "cragprowl_belt": {
        "name": "Ceinture du rôdeur des rochers"
      },
      "stormroot_cowl": {
        "name": "Cagoule de la racine de tempête"
      },
      "thunderward_legguards": {
        "name": "Garde-jambes du protecteur du tonnerre"
      },
      "revenantstep_treads": {
        "name": "Semelles du revenant"
      },
      "shardfang_grips": {
        "name": "Gantelets Croc-d'éclat"
      },
      "shardsong_mantle": {
      ...
      "vestments_of_the_waking_grove": {
        "name": "Vêtements du bosquet éveillé"
      },
      "nightfangs_greatstaff": {
        "name": "Grand bâton de Croc-de-nuit"
      },
      "maul_of_the_scourged_wilds": {
        "name": "Marteau des terres ravagées"
      },
      "tidehymn_slippers": {
        "name": "Chaussons du cantique des marées"
      },
      "pearlward_aegis": {
        "name": "Égide du gardien de nacre"
      },
      "wildgrowth_leggings": {
        "name": "Jambières de la végétation sauvage"
      },
      "grovewardens_grips": {
        "name": "Gantelets du gardien du bosquet"
      },
      "verdant_walkers": {
        "name": "Marcheurs verdoyants"
      },
      "lunarward_cinch": {
        "name": "Ceinturon du gardien lunaire"
      },
      "dreamroot_boots": {
        "name": "Bottes de racine onirique"
      },
      "stormbark_mantle": {
        "name": "Manteau d'écorce de tempête"
      },
      "wildsoul_maul": {
        "name": "Marteau de l'âme sauvage"
      },
      "resonant_thread": {
        "name": "Fil résonnant"
      },
      "resonant_hide": {
        "name": "Peau résonnante"
      },
      "resonant_links": {
        "name": "Mailles résonnantes"
      },
      "resonant_steel": {
        "name": "Acier résonnant"
      },
      "resonant_timber": {
        "name": "Bois résonnant"
      },
      "fine_copper_ore": {
        "name": "Minerai de cuivre fin"
      },
      "fine_iron_ore": {
        "name": "Minerai de fer fin"
      },
      "fine_thorium_ore": {
        "name": "Minerai d'osmium fin"
      },
      "fine_ironbark_log": {
        "name": "Bûche d'écorce de fer fine"
      },
      "fine_ashwood_log": {
        "name": "Bûche de frêne fin"
      },
      "fine_elderwood_log": {
        "name": "Bûche fine de Highpine"
      },
      "fine_silverleaf_herb": {
        "name": "Herbe fine à feuilles de sheen"
      },
      "fine_goldleaf_herb": {
        "name": "Herbe fine à feuilles d'or"
      },
      "fine_sunpetal_herb": {
        "name": "Fine herbe pétale de soleil"
      },
      "stormreel_fishing_rod": {
        "name": "Canne à pêche Moulinet-tempête"
      },
      "tidewrought_fishing_rod": {
        "name": "Canne à pêche Forgée-marée"
      },
      "duskwisp_essence": {
      ...
      "gleaming_antler": {
        "name": "Bois de cerf luisant"
      },
      "wisp_mote": {
        "name": "Poussière de feu follet"
      },
      "starfall_shard": {
        "name": "Éclat d'étoile tombée"
      },
      "elder_bark": {
        "name": "Écorce d'ancien"
      },
      "hollow_sealstone": {
        "name": "La Pierre du Sceau de la Combe"
      },
      "monument_overlook": {
        "name": "Monument usé"
      },
      "monument_court": {
        "name": "Monument englouti"
      },
      "monument_north": {
        "name": "Monument oublié"
      },
      "guardian_core": {
        "name": "Coeur de gardien"
      },
      "wardens_seal": {
        "name": "Le Sceau du Veilleur"
      },
      "gleamstag_charm": {
        "name": "Charme du Cerf-Luisant"
      },
      "veilsteel_blade": {
        "name": "Lame d'acier voilé"
      },
      "duskfang_dirk": {
        "name": "Dague croc-du-crépuscule"
      },
      "gleamwood_stave": {
        "name": "Bâton de bois luisant"
      },
      "wardens_oathband": {
        "name": "Anneau de serment du Veilleur"
      },
      "wardplate_cuirass": {
        "name": "Cuirasse de plaques de garde"
      },
      "nightweave_tunic": {
        "name": "Tunique de tisse-nuit"
      },
      "veilcloth_robe": {
      ...
      "gatherers_cache": {
        "name": "Cache du récolteur"
      },
      "artisans_eye": {
        "name": "Oeil de l'artisan"
      },
    ...
    "npcs": {
      ...
      "chronicler_saul": {
        ...
        "title": "La Chronique du Val",
        "greeting": "Tout haut fait qui mérite d'être accompli mérite d'être écrit deux fois, {playerName}: une fois pour le registre, une fois pour la veillée."
      },
      "chronicler_osric_fenn": {
        "name": "Chroniqueur Osric Fenn",
        "title": "La Chronique du Marais",
        "greeting": "Gare à l'humidité sur les pages, {playerName}. Le marais dévore plus de livres que les lecteurs n'en liront jamais."
      },
      "chronicler_edda_hartwell": {
        "name": "Chroniqueuse Zenzie",
        "title": "La Chronique des Hauteurs",
      ...
      "forgemistress_darva": {
        ...
        "greeting": "La forge me répond, {className}. Apportez du bon minerai et il vous répondra aussi."
      },
      "cook_marlow": {
        "name": "Cuisinier Marlow",
        "title": "Maître des Cuisines",
        "greeting": "Rien ne laisse mes cuisines à moitié cuites, {className}. Asseyez-vous, mangez, puis retournez là-bas."
      },
      "weaver_ottilie": {
        "name": "Tisserand Ottilie",
        "title": "Maître du métier à tisser",
        "greeting": "Attention aux discussions, {className}. Une main ferme sur le métier à tisser bat une main forte."
      },
      "tinker_gizzel": {
        "name": "Bricoleur Gizzel",
        "title": "Maître des Outillages",
        "greeting": "Ressorts, pignons et arêtes vives, {className} : l'outillage a tout ce qui manque à vos mains."
      },
      "tanner_hesk": {
        "name": "Tanneur Hesk",
        "title": "Maître de la Tannerie",
        "greeting": "Une peau n'est aussi bonne que son bronzage, {className}. Les cuves sont prêtes quand vous l'êtes."
      },
      "alchemist_verane": {
    ...
    "quests": {
      "q_prof_intro": {
        ...
        "objectives": {
          "0": {
            "label": "Filon de minerai récolté"
          }
        }
      },
      "q_wolves": {
      ...
      "q_the_codfather": {
        ...
        "text": "Le Codfather n'est pas qu'un poisson, {playerName}, c'est un tueur de sang-froid. Les anciens jurent qu'il mange des Mire Prowlers au petit-déjeuner, et même les veuves de Mirefen ne tisseront pas leurs toiles près des Deepfen Shallows par pure terreur. Il règne sur ces eaux, et l'eau des marais ne nécessite rien de moins qu'une canne à pêche Ironreel ; mon comptoir les vend. Prenez-en un en main, sortez ce vieux diable de ses eaux, et j'admettrai que vous avez rejoint la famille.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "J'ai déjà vu ces marques sur trois vieilles tombes autour du champ de bataille nord. Le Capitaine Aldren se trouve sur la colline ouest, le Grand Prêtre Malric plus au sud, le long du bord ouest, et le Royal Assassin Voss près de la falaise est. Touchez chaque tombe et écoutez, {playerName}. Les morts peuvent se souvenir de ce que les vivants ont oublié.",
      ...
      "q_prof_attune_smith": {
        "title": "La promesse du forgeron",
        "text": "L'acier ne pardonne pas une main vagabonde, alors je vous le dis clairement avant que vous juriez quoi que ce soit. Liez-vous à ma forge et la Fabrication d'armes et la Fabrication d'armures deviennent vos deux majeures, les seuls métiers que vous pouvez porter au-delà du travail rare. Le métier qui leur est opposé sur la roue s'installe en passe-temps, travaillé jusqu'au rare et pas plus loin. Vos autres savoir-faire ne brûlent pas, {playerName} : ils se taisent simplement, dormants jusqu'à ce que vous les rappeliez. Et sachez-le avant que le marteau tombe : quittez cette paire pour une autre et vous devrez revenir par un dur labeur, cinq ennemis abattus la première fois, huit la suivante, onze après, encore plus à chaque écart. Encore là ? Alors apportez-moi trois filons de minerai travaillés de la Vallée de vos propres mains, et nous appellerons la promesse faite.",
        "completion": "Du bon minerai, et de bonnes mains pour le travailler. La Fabrication d'armes et la Fabrication d'armures sont vôtres à maîtriser. Gagnez le reste.",
        "objectives": {
          "0": {
            "label": "Filons de minerai récoltés"
          }
        }
      },
      "q_prof_attune_outfitter": {
        "title": "La mesure de l'équipementier",
        "text": "Mesurez le coût avant de couper, c'est la première règle à mon métier à tisser. Choisissez-moi et le Travail du cuir et la Couture deviennent vos deux majeures, la paire que vous pouvez porter au-delà du travail rare ; le métier qui leur est opposé s'installe en passe-temps, emmené jusqu'au rare et laissé là. Les savoir-faire que vous mettez de côté ne sont pas défaits, {playerName}, juste pliés, dormants jusqu'à ce que vous les repreniez. Soyez certain cependant : si vous quittez cette paire et la voulez à nouveau plus tard, le chemin du retour se paie en labeur qui s'allonge à chaque fois, cinq abattus au début, puis huit, puis onze, toujours un peu plus. Si votre décision est prise, abattez quatre araignées des bois et apportez leur soie au métier à tisser, car le bon fil commence chaque bon vêtement.",
        "completion": "Point régulier, main régulière. Le Travail du cuir et la Couture sont vôtres pour les porter aussi loin que votre compétence ira. Mesurez deux fois et ils ne vous trahiront pas.",
        "objectives": {
          "0": {
            "label": "Araignées des bois abattues"
          }
        }
      },
      "q_prof_attune_apothecary": {
        "title": "Une recette qui vaut la peine",
        "text": "Chaque bon plat mêle deux saveurs qui vont ensemble, et il en va de même pour un bon métier, {playerName}. Asseyez-vous avec moi et l'Alchimie et la Cuisine deviennent vos deux majeures, les deux que vous pouvez faire mijoter au-delà du travail rare ; le métier à l'autre bout de la roue est votre passe-temps, affiné jusqu'au rare et pas plus loin. Le reste de vos savoir-faire reste dans le garde-manger, dormant, non gâté, prêt quand vous les reprenez. Avertissement pendant que la marmite est encore froide : partez pour une autre paire et revenir est une corvée qui grossit, cinq bêtes la première fois, huit la suivante, onze après, plus lourd à chaque service. Encore faim ? Alors chassez-moi quatre sangliers sauvages, car une cuisine qui se respecte commence par de la bonne viande.",
        "completion": "Voilà un début qui a du fond. L'Alchimie et la Cuisine sont vôtres pour mijoter aussi haut que vous le souhaitez. Revenez l'estomac dans les talons.",
        "objectives": {
          "0": {
            "label": "Sangliers sauvages chassés"
          }
        }
      },
      "q_prof_attune_bombardier": {
        "title": "Un arrangement volatile",
        "text": "Oh, oh, vous voulez le truc bien, le truc bruyant, oui ? Écoutez, écoutez, avant de toucher quoi que ce soit qui tic-tac : dites le mot et l'Ingénierie et l'Alchimie deviennent vos deux majeures, les seules deux que vous pouvez pousser au-delà du travail rare (c'est là que c'est AMUSANT, croyez-moi). Le métier opposé va dans votre poche en tant que passe-temps, rare et pas plus loin, ne faites pas la moue. Vos autres savoir-faire ? Pas perdus, {playerName}, juste en sommeil, réveillez-les quand vous voulez. Mais (il y a toujours un mais, tenez la mèche) lâchez cette paire et revenez plus tard et ça vous coûtera de la sueur qui s'accumule, cinq choses la première fois, huit la suivante, onze après, plus, plus, à chaque fois que vous perdez courage. Oui ? OUI ? Alors allez me cueillir trois parcelles de plantes, les volatiles, ne demandez pas lesquelles, elles sont toutes un peu volatiles si on y croit assez fort.",
        "completion": "HA. Des réactifs, de vrais, et tous vos doigts encore attachés, bien, bien. Ingénierie et Alchimie, à vous, allez faire quelque chose qui le regrettera. Filez.",
        "objectives": {
          "0": {
            "label": "Parcelles de plantes récoltées"
          }
        }
      },
      "q_prof_amends_smith": {
        "title": "Retour à la forge",
        "text": "Vous voilà donc revenu à la forge. Je ne vais pas prétendre que ça ne pique pas, {playerName}, mais je suis juste de main et le travail est juste aussi. Vous connaissez le prix du retour : du labeur, et encore plus à chaque écart. Abattez les loups qui harcèlent la route du nord, et leur swing rappellera à vos bras ce que cette paire exigeait d'eux jadis.",
        "completion": "Le rythme est de retour dans vos mains. La Fabrication d'armes et la Fabrication d'armures sont de nouveau vos majeures. Ne prenez pas l'habitude de partir.",
        "objectives": {
          "0": {
            "label": "Loups des forêts tués"
          }
        }
      },
      ...
      "q_prof_amends_bombardier": {
        "title": "Le registre grossit",
        "text": "Vous êtes REVENU, ha, ils reviennent toujours, le truc bruyant a quelque chose d'attractif, non ? Pas de bouderie de ma part, {playerName}, mais le registre, oh le registre, il grossit à chaque fois que vous fuyez, de plus en plus à chaque retour, c'est seulement juste. Allez nettoyer les rats des tunnels du chantier pour moi, la sueur d'abord, les étincelles ensuite, c'est la règle que je viens d'inventer.",
        "completion": "VOILA, la démangeaison est de retour dans vos mains. Ingénierie et Alchimie, de nouveau majeures, allez, allez faire du bruit. Essayez de rester cette fois, hein ?",
        "objectives": {
          "0": {
            "label": "Rats des tunnels exterminés"
          }
        }
      },
      "q_prof_workorder_forge": {
        "title": "Bon de travail de la forge",
        "text": "La forge veut toujours être nourrie, {playerName}. Apportez-moi huit morceaux de minerai de cuivre et je vous paierai pour la livraison. Pas de cérémonie, juste du minerai et des pièces.",
        "completion": "Bon poids, pas de laitier. Voici votre dû. La forge aura bientôt faim de nouveau.",
        "objectives": {
          "0": {
            "label": "Minerai de cuivre livré"
          }
        }
      },
      "q_prof_workorder_kitchens": {
        "title": "Bon de travail des cuisines",
        "text": "Mon garde-manger commence à se vider, {playerName}, et les garde-mangers vides rendent les cuisiniers grincheux. Rapportez-moi huit morceaux de viande de gibier et il y a des pièces pour vous, plus ma gratitude éternelle, qui vaut moins mais a meilleur goût.",
        "completion": "Voilà un garde-manger bien rempli. Voici votre paye. Revenez quand vos sacs sont lourds.",
        "objectives": {
          "0": {
            "label": "Viande de gibier livrée"
          }
        }
      },
      "q_prof_workorder_loom": {
        "title": "Bon de travail du métier à tisser",
        "text": "Le métier à tisser se retrouve à sec et les mains oisives gaspillent la lumière du jour, {playerName}. Apportez-moi six écheveaux de soie d'araignée et je vous paierai à un juste tarif, compté jusqu'au cuivre.",
        "completion": "Belle soie, filée régulièrement. Vos pièces, exactement comptées. Le métier à tisser vous remercie, et moi aussi.",
        "objectives": {
          "0": {
            "label": "Soie d'araignée livrée"
          }
        }
      },
      "q_prof_workorder_toolworks": {
        "title": "Bon de travail de l'outillage",
        "text": "Manches, poignées, crosses, je consomme du bois comme si ça allait se démoter, ce qui n'arrivera PAS, le bois est éternel, {playerName}. Charriez-moi huit grumes de bois de fer et je vous paierai, des pièces, de vraies pièces, pas un service, je le promets, la plupart du temps.",
        "completion": "Parfait, parfait, grain droit, pas de pourriture. Tenez, vos pièces, voyez, je tiens parole (la plupart du temps). Revenez quand vous trébuchez sur un arbre.",
        "objectives": {
          "0": {
            "label": "Grume de bois de fer livrée"
          }
        }
      },
      "q_prof_workorder_tannery": {
        "title": "Bon de travail de la tannerie",
        "text": "Les cuves sont vides. Apportez huit peaux brutes. Des pièces quand vous le ferez.",
        "completion": "Bonnes peaux. Paye correcte. Encore quand vous en aurez plus.",
        "objectives": {
          "0": {
            "label": "Peau brute livrée"
          }
        }
      },
      "q_prof_workorder_apothecary": {
        "title": "Bon de travail de l'apothicaire",
        "text": "Mes étagères ont besoin de feuille-d'or, et le stock du marché est, prévisiblement, adultéré. Apportez-moi six herbes de feuille-d'or, sans meurtrissure, et vous serez compensé précisément. Les feuilles meurtries seront refusées, alors faites attention à votre sacoche.",
        "completion": "Acceptable. Puissant et bien manipulé. Votre paiement, compté à la pièce. Ne laissez pas ça monter à la tête, c'est un autre réactif.",
        "objectives": {
          "0": {
            "label": "Herbe feuille-d'or livrée"
          }
        }
      },
      "q_riding_lessons": {
      ...
      "q_prof_hobby_switch": {
        "title": "Un autre passe-temps",
        "text": "Les majeures exigent un serment. Un passe-temps ne demande qu'où votre curiosité vous mène, {playerName}. Récoltez quelques plantes et décidez quel métier opposé à vos majeures vous souhaitez poursuivre.",
        "completion": "Un choix plus léger, mais utile. Suivez cette curiosité aussi loin que le travail rare saura vous mener.",
        "objectives": {
          "0": {
    ...
    "letters": {
      ...
      "guild_trend_engineering_alchemy": {
        ...
        "subject": "Votre travail en ingénierie et alchimie",
      ...
      "guild_trend_alchemy_cooking": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail en Alchimie et Cuisine",
      ...
      "guild_trend_cooking_leatherworking": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail en Cuisine et Travail du Cuir",
      ...
      "guild_trend_leatherworking_tailoring": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail dans le travail du cuir et la couture",
      ...
      "guild_trend_tailoring_inscription": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail en couture et inscription",
      ...
      "guild_trend_inscription_enchanting": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail en Inscription et Enchantement",
      ...
      "guild_trend_enchanting_jewelcrafting": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail en enchantement et en joaillerie",
      ...
      "guild_trend_jewelcrafting_weaponcrafting": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail en joaillerie et en fabrication d'armes",
      ...
      "guild_trend_weaponcrafting_armorcrafting": {
        "sender": "La guilde des artisans",
        "subject": "Votre travail dans la fabrication d'armes et d'armures",
      ...
      "mastery_reset_notice": {
        "sender": "La Salle de la Guilde",
        "subject": "Votre métier, rendu honnête",
        "body": "Compagnon de guilde,\n\nLa guilde a adopté un nouveau mode de mesure de la maîtrise. Chaque main reprend l'ascension depuis le début : vos compétences artisanales et vos aptitudes de collecte ont été remises à zéro.\n\nTout le reste vous appartient, intact : vos recettes, vos outils et matériaux, votre banque et votre or, vos harmonisations et vos titres, vos hauts faits et votre renommée, vos quêtes et votre courrier.\n\nL'ascension est maintenant honnête. Le travail bâclé ne vous portera pas. Cherchez des recettes plus exigeantes, des filons plus riches et des eaux plus profondes.\n\nAvec respect,\nLa Salle de la Guilde"
      },
      "prof_tier_weaponcrafting_armorcrafting_1": {
        "sender": "Maîtresse des forges Darva",
        "subject": "Une étincelle qui mérite attention",
        "body": "La nouvelle parvient à ma forge : l'une de vos majeures tient maintenant au travail peu commun. C'est le plus petit échelon d'une longue ascension, mais vous l'avez gagné à l'enclume, pas en demandant. Gardez le feu vif."
      },
      "prof_tier_weaponcrafting_armorcrafting_2": {
        "sender": "Maîtresse des forges Darva",
        "subject": "Travail rare, et mérité",
        "body": "On me dit qu'une de vos majeures a atteint le travail rare. C'est l'échelon où les mains négligentes tombent et où les vrais forgerons restent debout. Vous êtes encore debout. Bien."
      },
      "prof_tier_weaponcrafting_armorcrafting_3": {
        "sender": "Maîtresse des forges Darva",
        "subject": "Le métal vous répond maintenant",
        "body": "Une de vos majeures a grimpé au-delà du rare pour entrer dans le travail sérieux. Le métal répond à une main comme la vôtre, il ne lutte plus contre elle. Ne laissez pas l'éloge ramollir votre bras."
      },
      "prof_tier_weaponcrafting_armorcrafting_4": {
        "sender": "Maîtresse des forges Darva",
        "subject": "Près du sommet de l'échelle",
        "body": "Une de vos majeures se trouve à un seul échelon de la maîtrise. Peu de mains que j'ai connues atteignent cette hauteur, et encore moins gardent leur tranchant ici. Finissez l'ascension."
      },
      "prof_tier_weaponcrafting_armorcrafting_5": {
        "sender": "Maîtresse des forges Darva",
        "subject": "La maîtrise, enfin",
        "body": "Une de vos majeures a atteint la maîtrise, le sommet qu'une main peut gravir. Je ne donne pas ma parole librement, alors entendez-la une fois : la forge est fière de vous. Allez maintenant apprendre quelque chose de nouveau au feu."
      },
      "prof_tier_leatherworking_tailoring_1": {
        "sender": "Tisserand Ottilie",
        "subject": "Une première rangée bien droite",
        "body": "La guilde note qu'une de vos majeures a atteint le travail peu commun. Ce n'est que la première rangée parmi beaucoup, mais elle est régulière et vraie. Mesurez la suivante avec autant de soin."
      },
      "prof_tier_leatherworking_tailoring_2": {
        "sender": "Tisserand Ottilie",
        "subject": "Travail rare, bien mesuré",
        "body": "Une de vos majeures a grimpé au travail rare. C'est là qu'une main négligente laisse voir chaque maille lâchée, et la vôtre n'en a pas laissé. Je suis discrètement satisfaite."
      },
      "prof_tier_leatherworking_tailoring_3": {
        "sender": "Tisserand Ottilie",
        "subject": "Le patron devient clair",
        "body": "Une de vos majeures a dépassé le rare pour atteindre un travail plus raffiné. Le patron devient clair pour une main à ce niveau, plus de tâtonnements. Continuez à mesurer deux fois."
      },
      "prof_tier_leatherworking_tailoring_4": {
        "sender": "Tisserand Ottilie",
        "subject": "Une rangée du sommet",
        "body": "Une de vos majeures est à une rangée de la maîtrise. La dernière rangée est toujours la plus difficile à garder régulière. Ne la précipitez pas maintenant."
      },
      "prof_tier_leatherworking_tailoring_5": {
        "sender": "Tisserand Ottilie",
        "subject": "Le dernier point",
        "body": "Une de vos majeures a atteint la maîtrise. J'ai mesuré votre travail deux fois, comme je mesure tout, et il tient. Peu de mains tirent jamais le dernier point aussi proprement. Je suis fière, et je ne le dis pas à la légère."
      },
      "prof_tier_alchemy_cooking_1": {
        "sender": "Cuisinier Marlow",
        "subject": "Un avant-goût des choses à venir",
        "body": "La nouvelle parvient à ma cuisine : l'une de vos majeures a atteint le travail peu commun. C'est un avant-goût, rien de plus, mais prometteur. Gardez la marmite en mouvement."
      },
      "prof_tier_alchemy_cooking_2": {
        "sender": "Cuisinier Marlow",
        "subject": "Travail rare, sans les bords brûlés",
        "body": "On me dit qu'une de vos majeures a mijoté jusqu'au travail rare. C'est la chaleur à laquelle la plupart des cuisiniers brûlent le plat, et vous, non. Asseyez-vous, mais pas longtemps."
      },
      "prof_tier_alchemy_cooking_3": {
        "sender": "Cuisinier Marlow",
        "subject": "Maintenant, vous cuisinez",
        "body": "Une de vos majeures a bouillonné au-delà du rare pour atteindre une vraie profondeur. Maintenant, vous cuisinez, comme on dit. Assaisonnez hardiment et goûtez sans cesse."
      },
      "prof_tier_alchemy_cooking_4": {
        "sender": "Cuisinier Marlow",
        "subject": "Un plat du festin",
        "body": "Une de vos majeures n'est plus qu'un plat de la maîtrise. Le dernier est toujours le plus riche et le plus facile à rater. Des mains fermes sur la louche."
      },
      "prof_tier_alchemy_cooking_5": {
        "sender": "Cuisinier Marlow",
        "subject": "La maîtrise, servie chaude",
        "body": "Une de vos majeures a atteint la maîtrise, le sommet de tout le garde-manger. Je nourris tout le monde, mais peu cuisinent jusqu'ici. Fier de vous, vraiment. Allez maintenant faire quelque chose qui fera pleurer à table."
      },
      "prof_tier_engineering_alchemy_1": {
        "sender": "Bricoleur Gizzel",
        "subject": "PREMIERE étincelle, ha",
        "body": "Oi, les chiffres disent qu'une de vos majeures vient de toucher le travail peu commun, une broutille, minuscule, mais ça A CLAQUÉ, non ? La première étincelle est toujours la plus mignonne. Plus d'étincelles. Allez."
      },
      "prof_tier_engineering_alchemy_2": {
        "sender": "Bricoleur Gizzel",
        "subject": "Rare, oh, RARE",
        "body": "On me dit qu'une de vos majeures a grimpé au travail rare, et le rare, c'est là que ça commence à être vraiment dangereux (le bon genre). La plupart abandonnent avant le fun. Pas vous. HA."
      },
      "prof_tier_engineering_alchemy_3": {
        "sender": "Bricoleur Gizzel",
        "subject": "Maintenant ça devient bruyant",
        "body": "Une de vos majeures a explosé au-delà du rare pour entrer dans le sérieux, oh c'est là que ça devient BRUYANT. N'arrêtez pas maintenant, quoi que vous fassiez, l'élan est tout, les mèches aussi."
      },
      "prof_tier_engineering_alchemy_4": {
        "sender": "Bricoleur Gizzel",
        "subject": "Un échelon, UN, du sommet",
        "body": "Une de vos majeures est à UN échelon de la maîtrise, un, singulier, vous l'entendez bourdonner ? Le dernier pas est la plus grande explosion. Ne clignez pas des yeux."
      },
