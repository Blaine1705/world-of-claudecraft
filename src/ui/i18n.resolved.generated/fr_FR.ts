...
export const fr_FR: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "devotion_ward": {
        "name": "Devotion Aura",
        "description": "Reduce damage taken by you and party members by 5% until death or replacement. You can provide only one Devotion, but Devotions from different Paladins can coexist."
      },
      "hammer_of_grace": {
      ...
      "grace_devotion": {
        "name": "Grace Devotion",
        "description": "You and party members restore 15 mana every 5 sec and pay 6% less mana for 3 min."
      },
      "recall_the_fallen": {
