...
export const nl_NL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      ...
      "editKeysHint": "Klik op een slot op de actiebalk en druk vervolgens op een toets om het te binden.",
      "bannerHint": "Klik op een slot en druk vervolgens op een toets om het te binden. Klik op Gereed als u klaar bent.",
      "bannerCapturing": "Druk op een toets om dit slot te binden...",
      "boundToKey": "Gebonden aan {key}.",
      "reset": "Opnieuw instellen",
      "done": "Klaar",
      "cancel": "Annuleren",
      "resetConfirmTitle": "Actiebalktoetsen opnieuw instellen?",
      "resetConfirmBody": "De eerste balk keert terug naar de standaardtoetsen. De tweede en derde maat worden ongebonden. Dit kan niet ongedaan worden gemaakt."
    },
    "mounts": {
      "title": "Rijdieren",
      "close": "Sluiten",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "In de 1v1- en 2v2-beugels speelt elke vechter de All-Rounder-kit. Daden waarvoor de 3v3-beugel of groter nodig is, kunnen hier niet worden verdiend.",
      "role": {
        "allrounder": {
          "name": "Allrounder",
      ...
      "practiceUnratedNote": "Oefengevechten worden niet beoordeeld: het klassement en de voortgang in het Boek der Daden tellen niet mee.",
      ...
      "briefing": {
        ...
        "unratedNote": "Er zijn bots op het veld, dus dit gevecht heeft geen rating: het klassement verandert niet en daden voor doelpunten, reddingen en schone lakens tellen niet mee.",
        "practiceUnratedNote": "Dit is een oefengevecht en heeft dus geen beoordeling: de standen veranderen niet en de voortgang in het Boek der Daden telt niet mee.",
    ...
    "materialHint": {
      "fineGrade": "Fijne kwaliteit. Verzameld uit een volledige ader met een gereedschap dat boven het materiaal staat, en telt als de gewone versie waar dat nodig is.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Om in deze wateren te vissen, heb je een hengel van niveau {tier} nodig."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Je hebt Mining {skill} nodig om de houweel die al in je koffer zit te zwaaien.",
        "logging": "Je hebt logboekregistratie {skill} nodig om de bijl die al in je koffer zit te zwaaien.",
        "herbalism": "Je hebt Herbalism {skill} nodig om de sikkel al in je zakken te laten werken."
      },
      "wieldUnmetCorpse": "Je moet vaardigheden {skill} verzamelen om je beste gereedschap aan het werk te kunnen zetten.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Vereist voor het vissen in wateren tot niveau {tier}."
        },
        "use": {
      ...
      "stateCooldownTimed": "Komt terug in {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Uw gereedschap verfijnt deze opbrengst tot een fijn niveau."
    },
    "archetypeTitle": {
      "label": "Titel",
      "none": "Geen",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} van {max} kosten",
      "toolEffectSpent": "Opgebruikt, moet worden opgeladen",
      "toolEffectDepleted": "Gereedschapseffect uitgegeven",
      "toolEffectRechargePrice": "Opladen: {count} x {material}",
      "toolEffectModeAsk": "Vraag elk gebruik",
      "toolEffectModePrompt": "Vraagt ​​elk gebruik",
      "toolEffectConfirmTitle": "Gebruik {effect}?",
      "toolEffectConfirmBody": "Een vergoeding uitgeven aan deze oogst? Dalen komt nog steeds voor, zonder de bonus. Resterende kosten: {charges}.",
      "toolEffectConfirmAccept": "Gebruik een lading",
      "toolEffectConfirmDecline": "Verzamel zonder",
      "toolEffectName": {
        "gatherersCache": "Verzamelaarscache",
        "artisansEye": "Ambachtelijk oog",
        "quickeningCharm": "Terugverende charme"
      },
      "toolEffectSlotButton": "Sleuf {effect}",
      "toolEffectRechargeButton": "Opladen",
      "toolEffectSlotted": "{effect} sleuf op {profession}.",
      "toolEffectSlotInvalid": "{effect} kan daar niet worden geplaatst.",
      "toolEffectNoTool": "Je hebt eerst een echt {profession}-gereedschap nodig.",
      "toolEffectNoCharm": "Je hebt een handgemaakte {effect}-bedel in je tas nodig.",
      ...
      "toolEffectRechargeNoSlot": "Er is geen effect op {profession}.",
      "toolEffectRechargeFull": "{effect} is al volledig opgeladen.",
      "toolEffectRechargeToolCapped": "Neem een ​​beter {profession}-apparaat mee om {effect} verder op te laden.",
      "toolEffectRechargeMaterials": "Voor het opladen van {effect} is {material} x{count} nodig.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(besteedt {count} fijn)",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Deel akte-ontgrendelingen met gildeleden en volgers, en akte- en meesterwerkkaarten met de Discord-feed",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "Een verklaring is ook geen levenslange gevangenisstraf. Een paar dat je nog nooit hebt vastgehouden is eenvoudigweg een zoektocht naar nieuwe afstemming, terwijl het terugkeren naar een paar waar je van wegliep je vraagt ​​om eerst het goed te maken: de eerste keer vijf taken, en nog eens drie toegevoegd voor elke terugkeer die je al hebt gedaan (het opnemen van een gloednieuw paar verhoogt nooit de telling). De keuze blijft betekenisvol zonder ooit een deur voorgoed op slot te doen.",
      "whatHeading": "Een vak naast het zwaard",
      "whatBody": "Beroepen vormen het beroepsleven van de wereld: vier verzamelactiviteiten die grondstoffen rechtstreeks uit het land halen, en een ring van tien ambachten die er uitrusting, maaltijden, drankjes en gereedschap van maken. Alles voedt hier iets anders. Het erts dat je ontgint, wordt een mes, het mes krijgt een betovering en de betovering heeft stof nodig die uit oude spullen wordt gebroken, dus een verzamelaar, een ambachtsman en een knutselaar zijn allemaal schakels in één ketting.\n\nEr is geen beroepsgrens waar u zich zorgen over kunt maken. Elk personage kan zeven van de acht ambachten die vandaag de dag inhoud hebben, oprichten en alle vier beroepen naast elkaar verzamelen (Techniek is het enige houvast: de recepten beginnen allemaal boven het vrije plafond, dus de ladder wacht op de eed van de Bombardier); de enige exclusieve keuze is jouw archetype, de identiteit waar je uiteindelijk bij zweert, maar als je de ambachten die daarachter sluimeren eenmaal hebt afgestemd, klimmen ze alleen op hun gemeenschappelijke recepten, en op vaardigheden helemaal niet. Vaardigheden gaan nooit achteruit en niets wat je leert, wordt ooit weggenomen.",
      ...
      "archetypesBody": "De tien ambachten zitten op een vast wiel, en de geografie op dat wiel is van belang. Elke twee buren vormen een benoemd paar: Smith voor wapen- en pantserbewerking, Outfitter voor leerbewerking en maatwerk, apotheker voor alchemie en koken, Bombardier voor techniek en alchemie, en nog zes anderen rond de ring.\n\nAfstemmen op een paar is een zoektocht, geen menuklik. Er kunnen vandaag vier paren worden aangesloten (Smith, Outfitter, Apothecary en Bombardier), elk verankerd door een plaatselijke meester in Eastbrook, wiens acceptatiemissie de hele koop vooraf bepaalt voordat je deze aanvaardt. Totdat je aangeeft, gaat elk ambacht vrijelijk verder met recepten tot aan het zeldzame niveau (voor elk recept wordt vaardigheid 74 of minder gevraagd), dus je kunt bijna alles proberen voordat je kiest (techniek alleen heeft geen recept dat zo laag is, dus het aantal wacht).\n\nZodra je je hebt afgestemd, worden je twee paar ambachten je hoofdvak, zonder plafond onder de dop. De rest van het wiel wordt niet donker: één vaartuig tegenover je hoofdvak blijft bestaan ​​als een hobby die door het zeldzame niveau blijft klimmen (een herhaalbare zoektocht in de smederij van Smith Haldren laat je wisselen welk vaartuig), en elk ander vaartuig sluimert. Een sluimerend vaartuig behoudt zijn vaardigheid en zijn gebruikelijke recepten, die het op de normale curve blijven onderwijzen totdat ze grijs worden op 75; alles boven het gewone stopt onmiddellijk met betalen, en een sluimerend ambacht wordt nooit een meesterwerk terwijl het rust.",
      "pairFmt": "{a} en {b}",
      ...
      "startBody": "Vers van de weg in Eastbrook? Zoek Foreman Odell en neem A Trade for Every Hand: hij wijst je naar de ertsaders rond de Copper Dig ten zuidoosten van de stad en overhandigt je je eerste eelt. Let op de opgraving zelf: de Deeprock Diggers die erop kamperen staan ​​een paar niveaus boven een nieuwe aankomst, dus werk eerst aan de afgelegen aderen en bewaar het hart van het kamp voor als je een beetje geëgaliseerd bent. Vanaf dat moment oogst je elke ader, elke boomstam en elk kruidenveld dat je passeert tijdens het zoeken; vaardigheid is voor reizigers vanzelfsprekend.\n\nTerug in de stad druk je op T om het knutselvenster te openen en te werken met de algemene recepten die elk personage vanaf het begin kent. Bezoek de meesters in de smederij, keukens, weefgetouwen en gereedschapsfabrieken om te zien wat ze leren, en neem hun werkorders op voor vaste munten. Tegen de tijd dat de brief van het Gilde je vindt, weet je al welk paar zich als thuis voelt.",
      "colStation": "Station",
      "colHub": "Hub",
      "colMaster": "Meester",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Engineering bouwt de gereedschappen die elke serieuze verzamelaar nodig heeft: de pikhouwelen, bijlen, sikkels en hengels van niveau 4 en niveau 5 die geen enkele toonbank ooit voor munt zal verkopen, waarbij ze allemaal het gereedschap eronder verbruiken.",
        "enchanting": "Enchanting haalt de uitrusting uit elkaar en geeft de kracht er weer aan: breek ongewenste stukken in geheimzinnige materialen en geef ze vervolgens uit aan een permanente statistiekbonus voor een stuk dat je wilt behouden. Breken en betoveren heeft geen station en geen trainer nodig, en iedereen kan op dag één beginnen; alleen de twee charmerecepten vragen meer, geleerd op de gereedschapswerkplaats."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "Mijnbouw is de ruggengraat. Kopererts komt uit de tier 1-aders van Eastbrook Vale, ijzererts uit Mirefen Marsh en osmiumerts uit Thornpeak Heights, en elke sport van de ladder gaat op dezelfde manier omhoog. Houtkap is belangrijker dan je zou verwachten: ijzerbast draagt ​​de zwijnenspeer, essenhout draagt ​​de maul en een enkele hoge dennenboom vormt de strijdstaf.\n\nDe rest komt van de jacht en de balie. Ruwe huiden als houvast worden rechtstreeks van de lijken van wolven en zwijnen geoogst, botfragmenten komen van de rusteloze doden of uit geborgen gewone spullen, en de smederijladder verbrandt Smithing Flux, 20 koper per pot van Darva zelf. Als je eigen mijnbouw achterblijft, kan geen enkele counter je redden van het erts zelf: osmium komt uit de Thornpeak-aders, uit de starteraders van elke jongere zone behalve de Farshore (waarvan de aderen ijzer graven), of uit de stapel van een andere speler, door handel of de Wereldmarkt. Alleen de Glyphsteel Bar wordt voor munt gekocht, bij Tinker Gizzel bij de gereedschapswerkplaats of Quartermaster Bree in Highwatch.",
          ...
          "routeBody": "Elk stuk met een echte statistische lijn, wat op deze ladder de ijzeren sport en hoger betekent, kan als een meesterwerk van het aambeeld komen, zolang de fijnere kwaliteit maar binnen je plafond past; de staatloze koperen commons komen nooit voort, omdat er niets in valt te verbeteren. IJzer en osmium tellen als materiaal van niveau 1 voor de meesterwerkbonus, highpine en glyphsteel als niveau 2, en vaardigheid die boven het eigen niveau van een recept staat, voegt zijn eigen punt per niveau toe, dus onder de osmium drie zijn het de oorlogsbijl en de gevechtsstaf die de materiële voorsprong dragen, en een sport blijft beter voortbestaan ​​nadat je hem ontgroeid bent.\n\nBerijd de koperen sport tot 25, train de ijzeren sport op de dag dat hij opengaat en rijd hem naar 50, daarna de osmium-sport naar 75. Voorbij 75 is er nog niets hogers, dus de osmium-recepten vervagen tot de helft en dan een kwart winst: budget ongeveer 150 extra ambachten om de limiet van 125 te bereiken, en onthoud het gedeelde gaspedaal van tien ambachtelijke acties per minuut als je gaat zitten om te batchen.\n\nFinancier de klim terwijl je gaat: Darva's smederijopdracht neemt elke 30 minuten acht kopererts uit je handen voor een klein muntje en XP, en de ijzeren en osmium sporten verkopen eerlijk aan nivelleringsgevechten. Het Book of Deeds markeert Edge en Temper op vaardigheid 50 en bekroont Grandmaster Weaponcrafting op 125."
        },
        "armorcrafting": {
          "identityHeading": "Maliën voor de frontlinie",
          "identityBody": "De ladder van Armorcrafting leest als de carrière van een soldaat: de eenvoudige geklonken koperen gordel, sabatons en handschoenen om te beginnen, de ironlink maliënkolder, legguards en spaulders met hun eerste echte stat-lijnen, en de zeldzame osmiumschaal grote helm, kuras en leggings, Strength- en Stamina-stukken met pantsernummers die bovenaan de kunst van een crafter staan.\n\nHet heeft ook een rustigere kant: de Eastbrook Warded-legging, een veld-common met caster-statted, en de Kilnscale Mantle, een zeldzame Intellect en Spirit-postschouder op vaardigheid 75, houden de betoverde postdragers op de klantenlijst. Op de ring zit het tussen Weaponcrafting en Engineering; het Smith-paar met Weaponcrafting wordt beëdigd voor Forgemistress Darva, terwijl het Gearwright-paar met Engineering wordt genoemd maar nog geen eedmissie heeft.",
          "materialsHeading": "Erts bij de zak",
          "materialsBody": "Geen enkel vaartuig eet erts sneller. Alleen al de ironlink maliënkolder kost vijf ijzererts, en elk stuk osmiumschaal heeft drie of vier osmium plus een glyphsteel-staaf nodig, dus een serieuze wapenmaker ontgint Mirefen Marsh en Thornpeak Heights of betaalt iemand die dat wel doet. Koper voedt de eerste sport, rechtstreeks uit de aderen van de Copper Dig.\n\nRondom het metaal zitten de zachte delen: ruwe huid geoogst van lijken van wolven en zwijnen, botfragmenten van de rusteloze doden (of geborgen uit gewone spullen) en Smithing Flux-potten (elk 20 koperen in de smidse) in bijna elk recept. Geen enkele counter verkoopt osmium: de ongeduldige kopen het van andere spelers of delven het zelf, op Thornpeak of de starteraders van tien van de elf jongere zones (alleen de Farshore graaft ijzer).",
          "ladderHeading": "Leren bij Darva's smidse",
          "ladderBody": "Twee veldcommons, het Eastbrook Chainmail Vest en de Warded Leggins, zijn vanaf het begin bekend en worden overal gemaakt. De trainerladder bestaat uit negen recepten in drie sporten bij de Eastbrook-smidse: de koperen sport is gratis bij vaardigheid 0, de ironlink-sport kost 25 zilver per recept bij vaardigheid 25, en de osmiumschaal-sport kost elk 1 goud bij vaardigheid 50, waarbij elke sport kan worden geleerd zodra jouw niveau deze bereikt.\n\nVoorbij de ladder zitten twee specials. De Boundstone Helm is een van de twee Smith-combinatierecepten (de Gravewyrm Gauntlets zijn zijn broer of zus op het gebied van wapenbewerking), door trainers onderwezen, stationvrij en alleen uitvoerbaar door een afgestemde Smith met beide ambachten op vaardigheid 25. De Kilnscale Mantle heeft helemaal geen leraar nodig: iedereen kent het vanaf het begin, en niets anders dan de smederij en de materiaalpoorten die ermee werken. De vermelde vaardigheid van 75 gaat over winst, niet over toestemming: met Armorcrafting als major betaalt het de volledige vaardigheidswinst vanaf de allereerste hamerslag tot 99, dus een Smith met osmium in reserve kan er vroeg op leunen. Onder het plafond van een majoor leert het niveau 3-recept niets, dus een niet-aangegeven of hobby-pantsermaker werkt het voor het stuk, niet voor de punten.",
        ...
        "leatherworking": {
          ...
          "materialsBody": "Leerbewerking is het ambacht waarbij je nivelleringsroute en je aanvoerlijn hetzelfde zijn: ruwe huid wordt rechtstreeks geoogst van huiddragende lijken, vooral wolven en zwijnen, en elk lijk dient slechts één oogstmachine, wie het eerst komt, het eerst maalt. Een zeldzame of betere oogstrol levert ook een ongerepte huid op, een gesigneerd exemplaar waar de Mirewarden Jerkin om vraagt, dus spaar alles wat je vindt.\n\nDe ondersteunende cast is klein: spinnenpoten en zijde, handgesponnen stof van mensachtigen, een enkel osmiumerts in elk zeldzaam stuk mirewarden (zes in de sluitsteen van de Duskhide Wraps) en een looimiddel voor 16 koper van de toonbank van de leerlooierij. Osmium zelf wordt nooit tegengekocht: mijne het zelf, op Thornpeak of in de starteraders van bijna elke jongere zone (alleen de Farshore graaft ijzer), of koop het van een andere speler.",
          "ladderHeading": "Geleerd in Fenbridge",
          "ladderBody": "Hier is de rimpel: de leerlooierij staat in Fenbridge, aan de Mirefen Marsh Road, waardoor leerbewerking het enige diepe ambacht is dat in het moeras wordt getraind. Tanner Hesk leert de ladder in zijn vaten: de Fenbridge-huid sport gratis bij vaardigheid 0, de marshstalker sport op 25 zilver, een recept uit vaardigheid 25, en de mirewarden sport op 1 goud elk uit vaardigheid 50, waarbij elke sport opengaat naarmate je niveau deze bereikt.\n\nDrie recepten slaan de trainer over: de field commons (de Tanned Leather Jerkin en Eastbrook Druid's Hide) worden vanaf het begin gemaakt, en de Duskhide Wraps zijn bij iedereen bekend, maar zitten op vaardigheid 75, leerlooierij-gebonden. Merk op dat de Outfitter-eed zelf in Eastbrook bij Ottilie wordt beëdigd; alleen het lesgeven gebeurt in het moeras.",
          "routeHeading": "Meesterwerken, en een werkbare weg naar 125",
          "routeBody": "Elk stuk met echte statistieken maakt kans op een meesterwerk, zolang de fijnere kwaliteit binnen het plafond van je niveau past, inclusief de Eastbrook Druid's Hide, en een gesigneerde ongerepte huid in een Mirewarden Jerkin automatisch de ondertekende reagensbonus oplevert; osmium geldt als tier 1-materiaal voor de proc. De staatloze huidengemeenschap kan niet voortduren.\n\nLevel het op de natuurlijke manier: oogst elke wolf en elk zwijn dat je doodt vanaf niveau één, laat de twee veldcommons je naar 25 brengen waar je ook bent, en train dan de huidsport bij de vaten als de speurtochten je toch het moeras in trekken. Marshstalker brengt je naar 50 en mirewarden naar 75; voorbij dat de Duskhide Wraps, een niveau 3-recept met zes osmiumerts, drie Pristine Hide, twee ruwe huiden en een Tanning Agent, een afgestemde Outfitter volledige winst betaalt tot 99 en de helft daarna, ongeveer 75 ambachten voor de laatste vijftig punten tot de 125 cap; onder het plafond van een majoor leert het niveau 3-recept niets.\n\nDe mobiele leerlooierij is voor dit ambacht belangrijker dan enig ander: specialiseer je op 75-jarige leeftijd en een zadeltas met huiden wordt een afgewerkte uitrusting bij het kampvuur in plaats van een wandeling terug naar Fenbridge. Hesk's leerlooierijwerkorder koopt elke 30 minuten acht ruwe huiden, een nette opbrengst voor de huiden die je hoe dan ook verzamelde, en het Book of Deeds markeert Tanner's Trade op vaardigheid 50 met Grandmaster Leatherworking op de dop."
        },
        "cooking": {
          "identityHeading": "De pot die de groep voedt",
          "identityBody": "Eet een gekookte maaltijd en deze geneest je na 18 seconden rust, wat tussen de trekjes de goedkoopste genezing in het spel is. De ladder loopt van een Pan-Seared River Perch met 90 gezondheid helemaal tot aan Marlow's Grand Roast op 980, een sit-heal die niets in het spel kan verslaan.\n\nOp de ring zit Cooking tussen Alchemy en Leatherworking. Het levende paar is de Apotheker, Alchemie en Koken, beëdigd voor Cook Marlow in de keukens van Eastbrook nadat hij op vier wilde zwijnen voor de pot had gejaagd; het Trapper-paar met Leatherworking staat op de ring genoemd, maar heeft nog geen eedmissie.",
          "materialsHeading": "Een voorraadkast gevoed door hengel en mes",
          "materialsBody": "De visbestanden bevatten de kenmerkende ingrediënten, zone voor zone: spiegelforel en rivierbaars uit de wateren van Eastbrook Vale, moerassnoek en moeraspaling uit Mirefen Marsh, ijsforel en leisteenkarper uit Thornpeak Heights. De sporten mengen de zones vrijelijk (de vrije sport wil al moerassnoek, de middelste sport Thornpeak's ijskieuw, en het zeldzame avondmaal vouwt de spiegelforel van de Vale weer naar binnen), dus een kok die vist waar de weg ook heen gaat, komt nooit droog te staan.\n\nDe kant van de slager komt van geoogste lijken: wildvlees van zwijnen en hun verwanten, en, op een zeldzame of betere oogstrol, een gesigneerde Prime Cut, het middelpunt van het grote braadstuk. Kruiden kruiden de betere gerechten, één stuk essenhout rookt de paling, en Cooking Salt levert 8 koperen zakjes uit Marlows eigen kraam.",
          "ladderHeading": "Van boemdrogen tot het grootse braadstuk",
          "ladderBody": "Gezouten Boemdrogen is het veldrecept: van het begin bekend, een spin-poot, overal te craftten, het reisvoor van elke verse avonturier. De leermeesters-ladder kookt bij de Oostbeekse keukens aan de oostkant van het plein: de gratis trede op vaardigheid 0 (de baars, Jager's Wildspies, Gekruidde Moerassnoek), de midtrede op vaardigheid 25 voor 25 zilver per recept (Ashwood Gerookte Aal, Goudblad-Wildstoofpot, Ijsvinnen-Vissoep), en de zeldzame trede op vaardigheid 50 voor 1 goud elk (Zilverkarper-Maaltijd, Hengelaar's Feestschotel, Marlows Grootse Braadstuk).\n\nBatchgerechten strekken je ingredienten: de gerookte aal en de wildstoofpot serveren twee per bereiding, en de feestschotel drie. Marlow leert elke trede zodra jouw rang in Koken die bereikt.",
        ...
        "alchemy": {
          ...
          "identityBody": "Het ambacht wordt bewerkt in de apotheek in Highwatch, de thuisbasis van Alchemist Verane, Meester van de Apotheker, die de receptenladder leert, glazen flesjes verkoopt voor 12 koper en munten betaalt voor kruiden via haar werkorder.\n\nOp de ambachtsring zit Alchemy met vallen en opstaan, naast Engineering aan de ene kant en Koken aan de andere kant. Dat geeft het twee identiteiten: de Bombardier (Engineering and Alchemy, opgenomen bij Tinker Gizzel in Eastbrook) en de Apotheker (Alchemy and Cooking, beëdigd bij Cook Marlow). Stem af op een van beide paren om van Alchemy een hoofdvak te maken en laat je eigen gesigneerde werk je dat leren; het Bombardier-paar opent ook zijn combinatiebrouwsel, het Elixir of the Bear, terwijl het Apotheker-paar nog geen combinatierecept verzendt. De ladder zelf wacht echter nooit, omdat elk Alchemy-recept zich in het zeldzame niveau bevindt waar niet-aangegeven ambachten onder vallen, zodat de hele klim naar de top open is voordat er een eed wordt afgelegd.",
          ...
          "ladderBody": "Iedereen kent de Minor Healing Potion al vanaf het begin en kan hem overal mixen, er is geen station nodig. De echte ladder bestaat uit negen recepten die Verane bij de apotheek heeft geleerd, drie bij elke trede: de recepten van vaardigheid 0 zijn gratis, de vaardigheid 25 sport kost 25 zilver per recept en de vaardigheid 50 sport kost 1 goud per recept. Elke sport is een genezende drank, een mana-trekking en een uithoudingsvermogen-elixer, gaande van gewone sheenleaf-flessen (120 gezondheid, 160 mana) via ongewoon bladgoud (200 gezondheid, 260 mana) tot zeldzaam zonnebloemblad (280 gezondheid, 360 mana).\n\nDe elixers stijgen op dezelfde manier: het elixer van het zwijn geeft 6 uithoudingsvermogen voor 10 minuten, het Vipersear-elixir 9 voor 15 minuten en het elixer van de slang 12 voor 15 minuten, waarbij alleen de slang twee flessen per ambacht brouwt. Nog een recept ligt terzijde: het Elixir of the Bear, een combinatiebrouwsel dat Verane leert voor 25 zilver zodra je Alchemy 25 bereikt, overal mengbaar, maar alleen door een afgestemde Bombardier met zowel Alchemy als Engineering op 25.",
          "routeHeading": "De weg van een brouwer naar 125",
          "routeBody": "Concepten en elixers zijn nooit meesterwerken; die proc behoort tot uitrusting met statistieken. Je naam reist echter nog steeds rond: de zeldzame zonnebloemblaadjes komen ondertekend aan met het merkteken van de maker, en dat geldt ook voor elke fles van het dubbele batch Elixir of the Serpent, dus niets zeldzaams in dit ambacht laat de bank ongesigneerd achter. Bij vaardigheid 75 specialiseer je je, en elk Alchemy-recept kost vanaf dat moment 20 procent minder materialen.\n\nNeem Herbalism vroeg en kies naarmate je levelt: sheenleaf is overal in de Vale, en zodra je Verane's bank bereikt, brengt de vrije trede je netjes naar vaardigheid 25 op kruiden die je toch zou hebben geplukt. Leer de 25-sport zodra hij wordt ingeschakeld, verplaats je pluk naar het moeras voor bladgoud en laat de werkorder van Verane (zes bladgoudkruiden voor 45 koper, elke 30 minuten herhaalbaar) onderweg een klein muntje teruggeven.\n\nBrouw vanaf 50 zonnebloemblaadjes en Serpent-batches uit Thornpeak-zonneblaadjes, met nog een beetje Vale- en moerasgroen in de mix. Het laatste stuk van 100 naar 125 is een opzettelijk straaltje, dus brouw wat daadwerkelijk verkoopt in plaats van kruiden te verbranden voor het aantal, en onthoud dat verbruiksartikelen het goede zijn dat iedereen voor altijd opnieuw koopt. Het Book of Deeds markeert Strange Brews op vaardigheid 50 en Grandmaster Alchemy op de dop."
        },
        "engineering": {
          "identityHeading": "Het monopolie van de gereedschapsmaker",
          "identityBody": "Het ambacht wordt bewerkt in de gereedschapswerkplaats in de zuidwestelijke hoek van Eastbrook Square, de thuisbasis van Tinker Gizzel, Master of the Toolworks. Niveaus 1 tot en met 3 van elke gereedschapslijn zijn gewone leveranciersvoorraad; Niveaus 4 en 5 komen van een ingenieursbank, of uit de delve-teller van de Drowned Litany voor Delve Marks achter de vrije poorten, en nooit uit een kassa voor munten.\n\nOp de ring zit het met vallen en opstaan, naast Alchemy en Armorcrafting, waardoor het twee paar identiteiten krijgt: de Bombardier (Engineering en Alchemy, overgenomen door Gizzel zelf) en de Gearwright (Armorcrafting and Engineering, genoemd maar nog niet beëdigbaar). Eén waarschuwing is hier belangrijker dan waar dan ook: alle receptsporten van Engineering bevinden zich boven het zeldzame plafond waar hobby's en niet-aangegeven ambachtslieden onder werken, dus het vaardigheidsnummer beweegt alleen voor een ambachtsman wiens hoofdvak Engineering omvat, wat tegenwoordig de Bombardier betekent. Iedereen kan nog steeds het landwerktuig bouwen; een onaangepaste ambachtsman leert er gewoon niets van, en de twee hengelrecepten vragen bovendien om de leer van Gizzel.",
          "materialsHeading": "Reagenten en vorige gereedschappen",
          "materialsBody": "Elk recept voor landgereedschap verbruikt het gereedschap één niveau eronder plus een FINE-materiaal, en die koppeling is de hele landladder: vier Fine Iron Ore en een Skysilver Mining Pick worden de Osmium Mining Pick, dan worden twee Glyphsteel Bars, twee Fine Osmium Ore en die osmium pick de Glyphsteel Mining Pick. De bijl- en sikkellijnen weerspiegelen de fijne plus-voor-gereedschap-vorm met fijn essenhout en fijne hoogpijnboomstammen, fijn bladgoud en fijne zonnebloemblaadjeskruiden, hoewel voor hun niveau 5-sporten geen Glyphsteel-staven nodig zijn: de houweel is de enige lijn die bovenaan duurder wordt. De twee hengelrecepten doorbreken het patroon met opzet: de Stormreel neemt vier Sunglint Koi en een Silverstream hengel, de Tidewrought twee Koi, acht Raw Slatefin Carp en die Stormreel, dus de top van de vissersladder wordt op het water betaald in plaats van op een ader.\n\nEen fijn materiaal wordt nergens verkocht en valt niet uit een gewone oogst: je verkrijgt het door een van de volwaardige aderen van een zone te bewerken met een gereedschap dat boven het materiaal zelf staat, wat in de praktijk betekent dat het gereedschap een sport lager is dan het gereedschap dat je probeert te bouwen (hoe makkelijker de aderen in een zone blijven voor reizigers om het gewone materiaal op te leveren, wat je ook slingert). Dat is opzettelijk. Op de knutselroute komt een hulpmiddel van niveau 5 voort uit het feitelijk zwaaien met niveau 4, niet uit een winkeluitje; de Delve Marks-teller is de enige manier om dit te omzeilen. De enige uitzondering is de Glyphsteel Bar, verfijnd en alleen voor leveranciers, 1 zilver 60 koper per baar van Quartermaster Bree in Highwatch of van Gizzel's eigen toonbank, dus alleen de Glyphsteel Mining Pick heeft een vaste muntvloer die in de prijs is ingebouwd.",
          "ladderHeading": "De gereedschappenladder",
          "ladderBody": "De ladder bevat acht recepten, allemaal gebonden aan het gereedschapsstation. De zes recepten voor landgereedschap zijn automatisch bekend, er is nooit een trainersvergoeding: de pikhouweel, bijl en sikkel van niveau 4 bij vaardigheid 75, en de versies van niveau 5 bij vaardigheid 150. Dat tweede getal is geen typfout, en het staat met opzet boven de huidige limiet van 125: vaardigheidsvereisten bepalen hier nooit een ambacht, ze bepalen alleen de vaardigheidswinst, dus je kunt een hulpmiddel van niveau 5 bouwen op de dag dat je de reagentia en zijn voorganger van niveau 4 vasthoudt. De twee vervaardigde hengels vormen de uitzondering die wordt aangeleerd: Gizzel leert de Stormreel op vaardigheid 75 voor 4 goud en de Tidewrought op vaardigheid 125 voor 16 goud, elk op het moment dat jouw niveau in het vaartuig zijn eigen niveau bereikt.\n\nElk voltooid gereedschap is zeldzaam of van epische kwaliteit en wordt gesigneerd geleverd, zodat jouw naam op de gereedschapsriemen van andere spelers terechtkomt. Engineering bevat ook de helft van één combinatierecept: het Elixir of the Bear, gebrouwen door een afgestemde Bombardier met zowel Engineering als Alchemy op 25-jarige leeftijd.",
        ...
        "enchanting": {
          ...
          "identityBody": "Elke betovering is vanaf het begin bekend, iedereen kan vanaf de eerste dag ontgoochelen, en geen van beide heeft ooit een station nodig; de vaardigheidslimieten op 125 zoals elk ambacht. De enige geleerde hoek van het vak zijn de twee charmerecepten: Tinker Gizzel leert de Gatherer's Cache en het Artisan's Eye bij de gereedschapswerkplaats in de zuidwestelijke hoek van Eastbrook Square, voor het gewone niveautarief zodra je Enchanting 25 bereikt, en de charmes zelf worden op zijn station bewerkt.\n\nOp de ring zit het tussen Inscription en Jewelcrafting, dus de twee paaridentiteiten zijn de Arcanist (Inscription en Enchanting) en de Gembinder (Enchanting en Jewelcrafting). Geen van beide kan nog worden beëdigd, aangezien beide buren wachten op hun eerste recepten, dus vandaag zijn betoverende beklimmingen een ambacht voor iedereen: gratis tot het zeldzame niveau vóór elke eed, en een natuurlijke hobbykeuze voor een Bombardier of een Apotheker. Enchanters houden ook de verzamelwereld draaiende: de twee slottable-tooleffecten zijn Enchanter-werk, en een originele crafter laadt zijn eigen effecten met korting op, nog dieper als ze gespecialiseerd zijn.",
          "levelingHeading": "Hoe Betovering omhoog gaat",
          "levelingBody": "Drie acties verplaatsen de vaardigheid: een stuk ontgoochelen, een betovering toepassen en de twee charmes maken, die de gewone ambachtelijke curve beklimmen. Elk succes is maximaal één punt waard, afhankelijk van hoe serieus het werk is: de zeldzaamheid van het stuk dat je breekt, of het reagensniveau van de betovering die je toepast. Algemene ontgoochelingen en alleen-stof-betoveringen scoren als gewoon werk; ongewoon ontgoochelt en essentie betovert als ongewoon; zeldzame ontgoochelingen en elke Runed- of Greater-betovering is zeldzaam; epische en legendarische ontgoochelingen staan ​​nog steeds hoger op tafel, hoewel geen enkele betoverende identiteit tegenwoordig verder reikt dan de zeldzame trede, dus betalen ze in de praktijk hetzelfde als zeldzaam werk. Eén eerlijkheid regeert de breekbank: een stuk dat van een spelersbank kwam (gemaakt, gesigneerd of meesterwerk) freest nog steeds in materialen maar leert niets, dus een craft-and-break-lus brengt niemand op gelijke hoogte, en de lessen zijn in wereldgevonden uitrusting.\n\nDe bekende beheersingsvervaging is van toepassing op niveaus van 25 punten, dus werk van normaal niveau wordt grijs bij vaardigheid 75, ongewoon werk bij 100 en werk van zeldzaam niveau precies bij de limiet van 125. Betoveren heeft ook één voordeel: input boven het plafond van je archetype wordt naar beneden afgerond naar dat plafond in plaats van op nul gezet, dus voordat je afstemt, scoort een epische ontgoocheling simpelweg als zeldzaam in plaats van niets te leren. Als Enchanting achter een andere identiteit sluimert, de score verbreekt en toepast als gewoon werk en de klim op 75 blijft staan, terwijl de twee charmes, die de knutselcurve boven het gemeenschappelijke plafond volgen, een slapende tovenaar helemaal niets leert; bewaar het omdat je hobby en zeldzaam werk nog steeds loont, alleen langzamer dan 75.",
          "marketHeading": "Betoverde exemplaren, herkomst en de markt",
          "marketBody": "Door een betovering toe te passen, worden de reagentia uitgegeven en wordt één specifiek exemplaar van het item gemarkeerd. Richt het op een ingepakt exemplaar en je krijgt een duidelijk betoverd exemplaar terug; richt het op een kledingstuk dat je al draagt ​​en het wordt betoverd op zijn plaats, precies waar het zit, zonder dans die je moet uitrusten en opnieuw uitrusten. Hoe dan ook, de bonus volgt dat stuk voor altijd, via unequips, banktrips en transacties. Eén betovering per stuk: het toepassen van een andere betovering op een betoverde kopie vraagt ​​om bevestiging, vervangt vervolgens de oude betovering en vernietigt deze zonder restitutie van de materialen. Verkopen, weggooien en ontgoochelen geven allemaal de voorkeur aan gewone kopieën, zodat je voltooide stuk niet per ongeluk wordt opgegeten.\n\nMeesterwerkuitrusting en betovering zijn vrienden: een meesterwerkstuk blijft volledig betoverbaar, en de betovering voegt bovenop de meesterwerkbonus toe zonder het of de handtekening van de maker te verstoren. Door elke bron op elkaar te stapelen, is een ondertekend meesterwerk met een grotere betovering het beste dat een vervaardigd stuk kan krijgen, en het zit door zijn ontwerp nog steeds onder de raid-buit.\n\nOp de markt wordt een betoverd of gesigneerd stuk als al het andere vermeld: het gaat omhoog als zijn eigen vermelding in één exemplaar, de tooltip toont de betovering en het merkteken van de maker, en de Ravenpost vermeldt het net zo getrouw. De materialen blijven de vaste helft van het ambacht: stof, essentie en scherven worden vrijelijk aangeboden, het aanbieden kost niets en de handelaar neemt slechts 5 procent van een voltooide verkoop. Dat maakt dat de twee klassieke tovenaars inkomens verdienen door materialen te verkopen en voltooid werk te verkopen: via de markt, per raaf of face-to-face in een handelsetalage."
        }
      },
      "howHeading": "Hoe vervaardiging werkt",
      "howBody": "Open het knutselvenster (standaardtoets T) en elk recept dat je kent, wordt vermeld met wat het nodig heeft en wat je bij de hand hebt. Stationgebonden recepten vragen je om binnen 20 meter van het juiste station in de stad te staan, veldrecepten kun je overal maken, en het breken en betoveren van Enchanting heeft helemaal geen station nodig (alleen de twee charmerecepten zijn stationwerk, bij de gereedschapswerkplaats). Er bestaat geen mislukking: een ambacht met de materialen in de hand slaagt altijd.\n\nTwee kleine fricties houden de economie eerlijk. Elk succesvol ambacht betaalt een vergoeding van 2 koper per punt van het statistische budget van het item, en acties van het type ambacht delen één tempo: maximaal 10 ambachten, ontgoochelingen, betoveringen, bergingen of het opladen van gereedschappen in elk venster van 60 seconden. Geen van beide zal een normale sessie hinderen; beide voorkomen dat een maximale specialist de markt overspoelt.",
      ...
      "masterworkBody": "Elk succesvol ambacht is precies wat het recept belooft, en soms een beetje meer: ​​een meesterwerk maakt hetzelfde stuk een kwaliteitsniveau fijner af, waarbij de bonusstatistieken tijdens het ambacht worden ingebakken. Het is alleen een toevoeging, nooit een downgrade, en het blijft onder de raid-vloer, dus vervaardigde uitrusting kan uitstekend zijn zonder een raid-drop te vervangen.\n\nDe kans is gepubliceerd, niet mystiek: {base}% basis, plus {perTier}% per niveau dat je vaardigheid hoger ligt dan het recept, plus {signed}% als er een ondertekend reagens in gaat, plus {spec}% als je eenmaal gespecialiseerd bent, waarbij materialen van een hoger niveau 1 tot 2% meer toevoegen, alles met een maximum van {cap}%. Alleen een stuk met echte statistieken kan verbeteren, dus staatloze commons, gereedschappen en verbruiksartikelen komen nooit voort; een sluimerend vaartuig brengt er nooit één voort, en een hobbyvaartuig kan zijn meesterwerk niet verder brengen dan zijn zeldzame plafond.\n\nFijn werk draagt ​​zijn maker. Zeldzame en betere resultaten worden ondertekend, elk exemplaar (gemaakt door; verzameld materiaal wordt verzameld door), een meesterwerk wordt altijd ondertekend, ongeacht de kwaliteit ervan. Een handtekening is de herkomst, geen slot: ondertekende goederenhandel, post en vermelding op de wereldmarkt vrijelijk.",
      "trainingHeading": "Training",
      "trainingBody": "Trainerrecepten zijn afkomstig van de plaatselijke meesters, die op hun stations worden onderwezen. De regel is één regel: een meester leert een recept zodra jouw niveau in het vak het eigen niveau van het recept heeft bereikt, en niets anders kan het bereiken, niet jouw niveau, niet jouw archetype. De uitrustings- en verbruiksladders lopen met hun sporten op vaardigheid 0, 25 en 50; De twee hengellessen van Engineering zetten de ladder voort op 75 en 125, en de twee charmerecepten van Enchanting bevinden zich op sport 25, dus er gaat een nieuwe sport open als je niveaus stijgen.\n\nDe kosten zijn eenmalig en vast per sport: de startsport is gratis, de vaardigheid 25 kost {tier1} een recept, de vaardigheid 50 trede {tier2}, en de hengellessen erboven hebben hun eigen kosten, vermeld naast elk recept in de tabel. Je moet op het eigenlijke station van de meester staan ​​om te trainen, en een mobiel station telt nooit mee. De gewone veldrecepten en de zes zelfgemaakte recepten voor landwerktuigen behoeven helemaal geen training; elk personage kent ze vanaf het begin.",
      ...
      "ench": {
        ...
        "enchantsNote": "Betoveringen zijn er in drie niveaus. De basislaag draait op Chime Dust (met een beetje Essence aan de bovenkant) en omvat de wapensleuf plus elke pantsersleuf behalve de off-hand, met voldoende stat-asopties zodat elke build iets voor elke slot vindt. De Greater-laag kost één Chime Shard plus Essence: sterkere bonussen op slots met de hoogste impact. Shards voeden bovendien nog twee putten, de twee charmerecepten voor vijf per stuk en de bovenste trede van het opladen van gereedschapseffecten, dus spaar er een paar voordat je geld uitgeeft.\n\nDaartussen zitten de vijf Runed-betoveringen, één consument per getypte secundaire, dus niets dat je freest is ooit een doodlopende weg: Runed Edge (wapen, kracht, verbruikt Resonant Steel), Runed Sigil (wapen, Intellect, Resonant Timber), Runed Weave (borst, Spirit, Resonant Thread), Runed Hide (benen, Agility, Resonant Hide) en Runed Links (helm, Stamina, Resonant Links). Elk neemt ook twee Chime Essence; waar een slot en stat zowel een basis als een grotere betovering hebben, komt de Runed-bonus ertussen terecht, terwijl Runed Weave de sterkste Spirit-betovering op de borst is en Runed Hide de enige Agility-betovering op de benen is. De exacte bonussen staan ​​allemaal in de onderstaande tabel.",
      ...
      "gatherIntro": {
        "mining": "Mijnbouw haalt erts rechtstreeks uit de rotsen van de wereld: koper in Eastbrook Vale, ijzer in Mirefen Marsh en osmium in Thornpeak Heights, met startaders verspreid over elke jongere zone daarbuiten, die de smederijen voeden. Open voor iedereen vanaf niveau 1: een 20 kopermijnplectrum van een Eastbrook-, Fenbridge- of Highwatch-teller opent elke startader, en de hogere sporten van de pickladder worden wakker als je eigen teller ze verdient. Bijgehouden op zijn eigen teller tot een maximum van 100.",
        "logging": "Bij houtkap wordt hout gekapt van boomstammen over de hele wereld: ijzerschors in Eastbrook Vale, essenhout in Mirefen Marsh, hoge dennen in Thornpeak Heights, en starters in elke jongere zone, de ruwe voorraad voor handbomen, duigen en de ingenieursbank. Open voor iedereen vanaf niveau 1 met een houtbijl in je koffers (20 koper bij de Eastbrook-, Fenbridge- en Highwatch-balies), bijgehouden op de eigen teller tot een maximum van 100.",
        "herbalism": "De kruidengeneeskunde verzamelt wat in het wild groeit: glansblad in Eastbrook Vale, bladgoud in Mirefen Marsh, zonnebloemblad in Thornpeak Heights en starterplekken in elke jongere zone, het blad en de stengel die het apothekersvak in stand houden. Open voor iedereen vanaf niveau 1 met een kruidensikkel in je tas (20 koper bij de Eastbrook-, Fenbridge- en Highwatch-balies), bijgehouden op zijn eigen teller tot een maximum van 100.",
        "fishing": "Vissen is een vreemde eend in de bijt onder de verzamelactiviteiten, en de diepste: een echte hap-en-reel-minigame, zijn eigen vangsttabellen in elk van de drie kernzones (de jonge wateren daarbuiten bedienen voorlopig allemaal de tafel van de Vale), en een vaardigheidslimiet van 200, tweemaal zoveel als de andere. Koop een hengel, kijk naar open water en werp."
      },
      "rhythmHeading": "Het verzamelritme",
      "rhythmBody": "Een oogst is een korte zichtbare worp, geen onmiddellijke greep: {base} seconden basis, nooit onder een {floor} tweede verdieping. Als je een stuk gereedschap boven het niveau van het knooppunt draagt, een stuk gereedschap dat je met je vaardigheid kunt gebruiken, versnelt je met {tool} seconden per niveau erboven, en elke vaardigheidsband die je overschrijdt, verkort nog eens {band} seconden; Alleen al het matchen van het niveau van het knooppunt brengt je binnen, het zijn de niveaus erboven die je snel maken.\n\nEen volle zak weigert beleefd de cast voordat deze begint, dus er wordt niets verspild halverwege de swing, en voor elke oogst wordt een klein stukje karakter-XP betaald, geschaald op basis van het niveau van het knooppunt ten opzichte van dat van jou, zoals de kill-XP-schaal: een triviaal grijs knooppunt leert een afgedekt personage niets.",
      "gainBody": "Winst is deterministisch, nooit een vaardigheids-up roll: een knooppunt op of boven jouw winstniveau levert een volledig punt per oogst op, en elke {step}-vaardigheid is één niveau dat wordt gescoord tegen het knooppunt. Tier 1-nodes betalen volledig onder de 25, de helft tot 49, een kwart tot 74 en niets vanaf 75; niveau 2-knooppunten betalen volledig aan 49; de twee niveau 3-knooppunten van elke transactie betalen volledig tot 74 en de helft tot aan de limiet van {cap}.\n\nDe beoogde route is duidelijk: leer op de startknooppunten van de Vale, ga naar het moeras en eindig de klim op de hoge grond van Thornpeak Heights. Bij de limiet stopt het leren, maar de opbrengsten niet: een verzamelaar met een limiet blijft voor altijd de beste kansen rollen die de handel biedt.",
      ...
      "toolsNote": "Elk knooppunt heeft zijn handelsgereedschap in je koffer nodig, inclusief niveau 1: geen pikhouweel, geen erts, en geen hengel, geen vis. De leveranciersladder bestrijkt de niveaus 1 tot en met 3 in de drie kernknooppunten: het gereedschap van niveau 1 wordt bij alle drie verkocht, de sporten erboven beginnen op de grond die ze gebruikt (Fenbridge voegt niveau 2 toe, Highwatch niveau 3), en de jongere nederzettingen daarbuiten hebben helemaal geen gereedschap in voorraad, dus zorg dat je je uitrusting gereedmaakt voordat je op reis gaat. Elke toonbank verkoopt elke sport die hij in voorraad heeft, en elk stuk gereedschap gaat via directe handel; elke trede wordt ook vermeld op de Markt en reist per post, behalve de drie landstarters van 20 koperen: die worden aan een balie gekocht of van hand tot hand doorgegeven, en nooit terugverkocht, per post verzonden of vermeld. Wat afgesloten is, is het hanteren. Een landgereedschap boven niveau 1 werkt alleen als je vaardigheid in zijn eigen vak het heeft verdiend. {tier2Prof} voor niveau 2, {tier3Prof} voor niveau 3, en 85 en 100 voor de twee vervaardigde sporten, en de leveranciersrij, de tooltip en de tabel hieronder noemen allemaal de vereiste vooraf. Tot die tijd wacht een gereedschap dat je vooruit hebt gekocht gewoon in je koffers, opent geen terrein, koopt geen snelheid en slaat geen fijne cijfers, en hanteert het moment dat je teller het nummer raakt. Hengels vormen de enige uitzondering: voor geen enkele hengel is een hanteervereiste vereist, en handelaar Wilkes in Eastbrook heeft opzettelijk de niveau 2 en niveau 3 hengels in voorraad voor vissers die vooruit kopen. Een gereedschap neemt nooit een uitrustingsslot in beslag en verslijt nooit, dus elk is een eenmalige aankoop, en alleen het niveau is van belang voor de poort: een zeldzamer gereedschap van hetzelfde niveau opent niets extra's. Zeldzaamheid is echter niet alleen kleur. Het zorgt ervoor dat het effect van een gleufgereedschap langer meegaat, en op een hengel vergroot het het molenvenster.\n\nEen beter hulpmiddel koopt drie dingen, niet twee. Het opent terrein op een hoger niveau, het verkort de worp, en het verbetert wat eruit komt: werk een ader met een stuk gereedschap dat BOVEN het eigen materiaal van de zone staat, en de oogst levert het fijne materiaal op in plaats van het gewone materiaal. De ader moet een van de volwaardige aderen van de zone zijn, dus de gemakkelijkere aderen die een zone voor reizigers behoudt, leveren nog steeds het gewone materiaal op. De recepten voor handgemaakte gereedschappen verbruiken fijne materialen, en overal waar een recept of een werkorder daarom vraagt, geldt een fijne kwaliteit als de gewone versie, dus upgraden laat je nooit in de steek: het betekent alleen dat je kopererts arriveert als fijn kopererts.\n\nBoven de verkopersladder heeft elke transactie twee vervaardigde gereedschappen, niveau 4 en niveau 5, gemaakt in de gereedschapswerkplaats (elk personage kent de landrecepten; de vaardigheid die voor het werk klimt is die van Engineering), of gekocht met Delve Marks bij de Drowned Litany-balie zodra aan de clears-poorten is voldaan: de onderstaande tabel bevat de Marks-prijs en de clears die elke trede vraagt. Geen enkele handelaar verkoopt ze ooit voor munt. Vissen heeft zijn eigen paar, en deze worden geleerd van de gereedschapsmaker in plaats van vanaf het begin bekend te zijn. Geen enkel knooppunt en geen water heeft vandaag de dag meer nodig dan niveau 3, dus kopen de bovenste twee sporten snelheid, hellingshoek en een vriendelijker haspelvenster in plaats van toegang, en zullen ze het toegangsticket zijn wanneer hoger niveau arriveert.",
      "toolCrafted": "Gemaakt ({craft})",
      "toolCraftedOrMarks": "Gemaakt ({craft}) of {marks} Delve Marks nadat drie Drowned Litany zijn gewist",
      "toolCraftedOrMarksHeroic": "Gemaakt ({craft}) of {marks} Delve Marks na een heroïsche verdronken litanie duidelijk",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Niet verkocht",
      "priceNone": "Wordt niet voor munt verkocht",
      "toolTierReq": "Rang {tier} gereedschap",
      "colWield": "Gebruik bij",
      "wieldNone": "Elk",
      ...
      "bandsBody": "Vaardigheidsbereiken zijn de gedeelde 0/100/200-ladder boven de handelsteller. Voor de landhandel kruiste de band bij 100 scheerbeurten de verzamelcast, en hun pet maakt band 1 tot plafond. De vissersbanden scheren niets: zij selecteren de vangsttafels (met een bijpassende hengel), alleen de visserij bereikt band 2, en het is de klim zelf die een visser naar dieper water trekt, waar zowel de betere tafels als de verdere lessen leven.",
      ...
      "specimenBody": "Houd wat ruimte vrij als je gaat boeren: een ondertekende meevaller heeft een eigen ruimte nodig of een bijpassende ondertekende stapel om in te landen, en als er niets past, komt de opbrengst nog steeds binnen, maar de handtekening gaat verloren. Het oogsten van lijken heeft ook zijn eigen jackpottak: ongeveer {pct}% van elk geoogst onderdeel komt zeldzaam of beter voor. Een familie die een perfect exemplaar wil geven (huid, zijde, gif, vlees) houdt de gewone opbrengst duidelijk en munt het ondertekende exemplaar ernaast; elke andere familie ondertekent de opbrengst zelf.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "Bij de 100 mijlpaal staat Old Salt vermeld en bij de 200 staat Master Angler met de titel, de absolute top van de kunst van de visser; Vissen telt ook mee voor Master Gatherer, verdiend bij 100 in drie verzameltransacties. Een eerste vis uit elk van de wateren van de zes zones vult zijn eigen pagina, de drie kernzones en de Willowfen, de Galecrest en de Farshore daarachter, en de Sunglint Koi registreert Glimmer of Hope, zodat reizigers met een hengel in hun roedel hun boek sneller vullen dan ze verwachten."
      },
      "fish": {
        "startHeading": "Aan de slag",
        "startBody": "Een Simple Fishing Pole kost 20 koper bij Fisherman Brandt in Eastbrook (zoek naar Old Salt aan de oostkant van de stad, langs de weg naar Mirror Lake); Tinker Gizzel, Provisioner Hale in Fenbridge en Quartermaster Bree in Highwatch zijn ook aandelenpolen. Gebruik de paal terwijl je in het water kijkt dat diep genoeg is om vissen vast te houden, tot ongeveer 24 meter voor je, en je bobber vaart uit.\n\nJe kunt niet werpen tijdens een gevecht, tijdens het zwemmen of terwijl je dood bent: werpen vanaf de kust is de beoogde houding. Water wordt echter moeilijker naarmate het land dat doet: het moeras wil op zijn minst de ijzeren molen van niveau 2 en de toppen de Zilverstroom van niveau 3, en een lijn die wordt geworpen zonder de hengel die het water meeneemt, verlaat nooit je hand. Daarboven zitten twee hengels, de Stormreel en de Tidewrought: ingenieurs maken ze in de gereedschapswerkplaats uit wat een lijn omhoog trekt, en de delve-teller van de Drowned Litany verkoopt ze voor Delve Marks achter de open poorten, maar nooit voor munten. Er wordt niet om water gevraagd, dus kopen ze een kortere wachttijd en een breder haspelvenster in plaats van toegang, wat op de bovenste sport een hap in een platte drie seconden betekent.",
        "biteHeading": "Aanslaan en inhalen",
        "biteBody": "Na het werpen komt er een hapje op een verborgen moment tussen {min} en {max} seconden; de vertraging wordt bepaald wanneer de lijn landt, dus geen twee worpen voelen hetzelfde aan. Wanneer de dobber bijt, heb je een venster van {reel} tweede om de hengel opnieuw in te drukken en binnen te halen: haal erin en de vangst landt, aarzel er voorbij en de vis komt weg zonder iets te laten zien. Een hele sessie duurt maximaal {cap} seconden, dus zelfs een stille cast verdwijnt snel.\n\nBetere hengels scherpen beide uiteinden van de minigame aan: elke hengellaag boven de eerste trimt {rod} seconden van de langst mogelijke wachttijd, nooit onder de verdieping van drie seconden graast de bovenste hengel al, en voegt {reelRod} seconden toe aan het rolvenster, dus de Ironreel trekt het ergste wachten terug naar 6,5 seconden met een venster van 3,25 seconden, en de Silverstream naar 5 met een venster voorbij 4, waardoor de zeldzaamheid de rol iets breder maakt dan wat de niveau alleen betaalt. De snelste aanbeten veranderen nooit wat je vasthoudt, en er hoeft alleen maar een hengel in je tas te zitten om te tellen.",
        "scheduleHeading": "Vaardigheidswinst",
        "scheduleNote": "De viswinst volgt een vast schema zonder dobbelstenen: een volledig punt per vangst onder de 50, een half punt onder de 100, een tiende onder de 150 en een langzaam druppeltje van 0,02 van 150 naar 200. Dat laatste stuk is met opzet een reis van duizenden vangsten: 200 is een statement, geen tussenstop op weg naar iets anders.\n\nJunk stopt volledig met lesgeven op {cutoff}: vanaf dat moment zijn onkruid en laarzen alleen maar onkruid en laarzen. Het water zelf maakt ook de les uit: de wateren van niveau 1 van de Vale (en elke jonge kust buiten het binnenland) leren niets boven de 100, de stop van het moeras op 150, en alleen de school van Thornpeak is een visser tot aan 200. Elke aangevoerde vangst wint anders met de geplande snelheid, dus als de teller stopt, vertelt het schema je dat je dieper water moet zoeken.",
        "colProficiency": "Vaardigheid",
        "colGain": "Winst per vangst",
        "belowFmt": "Onder {below}",
        "tablesHeading": "Vangsttabellen",
        "tablesNote": "Je vaardigheid selecteert een van de drie vangbanden: band 0 vanaf het begin, band 1 op 100, band 2 op 200, waarbij elk gewicht uit rommel en lege haken wordt verplaatst naar echte vis, zone voor zone. Elke band boven de eerste vraagt ​​ook om een ​​hengel: band 1 wil de tier 2 Ironreel, band 2 de tier 3 Silverstream. Je effectieve band is de laagste van wat je vaardigheid heeft verdiend en wat je hengel ondersteunt, en de dop is stil: met een kleinere hengel vang je nog steeds, net buiten de tafel van de lagere band, dus als je vangsten vastlopen terwijl je vaardigheid stijgt, controleer dan eerst je hengel.\n\nDe wateren van elke zone bevatten hun eigen paar voedselvissen, die beter genezen naarmate de zone dieper is, allemaal kookinputs en prima eet-en-eetvoedsel, rauw van de lijn. De rest van de tabel is de vissersbelasting: wiet, af en toe een laars en de lege haak, die nooit helemaal verdwijnt. Hoeveel u betaalt, hangt af van het water waarin uw dobber landt, niet van waar u staat: een worp reikt tot 24 meter, en de hengel die het water nodig heeft, de tafel waaruit hij put, de akte die hij crediteert, en hoe ver hij leert, is allemaal antwoord op de zone waartoe het water behoort, bepaald op het moment dat de lijn landt. Het water van elke zone is geschreven voor een eigen band, de Vale voor band 0, het moeras voor band 1, de pieken voor band 2, en als je één band daaronder vist, verandert ongeveer een derde van je worpen in lege haken, twee banden daaronder meer dan de helft. De hengel brengt je naar het water; het is de vaardigheid die ervoor zorgt dat het loont, en het is de klim die een visser dieper trekt, want betere bands zorgen niet alleen voor een betere beloning: voorbij de Vale zijn dit de enige wateren die les blijven geven. De {rare} is de enige rij die beantwoordt aan jouw vangband en niets anders: dezelfde kansen in elke zone, en zes keer waarschijnlijker op band 2 dan op band 0, dus het zeldzaamste op de kade is datgene waar een Master Angler echt beter in is.",
        ...
        "koiBody": "Elk waterlichaam in het spel verbergt dezelfde prijs: de Sunglint Koi, een ongewone glans op de lijn die 75 koper waard is voor een verkoper en nog veel meer voor je trots. De kansen zijn afhankelijk van je vangband en van niets anders, hetzelfde in elke zone: een rij van 1 procent van de vangsttabel op band 0, 3 op band 1 en 6 op band 2, getrokken bij elke binnengehaalde worp, zodat de koi naar de visser komt die de diepe tafels heeft verdiend. Als je er één landt, wordt Glimmer of Hope in je Book of Daden opgenomen, een verzamelaarsmerk van nul roem. Wanneer dit gebeurt, zorgt het logboek ervoor dat u dit weet."
      },
      "econ": {
        ...
        "trainingNote": "Eén vast bedrag per recept, één keer in rekening gebracht als een meester het leert; elke trede van de onderstaande tabel wordt vandaag de dag live gebruikt, van de gratis startersrecepten tot de hengellessen van de gereedschapmaker bovenaan.",
        ...
        "provenanceBody": "Sommige items dragen een naam. Beweeg er een over en de tooltip zegt Verzameld door die-en-zo op een onbewerkt materiaal, of Gemaakt door die-en-zo op een voltooid stuk: hetzelfde merkteken, geformuleerd voor hoe het item tot stand is gekomen. Een handtekening maakt deel uit van het item zelf, reist met hem mee via transacties, de bank, de post, de wereldmarkt en zelfs door een terugkoop door een verkoper, en vervaagt nooit.\n\nVerzamelen levert automatisch zijn beste werk op: elke oogst die zeldzaam of beter is, komt ondertekend aan, en zeldzame vondsten tekenen hun hele vijfvoudige meevaller. De geluksrol van een lijkenoogst markeert de opbrengst waar de familie geen exemplaar heeft om te geven, en waar dat wel het geval is, wordt de opbrengst duidelijk gehouden en wordt het ondertekende ongerepte exemplaar ernaast geslagen. Borden maken langs dezelfde lijn: elk exemplaar van een zeldzame of betere productie wordt gesigneerd, en een meesterwerk signeert altijd, ongeacht de kwaliteit ervan, dus de beste versie van welk stuk dan ook vermeldt altijd de maker ervan. Het enige dat je een handtekening kan kosten is een volle tas: een gesigneerde eenheid heeft een eigen ruimte nodig, of een bijpassende gesigneerde stapel, om in te landen.\n\nEen stapel items deelt één identiteit, dus twee kopieën worden alleen samengevoegd als elk merkteken exact overeenkomt: hetzelfde item, dezelfde ondertekenaar, dezelfde meesterwerkstatistieken, dezelfde betovering, dezelfde band. Een ondertekende boomstam voegt zich nooit in welke richting dan ook bij een gewone stapel (samenvoegen zou iemands naam wissen), maar identieke ladingen worden gelukkig samengevoegd, dus twintig erts ondertekend door dezelfde verzamelaar zitten in één stapel en een meevaller versnippert je koffers niet.\n\nHandtekeningen betalen ambachtslieden terug: als je een ondertekend exemplaar van een benodigd reagens op de bank houdt, ongeacht wie het heeft ondertekend, wordt de kans op een meesterwerk met 2 procentpunten vergroot, en als je een door je eigen hand ondertekend reagens vasthoudt, wordt de vereiste hoeveelheid van dat reagens met één verlaagd (nooit minder dan één). Je eigen ondertekende, zeldzame of betere werk blijft je zelfs vandaag nog via de fles leren: drink een drankje dat je hebt gesigneerd en een klein straaltje vaardigheid vloeit terug naar het ambacht dat het heeft gebrouwen, zolang dat ambacht een van je actieve hoofdvakken is.",
        ...
        "throttleBody": "De output heeft een plafond: knutselen, ontgoochelen, betoveren, redden en opladen met gereedschapseffecten delen één budget van {actions} succesvolle acties in elk venster van {seconds} seconde. Een afgewezen poging kost niets en besteedt geen budget. Je zult het nooit voelen tijdens normaal spelen; het bestaat zodat een maximale specialist met een volle bank de markt niet kan overspoelen, ongeacht hun vaardigheden of voorraad.",
      ...
      "faq": {
        ...
        "a4": "Je hebt een meevaller getroffen. Ongeveer 1 op de 90 oogsten veroorzaakt een zeldzame verzamelgebeurtenis (oud kernhout aan een boom, een ongerepte ader aan erts, een maanverlichte bloei aan kruiden): het vermenigvuldigt de opbrengst vijf keer, ondertekent elke eenheid met jouw naam en kondigt de vondst aan de hele zone aan. Een zeldzame of betere zeldzaamheidsrol op een gewone oogst tekent ook de opbrengst.\n\nGesigneerd materiaal is het waard om te bewaren of duur te verkopen: het vasthouden van een ondertekend exemplaar van een benodigd reagens op de bank voegt 2 procentpunten toe aan de kans op een meesterwerk. Houd er rekening mee dat ze alleen identiek gesigneerde exemplaren stapelen, zodat ze hun eigen tassenslot behouden.",
        ...
        "a6": "De negen algemene veldrecepten en de zes vervaardigde recepten voor landwerktuigen zijn vanaf het begin bij iedereen bekend, evenals de drie stationgebonden dekstenen (de Kilnscale Mantle, de Wardweave Cowl en de Duskhide Wraps), die geen trainer nodig hebben, alleen hun station. Al het andere wordt onderwezen door de plaatselijke meesters op hun stations verspreid over de drie hubsteden: de meeste staan ​​in Eastbrook, de leerlooier heeft de leerlooierij in Fenbridge en de alchemist heeft de apotheek in Highwatch.\n\nTrainerrecepten worden uitgevoerd in sporten: vaardigheid 0, 25 en 50 voor de uitrusting en verbruiksartikelen, gratis geprijsd, 25 zilver en 1 goud als eenmalige kosten; De twee charmerecepten van Enchanting staan ​​op sport 25, en de gereedschapmaker leert de twee vervaardigde hengels op 75 en 125 voor 4 en 16 goud. Een meester leert je een recept zodra jouw groep in dat vaartuig de eigen groep van het recept heeft bereikt, en je moet op hun station staan ​​om het te leren: een mobiel station telt niet mee.",
        "q7": "Waarom ging mijn verzamelen ineens langzamer?",
        "a7": "De verzamelcast begint op 2,5 seconden en wordt op twee manieren ingekort: 0,4 seconden voor elk gereedschapsniveau dat je bij je hebt en boven het eigen niveau van het knooppunt kunt hanteren, en 0,15 seconden zodra de teller van je transactie de 100-band overschrijdt, met een vloer van 1,5 seconden. Ga van knooppunten van niveau 1 naar knooppunten van niveau 3 en uw overschot verdwijnt, zodat dezelfde keuze weer langzamer zwaait. Als u precies het vereiste niveau bezit, koopt u geen snelheid; het opent alleen het knooppunt.\n\nVaardigheidswinst vervaagt op dezelfde manier als crafting: een knooppunt wordt grijs naarmate je vaardigheid voorbij zijn niveau klimt (niveau 1-knooppunten leren niets vanaf vaardigheid 75), dus het antwoord op langzame winst is knooppunten van een hoger niveau. Die hebben gereedschap nodig van ten minste hun niveau in je koffers (geen enkel knooppunt wordt ooit met blote handen bewerkt, niveau 1 inbegrepen), en een landgereedschap boven niveau 1 wil ook eerst zijn hanteermarkering, 40/70/85/100 in zijn eigen handel voor niveaus 2 tot en met 5. Vissen volgt zijn eigen afbouw: volledige winst onder de 50, de helft onder de 100, een straaltje van 0,1 onder de 150 en 0,02 onder de 200, de vangsten van rommel leren helemaal niets vanaf 100, en het water zelf sluit de les af (niveau 1-wateren stoppen met lesgeven op 100, het moeras op 150), dus een vastgelopen teller kan ook betekenen dat je het water bent ontgroeid.",
        "q8": "Kan ik buiten de stad ambachten maken?",
        "a8": "Gedeeltelijk. De negen algemene veldrecepten (het startwapen, het pantser, het voedsel en de drankjes) kunnen overal en altijd worden gemaakt, en dat geldt ook voor de drie combinatierecepten van de beëdigde paren. Al het andere daarboven is gebonden aan een stationstype: smederij, keukens, apotheek, leerlooierij, weefgetouw of gereedschapswerkplaats, en je moet zich binnen 20 meter van het station bevinden voordat het vaartuig er doorheen kan.\n\nBij 75 vaardigheid in een ambacht specialiseer je je, en samen met een materiaalkorting van 20 procent krijg je een mobiel station: plaats het in het veld en het blijft 10 minuten staan, waarbij de recepten van dat ambacht worden geserveerd alsof je bij het echte werk bent. Het mobiele station is alleen bedoeld om te knutselen: voor het leren van recepten en vrijblijvende commissies is altijd het echte station in de stad nodig."
      }
    },
    "economy": {
  ...
  "questUi": {
    "tracker": {
      ...
      "unknownQuest": "Onbekende zoektocht ({id})"
    },
    "log": {
      "title": "Questlogboek",
    ...
    "dialog": {
      ...
      "repeatableQuestAria": "Herhaalbare zoektocht: {name}",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Onbekend artikel {id}, aantal {count}",
      "unknownItemAriaMasterwork": "Onbekend item {id}, aantal {count}, meesterwerk",
      "unknownItemAriaEnchanted": "Onbekend item {id}, aantal {count}, betoverde kopie",
      "unknownItemAriaBound": "Onbekend item {id}, aantal {count}, ingebonden exemplaar",
      "unknownItemAriaInstanced": "Onbekend item {id}, aantal {count}, door de maker gemarkeerd exemplaar"
    },
    "equipment": {
      "empty": "Leeg",
      "levelClass": "Niveau {level} {className}"
    ...
    "vendor": {
      ...
      "qtyRowAria": "Aankoophoeveelheid",
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Koop {count} per keer",
      "qtyCustom": "Aangepast",
      "qtyCustomAria": "Kies een aangepast bedrag om te kopen",
      "buyCountAria": "Koop {count} van {item} voor {price}",
      "buyCountAriaWithRequirement": "Koop {count} van {item} voor {price}. {requirement}",
      "buyQuantityTitle": "Hoeveel {item} kopen? Tot {max}.",
      "buyQuantityInput": "Hoeveelheid om te kopen",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_thorium_ore": {
        "name": "Fijn osmiumerts"
      },
      "fine_ironbark_log": {
        "name": "Fijne ijzerschorsstam"
      },
      "fine_ashwood_log": {
        "name": "Fijn essenhoutblok"
      },
      "fine_elderwood_log": {
        "name": "Fijne Highpine-stam"
      },
      "fine_silverleaf_herb": {
        "name": "Fijn Sheenbladkruid"
      },
      "fine_goldleaf_herb": {
        "name": "Fijn bladgoudkruid"
      },
      "fine_sunpetal_herb": {
        "name": "Fijn zonnebloemkruid"
      },
      "stormreel_fishing_rod": {
        "name": "Stormreel hengel"
      },
      "tidewrought_fishing_rod": {
        "name": "Getijdenwrochte hengel"
      },
      "duskwisp_essence": {
      ...
      "gatherers_cache": {
        "name": "Verzamelaarscache"
      },
      "artisans_eye": {
        "name": "Ambachtelijk oog"
      },
    ...
    "quests": {
      ...
      "q_the_codfather": {
        "title": "De Codfather",
        "text": "De Codfather is niet zomaar een vis, {playerName}, hij is een koelbloedige moordenaar. Oldtimers zweren dat hij Mire Prowlers als ontbijt eet, en zelfs de Mirefen-weduwen zullen uit pure angst hun web niet spinnen in de buurt van de Deepfen Shallows. Hij regeert die wateren, en moeraswater neemt niet minder een ijzeren hengel mee; mijn toonbank verkoopt ze. Neem er een in de hand, sleep die oude duivel uit zijn water, en ik zal toegeven dat je je bij de familie hebt aangesloten.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Ik heb deze sporen eerder gezien, op drie oude graven rond het noordelijke slagveld. Kapitein Aldren ligt aan de westelijke helling, hogepriester Malric verder naar het zuiden langs de westelijke rand, en Royal Assassin Voss bij de oostelijke klif. Raak elk graf aan en luister, {playerName}. De doden kunnen zich herinneren wat de levenden vergeten zijn.",
      ...
      "q_nythraxis_sealed_crypt": {
        ...
        "text": "De visioenen wijzen naar de verlaten crypte in de oostelijke klif. Er bestaat een oude legende dat de crypte een koning herbergde. Misschien verzegelde Doorntop hem eronder nadat Malrics ritueel hem in iets dodeloos veranderde. Betreed de crypte en zie wat er binnen overblijft.",
      ...
      "q_mogger": {
        ...
        "text": "Mogger heeft karren gespleten, hekken platgewalst en genoeg vee gedood om het halve Dal leeg te maken. Sta hem niet alleen tegenover. Neem twee sterke metgezellen mee de westelijke weide in en leg het beest voorgoed neer.",
