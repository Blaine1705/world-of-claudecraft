...
export const nl_NL: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsNote": "Elk grondstoffenpunt vraagt het gereedschap van zijn ambacht in je tassen, rang 1 inbegrepen: zonder mijnhouweel geen erts, zonder hengel geen vis. De verkoopladder dekt de rangen 1 tot 3, en elke zonehub houdt alleen de rangen op voorraad die zijn eigen terrein gebruikt: het gereedschap van rang 1 is in elke zonehub te koop, terwijl de sporten daarboven worden verkocht waar de aders liggen die ze vragen. Voor die sporten vragen handelaren ook vaardigheid in het ambacht van het gereedschap, {tier2Prof} voor rang 2 en {tier3Prof} voor rang 3, en de regel noemt de eis. Een gereedschapsstuk hoeft alleen in je tassen te zitten, er is geen uitrustslot en geen duurzaamheid, dus elk is een eenmalige aankoop, en wat je al bezit blijft werken. Alleen de rang telt voor de toegangspoort: de zeldzaamheidskleur van gereedschap is puur cosmetisch.\n\nBoven de verkoopladder staan twee gemaakte gereedschappen, rang 4 en rang 5, gemaakt in de gereedschapsmakerij door knutselaars en nooit verkocht door een NPC. Geen enkel grondstoffenpunt heeft nu meer dan rang 3 nodig, dus hun huidige waarde zit in snelheid: een topgereedschap pinnt de cast op zijn vloer op lagere grondstoffenpunten, en het zal het toegangsticket zijn wanneer hoger terrein arriveert.",
