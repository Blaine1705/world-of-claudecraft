...
export const cs_CZ: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Upravit klávesy na panelu akcí",
      "editKeysHint": "Klikněte na slot na panelu akcí a poté jej svažte stisknutím klávesy.",
      "bannerHint": "Klikněte na slot a poté jej svažte stisknutím klávesy. Po dokončení klepněte na Hotovo.",
      "bannerCapturing": "Stisknutím klávesy svážete tento slot...",
      "boundToKey": "Vázáno na {key}.",
      "reset": "Resetovat",
      "done": "Hotovo",
      "cancel": "Zrušit",
      "resetConfirmTitle": "Resetovat klávesy na panelu akcí?",
      "resetConfirmBody": "První pruh se vrátí na výchozí klávesy. Druhý a třetí pruh se stanou nevázané. Toto nelze vrátit zpět."
    },
    "mounts": {
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "V závorkách 1v1 a 2v2 hraje každý bojovník sadu All-Rounder. Skutky, které vyžadují 3v3 nebo větší, zde nelze získat.",
      "role": {
        "allrounder": {
          "name": "Univerzál",
      ...
      "practiceUnratedNote": "Tréninkové zápasy jsou neohodnoceny: pořadí a postup v Book of Deeds se nepočítají.",
      ...
      "briefing": {
        ...
        "unratedNote": "Na hřišti jsou boti, takže tento zápas nemá hodnocení: pořadí se nehýbe a skutky za góly, zákroky a čisté konto se nepočítají.",
        "practiceUnratedNote": "Jedná se o cvičný zápas, takže není hodnocen: pořadí se nehýbe a postup v Book of Deeds se nepočítá.",
    ...
    "materialHint": {
      "fineGrade": "Dobrá známka. Shromážděné z plné žíly s nástrojem nadřazeným materiálem a počítá se jako běžná verze všude tam, kde je potřeba.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "K rybaření v těchto vodách potřebujete rybářský prut úrovně {tier}."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Potřebujete Mining {skill}, abyste mohli mít trsátko ve svých taškách.",
        "logging": "K tomu, abyste máchli sekerou, kterou už máte v taškách, potřebujete protokolování {skill}.",
        "herbalism": "Potřebujete Herbalism {skill}, abyste mohli pracovat se srpem, který už máte ve svých taškách."
      },
      "wieldUnmetCorpse": "Abyste mohli používat svůj nejlepší nástroj, potřebujete získat dovednosti {skill}.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Vyžaduje se pro lov ve vodách do úrovně {tier}."
        },
        "use": {
      ...
      "emptyHookNote": "Nic na háku",
      "stateReady": "Připraveno",
      "stateCooldown": "Dobíjení",
      "stateCooldownTimed": "Znovu se objeví v {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Váš nástroj zjemní tento výnos na jemnou třídu."
    },
    "archetypeTitle": {
      "label": "Titul",
      "none": "Žádný",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} z {max} poplatků",
      "toolEffectSpent": "Vybitý, potřebuje dobít",
      "toolEffectDepleted": "Spotřebovaný efekt nástroje",
      "toolEffectRechargePrice": "Dobití: {count} x {material}",
      "toolEffectModeAsk": "Zeptejte se každého použití",
      "toolEffectModePrompt": "Ptá se každého použití",
      "toolEffectConfirmTitle": "Použít {effect}?",
      "toolEffectConfirmBody": "Utratit poplatek za tuto sklizeň? Klesající se stále shromažďují, bez bonusu. Zbývající poplatky: {charges}.",
      "toolEffectConfirmAccept": "Použijte poplatek",
      "toolEffectConfirmDecline": "Shromáždit bez",
      "toolEffectName": {
        "gatherersCache": "Sběratelská mezipaměť",
        "artisansEye": "Oko řemeslníka",
        "quickeningCharm": "Springback kouzlo"
      },
      "toolEffectSlotButton": "Slot {effect}",
      "toolEffectRechargeButton": "Dobít",
      "toolEffectSlotted": "{effect} umístěno na {profession}.",
      "toolEffectSlotInvalid": "{effect} tam nelze umístit.",
      "toolEffectNoTool": "Nejprve potřebujete skutečný nástroj {profession}.",
      "toolEffectNoCharm": "Ve svých taškách potřebujete vytvořené kouzlo {effect}.",
      "toolEffectNoGain": "{effect} je již zasunuto a plně nabito.",
      "toolEffectRecharged": "{effect} dobito: {material} x{count} spotřebováno.",
      "toolEffectRechargeNoSlot": "Na {profession} není umístěn žádný efekt.",
      "toolEffectRechargeFull": "{effect} je již plně nabitá.",
      "toolEffectRechargeToolCapped": "Noste lepší nástroj {profession} k dalšímu nabíjení {effect}.",
      "toolEffectRechargeMaterials": "Nabíjení {effect} vyžaduje {material} x{count}.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(útrata {count} v dobré kvalitě)",
      ...
      "identity": {
        ...
        "skillListAria": "Řemeslné dovednosti",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Sdílejte odemknutí listin s cechovními kolegy a následovníky a karty listin a mistrovských děl pomocí kanálu Discord",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolCraftedOrMarks": "Vytvořeno ({craft}) nebo {marks} Delve Marks po třech utopených litaniích",
      "toolCraftedOrMarksHeroic": "Vytvořeno ({craft}) nebo {marks} Ponořte se do znamení po vymazání Heroic Drowned Litanie",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Neprodáváno",
      "priceNone": "Neprodává se za mince",
      "toolTierReq": "Nástroj {tier}. úrovně",
      "colWield": "Použijte při",
      "wieldNone": "Žádný",
      ...
      "econ": {
        ...
        "trainingNote": "Jeden paušální poplatek za příčku receptu, účtovaný jednou, když to mistr učí; každá příčka níže uvedené tabulky se dnes živě používá, od bezplatných startovacích receptů až po lekce pro nástrojáře nahoře.",
  ...
  "questUi": {
    ...
    "log": {
      ...
      "repeatableStatus": "Opakovatelné",
      "cooldownStatus": "Brzy opět k dispozici",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Neznámá položka {id}, množství {count}",
      "unknownItemAriaMasterwork": "Neznámá položka {id}, množství {count}, mistrovské dílo",
      "unknownItemAriaEnchanted": "Neznámá položka {id}, množství {count}, okouzlená kopie",
      "unknownItemAriaBound": "Neznámá položka {id}, množství {count}, vázaná kopie",
      "unknownItemAriaInstanced": "Neznámá položka {id}, množství {count}, kopie označená výrobcem"
    },
    "equipment": {
      "empty": "Prázdné",
      "levelClass": "Úroveň {level} {className}"
    ...
    "vendor": {
      ...
      "qtyRowAria": "Nákupní množství",
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Nakupujte {count} najednou",
      "qtyCustom": "Zvyk",
      "qtyCustomAria": "Vyberte si vlastní částku k nákupu",
      "buyCountAria": "Koupit {count} z {item} za {price}",
      "buyCountAriaWithRequirement": "Kupte {count} z {item} za {price}. {requirement}",
      "buyQuantityTitle": "Kolik {item} koupit? Až {max}.",
      "buyQuantityInput": "Množství k nákupu",
      "buyQuantityConfirm": "Nakoupit",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_thorium_ore": {
        "name": "Jemná Osmium Ruda"
      },
      "fine_ironbark_log": {
        "name": "Jemný protokol Ironbark"
      },
      "fine_ashwood_log": {
        "name": "Jemný Ashwood Log"
      },
      "fine_elderwood_log": {
        "name": "Jemný Highpine Log"
      },
      "fine_silverleaf_herb": {
        "name": "Jemná listová bylina"
      },
      "fine_goldleaf_herb": {
        "name": "Jemná zlatolistá bylina"
      },
      "fine_sunpetal_herb": {
        "name": "Jemná slunečnicová bylina"
      },
      "stormreel_fishing_rod": {
        "name": "Rybářský prut Stormreel"
      },
      "tidewrought_fishing_rod": {
        "name": "Tidewrought rybářský prut"
      },
      "duskwisp_essence": {
    ...
    "quests": {
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Tyto značky jsem viděl již dříve, na třech starých hrobech kolem severního bojiště. Kapitán Aldren leží na západním svahu, velekněz Malric dále na jih podél západního okraje a Royal Assassin Voss u východního útesu. Dotkněte se každého hrobu a poslouchejte, {playerName}. Mrtví si mohou pamatovat to, co živí zapomněli.",
