...
export const cs_CZ: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsNote": "Každé naleziště vyžaduje nástroj svého řemesla v brašnách, včetně 1. úrovně: bez krumpáče není ruda a bez prutu nejsou ryby. Prodejní žebříček pokrývá úrovně 1 až 3 a každé centrum drží jen ty úrovně, které využívá jeho vlastní terén: nástroj 1. úrovně se prodává v centru každé zóny, zatímco vyšší příčky se prodávají tam, kde leží ložiska, která je vyžadují. U těchto příček obchodníci navíc žádají zručnost v řemesle daného nástroje, {tier2Prof} pro 2. úroveň a {tier3Prof} pro 3. úroveň, a řádek požadavek uvádí. Nástroj stačí mít v brašně, žádný slot na vybavení ani trvanlivost neexistuje, takže každý je jednorázovým nákupem a co už vlastníš, funguje dál. Důležitá je jen úroveň: vzácnostní barva nástroje je kosmetická.\n\nNad prodejním žebříčkem stojí dva vyráběné nástroje, 4. a 5. úrovně, vyrobené v dílně inženýry a žádným NPC neprodávané. Žádné dnešní naleziště nepotřebuje víc než 3. úroveň, takže jejich hodnota nyní spočívá v rychlosti: špičkový nástroj udrží sesílání na spodním limitu u nižších nalezišť a bude vstupenkou, až přijde terén vyšší úrovně.",
