...
export const sv_SE: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsNote": "Varje nod kräver sitt yrkes verktyg i dina väskor, nivå 1 inräknat: ingen hacka, ingen malm, och inget spö, ingen fisk. Handlarens stege täcker nivå 1 till 3, och varje huvudort för bara de nivåer som dess egen mark använder: verktyget på nivå 1 säljs i varje huvudort, medan stegpinnarna ovanför säljs där de ådror finns som kräver dem. För de stegpinnarna kräver handlare dessutom skicklighet i verktygets eget yrke, {tier2Prof} för nivå 2 och {tier3Prof} för nivå 3, och raden anger kravet. Ett verktyg behöver bara vara i dina väskor, det finns ingen utrustningsplats och ingen hållbarhet, så vart och ett är ett engångsköp, och det du redan äger fortsätter att fungera. Bara nivån spelar roll för spärren: ett verktygs sällsynthetsfärg är kosmetisk.\n\nÖver handlarstegen sitter två tillverkade verktyg, nivå 4 och nivå 5, tillverkade vid verkstaden av ingenjörer och aldrig sålda av någon NPC. Ingen nod idag kräver mer än nivå 3, så deras värde just nu är hastighet: ett toppverktyg låser kastet vid sitt golv på lägre noder, och det blir entrébiljetten när mark av högre nivå anländer.",
