...
export const sv_SE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Redigera åtgärdsfältstangenter",
      "editKeysHint": "Klicka på en plats i åtgärdsfältet och tryck sedan på en tangent för att binda den.",
      "bannerHint": "Klicka på en plats och tryck sedan på en tangent för att binda den. Klicka på Klar när du är klar.",
      "bannerCapturing": "Tryck på en tangent för att binda denna plats...",
      "boundToKey": "Bundet till {key}.",
      "reset": "Återställa",
      "done": "Gjort",
      "cancel": "Avboka",
      "resetConfirmTitle": "Återställa åtgärdsfältstangenterna?",
      "resetConfirmBody": "Den första stapeln återgår till sina standardnycklar. Den andra och tredje takten blir obundna. Detta kan inte ångras."
    },
    "mounts": {
      "title": "Riddjur",
      "close": "Stäng",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "I 1v1 och 2v2 parentes spelar varje fighter All-Rounder kit. Handlingar som kräver 3v3-fästet eller större kan inte tjänas in här.",
      "role": {
        "allrounder": {
      ...
      "practiceUnratedNote": "Träningsmatcher är inte betygsatta: ställning och framsteg i gärningsboken räknas inte.",
      ...
      "briefing": {
        ...
        "unratedNote": "Botar finns på planen, så den här matchen är inte betygsatt: ställningen rör sig inte, och mål, räddningar och nollan räknas inte.",
        "practiceUnratedNote": "Det här är en träningsmatch, så den är inte betygsatt: ställningen rör sig inte och framstegen i Gärningsboken räknas inte.",
    ...
    "materialHint": {
      "fineGrade": "Bra betyg. Samlad från en full-tier ven med ett verktyg rankat ovanför materialet, och räknas som den vanliga versionen där det behövs.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Du behöver ett fiskespö i nivå {tier} för att fiska i dessa vatten."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Du behöver Mining {skill} för att svänga valet redan i dina väskor.",
        "logging": "Du behöver Logga {skill} för att svänga yxan redan i dina väskor.",
        "herbalism": "Du behöver Herbalism {skill} för att arbeta skäran redan i dina väskor."
      },
      "wieldUnmetCorpse": "Du behöver samla färdigheter {skill} för att få ditt bästa verktyg att fungera.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Krävs för att fiska vatten upp till nivå {tier}."
        },
        "use": {
      ...
      "stateCooldownTimed": "Återuppstår i {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Ditt verktyg förfinar detta utbyte till finkvalitet."
    },
    "archetypeTitle": {
      "label": "Titel",
      "none": "Ingen",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} av {max} avgifter",
      "toolEffectSpent": "Förbrukad, behöver laddas",
      "toolEffectDepleted": "Verktygseffekt förbrukad",
      "toolEffectRechargePrice": "Ladda: {count} x {material}",
      "toolEffectModeAsk": "Fråga varje användning",
      "toolEffectModePrompt": "Frågar varje användning",
      "toolEffectConfirmTitle": "Använd {effect}?",
      "toolEffectConfirmBody": "Spendera en avgift på denna skörd? Att avslå samlas fortfarande, utan bonus. Avgifter kvar: {charges}.",
      "toolEffectConfirmAccept": "Använd en laddning",
      "toolEffectConfirmDecline": "Samla utan",
      "toolEffectName": {
        "gatherersCache": "Samlarens cache",
        "artisansEye": "Hantverkarens öga",
        "quickeningCharm": "Springback Charm"
      },
      "toolEffectSlotButton": "Fack {effect}",
      "toolEffectRechargeButton": "Ladda om",
      "toolEffectSlotted": "{effect} placerad på {profession}.",
      "toolEffectSlotInvalid": "{effect} kan inte placeras där.",
      "toolEffectNoTool": "Du behöver ett riktigt {profession} verktyg först.",
      "toolEffectNoCharm": "Du behöver en tillverkad {effect} berlock i dina väskor.",
      "toolEffectNoGain": "{effect} är redan slitsad och fulladdad.",
      "toolEffectRecharged": "{effect} laddad: {material} x{count} förbrukad.",
      "toolEffectRechargeNoSlot": "Ingen effekt är placerad på {profession}.",
      "toolEffectRechargeFull": "{effect} är redan fulladdad.",
      "toolEffectRechargeToolCapped": "Bär ett bättre {profession}-verktyg för att ladda {effect} ytterligare.",
      "toolEffectRechargeMaterials": "Att ladda {effect} kräver {material} x{count}.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(spenderar {count} fint betyg)",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Dela upplåsningar av gärningar med guildmates och följare, och kort för handling och mästerverk med Discord-flödet",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "En förklaring är inte heller ett livstidsstraff. Ett par som du aldrig har hållit är helt enkelt ett nytt inställningsuppdrag, medan att återvända till ett par du gick ifrån ber dig att göra rätt först: fem uppgifter första gången och ytterligare tre läggs till för varje retur du redan har gjort (att ta upp ett helt nytt par höjer aldrig siffran). Valet förblir meningsfullt utan att någonsin låsa en dörr för gott.",
      "whatHeading": "En handel vid sidan om svärdet",
      "whatBody": "Yrken är världens arbetsliv: fyra samlande yrken som drar råvaran rakt ur landet, och en ring med tio hantverk som gör det till redskap, måltider, drycker och verktyg. Allt föder något annat här. Malmen du bryter blir ett blad, bladet tar en trollkarl och trollkarlen behöver damm som bryts ur gamla redskap, så en samlare, en hantverkare och en pysslare är alla länkar i en kedja.\n\nDet finns ingen yrkesgräns att våndas över. Varje karaktär kan höja sju av de åtta hantverken som har innehåll idag och alla fyra samlande yrken sida vid sida (ingenjörskonst är det enda som håller fast: dess recept börjar alla ovanför det fria taket, så dess stege väntar på Bombardiers ed); det enda exklusiva valet är din arketyp, identiteten du så småningom svär till, men när du väl anpassar de hantverk som slumrar bakom det klättrar bara på deras vanliga recept, och tidigare färdigheter 75 inte alls. Skickligheten går aldrig ner, och ingenting du lär dig tas aldrig bort.",
      ...
      "archetypesBody": "De tio hantverken sitter på ett fast hjul, och geografin på det hjulet spelar roll. Varannan granne bildar ett namngivet par: Smith för vapenhantverk och pansarslöjd, Outfitter för läderbearbetning och skräddarsydd, apotekare för alkemi och matlagning, Bombardier för teknik och alkemi, och sex till runt ringen.\n\nAtt anpassa sig till ett par är ett uppdrag, inte ett menyklick. Fyra par kan förenas idag (Smith, Outfitter, Apothecary och Bombardier), vart och ett förankrat av en bosatt mästare i Eastbrook vars acceptansuppdrag anger hela köpet innan du tar det. Tills du förklarar, går varje hantverk fritt på recept upp genom den sällsynta nivån (vilket som helst recept kräver färdighet 74 eller mindre), så du kan prova nästan allt innan du väljer (Ensam teknik har inget recept så lågt, så antalet väntar).\n\nNär du väl har ställt in dig blir dina två par hantverk dina majors, utan något tak kort än kepsen. Resten av hjulet blir inte mörkt: ett farkost mittemot dina majors fortsätter som en hobby som fortsätter att klättra genom den sällsynta nivån (ett upprepat uppdrag i Smith Haldrens smedja låter dig byta vilket), och varannan farkost går i dvala. Ett slumrande hantverk behåller sin skicklighet och sina vanliga recept, som fortsätter att lära det på den normala kurvan tills de grånar vid 75; allt ovanför det vanliga slutar betala på en gång, och ett slumrande hantverk blir aldrig ett mästerverk medan det vilar.",
      "pairFmt": "{a} och {b}",
      ...
      "startBody": "Fräsch av vägen i Eastbrook? Hitta Foreman Odell och ta A Trade for Every Hand: han kommer att peka dig mot malmen runt Copper Dig sydost om staden och ge dig dina första förhårdnader. Tänk på själva grävningen: Deeprock Diggers som slog läger på den står några nivåer ovanför en ny ankomst, så arbeta med de yttre ådrorna först och spara lägrets hjärta till när du har planat lite. Från och med då, skörda varje ådra, timmerbestånd och örtlapp du passerar medan du letar; kompetens kommer naturligt för resenärer.\n\nTillbaka i stan, tryck på T för att öppna pysselfönstret och arbeta med de vanliga recepten som alla karaktärer känner till från början. Besök mästarna i smedjan, köken, vävstolen och verktygsverken för att se vad de lär ut och ta deras arbetsorder för stadiga mynt. När Guilds brev hittar dig kommer du redan att veta vilket par som känns som hemma.",
      "colStation": "Station",
      "colHub": "Ort",
      "colMaster": "Mästare",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Ingenjörskonst bygger verktygen som varje seriös samlare till slut vill ha: tier 4 och tier 5 hackor, yxor, skäror och fiskespön som ingen disk någonsin kommer att sälja för mynt, var och en förbrukar verktyget under det.",
        "enchanting": "Förtrollande tar isär utrustningen och sätter in kraften igen: bryt oönskade bitar i mystiska material och spendera dem sedan på en permanent stat-bonus för en bit du vill behålla. Brytande och förtrollande behöver ingen station och ingen tränare, och vem som helst kan börja på dag ett; bara de två charmrecepten frågar mer, lärt ut på verktygsverket."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "Gruvdrift är ryggraden. Kopparmalm kommer från tier 1-årerna i Eastbrook Vale, järnmalm från Mirefen Marsh och osmiummalm från Thornpeak Heights, och varje steg på stegen går upp på samma sätt. Avverkning är viktigare än du kanske förväntar dig: järnbark bär galtspjutet, askträd axlar maulen, och en enda högträstock utgör stridsstaven.\n\nResten kommer från jakten och disken. Grovt grepp skördas rakt av varg- och vildsvinskroppar, benfragment lossnar från de rastlösa döda eller ur räddade gemensamma redskap, och smidesstegen bränner Smithing Flux, 20 koppar en burk från Darva själv. Om din egen gruvdrift släpar efter, kommer ingen räknare att rädda dig på själva malmen: osmium kommer från Thornpeak-venerna, från startvenerna i alla yngre zoner utom Farshore (vars ådror gräver järn), eller ur en annan spelares stack, genom handel eller världsmarknaden. Endast Glyphsteel Bar köps för mynt, från Tinker Gizzel på verktygsverket eller Quartermaster Bree i Highwatch.",
          ...
          "routeBody": "Alla pjäser med en riktig statisk linje, vilket på denna stege betyder järnpinnen och uppåt, kan lossna från städet som ett mästerverk så länge som den finare kvaliteten passar in i ditt nivåtak; de statlösa kopparallmänningarna proc aldrig, eftersom det inte finns något i dem att förbättra. Järn och osmium räknas som tier 1-material för mästerverksbonusen, highpine och glyphsteel som tier 2, och skickligheten att sitta över ett recepts egen tier lägger till sin egen poäng per tier, så bland osmium tre är det krigsyxan och stridsstaven som bär den materiella kanten, och en stegpinne fortsätter att gå bättre efter att du har vuxit ur den.\n\nKör kopparplåten till 25, träna järnpinnen dagen den öppnar och kör den till 50, sedan osmiumtrappan till 75. Senaste 75 har inget högre skepp än, så osmiumrecepten bleknar till hälften och sedan en kvartsvinst: budgetera med ungefär 150 hantverk till för att nå 125 farkoster per minut, och kom ihåg att åtgärden går ner i tio minuter. parti.\n\nFinansiera klättringen när du går: Darvas smidesarbetsorder tar åtta kopparmalm från dina händer var 30:e minut för ett litet mynt och XP, och järn- och osmiumstegarna säljer ärligt till utjämning av närstrid. The Book of Deeds markerar Edge and Temper vid färdighet 50 och kröner Grandmaster Weaponcrafting vid 125."
        },
        "armorcrafting": {
          "identityHeading": "Ringbrynja för frontlinjen",
          "identityBody": "Armorcraftings stege läser som en soldats karriär: den enkla nitade koppargördeln, sabatongerna och handskarna att starta, järnlänks-hauberken, benskydden och spadlarna med sina första riktiga statistiska linjer, och den sällsynta osmiumskala greathelmen, cuirass och leggings, styrka och uthållighet i armarnas främsta siffror.\n\nDen har också en tystare sida: Eastbrook Warded Leggings, en vanlig rullstol, och Kilnscale Mantle, en sällsynt Intellect and Spirit postskuldra vid skicklighet 75, håller de trollsinnade postbärarna på kundlistan. På ringen sitter den mellan Weaponcrafting och Engineering; Smith-paret med Weaponcrafting svurs före Forgemistress Darva, medan Gearwright-paret med Engineering är namngivna men har ingen eduppdrag ännu.",
          "materialsHeading": "Malm i säcktals",
          "materialsBody": "Inget hantverk äter malm snabbare. Enbart ironlink-hauberken tar fem järnmalm, och varje bit i osmiumskala vill ha tre eller fyra osmium plus en glyphsteel-stång, så en seriös pansarhantverkare bryter Mirefen Marsh och Thornpeak Heights eller betalar någon som gör det. Koppar matar det första steget, direkt från venerna av koppargrävan.\n\nRunt metallen går de mjuka delarna: grov hud som skördats av varg- och vildsvinskroppar, benfragment från rastlösa döda (eller bärgade ur vanliga redskap) och Smithing Flux-burkar (20 koppar vardera i smedjan) i nästan varje recept. Ingen disk säljer osmium: de otåliga köper det av andra spelare eller bryter det själva, på Thornpeak eller startådrorna i tio av de elva yngre zonerna (enbart Farshore gräver järn).",
          "ladderHeading": "Att lära sig vid Darvas smedja",
          "ladderBody": "Två fältallmänningar, Eastbrook Chainmail Vest och Warded Leggings, är kända från början och hantverkar var som helst. Tränarstegen är nio recept i tre steg på Eastbrook-smedjan: kopparsteget är gratis vid färdighet 0, ironlink-steget kostar 25 silver, ett recept vid färdighet 25, och stegpinnen i osmiumskala kostar 1 guld vardera vid färdighet 50, och varje steg kan läras ut i det ögonblick din nivå når den.\n\nBortom stegen sitter två specialare. The Boundstone Helm är ett av de två Smith kombinationsrecepten (Gravewyrm Gauntlets är dess syskon på vapenhantverkssidan), tränarlärd, stationsfri och användbar endast av en anpassad Smith med båda hantverken på färdighet 25. Kilnscale Mantle behöver ingen lärare alls: alla känner till den från början, och inget annat än smedjan som fungerar den och. Dess listade färdighet på 75 handlar om vinst, inte om tillåtelse: med Armorcrafting som major betalar den full färdighetsvinst från det allra första hammarslaget till 99, så en Smith med osmium till övers kan luta sig mot det tidigt. Under en majors tak lär nivå 3-receptet ingenting, så en odeklarerad eller hobbypansarhantverkare gör det för stycket, inte poängen.",
          "routeHeading": "Mästerverk, och en fungerande väg till 125",
        ...
        "leatherworking": {
          ...
          "materialsBody": "Läderbearbetning är hantverket där din utjämningsväg och din tillförsellinje är samma sak: grov hud skördas rakt av hudbärande lik, vargar och galtar framför allt, och varje lik serverar endast en skördare, först till kvarn gäller. En sällsynt eller bättre skörderulle ger också en Pristine Hide, ett signerat exemplar som Mirewarden Jerkin efterlyser, så se till att alla du hittar.\n\nStödrollen är liten: spindelben och siden, hemspunnet tyg av humanoider, en enda osmiummalm i varje mirewarden sällsynt stycke (sex i Duskhide Wraps capstone) och ett garvmedel på 16 koppar från garveridisken. Osmium i sig är aldrig motköpt: ta ut det själv, på Thornpeak eller nästan alla yngre zoners startådror (enbart Farshore gräver järn), eller köp det av en annan spelare.",
          "ladderHeading": "Lärd i Fenbridge",
          "ladderBody": "Här är rynkan: garveriet står i Fenbridge, på Mirefen Marsh Road, vilket gör Leatherworking till det enda djupa hantverket som tränats i träsket. Tanner Hesk lär ut stegen vid sina kar: Fenbridge-huden steg fritt vid färdighet 0, marshstalkern steg på 25 silver ett recept från färdighet 25, och mirewarden steg på 1 guld vardera från färdighet 50, varje steg öppnas när din nivå når den.\n\nTre recept hoppar över tränaren: fältallmänna (den garvade läder Jerkin och Eastbrook Druid's Hide) hantverk var som helst från början, och Duskhide Wraps är kända för alla men sitter på skicklighet 75, garveribundna. Observera att Outfitter-eden själv svurs tillbaka i Eastbrook med Ottilie; endast undervisningen sker i kärret.",
          "routeHeading": "Mästerverk, och en fungerande väg till 125",
          "routeBody": "Varje pjäs med riktig statistik rullar mästerverkschansen så länge den finare kvaliteten passar in i ditt nivåtak, den staterade Eastbrook Druid's Hide inkluderad, och en signerad Pristine Hide in a Mirewarden Jerkin ger den signerade reagensbonusen automatiskt; osmium räknas som ett nivå 1-material för proc. De statlösa gömställena kan inte proc.\n\nUtjämna det på det naturliga sättet: skörda varje varg och vildsvin du dödar från nivå ett, låt de två fältallmänningarna bära dig till 25 var du än står, träna sedan gömstället vid karen när uppdragen ändå drar dig in i träsket. Marshstalker bär dig till 50 och mirewarden till 75; förbi att Duskhide Wraps, ett nivå 3-recept på sex osmiummalm, tre Pristine Hide, två grova hudar och en Tanning Agent, betalar en avstämd Outfitter full vinst till 99 och en halv efter, cirka 75 hantverk för de sista femtio poängen till 125-locket; under en majors tak lär nivå 3-receptet ingenting.\n\nDet mobila garveriet betyder mer för det här hantverket än något annat: specialisera sig på 75 och en sadelväska med skinn blir färdig utrustning vid lägerelden istället för en promenad tillbaka till Fenbridge. Hesks garveriarbetsorder köper åtta grova hudar var 30:e minut, en snygg avkastning på skinn du samlade in oavsett, och gärningsboken markerar Tanner's Trade på färdighet 50 med Grandmaster Leatherworking på locket."
        },
        "cooking": {
          "identityHeading": "Grytan som mättar sällskapet",
          "identityBody": "Ät en lagad måltid och det läker dig över 18 sekunders vila, vilket mellan dragen är den billigaste healingen i spelet. Stegen går från en 90-hälsosamma Pan-Seared River Abborre hela vägen till Marlow's Grand Roast på 980, en sit-heal som ingenting i spelet slår.\n\nPå ringen Cooking sitter mellan Alchemy och Leatherworking. Dess levande par är Apothecary, Alchemy and Cooking, svurit före Cook Marlow vid Eastbrooks kök efter att ha jagat fyra vildsvin till grytan; Trapper-paret med Leatherworking är namngivna på ringen men har ingen eduppdrag ännu.",
          "materialsHeading": "Ett skafferi fött av spö och kniv",
          "materialsBody": "Fisket har de kännetecknande ingredienserna, zon för zon: spegelöring och flodabborre från vattnet i Eastbrook Vale, kärrgädda och myrål från Mirefen Marsh, frostöring och skifferkarp från Thornpeak Heights. Stegarna blandar zonerna fritt (den fria stegen vill redan ha kärrgädda, den mellanliggande Thornpeaks frostgädda och den sällsynta kvällsmaten viker in Vales spegelöring igen), så en kock som fiskar vart vägen än går blir aldrig torr.\n\nSlaktarsidan lossnar från skördade lik: viltkött från galtar och deras anhöriga, och, på en sällsynt eller bättre skörderulle, en signerad Prime Cut, mittpunkten i den stora steken. Örter kryddar de bättre rätterna, en stock av ask röker ålen, och Cooking Salt kör 8 koppar per påse från Marlows eget stall.",
        ...
        "alchemy": {
          ...
          "identityBody": "Hantverket bearbetas på apoteket i Highwatch, hemmet för alkemisten Verane, apotekarens mästare, som lär ut receptstegen, säljer glasflaskor för 12 koppar och betalar mynt för örter genom sin arbetsorder.\n\nPå hantverksringen sitter Alchemy med trial-and-error-affärerna, bredvid Engineering på ena sidan och Cooking på den andra. Det ger den två par identiteter: Bombardier (teknik och alkemi, upptagen före Tinker Gizzel i Eastbrook) och apotekaren (alkemi och matlagning, svurit före Cook Marlow). Anpassa dig till båda paren för att göra Alchemy till en major och låt ditt eget signerade arbete lära dig tillbaka; Bombardier-paret öppnar också sin kombinationsbryggning, Elixir of the Bear, medan Apothecary-paret inte skickar något kombinationsrecept ännu. Själva stegen väntar dock aldrig, eftersom varje alkemi-recept sitter i den sällsynta nivån som odeklarerat hantverk arbetar under, så hela klättringen till mössan är öppen innan någon ed.",
          ...
          "ladderBody": "Alla känner till Minor Healing Potion från början och kan blanda den var som helst, ingen station behövs. Den riktiga stegen är nio recept som Verane lär ut på apoteket, tre vid varje steg: recepten för färdighet 0 är gratis, steg 25 kostar 25 silver per recept, och steg 50 kostar 1 guld per recept. Varje steg är ett läkande drag, ett manadrag och ett uthållighetselixir, som går från vanliga sheenleaf-flaskor (120 hälsa, 160 mana) genom ovanliga guldblad (200 hälsa, 260 mana) till sällsynta solblad (280 hälsa, 360 mana).\n\nElixiren klättrar på samma sätt: Galtens Elixir ger 6 Stamina i 10 minuter, Vipersear Elixir 9 i 15 minuter och Elixir av Ormen 12 i 15 minuter, Ormen ensam brygger två flaskor per båt. Ytterligare ett recept ligger vid sidan av: Björnens Elixir, en kombinationsbryggning Verane lär ut för 25 silver när din Alchemy når 25, kan blandas var som helst, men bara av en anpassad Bombardier med både Alchemy och Engineering vid 25.",
          "routeHeading": "En bryggares väg till 125",
          "routeBody": "Utkast och elixir rullar aldrig mästerverk; att proc tillhör stat-bärande redskap. Ditt namn reser sig dock fortfarande: de sällsynta solbladsutkasten anländer signerade med ett tillverkarmärke, och det gör varje flaska av ormens elixir med dubbelsats, så inget sällsynt i det här hantverket lämnar bänken osignerad. Vid färdighet 75 specialiserar du dig, och varje alkemi-recept kostar 20 procent färre material från och med då.\n\nTa Herbalism tidigt och plocka allt efterhand: sheenleaf finns överallt i Vale, och när du väl når Veranes bänk kommer den fria stegen att bära dig rent till färdighet 25 på örter som du ändå skulle ha plockat. Lär dig de 25 stegen i det ögonblick det slås på, flytta ditt plockning till träsket för bladguld och låt Veranes arbetsorder (sex guldbladsörter för 45 koppar, repeterbar var 30:e minut) lämna tillbaka ett litet mynt när du går.\n\nFrån 50 och framåt, brygg solbladsutkast och Serpent-batcher av Thornpeak solblad, med lite Vale och kärrgrönska fortfarande i mixen. Den sista sträckan från 100 till 125 är en avsiktlig droppe, så brygg det som faktiskt säljer istället för att bränna örter för numret, och kom ihåg att förbrukningsvaror är det som alla köper om för alltid. The Book of Deeds markerar Strange Brews vid färdighet 50 och Grandmaster Alchemy på toppen."
        },
        "engineering": {
          "identityHeading": "Verktygsmakarens monopol",
          "identityBody": "Hantverket bearbetas vid verktygsverket i det sydvästra hörnet av Eastbrook Square, hem för Tinker Gizzel, Master of the Toolworks. Nivå 1 till 3 av varje verktygslinje är ordinärt lager från leverantören; nivåerna 4 och 5 kommer från en ingenjörsbänk, eller från Drowned Litanys dykdisk för Delve Marks bakom dess clearing-portar, och aldrig ut ur någon kassa för mynt.\n\nPå ringen sitter den med trial-and-error-handeln, bredvid Alchemy and Armorcrafting, vilket ger den två par identiteter: Bombardier (Engineering och Alchemy, upptagen före Gizzel själv) och Gearwright (Armorcrafting and Engineering, namngiven men ännu inte svärbar). En varning är viktigare här än någon annanstans: varenda en av Engineerings receptsteg sitter ovanför det sällsynta taket som hobbyer och odeklarerade hantverkare arbetar under, så kompetensnumret rör sig bara för en hantverkare vars huvudområden inkluderar Engineering, vilket idag betyder Bombardier. Vem som helst kan fortfarande bygga landredskapen; en oinställd hantverkare lär sig bara ingenting av att göra det, och de två spörecepten ber om Gizzels undervisning förutom.",
          "materialsHeading": "Reagenser och tidigare verktyg",
          "materialsBody": "Varje landverktygsrecept förbrukar verktyget en nivå under det plus ett FINt material, och den sammankopplingen är hela landstegen: fyra Fine Iron Ore och en Skysilver Mining Pick blir Osmium Mining Pick, sedan två Glyphsteel Bars, två Fine Osmium Ore och den osmium picken blir Glyphsteel Mining Pick. Yx- och skärelinjerna speglar formen av fin-plus-förut-verktyget med Fine Ashwood och Fine Highpine-stockar, Fine Goldleaf och Fine Sunpetal Herbs, även om deras tier 5-steg inte kräver några Glyphsteel Bars: valet är den linje som blir dyrare på toppen. De två spörecepten bryter mönstret med avsikt: Stormreel tar fyra Sunlint Koi och ett Silverstream spö, Tidewrought två Koi, åtta Raw Slatefin Carp och den Stormreel, så toppen av sportfiskarens stege betalas på vattnet snarare än vid en ådra.\n\nEtt fint material säljs inte någonstans och tappar inte från en vanlig skörd: du får det genom att arbeta med en av en zons fullgradiga ådror med ett verktyg rankat ovanför själva materialet, vilket i praktiken betyder att verktyget stegar under det du försöker bygga (ju enklare ådror en zon håller för resenärer ger det vanliga materialet vad du än svingar). Det är medvetet. På hantverksrutten kommer ett tier 5-verktyg från att faktiskt svänga tier 4 ett, inte från en shoppingtur; Delve Marks-räknaren är en väg runt det. Det enda undantaget är Glyphsteel Bar, raffinerad och endast för säljare, 1 silver 60 koppar per bar från Quartermaster Bree i Highwatch eller från Gizzels egen disk, så Glyphsteel Mining Pick ensam bär ett fast myntgolv inbyggt i kostnaden.",
          "ladderHeading": "Verktygssteget",
          "ladderBody": "Stegen är åtta recept, alla bundna till verktygsstationen. De sex landverktygsrecepten är kända automatiskt, ingen tränaravgift någonsin: nivå 4-hacka, yxa och skära vid färdighet 75, och nivå 5-versionerna vid färdighet 150. Det andra numret är inte ett stavfel, och det sitter över det nuvarande 125-taket med avsikt: skicklighetskraven gränsar aldrig till ett hantverk här, de får bara ett verktyg som du kan bygga en dag. reagenser och dess föregångare i nivå 4. De två tillverkade spöna är det inlärda undantaget: Gizzel lär ut Stormreel vid färdighet 75 för 4 guld och Tidewrought vid färdighet 125 för 16 guld, var och en i det ögonblick din nivå i hantverket når sin egen.\n\nVarje färdigt verktyg är sällsynt eller episk kvalitet och kommer ut signerade, så ditt namn rider i zonerna på andra spelares verktygsbälten. Engineering håller också hälften av ett kombinationsrecept: björnens Elixir, bryggt av en anpassad Bombardier med både teknik och alkemi vid 25 års ålder.",
        ...
        "enchanting": {
          ...
          "identityBody": "Varje förtrollning är känd från början, vem som helst kan avförtrolla från dag ett, och ingen av dem behöver någonsin en station; färdighetstaken vid 125 som alla hantverk. Det ena hörnet av handeln är dess par charmrecept: Tinker Gizzel lär ut Gatherer's Cache och Artisan's Eye vid verktygsfabriken i det sydvästra hörnet av Eastbrook Square, för den vanliga nivåavgiften när din Enchanting når 25, och själva charmen bearbetas på hans station.\n\nPå ringen sitter den mellan Inscription och Jewelcrafting, så dess två par identiteter är Arcanist (Inscription and Enchanting) och Gembinder (Enchanting and Jewelcrafting). Ingendera kan svära ännu, eftersom båda grannarna väntar på sina första recept, så idag är Förtrollande klättringar som allas hantverk: gratis till den sällsynta nivån före någon ed, och ett naturligt hobbyval för en Bombardier eller en Apotekare. Enchanters håller också samlingsvärlden igång: de två slottable-verktygseffekterna är Enchanter-verk, och en original hantverkare laddar upp sina egna effekter till en rabatt, djupare än en gång specialiserad.",
          "levelingHeading": "Hur förtrollning levlar",
          "levelingBody": "Tre åtgärder flyttar färdigheten: avförtrolla en pjäs, applicera en förtrollning och skapa de två berlockerna som klättrar på den vanliga hantverkskurvan. Varje framgång är värd upp till en poäng, skalad efter hur seriöst arbetet är: sällsyntheten hos den bit du bryter, eller reagensnivån för den förtrollning du använder. Vanliga förtrollare och bara dammförtrollare poäng som vanligt arbete; ovanliga besvikelser och väsen förtrollar som ovanliga; sällsynta disenchants och varje Runed eller Greater förtrollning som sällsynt; Episka och legendariska besvikare rankas ännu högre på bordet, även om ingen förtrollande identitet idag når förbi den sällsynta stegen, så de betalar samma sak som sällsynt arbete i praktiken. En ärlighet styr den brytande bänken: en bit som kom från en spelarbänk (gjord, signerad eller mästerverk) fräser fortfarande till material men lär ingenting, så en craft-and-break-slinga nivåsätter ingen, och lektionerna är i världsfunna redskap.\n\nDen välbekanta behärskningsfadingen gäller på 25-punktsnivåer, så arbete med vanligt betyg blir grått vid färdighet 75, ovanligt arbete vid 100 och sällsynt arbete exakt vid 125-tak. Förtrollande har också en egen vänlighet: input ovanför ditt arketyptak avrundas nedåt till det taket istället för att nollställas, så innan du ställer in dig blir en episk besvikelse helt enkelt sällsynt snarare än att lära ingenting. Om Enchanting hamnar i dvala bakom en annan identitet, bryter och tillämpar poäng som vanligt arbete och klättringen stannar vid 75, medan de två charmen, som rider på hantverkskurvan ovanför det gemensamma taket, lär en slumrande trollkarl ingenting alls; behåll det som din hobby och sällsynt arbete fortfarande lönar sig, bara långsammare efter 75.",
          "marketHeading": "Förtrollade kopior, ursprung och marknaden",
          "marketBody": "Att applicera en förtrollning förbrukar reagenserna och markerar en specifik kopia av föremålet. Rikta den mot en kopia i påsar och du får tillbaka en distinkt förtrollad kopia; rikta den mot en pjäs du redan har på dig och den är förtrollad på plats, precis där den sitter, utan outrustning och återutrusta dans. I vilket fall som helst följer bonusen den biten för alltid, genom unequips, bankresor och byten. En förtrollning per bit: att applicera en annan förtrollning på en förtrollad kopia ber om bekräftelse, och ersätter sedan den gamla förtrollningen direkt och förstör den utan återbetalning av dess material. Att sälja, kassera och avförtrolla alla föredrar vanliga kopior först, så att ditt färdiga stycke inte äts upp av misstag.\n\nMästerverksutrustning och förtrollande är vänner: ett mästerverk förblir helt förtrollande, och förtrollaren lägger utöver mästerverksbonusen utan att störa den eller tillverkarens signatur. Att stapla varje källa, ett signerat mästerverk som bär en större förtrollning är det bästa ett tillverkat stycke får, och det sitter fortfarande under raidbyte av design.\n\nPå marknaden listas en förtrollad eller signerad pjäs som allt annat: den går upp som sin egen enstaka lista, verktygstipset visar förtrollningen och tillverkarens märke, och Ravenpost bär den lika troget. Materialen förblir den stabila halvan av hantverket: Dust, Essence och Shards listas fritt, listningen kostar ingenting, och handlaren tar endast 5 procent av en genomförd försäljning. Det gör att de två klassiska förtrollarinkomsterna säljer material och säljer färdigt arbete: över marknaden, med korp eller ansikte mot ansikte i ett handelsfönster."
        }
      },
      "howHeading": "Hur hantverkande fungerar",
      "howBody": "Öppna tillverkningsfönstret (standardknapp T) och varje recept du känner till listas med vad det behöver och vad du har till hands. Stationsbundna recept ber dig att stå inom 20 meter från rätt station i stan, fältrecept tillverkar var som helst, och Enchantings brytande och förtrollande behöver ingen station alls (bara dess två charmrecept är stationsarbete, vid verktygsverket). Det finns ingen felrulle: ett hantverk med materialen i handen lyckas alltid.\n\nTvå små friktioner håller ekonomin ärlig. Varje framgångsrikt hantverk betalar en avgift på 2 koppar per poäng av föremålets statistiska budget, och hantverksliknande åtgärder delar en takt: högst 10 hantverk, avförtrollare, förtrollningar, räddningar eller verktygsladdningar i varje 60-sekundersfönster. Inte heller kommer att besvära en normal session; båda hindrar en maxad specialist från att översvämma marknaden.",
      ...
      "masterworkBody": "Varje framgångsrikt hantverk är precis vad receptet lovar, och ibland lite mer: ett mästerverk avslutar samma stycke en kvalitetsnivå finare, med bonusstatistiken inbakad vid hantverkstiden. Det är endast tillägg, aldrig en nedgradering, och det stannar under raidgolvet, så tillverkad utrustning kan vara utmärkt utan att ersätta en raiddropp.\n\nChansen är publicerad, inte mystisk: {base}% bas, plus {perTier}% per nivå din färdighet ligger över receptet, plus {signed}% när något signerat reagens går in, plus {spec}% när du är specialiserad, med material på högre nivå som lägger till 1 till 2% mer, allt begränsat till {cap}%. Endast en bit med verklig statistik kan förbättras, så statlösa allmänningar, verktyg och förbrukningsartiklar proc aldrig; ett slumrande hantverk producerar aldrig ett, och ett hobbyhantverk kan inte bemästra sitt sällsynta tak.\n\nFint arbete bär sin skapare. Sällsynta och bättre utskrifter är signerade, varje exemplar (Gjord av; samlat material bär Samlat av), ett mästerverk är alltid signerat oavsett dess kvalitet. En signatur är härkomst, inte ett lås: signerad varuhandel, post och lista på världsmarknaden fritt.",
      "trainingHeading": "Träning",
      "trainingBody": "Lärarrecept kommer från de boende mästarna, som lärs ut på deras stationer. Regeln är en rad: en mästare lär ut ett recept när din nivå i hantverket har nått receptets egen nivå, och inget annat begränsar det, inte din nivå, inte din arketyp. Stegarna för redskap och förbrukningsmaterial kör sina steg vid färdigheter 0, 25 och 50; Engineerings två spölektioner fortsätter stegen på 75 och 125, och Enchantings två charmrecept sitter på 25 stegpinnen, så en ny stege öppnas när dina nivåer klättrar.\n\nAvgifterna är engångssteg och fasta för steg: startsteget är gratis, färdigheten 25 stegen kostar {tier1} ett recept, färdigheten 50 stegen {tier2}, och spötlektionerna ovanför dem har sina egna avgifter, listade bredvid varje recept i tabellen. Du måste stå vid befälhavarens faktiska station för att träna, och en mobil station räknas aldrig. De vanliga fältrecepten och de sex tillverkade landverktygsrecepten behöver ingen utbildning alls; varje karaktär känner dem från början.",
      ...
      "ench": {
        ...
        "enchantsNote": "Enchants kommer i tre nivåer. Basnivån körs på Chime Dust (med lite Essence i den övre änden) och täcker vapenfacket plus alla pansarluckor utom off-handen, med tillräckligt många stat-axis-alternativ för att varje konstruktion hittar något för varje slot. The Greater tier kostar en Chime Shard plus Essence: starkare bonusar på slots med mest effekt. Shards matar ytterligare två diskbänkar förutom, de två charmrecepten på fem styck och det översta steget av laddningar med verktygseffekt, så satsa på några innan du spenderar.\n\nMellan dem sitter de fem Runed-förtrollarna, en konsument per maskinskriven sekundär, så inget du fräser är någonsin en återvändsgränd: Runed Edge (vapen, Styrka, förbrukar Resonant Steel), Runed Sigil (vapen, Intellekt, Resonant Timber), Runed Weave (bröst, Spirit, Resonant Thread), Runed Hide (legs, Resonant Hide), och Runed Hide (ben, Uthållighet, resonanslänkar). Varje tar också två Chime Essence; där en slot och stat har både en bas och en Greater-förtrollning landar Runed-bonusen mellan dem, medan Runed Weave är den starkaste chest Spirit-förtrollare direkt och Runed Hide är den enda ben-agility-förtrollningen överhuvudtaget. De exakta bonusarna finns alla i tabellen nedan.",
      ...
      "gatherIntro": {
        "mining": "Gruvdrift drar malm rakt ut ur världens klippa: koppar i Eastbrook Vale, järn i Mirefen Marsh och osmium uppe i Thornpeak Heights, med startådror utspridda genom alla yngre zoner bortom dem, och matar smedjans hantverk. Öppet för alla från nivå 1: ett 20 koppargruvval från en Eastbrook-, Fenbridge- eller Highwatch-disk öppnar varje startådra, och de högre stegen på plockstegen vaknar när din egen räknare tjänar dem. Spåras på sin egen räknare till ett tak på 100.",
        "logging": "Avverkning avverkar timmer från trädbestånd över hela världen: järnbark i Eastbrook Vale, ask i Mirefen Marsh, highpine i Thornpeak Heights och startbestånd i varje yngre zon, råmaterialet för skaft, stavar och ingenjörsbänken. Öppet för alla från nivå 1 med en skogsyxa i väskan (20 koppar vid Eastbrook-, Fenbridge- och Highwatch-diskarna), spårad på sin egen disk till ett tak på 100.",
        "herbalism": "Herbalism samlar det som växer vilt: sheenleaf i Eastbrook Vale, guldblad i Mirefen Marsh, solblad i Thornpeak Heights och startfläckar i varje yngre zon, löven och stjälken som håller apotekarbranschen igång. Öppet för alla från nivå 1 med en örtskära i väskan (20 koppar vid Eastbrook, Fenbridge och Highwatch-diskarna), spårad på sin egen disk till ett tak på 100.",
        "fishing": "Fiske är det udda bland de samlande yrkena, och det djupaste: ett riktigt bit-och-rulle-minispel, sina egna fångsttabeller i var och en av de tre hjärtats zoner (de unga vattnen utanför dem tjänar alla till Vales bord för tillfället), och ett färdighetstak på 200, dubbelt så många andra. Köp en stolpe, möta öppet vatten och kasta."
      },
      "rhythmHeading": "Insamlingsrytmen",
      "rhythmBody": "En skörd är ett kort synligt kast, inte ett omedelbart grepp: {base} sekunders bas, aldrig under en {floor} andra våning. Att bära ett verktyg ovanför nodens nivå, ett som din kunskap låter dig använda, snabbar upp dig med {tool} sekunder per nivå ovanför det, och varje kompetensband du korsar trimmer ytterligare {band} sekunder; bara att matcha nodens nivå får dig in genom dörren, det är nivåerna ovanför den som gör dig snabb.\n\nEn full påse tackar artigt nej till rollbesättningen innan den börjar, så ingenting slösas bort mitt i svängen, och varje skörd betalar en liten bit av karaktärs-XP, skalat av nodens nivå mot din egen så som dödar XP-skalor: en trivial grå nod lär ingenting för en kapad karaktär.",
      "gainBody": "Vinsten är deterministisk, aldrig en färdighetsuppgång: en nod vid eller över din vinstnivå lär ut en hel poäng per skörd, och varje {step}-färdighet är en nivå som poängsätts mot noden. Nivå 1-noder betalar fullt ut under 25, hälften till 49, en fjärdedel till 74 och ingenting från 75 och framåt; nivå 2-noder betalar fullt ut till 49; de två nivå 3-noderna i varje handel betalar fullt ut till 74 och hälften ända upp till taket på {cap}.\n\nDen avsedda rutten är enkel: lär dig om startnoderna i Vale, flytta till kärret och avsluta klättringen på Thornpeak Heights höga mark. Vid locket stannar inlärningen men avkastningen gör det inte: en samlare med tak fortsätter att rulla de bästa oddsen som handeln erbjuder för alltid.",
      ...
      "toolsNote": "Varje nod behöver sitt handelsverktyg i dina väskor, nivå 1 ingår: ingen hacka, ingen malm och ingen stång, ingen fisk. Leverantörsstegen täcker nivåerna 1 till 3 över de tre heartland-naven: nivå-1-verktyget säljs på alla tre, stegen ovanför det där marken som använder dem börjar (Fenbridge lägger till nivå 2, Highwatch nivå 3), och de yngre bosättningarna utanför dem har inga verktyg alls, så gör dig redo innan du reser. Varje disk säljer varje steg den lagrar fritt, och alla verktyg passerar direkt handel; varje steg listar sig också på marknaden och resor med post förutom de tre 20-koppar landstartarna: de köps vid en disk eller lämnas hand i hand, och säljs aldrig tillbaka, postas eller listas. Det som är gated är hanteringen. Ett landverktyg ovanför nivå 1 fungerar bara när din färdighet i sin egen handel har tjänat in det, {tier2Prof} för nivå 2, {tier3Prof} för nivå 3, och 85 och 100 för de två tillverkade stegpinnarna, och leverantörsraden, verktygstipset och tabellen nedan nämner alla kravet i förväg. Tills dess väntar ett verktyg som köpts i förväg helt enkelt i dina väskor, öppnar ingen mark, köper ingen hastighet och slår inga fina graderingar, för att sedan använda det ögonblick din räknare vidrör sitt nummer. Fiskespön är det enda undantaget: inget spö har ett utövande krav, och Trader Wilkes i Eastbrook lagrar medvetet tier 2 och tier 3 spön för sportfiskare som köper framåt. Ett verktyg upptar aldrig en utrustningsplats och slits aldrig ut, så vart och ett är ett engångsköp, och bara nivån spelar roll för porten: ett sällsyntare verktyg i samma nivå öppnar inget extra. Sällsynthet är dock inte bara färg. Det gör att en slitsad verktygseffekt håller längre, och på en spö vidgar den rullfönstret.\n\nEtt bättre verktyg köper tre saker, inte två. Det öppnar marken i högre nivåer, det förkortar kasten och det förbättrar det som kommer ut: arbeta en ven med ett verktyg som är rankat ÖVER områdets eget material och skörden ger det fina betyget istället för det vanliga. Venen måste vara en av zonens fullklassiga, så ju lättare ådror en zon håller för resenärer ger fortfarande det vanliga materialet. Fina material är vad de tillverkade verktygsrecepten förbrukar, och ett fint betyg räknas som sin vanliga version överallt där ett recept eller en arbetsorder ber om ett, så uppgradering leder aldrig till att du strandar: det betyder bara att din kopparmalm kommer som Fine Copper Ore.\n\nOvanför säljarstegen har varje handel två tillverkade verktyg, nivå 4 och nivå 5, gjorda på verktygsfabriken (varje karaktär känner till landrecepten; färdigheten som klättrar för arbetet är Engineerings), eller köpt med Delve Marks på Drowned Litany-disken när dess röjningsportar är uppfyllda: tabellen nedan visar Marks-priset och fråga rensar var och en. Ingen handlare säljer dem någonsin för mynt. Fiske har sitt eget par, och de lärs av verktygsmakaren snarare än kända från början. Ingen nod och inget vatten behöver idag mer än nivå 3, så de två översta stegpinnarna köper hastighet, gradering och ett snällare rullefönster snarare än åtkomst, och de kommer att vara inträdesbiljetten när högre nivåer anländer.",
      "toolCrafted": "Tillverkad ({craft})",
      "toolCraftedOrMarks": "Tillverkad ({craft}) eller {marks} Delve Marks efter tre Drowned Litany clears",
      "toolCraftedOrMarksHeroic": "Tillverkad ({craft}) eller {marks} fördjupa märken efter en heroisk drunknad litany.",
      "toolVendor": "{name} ({hub})",
      ...
      "bandsBody": "Kompetensband är den delade 0/100/200 stegen över en handels disk. För landhandeln korsade bandet vid 100 rakningar, och deras mössa gör band 1 till taket. Fishings band rakar ingenting: de väljer fångsttabellerna (med ett spö att matcha), bara fiske når band 2, och själva klättringen är det som drar en sportfiskare till djupare vatten, där de bättre borden och de vidare lektionerna båda bor.",
      ...
      "specimenBody": "Ha ett litet påsrum över när du odlar: en signerad vindfall behöver sitt eget rum eller en matchande signerad stack att landa i, och om inget passar kommer avkastningen fortfarande men signaturen går förlorad. Corpse Harvesting har också sin egen jackpotarm: cirka {pct}% av varje skördad komponent kommer upp sällsynt eller bättre. En familj med ett perfekt exemplar att ge (hud, siden, gift, kött) behåller sin ordinarie avkastning och präglar det signerade exemplaret bredvid sig; varannan familj undertecknar själva avkastningen.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "De 100 milstolpen inskriver Old Salt och 200 inskriver Master Angler med sin titel, toppen av sportfiskarens konst; Fiske räknas också till Master Gatherer, som tjänas till 100 i valfri tre samlingsaffärer. En första fisk från vart och ett av sex zoners vatten fyller sin egen sida, de tre hjärtats zoner och Willowfen, Galecrest och Farshore bortom dem, och Sunglint Koi registrerar Glimmer of Hope, så resenärer med en stång i packningen fyller sin bok snabbare än de förväntar sig."
      },
      "fish": {
        "startHeading": "Kom igång",
        "startBody": "En enkel fiskestång kostar 20 koppar från Fisherman Brandt i Eastbrook (leta efter Old Salt vid stadens östra kant, vid vägen till Mirror Lake); Tinker Gizzel, Provisioner Hale i Fenbridge och Quartermaster Bree i Highwatch-stockar också. Använd stången medan du vänder dig mot vatten som är tillräckligt djupt för att hålla fisk, upp till cirka 24 yards framför dig, och din bobber seglar ut.\n\nDu kan inte kasta medan du är i strid, medan du simmar eller när du är död: kastning från land är den avsedda hållningen. Vattnet blir dock hårdare som landet gör: kärret vill ha åtminstone tier 2 Ironreel och topparna tier 3 Silverstream, och en lina som kastas utan staven som vattnet tar lämnar aldrig din hand. Två spön sitter ovanför dem, Stormreel och Tidewrought: ingenjörer tillverkar dem vid verktygsverket av vad en lina drar upp, och den drunknade litanys dykdisk säljer dem för Delve Marks bakom dess röjningsportar, dock aldrig för mynt. Inget vatten frågar efter dem, så de köper en kortare väntetid och ett bredare haspelfönster istället för åtkomst, vilket längst upp betyder ett bett på tre sekunder.",
        "biteHeading": "Napp och indragning",
        "biteBody": "Efter gipset kommer ett bett i ett dolt ögonblick mellan {min} och {max} sekunder; fördröjningen avgörs när linjen landar, så inga kast känns riktigt lika. När bobbern biter har du ett {reel} andra fönster för att trycka på stången igen och rulla in: rulla in den och fångsten landar, tveka förbi den och fisken kommer undan utan något att visa. En hel session tar {cap} sekunder, så även en tyst cast löser sig snabbt.\n\nBättre spön vässar båda ändarna av minispelet: varje spönivå ovanför det första trimmar {rod} sekunder av längsta möjliga väntetid, aldrig under tresekundersvåningen grisar det översta spöet redan, och lägger till {reelRod} sekunder till rullefönstret, så Ironreel drar den värsta väntan ner till 6,5 sekunder förbi ett fönster till 3,25 sekunder och Silver med ett fönster på 3,25 sekunder. 4, dess sällsynthet breddar rullen lite utöver vad nivån ensam betalar. De snabbaste betten ändrar aldrig vad du än håller, och ett spö behöver bara vara i dina väskor för att räknas.",
        "scheduleHeading": "Skicklighetsvinst",
        "scheduleNote": "Fiskevinsten följer ett fast schema utan tärningar: en hel poäng per fångst under 50 färdigheter, en halv poäng under 100, en tiondel under 150 och en långsam 0,02 trickle från 150 till 200. Den sista sträckan är en resa med tusentals fångster med avsikt: 200 är ett uttalande, inte ett stopp på vägen till något annat.\n\nSkräp slutar helt och hållet att undervisa på {cutoff}: därifrån är ogräs och stövlar bara ogräs och stövlar. Vattnet i sig täcker också lektionen: Vales nivå 1-vatten (och varje ung strand bortom hjärtat) lär ingenting över 100, träskets stopp vid 150, och bara Thornpeaks skola en sportfiskare hela vägen till 200. Varje landad fångst vinner annars i den schemalagda takten, så när disken stannar, är schemat deeek.",
        "colProficiency": "Skicklighet",
        "colGain": "Vinst per fångst",
        "belowFmt": "Under {below}",
        "tablesHeading": "Fångsttabeller",
        "tablesNote": "Din skicklighet väljer ett av tre fångstband: band 0 från början, band 1 vid 100, band 2 vid 200, var och en förskjuter vikt ur skräp och tomma krokar till riktig fisk, zon för zon. Varje band ovanför det första kräver också ett spö: band 1 vill ha nivå 2 Ironreel, band 2 nivå 3 Silverstream. Ditt effektiva band är det lägsta av vad din skicklighet har tjänat och vad ditt spö stödjer, och hatten är tyst: med ett mindre spö fångar du fortfarande, precis utanför det nedre bandets bord, så om dina fångster känns fast medan din skicklighet klättrar, kontrollera spöet först.\n\nVarje zons vatten rymmer sitt eget par matfiskar, läker mer ju djupare zonen är, alla matlagningsinsatser och perfekt god mat som kan sitta och ätas rå. Resten av bordet är sportfiskarens skatt: ogräs, en och annan känga och den tomma kroken, som aldrig helt försvinner. Hur mycket du betalar beror på vattnet din bobber landar i, inte var du står: ett kast når upp till 24 yards, och spöet vattnet kräver, bordet det drar ifrån, handlingen den tillgodoräknar sig, och hur långt det lär alla svar på den zon som vattnet hör till, avgjorde det ögonblick som linjen landar. Varje zons vatten skrivs för ett eget band, Vale för band 0, kärret för band 1, topparna för band 2, och att fiska ett band under som förvandlar ungefär en tredjedel av dina kast till tomma krokar, två band under det mer än hälften. Spöet tar dig till vattnet; skickligheten är det som gör att det lönar sig, och klättringen är det som drar en sportfiskare djupare, för bättre band är inte bara bättre lön: förbi Vale är de de enda vattnen som fortsätter att lära ut. {rare} är den enda raden som svarar på ditt fångstband och inget annat: samma odds i varje zon, och sex gånger mer sannolikt vid band 2 än vid band 0, så det sällsynta på kajen är det som en Master Angler verkligen är bättre på.",
        ...
        "koiBody": "Varje vattenmassa i spelet döljer samma pris: Sunglint Koi, en ovanlig glimt på linjen värd 75 koppar för en säljare och snarare mer till din stolthet. Dess odds svarar mot ditt fångstband och inget annat, detsamma i varje zon: en rad på 1 procent av fångsttabellen vid band 0, 3 vid band 1 och 6 vid band 2, dragna på varje inrullat kast, så koi kommer till sportfiskaren som tjänade de djupa borden. Att landa ett registrerar Glimmer of Hope i din gärningsbok, ett nollberömt samlarmärke. När det händer ser loggen till att du vet."
      },
      "econ": {
        ...
        "trainingNote": "En fast avgift per receptsteg, debiteras en gång när en mästare lär ut det; varje steg i tabellen nedan används live idag, från de kostnadsfria startrecepten till verktygsmakarens spölektioner överst.",
        ...
        "provenanceBody": "Vissa föremål bär ett namn. Håll muspekaren över ett och verktygstipset säger Samlad av så och så på ett råmaterial, eller Tillverkat av så och så på ett färdigt stycke: samma märke, formulerat för hur föremålet kom till. En signatur är en del av själva föremålet, reser med det genom affärer, banken, posten, världsmarknaden och till och med ett återköp från leverantören och bleknar aldrig.\n\nAtt samla in tecken fungerar automatiskt: alla skördar som rullar sällsynt eller bättre anländer undertecknade, och sällsynta fynd undertecknar hela sin femfaldiga vindfall. En likskörds lyckorulle undertecknar sin avkastning där familjen inte har något exemplar att ge, och där den gör det, håller avkastningen jämn och präglar det signerade orörda exemplaret bredvid det. Skapa skyltar på samma linje: varje exemplar av en sällsynt eller bättre utgåva är mintsignerad, och ett mästerverk signerar alltid oavsett dess kvalitet, så den finaste versionen av ett föremål namnger alltid sin tillverkare. Det enda som kan kosta dig en signatur är en full påse: en signerad enhet behöver sitt eget utrymme, eller en matchande signerad stack, för att landa i.\n\nEn hög med föremål delar en identitet, så två kopior sammanfogas endast när varje märke matchar exakt: samma föremål, samma undertecknare, samma mästerverksstatistik, samma förtrollning, samma bindning. En signerad stock förenas aldrig med en vanlig hög i någon av riktningarna (sammanslagning skulle radera någons namn), men identiska nyttolaster smälter samman glatt, så tjugo malm signerade av samma samlare sitter i en stack och ett oväntat fall förstör inte dina väskor.\n\nSignaturer betalar hantverkare tillbaka: att hålla en signerad kopia av ett behövt reagens vid bänken, vem som än signerade det, lägger till 2 procentenheter av mästerverkschans, och att hålla ett reagens signerat av din egen hand minskar reagensens erforderliga kvantitet med en (aldrig under en). Ditt eget undertecknade sällsynta-eller-bättre arbete fortsätter till och med att lära dig, idag genom enbart kolven: drick en dryck du signerat och en liten droppe av skicklighet flödar tillbaka till hantverket som bryggde det, så länge som hantverket är en av dina aktiva majors.",
        ...
        "throttleBody": "Output har ett tak: hantverk, avförtrollande, förtrollande, räddande och verktygseffektladdningar delar en budget på {actions} framgångsrika åtgärder i varje {seconds}-sekundsfönster. Ett nekat försök kostar ingenting och spenderar ingen budget. Du kommer aldrig att känna det i normalt spel; det existerar så en maxad specialist med en full bank kan inte översvämma marknaden, oavsett deras skicklighet eller lager.",
      ...
      "faq": {
        ...
        "a4": "Du träffade en vindfall. Ungefär 1 skörd av 90 utlöser en sällsynt insamlingshändelse (urgammal kärnved på ett träd, en orörd ådra på malm, en månbelyst blomning på örter): den multiplicerar avkastningen fem gånger, signerar varje enhet med ditt namn och tillkännager fyndet för hela zonen. En sällsynt eller bättre sällsynthetsrulle på en vanlig skörd anger också avkastningen.\n\nSignerat material är värt att behålla eller sälja dyrt: att hålla en signerad kopia av ett nödvändigt reagens vid bänken ger 2 procentenheter till mästerverkets chans. Kom bara ihåg att de bara staplar med identiskt signerade kopior, så de behåller sin egen väska.",
        ...
        "a6": "De nio vanliga fältrecepten och de sex tillverkade landverktygsrecepten är kända för alla från början, och så är tre stationsbundna slutstenar (Kilnscale Mantle, Wardweave Cowl och Duskhide Wraps), som inte behöver någon tränare, bara deras station. Allt annat lärs ut av de boende mästarna på deras stationer över de tre navstäderna: de flesta står i Eastbrook, garvaren håller garveriet i Fenbridge och alkemisten har apoteket i Highwatch.\n\nTränarrecept körs i steg: färdigheter 0, 25 och 50 för redskap och förbrukningsmaterial, gratis, 25 silver och 1 guld som engångsavgifter; Enchantings två charmrecept sitter på 25 stegpinnen, och verktygsmakaren lär de två tillverkade fiskespöna på 75 och 125 för 4 och 16 guld. En mästare lär ut ett recept när din konsol i det hantverket har nått receptets egen konsol, och du måste stå vid deras station för att lära dig: en mobilstation räknas inte.",
        "q7": "Varfor gick min insamling plötsligt langsamt?",
        "a7": "Samlingskastet börjar på 2,5 sekunder och rakas ner på två sätt: 0,4 sekunder för varje verktygsnivå du bär och kan använda ovanför nodens egen nivå, och 0,15 sekunder när din trades räknare korsar sitt 100-band, med ett golv på 1,5 sekunder. Flytta från nivå 1-noder upp till nivå 3-noder och ditt överskott försvinner, så samma val svänger långsammare igen. Att hålla exakt den nivå som krävs köper ingen hastighet; den öppnar bara noden.\n\nFärdighetsförstärkning bleknar på samma sätt som crafting gör: en nod grånar när din skicklighet klättrar förbi dess nivå (nivå 1-noder lär ingenting från färdighet 75 och framåt), så svaret på långsamma vinster är högre nivånoder. De behöver ett verktyg av åtminstone deras nivå i dina väskor (ingen nod arbetas någonsin barhänt, nivå 1 inkluderat), och ett landverktyg över nivå 1 vill också ha sitt bruksmärke först, 40/70/85/100 i sin egen handel för nivåer 2 till 5. Fisket följer sin egen avsmalning: full vinst under 50 under 100, 100 under 50, 100. och 0,02 under 200, skräpfångster lär ingenting alls från 100 och framåt, och vattnet i sig täcker lektionen (nivå 1-vatten slutar lära ut vid 100, kärret vid 150), så en avstängd räknare kan också betyda att du har vuxit ur vattnet.",
        "q8": "Kan jag tillverka utanfor staden?",
        "a8": "Delvis. De nio vanliga fältrecepten (startvapen, rustningar, mat och dryckeshäftklamrar) kan skapa var som helst, när som helst, och det gör även de tre kombinationsrecepten för de svurna paren. Allt annat ovanför dem är bundet till en stationstyp: smedja, kök, apotek, garveri, vävstol eller verktygsverk, och du måste befinna dig inom 20 meter från stationen för att farkosten ska gå igenom.\n\nVid 75 skicklighet i ett hantverk specialiserar du dig, och tillsammans med 20 procent materialrabatt får du en mobilstation: placera den på fältet och den står i 10 minuter och serverar det hantverkets recept som om du var på riktigt. Den mobila stationen är endast till för hantverk: att lära sig recept och oförbindande uppdrag kräver alltid den riktiga stationen i stan."
      }
    },
    "economy": {
  ...
  "questUi": {
    ...
    "log": {
      ...
      "repeatableStatus": "Repeterbar",
      "cooldownStatus": "Snart tillgänglig igen",
    ...
    "dialog": {
      ...
      "repeatableQuestAria": "Upprepad uppdrag: {name}",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Okänd artikel {id}, kvantitet {count}",
      "unknownItemAriaMasterwork": "Okänd artikel {id}, kvantitet {count}, mästerverk",
      "unknownItemAriaEnchanted": "Okänd artikel {id}, kvantitet {count}, förtrollad kopia",
      "unknownItemAriaBound": "Okänd artikel {id}, kvantitet {count}, inbunden kopia",
      "unknownItemAriaInstanced": "Okänd artikel {id}, kvantitet {count}, tillverkarmärkt kopia"
    },
    "equipment": {
      "empty": "Tom",
      "levelClass": "Nivå {level} {className}"
    ...
    "vendor": {
      ...
      "qtyRowAria": "Inköpskvantitet",
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Köp {count} åt gången",
      "qtyCustom": "Beställnings",
      "qtyCustomAria": "Välj ett anpassat belopp att köpa",
      "buyCountAria": "Köp {count} av {item} för {price}",
      "buyCountAriaWithRequirement": "Köp {count} av {item} för {price}. {requirement}",
      "buyQuantityTitle": "Köpa hur många {item}? Upp till {max}.",
      "buyQuantityInput": "Kvantitet att köpa",
      "buyQuantityConfirm": "Köpa",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_ashwood_log": {
        "name": "Fin Ashwood stock"
      },
      "fine_elderwood_log": {
        "name": "Fin Highpine stock"
      },
      "fine_silverleaf_herb": {
        "name": "Fin sheenleaf ört"
      },
      "fine_goldleaf_herb": {
        "name": "Fin guldbladsört"
      },
      "fine_sunpetal_herb": {
        "name": "Fin solbladsört"
      },
      "stormreel_fishing_rod": {
        "name": "Stormreel fiskespö"
      },
      "tidewrought_fishing_rod": {
        "name": "Tidewrought fiskespö"
      },
      "duskwisp_essence": {
    ...
    "quests": {
      ...
      "q_the_codfather": {
        "title": "Torskfadern",
        "text": "Torskfadern är inte bara en fisk, {playerName}, han är en kallblodig mördare. Oldtimers svär att han äter Mire Prowlers till frukost, och till och med Mirefen Widows kommer inte att spinna sina nät nära Deepfen Shallows av ren skräck. Han styr dessa vatten, och kärrvatten tar ett järnhjulsfiskespö, inte mindre; min disk säljer dem. Ta en i handen, dra upp den gamla djävulen ur hans vatten, så ska jag erkänna att du har anslutit dig till familjen.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Jag har sett dessa märken förut, på tre gamla gravar runt det norra slagfältet. Kapten Aldren ligger på den västra höjden, översteprästen Malric längre söderut längs den västra kanten och Royal Assassin Voss vid den östra klippan. Rör vid varje grav och lyssna, {playerName}. De döda kanske kommer ihåg vad de levande glömde.",
