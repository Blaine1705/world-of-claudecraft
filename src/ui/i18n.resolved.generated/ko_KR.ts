...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "veilbound_march": "적 무리를 통과해 표식을 남기고, 자신에게 주는 피해를 줄이며 위협을 굳힙니다.",
    ...
    "profPages": {
      ...
      "ench": {
        ...
        "disenchantNote": "마력 추출은 일반 품질 이상의 무기나 방어구를 하나 소모해 마법 재료로 분해한다. 이미 마법이 부여된 물건은 분해할 수 없다. 일반과 고급 품질은 울림 가루 한 줌으로 변하며, 희귀하거나 레벨이 높을수록 조금 더 나온다. 희귀 이상은 결과물의 형태가 달라져, 희귀 품질은 울림 정수 하나, 영웅이나 전설 품질은 울림 파편 하나가 나오고, 재료의 종류에 따른 보조 재료도 함께 나온다.",
        "typedHeading": "계열 부산물",
  ...
  "entities": {
    "abilities": {
      ...
      "veilbound_march": {
        "name": "장막결속 행진",
        "description": "4초 동안 에테르 상태가 되어 이동 속도가 40%, 방어도가 30% 증가하고 감속, 이동 불가, 강제 이동에 면역이 됩니다. 통과한 적은 6초 동안 장막의 표식에 걸려 매초 신성 피해를 받고, 자신에게 주는 피해가 20% 감소하며, 자신을 향한 추가 위협을 생성합니다. 첫 표식은 헌신 1을 생성합니다. 행진이 끝나면 근처의 표식 대상에게 마지막 폭발 피해를 줍니다. 승천 중에는 폭발 피해가 50% 증가하고 적을 자신 쪽으로 살짝 끌어당깁니다."
      },
      "veilbound_mark": {
        "name": "장막의 표식",
        "description": "매초 신성 피해를 받고, 표식을 건 성기사에게 주는 피해가 20% 감소하며, 그 성기사를 향한 추가 위협을 생성합니다."
      },
      "righteous_fury": {
        "name": "불타는 맹세",
