...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "play": "튜토리얼 진행하기",
      "skip": "튜토리얼 건너뛰기",
      "declineNote": "뜻대로 하세요, 친구. 언제든 마음이 바뀌면, 제 곁의 이 종이 밤낮없이 수련의 해안으로 데려다줍니다. 늑대는 기다려 주지 않지만, 이 종은 기다려 준답니다.",
      "bellHomeNote": "벌써 해안에서 돌아오셨나요? 방금 울리신 것이 나룻배 종입니다. 그 쌍둥이가 바로 제 곁에 서 있죠. 언제든 울리면 건너기가 수련의 해안으로 다시 데려다줍니다. 실수로 울리셨더라도 손해 볼 것 없어요.",
      "noteClose": "알겠어요"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "방랑자 브린",
        "title": "항구 안내인",
        "greeting": "이스트브룩 골짜기는 오는 사람을 가리지 않아요, 친구. 그리고 아직 발걸음이 불안한 이들에게는 언제나 수련의 해안이 있죠. 제 곁의 이 종이 일 년 내내 언제든 건너다 주고, 섬의 쌍둥이 종이 다시 집으로 울려 보내 준답니다."
      },
      "instructor_maren": {
        "name": "교관 마렌",
        "title": "수련 사범",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "주머니와 돈주머니",
        "text": "골짜기로 떠나기 전 마지막 가르침이에요, {playerName}. 모험가의 목숨을 지켜 주는 가르침이죠. 바로 당신이 지고 다니는 짐 얘기입니다. 배낭에는 열여섯 칸이 있고, 그 옆에 빈 가방 고리 넷이 기다립니다. 가방을 하나 채울 때마다 그 공간이 전체 용량에 더해져요. 보급관 핀치에게서 아마천 주머니를 사서 채운 다음, 내게 돌아오세요.",
