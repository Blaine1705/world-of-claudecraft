...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "strafeBody": "옆으로 움직이는 또 다른 방법이 있습니다. 마우스 오른쪽 버튼을 누른 채 드래그해 시점을 돌려, 내려온 길을 거슬러 북쪽을 바라보세요. 그런 다음 {strafeKey}를 누른 채 마지막 길을 붉은 깃발까지 옆걸음하세요. 옆걸음은 시선을 표적에 둔 채 움직이게 해 줍니다. 언젠가 전투에서 이렇게 움직이게 될 거예요.",
      "strafeBodyTouch": "옆으로 움직이는 또 다른 방법이 있습니다. 손가락으로 드래그해 시점을 돌려 북쪽을 바라본 다음, 이동 스틱을 왼쪽으로 밀어 마지막 길을 붉은 깃발까지 옆걸음하세요.",
      "strafeBodyPad": "옆으로 움직이는 또 다른 방법이 있습니다. 오른쪽 스틱을 밀어 시점을 돌려 북쪽을 바라본 다음, 왼쪽 스틱을 왼쪽으로 밀어 마지막 길을 붉은 깃발까지 옆걸음하세요.",
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "정확한 일격",
        "text": "발 다음은 팔입니다, {playerName}. 수련장은 내 뒤 길을 오른 곳에 있고, 그곳의 짚 허수아비들은 맞으라고 만든 것들이죠. 길을 잃겠거든 M을 눌러 지도를 여세요. 맡은 임무는 모두 지도에 표시됩니다. 허수아비에게 다가가 Tab을 누르거나 왼쪽 클릭해 대상으로 잡고, 그런 다음 1을 누르거나 화면 아래쪽 행동 단축바의 첫 번째 아이콘을 클릭해 내리치세요. 하나가 무너질 때까지 계속 치세요. 반격은 없습니다. 허수아비란 원래 그런 법이니까요. 교련관 루크가 수련장 동쪽 끝에서 지켜보고 있습니다. 그에게 F를 눌러 결과를 보고하세요.",
      ...
      "q_ps_shell_and_claw": {
        "title": "껍데기와 집게발",
        "text": "짚은 상관하지 않죠, {playerName}. 그러니 이번엔 상관하는 놈들입니다. 해변 종종게들이 먼 바닷가의 난파선 해안에서 잔해를 뒤지고 있어요. 내 수련장에서 서쪽으로 길을 따라가면 곧장 놈들에게 닿습니다. 놈들은 되꼬집으니 체력 막대를 살피며 계속 휘두르세요. Tab이나 왼쪽 클릭으로 한 마리를 대상으로 잡고, 1을 누르고, 껍데기가 갈라질 때까지 멈추지 마세요. 셋이면 충분합니다. 그런 다음 북쪽 언덕길을 오르세요. 조수지기 넬이 바닷가 장부를 맡고 있고, 당신의 껍데기도 세어 줄 겁니다.",
      ...
      "q_ps_the_wreck_line": {
        "title": "난파선 해안",
        "text": "조수는 이 섬에 표류물로 값을 치릅니다, {playerName}. 옛 난파선에서 나온 표류 상자들이 나와 새벽쉼터 야영지 사이 언덕을 따라 옮겨져 놓여 있죠. 내 길을 따라 야영지 쪽으로 가면 바로 그 곁을 지나게 됩니다. 여는 건 간단해요. 이름이 보일 때까지 상자에 다가가 F를 누르거나 상자를 왼쪽 클릭하면, 품고 있던 것을 내어 줍니다. 셋이면 충분하고, 앞으로 만날 모든 상자와 채집물과 문도 전부 같은 F 하나로 연다는 걸 기억하세요. 보급관 핀치가 야영지 좌판을 지키며 표류물이라면 나뭇가지 하나까지 사들입니다. 거둔 것을 그녀에게 넘기세요.",
        "completion": "밧줄과 타르, 그리고 바다가 어쩐 일로 남겨 준 치즈 반 덩이. 전부 사죠. 몸을 굽혀 나를 줄 아는 게 분명하니, {playerName}, 생업 이야기도 들어 두세요. 채집은 도구에서 시작합니다. 곡괭이, 도끼, 낫, 낚싯대, 전부 골짜기 상인들이 팔죠. Shift를 누른 채 P를 누르면 전문 기술 수첩이 열립니다. 그것이 당신의 생업의 바퀴이고, 익힌 기술이 모두 적혀 있어요. 인접한 한 쌍에 조율하면 그 둘은 상한 없는 주 전공이 되고, 바퀴 건너편 하나는 취미로 남고, 나머지는 지식을 간직한 채 잠듭니다. 정해진 것은 아무것도 없어요. 장인이 짝을 정해 주고, 부탁하면 언제든 바꿔 줍니다. 이스트브룩의 대장간과 주방과 베틀과 공방, 펜브리지 무두질터, 하이워치 약방에서요.",
        "objectives": {
          "0": {
            "label": "표류 상자 열기"
          }
      ...
      "q_ps_pouch_and_purse": {
        ...
        "completion": "좋은 주머니군요. 말썽거리를 담을 칸이 여섯 늘었네요. 이제 어떤 가방에도 담기지 않는 나머지 절반의 가르침입니다, {playerName}. 들고 다닐 수 없는 것은 도금 금고가 맡습니다. 경리관 윅이 서쪽 길을 오른 곳에 금고 책상을 두고 있는데, 그가 열어 주는 금고는 어느 마을의 어느 경리관과도 같은 금고이고, 돈주머니가 두둑해지면 금고 칸도 더 살 수 있죠. 값진 것은 금고에, 가방에는 여유를. 어떤 늑대보다도 꽉 찬 배낭이 끝장낸 모험이 더 많답니다.",
        "objectives": {
          "0": {
            "label": "아마천 주머니 구입하기"
          }
