...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "방금 건너오셨나요? 수련의 해안에 온 것을 환영합니다. 제 뒤 길 끝의 새벽쉼터 야영지에서 교관 마렌이 훈련을 이끌고 있어요. 무엇보다 먼저 당신과 이야기하고 싶어 할 겁니다. 떠날 준비가 되면 이 부두 끝의 종을 울리세요. 건너기가 이스트브룩 마을까지 데려다줄 겁니다.",
      "noteClose": "알겠어요"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "정확한 일격",
        "text": "수련의 해안에 온 걸 환영해요, {playerName}. 이곳의 모든 가르침은 같은 것에서 시작합니다. 발을 딛고, 칼자루를 쥐는 것. 야영지 남서쪽 수련장의 허수아비들은 맞으라고 만든 것들입니다. 하나를 골라 자세를 잡고, 셋이 쓰러질 때까지 내리치세요. 허수아비의 반격은 따끔한 정도죠. 이 해안 너머의 것들은 훨씬 세게 때린답니다.",
