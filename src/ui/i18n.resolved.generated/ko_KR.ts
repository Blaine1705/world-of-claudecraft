...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsHeading": "도구",
      "toolsNote": "모든 채집지에는 그 전문직의 도구가 가방에 있어야 하며, 1티어도 예외가 아니다. 곡괭이가 없으면 광석도 없고, 낚싯대가 없으면 물고기도 없다. 상인 사다리는 1티어부터 3티어까지를 다루며, 각 거점은 자기 지역이 쓰는 티어만 취급한다. 1티어 도구는 어느 지역 거점에서든 팔고, 그 위 단계는 그것을 필요로 하는 광맥이 있는 곳에서 판다. 그 위 단계를 살 때는 상인이 해당 도구의 전문직 숙련도도 요구한다. 2티어는 {tier2Prof}, 3티어는 {tier3Prof}이며, 조건은 해당 줄에 표시된다. 도구는 가방에 들어 있기만 하면 되고, 장착 칸도 내구도도 없어서 한 번만 사면 되며, 이미 가진 도구는 그대로 쓸 수 있다. 조건을 가르는 것은 티어뿐이며, 도구의 희귀도 색은 겉모습일 뿐이다.\n\n상인 사다리 위에는 제작 도구 두 가지, 4티어와 5티어가 있다. 기술자가 도구 공방에서 만들며 어떤 NPC도 팔지 않는다. 현재 3티어를 넘는 채집지는 없으므로 지금 이들의 가치는 속도다. 최상급 도구는 낮은 등급 채집지에서 시전 시간을 최소치로 고정하며, 더 높은 티어의 땅이 열리면 그때의 입장권이 된다.",
