...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "이 땅에서는 모험을 시작하는 이들이 수련의 해안을 찾는 것이 전통이에요. 해협 너머의 조용한 섬이죠. 그곳에서 세상의 시련에 맞서기 전에 실력을 갈고닦고 이곳에 익숙해질 수 있어요. 나룻배는 양방향으로 다니고, 가든 안 가든 누구도 당신을 얕보지 않을 거예요.",
      ...
      "islandArrivalNote": "방금 건너오셨나요? 수련의 해안에 온 것을 환영합니다. 제 뒤 길을 따라 새벽쉼터 야영지에서 교관 마렌이 훈련을 이끌고 있어요. 이름이 보일 때까지 바짝 다가가 F를 누르거나 왼쪽 클릭하면 이야기할 수 있고, 첫 번째 임무를 내줄 겁니다. 그리고 떠날 준비가 되면 제 부두 옆에 선 종을 울리세요. 건너기가 이스트브룩의 집으로 데려다줄 겁니다.",
      "noteClose": "알겠어요"
    },
    "tutorial": {
    ...
    "bootcamp": {
      "title": "첫걸음",
      "moveTitle": "다리 풀기",
      "moveBody": "{moveKeys}로 아무 방향으로나 몇 걸음 걸어 보세요.",
      "moveBodyTouch": "화면 아래의 이동 스틱을 드래그해 아무 방향으로나 몇 걸음 걸어 보세요.",
      "moveBodyPad": "왼쪽 스틱을 밀어 아무 방향으로나 몇 걸음 걸어 보세요.",
      "cameraTitle": "시점 돌리기",
      "cameraBody": "마우스 오른쪽 버튼을 누른 채 드래그해 시점을 돌려 보세요. 왼쪽 오른쪽을 한껏 둘러보세요.",
      "cameraBodyTouch": "이동 스틱이 아니라 세상 화면을 손가락으로 드래그해 시점을 돌려 보세요.",
      "cameraBodyPad": "오른쪽 스틱을 밀어 시점을 돌려 보세요.",
      "courseTitle": "건틀릿 달리기",
      "courseBody": "이제 둘을 함께 써 보세요. 부두 남쪽 바닷가의 깃발 줄을 달리는 겁니다. {jumpKey}로 울타리를 뛰어넘고, 상자를 타고 올라, 붉은 깃발까지 모든 깃발을 짚으세요.",
      "courseBodyTouch": "이제 둘을 함께 써 보세요. 부두 남쪽 바닷가의 깃발 줄을 달리는 겁니다. 점프 버튼으로 울타리를 뛰어넘고, 상자를 타고 올라, 붉은 깃발까지 모든 깃발을 짚으세요.",
      "courseBodyPad": "이제 둘을 함께 써 보세요. 부두 남쪽 바닷가의 깃발 줄을 달리는 겁니다. 점프 버튼으로 울타리를 뛰어넘고, 상자를 타고 올라, 붉은 깃발까지 모든 깃발을 짚으세요.",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "ferryman_odo": {
        "name": "뱃사공 오도",
        "title": "나루터지기",
        "greeting": "방금 건너오셨나요, {playerName}? 그럼 해안길을 따라 올라가세요. 새벽쉼터 야영지에서 교관 마렌이 훈련을 이끌고 있습니다. 바짝 다가가 F를 누르거나 왼쪽 클릭하면, 첫 번째 임무를 내줄 겁니다. 골짜기가 다시 부르거든 내 부두 옆에 선 종을 울리세요. 건너기가 이스트브룩 마을에 내려 줄 겁니다."
      },
      "bursar_wick": {
        "name": "경리관 윅",
        "title": "도금 금고",
