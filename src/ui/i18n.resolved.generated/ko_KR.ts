...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "controller": {
      ...
      "crossHotbarExpandHelp": "한쪽 트리거를 누른 상태에서 다른 트리거를 짧게 누르면 두 번째 세트로 전환됩니다.",
      "crossHotbarSet": "Set {set}",
      "crossHotbarSetPrimary": "첫 번째 세트",
      "crossHotbarSetExpanded": "두 번째 세트",
      ...
      "crossHotbarEditHint": "정렬 중: 확인으로 액션을 집어 다음 칸에 놓고, 취소로 칸을 비웁니다.",
