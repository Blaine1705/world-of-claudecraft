  ...
  "entities": {
    ...
    "npcs": {
      ...
      "quartermaster_finch": {
        "name": "보급관 핀치",
        "title": "야영지 물자상",
        "greeting": "빵과 물, 그리고 연습이 과했을 때를 위한 물약이죠. 동전이면 살 수 있고, 동전은 일해서 버는 것. 그게 경제의 전부예요, {playerName}. 더 복잡해지는 일은 없어요. 더 커질 뿐이지."
      },
      "ferryman_odo": {
        "name": "뱃사공 오도",
        "title": "나루터지기",
    ...
    "quests": {
      ...
      "q_ps_find_your_feet": {
        "title": "첫걸음 떼기",
        "text": "수련의 해안에 온 걸 환영해요, {playerName}. 이 섬에서는 먼저 건드리지 않는 한 무는 것이 없으니, 이 고요함을 활용하세요. 야영지를 둘러보고 얼굴들을 익혀 두세요. 보급관 핀치가 물자를 맡고, 뱃사공 오도가 돌아가는 길을 지킵니다. 두 사람을 찾아뵌 뒤 내게 돌아오세요.",
        "completion": "발도 빠르고, 주전자가 끓기도 전에 돌아왔군요. 이제 야영지를 알게 됐으니, {playerName}, 정말로 무언가 물어올 때 어디로 달려가야 할지도 아는 셈이죠.",
        "objectives": {
          "0": {
            "label": "보급관 핀치 방문"
          },
      ...
      "q_ps_strike_true": {
        "title": "정확한 일격",
        "text": "한 번도 휘둘러 본 적 없는 칼은 그저 무거운 막대기일 뿐이에요, {playerName}. 야영지 남서쪽 수련장의 허수아비들은 맞으라고 만든 것들입니다. 하나를 골라 자세를 잡고, 셋이 쓰러질 때까지 내리치세요. 허수아비는 반격하지 않아요. 이 해안 너머의 것들은 반격하죠.",
      ...
      "q_ps_tools_of_the_trade": {
        "title": "장사의 도구",
        "text": "동전은 쓰라고 있는 거예요, {playerName}. 그리고 내 좌판은 정직하죠. 내게서 치유 물약 한 병을 사면 수업료로 값보다 더 많이 돌려드릴게요. 상인을 찾고, 값을 재고, 거스름돈을 세는 것. 골짜기에 도착하면 남은 돈은 그곳 상인들의 채집 도구에 쓰세요. 지금껏 주조된 모든 재산은 딱 이만큼 작게 시작했답니다.",
        "completion": "물약 한 병, 값을 치르고 샀고, 약속한 환불도 드렸어요. 이런 거래는 앞으로 자주 못 볼 겁니다. 궂은 날을 위해 마개를 닫아 두세요, {playerName}. 그리고 골짜기 상인들은 정직한 동전을 든 사람이라면 누구에게나 곡괭이와 도끼와 낫을 판다는 걸 기억하세요.",
        "objectives": {
          "0": {
            "label": "치유 물약 구입하기"
          }
