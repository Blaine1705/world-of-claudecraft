...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "variableWarning": "$WOC 금액은 미리보기이며 고정 가격이 아닙니다. 정확한 수량은 결제 시점의 최신 견적으로 정해집니다.",
        ...
        "notInstant": "$WOC 거래는 즉시 완료되지 않습니다. 판매자가 수락하면 아이템이 에스크로로 이동하고, 결제가 확인되면 구매자에게 전달됩니다.",
        ...
        "hintAcceptLocked": "해당 아이템은 잠겨 있습니다. 판매하기 전에 가방에서 잠금을 해제하세요.",
        ...
        "p2pBindingNote": "양측이 수락하면 {duration} 안에 결제해야 합니다. 결제하지 않으면 마켓 위반이 기록됩니다.",
        "p2pBindingNoteUntimed": "양측이 수락하면 곧 결제 기한이 됩니다. 결제하지 않으면 마켓 위반이 기록됩니다.",
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC 가격이 복구될 때까지 거래가 일시 중지됩니다. 경매 카운트다운은 계속됩니다. 새 입찰과 결제는 가격이 정상화될 때까지 대기하지만, 이미 전송된 결제는 그대로 정산됩니다.",
      "walletBanner": "지갑을 연동하고 인증하면 거래소에서 입찰, 구매, 판매할 수 있습니다.",
      "rateNote": "현재 환율: 1 USD당 약 {tokens} $WOC (외부 거래 시장의 최신 체결 가격, {time} 기준).",
      "estimateNote": "현재 환율로 약 {tokens} $WOC. 최종 수량은 결제를 요청할 때 확정됩니다.",
      ...
      "detailSales": "최근 판매",
      "detailSaleRow": "{usd}: {seller}에서 {buyer}에게",
      ...
      "bidBondNote": "입찰 시 {usd} 상당의 환불 가능한 보증금($WOC)을 예치합니다. 상회 입찰이 나오면 반환되며(차순위 제안으로 당신이 구매자가 되는 경우 제외), 낙찰 후 결제하지 않은 경우에만 몰수됩니다.",
      "bidBindingNote": "보증금 거래에 서명하는 순간 입찰은 확정됩니다. 입찰은 철회할 수 없으며, 낙찰 후 결제하지 않으면 보증금이 몰수되고 계정에 마켓 위반이 기록됩니다.",
      "bidCloseNote": "마감 직전 몇 분 사이에 보증금이 확인된 입찰은 경매를 몇 분 연장할 수 있습니다. 경매가 끝난 뒤 도착한 결제는 경매를 다시 열지 않고 환불됩니다.",
      "offerNextNote": "낙찰자가 결제하지 않으면 당신이 자신의 입찰가로 구매자가 될 수 있습니다. 이때 보증금이 다시 예치되며 정산 기간 안에 결제해야 합니다. 결제하지 않으면 보증금이 몰수되고 위반이 기록됩니다.",
      "buyNowNote": "즉시 구매는 이 매물을 잠시 당신을 위해 확보합니다. 결제하지 않고 떠나면 한동안 즉시 구매가 중지됩니다.",
      ...
      "sellOfferNext": "낙찰자가 결제하지 않으면 다음 입찰자에게 아이템을 제안합니다.",
      "sellSubmit": "아이템 등록",
      "sellSubmitAria": "{item}을(를) 거래소에 등록",
      "sellFeeNote": "판매 완료 시 약 10% 수수료가 부과됩니다. 3%는 소각, 7%는 트레저리로 가며, 각각 올림으로 계산되고 판매자는 그 나머지 정확한 금액(약 90%)을 받습니다. 대금은 정산 트랜잭션으로 연동된 지갑에 바로 도착합니다.",
      "activityListings": "내 등록",
      "activityBids": "내 입찰",
      "activitySettlements": "내 정산",
      "activityEmpty": "아직 없습니다. 입찰, 등록, 정산 내역이 여기에 표시됩니다.",
      "activityPayNow": "지금 결제",
      "activityPayNowAria": "정산 {id} 지금 결제",
      "activityDeadline": "결제 기한: {duration} 남음",
      "activityStrikes": "거래소 경고 횟수: {count}",
      "activitySuspended": "미결제 정산으로 인해 입찰이 {duration} 동안 정지됩니다.",
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "paused": "가격 정보가 복구될 때까지 거래소 거래가 일시 중지됩니다. 경매 카운트다운은 계속됩니다.",
      ...
      "suspended": "미결제 정산으로 인해 거래소 입찰이 정지되었습니다.",
