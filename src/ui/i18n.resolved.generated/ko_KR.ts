...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "doneTitle": "완주",
      "doneBody": "몸 쓰는 법은 이걸로 전부입니다. 문가의 워든 탐에게 걸어 돌아가 완주를 보고하세요. 그가 건넬 말과 첫 보상이 기다립니다."
    },
    "widgets": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_the_gauntlet": {
        "title": "건틀릿 완주",
        "text": "골짜기가 인정하는 다리는 모두 이 길부터 달렸습니다, {playerName}. 첫 번째 길을 서쪽 깃발까지 걷고, 주위를 한껏 둘러본 뒤, 남쪽 길을 왼쪽으로 미끄러져 두 번째 깃발까지 가고, 다시 한 번 둘러본 다음, 마지막 길을 붉은 깃발까지 달리세요. 깃발은 순서대로 지나야 합니다. 화면 위의 카드가 그때그때 필요한 버튼을 보여 줄 거예요. 붉은 깃발을 지나면 문가의 저에게 돌아오세요.",
        "completion": "깔끔한 완주였습니다, {playerName}. 다리는 이제 길을 익혔으니, 나머지는 진짜 일을 할 차례죠. 교관 마렌이 부두 북쪽 길을 오른 새벽쉼터 야영지에서 훈련을 이끌고 있습니다. 이름이 보일 때까지 바짝 다가가 F를 누르거나 왼쪽 클릭하면, 첫 임무를 내줄 겁니다.",
        "objectives": {
          "0": {
            "label": "건틀릿 깃발 통과"
          }
