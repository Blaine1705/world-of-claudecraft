...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "death": {
      ...
      "keeperTalkBody": "그 자리에서 되살려 줄 수 있지만 대가가 따릅니다. 부활 후유증으로 모든 능력치가 75% 감소하며, 레벨이 높을수록 길게, 최대 10분간 지속됩니다. 10레벨 미만의 영웅은 후유증을 전혀 겪지 않습니다. 영혼이 쓰러진 곳으로 달려가 부활하면 아무런 대가가 없습니다.",
      "keeperTalkAccept": "부활",
      "keeperTalkLeave": "떠나기",
