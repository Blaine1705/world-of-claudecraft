...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "vcup": {
      ...
      "rolesHeading": "포지션",
      "rolesSmallBracketNote": "1대1과 2대2 등급에서는 모든 선수가 올라운더로 출전합니다. 키퍼 플레이와 관련 업적에는 3대3 이상 등급이 필요합니다.",
      "role": {
        "allrounder": {
          "name": "올라운더",
      ...
      "briefing": {
        ...
        "unratedNote": "봇이 경기장에 있어 이 경기는 등급전이 아닙니다. 전적과 업적의 서 진행도가 반영되지 않습니다.",
        "rosterHeading": "출전 명단",
        "you": "나",
        "bot": "봇",
        "ready": "준비 완료",
