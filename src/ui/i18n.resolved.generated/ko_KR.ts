...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "berserkerStance": "광폭 태세: 치명타 3% 더 자주 발생, 3% 더 강하게 적중",
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "hamstring": "대상의 다리를 베어 이동 속도를 늦춰 추격하지 못하게 합니다.",
  ...
  "entities": {
    "abilities": {
      ...
      "defensive_stance": {
        "name": "방어 태세",
        "description": "방어 전투 태세입니다. 위협 수준을 30% 더 생성하지만, 주고받는 피해가 10% 감소합니다. 전투 태세를 시전하면 공세로 돌아갑니다."
      },
      "battle_stance": {
        "name": "전투 태세",
      ...
      "enrage_passive": {
        "name": "격노",
        "description": "지속효과: 격노 상태에서 가하는 피해 11%, 공격 속도 25%, 이동 속도 10% 증가(4초). 피가르기는 30% 확률로, 붉은 수확은 항상 격노시킵니다. (분노)"
      },
      "bloodthirst": {
        "name": "사혈",
      ...
      "emboldening_roar": {
        "name": "고무의 포효",
        "description": "고무의 포효를 질러 자신과 40미터 내 아군 플레이어를 고무시킵니다. 다음 3개의 기술이 반드시 치명타로 적중합니다. (분노)"
      },
      "raised_guard": {
        "name": "방패 올리기",
        "description": "방패 뒤에 몸을 웅크립니다: 6초 동안 받는 물리 피해가 50% 감소합니다. (방어)"
      },
      "iron_resolve": {
        "name": "고통 무시",
        "description": "이를 악물고 고통을 무시합니다: 모든 분노를 소모해(최소 20) 소모한 분노 1당 4의 피해를 흡수합니다. 최대 10초 동안 지속됩니다. (방어)"
      },
      "faultline": {
        "name": "충격파",
        "description": "땅에 충격파를 일으킵니다: 전방 8미터 내의 적에게 {damage}의 피해를 주고 3초 동안 기절시킵니다. (방어)"
      },
      "defiant_bellow": {
        "name": "도전의 외침",
      ...
      "repentance": {
        "name": "참회",
        "description": "적을 최대 6초 동안 명상 상태로 만듭니다. 피해를 받으면 효과가 해제됩니다. (징벌 전문화 상징)"
      },
      "bestial_wrath": {
        "name": "야수의 격노",
      ...
      "shamanistic_rage": {
        "name": "주술의 분노",
        "description": "주술의 분노를 방출하여 마나 160를 회복합니다. (고양 전문화 상징)"
      },
      "natures_swiftness": {
        "name": "자연의 신속함",
        "description": "자연을 불러 다음 주문을 즉시 시전하게 합니다. (복원 전문화 상징)"
      },
      "siphon_life": {
        "name": "생명력 착취",
      ...
      "fel_domination": {
        "name": "악마 지배",
        "description": "지옥의 기운을 지배하여 다음 주문을 즉시 시전하게 합니다. (악마 전문화 상징)"
      },
      "conflagrate": {
        "name": "점화",
      ...
      "storm_bolt": {
        "name": "폭풍망치",
        "description": "무기를 던져 대상에게 {damage}의 피해를 입히고 3초 동안 기절시킵니다."
      },
      "piercing_howl": {
        "name": "날카로운 고함",
        "description": "날카로운 고함을 질러 15미터 내 모든 적의 이동 속도를 8초 동안 50% 감소시킵니다."
      },
      "die_by_sword": {
        "name": "투사의 혼",
      ...
      "recklessness": {
        "name": "무모한 희생",
        "description": "격노: 12초 동안 분노 생성량이 50%, 치명타 확률이 20% 증가합니다."
      },
      "avatar": {
        "name": "화신",
        "description": "20초 동안 거인으로 변신하여 자신에게 걸린 모든 제어 효과를 해제하고 입히는 피해가 20% 증가합니다."
      },
      "sanguine_aura": {
        "name": "핏빛 오라",
        "description": "적의 피로 무기를 물들입니다. 자신과 근접 아군의 공격 속도가 10%, 피해가 10% 증가합니다. 20초 동안 지속됩니다."
      },
      "victory_rush": {
        "name": "연전연승",
        "description": "무기 피해에 {damage}를 더한 피해를 입히고 최대 생명력의 20%를 회복합니다. 적 처치 후 20초 이내에만 사용할 수 있습니다."
      },
      "bladestorm": {
        "name": "칼날폭풍",
        "description": "강철 회오리가 되어 4초 동안 매초 8미터 내 모든 적에게 {damage}의 피해를 입힙니다."
      },
      "intimidating_shout": {
        "name": "위협의 외침",
        "description": "공포스러운 외침으로 8미터 내 최대 5명의 적을 8초 동안 공포에 질려 도망치게 합니다. 피해를 입으면 효과가 풀릴 수 있습니다."
      },
      "pummel": {
        "name": "자루 공격",
        "description": "시전을 방해하고 해당 계열 주문을 4초 동안 시전할 수 없게 합니다. 시전을 끊으면 분노 10을 생성합니다."
      },
      "heroic_leap": {
        "name": "영웅의 도약",
        "description": "목표 지점으로 도약하여 주위 적에게 {damage}의 피해를 입힙니다."
      },
      "rallying_cry": {
        "name": "재집결의 함성",
