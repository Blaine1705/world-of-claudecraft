...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "stats": {
      ...
      "warfareBodyPets": "워페어는 플레이어끼리의 싸움에서만 셈해지는 유일한 능력치입니다. 당신과 소환수가 다른 플레이어와 그 소환수에게 주는 피해를 올리고, 그들에게서 받는 피해를 낮추며, 캐릭터 정보에는 두 값이 한 줄에 함께 표시됩니다. 야생 생명체를 상대로는 아무 일도 하지 않습니다. 명예로 사는 워페어 장비에서 나오므로, 레벨을 올리는 동안 좇을 것이 아니라 PvP를 즐긴 대가로 주어지는 보상입니다."
    },
    "progression": {
