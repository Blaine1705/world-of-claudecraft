  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "방랑자 브린",
        "title": "항구 안내인",
        "greeting": "이스트브룩 골짜기는 오는 사람을 가리지 않아요, 친구. 그리고 아직 발걸음이 불안한 이들에게는 언제나 수련의 해안이 있죠. 동쪽 바닷가의 나룻배 마법진은 일 년 내내 양방향으로 통한답니다."
      },
      "instructor_maren": {
        "name": "교관 마렌",
        "title": "수련 사범",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "정확한 일격",
        "text": "한 번도 휘둘러 본 적 없는 칼은 그저 무거운 막대기일 뿐이에요, {playerName}. 야영지 남쪽 수련장의 허수아비들은 맞으라고 만든 것들입니다. 하나를 골라 자세를 잡고, 셋이 쓰러질 때까지 내리치세요. 허수아비는 반격하지 않아요. 이 해안 너머의 것들은 반격하죠.",
