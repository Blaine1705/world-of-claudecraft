...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hostDiag": {
      "title": "시스템 보고서",
      "intro": "이 컴퓨터에서 게임이 원활하게 실행되지 않는다면 시스템 보고서를 만들어 지원팀에 보내 주세요. 보고서에는 이 컴퓨터의 사양과 게임 설정이 담겨 있어, 프레임 속도를 떨어뜨리는 원인을 파악하는 데 도움이 됩니다.",
      "containsTitle": "보고서에 포함되는 내용",
      "containsHardware": "하드웨어 및 드라이버: 컴퓨터 제조사와 모델, 프로세서, 메모리, 그래픽 카드, 남은 디스크 공간.",
      "containsWindows": "Windows 버전, 전원 및 배터리 상태, 그래픽 설정.",
      "containsNvidia": "NVIDIA 제어판 설정(해당 소프트웨어가 설치된 경우).",
      "containsDisplays": "디스플레이 구성: 화면 수, 해상도, 주사율.",
      "containsPrograms": "프로세서와 메모리를 가장 많이 사용하는 프로그램의 이름.",
      "containsBrowsers": "설치된 웹 브라우저와 그 버전, 하드웨어 가속 사용 여부.",
      "containsGame": "게임 및 런처 버전, 현재 그래픽 설정과 지역, 그리고 이 보고서를 게임이 이미 전송하는 성능 데이터와 연결해 주는 세션 코드.",
      "privacy": "파일, 사용자 이름, 계정 정보는 포함되지 않습니다. 컴퓨터 이름도 포함되지 않으며, 무작위 코드로 대체됩니다. 자동으로 전송되는 것은 없습니다. 보고서는 컴퓨터에 저장되는 파일이며, 누구에게 보낼지는 직접 결정합니다.",
      "create": "보고서 만들기",
      "running": "시스템 정보를 수집하는 중... 몇 초 정도 걸립니다.",
      "saved": "보고서가 {fileName}(으)로 저장되었습니다.",
      "savedNoName": "보고서가 저장되었습니다.",
      "detailPartial": "일부 정보를 수집하지 못했습니다. 그래도 보고서는 유용합니다.",
      "detailUnavailable": "Windows 시스템 검사 도구가 없거나 변경되어 기본 정보만 포함되었습니다. 게임을 다시 설치하면 복구됩니다.",
      "detailNativeError": "Windows 시스템 검사를 실행할 수 없어 기본 정보만 포함되었습니다.",
      "busy": "이미 보고서를 만드는 중입니다.",
      "failed": "보고서를 만들지 못했습니다. 다시 시도해 주세요.",
      "sendHint": "저장된 파일을 Discord에서 지원팀에 보내거나 지원 요청에 첨부해 주세요."
    },
    "paperdoll": {
