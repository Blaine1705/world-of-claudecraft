  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "방랑자 브린",
        "title": "항구 안내인",
        "greeting": "이스트브룩 골짜기는 오는 사람을 가리지 않아요, 친구. 그리고 아직 발걸음이 불안한 이들에게는 언제나 수련의 해안이 있죠. 서쪽 바닷가의 나룻배 마법진은 일 년 내내 양방향으로 통한답니다."
      },
      "instructor_maren": {
        "name": "교관 마렌",
        "title": "수련 사범",
      ...
      "ferryman_odo": {
        "name": "뱃사공 오도",
        "title": "나루터지기",
        "greeting": "해협은 잔잔하고 배는 튼튼해요, {playerName}. 골짜기로 갈 준비가 되면, 부두 끝의 건너기 마법진이 언제든 데려다줄 겁니다."
      },
      "bursar_wick": {
        "name": "경리관 윅",
        "title": "도금 금고",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "주머니와 돈주머니",
        "text": "지금 지고 있는 짐 얘기를 해 보죠, {playerName}. 배낭에는 열여섯 칸이 있고, 그 옆에 빈 가방 고리 넷이 기다립니다. 가방을 하나 채울 때마다 그 공간이 전체 용량에 더해져요. 들고 다닐 수 없는 것은 도금 금고가 맡습니다. 어느 마을의 어느 경리관이든 같은 금고를 열어 주고, 돈주머니가 두둑해지면 금고 칸도 더 살 수 있죠. 자, 습관을 들이는 연습입니다. 보급관 핀치에게서 아마천 주머니를 사서 채워 보세요.",
        "completion": "좋은 주머니군요. 말썽거리를 담을 칸이 여섯 늘었네요. 값진 것은 금고에, 가방에는 여유를, {playerName}. 어떤 늑대보다도 꽉 찬 배낭이 끝장낸 모험이 더 많답니다.",
        "objectives": {
          "0": {
            "label": "아마천 주머니 구입하기"
          }
      ...
      "q_ps_set_sail": {
        ...
        "completion": "마렌이 그렇게 말했다고요? 내게 일주일 내내 밧줄 매듭 연습을 시킨 사람의 입에서 나온 말치고는 대단한 칭찬이군요. 부두 끝의 마법진에 걸어 들어가면 언제든 골짜기로 데려다줍니다, {playerName}. 늑대를 조심하세요.",
        "objectives": {
          "0": {
            "label": "뱃사공 오도에게 보고"
          }
