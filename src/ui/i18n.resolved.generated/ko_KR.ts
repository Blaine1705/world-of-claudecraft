...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "처음 보는 얼굴이군요, 친구. 이 길이 처음이라면, 세상의 시련에 맞서기 전에 실력을 갈고닦고 이곳에 익숙해질 수 있는 곳이 있어요. 해협 건너의 조용한 섬, 수련의 해안이죠. 나룻배는 양방향으로 다니고, 가든 안 가든 누구도 당신을 얕보지 않을 거예요.",
  ...
  "guide": {
    ...
    "glossary": {
      ...
      "fiveSecondDef": "마나는 마지막으로 마나를 쓴 뒤 5초가 지나야 비로소 저절로 차오르기 시작합니다. 시전자들이 주문을 쉼 없이 쏟아붓는 대신 호흡을 조절하는 이유가 바로 이것입니다.",
      "talentRowTerm": "특성 단계",
    ...
    "talentsPage": {
      ...
      "loadoutNote": "하나의 구성으로 정착할 필요는 없습니다. 패널에서 이름을 붙여 배치를 저장하면 특성 선택과 행동 단축바까지 함께 기억하므로, 다른 구성으로 갈아타는 일은 클릭 한 번이면 끝납니다. 초기화와 같은 규칙이 적용되어, 전투 중이 아니어야 하고 투기장 경기나 전장 안이어서도 안 됩니다."
    },
    "arenaPage": {
      "heading": "투기장과 PvP",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "방랑자 브린",
        "title": "항구 안내인",
        "greeting": "이스트브룩 골짜기는 오는 사람을 가리지 않아요, 친구. 그리고 아직 발걸음이 불안한 이들에게는 언제나 수련의 해안이 있죠. 서쪽 바닷가의 나룻배 종은 일 년 내내 양쪽으로 울린답니다."
      },
      "instructor_maren": {
        "name": "교관 마렌",
        "title": "수련 사범",
      ...
      "ferryman_odo": {
        "name": "뱃사공 오도",
        "title": "나루터지기",
        "greeting": "방금 건너오셨나요, {playerName}? 그럼 해안길을 따라 올라가세요. 새벽쉼터 야영지에서 교관 마렌이 훈련을 이끌고 있는데, 무엇보다 먼저 당신과 이야기하고 싶어 할 겁니다. 골짜기가 다시 부르거든 부두 끝의 종을 울리세요. 건너기가 이스트브룩 마을에 내려 줄 겁니다."
      },
      "bursar_wick": {
        "name": "경리관 윅",
        "title": "도금 금고",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "정확한 일격",
        "text": "수련의 해안에 온 걸 환영해요, {playerName}. 이곳의 모든 가르침은 같은 것에서 시작합니다. 발을 딛고, 칼자루를 쥐는 것. 야영지 남서쪽 수련장의 허수아비들은 맞으라고 만든 것들입니다. 하나를 골라 자세를 잡고, 셋이 쓰러질 때까지 내리치세요. 허수아비는 반격하지 않아요. 이 해안 너머의 것들은 반격하죠.",
        "completion": "셋을 쓰러뜨렸고, 손아귀도 벌써 단단해졌네요. 그 감각을 기억하세요, {playerName}. 발을 딛고, 시선을 들고, 온몸으로 휘두르기. 골짜기의 늑대는 짚보다 빠르지만, 같은 산수에 쓰러진답니다.",
        "objectives": {
          "0": {
      ...
      "q_ps_the_wreck_line": {
        "title": "난파선 해안",
        "text": "조수는 이 섬에 표류물로 값을 치릅니다. 옛 난파선의 표류 상자들이 골짜기를 마주한 바닷가로 밀려오죠. 상자를 뒤지는 게들은 보기보다 세게 꼬집으니 발밑을 조심하세요. 상자 셋을 열어 바다가 남긴 것을 가져와요.",
        "completion": "밧줄과 타르, 그리고 바다가 어쩐 일로 남겨 준 치즈 반 덩이. 세상은 허리를 굽힐 가치가 있는 것들로 가득해요, {playerName}. 이 습관을 지키세요. 보고, 열고, 갖기.",
        "objectives": {
          "0": {
            "label": "표류 상자 열기"
          }
      ...
      "q_ps_a_path_of_your_own": {
        "title": "나만의 길",
        "text": "칼을 휘두르는 것과 왜 휘두르는지 아는 것은 별개예요, {playerName}. 5레벨이 되면 세상은 당신에게 전문화를 고르라 할 겁니다. 당신의 소명에 놓인 세 갈래 길 중 하나, 저마다의 강점이 있죠. 그때부터는 몇 레벨마다 특성 한 줄이 열리고, 셋 중 하나를 고릅니다. 허수아비 둘을 더 쓰러뜨리면서, 짚이 흩날리는 동안 어느 길을 걸을지 생각해 보세요.",
        "completion": "둘을 더 쓰러뜨렸고, 휘두름 뒤에 전보다 단단한 것이 생겼네요. 무엇보다 이것만은 기억하세요, {playerName}. 당신의 어떤 선택도 감옥이 아닙니다. 특성 창은 언제든 열 수 있고, 5레벨에 선택한 뒤에도 안전한 곳에 서 있기만 하면 특성과 전문화 모두 비용 없이 언제든 초기화하고 다시 고를 수 있어요. 담대하게 고르고, 더 배우면 다시 고르세요.",
        "objectives": {
          "0": {
            "label": "훈련용 허수아비 쓰러뜨리기"
          }
      ...
      "q_ps_the_wheel_of_trades": {
        "title": "생업의 바퀴",
        "text": "칼은 한 끼를 먹여 주지만, {playerName}, 생업은 평생을 먹여 줍니다. 모험가라면 누구나 칼 곁에 전문 기술을 둡니다. 채광, 벌목, 약초 채집, 낚시, 그리고 그 모두를 값어치로 바꾸는 제작 기술이죠. 보급관 핀치는 내가 치른 훈련보다 많은 좌판을 꾸려 왔어요. 가서 생업이 어떻게 세워지는지 물어보세요.",
        "completion": "마렌이 드디어 말 걸 만한 학생을 보냈군요. 한 번만 말할 테니 잘 들어요, {playerName}. 채집은 도구에서 시작합니다. 곡괭이, 도끼, 낫, 낚싯대, 전부 골짜기 상인들이 팔죠. 당신의 기술은 바퀴를 이룹니다. 좋아하는 것을 갈고닦다가 인접한 한 쌍에 조율하면 그 둘은 상한 없는 주 전공이 되고, 바퀴 건너편 하나는 취미로 남고, 나머지는 다시 잡을 때까지 잠듭니다. 배운 것은 결코 사라지지 않고, 준비가 되면 마을의 장인들이 조율을 권해 올 거예요.",
        "objectives": {
          "0": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "주머니와 돈주머니",
        "text": "골짜기로 떠나기 전 마지막 가르침이에요, {playerName}. 모험가의 목숨을 지켜 주는 가르침이죠. 바로 당신이 지고 다니는 짐 얘기입니다. 배낭에는 열여섯 칸이 있고, 그 옆에 빈 가방 고리 넷이 기다립니다. 가방을 하나 채울 때마다 그 공간이 전체 용량에 더해져요. 보급관 핀치에게서 아마천 주머니를 사서 채운 다음, 이 가르침을 금고 책상의 경리관 윅에게 가져가세요. 그가 맡아 주는 것은 어떤 가방에도 담기지 않는 나머지 절반이니까요.",
        "completion": "마렌이 드디어 학생을 보냈군요. 주머니는 당신 것이고, 가르침의 나머지 절반은 이렇습니다, {playerName}. 들고 다닐 수 없는 것은 도금 금고가 맡습니다. 어느 마을의 어느 경리관이든 같은 금고를 열어 주고, 돈주머니가 두둑해지면 금고 칸도 더 살 수 있죠. 값진 것은 금고에, 가방에는 여유를. 어떤 늑대보다도 꽉 찬 배낭이 끝장낸 모험이 더 많답니다.",
        "objectives": {
          "0": {
            "label": "아마천 주머니 구입하기"
          }
      ...
      "q_ps_set_sail": {
        "title": "출항",
        "text": "이 해안에는 당신이 쓰러뜨리지 않았거나, 열지 않았거나, 사지 않은 것이 하나도 남지 않았어요, {playerName}. 준비는 끝났고, 이스트브룩에는 진짜 일이 기다립니다. 낡은 부두로 내려가 뱃사공 오도에게 전하세요. 내가 당신이 건너갈 자격을 얻었다 했다고요.",
        "completion": "마렌이 그렇게 말했다고요? 내게 일주일 내내 밧줄 매듭 연습을 시킨 사람의 입에서 나온 말치고는 대단한 칭찬이군요. 준비가 되면 부두 끝의 종을 울리세요, {playerName}. 건너기가 이스트브룩 마을 한복판에 내려 줄 겁니다. 늑대를 조심하세요.",
        "objectives": {
          "0": {
            "label": "뱃사공 오도에게 보고"
          }
