...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "interfacePage": {
      ...
      "winTalentsBody": "특성 나무와 쓸 수 있는 특성 점수, 그리고 각 줄이 단계마다 무엇을 해 주는지가 담깁니다.",
    ...
    "commandsPage": {
      ...
      "talents": "자신의 전문화와, 특성 점수가 직업 트리와 전문화 트리에 어떻게 나뉘어 있는지 보여 줍니다.",
    ...
    "classPage": {
      ...
      "formLine": {
        "form_bear": "방어를 맡는 형태입니다. 두꺼운 가죽을 두르고, 마나 대신 분노를 쓰며, 위협 수준을 더 쌓아 적이 계속 당신에게 달려들게 합니다.",
    ...
    "riftsPage": {
      ...
      "floorsBody": "균열은 몇 개 층으로 이어지며 각 층은 새로 지어집니다. 그리고 그 층이 당신을 놓아줄 때까지 아래로 향하는 길은 열리지 않습니다. 살아 있는 것을 정리하고, 길을 가로막은 장치를 풀어내면 비로소 하강로가 찢겨 열립니다. 마지막 층은 우두머리로 끝납니다. 층마다 저마다의 성격이 있어 한 번의 공략이 당신을 서리 속에서 잉걸불 속으로 데려가기도 하며, 새 층에 들어설 때마다 채팅에 그 이름이 뜹니다. 이번 균열이 몇 층짜리인지는 화면의 추적기에서 알 수 있습니다. 어떤 균열은 대신 손으로 빚은 특별한 무대를 엽니다. Infernal Citadel이라 불리는 곳으로, 생성된 하강로가 아니라 정해진 길이대로 진행됩니다.",
