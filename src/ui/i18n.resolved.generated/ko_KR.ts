...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "방금 건너오셨나요? 수련의 해안에 온 것을 환영합니다. W, A, S, D로 걷고, 마우스 오른쪽 버튼을 누른 채로 시점을 돌리세요. 제 뒤 길을 따라 새벽쉼터 야영지에서 교관 마렌이 훈련을 이끌고 있어요. 이름이 보일 때까지 바짝 다가가 F를 누르거나 왼쪽 클릭하면 이야기할 수 있고, 첫 번째 임무를 내줄 겁니다. 그리고 떠날 준비가 되면 제 부두 옆에 선 종을 울리세요. 건너기가 이스트브룩의 집으로 데려다줄 겁니다.",
      "noteClose": "알겠어요"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_the_wreck_line": {
        "title": "난파선 해안",
        "text": "조수는 이 섬에 표류물로 값을 치릅니다. 옛 난파선의 표류 상자들이 야영지 남동쪽, 골짜기를 마주한 바닷가로 밀려오죠. 여는 건 간단해요, {playerName}. 상자 이름이 보일 때까지 바짝 다가가 F를 누르거나 상자를 왼쪽 클릭하면, 품고 있던 것을 내어 줍니다. 셋이면 충분합니다. 표류물을 뒤지는 게들은 보기보다 세게 꼬집으니 발밑을 조심하고, 이것만은 기억하세요. 앞으로 만날 모든 상자와 채집물과 문은 전부 같은 F 하나로 엽니다.",
