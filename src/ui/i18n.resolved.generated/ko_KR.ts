...
export const ko_KR: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "ice_block": {
        "name": "차가운 관",
        "description": "8초 동안 단단한 얼음 속에 자신을 가두어 모든 피해에 면역이 됩니다. 일반적인 해로운 효과를 제거하고 새로운 효과가 적용되는 것을 방지합니다. 일부 전투 효과는 제거하거나 방지할 수 없습니다. 기절 또는 변이 상태에서도 사용할 수 있습니다. 갇힌 동안에는 행동할 수 없습니다. 다시 사용하면 취소됩니다. (마법사)"
      },
      "inner_focus": {
        "name": "고요한 마음",
