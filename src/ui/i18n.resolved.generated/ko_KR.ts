...
export const ko_KR: EnTranslations = {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "정확한 일격",
        "text": "수련의 해안에 온 걸 환영해요, {playerName}. 이곳의 모든 가르침은 같은 것에서 시작합니다. 발을 딛고, 칼자루를 쥐는 것. W, A, S, D로 걷고, 마우스 오른쪽 버튼을 누른 채 시점을 돌리세요. 야영지 남서쪽 수련장의 허수아비들은 맞으라고 만든 것들입니다. 하나에게 다가가 Tab을 누르거나 왼쪽 클릭하면 대상으로 잡힙니다. 그런 다음 1을 누르거나, 화면 아래쪽 행동 단축바의 첫 번째 아이콘을 클릭해 내리치세요. 셋이 쓰러질 때까지 계속 내리치세요. 허수아비의 반격은 따끔한 정도죠. 이 해안 너머의 것들은 훨씬 세게 때린답니다.",
