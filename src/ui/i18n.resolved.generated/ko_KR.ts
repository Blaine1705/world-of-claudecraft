...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "temporalEcho": "시전자의 비전 피해가 단일 대상 피해의 {singlePct}%, 광역 피해의 {areaPct}%만큼 당신을 치유합니다. 에테르 쇄도와 에테르 화살은 개별 시간의 메아리에 4배 보너스를 적용합니다. 그룹 메아리는 같은 양의 치유 비축분을 생성하고, 생명력이 60% 미만인 징표 대상 아군에게 잃은 생명력에 따라 나누어 줍니다",
  ...
  "entities": {
    "abilities": {
      ...
      "temporal_echo": {
        "name": "시간의 메아리",
        "description": "더 건강했던 순간의 메아리로 아군에게 표식을 남겨 즉시 생명력을 {damage} 회복시킵니다. {duration}초 동안 다른 단일 대상 비전 피해의 {echoSinglePct}%와 광역 비전 피해의 {echoAreaPct}%가 그 아군을 치유합니다. 에테르 쇄도와 에테르 화살은 대신 자신이 입힌 피해의 {echoDriverPct}%만큼 그 아군을 치유합니다."
      },
      "temporal_cascade": {
        "name": "시간의 연쇄",
        "description": "시간의 메아리를 파티에 연쇄시켜 대상과 가장 가까운 아군 최대 네 명을 즉시 치유하고 각각에게 {duration}초 동안 징표를 남깁니다. 자신이 입힌 비전 피해의 일부가 메아리를 타고 돌아와 징표가 있는 아군을 치유합니다. 에테르 쇄도와 에테르 화살은 각 그룹 메아리에서 같은 양의 치유 비축분을 생성하고, 생명력이 60% 미만인 징표 대상 아군에게 잃은 생명력에 따라 나누어 줍니다. (시간술)"
      },
      "temporal_reversal": {
        "name": "시간 역전",
    ...
    "itemSets": {
      ...
      "chronoweave": {
        "name": "에테르직조 예복",
        "bonus2": "시간의 메아리가 다른 단일 대상 비전 피해의 50%를 치유로 전환합니다. 에테르 쇄도와 에테르 화살은 대신 자신이 입힌 피해의 200%를 치유로 전환합니다. 피해를 입어도 주문 시전이 더 이상 지연되지 않습니다.",
        "bonus4": "시간의 연쇄의 재사용 대기시간이 5초 감소하고 마나 소모량이 30% 감소합니다."
      },
      "cinderbark": {
        "name": "잿불나무껍질 수호구",
