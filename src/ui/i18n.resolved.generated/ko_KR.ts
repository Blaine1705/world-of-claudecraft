...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "variableWarning": "$WOC 금액은 미리 보기이며 고정 가격이 아닙니다. 정확한 수량은 구매자가 결제할 때 새 견적으로 정해집니다.",
        "feeLine": "거래소 수수료 {fee}",
        "netLine": "받는 금액 {net}",
        "sendOffer": "$WOC 제안",
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC 가격이 복구될 때까지 거래가 일시 중지됩니다. 경매 카운트다운은 계속되며, 가격이 정상화될 때까지 어떤 판매도 성사되지 않습니다.",
      "walletBanner": "지갑을 연동하고 인증하면 거래소에서 입찰, 구매, 판매할 수 있습니다.",
      "rateNote": "현재 환율: 1 USD당 약 {tokens} $WOC ({time} 기준).",
      ...
      "bidBondConfirming": "보증금을 보냈습니다. 네트워크에서 확인 중이며, 완료되면 입찰이 등록됩니다.",
      ...
      "sellFeeNote": "판매 완료 시 10% 수수료가 부과됩니다. 90%는 판매자에게, 3%는 소각, 7%는 트레저리로 갑니다. 대금은 정산 트랜잭션으로 연동된 지갑에 바로 도착합니다.",
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "terms_required": "계속하려면 거래소 정산 약관에 동의하세요.",
      ...
      "sale_conflict": "이 등록에는 이미 다른 유효한 판매 기록이 있습니다.",
