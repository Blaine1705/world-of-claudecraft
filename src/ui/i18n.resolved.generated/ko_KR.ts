...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "worldPvp": {
      ...
      "groupLine": "파티, 공격대, 길드원끼리는 절대 적대하지 않습니다.",
    ...
    "hill": {
      ...
      "moves": "{minutes} 후 이동합니다",
      "honorNote": "원 안에 있는 점령 측 구성원마다 매분 명예 {honor}, 동시에 최대 {max}명까지"
    },
    "warfareShop": {
  ...
  "guide": {
    ...
    "worldPvpPage": {
      ...
      "introZones": "열린 세계의 플레이어 간 전투는 선택 사항이며, 그 의미는 지금 서 있는 땅이 정합니다. PvP 깃발을 올리면 파티, 공격대, 길드에 속하지 않은 깃발을 올린 모든 플레이어가 분쟁 지역에서 적이 되고, 깃발을 내리면 잠시 후 다시 구경꾼이 됩니다. 두 지역은 월드 전투가 전혀 일어나지 않는 성역이고, 만렙 지역 가운데 셋은 깃발과 상관없이 그곳의 모두가 공격 대상인 자유 전투 지역입니다. 파티, 공격대, 길드원은 어디서든 서로의 적이 되지 않습니다.",
