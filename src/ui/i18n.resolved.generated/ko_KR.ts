...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "frameRateCapNote": "게임이 초당 그리는 이미지 수를 제한합니다. 디스플레이 속도를 따라가지 못하는 컴퓨터에서는 제한을 낮추면 화면이 더 안정되고 컴퓨터 발열도 줄어듭니다. 제한은 디스플레이에 맞춰지므로 실제 값은 숫자와 조금 다를 수 있습니다. 디스플레이: 제한 없음. 자동: 현재는 디스플레이와 같습니다.",
