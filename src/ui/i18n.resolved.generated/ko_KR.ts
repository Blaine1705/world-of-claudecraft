...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "coachNextBody": "화살표를 따라 {npc}에게 가세요. 이름이 보일 때까지 다가가 {interactKey}를 누르거나 왼쪽 클릭해 다음 임무를 받으세요.",
      "coachNextBodyTouch": "화살표를 따라 {npc}에게 가세요. 이름이 보일 때까지 다가가 상대를 탭하거나 사용 버튼을 탭해 다음 임무를 받으세요.",
      "coachNextBodyPad": "화살표를 따라 {npc}에게 가세요. 이름이 보일 때까지 다가가 상호작용 버튼을 눌러 다음 임무를 받으세요.",
      "coachTaskBody": "화살표를 따라 임무 장소로 가세요. 오른쪽 추적창이 진행을 세어 주고, 길을 잃으면 {mapKey}로 지도를 열 수 있습니다.",
      "coachTaskBodyTouch": "화살표를 따라 임무 장소로 가세요. 오른쪽 추적창이 진행을 세어 주고, 길을 잃으면 지도 버튼이 길을 보여 줍니다.",
      "coachTaskBodyPad": "화살표를 따라 임무 장소로 가세요. 오른쪽 추적창이 진행을 세어 주고, 길을 잃으면 지도 버튼이 길을 보여 줍니다.",
    ...
    "noticeboard": {
      ...
      "listingsBanner": "게시판에 붙은 공고가 {count}건 있습니다.",
