...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "qtyRowAria": "제작 수량",
      "qtyDecreaseAria": "제작 수량 줄이기",
      "qtyIncreaseAria": "제작 수량 늘리기",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "econ": {
        ...
        "castPaceBody": "전문 기술 행동은 실제 시전 시간이 걸립니다. 간단한 야외 제작법은 약 1.5초, 상위 사다리 제작법은 몇 초, 마력 추출·마법부여·분해·도구 효과 충전은 각각 짧은 고정 시전입니다. 시전 중 취소해도 재료를 잃지 않습니다. 성공한 제작마다 아이템 예산에 비례한 구리 수수료도 지불합니다. 재료, 작업대, 숙련도 상한과 함께 이 속도는 별도의 행동 한도 없이도 시장을 건전하게 유지합니다.",
