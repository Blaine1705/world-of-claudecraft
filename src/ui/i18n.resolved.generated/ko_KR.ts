...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "방금 건너오셨나요? 수련의 해안에 온 것을 환영합니다. 바로 앞 바닷가에서 워든 탐이 건틀릿을 지키고 있어요. 먼저 그를 찾아가면, 그의 길이 몸 쓰는 법을 전부 가르쳐 줄 겁니다. 붉은 깃발을 지나고 나면, 부두 북쪽 길을 오른 새벽쉼터 야영지에서 교관 마렌이 첫 임무를 줄 거예요. 이름이 보일 때까지 바짝 다가가 F를 누르거나 왼쪽 클릭하면 이야기할 수 있습니다. 그리고 떠날 준비가 되면 제 부두 옆에 선 종을 울리세요. 건너기가 이스트브룩의 집으로 데려다줄 겁니다.",
      "noteClose": "알겠어요"
    },
    "tutorial": {
    ...
    "bootcamp": {
      ...
      "forwardBody": "앞에 보이는 건틀릿 문으로 들어가, {forwardKey}를 누른 채 첫 번째 길을 따라 서쪽 깃발까지 걸어가세요.",
      "forwardBodyTouch": "앞에 보이는 건틀릿 문으로 들어가, 이동 스틱을 위로 민 채 첫 번째 길을 따라 서쪽 깃발까지 걸어가세요.",
      "forwardBodyPad": "앞에 보이는 건틀릿 문으로 들어가, 왼쪽 스틱을 위로 민 채 첫 번째 길을 따라 서쪽 깃발까지 걸어가세요.",
      "cameraTitle": "시점 돌리기",
      "cameraBody": "깃발 하나 통과. 이제 마우스 오른쪽 버튼을 누른 채 드래그해 시점을 돌려 보세요. 남쪽으로 뻗은 울타리 길을 내려다본 뒤, 원래 향하던 쪽으로 돌아오세요.",
      "cameraBodyTouch": "깃발 하나 통과. 이제 (이동 스틱이 아니라) 세상 화면을 손가락으로 드래그해 시점을 돌려 보세요. 남쪽으로 뻗은 울타리 길을 내려다보세요.",
      "cameraBodyPad": "깃발 하나 통과. 이제 오른쪽 스틱을 밀어 시점을 돌려 보세요. 남쪽으로 뻗은 울타리 길을 내려다보세요.",
      "leftTitle": "왼쪽으로 미끄러지기",
      "leftBody": "향한 방향은 그대로 두고, {strafeKey}를 누른 채 남쪽 길을 따라 왼쪽으로 게걸음해 깃발까지 가세요. 옆걸음은 시선을 표적에 둔 채 움직이게 해 줍니다. 언젠가 전투에서 이렇게 움직이게 될 거예요.",
      "leftBodyTouch": "이동 스틱을 왼쪽으로 밀어 남쪽 길을 따라 옆걸음으로 깃발까지 가세요.",
      "leftBodyPad": "왼쪽 스틱을 왼쪽으로 밀어 남쪽 길을 따라 옆걸음으로 깃발까지 가세요.",
      "camera2Title": "다시 둘러보기",
      "camera2Body": "깃발 둘 통과. 오른쪽 버튼을 누른 채 한 번 더 시점을 돌려, 서쪽으로 뻗은 마지막 길에 몸을 맞추세요.",
      "camera2BodyTouch": "깃발 둘 통과. 한 번 더 손가락으로 드래그해, 서쪽으로 뻗은 마지막 길에 몸을 맞추세요.",
      "camera2BodyPad": "깃발 둘 통과. 오른쪽 스틱을 한 번 더 밀어, 서쪽으로 뻗은 마지막 길에 몸을 맞추세요.",
      "forward2Title": "끝까지 달리기",
      "forward2Body": "다시 {forwardKey}를 누른 채 마지막 길을 붉은 깃발까지 달리세요.",
      "forward2BodyTouch": "다시 이동 스틱을 위로 밀어 마지막 길을 붉은 깃발까지 달리세요.",
      "forward2BodyPad": "다시 왼쪽 스틱을 위로 밀어 마지막 길을 붉은 깃발까지 달리세요.",
      "courseProgress": "깃발 {current} / {total}",
      "doneTitle": "훈련 준비 완료",
      "doneBody": "몸 쓰는 법은 이걸로 전부입니다. 부두에서 길을 오르면 새벽쉼터 야영지에서 교관 마렌이 훈련을 이끌고 있어요. 첫 임무가 당신을 기다립니다."
    },
    "widgets": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "warden_tam": {
        "name": "워든 탐",
        "title": "건틀릿의 파수꾼",
        "greeting": "이 길들이 건틀릿입니다, {playerName}. 골짜기가 인정하는 모험가는 모두 여길 달렸죠. 첫 번째 길을 서쪽 깃발까지 걷고, 주위를 한껏 둘러본 뒤, 두 번째 길을 왼쪽으로 미끄러져 내려가고, 다시 한 번 둘러본 다음, 마지막 길을 붉은 깃발까지 달리세요. 화톳불은 밤새 꺼지지 않습니다. 붉은 깃발을 지나고 나면, 새벽쉼터 야영지의 교관 마렌이 첫 임무를 줄 겁니다."
      },
      "tidewatcher_ondrel": {
        "name": "온드렐 베인",
        "title": "조수지기",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "정확한 일격",
        "text": "수련의 해안에 온 걸 환영해요, {playerName}. 이곳의 모든 가르침은 같은 것에서 시작합니다. 발을 딛고, 칼자루를 쥐는 것. 야영지 남서쪽 수련장의 허수아비들은 맞으라고 만든 것들입니다. 수련장을 못 찾겠거든 M을 눌러 지도를 여세요. 맡은 임무는 모두 지도에 표시되니 헤맬 일이 없습니다. 허수아비 하나에게 다가가 Tab을 누르거나 왼쪽 클릭하면 대상으로 잡히고, 그런 다음 1을 누르거나 화면 아래쪽 행동 단축바의 첫 번째 아이콘을 클릭해 내리치세요. 셋이 쓰러질 때까지 계속 내리치세요. 허수아비의 반격은 따끔한 정도지만, 이 해안 너머의 것들은 훨씬 세게 때린답니다. 셋째가 쓰러지면 내게 돌아와 F를 눌러 임무를 마치고 보상을 받으세요. 이 세상 모든 의뢰가 그렇게 끝난답니다.",
        "completion": "셋을 쓰러뜨렸고, 손아귀도 벌써 단단해졌네요. 그 감각을 기억하세요, {playerName}. 대상을 잡고, 내리치고, 계속 내리치기. 골짜기의 늑대는 짚보다 빠르지만, 같은 산수에 쓰러진답니다.",
        "objectives": {
          "0": {
      ...
      "q_ps_the_wreck_line": {
        "title": "난파선 해안",
        "text": "조수는 이 섬에 표류물로 값을 치릅니다. 옛 난파선의 표류 상자들이 연습장 너머 먼 바닷가로 밀려오죠. 허수아비들을 지나 길을 따라가면 곧장 물가까지 이어집니다. 상자를 여는 건 간단해요, {playerName}. 이름이 보일 때까지 바짝 다가가 F를 누르거나 상자를 왼쪽 클릭하면, 품고 있던 것을 내어 줍니다. 셋이면 충분합니다. 표류물을 뒤지는 게들은 보기보다 세게 꼬집으니 발밑을 조심하고, 이것만은 기억하세요. 앞으로 만날 모든 상자와 채집물과 문은 전부 같은 F 하나로 엽니다.",
        "completion": "밧줄과 타르, 그리고 바다가 어쩐 일로 남겨 준 치즈 반 덩이. 세상은 허리를 굽힐 가치가 있는 것들로 가득해요, {playerName}. 이 습관을 지키세요. 가까이 다가가, F를 누르고, 당신 몫을 챙기기.",
        "objectives": {
          "0": {
            "label": "표류 상자 열기"
          }
      ...
      "q_ps_the_wheel_of_trades": {
        "title": "생업의 바퀴",
        "text": "칼은 한 끼를 먹여 주지만, {playerName}, 생업은 평생을 먹여 줍니다. 모험가라면 누구나 칼 곁에 전문 기술을 둡니다. 채광, 벌목, 약초 채집, 낚시, 그리고 그 모두를 값어치로 바꾸는 제작 기술이죠. 보급관 핀치의 좌판은 내 수련장에서 몇 걸음 거리에 있고, 핀치는 내가 치른 훈련보다 많은 좌판을 꾸려 왔어요. 다가가서 F를 누르거나 왼쪽 클릭하면 이야기할 수 있습니다. 상자를 여는 그 키가 대화도 연답니다.",
        "completion": "마렌이 드디어 말 걸 만한 학생을 보냈군요. 한 번만 말할 테니 잘 들어요, {playerName}. 채집은 도구에서 시작합니다. 곡괭이, 도끼, 낫, 낚싯대, 전부 골짜기 상인들이 팔죠. Shift를 누른 채 P를 누르면 전문 기술 수첩이 열립니다. 그것이 당신의 바퀴이고, 익힌 기술과 각각의 숙련도가 모두 적혀 있죠. 좋아하는 것을 갈고닦다가 인접한 한 쌍에 조율하면 그 둘은 상한 없는 주 전공이 되고, 바퀴 건너편 하나는 취미로 남고, 나머지는 지식을 간직한 채 잠듭니다. 사라지는 것도, 되돌릴 수 없는 것도 없어요. 짝을 정해 주는 것도 장인이고, 나중에 바꿔 주는 것도 장인입니다. 이스트브룩이라면 대장간의 대장장이 다르바, 여관 주방의 요리사 말로우, 베틀 앞의 직조공 오틸리에, 공방의 땜장이 기젤이 있고, 펜브리지 무두질터에는 무두장이 헤스크가, 하이워치 약방에는 연금술사 베란이 있습니다.",
        "objectives": {
          "0": {
            "label": "보급관 핀치에게 생업에 대해 묻기"
          }
        }
      },
      "q_ps_pouch_and_purse": {
        "title": "주머니와 돈주머니",
        "text": "골짜기로 떠나기 전 마지막 가르침이에요, {playerName}. 모험가의 목숨을 지켜 주는 가르침이죠. 바로 당신이 지고 다니는 짐 얘기입니다. 배낭에는 열여섯 칸이 있고, 그 옆에 빈 가방 고리 넷이 기다립니다. 가방을 하나 채울 때마다 그 공간이 전체 용량에 더해져요. 그러니 보급관 핀치에게 F를 눌러 좌판을 열고, 물건 중에서 아마천 주머니를 왼쪽 클릭해 사세요. 그런 다음 B를 눌러 가방을 열고, 거기 있는 주머니를 왼쪽 클릭해 빈 고리에 채우세요. 허리에 걸리거든 내게 돌아오세요.",
        "completion": "좋은 주머니군요. 말썽거리를 담을 칸이 여섯 늘었네요. 이제 어떤 가방에도 담기지 않는 나머지 절반의 가르침입니다, {playerName}. 들고 다닐 수 없는 것은 도금 금고가 맡습니다. 내 뒤 책상의 경리관 윅이 열어 주는 금고는 어느 마을의 어느 경리관과도 같은 금고이고, 돈주머니가 두둑해지면 금고 칸도 더 살 수 있죠. 값진 것은 금고에, 가방에는 여유를. 어떤 늑대보다도 꽉 찬 배낭이 끝장낸 모험이 더 많답니다.",
        "objectives": {
          "0": {
            "label": "아마천 주머니 구입하기"
          }
      ...
      "q_ps_set_sail": {
        "title": "출항",
        "text": "이 해안에는 당신이 쓰러뜨리지 않았거나, 열지 않았거나, 사지 않은 것이 하나도 남지 않았어요, {playerName}. 준비는 끝났고, 이스트브룩에는 진짜 일이 기다립니다. 길을 따라 낡은 부두로 내려가 뱃사공 오도에게 F를 누르고, 내가 당신이 건너갈 자격을 얻었다 했다고 전하세요. 누구에게 무엇을 빚졌는지 헷갈릴 때는 언제든 L을 누르세요. 그것이 당신의 퀘스트 일지입니다.",
