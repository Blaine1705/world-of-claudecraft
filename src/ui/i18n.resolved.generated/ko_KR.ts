...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "strafeBody": "옆으로 움직이는 또 다른 방법이 있습니다. {strafeKey}를 눌러 마지막 길로 한 걸음 비켜선 다음, {forwardKey}를 누른 채 {strafeKey}로 옆걸음하며 붉은 깃발이 등 뒤로 갈 때까지 나아가세요. 옆걸음은 시선을 표적에 둔 채 움직이게 해 줍니다. 언젠가 전투에서 이렇게 움직이게 될 거예요.",
      ...
      "taskStrikeTrueBodyCaster": "짚 허수아비에게 다가가 {targetKey}를 누르거나 왼쪽 클릭해 대상으로 잡으세요. 그런 다음 {attackKey}를 누르거나 행동 단축바의 두 번째 버튼을 클릭해 주문을 시전하세요. 하나가 무너질 때까지 계속 시전하세요.",
      ...
      "taskShellBodyCaster": "종종게는 마주 집게를 휘두릅니다. {targetKey}를 누르거나 왼쪽 클릭해 한 마리를 대상으로 잡고, {attackKey}를 눌러 주문을 시전하며 거리를 둔 채 계속 시전하세요. 한꺼번에 너무 많이 달려들면 길을 따라 뒤로 물러나세요. 녀석들은 금세 추격을 포기하고, 쉬는 동안 생명력도 돌아옵니다.",
      "taskShellBodyCasterTouch": "종종게는 마주 집게를 휘두릅니다. 한 마리를 탭해 대상으로 잡고, 행동 단축바의 두 번째 버튼을 탭해 주문을 시전하며 거리를 둔 채 계속 시전하세요. 한꺼번에 너무 많이 달려들면 길을 따라 뒤로 물러나세요. 녀석들은 금세 추격을 포기하고, 쉬는 동안 생명력도 돌아옵니다.",
      "taskShellBodyCasterPad": "종종게는 마주 집게를 휘두릅니다. 대상 버튼을 누르고, 이어서 두 번째 행동 버튼을 눌러 주문을 시전하며 거리를 둔 채 계속 시전하세요. 한꺼번에 너무 많이 달려들면 길을 따라 뒤로 물러나세요. 녀석들은 금세 추격을 포기하고, 쉬는 동안 생명력도 돌아옵니다.",
