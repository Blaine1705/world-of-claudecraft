...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "taskLongWalkBody": "해안 길을 따라 남쪽으로 걸어가 안식의 돌 앞에서 {interactKey}를 눌러 무릎을 꿇으세요. 여기서는 아무것도 당신을 해치지 않고, 잃는 것도 없습니다.",
      ...
      "taskShellBody": "종종게는 마주 집게를 휘두릅니다. 왼쪽 클릭해 한 마리를 대상으로 잡고, {attackKey}를 눌러 내리치며 계속 공격하세요. 한꺼번에 너무 많이 달려들면 길을 따라 뒤로 물러나세요. 녀석들은 금세 추격을 포기하고, 쉬는 동안 생명력도 돌아옵니다.",
      ...
      "taskShellBodyCaster": "종종게는 마주 집게를 휘두릅니다. 왼쪽 클릭해 한 마리를 대상으로 잡고, {attackKey}를 눌러 주문을 시전하며 거리를 둔 채 계속 시전하세요. 한꺼번에 너무 많이 달려들면 길을 따라 뒤로 물러나세요. 녀석들은 금세 추격을 포기하고, 쉬는 동안 생명력도 돌아옵니다.",
