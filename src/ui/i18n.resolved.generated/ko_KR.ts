...
export const ko_KR: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "lava_burst": {
        "name": "용암 폭발",
        "description": "{damage}의 화염 피해를 입힙니다. 당신의 잉걸 충격으로 불타는 대상에게는 항상 치명타가 적중합니다. 용암 쇄도: 잉걸 충격의 지속 피해가 들어갈 때마다 20% 확률로 이 재사용 대기시간이 초기화되고 다음 용암 폭발이 즉시 시전됩니다. 피해는 주문력에 따라 증가합니다. (천둥소환)"
      },
      "thunderstorm": {
        "name": "폭풍 파쇄",
