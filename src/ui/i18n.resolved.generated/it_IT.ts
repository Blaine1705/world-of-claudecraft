  ...
  "entities": {
    "abilities": {
      ...
      "storm_bolt": {
        ...
        "description": "Scaglia la tua arma sul bersaglio, infliggendo {damage} e stordendolo per 3 sec."
      },
      "piercing_howl": {
        "name": "Urlo Penetrante",
        "description": "Un urlo lacerante che rallenta del 50% tutti i nemici entro 15 metri per 8 sec."
      },
      "die_by_sword": {
      ...
      "recklessness": {
        "name": "Temerarietà",
        "description": "Ira: la generazione di rabbia aumenta del 50% e la probabilità di colpo critico del 20% per 12 sec."
      },
      "avatar": {
        "name": "Avatar",
        "description": "Ti trasformi in un colosso per 20 sec, spezzando ogni controllo su di te e aumentando i danni inflitti del 20%."
      },
      "sanguine_aura": {
        "name": "Aura Sanguigna",
        "description": "Intridi la tua arma del sangue dei nemici: tu e i tuoi alleati in mischia guadagnate il 10% di velocità d'attacco e il 10% di danni per 20 sec."
      },
      "victory_rush": {
        "name": "Slancio della Vittoria",
        "description": "Colpisce infliggendo danni dell'arma più {damage} e ti cura del 20% della salute massima. Utilizzabile solo entro 20 sec dall'uccisione di un nemico."
      },
      "bladestorm": {
        "name": "Tempesta di Lame",
        "description": "Diventi un turbine d'acciaio che colpisce tutti i nemici entro 8 metri, infliggendo {damage} ogni secondo per 4 sec."
      },
      "intimidating_shout": {
        "name": "Urlo Intimidatorio",
        "description": "Un urlo terrificante che fa fuggire fino a 5 nemici entro 8 metri per 8 sec. I danni possono spezzare l'effetto."
      },
      "pummel": {
        "name": "Tempestare",
        "description": "Interrompe l'incantesimo e impedisce di lanciare incantesimi di quella scuola per 4 sec. Genera 10 rabbia quando taglia un lancio."
      },
      "heroic_leap": {
        "name": "Balzo Eroico",
        "description": "Balza sull'area bersaglio, infliggendo {damage} danni ai nemici vicini."
      },
      "rallying_cry": {
        "name": "Grido di Guerra",
        "description": "Lanci un grido di guerra che concede a te e ai membri del gruppo entro 40 metri il 20% di salute massima aggiuntiva per 20 sec."
      },
      "summon_imp": {
        "name": "Evoca Emberkin",
