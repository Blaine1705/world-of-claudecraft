...
export const es_ES: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsNote": "Cada nodo necesita la herramienta de su oficio en tu mochila, incluido el nivel 1: sin pico no hay mineral, y sin caña no hay peces. La escalera de vendedores cubre los niveles 1 a 3, y cada pueblo principal solo tiene en existencias los niveles que su propio terreno usa: la herramienta de nivel 1 se vende en todos los pueblos principales, mientras que los peldaños superiores se venden donde están las vetas que los exigen. Para esos peldaños los vendedores piden además pericia en el oficio de la herramienta, {tier2Prof} para el nivel 2 y {tier3Prof} para el nivel 3, y la fila indica el requisito. La herramienta solo tiene que estar en tu mochila, no hay ranura de equipamiento ni durabilidad, así que cada una es una compra de una sola vez, y lo que ya posees sigue funcionando. Solo importa el nivel para el acceso: el color de rareza de una herramienta es cosmético.\n\nPor encima de la escalera de vendedores hay dos herramientas elaboradas, de nivel 4 y nivel 5, fabricadas en el taller de herramientas por ingenieros y que ningún NPC vende. Ningún nodo actual necesita más de nivel 3, así que su valor ahora mismo es la velocidad: una herramienta del nivel más alto fija el tiempo de lanzamiento en su mínimo en los nodos inferiores, y será el boleto de entrada cuando lleguen terrenos de nivel más alto.",
