...
export const es_ES: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "unitFrame": {
      ...
      "targetOfTargetLabel": "La marca de tu marca",
      "partyLabel": "Tu grupo",
      "partyGroup": "Grupo {n}",
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "hamstring": "Corta las piernas del objetivo para ralentizarlo y que no pueda darte alcance.",
  ...
  "entities": {
    "abilities": {
      ...
      "demoralizing_shout": {
        ...
        "description": "Lanza un grito aterrador y reduce un 20% el daño que infligen todos los enemigos cercanos durante 20 s."
      },
      "charge": {
        "name": "Arremetida",
      ...
      "shield_slam": {
        ...
        "description": "Golpeas al objetivo con tu escudo por {damage} y generas una amenaza enorme, obteniendo 15 de ira. (habilidad distintiva de Protección)"
      },
      "whirlwind": {
        "name": "Remolino de Cuchillas",
        "description": "Giras en un arco letal y golpeas a todos los enemigos cercanos por {damage}, generando ira por cada enemigo alcanzado en lugar de costarla. Tus 2 próximas habilidades de un solo objetivo también golpean a los enemigos cercanos a tu objetivo. (talento de Furia)"
      },
      "berserker_rage": {
      ...
      "rallying_cry": {
        ...
        "description": "Profieres un grito de guerra que os otorga a ti y a los miembros del grupo en un radio de 40 yardas un 20% de salud máxima adicional durante 10 s. Protección: además reciben un 5% menos de daño mientras dura."
      },
      "summon_imp": {
