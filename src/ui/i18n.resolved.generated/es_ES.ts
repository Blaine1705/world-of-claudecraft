    ...
    "profPages": {
      ...
      "craftProse": {
        ...
        "alchemy": {
          ...
          "ladderBody": "Desde el principio, todo el mundo conoce la poción de curación menor y puede mezclarla en cualquier lugar, sin necesitar una estación. La verdadera progresión son nueve recetas que Verane enseña en la botica, tres en cada tramo: las recetas de habilidad 0 son gratis, el tramo de habilidad 25 cuesta 25 monedas de plata por receta y el tramo de habilidad 50 cuesta 1 moneda de oro por receta. Cada tramo incluye una poción de curación, una poción de maná y un elixir de aguante, que avanzan desde frascos comunes de sheenleaf (120 de salud, 160 de maná), pasan por goldleaf poco común (200 de salud, 260 de maná) y llegan al sunpetal raro (280 de salud, 360 de maná).\n\nLos elixires progresan del mismo modo: el Elixir del Jabalí otorga 6 de aguante durante 10 minutos, el Elixir Vipersear otorga 9 durante 15 minutos y el Elixir de la Serpiente otorga 12 durante 15 minutos; solo el de la Serpiente produce dos frascos por elaboración. Hay una receta adicional aparte: el Elixir del Oso, un brebaje combinado que Verane enseña por 25 monedas de plata cuando tu Alquimia alcanza 25. Puede mezclarse en cualquier lugar, pero solo por un Bombardier armonizado que tenga Alquimia e Ingeniería a 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Todos los encantamientos se conocen desde el principio, cualquiera puede desencantar desde el primer día, y ninguna de las dos acciones necesita estación; el límite de habilidad es 125, como en cualquier oficio. El único rincón enseñado del oficio es su par de recetas de abalorios: Tinker Gizzel enseña el Alijo del Recolector y el Ojo del Artesano en la fábrica de herramientas, en la esquina suroeste de Eastbrook Square, por la tarifa de tramo normal cuando tu Encantamiento alcanza 25, y los abalorios se elaboran en su estación.\n\nEn el anillo queda entre Inscripción y Joyería, así que sus dos identidades de pareja son el Arcanista (Inscripción y Encantamiento) y el Engarzador de Gemas (Encantamiento y Joyería). Ninguna de las dos puede jurarse todavía, porque ambos oficios vecinos esperan sus primeras recetas, así que hoy Encantamiento asciende como un oficio para todos: libre hasta el tramo raro antes de cualquier juramento y una elección natural como oficio secundario para un Bombardier o un Boticario. Los encantadores también mantienen activo el mundo de la recolección: los dos efectos insertables para herramientas son trabajo del encantador, y el artesano original recarga sus propios efectos con descuento, aún mayor una vez especializado.",
