    ...
    "profPages": {
      ...
      "craftProse": {
        ...
        "alchemy": {
          ...
          "ladderBody": "Todos conocen la poción de curación menor desde el principio y pueden mezclarla en cualquier lugar, sin estación. La verdadera escalera son las nueve recetas que Verane enseña en la botica, tres en cada peldaño: las recetas de habilidad 0 son gratis, el peldaño de habilidad 25 cuesta 25 monedas de plata por receta y el peldaño de habilidad 50 cuesta 1 moneda de oro por receta. Cada peldaño incluye una poción de curación, una poción de maná y un elixir de aguante, que avanzan desde frascos comunes de hoja brillante (120 de salud, 160 de maná), pasan por hoja dorada poco común (200 de salud, 260 de maná) y llegan al pétalo solar raro (280 de salud, 360 de maná).\n\nLos elixires suben de la misma forma: el Elixir del Jabalí otorga 6 de aguante durante 10 minutos, el Elixir de Ojo Viperino otorga 9 durante 15 minutos y el Elixir de la Serpiente otorga 12 durante 15 minutos; solo el de la Serpiente produce dos frascos por elaboración. Una receta más queda aparte: el Elixir del Oso, un brebaje combinado que Verane enseña por 25 monedas de plata cuando tu Alquimia llega a 25. Puede mezclarse en cualquier lugar, pero solo por un Bombardero armonizado con Alquimia e Ingeniería a 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Todos los encantamientos se conocen desde el inicio, cualquiera puede desencantar desde el primer día y ninguna de las dos acciones necesita estación; el límite de habilidad es 125, como en cualquier oficio. La única parte enseñada del oficio es su par de recetas de talismanes: Tinker Gizzel enseña el Alijo del Recolector y el Ojo del Artesano en la fábrica de herramientas, en la esquina suroeste de la Plaza Eastbrook, por la tarifa normal del peldaño cuando tu Encantamiento llega a 25, y los talismanes se elaboran en su estación.\n\nEn el anillo se sitúa entre Inscripción y Joyería, así que sus dos identidades de pareja son el Arcanista (Inscripción y Encantamiento) y el Engarzador de Gemas (Encantamiento y Joyería). Ninguna puede jurarse todavía, porque ambos oficios vecinos esperan sus primeras recetas, así que hoy Encantamiento sube como un oficio para todos: libre hasta el nivel raro antes de cualquier juramento y una elección natural como pasatiempo para un Bombardero o un Boticario. Los encantadores también mantienen en marcha el mundo de la recolección: los dos efectos insertables para herramientas son obra del encantador, y el artesano original recarga sus propios efectos con descuento, aún mayor una vez especializado.",
