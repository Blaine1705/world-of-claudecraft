...
export const es_ES: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mounts": {
      ...
      "keybindHint": "Pulsa la tecla Montar / Desmontar para montar.",
      ...
      "spec_block": "+{pct}% de bloqueo de daño cuerpo a cuerpo",
      "spec_crit": "+{pct}% de probabilidad de golpe crítico",
