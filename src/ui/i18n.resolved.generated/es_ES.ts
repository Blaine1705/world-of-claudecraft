...
export const es_ES: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Editar teclas de la barra de acciones",
      "editKeysHint": "Haga clic en una ranura en la barra de acciones y luego presione una tecla para vincularla.",
      "bannerHint": "Haga clic en una ranura y luego presione una tecla para vincularla. Haga clic en Listo cuando haya terminado.",
      "bannerCapturing": "Presione una tecla para vincular esta ranura...",
      "boundToKey": "Vinculado a {key}.",
      "reset": "Reiniciar",
      "done": "Hecho",
      "cancel": "Cancelar",
      "resetConfirmTitle": "¿Restablecer las teclas de la barra de acciones?",
      "resetConfirmBody": "La primera barra vuelve a sus claves predeterminadas. Las barras segunda y tercera quedan sin consolidar. Esto no se puede deshacer."
    },
    "mounts": {
      "title": "Monturas",
      "close": "Cerrar",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "En las categorías 1v1 y 2v2, cada luchador usa el kit All-Rounder. Las escrituras que requieren el grupo 3v3 o mayor no se pueden obtener aquí.",
      "role": {
        "allrounder": {
          "name": "Polivalente",
      ...
      "practiceUnratedNote": "Los combates de práctica no están clasificados: las clasificaciones y el progreso del Libro de hazañas no cuentan.",
      ...
      "briefing": {
        ...
        "unratedNote": "Los robots están en el campo, por lo que esta pelea no está clasificada: la clasificación no cambia y los goles, las paradas y la portería a cero no cuentan.",
        "practiceUnratedNote": "Esta es una pelea de práctica, por lo que no está clasificada: las posiciones no cambian y el progreso del Libro de hazañas no cuenta.",
    ...
    "materialHint": {
      "fineGrade": "Buen grado. Se obtiene de una veta de nivel completo con una herramienta clasificada por encima del material y cuenta como la versión ordinaria siempre que se requiera.",
    ...
    "gathering": {
      ...
      "wieldUnmet": {
        "mining": "Necesitas Mining {skill} para mover el pico que ya tienes en tus bolsas.",
        "logging": "Necesitas Logging {skill} para blandir el hacha que ya tienes en tus maletas.",
        "herbalism": "Necesitas Herboristería {skill} para trabajar la hoz que ya tienes en tus maletas."
      },
      "wieldUnmetCorpse": "Necesitas reunir la habilidad {skill} para poner a trabajar tu mejor herramienta.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Requerido para pescar en aguas hasta el nivel {tier}."
        },
        "use": {
      ...
      "emptyHookNote": "Nada en el gancho",
      "stateReady": "Listo",
      "stateCooldown": "Reapareciendo",
      "stateCooldownTimed": "Reaparece en {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Su herramienta refina este rendimiento a una calidad fina."
    },
    "archetypeTitle": {
      "label": "Título",
      "none": "Ninguno",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} de {max} cargos",
      "toolEffectSpent": "Gastado, necesita recarga",
      "toolEffectDepleted": "Efecto de herramienta gastado",
      "toolEffectRechargePrice": "Recarga: {count} x {material}",
      "toolEffectModeAsk": "Preguntar cada uso",
      "toolEffectModePrompt": "Pregunta cada uso",
      "toolEffectConfirmTitle": "¿Usar {effect}?",
      "toolEffectConfirmBody": "¿Gastar un cargo en esta cosecha? Los que están en declive todavía se acumulan, sin el bono. Cargos restantes: {charges}.",
      "toolEffectConfirmAccept": "Usar un cargo",
      "toolEffectConfirmDecline": "Reunirse sin",
      "toolEffectName": {
        "gatherersCache": "Alijo del Recolector",
        "artisansEye": "Ojo del Artesano",
        "quickeningCharm": "Encanto de recuperación elástica"
      },
      "toolEffectSlotButton": "Ranura {effect}",
      "toolEffectRechargeButton": "Recargar",
      "toolEffectSlotted": "{effect} ranurado en {profession}.",
      "toolEffectSlotInvalid": "{effect} no se puede colocar allí.",
      "toolEffectNoTool": "Primero necesitas una herramienta {profession} real.",
      "toolEffectNoCharm": "Necesitas un dije {effect} elaborado en tus bolsos.",
      "toolEffectNoGain": "{effect} ya está colocado y completamente cargado.",
      "toolEffectRecharged": "{effect} recargado: {material} x{count} consumido.",
      "toolEffectRechargeNoSlot": "No se asigna ningún efecto a {profession}.",
      "toolEffectRechargeFull": "{effect} ya está completamente cargado.",
      "toolEffectRechargeToolCapped": "Lleve una herramienta {profession} mejor para cargar {effect} más.",
      "toolEffectRechargeMaterials": "La recarga de {effect} necesita {material} x{count}.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(gasta {count} buena calificación)",
      ...
      "identity": {
        ...
        "colRole": "Función",
        "colCap": "Tope",
        "allCrafts": "Todas las manualidades",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Comparte desbloqueos de escrituras con compañeros de gremio y seguidores, y tarjetas de escrituras y obras maestras con el feed de Discord.",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "Una declaración tampoco es una cadena perpetua. Un par que nunca has tenido es simplemente una nueva misión de sintonía, mientras que regresar a un par del que te alejaste te pide que hagas las paces primero: cinco tareas la primera vez y tres más agregadas por cada regreso que ya has realizado (tomar un par nuevo nunca aumenta la cuenta). La elección sigue siendo significativa sin cerrar una puerta para siempre.",
      "whatHeading": "Un oficio junto a la espada",
      "whatBody": "Las profesiones son la vida laboral del mundo: cuatro oficios de recolección que extraen materia prima directamente de la tierra y un anillo de diez oficios que la convierten en equipo, comida, pociones y herramientas. Aquí todo alimenta algo más. El mineral que extraes se convierte en una espada, la espada requiere un encantamiento y el encantamiento necesita polvo extraído del equipo viejo, por lo que un recolector, un artesano y un reparador son eslabones de una sola cadena.\n\nNo hay un límite profesional por el que preocuparse. Cada personaje puede desarrollar siete de los ocho oficios que tienen contenido hoy y las cuatro profesiones reunidas una al lado de la otra (la ingeniería es la única que se resiste: todas sus recetas comienzan por encima del techo libre, por lo que su escalera espera el juramento del Bombardero); la única opción exclusiva es tu arquetipo, la identidad que finalmente juras, aunque una vez que te sintonizas, las artesanías que quedan latentes detrás de él solo suben según sus recetas comunes, y no pasan la habilidad 75 en absoluto. Las habilidades nunca disminuyen y nada de lo que aprendes desaparece.",
      ...
      "archetypesBody": "Las diez naves se asientan sobre una rueda fija, y la geografía en esa rueda es importante. Cada dos vecinos forman una pareja con nombre: herrero para la fabricación de armas y armaduras, proveedor de peletería y sastrería, boticario de alquimia y cocina, bombardero de ingeniería y alquimia, y seis más alrededor del ring.\n\nSintonizarse con una pareja es una búsqueda, no un clic en un menú. Hoy se pueden unir cuatro parejas (Smith, Outfitter, Apothecary y Bombardier), cada una liderada por un maestro residente en Eastbrook cuya misión de aceptación establece todo el trato por adelantado antes de aceptarlo. Hasta que lo declares, cada oficio avanza libremente en recetas hasta el nivel raro (cualquier receta que requiera una habilidad de 74 o menos), por lo que puedes probar casi todo antes de elegir (la ingeniería por sí sola no tiene una receta tan baja, por lo que su número espera).\n\nUna vez que te sintonices, tus dos pares se convierten en tus mayores, sin límite inferior al límite. El resto de la rueda no se apaga: una nave opuesta a tus especialidades permanece como un pasatiempo que sigue subiendo a través del nivel raro (una misión repetible en la forja de Smith Haldren te permite cambiar cuál), y todas las demás naves quedan inactivas. Un oficio latente mantiene su habilidad y sus recetas comunes, que siguen enseñándole en la curva normal hasta que se vuelven grises a 75; todo lo que está por encima de lo común deja de dar frutos de inmediato, y una nave inactiva nunca resulta una obra maestra mientras descansa.",
      "pairFmt": "{a} y {b}",
      ...
      "startBody": "¿Recién salido de la carretera en Eastbrook? Encuentra al capataz Odell y acepta Un intercambio para cada mano: él te indicará las vetas de mineral alrededor de Copper Dig al sureste de la ciudad y te entregará tus primeros callos. Cuidado con la excavación en sí: los excavadores de Roca Profunda acampados en él se encuentran unos niveles por encima de un recién llegado, así que trabaja primero en las venas periféricas y guarda el corazón del campamento para cuando hayas nivelado un poco. A partir de entonces, cosecha cada veta, bosquecillo y parche de hierbas que pases durante la misión; el dominio es algo natural para los viajeros.\n\nDe vuelta en la ciudad, presiona T para abrir la ventana de elaboración y trabajar en las recetas comunes que todos los personajes conocen desde el principio. Visite a los maestros en la forja, las cocinas, los telares y las herramientas para ver lo que enseñan y tome sus órdenes de trabajo por una moneda estable. Para cuando la carta del Gremio te encuentre, ya sabrás qué pareja se siente como en casa.",
      "colStation": "Estación",
      "colHub": "Centro",
      "colMaster": "Maestro",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Ingeniería construye las herramientas que todo recolector serio termina deseando: picos, hachas, hoces y cañas de pescar de nivel 4 y 5 que ningún mostrador venderá por monedas, y cada uno consume la herramienta que se encuentra debajo.",
        "enchanting": "El encantamiento desarma el equipo y le devuelve el poder: rompe las piezas no deseadas en materiales arcanos y luego gástalas en una bonificación de estadísticas permanente para una pieza que deseas conservar. Romper y encantar no necesitan estación ni entrenador, y cualquiera puede empezar desde el primer día; Sólo las dos recetas de encantamientos piden más, que se enseñan en Toolworks."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "La minería es la columna vertebral. El mineral de cobre proviene de las vetas de nivel 1 de Eastbrook Vale, el mineral de hierro de Mirefen Marsh y el mineral de osmio de Thornpeak Heights, y cada peldaño de la escalera sube de la misma manera. La tala importa más de lo que cabría esperar: la corteza de hierro empuña la lanza del jabalí, la madera de fresno sostiene el mazo y un solo tronco de pino alto forma el bastón de batalla.\n\nEl resto viene de la caza y del contraataque. La piel áspera para las empuñaduras se recolecta directamente de los cadáveres de lobos y jabalíes, los fragmentos de huesos se desprenden de los muertos inquietos o del equipo común recuperado, y la escalera de la forja quema Smithing Flux, 20 cobre el frasco de la propia Darva. Si tu propia minería se queda atrás, ningún contador te salvará en el mineral en sí: el osmio proviene de las vetas de Thornpeak, de las vetas iniciales de cada zona más joven excepto Farshore (cuyas vetas extraen hierro), o de la pila de otro jugador, mediante el comercio o el Mercado Mundial. Solo la barra Glyphsteel se compra con monedas, de Tinker Gizzel en Toolworks o Quartermaster Bree en Highwatch.",
          ...
          "routeBody": "Cualquier pieza con una línea de estadísticas real, que en esta escalera significa el peldaño de hierro hacia arriba, puede salir del yunque como una obra maestra siempre que la calidad más fina encaje dentro del techo de su nivel; los bienes comunes de cobre sin estado nunca se activan, porque no hay nada en ellos que mejorar. El hierro y el osmio cuentan como materiales de nivel 1 para la bonificación de obra maestra, el pino alto y el glifoacero como nivel 2, y la habilidad que se encuentra por encima del nivel de una receta agrega su propio punto por nivel, por lo que entre los tres de osmio es el hacha de guerra y el bastón de batalla los que llevan el borde del material, y un peldaño sigue funcionando mejor después de que lo hayas superado.\n\nSube el peldaño de cobre a 25, entrena el peldaño de hierro el día que se abre y súbelo a 50, luego el peldaño de osmio a 75. Más allá de 75, no hay barcos más altos todavía, por lo que las recetas de osmio se desvanecen a la mitad y luego a un cuarto de ganancia: presupuesta aproximadamente 150 naves más para alcanzar el límite de 125, y recuerda el acelerador compartido de diez acciones de naves por minuto cuando te sientas a procesar lotes.\n\nFinancia el ascenso a medida que avanzas: la orden de trabajo de la forja de Darva te quita ocho minerales de cobre cada 30 minutos por una pequeña moneda y XP, y los peldaños de hierro y osmio se venden honestamente para nivelar cuerpo a cuerpo. El Libro de las hazañas marca Edge and Temper en la habilidad 50 y corona a Grandmaster Weaponcrafting en 125."
        },
        "armorcrafting": {
          "identityHeading": "Malla para la primera línea",
          "identityBody": "La escalera de Armorcrafting se lee como la carrera de un soldado: el simple cinturón de cobre remachado, los sabatones y los guanteletes para comenzar, la cota de hierro, las musleras y las hombreras con sus primeras líneas de estadísticas reales, y el raro gran yelmo, coraza y calzas de escala de osmio, piezas de Fuerza y ​​Resistencia con números de armadura en la cima del arte de un artesano.\n\nTambién tiene un lado más tranquilo: las calzas protegidas de Eastbrook, un campo común con estadísticas de lanzador, y el manto Kilnscale, un hombro de malla de intelecto y espíritu poco común con habilidad 75, mantienen a los portadores de malla con mentalidad de hechizos en la lista de clientes. En el ring se encuentra entre Fabricación de armas e Ingeniería; la pareja de Smith con Fabricación de armas presta juramento ante Forgemistress Darva, mientras que la pareja de Gearwright con Ingeniería tiene nombre pero aún no tiene ninguna misión de juramento.",
          "materialsHeading": "Mineral a sacos",
          "materialsBody": "Ninguna embarcación come mineral más rápido. La cota de enlace de hierro por sí sola requiere cinco minerales de hierro, y cada pieza de escala de osmio necesita tres o cuatro de osmio más una barra de glifacero, por lo que un armero serio extrae Mirefen Marsh y Thornpeak Heights o paga a alguien que lo haga. El cobre alimenta el primer peldaño, directamente desde las vetas de Copper Dig.\n\nAlrededor del metal se encuentran las partes blandas: piel áspera extraída de cadáveres de lobos y jabalíes, fragmentos de huesos de muertos inquietos (o rescatados de equipo común) y frascos de Smithing Flux (20 de cobre cada uno en la forja) en casi todas las recetas. Ningún mostrador vende osmio: los impacientes lo compran a otros jugadores o lo extraen ellos mismos, en Thornpeak o en las venas iniciales de diez de las once zonas más jóvenes (solo Farshore extrae hierro).",
          "ladderHeading": "Aprendiendo en la fragua de Darva",
          "ladderBody": "Dos campos comunes, el chaleco de cota de malla de Eastbrook y las calzas protegidas, se conocen desde el principio y se fabrican en cualquier lugar. La escalera del entrenador consta de nueve recetas en tres peldaños en la forja de Eastbrook: el peldaño de cobre es gratis en la habilidad 0, el peldaño de enlace de hierro cuesta 25 de plata por receta en la habilidad 25 y el peldaño de escala de osmio cuesta 1 de oro cada uno en la habilidad 50, y cada peldaño se puede enseñar en el momento en que su nivel lo alcanza.\n\nMás allá de la escalera se encuentran dos especiales. El Boundstone Helm es una de las dos recetas combinadas de Smith (los Gravewyrm Gauntlets son sus hermanos en el lado de la fabricación de armas), enseñado por un entrenador, sin estación y manejable solo por un Smith sintonizado con ambas artesanías en la habilidad 25. Kilnscale Mantle no necesita ningún maestro: todos lo saben desde el principio, y nada más que la forja y las puertas de materiales que lo trabajan. Su habilidad listada de 75 se trata de ganancia, no de permiso: con Armorcrafting como especialidad, paga la ganancia de habilidad completa desde el primer golpe de martillo hasta 99, por lo que un herrero con osmio de sobra puede apoyarse en ella desde el principio. Por debajo del techo de un mayor, la receta de nivel 3 no enseña nada, por lo que un armero aficionado o no declarado trabaja por la pieza, no por los puntos.",
        ...
        "leatherworking": {
          ...
          "materialsBody": "La peletería es el oficio en el que tu ruta de nivelación y tu línea de suministro son la misma: la piel en bruto se recolecta directamente de los cadáveres que la llevan, lobos y jabalíes sobre todo, y cada cadáver sirve a un solo recolector, por orden de llegada. Una tirada de cosecha rara o mejor también otorga una Piel Prístina, un espécimen firmado que pide el Mirewarden Jerkin, así que guarda cada uno que encuentres.\n\nEl elenco de apoyo es pequeño: patas de araña y seda, tela casera hecha de humanoides, un solo mineral de osmio en cada pieza rara de mirewarden (seis en la piedra angular de Duskhide Wraps) y un agente curtidor a 16 de cobre del mostrador de la curtiduría. El osmio en sí nunca se contracompra: sácalo tú mismo, en Thornpeak o en las venas iniciales de casi cualquier zona más joven (solo Farshore extrae hierro), o cómpralo a otro jugador.",
          "ladderHeading": "Entrenado en Fenbridge",
          "ladderBody": "Aquí está el problema: la curtiduría se encuentra en Fenbridge, en la carretera de Mirefen Marsh, lo que hace que la peletería sea el único oficio profundo que se practica en el pantano. Tanner Hesk enseña la escalera en sus cubas: la piel de Fenbridge se libera en la habilidad 0, el peldaño del acechador de pantanos en 25 de plata una receta de la habilidad 25, y el peldaño de mirewarden en 1 de oro cada uno desde la habilidad 50, cada peldaño se abre a medida que tu nivel lo alcanza.\n\nTres recetas se saltan al entrenador: los bienes comunes de campo (el chaleco de cuero curtido y la piel de druida de Eastbrook) se elaboran en cualquier lugar desde el principio, y los Duskhide Wraps son conocidos por todos, pero tienen la habilidad 75, destinados a la curtiduría. Tenga en cuenta que el juramento de Outfitter en sí se hace en Eastbrook con Ottilie; sólo la enseñanza ocurre en el pantano.",
          "routeHeading": "Obras maestras y una ruta hasta 125",
          "routeBody": "Cualquier pieza con estadísticas reales tiene la posibilidad de obra maestra siempre que la calidad más fina encaje dentro de su límite máximo de nivel, incluida la piel de druida de Eastbrook con estadísticas, y una piel prístina firmada en un chaleco Mirewarden proporciona la bonificación de reactivo firmado automáticamente; El osmio cuenta como material de nivel 1 para el proceso. Los comunes ocultos sin estado no pueden activarse.\n\nNivela de forma natural: cosecha cada lobo y jabalí que mates desde el nivel uno, deja que los dos campos comunes te lleven a 25 dondequiera que estés, luego entrena el peldaño de la piel en las tinas cuando las misiones te lleven al pantano de todos modos. Marshstalker te lleva a 50 y mirewarden a 75; más allá de eso, Duskhide Wraps, una receta de nivel 3 con seis minerales de osmio, tres pieles prístinas, dos pieles ásperas y un agente bronceador, le pagan a un Outfitter sintonizado una ganancia total de 99 y medio después, alrededor de 75 artesanías para los últimos cincuenta puntos hasta el límite de 125; Por debajo del techo de un mayor, la receta de nivel 3 no enseña nada.\n\nLa curtiduría móvil es más importante para este oficio que cualquier otro: especialízate en 75 y una alforja de pieles se convierte en equipo terminado en la fogata en lugar de caminar de regreso a Fenbridge. La orden de trabajo de la curtiduría de Hesk compra ocho pieles en bruto cada 30 minutos, un buen retorno de las pieles que recolectaste de todos modos, y el Libro de escrituras marca el oficio del curtidor en la habilidad 50 con el gran maestro peletero en la cima."
        },
        "cooking": {
          "identityHeading": "El puchero que alimenta al grupo",
          "identityBody": "Come una comida cocinada y te curará con 18 segundos de descanso, que entre tirones es la curación más barata del juego. La escalera va desde un Pan-Seared River Perch de 90 puntos de vida hasta Marlow's Grand Roast en 980, un sit-heal que no hay nada mejor en el juego.\n\nEn el ring, Cocinar se encuentra entre Alquimia y Peletería. Su pareja viva es el Boticario, Alquimia y Cocina, jurado ante el cocinero Marlow en las cocinas de Eastbrook después de cazar cuatro jabalíes para la olla; La pareja Trampero con Peletería aparece nombrada en el anillo, pero aún no tiene ninguna misión de juramento.",
          "materialsHeading": "Una despensa alimentada por la caña y el cuchillo",
          "materialsBody": "La pesca cuenta con los ingredientes característicos, zona por zona: trucha espejo y perca de río de las aguas de Eastbrook Vale, lucio y anguila de pantano de Mirefen Marsh, trucha helada y carpa pizarra de Thornpeak Heights. Los peldaños mezclan las zonas libremente (el peldaño libre ya quiere el lucio de los pantanos, el peldaño medio, las agallas heladas de Thornpeak, y la rara cena vuelve a plegar la trucha espejo del Valle), por lo que un cocinero que pesca dondequiera que vaya el camino nunca se queda seco.\n\nEl lado del carnicero proviene de cadáveres cosechados: carne de caza de jabalíes y sus parientes y, en un rollo de cosecha raro o mejor, un Prime Cut firmado, la pieza central del gran asado. Las hierbas sazonan los mejores platos, un tronco de fresno ahuma la anguila y la sal para cocinar cuesta 8 monedas de cobre por bolsa del propio puesto de Marlow.",
        ...
        "alchemy": {
          ...
          "identityBody": "El oficio se trabaja en la botica de Highwatch, hogar del alquimista Verane, maestra del boticario, quien enseña la escalera de recetas, vende viales de vidrio a 12 monedas de cobre y paga con monedas las hierbas a través de su orden de trabajo.\n\nEn el ring de artesanía, Alquimia se ubica con los oficios de prueba y error, junto a Ingeniería por un lado y Cocina por el otro. Eso le da dos identidades: el Bombardier (Ingeniería y Alquimia, asumido ante Tinker Gizzel en Eastbrook) y el Boticario (Alquimia y Cocina, juramentado ante Cook Marlow). Sintonízate con cualquiera de los dos para hacer de la Alquimia una especialidad y deja que tu propio trabajo firmado te enseñe; la pareja Bombardier también abre su brebaje combinado, el Elixir del Oso, mientras que la pareja Apothecary aún no envía ninguna receta combinada. Sin embargo, la escalera en sí nunca espera, porque cada receta de Alquimia se encuentra dentro del raro nivel bajo el cual trabajan las artesanías no declaradas, por lo que todo el ascenso hasta el límite está abierto antes de cualquier juramento.",
          ...
          "ladderBody": "Todo el mundo conoce la poción curativa menor desde el principio y puede mezclarla en cualquier lugar, sin necesidad de estación. La verdadera escalera son nueve recetas enseñadas por Verane en la botica, tres en cada peldaño: las recetas de habilidad 0 son gratuitas, la habilidad de 25 peldaños cuesta 25 plata por receta y la habilidad de 50 peldaños cuesta 1 oro por receta. Cada peldaño es una poción curativa, una poción de maná y un elixir de resistencia, que van desde botellas de hojas de brillo comunes (120 de salud, 160 de maná) hasta hojas de oro poco comunes (200 de salud, 260 de maná) y un raro pétalo de sol (280 de salud, 360 de maná).\n\nLos elixires suben de la misma manera: el Elixir del Jabalí otorga 6 de Resistencia durante 10 minutos, el Elixir de Vipersear 9 durante 15 minutos y el Elixir de la Serpiente 12 durante 15 minutos, la Serpiente sola elabora dos botellas por artesanía. Una receta más está a un lado: el Elixir del Oso, una bebida combinada que Verane enseña por 25 monedas de plata una vez que tu Alquimia alcanza 25, y que se puede mezclar en cualquier lugar, pero solo por un Bombardier sintonizado con Alquimia e Ingeniería en 25.",
          "routeHeading": "La ruta de un elaborador hasta 125",
          "routeBody": "Las bebidas y los elixires nunca producen obras maestras; ese proceso pertenece al equipo que contiene estadísticas. Sin embargo, tu nombre aún viaja: los raros borradores de pétalos de sol llegan firmados con la marca del fabricante, al igual que cada botella del Elixir de la Serpiente de doble lote, por lo que nada raro en esta artesanía sale del banco sin firmar. En la habilidad 75 te especializas y, a partir de ese momento, cada receta de Alquimia cuesta un 20 por ciento menos de materiales.\n\nToma Herboristería temprano y elige a medida que subes de nivel: sheenleaf está en todas partes del Valle, y una vez que llegues al banco de Verane, el peldaño libre te llevará limpiamente a la habilidad 25 en hierbas que habrías elegido de todos modos. Aprenda los 25 peldaños en el momento en que se enciende, mueva su recolección al pantano en busca de pan de oro y deje que la orden de trabajo de Verane (seis hierbas Goldleaf por 45 de cobre, repetible cada 30 minutos) le devuelva una pequeña moneda a medida que avanza.\n\nA partir de 50, prepara caldos de pétalos de sol y lotes de Serpiente a partir de pétalos de sol de Pico de Espina, con un poco de Vale y vegetación de pantano todavía en la mezcla. El último tramo de 100 a 125 es un goteo deliberado, así que prepare lo que realmente se vende en lugar de quemar hierbas para obtener el número, y recuerde que los consumibles son el bien elaborado que todos vuelven a comprar para siempre. El Libro de los Hechos marca Strange Brews en la habilidad 50 y Grandmaster Alchemy en el límite."
        },
        "engineering": {
          "identityHeading": "El monopolio del fabricante de herramientas",
          "identityBody": "El oficio se trabaja en la fábrica de herramientas en la esquina suroeste de Eastbrook Square, hogar de Tinker Gizzel, maestro de las herramientas. Los niveles 1 a 3 de cada línea de herramientas son existencias ordinarias de proveedores; Los niveles 4 y 5 salen del banco de un ingeniero, o del mostrador de excavación de Marcas de Profundidad de Letanía Ahogada detrás de sus puertas transparentes, y nunca de ninguna caja registradora para monedas.\n\nEn el ring se encuentra con los oficios de prueba y error, junto a Alquimia y Armería, lo que le otorga dos pares de identidades: el Bombardier (Ingeniería y Alquimia, asumido antes que el propio Gizzel) y el Gearwright (Armorcrafting e Ingeniería, nombrado pero aún no juramentado). Una advertencia importa más aquí que en cualquier otro lugar: cada uno de los peldaños de recetas de Ingeniería se encuentra por encima del techo de nivel raro bajo el cual trabajan los pasatiempos y los artesanos no declarados, por lo que el número de habilidad solo se mueve para un artesano cuyas especialidades incluyen Ingeniería, que hoy significa Bombardier. Cualquiera todavía puede construir las herramientas terrestres; un artesano no sintonizado simplemente no aprende nada al hacerlo, y las dos recetas de varillas piden además las enseñanzas de Gizzel.",
          "materialsHeading": "Reactivos y herramientas anteriores",
          "materialsBody": "Cada receta de herramienta terrestre consume la herramienta de un nivel inferior más un material FINO, y esa combinación es toda la escalera terrestre: cuatro minerales de hierro finos y un pico de minería Skysilver se convierten en el pico de minería de osmio, luego dos barras de Glyphsteel, dos minerales de osmio finos y ese pico de osmio se convierten en el pico de minería de Glyphsteel. Las líneas del hacha y la hoz reflejan la forma de herramienta fina más anterior con Fine Ashwood y Fine Highpine Logs, Fine Goldleaf y Fine Sunpetal Herbs, aunque sus peldaños de nivel 5 no requieren barras de Glyphsteel: la púa es la única línea que se vuelve más cara en la parte superior. Las dos recetas de caña rompen el patrón a propósito: el Stormreel toma cuatro Sunglint Koi y una caña Silverstream, el Tidewrought dos Koi, ocho Raw Slatefin Carp y ese Stormreel, por lo que la parte superior de la escalera del pescador se paga en el agua en lugar de en una vena.\n\nUn material fino no se vende en ninguna parte y no cae de una cosecha ordinaria: se obtiene trabajando una de las vetas de grado completo de una zona con una herramienta clasificada por encima del material en sí, lo que en la práctica significa que la herramienta está un peldaño por debajo de la que estás tratando de construir (las vetas más fáciles que una zona mantiene para los viajeros producen el material simple sin importar lo que hagas). Eso es deliberado. En la ruta de manualidades, una herramienta de nivel 5 proviene de usar la de nivel 4, no de un viaje de compras; el contador de Marcas de Profundidad es el único camino a seguir. La única excepción es la barra de acero Glyphsteel, refinada y exclusiva del proveedor, 1 plata 60 cobre por barra del intendente Bree en Highwatch o del propio mostrador de Gizzel, por lo que solo el pico de minería Glyphsteel tiene un piso de monedas fijo incorporado en su costo.",
          "ladderHeading": "La escalera de herramientas",
          "ladderBody": "La escalera consta de ocho recetas, todas vinculadas a la estación de herramientas. Las seis recetas de herramientas terrestres se conocen automáticamente, sin costo alguno para el entrenador: el pico, el hacha y la hoz de nivel 4 en la habilidad 75, y las versiones de nivel 5 en la habilidad 150. Ese segundo número no es un error tipográfico y se ubica por encima del límite actual de 125 a propósito: los requisitos de habilidad nunca bloquean una nave aquí, solo determinan la ganancia de habilidad, por lo que puedes construir una herramienta de nivel 5 el día que tengas sus reactivos y su predecesor de nivel 4. Las dos cañas elaboradas son la excepción enseñada: Gizzel enseña Stormreel en la habilidad 75 por 4 de oro y Tidewrought en la habilidad 125 por 16 de oro, cada una en el momento en que tu nivel en la nave alcanza el suyo.\n\nCada herramienta terminada es de calidad única o épica y viene firmada, por lo que tu nombre aparece en las zonas de los cinturones de herramientas de otros jugadores. Ingeniería también contiene la mitad de una receta combinada: el Elixir del Oso, elaborado por un Bombardier sintonizado con Ingeniería y Alquimia en 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Todo encantamiento se conoce desde el principio, cualquiera puede desencantarse desde el primer día, y ninguno de los dos necesita nunca una estación; el límite de habilidad es 125 como cualquier oficio. El único rincón del oficio donde se enseña es su par de recetas de encantamientos: Tinker Gizzel enseña el Alijo del Recolector y el Ojo del Artesano en la fábrica de herramientas en la esquina suroeste de Eastbrook Square, por la tarifa de nivel ordinaria una vez que tu Encantamiento llega a 25, y los encantamientos mismos se trabajan en su estación.\n\nEn el anillo se encuentra entre Inscripción y Joyería, por lo que sus dos identidades son el Arcanista (Inscripción y Encantamiento) y el Enclavador de Gemas (Encantamiento y Joyería). Ninguno de los dos puede jurar todavía, ya que ambos vecinos esperan sus primeras recetas, por lo que hoy Enchanting asciende como oficio de todos: gratis al nivel raro antes de cualquier juramento y un pasatiempo natural para un Bombardier o un Boticario. Los encantadores también mantienen el mundo de reunión en funcionamiento: los dos efectos de las herramientas que se pueden colocar son trabajo del encantador, y un artesano original recarga sus propios efectos con un descuento, aún más profundo una vez que se especializa.",
          "levelingHeading": "Cómo sube el encantamiento",
          "levelingBody": "Tres acciones mueven la habilidad: desencantar una pieza, aplicar un encantamiento y crear los dos amuletos, que ascienden en la curva de elaboración ordinaria. Cada éxito vale hasta un punto, calculado según la seriedad del trabajo: la rareza de la pieza que rompes o el nivel de reactivo del encantamiento que aplicas. Los desencantamientos comunes y los encantamientos de sólo polvo se consideran trabajo común; desencantamientos poco comunes y encantamientos de esencias como poco comunes; desencantamientos raros y cada encantamiento rúnico o mayor como raro; Los desencantamientos épicos y legendarios ocupan un lugar aún más alto en la mesa, aunque hoy en día ninguna identidad encantadora supera el peldaño raro, por lo que pagan lo mismo que un trabajo raro en la práctica. Una honestidad gobierna el banco de break: una pieza que salió de un banco de jugadores (elaborada, firmada o trabajada con maestría) todavía se transforma en materiales pero no enseña nada, por lo que un ciclo de creación y descanso no nivela a nadie, y las lecciones están en equipo encontrado en el mundo.\n\nEl familiar desvanecimiento de dominio se aplica en niveles de 25 puntos, por lo que el trabajo de grado común se vuelve gris en la habilidad 75, el trabajo poco común en 100 y el trabajo de nivel raro exactamente en el límite de 125. El encantamiento también tiene una bondad propia: la entrada por encima del techo de tu arquetipo se redondea hacia abajo hasta ese techo en lugar de ponerlo a cero, por lo que antes de sintonizarte, un desencantamiento épico simplemente se califica como raro en lugar de no enseñar nada. Si Encantamiento termina inactivo detrás de otra identidad, romper y aplicar puntuación como trabajo común y la subida se detiene en 75, mientras que los dos encantamientos, recorriendo la curva de elaboración por encima del techo común, no le enseñan nada en absoluto a un encantador inactivo; manténgalo como su pasatiempo y el trabajo de nivel poco común aún vale la pena, solo que más lento después de 75.",
          "marketHeading": "Copias encantadas, procedencia y el mercado",
          "marketBody": "La aplicación de un encantamiento gasta los reactivos y marca una copia específica del artículo. Apunte a una copia en bolsa y obtendrá una copia encantada distinta; apúntalo a una pieza que ya estás usando y quedará encantada en el lugar, justo donde está, sin baile de desequipamiento y reequipamiento. De cualquier manera, el bono sigue a esa pieza para siempre, a través de desequipamientos, viajes a bancos y intercambios. Un encantamiento por pieza: aplicar un encantamiento diferente a una copia encantada solicita confirmación, luego reemplaza el antiguo encantamiento por completo, destruyéndolo sin reembolso de sus materiales. Vender, descartar y desencantar prefiere primero las copias simples, para que la pieza terminada no se coma por accidente.\n\nEl equipo de obra maestra y el encantamiento son amigos: una pieza de obra maestra sigue siendo totalmente encantable, y el encantamiento se suma a la bonificación de obra maestra sin alterarla ni alterar la firma del creador. Al acumular todas las fuentes, una obra maestra firmada que lleva un encantamiento mayor es lo mejor que obtiene una pieza elaborada, y aún se encuentra debajo del botín de incursión por diseño.\n\nEn el mercado, una pieza encantada o firmada aparece como cualquier otra cosa: aparece como su propia lista de copia única, la información sobre herramientas muestra el encantamiento y la marca del fabricante, y el Ravenpost la lleva con la misma fidelidad. Los materiales siguen siendo la mitad estable del oficio: el polvo, la esencia y los fragmentos se enumeran libremente, cotizar no cuesta nada y el comerciante se queda con el 5 por ciento de una venta completada. Eso hace que los dos encantadores clásicos se ganen vendiendo materiales y vendiendo trabajos terminados: en el mercado, a través de un cuervo o cara a cara en una ventana comercial."
        }
      },
      "howHeading": "Cómo funciona la artesanía",
      "howBody": "Abra la ventana de elaboración (tecla predeterminada T) y cada receta que conoce aparecerá en una lista con lo que necesita y lo que tiene a mano. Las recetas vinculadas a la estación te piden que te quedes a 20 yardas de la estación correcta en la ciudad, las recetas de campo se elaboran en cualquier lugar, y la ruptura y el encantamiento de Enchanting no necesitan ninguna estación (solo sus dos recetas de encantamiento son trabajo de estación, en las herramientas). No hay tirada de fracaso: una manualidad con los materiales en la mano siempre tiene éxito.\n\nDos pequeñas fricciones mantienen la economía honesta. Cada artesanía exitosa paga una tarifa de 2 cobre por punto del presupuesto de estadísticas del objeto, y las acciones de tipo artesanía comparten un mismo ritmo: como máximo 10 artesanías, desencantamientos, encantamientos, salvamentos o recargas de herramientas en cada ventana de 60 segundos. Ninguno de los dos perturbará una sesión normal; Ambos evitan que un especialista al máximo inunde el mercado.",
      ...
      "masterworkBody": "Cada artesanía exitosa es exactamente lo que promete la receta y, a veces, un poco más: una obra maestra termina la misma pieza con un nivel de calidad mejor, con las estadísticas adicionales incorporadas en el momento de la elaboración. Es solo un complemento, nunca una degradación, y permanece por debajo del nivel de la banda, por lo que el equipo elaborado puede ser excelente sin reemplazar un lanzamiento de banda.\n\nLa probabilidad es publicada, no mística: {base}% de base, más {perTier}% por cada nivel en el que tu habilidad se encuentre por encima de la receta, más {signed}% cuando ingresa cualquier reactivo firmado, más {spec}% una vez que estás especializado, con materiales de nivel superior que agregan entre un 1 y un 2 % más, todo con un límite de {cap}%. Sólo una pieza con estadísticas reales puede mejorar, por lo que los bienes comunes, las herramientas y los consumibles sin estado nunca se activan; una nave inactiva nunca produce uno, y una nave de hobby no puede superar su raro techo.\n\nEl buen trabajo lleva a su creador. Las producciones raras y mejores están firmadas, cada copia (Elaborada por; los materiales reunidos se llevan Recogido por), una obra maestra siempre está firmada sea cual sea su calidad. Una firma es procedencia, no un candado: los bienes firmados se comercializan, envían por correo y cotizan en el Mercado Mundial libremente.",
      "trainingHeading": "Entrenamiento",
      "trainingBody": "Las recetas de los entrenadores provienen de los maestros residentes y se enseñan en sus estaciones. La regla es una línea: un maestro enseña una receta una vez que tu nivel en el oficio ha alcanzado el propio nivel de la receta, y nada más la controla, ni tu nivel, ni tu arquetipo. Las escaleras de equipo y consumibles pasan por sus peldaños en las habilidades 0, 25 y 50; Las dos lecciones de ingeniería continúan la escalera en 75 y 125, y las dos recetas de encanto de Enchanting se ubican en el peldaño 25, por lo que se abre un nuevo peldaño a medida que suben tus niveles.\n\nLas tarifas son únicas y fijas por peldaño: el peldaño inicial es gratuito, el peldaño de habilidad 25 cuesta {tier1} una receta, el peldaño de habilidad 50 {tier2} y las lecciones de barra superiores tienen sus propias tarifas, que se enumeran al lado de cada receta en la tabla. Debes pararte en la estación real del maestro para entrenar, y una estación móvil nunca cuenta. Las recetas de campo comunes y las seis recetas de herramientas terrestres elaboradas no necesitan ningún entrenamiento; Cada personaje los conoce desde el principio.",
      ...
      "ench": {
        ...
        "enchantsNote": "Los encantamientos vienen en tres niveles. El nivel base funciona con Chime Dust (con un poco de Essence en el extremo superior) y cubre la ranura para armas más todas las ranuras para armadura excepto la mano izquierda, con suficientes opciones de eje de estadísticas para que cada construcción encuentre algo para cada ranura. El nivel mayor cuesta un Chime Shard más Essence: bonificaciones más fuertes en las ranuras de mayor impacto. Además, los fragmentos alimentan dos sumideros más, las dos recetas de encantamientos a cinco cada una y el peldaño superior de recargas de efectos de herramientas, así que guarda algunos antes de gastar.\n\nEntre ellos se encuentran los cinco encantamientos rúnicos, un consumidor por secundario escrito, por lo que nada de lo que hagas será un callejón sin salida: Runed Edge (arma, fuerza, consume acero resonante), Runed Sigil (arma, intelecto, madera resonante), Runed Weave (pecho, espíritu, hilo resonante), Runed Hide (piernas, agilidad, piel resonante) y Runed Links (casco, resistencia, enlaces resonantes). Cada uno también necesita dos Chime Essence; donde una ranura y una estadística tienen una base y un encantamiento mayor, la bonificación de runas se encuentra entre ellos, mientras que Runed Weave es el encantamiento de espíritu de cofre más fuerte y Runed Hide es el único encantamiento de agilidad para las piernas. Los bonos exactos se encuentran todos en la siguiente tabla.",
      ...
      "gatherIntro": {
        "mining": "La minería extrae mineral directamente de la roca del mundo: cobre en Eastbrook Vale, hierro en Mirefen Marsh y osmio en Thornpeak Heights, con vetas iniciales esparcidas por cada zona más joven más allá de ellas, alimentando las forjas. Abierto a todos desde el nivel 1: una selección de 20 minas de cobre de un contador de Eastbrook, Fenbridge o Highwatch abre cada veta inicial, y los peldaños más altos de la escalera de selección se activan a medida que su propio contador los gana. Seguimiento en su propio contador hasta un límite de 100.",
        "logging": "La tala extrae madera de rodales de árboles en todo el mundo: corteza de hierro en Eastbrook Vale, madera de fresno en Mirefen Marsh, pino alto en Thornpeak Heights y rodales iniciales en cada zona más joven, la materia prima para mangos, duelas y el banco del ingeniero. Abierto a todos desde el nivel 1 con un hacha de registro en sus bolsas (20 de cobre en los mostradores de Eastbrook, Fenbridge y Highwatch), rastreado en su propio mostrador hasta un límite de 100.",
        "herbalism": "La herboristería reúne lo que crece de forma silvestre: hojas de brillo en Eastbrook Vale, hojas de oro en Mirefen Marsh, pétalos de sol en Thornpeak Heights y parches iniciales en cada zona más joven, la hoja y el tallo que mantienen en marcha el oficio de boticario. Abierto a todos desde el nivel 1 con una hoz de herboristería en sus bolsas (20 de cobre en los mostradores de Eastbrook, Fenbridge y Highwatch), rastreado en su propio mostrador hasta un límite de 100.",
        "fishing": "La pesca es la más extraña entre los oficios de recolección, y la más profunda: un verdadero minijuego de morder y pescar, sus propias tablas de captura en cada una de las tres zonas centrales (las aguas jóvenes más allá de ellas sirven a la mesa del Valle por ahora) y un límite de competencia de 200, el doble que los demás. Compra una pértiga, mira hacia aguas abiertas y lanza."
      },
      "rhythmHeading": "El ritmo de recolección",
      "rhythmBody": "Una cosecha es un lanzamiento corto visible, no un agarre instantáneo: {base} segundos de base, nunca debajo de un {floor} segundo piso. Llevar una herramienta por encima del nivel del nodo, una que tu competencia te permita manejar, te acelera en {tool} segundos por nivel superior, y cada banda de competencia que cruzas recorta otros {band} segundos; simplemente hacer coincidir el nivel del nodo te lleva a la puerta, son los niveles superiores los que te hacen rápido.\n\nUna bolsa llena rechaza cortésmente el lanzamiento antes de que comience, por lo que no se desperdicia nada a mitad de camino, y cada cosecha paga una pequeña porción de XP del personaje, escalada por el nivel del nodo contra el tuyo de la misma manera que escala la XP de matar: un nodo gris trivial no le enseña nada a un personaje limitado.",
      "gainBody": "La ganancia es determinista, nunca una tirada de mejora de habilidad: un nodo en o por encima de su nivel de ganancia enseña un punto completo por cosecha, y cada competencia {step} es un nivel puntuado contra el nodo. Los nodos de nivel 1 pagan el total por debajo de 25, la mitad hasta 49, una cuarta parte hasta 74 y nada a partir de 75; los nodos de nivel 2 pagan el total a 49; los dos nodos de nivel 3 de cada operación pagan en su totalidad hasta 74 y la mitad hasta el límite de {cap}.\n\nLa ruta prevista es sencilla: aprende en los nodos iniciales del Valle, muévete hacia el pantano y termina la escalada en el terreno elevado de Thornpeak Heights. En el límite, el aprendizaje se detiene, pero los rendimientos no: un recolector limitado sigue obteniendo las mejores probabilidades que ofrece la operación para siempre.",
      ...
      "toolsNote": "Cada nodo necesita su herramienta comercial en sus bolsas, incluido el nivel 1: sin pico, sin mineral, sin caña, sin pescado. La escala de proveedores cubre los niveles 1 a 3 en los tres centros centrales: la herramienta de nivel 1 se vende en los tres, los peldaños superiores donde comienza el terreno que las usa (Fenbridge agrega el nivel 2, Highwatch nivel 3), y los asentamientos más jóvenes más allá de ellos no tienen herramientas en absoluto, así que equípese antes de viajar. Cada mostrador vende libremente cada escalón que tiene en existencia y cualquier herramienta pasa por comercio directo; cada peldaño también cotiza en el Mercado y viaja por correo, excepto los tres entrantes terrestres de 20 cobre: ​​se compran en un mostrador o se pasan de mano en mano, y nunca se venden de nuevo, se envían por correo ni se cotizan en la lista. Lo que está cerrado es el manejo. Una herramienta terrestre por encima del nivel 1 funciona solo una vez que su competencia en su propio oficio la haya obtenido, {tier2Prof} para el nivel 2, {tier3Prof} para el nivel 3 y 85 y 100 para los dos peldaños creados, y la fila del proveedor, la información sobre herramientas y la tabla a continuación mencionan el requisito por adelantado. Hasta entonces, una herramienta comprada con anticipación simplemente espera en sus bolsas, sin abrir terreno, sin comprar velocidad y sin acuñar calificaciones finas, y luego la empuña en el momento en que su contador toca su número. Las cañas de pescar son la única excepción: ninguna caña exige un requisito de manejo, y Trader Wilkes en Eastbrook deliberadamente almacena cañas de nivel 2 y 3 para los pescadores que compran con anticipación. Una herramienta nunca ocupa un espacio de equipo y nunca se desgasta, por lo que cada una es una compra única, y solo el nivel importa para la puerta: una herramienta más rara del mismo nivel no abre nada adicional. Pero la rareza no es sólo el color. Hace que el efecto de herramienta ranurada dure más y, en una caña, amplía la ventana del carrete.\n\nUna mejor herramienta compra tres cosas, no dos. Abre terrenos de mayor nivel, acorta el lanzamiento y mejora lo que sale: se trabaja una veta con una herramienta situada POR ENCIMA del material propio de la zona y la cosecha arroja la calidad fina en lugar de la simple. La veta tiene que ser una de las de plena ley de la zona, por lo que las vetas más fáciles que una zona mantiene para los viajeros aún producen el material ordinario. Los materiales finos son lo que consumen las recetas de herramientas elaboradas, y una calidad fina cuenta como su versión ordinaria en cualquier lugar donde una receta o una orden de trabajo lo solicite, por lo que la actualización nunca lo deja abandonado: solo significa que su mineral de cobre llega como mineral de cobre fino.\n\nPor encima de la escalera de proveedores, cada comercio tiene dos herramientas artesanales, nivel 4 y nivel 5, fabricadas en las fábricas de herramientas (cada personaje conoce las recetas de la tierra; la habilidad que sube para el trabajo es la de Ingeniería), o compradas con Marcas de Profundidad en el mostrador de Letanía Ahogada una vez que se alcanzan sus puertas de autorización: la tabla a continuación muestra el precio de las Marcas y las autorizaciones que pide cada peldaño. Ningún comerciante los vende jamás por monedas. La pesca tiene su propia pareja, y se aprenden del fabricante de herramientas en lugar de conocerse desde el principio. Hoy en día, ningún nodo ni agua necesita más que el nivel 3, por lo que los dos peldaños superiores compran velocidad, pendiente y una ventana de carrete más amable en lugar de acceso, y serán el boleto de entrada cuando llegue un terreno de nivel superior.",
      "toolCrafted": "Elaborada ({craft})",
      "toolCraftedOrMarks": "Crafted ({craft}) or {marks} Marcas de Profundidad after three Letanía Ahogada clears",
      "toolCraftedOrMarksHeroic": "Crafted ({craft}) or {marks} Marcas de Profundidad after a Heroic Letanía Ahogada clear",
      "toolVendor": "{name} ({hub})",
      ...
      "bandsBody": "Las bandas de competencia son la escalera compartida 0/100/200 sobre el mostrador de un oficio. Para los intercambios de tierras, la banda cruzada en 100 afeita el elenco de recolección y su límite hace que la banda 1 sea el techo. Las bandas de pesca no afeitan nada: seleccionan las tablas de captura (con una caña a juego), sólo la pesca llega a la banda 2, y la subida misma es lo que lleva al pescador a aguas más profundas, donde viven las mejores tablas y las lecciones posteriores.",
      ...
      "specimenBody": "Mantenga un poco de espacio libre para las bolsas cuando cultive: una ganancia inesperada firmada necesita espacio propio o una pila firmada correspondiente para aterrizar, y si nada encaja, el rendimiento aún llega, pero la firma se pierde. La recolección de cadáveres también tiene su propio premio mayor: alrededor del {pct}% de cada componente recolectado resulta raro o mejor. Una familia que tiene un espécimen perfecto para donar (piel, seda, veneno, carne) mantiene su producción ordinaria sencilla y acuña el espécimen firmado junto a él; todas las demás familias firman el rendimiento.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "El hito 100 inscribe Old Salt y 200 inscribe Master Angler con su título, la cima del arte del pescador; La pesca también cuenta para Master Gatherer, que se obtiene a 100 en tres oficios de recolección. Un primer pez de cada una de las aguas de las seis zonas llena su propia página, las tres zonas del corazón y Willowfen, Galecrest y Farshore más allá de ellas, y el Sunglint Koi registra Glimmer of Hope, por lo que los viajeros con una caña en su mochila llenan su libro más rápido de lo que esperan."
      },
      "fish": {
        "startHeading": "Primeros pasos",
        "startBody": "Una caña de pescar simple cuesta 20 cobre en Fisherman Brandt en Eastbrook (busque Old Salt en el extremo este de la ciudad, junto a la carretera hacia Mirror Lake); Tinker Gizzel, el abastecedor Hale en Fenbridge y el intendente Bree en los postes de stock de Highwatch también. Use la caña mirando hacia agua lo suficientemente profunda como para contener peces, hasta aproximadamente 24 yardas por delante de usted, y su corcho navegará.\n\nNo puedes lanzar mientras estás en combate, mientras nadas o mientras estás muerto: lanzar desde la orilla es la postura prevista. Sin embargo, el agua se vuelve más dura a medida que lo hace la tierra: el pantano quiere al menos el Ironreel de nivel 2 y los picos el Silverstream de nivel 3, y un sedal lanzado sin la caña que toma el agua nunca sale de tu mano. Dos varillas se encuentran encima de ellas, el Stormreel y el Tidewrought: los ingenieros los fabrican en las fábricas de herramientas con lo que saca una línea, y el mostrador de excavación de Letanía Ahogada los vende por Marcas de Profundidad detrás de sus puertas transparentes, aunque nunca por monedas. No les pide agua, por lo que compran una espera más corta y una ventana de carrete más amplia en lugar de acceso, lo que en el peldaño superior significa un bocado en tres segundos planos.",
        "biteHeading": "Picada y cobranza",
        "biteBody": "Después del lanzamiento, se produce una mordida en un momento oculto entre {min} y {max} segundos; el retraso se decide cuando llega la línea, por lo que no hay dos lanzamientos iguales. Cuando el corcho muerde, tienes {reel} segunda ventana para presionar la caña nuevamente y enrollar: enrolla dentro y la captura aterriza, duda y el pez se escapa sin nada que mostrar. Una sesión completa tiene un límite de {cap} segundos, por lo que incluso un lanzamiento silencioso se resuelve rápidamente.\n\nLas mejores cañas afinan ambos extremos del minijuego: cada nivel de caña por encima del primero recorta {rod} segundos de la espera más larga posible, nunca por debajo del piso de tres segundos la caña superior ya roza, y agrega {reelRod} segundos a la ventana del carrete, por lo que Ironreel reduce la peor espera a 6,5 segundos con una ventana de 3,25 segundos, y Silverstream a 5 con una ventana más allá de 4, su rareza ensancha el carrete un poco más allá del nivel. solo paga. Los bocados más rápidos nunca cambian lo que sea que tengas, y solo necesitas tener una caña en tus bolsas para contar.",
        "scheduleHeading": "Ganancia de pericia",
        "scheduleNote": "La ganancia de pesca sigue un cronograma fijo sin dados: un punto completo por captura por debajo de 50 de competencia, medio punto por debajo de 100, una décima parte por debajo de 150 y un lento goteo de 0,02 de 150 a 200. Ese último tramo es un viaje de miles de capturas a propósito: 200 es una declaración, no una parada en el camino hacia otra cosa.\n\nLa basura deja de enseñar por completo en {cutoff}: de ahí en adelante, las malas hierbas y las botas son sólo malas hierbas y botas. El agua en sí misma también culmina la lección: las aguas de nivel 1 de Vale (y todas las costas jóvenes más allá del corazón) no enseñan nada más allá de 100, la parada del pantano en 150, y solo la escuela de Thornpeak es un pescador hasta llegar a 200. De lo contrario, cada captura desembarcada gana al ritmo programado, por lo que cuando el contador se detiene, el cronograma le indica que busque aguas más profundas.",
        "colProficiency": "Pericia",
        "colGain": "Ganancia por captura",
        "belowFmt": "Por debajo de {below}",
        "tablesHeading": "Tablas de capturas",
        "tablesNote": "Su competencia selecciona una de las tres bandas de captura: banda 0 desde el principio, banda 1 en 100, banda 2 en 200, cada una cambiando el peso de los anzuelos vacíos y basura a peces reales, zona por zona. Cada banda por encima de la primera también exige una caña: la banda 1 quiere el Ironreel de nivel 2, la banda 2 el Silverstream de nivel 3. Tu banda efectiva es la menor entre lo que tu habilidad ha ganado y lo que soporta tu caña, y la tapa es silenciosa: con una caña menor aún atrapas, justo fuera de la mesa de la banda inferior, así que si tus capturas se atascan mientras tu habilidad sube, revisa tu caña primero.\n\nLas aguas de cada zona contienen su propio par de peces comestibles, que se curan más cuanto más profunda es la zona, todos ellos insumos para cocinar y alimentos perfectamente buenos para sentarse y comer crudos fuera de la línea. El resto de la tabla es el impuesto del pescador: hierba, alguna que otra bota y el anzuelo vacío, que nunca desaparece del todo. Cuánto pagas depende del agua en la que aterriza tu corcho, no de dónde estás parado: un lanzamiento alcanza hasta 24 yardas, y la caña que exige el agua, la mesa de la que extrae, la escritura que acredita y hasta dónde enseña, todo responde a la zona a la que pertenece el agua, se decide en el momento en que aterriza la línea. El agua de cada zona está escrita para una banda propia, el valle para la banda 0, el pantano para la banda 1, los picos para la banda 2, y pescar una banda debajo convierte aproximadamente un tercio de sus lances en anzuelos vacíos, dos bandas debajo más de la mitad. La caña te lleva al agua; la habilidad es lo que hace que rinda, y la subida es lo que lleva al pescador a mayor profundidad, porque mejores bandas no sólo significan mejor salario: más allá del Valle son las únicas aguas que siguen enseñando. El {rare} es la única fila que responde a su banda de captura y nada más: las mismas probabilidades en cada zona, y seis veces más probable en la banda 2 que en la banda 0, por lo que la cosa más rara en el muelle es en la que un maestro pescador realmente es mejor.",
        ...
        "koiBody": "Cada masa de agua del juego esconde el mismo premio: el Sunglint Koi, un brillo poco común en la línea que vale 75 monedas de cobre para un vendedor y mucho más para tu orgullo. Sus probabilidades responden a su banda de captura y nada más, las mismas en todas las zonas: una fila del 1 por ciento de la tabla de captura en la banda 0, 3 en la banda 1 y 6 en la banda 2, extraída en cada lance enrollado, de modo que el koi llega al pescador que se ganó las tablas profundas. Al aterrizar uno, se registra Glimmer of Hope en su Libro de hazañas, una marca de coleccionista sin renombre. Cuando sucede, el registro se asegura de que usted lo sepa."
      },
      "econ": {
        ...
        "trainingNote": "Una tarifa fija por nivel de receta, que se cobra una vez cuando un maestro la enseña; Cada peldaño de la siguiente tabla está en uso hoy en día, desde las recetas de inicio gratuitas hasta las lecciones de varillas del fabricante de herramientas en la parte superior.",
        ...
        "provenanceBody": "Algunos artículos llevan un nombre. Pase el cursor sobre uno y la información sobre herramientas dice Reunido por fulano de tal en una materia prima, o Elaborado por fulano de tal en una pieza terminada: la misma marca, redactada según cómo surgió el artículo. Una firma es parte del artículo en sí, viaja con él a través del comercio, el banco, el correo, el mercado mundial e incluso la recompra de un proveedor, y nunca se desvanece.\n\nLa recolección firma automáticamente su mejor trabajo: cualquier cosecha que resulte rara o mejor llega firmada, y los hallazgos raros firman su ganancia inesperada quíntuple. El rollo de la suerte de una cosecha de cadáveres firma su rendimiento cuando la familia no tiene espécimen para dar, y cuando lo tiene, mantiene el rendimiento simple y acuña el espécimen prístino firmado a su lado. Elaboración de letreros en la misma línea: cada copia de una producción rara o mejor se acuña firmada, y una obra maestra siempre firma independientemente de su calidad, por lo que la mejor versión de cualquier pieza siempre nombra a su creador. Lo único que puede costarle una firma es una bolsa llena: una unidad firmada necesita espacio propio, o una pila firmada correspondiente, para aterrizar.\n\nUna pila de elementos comparte una identidad, por lo que dos copias se fusionan solo cuando cada marca coincide exactamente: el mismo elemento, el mismo firmante, las mismas estadísticas de obra maestra, el mismo encantamiento, el mismo vínculo. Un tronco firmado nunca se une a una pila simple en ninguna dirección (la fusión borraría el nombre de alguien), pero cargas útiles idénticas se fusionan felizmente, por lo que veinte minerales firmados por el mismo recolector se ubican en una pila y una ganancia inesperada no destruye tus bolsas.\n\nLas firmas devuelven el dinero a los artesanos: mantener cualquier copia firmada de un reactivo necesario en el banco, quienquiera que lo haya firmado, agrega 2 puntos porcentuales de probabilidad de obra maestra, y sostener un reactivo firmado por su propia mano reduce la cantidad requerida de ese reactivo en uno (nunca menos de uno). Tu propio trabajo firmado, raro o mejor, incluso sigue enseñándote, hoy solo a través del frasco: bebe una poción que firmaste y un pequeño hilo de habilidad fluye de regreso al oficio que la elaboró, siempre y cuando ese oficio sea una de tus especialidades activas.",
        ...
        "throttleBody": "La producción tiene un límite: la creación, el desencantamiento, el encantamiento, la recuperación y las recargas de efectos de herramientas comparten un presupuesto de {actions} acciones exitosas en cada ventana de {seconds} segundos. Un intento rechazado no cuesta nada y no gasta ningún presupuesto. Nunca lo sentirás en el juego normal; existe para que un especialista al máximo con un banco lleno no pueda inundar el mercado, independientemente de su habilidad o reserva.",
      ...
      "faq": {
        ...
        "a4": "Obtuviste una ganancia inesperada. Aproximadamente 1 cosecha entre 90 desencadena un evento de recolección poco común (duramen antiguo en un árbol, una veta prístina en un mineral, una floración iluminada por la luna en unas hierbas): multiplica el rendimiento cinco veces, firma cada unidad con tu nombre y anuncia el hallazgo en toda la zona. Una tirada de rareza rara o mejor en una cosecha normal también indica el rendimiento.\n\nVale la pena conservar o vender los materiales firmados: tener cualquier copia firmada de un reactivo necesario en el banco añade 2 puntos porcentuales a la posibilidad de realizar una obra maestra. Solo recuerde que solo se apilan con copias firmadas idénticamente, por lo que mantienen su propia ranura para bolsa.",
        ...
        "a6": "Las nueve recetas de campo comunes y las seis recetas de herramientas terrestres elaboradas son conocidas por todos desde el principio, al igual que las tres piedras angulares vinculadas a la estación (el manto Kilnscale, la capucha Wardweave y las envolturas Duskhide), que no necesitan entrenador, solo su estación. Todo lo demás lo enseñan los maestros residentes en sus estaciones en las tres ciudades centrales: la mayoría se encuentra en Eastbrook, el curtidor mantiene la curtiduría en Fenbridge y el alquimista mantiene el boticario en Highwatch.\n\nLas recetas de los entrenadores se ejecutan en peldaños: habilidades 0, 25 y 50 para el equipo y las artesanías consumibles, con precio gratuito, 25 de plata y 1 de oro como tarifas únicas; Las dos recetas de encantamientos de Enchanting se encuentran en el peldaño 25, y el fabricante de herramientas enseña las dos cañas de pescar elaboradas en 75 y 125 por 4 y 16 de oro. Un maestro enseña una receta una vez que tu grupo en ese oficio ha alcanzado el grupo de la receta, y debes estar parado en su estación para aprender: una estación móvil no cuenta.",
        "q7": "¿Por qué mi recolección se volvió más lenta de repente?",
        "a7": "El lanzamiento de recolección comienza en 2,5 segundos y se reduce de dos maneras: 0,4 segundos por cada nivel de herramienta que llevas y puedes manejar por encima del propio nivel del nodo, y 0,15 segundos una vez que el contador de tu comercio cruza su banda de 100, con un piso de 1,5 segundos. Muévase de los nodos del nivel 1 a los nodos del nivel 3 y su excedente desaparecerá, por lo que la misma selección volverá a oscilar más lentamente. Mantener exactamente el nivel requerido no compra velocidad; solo abre el nodo.\n\nLa ganancia de habilidad se desvanece de la misma manera que lo hace la artesanía: un nodo se vuelve gris a medida que su competencia pasa de su nivel (los nodos de nivel 1 no enseñan nada a partir de la competencia 75 en adelante), por lo que la respuesta a las ganancias lentas son los nodos de nivel superior. Esos necesitan una herramienta de al menos su nivel en sus bolsas (nunca se trabaja ningún nodo con las manos desnudas, incluido el nivel 1), y una herramienta terrestre por encima del nivel 1 también quiere su marca de manejo primero, 40/70/85/100 en su propio oficio para los niveles 2 a 5. La pesca sigue su propia reducción: ganancia total por debajo de 50 de competencia, la mitad por debajo de 100, un goteo de 0,1 por debajo de 150 y 0,02 por debajo de 200, las capturas de basura no enseñan nada a partir de 100 y el agua misma limita la lección (las aguas de nivel 1 dejan de enseñar en 100, el pantano en 150), por lo que un contador detenido también puede significar que se le ha quedado pequeño el agua.",
        "q8": "¿Puedo crear objetos lejos del pueblo?",
        "a8": "En parte. Las nueve recetas de campo comunes (el arma inicial, la armadura, la comida y las pociones básicas) se elaboran en cualquier lugar y en cualquier momento, al igual que las tres recetas combinadas de las parejas juradas. Todo lo demás que está encima de ellos está vinculado a un tipo de estación: forja, cocinas, boticario, curtiduría, telar o taller de herramientas, y debes estar a menos de 20 yardas de la estación para que la nave pueda pasar.\n\nCon 75 de habilidad en un oficio, te especializas y, junto con un descuento del 20 por ciento en materiales, obtienes una estación móvil: colócala en el campo y permanecerá en pie durante 10 minutos, sirviendo las recetas de ese oficio como si estuvieras en el mundo real. La estación móvil es solo para manualidades: aprender recetas y comisiones libres siempre requiere la verdadera estación en la ciudad."
      }
    },
    "economy": {
  ...
  "questUi": {
    ...
    "log": {
      ...
      "cooldownStatus": "Disponible nuevamente pronto",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Artículo desconocido {id}, cantidad {count}",
      "unknownItemAriaMasterwork": "Artículo desconocido {id}, cantidad {count}, obra maestra",
      "unknownItemAriaEnchanted": "Artículo desconocido {id}, cantidad {count}, copia encantada",
      "unknownItemAriaBound": "Artículo desconocido {id}, cantidad {count}, copia encuadernada",
      "unknownItemAriaInstanced": "Artículo desconocido {id}, cantidad {count}, copia marcada por el fabricante"
    },
    "equipment": {
      "empty": "Vacío",
      "levelClass": "Nivel {level} {className}"
    ...
    "vendor": {
      ...
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Compre {count} a la vez",
      "qtyCustom": "Costumbre",
      "qtyCustomAria": "Elija una cantidad personalizada para comprar",
      "buyCountAria": "Compre {count} de {item} por {price}",
      "buyCountAriaWithRequirement": "Compre {count} de {item} por {price}. {requirement}",
      "buyQuantityTitle": "¿Comprar cuántos {item}? Hasta {max}.",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_copper_ore": {
        "name": "Mineral de cobre fino"
      },
      "fine_iron_ore": {
        "name": "Mineral de hierro fino"
      },
      "fine_thorium_ore": {
        "name": "Mineral fino de osmio"
      },
      "fine_ironbark_log": {
        "name": "Tronco de corteza de hierro fino"
      },
      "fine_ashwood_log": {
        "name": "Tronco fino de madera de fresno"
      },
      "fine_elderwood_log": {
        "name": "Tronco fino de alto pino"
      },
      "fine_silverleaf_herb": {
        "name": "Hierba de hoja de sheen fina"
      },
      "fine_goldleaf_herb": {
      ...
      "stormreel_fishing_rod": {
        "name": "Caña de Pesca Carretormenta"
      },
      "tidewrought_fishing_rod": {
        "name": "Caña de Pesca Forjamareas"
      },
      "duskwisp_essence": {
    ...
    "quests": {
      ...
      "q_the_codfather": {
        ...
        "text": "El Padrastro no es sólo un pez, {playerName}, es un asesino a sangre fría. Los veteranos juran que desayuna Mire Prowlers, e incluso las Mirefen Widows no tejen sus telas cerca de Deepfen Shallows por puro terror. Él gobierna esas aguas, y el agua de los pantanos requiere nada menos que una caña de pescar Ironreel; mi mostrador los vende. Toma uno en la mano, saca a ese viejo diablo de sus aguas y admitiré que te has unido a la familia.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "He visto estas marcas antes, en tres tumbas antiguas alrededor del campo de batalla del norte. El Capitán Aldren se encuentra en la elevación occidental, el Sumo Sacerdote Malric más al sur a lo largo del borde occidental y el Asesino Real Voss junto al acantilado oriental. Toca cada tumba y escucha, {playerName}. Los muertos pueden recordar lo que los vivos olvidaron.",
