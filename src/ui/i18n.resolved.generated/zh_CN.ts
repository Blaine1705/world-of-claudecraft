...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "在这片土地上，初次踏上冒险之路的人照传统都会去试炼之滨走一趟，那是海峡对面的一座安静小岛。在那里你可以先磨练身手、熟悉这个世界，再去迎接它的挑战。渡船来回都通，去或不去都没人会小看你。",
      ...
      "islandArrivalNote": "刚下渡船吗？欢迎来到试炼之滨。教官玛伦在我身后这条路尽头的晨憩营地主持操练：走到她跟前，直到她的名字显示出来，然后按 F，或者用鼠标左键点击她，就能与她交谈，她会交给你第一件差事。等你准备离开时，敲响立在我码头旁的那口铃，渡航就会送你回东溪镇。",
      "noteClose": "明白了"
    },
    "tutorial": {
    ...
    "bootcamp": {
      "title": "最初的脚步",
      "moveTitle": "活动双腿",
      "moveBody": "用 {moveKeys} 朝任意方向走上几步。",
      "moveBodyTouch": "拖动屏幕下方的移动摇杆，朝任意方向走上几步。",
      "moveBodyPad": "推动左摇杆，朝任意方向走上几步。",
      "cameraTitle": "转动视角",
      "cameraBody": "按住鼠标右键并拖动来转动视角。往左右两边好好看一圈。",
      "cameraBodyTouch": "用手指拖动世界画面（不是移动摇杆）来转动视角。",
      "cameraBodyPad": "推动右摇杆来转动视角。",
      "courseTitle": "跑过试炼跑道",
      "courseBody": "现在把两样合起来：沿码头以南海滩上的旗列跑一趟。用 {jumpKey} 跃过栏杆，爬过木箱，依次碰到每一面旗，直到红旗为止。",
      "courseBodyTouch": "现在把两样合起来：沿码头以南海滩上的旗列跑一趟。用跳跃按钮跃过栏杆，爬过木箱，依次碰到每一面旗，直到红旗为止。",
      "courseBodyPad": "现在把两样合起来：沿码头以南海滩上的旗列跑一趟。用跳跃按钮跃过栏杆，爬过木箱，依次碰到每一面旗，直到红旗为止。",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "ferryman_odo": {
        "name": "渡船人奥多",
        "title": "渡口看守",
        "greeting": "刚下渡船吗，{playerName}？那就沿着岸边的路往上走：教官玛伦在晨憩营地主持操练。走到她跟前，按 F，或者用鼠标左键点击她，她就会交给你第一件差事。等谷地召唤你回去时，敲响立在我码头旁的那口铃，渡航会把你送到东溪镇上。"
      },
      "bursar_wick": {
        "name": "司库威克",
        "title": "镀金保险箱",
