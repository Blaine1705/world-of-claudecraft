...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "interfacePage": {
      ...
      "framesGovernedUnitTooltip": "“编辑框体”也会松开提示框体，也就是鼠标停留对象的卡片显示位置：生物的等级和类型，或其他玩家的头衔、公会、等级、职业，以及带职责的专精。把它拖到任意位置，卡片会从那里展开，并避开最近的屏幕边缘。在框体设置的“显示或隐藏框体”中取消勾选“提示框”，即可完全隐藏该卡片。",
