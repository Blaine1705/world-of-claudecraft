  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "notInstant": "$WOC 交易并非即时完成。卖家接受后物品进入托管，付款核实后送达买家。",
        ...
        "closeSellerHold": "你的物品仍为买家的付款保留中。如果改变主意，可在交易所的活动页签取消出售。",
        "closePaymentContinuesBuyer": "你的付款仍在确认中。配送会自行完成。",
        "closePaymentContinuesSeller": "买家的付款仍在确认中。出售会自行完成。",
        "p2pBindingNote": "双方接受后，须在 {duration} 内付款。未付款会记一次市场违约。",
        "p2pBindingNoteUntimed": "双方接受后，须在短时间内付款。未付款会记一次市场违约。",
    ...
    "wocMarket": {
      ...
      "rateNote": "当前汇率：约每美元 {tokens} $WOC，取自外部交易市场最新成交价（{time}）。",
      ...
      "bidBondNote": "出价时会冻结 {usd} 的可退还保证金（以 $WOC 支付）。被超越时退还（除非二次机会转让让你成为买家）；只有当你中标却未付款时才会被没收。",
      "bidBindingNote": "一旦签署保证金交易，出价即具有约束力：出价无法撤回；若你中标却未付款，保证金将被没收，且你的账号会记一次市场违约。",
      "bidCloseNote": "在拍卖临近结束的几分钟内保证金获得确认的出价，可能使拍卖延长几分钟。拍卖结束后，迟到的付款不会重新开启拍卖，而是会被退款。",
      "offerNextNote": "若中标者未付款，你可能按自己的出价成为买家：保证金会再次被冻结，且须在结算窗口内付款。届时未付款将没收保证金并记一次违约。",
      "buyNowNote": "“立即购买”会为你短暂保留这份挂单。若未付款就离开，你的“立即购买”会暂停一段时间。",
