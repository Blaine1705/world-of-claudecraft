...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "strafeBody": "侧向移动还有另一种办法。按一下 {strafeKey}，侧步跨进最后一条跑道，然后按住 {forwardKey}，再用 {strafeKey} 横移，直到红旗被你甩在身后。横移能让你移动时视线始终锁在目标上：总有一天你会这样作战。",
      ...
      "taskStrikeTrueBodyCaster": "走到一个草人跟前，按 {targetKey}，或者用鼠标左键点击它，把它设为目标。然后按 {attackKey}，或者点击动作条上的第二个按钮，施放你的法术。一直施放到一个散架为止。",
      ...
      "taskShellBodyCaster": "掠蟹是会回击的。按 {targetKey}，或者用鼠标左键点击一只，把它设为目标，然后按 {attackKey} 施放法术，保持距离不停施放。要是一次有太多只扑上来，就沿小路往回撤：它们很快就会放弃追赶，休息时你的生命值也会慢慢回满。",
      "taskShellBodyCasterTouch": "掠蟹是会回击的。点按一只把它设为目标，然后点按动作条上的第二个按钮施放法术，保持距离不停施放。要是一次有太多只扑上来，就沿小路往回撤：它们很快就会放弃追赶，休息时你的生命值也会慢慢回满。",
      "taskShellBodyCasterPad": "掠蟹是会回击的。按下目标键，再按下第二个动作键施放法术，保持距离不停施放。要是一次有太多只扑上来，就沿小路往回撤：它们很快就会放弃追赶，休息时你的生命值也会慢慢回满。",
