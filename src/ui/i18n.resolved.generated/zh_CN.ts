...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "stats": {
      ...
      "warfareBodyPets": "战争是唯一一项只在玩家之间的战斗中才作数的属性：它提高你和你的宠物对其他玩家及其宠物造成的伤害，也降低你和你的宠物从他们那里受到的伤害，你的面板会把这两半写在同一行上。面对野生生物时它毫无作用。它来自你用荣誉换购的战争装备，因此它是参与 PvP 的回报，而不是升级途中该去追求的东西。"
    },
    "progression": {
