...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "taskLongWalkBody": "沿着海岸路往南走到往生石前，按 {interactKey} 跪下。这里没有任何东西能伤到你，这么做也不会让你损失什么。",
      ...
      "taskShellBody": "掠蟹是会回击的。用鼠标左键点击一只，把它设为目标，然后按 {attackKey} 挥刀，不停攻击。要是一次有太多只扑上来，就沿小路往回撤：它们很快就会放弃追赶，休息时你的生命值也会慢慢回满。",
      ...
      "taskShellBodyCaster": "掠蟹是会回击的。用鼠标左键点击一只，把它设为目标，然后按 {attackKey} 施放法术，保持距离不停施放。要是一次有太多只扑上来，就沿小路往回撤：它们很快就会放弃追赶，休息时你的生命值也会慢慢回满。",
