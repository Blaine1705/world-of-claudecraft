...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "刚下渡船吗？欢迎来到试炼之滨。看守塔姆就在你正前方的海滩上守着试炼跑道：先去找他，他的跑道会把你双腿该会的都教给你。等红旗被你甩在身后，就沿码头北边的路上去晨憩营地找教官玛伦领第一件差事：走到她跟前，直到她的名字显示出来，然后按 F，或者用鼠标左键点击她交谈。等你准备离开时，敲响立在我码头旁的那口铃，渡航就会送你回东溪镇。",
      "noteClose": "明白了"
    },
    "tutorial": {
    ...
    "bootcamp": {
      ...
      "forwardBody": "穿过面前的试炼跑道大门，按住 {forwardKey} 沿第一条跑道向西走到旗帜处。",
      "forwardBodyTouch": "穿过面前的试炼跑道大门，把移动摇杆推向上方，沿第一条跑道向西走到旗帜处。",
      "forwardBodyPad": "穿过面前的试炼跑道大门，把左摇杆推向上方，沿第一条跑道向西走到旗帜处。",
      "cameraTitle": "转动视角",
      "cameraBody": "第一面旗到手。现在按住鼠标右键并拖动来转动视角：看看向南延伸的围栏跑道，然后转回原来的朝向。",
      "cameraBodyTouch": "第一面旗到手。现在用手指拖动世界画面（不是移动摇杆）来转动视角：看看向南延伸的围栏跑道。",
      "cameraBodyPad": "第一面旗到手。现在推动右摇杆来转动视角：看看向南延伸的围栏跑道。",
      "leftTitle": "向左滑步",
      "leftBody": "保持朝向不变，按住 {strafeKey} 沿南边的跑道向左横移，走到旗帜处。横移能让你移动时视线始终锁在目标上：总有一天你会这样作战。",
      "leftBodyTouch": "把移动摇杆推向左边，沿南边的跑道横移到旗帜处。",
      "leftBodyPad": "把左摇杆推向左边，沿南边的跑道横移到旗帜处。",
      "camera2Title": "再看一次",
      "camera2Body": "第二面旗到手。再按住右键转动一次视角，对准向西延伸的最后一条跑道。",
      "camera2BodyTouch": "第二面旗到手。再用手指拖动一次画面，对准向西延伸的最后一条跑道。",
      "camera2BodyPad": "第二面旗到手。再推动一次右摇杆，对准向西延伸的最后一条跑道。",
      "forward2Title": "一口气跑完",
      "forward2Body": "再次按住 {forwardKey}，沿最后一条跑道跑到红旗处。",
      "forward2BodyTouch": "再次把移动摇杆推向上方，沿最后一条跑道跑到红旗处。",
      "forward2BodyPad": "再次把左摇杆推向上方，沿最后一条跑道跑到红旗处。",
      "courseProgress": "旗帜 {current}/{total}",
      "doneTitle": "可以受训了",
      "doneBody": "腿上的功夫就这些了。教官玛伦在码头沿路而上的晨憩营地主持操练，她的第一件差事正等着你。"
    },
    "widgets": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "quartermaster_finch": {
        "name": "军需官芬奇",
        "title": "营地补给商",
        "greeting": "面包、清水、一瓶练过头时救急的药剂，还有一只装路上零碎的备用小袋。铜板能买下它们，而铜板要靠干活挣来。这就是全部的经济学，{playerName}，它永远不会变得更复杂。只会变得更大。"
      },
      "ferryman_odo": {
        "name": "渡船人奥多",
        "title": "渡口看守",
        "greeting": "刚下渡船吗，{playerName}？看守塔姆就在码头正南的海滩上守着试炼跑道：先去跑一趟他的跑道，你的双腿会感谢你的。之后晨憩营地的教官玛伦会交给你第一件差事。等谷地召唤你回去时，敲响立在我码头旁的那口铃，渡航会把你送到东溪镇上。"
      },
      "bursar_wick": {
        "name": "司库威克",
        "title": "镀金保险箱",
      ...
      "warden_tam": {
        "name": "看守塔姆",
        "title": "试炼跑道的看守",
        "greeting": "这几条跑道就是试炼跑道，{playerName}，谷地敬重的每一位冒险者都跑过它。沿第一条跑道向西走到旗帜处，好好环顾四周，再沿第二条跑道向左滑步下去，再看一圈，最后沿末尾的跑道跑到红旗处。火盆整夜不熄。等红旗被你甩在身后，晨憩营地的教官玛伦会交给你第一件差事。"
      },
      "tidewatcher_ondrel": {
        "name": "翁德雷尔·凡恩",
        "title": "守潮者",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "击中要害",
        "text": "欢迎来到试炼之滨，{playerName}。这里的每一课都从同一件事开始：站稳脚，握好刃。营地西南练武场上的草人生来就是挨打的。要是找不到练武场，按 M 打开地图：你身上的每件差事都会标在上面，用不着乱转。走到一个草人跟前，按 Tab 或用鼠标左键点击它，把它设为目标，然后按 1，或者点击屏幕底部动作条上的第一个图标，挥出这一刀。一直打到三个散架为止。它们的还击不痛不痒，这片海滨之外的东西下手可重得多。第三个倒下之后，走回我这儿来，按 F 交还任务、领取报酬：这世上每一件差事，都是这样收尾的。",
        "completion": "三个倒下，你的手也稳多了。记住这种感觉，{playerName}：选定目标，挥出一刀，然后一直打下去。谷地的狼比稻草快，但同样的算术也能放倒它们。",
        "objectives": {
          "0": {
            "label": "击倒训练草人"
          }
      ...
      "q_ps_the_wreck_line": {
        "title": "沉船滩",
        "text": "潮水用海货支付这座岛：旧沉船上的漂流货箱，被冲上练习场再往前的那片远滩。从木靶那里沿小路继续走，它会一直把你领到水边。开箱很简单，{playerName}。走到货箱跟前，直到它的名字显示出来，然后按 F，或者用鼠标左键点击货箱本身，它就会把里面的东西交出来。开三只就够了。翻拣残骸的掠蟹夹起人来比看上去疼，所以脚下留神；另外记住，你今后遇到的每一只箱子、每一处采集点、每一道门扉，用的都是同一个 F 键。",
        "completion": "绳子、焦油，还有半轮大海竟然放过的奶酪。世上到处都是值得弯腰去捡的东西，{playerName}。保持这个习惯：走近，按 F，拿走属于你的东西。",
        "objectives": {
          "0": {
            "label": "开启漂流货箱"
          }
      ...
      "q_ps_the_wheel_of_trades": {
        "title": "百业环轮",
        "text": "一柄剑只能喂饱你一顿，{playerName}，一门手艺却能喂养你一生。每个冒险者在刀剑之外都操持着专业：采矿、伐木、采药、钓鱼，还有把这一切变成价值的制作技艺。军需官芬奇的货摊就在我这操练场几步之外，而她摆过的摊子比我带过的操练还多。走到她跟前，按 F，或者用鼠标左键点击她，就能与她交谈：开箱子的那个键，同样也开启对话。",
        "completion": "玛伦总算给我送来一个值得费口舌的学生。听好了，{playerName}，只说一遍：采集从一件工具开始，矿镐、斧子、镰刀、钓竿，谷地的商人那里都有得卖。按住 Shift 再按 P，就能打开你的专业手册：那就是你的环轮，上面列着你会的每一门技艺，以及各自练到了哪一步。钻研你喜欢的那些，当你调谐到相邻的一对，这两门便成为无上限的主修，环轮对面的一门留作你的爱好，其余的则连同所学一起休眠。什么都不会失去，什么也都不是定局：技艺大师为你定下这一对，日后你想改，找技艺大师也就改了。他们就在东溪谷：锻炉旁的锻造大师达尔瓦、旅店厨房里的厨师马洛、织机前的织匠奥蒂莉、工坊里的机巧师吉泽尔，还有芬桥制革坊的皮匠赫斯克，和高哨药剂铺的炼金师薇兰。",
        "objectives": {
          "0": {
            "label": "向军需官芬奇请教百业"
          }
      ...
      "q_ps_pouch_and_purse": {
        "title": "钱囊与背袋",
        "text": "去谷地之前还有最后一课，{playerName}，也是保住冒险者性命的一课：你随身带的东西。你的背包有十六格，旁边还空着四个袋扣；每系上一只袋子，它的空间就并入总容量。所以：对着军需官芬奇按 F，打开她的货摊，在她的货品里用鼠标左键点击亚麻小袋买下它，然后按 B 打开背包，再用鼠标左键点击袋中的亚麻小袋，把它系进一个空着的袋扣。等它挂上腰带，就回来找我。",
        "completion": "好袋子，又多出六格用来装麻烦。接下来是任何袋子都装不下的另一半课，{playerName}：背不下的，交给镀金保险箱。我身后桌前的司库威克，为你打开的正是每座城镇每位司库共用的同一座金库，等你的钱袋鼓起来，还能购买更多金库空间。贵重的存进金库，袋子留出空当。塞满的行囊断送过的冒险，比任何狼都多。",
        "objectives": {
          "0": {
            "label": "购买亚麻小袋"
          }
      ...
      "q_ps_set_sail": {
        "title": "扬帆起航",
        "text": "这片海滨上已经没有你没打倒过、没打开过、没买下过的东西了，{playerName}。你准备好了，而东溪谷有真正的差事在等着。沿路走到旧码头，对着渡船人奥多按 F，告诉他，就说是我说的，你挣到了这趟航程。什么时候记不清自己欠了谁什么，随时按 L：那是你的任务日志。",
