...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "worldPvp": {
      ...
      "groupLine": "小队、团队和公会成员之间永远不会互相敌对。",
  ...
  "guide": {
    ...
    "worldPvpPage": {
      ...
      "introZones": "开放世界的玩家对战需要主动开启，而你脚下的土地决定了这意味着什么。升起你的 PvP 旗帜后，所有不在你的小队、团队或公会中且同样开启了旗帜的玩家都会在争夺地带成为敌人；降下旗帜后，稍作等待你就会重新成为旁观者。有两座区域是完全不会发生世界战斗的圣域，而三座满级区域是自由混战地带，无论是否开启旗帜，身处其中的每个人都可以被攻击。小队、团队和公会的伙伴在任何地方都不会成为你的敌人。",
