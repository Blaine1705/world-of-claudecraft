  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人布琳",
        "title": "港口向导",
        "greeting": "东溪谷来者不拒，朋友。而对脚下还不稳的人来说，总还有试炼之滨：西岸的渡船铃一年到头两个方向都响。"
      },
      "instructor_maren": {
        "name": "教官玛伦",
        "title": "试炼导师",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "钱囊与背袋",
        "text": "去谷地之前还有最后一课，{playerName}，也是保住冒险者性命的一课：你随身带的东西。你的背包有十六格，旁边还空着四个袋扣；每系上一只袋子，它的空间就并入总容量。去军需官芬奇那里买一只亚麻小袋系上，然后把这一课带去保险箱桌前的司库威克那里。他掌管的，是任何袋子都装不下的另一半。",
        "completion": "玛伦总算把她的学生送到我这儿来了。小袋归你了，这一课的另一半在这里，{playerName}：背不下的，交给镀金保险箱。任何城镇的任何司库都为你打开同一座金库，等你的钱袋鼓起来，还能购买更多金库空间。贵重的存进金库，袋子留出空当。塞满的行囊断送过的冒险，比任何狼都多。",
        "objectives": {
          "0": {
            "label": "购买亚麻小袋"
          }
