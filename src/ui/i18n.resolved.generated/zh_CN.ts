...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "strafeBody": "侧向移动还有另一种办法。按住鼠标右键并拖动来转动视角，直到面向北方、回望你刚走下来的那条跑道，然后按住 {strafeKey}，沿最后一条跑道横移到红旗处。横移能让你移动时视线始终锁在目标上：总有一天你会这样作战。",
      "strafeBodyTouch": "侧向移动还有另一种办法。用手指拖动画面转动视角，直到面向北方，然后把移动摇杆推向左边，沿最后一条跑道滑步横移到红旗处。",
      "strafeBodyPad": "侧向移动还有另一种办法。推动右摇杆转动视角，直到面向北方，然后把左摇杆推向左边，沿最后一条跑道滑步横移到红旗处。",
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "击中要害",
        "text": "练完了脚，该练手臂了，{playerName}。练武场就在我身后沿路而上的地方，那里的草人生来就是挨打的。要是找不着路，按 M 打开地图：你身上的每件差事都会标在上面。走到一个草人跟前，按 Tab 或用鼠标左键点击它，把它设为目标，然后按 1，或者点击屏幕底部动作条上的第一个图标，挥出这一刀。一直打到一个散架为止；它不会还手，草人从来不还手。操练官鲁克在练武场东侧看着场子：对着他按 F，交上这份战果。",
      ...
      "q_ps_the_wreck_line": {
        "title": "沉船滩",
        "text": "潮水用海货支付这座岛，{playerName}：旧沉船上的漂流货箱，被搬上来丢在我和晨憩营地之间的坡道旁。沿我这条路朝营地走，你正好会从它们旁边经过。开箱很简单：走到货箱跟前，直到它的名字显示出来，然后按 F，或者用鼠标左键点击货箱本身，它就会把里面的东西交出来。开三只就够了，并且记住：你今后遇到的每一只箱子、每一处采集点、每一道门扉，用的都是同一个 F 键。军需官芬奇守着营地的货摊，残骸海货连一根木棍都收：把这批货交给她。",
        "completion": "绳子、焦油，还有半轮大海竟然放过的奶酪：我全要了。既然你显然弯得下腰、扛得动货，{playerName}，就顺便听听手艺这一课。采集从一件工具开始，矿镐、斧子、镰刀、钓竿，谷地的商人那里都有得卖。按住 Shift 再按 P，打开你的专业手册：那就是你的手艺环轮，上面列着你会的每一门技艺。调谐到相邻的一对，这两门便成为无上限的主修，环轮对面的一门留作你的爱好，其余的则连同所学一起休眠。什么都不是定局：技艺大师为你定下这一对，日后你想改，随时找他们就改了。他们就在东溪谷的锻炉、厨房、织机和工坊，芬桥的制革坊，还有高哨的药剂铺。",
        "objectives": {
          "0": {
            "label": "开启漂流货箱"
          }
      ...
      "q_ps_pouch_and_purse": {
        ...
        "completion": "好袋子，又多出六格用来装麻烦。接下来是任何袋子都装不下的另一半课，{playerName}：背不下的，交给镀金保险箱。司库威克的保险箱桌就设在西边沿路而上的地方，他为你打开的正是每座城镇每位司库共用的同一座金库；等你的钱袋鼓起来，还能购买更多金库空间。贵重的存进金库，袋子留出空当。塞满的行囊断送过的冒险，比任何狼都多。",
        "objectives": {
          "0": {
            "label": "购买亚麻小袋"
          }
