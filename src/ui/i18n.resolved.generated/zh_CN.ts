  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人布琳",
        "title": "港口向导",
        "greeting": "东溪谷来者不拒，朋友。而对脚下还不稳的人来说，总还有试炼之滨：西岸的渡送法阵一年到头双向通行。"
      },
      "instructor_maren": {
        "name": "教官玛伦",
        "title": "试炼导师",
      ...
      "ferryman_odo": {
        "name": "渡船人奥多",
        "title": "渡口看守",
        "greeting": "海峡风平浪静，船也结实，{playerName}。等你准备好去谷地了，码头尽头的渡送法阵随时送你过去。"
      },
      "bursar_wick": {
        "name": "司库威克",
        "title": "镀金保险箱",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "钱囊与背袋",
        "text": "说说你身上背的东西，{playerName}。你的背包有十六格，旁边还空着四个袋扣：每系上一只袋子，它的空间就并入总容量。背不下的，交给镀金保险箱：任何城镇的任何司库都为你打开同一座金库，等你的钱袋鼓起来，还能购买更多金库空间。现在来练练这个习惯：去军需官芬奇那里买一只亚麻小袋，把它系上。",
        "completion": "好袋子，又多出六格用来装麻烦。贵重的存进金库，袋子留出空当，{playerName}。塞满的行囊断送过的冒险，比任何狼都多。",
        "objectives": {
          "0": {
            "label": "购买亚麻小袋"
          }
      ...
      "q_ps_set_sail": {
        ...
        "completion": "玛伦这么说了？能从一个曾让我练了一星期系缆绳的女人嘴里说出来，这可是极高的评价。码头尽头的法阵随时送你去谷地，{playerName}，走进去就行。当心狼群。",
        "objectives": {
          "0": {
            "label": "向渡船人奥多报到"
          }
