...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "statInfo": {
      ...
      "desc": {
        ...
        "parry": "你完全招架正面近战攻击的几率，不受伤害。来自背后的攻击无法招架。"
      },
      "effects": {
    ...
    "auraEffect": {
      ...
      "crit": "暴击几率提高 {pct}%",
      "rageGen": "怒气获取提高 {pct}%",
      "reckless": "暴击几率提高 {pct}%，怒气获取提高 {ragePct}%",
  ...
  "entities": {
    "abilities": {
      ...
      "demoralizing_shout": {
        "name": "恐怖嚎叫",
        "description": "发出可怕的怒吼，使附近所有敌人造成的伤害降低 20%，持续 20 秒。"
      },
      "charge": {
        "name": "突进",
      ...
      "overpower": {
        "name": "血手",
        "description": "立即攻击，造成武器伤害加 {damage}，并产生 {rage} 点怒气，使你的下一次致残打击效果提高 20%（可叠加两次）。无法被躲闪。"
      },
      "execute": {
        "name": "早赴黄泉",
      ...
      "mortal_strike": {
        "name": "致残打击",
        "description": "凶狠的一击，造成武器伤害加 {damage}，并使目标受到的治疗降低 50%，持续 10 秒。施加撕裂伤口（流血）。（武器专精标志技能）"
      },
      "sweeping_strikes": {
        "name": "扩展弧击",
        "description": "持续 12 秒，你的单体攻击还会对 1 个附近敌人造成 75% 的伤害。（武器）"
      },
      "deep_wounds": {
        "name": "撕裂伤口",
      ...
      "raging_gale": {
        "name": "双斩",
        "description": "立即用武器连续攻击两次，每次造成 60% 武器伤害外加 {damage} 点伤害，并产生 {rage} 点怒气。最多储存 2 次使用次数。（狂怒）"
      },
      "red_harvest": {
        "name": "血色收割",
        "description": "孤注一掷：三次凶猛的打击，每次造成武器伤害外加 {damage} 点伤害。（狂怒）"
      },
      "furious_mending": {
        "name": "狂怒愈合",
        "description": "10 秒内你受到的伤害降低 20%，持续期间你的放血将为你恢复最大生命值的 20%。（狂怒）"
      },
      "emboldening_roar": {
        "name": "振奋咆哮",
        "description": "发出振奋的咆哮：你和 40 码内的友方玩家获得振奋效果，接下来的 3 个技能必定造成暴击。（狂怒）"
      },
      "raised_guard": {
        "name": "举盾格挡",
        "description": "举盾自守：6 秒内受到的物理伤害降低 50%。（防护）"
      },
      "iron_resolve": {
        "name": "无视疼痛",
        "description": "咬牙硬撑，无视疼痛：消耗你的全部怒气（至少 20 点），每消耗 1 点怒气便吸收 4 点伤害，最多持续 10 秒。（防护）"
      },
      "faultline": {
        "name": "震荡波",
        "description": "向地面轰出一道震荡波：你面前 8 码内的敌人受到 {damage} 点伤害并被击晕 3 秒。（防护）"
      },
      "defiant_bellow": {
        "name": "挑衅怒吼",
        "description": "发出挑衅的怒吼：10 码内的所有敌人都被嘲讽，被迫攻击你，持续 3 秒。（防护）"
      },
      "breachmaker": {
        "name": "破防重击",
        "description": "重击目标，造成武器伤害外加 {damage} 点伤害，并击碎其防御：你自己对其造成的伤害提高 20%，持续 8 秒。（武器）"
      },
      "measured_fury": {
        "name": "沉稳之怒",
        "description": "你沉稳的怒火磨砺了资源运用：你的技能怒气消耗降低 10%。（武器）"
      },
      "shield_slam": {
        "name": "碎盾击",
      ...
      "die_by_sword": {
        "name": "剑在人在",
        "description": "防御性冷却：持续 8 秒，你受到的伤害降低 30%，并能躲闪更多攻击。"
      },
      "recklessness": {
        "name": "鲁莽",
