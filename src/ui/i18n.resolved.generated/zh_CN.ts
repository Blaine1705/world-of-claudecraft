...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "hintOneItem": "$WOC 交易一次只包含一件物品。请只保留要出售的那一件。",
        "hintEnterPrice": "请输入美元价格。",
        "hintAcceptNeedsItem": "接受前请先放入你要出售的物品。",
        "hintAcceptLocked": "该物品已锁定。出售前请先在背包中解锁。",
        ...
        "statusPayingSeller": "已收到付款。正在网络上确认……",
        "paidSeller": "你的 {item} 已收到 {price} 的付款。",
        "paidBuyer": "你已为 {item} 支付 {price}。",
        "closedCancelled": "本次交易已取消。物品将通过邮件退还卖家。",
        "closedSuspended": "本次交易已被游戏管理员中止。物品将通过邮件退还卖家。",
        "closedUnpaid": "本次交易因未付款而结束。物品将通过邮件退还卖家。",
        "cancelSale": "取消出售",
        "youDeclined": "你已拒绝该报价。",
        "youWithdrew": "你已撤回报价。",
        ...
        "dealAwaitsPayment": "你的 $WOC 购买尚未付款。请再次与卖家交易以付款；否则交易将自动过期。",
        "paymentConfirmed": "付款已确认。配送完成后物品将通过邮件送达。",
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC 价格恢复期间交易暂停。拍卖倒计时照常进行；价格恢复健康之前不会有任何成交。",
      "walletBanner": "绑定并验证钱包后即可在交易所出价、购买或出售。",
      "rateNote": "当前汇率：约每美元 {tokens} $WOC（{time} 更新）。",
      "estimateNote": "按当前汇率约 {tokens} $WOC。最终数额在请求付款时才会确定。",
      ...
      "detailSales": "近期成交",
      "detailSaleRow": "{usd}，由 {seller} 售予 {buyer}",
      ...
      "bidBondNote": "出价时会冻结 {usd} 的可退还保证金（以 $WOC 支付）。被超越时退还；只有当你中标却未付款时才会被没收。",
      "bidBindingNote": "一旦签署保证金交易，出价即具有约束力：出价无法撤回；若你中标却未付款，保证金将被没收，且你的账号会记一次市场违约。",
      "bidCloseNote": "在拍卖临近结束的几分钟内确认的付款可能使拍卖延长几分钟。拍卖结束后，迟到的付款不会重新开启拍卖，而是会被退款。",
      "offerNextNote": "若中标者未付款，卖家可以按下一位出价者自己的出价将物品转让给对方。",
      ...
      "termsLabel": "我接受浮动代币结算条款。",
      "termsLink": "查看市场条款",
      "quoteTitle": "确认付款",
      "quoteTotal": "合计：{tokens} $WOC",
      "quoteSeller": "卖家所得：{tokens} $WOC",
      "quoteBurn": "销毁：{tokens} $WOC",
      "quoteTreasury": "国库：{tokens} $WOC",
      ...
      "settlementFailConfirmingOverdue": "这笔付款确认耗时过长，正在接受审核。",
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "paused": "价格恢复期间交易所暂停交易。拍卖倒计时照常进行。",
      ...
      "item_mismatch": "这不是买家同意购买的那件物品。请重新发起一笔交易。",
