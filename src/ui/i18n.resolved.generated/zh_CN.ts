...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "这张面孔我可没见过，朋友。如果这是你第一次踏上这些路，有一个地方可以让你先磨练身手、熟悉这个世界，再去迎接它的挑战：试炼之滨，海峡对面的一座安静小岛。渡船来回都通，去或不去都没人会小看你。",
      ...
      "islandArrivalNote": "刚下渡船吗？欢迎来到试炼之滨。用 W、A、S、D 走路，按住鼠标右键转动视角。教官玛伦在我身后这条路尽头的晨憩营地主持操练：走到她跟前，直到她的名字显示出来，然后按 F，或者用鼠标左键点击她，就能与她交谈，她会交给你第一件差事。等你准备离开时，敲响立在我码头旁的那口铃，渡航就会送你回东溪镇。",
      "noteClose": "明白了"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_the_wreck_line": {
        "title": "沉船滩",
        "text": "潮水用海货支付这座岛：旧沉船上的漂流货箱，被冲上营地东南、面向谷地的那片海滩。开箱很简单，{playerName}。走到货箱跟前，直到它的名字显示出来，然后按 F，或者用鼠标左键点击货箱本身，它就会把里面的东西交出来。开三只就够了。翻拣残骸的掠蟹夹起人来比看上去疼，所以脚下留神；另外记住，你今后遇到的每一只箱子、每一处采集点、每一道门扉，用的都是同一个 F 键。",
