...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC 价格恢复期间交易暂停。拍卖倒计时照常进行；新的出价和付款需等价格恢复健康后再进行，已发出的付款仍会照常结算。",
      "walletBanner": "绑定并验证钱包后即可在交易所出价、购买或出售。",
      "rateNote": "当前汇率：约每美元 {tokens} $WOC，取自交易所最新成交价（{time}）。",
      ...
      "sellFeeNote": "成交后收取约 10% 手续费：3% 销毁、7% 进入国库，两项均向上取整，你收到扣除后的确切余额（约 90%）。收益随结算交易直接进入你绑定的钱包。",
