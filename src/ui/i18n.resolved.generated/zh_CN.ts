...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "qtyRowAria": "制作数量",
      "qtyDecreaseAria": "减少制作数量",
      "qtyIncreaseAria": "增加制作数量",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "econ": {
        ...
        "castPaceBody": "专业动作需要真实读条时间：简单的野外配方大约一秒半，高阶阶梯配方则需要数秒；分解、附魔、拆解与工具效果充能各自有固定的短读条。中途取消不会损失材料。每次成功制作还会按物品预算支付铜币费用。加上材料、工作台与技能上限，这种节奏在不设额外动作配额的情况下，也能让市场保持健康。",
