...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "veilbound_march": "穿过敌群施加印记，削弱其对你的伤害并稳固仇恨。",
  ...
  "entities": {
    "abilities": {
      ...
      "bastion_rite": {
        "name": "堡垒仪式",
        "description": "使受到的物理伤害降低 20%，持续 6 秒。升华将持续时间延长至 10 秒。"
      },
      "sunward_disc": {
        "name": "日耀圆盾",
      ...
      "veilbound_march": {
        "name": "帷光行军",
        "description": "进入虚灵状态4秒，移动速度提高40%、护甲提高30%，并免疫定身、减速和位移。被你穿过的敌人会受到持续6秒的帷光印记，每秒受到神圣伤害，对你造成的伤害降低20%，并对你产生额外仇恨。首次施加印记获得1点奉献。行军结束时，附近被标记的敌人受到一次终结爆发。飞升使该爆发伤害提高50%，并将敌人轻微拉向你。"
      },
      "veilbound_mark": {
        "name": "帷光印记",
        "description": "每秒受到神圣伤害，对施加印记的圣骑士造成的伤害降低20%，并对该圣骑士产生额外仇恨。"
      },
      "righteous_fury": {
        "name": "炽燃誓约",
