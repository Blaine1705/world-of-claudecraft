  ...
  "entities": {
    ...
    "npcs": {
      ...
      "quartermaster_finch": {
        "name": "军需官芬奇",
        "title": "营地补给商",
        "greeting": "面包、清水，还有一瓶练过头时救急的药剂。铜板能买下它们，而铜板要靠干活挣来。这就是全部的经济学，{playerName}，它永远不会变得更复杂。只会变得更大。"
      },
      "ferryman_odo": {
        "name": "渡船人奥多",
        "title": "渡口看守",
    ...
    "quests": {
      ...
      "q_ps_find_your_feet": {
        "title": "站稳脚跟",
        "text": "欢迎来到试炼之滨，{playerName}。这座岛上没有什么东西会主动咬人，所以趁着安静：在营地里走走，认认这里的面孔。军需官芬奇管着补给，渡船人奥多守着回家的路。去拜访他们俩，然后回来找我。",
        "completion": "脚步利落，水壶还没烧开你就回来了。现在你熟悉了营地，{playerName}，也就知道真有东西咬人的时候该往哪儿跑了。",
        "objectives": {
          "0": {
            "label": "拜访军需官芬奇"
          },
      ...
      "q_ps_strike_true": {
        "title": "击中要害",
        "text": "从没挥过的剑不过是根沉棍子，{playerName}。营地西南练武场上的草人生来就是挨打的：挑一个，站稳，砍到三个散架为止。它们不会还手。这片海滨之外的东西可会。",
      ...
      "q_ps_tools_of_the_trade": {
        "title": "谋生之道",
        "text": "铜板就是拿来花的，{playerName}，而我这摊子童叟无欺。从我这儿买一瓶治疗药剂，我会退给你比价钱更多的钱，就当学费：找到商贩，掂量价钱，数清找零。等你到了谷地，把剩下的钱花在那里商人的采集工具上。古往今来铸出的每一笔财富，都是从这么小的一步开始的。",
        "completion": "一瓶药剂，钱货两讫，退款如约奉上：这样的好买卖你以后可不常见。留着它以备不时之需，{playerName}，也记住谷地的商人向任何拿着正当铜板的人出售矿镐、斧子和镰刀。",
        "objectives": {
          "0": {
            "label": "购买初级治疗药水"
          }
