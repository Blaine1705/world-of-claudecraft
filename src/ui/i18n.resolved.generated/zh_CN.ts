...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "play": "进行新手教学",
      "skip": "跳过新手教学",
      "declineNote": "随你的意，朋友。哪天改了主意，我身旁这口铃随时都能送你去试炼之滨，不分昼夜。狼群不等人，它等。",
      "bellHomeNote": "这么快就从海滨回来了？你刚才敲响的正是渡船铃。它的孪生兄弟就立在我身旁：想回试炼之滨，随时敲响它，渡航就会送你过去。敲错了也不打紧。",
      "noteClose": "明白了"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人布琳",
        "title": "港口向导",
        "greeting": "东溪谷来者不拒，朋友。而对脚下还不稳的人来说，总还有试炼之滨：我身旁这口铃一年到头随时送你过去，岛上那口孪生铃再送你回家。"
      },
      "instructor_maren": {
        "name": "教官玛伦",
        "title": "试炼导师",
      ...
      "ferryman_odo": {
        "name": "渡船人奥多",
        "title": "渡口看守",
        "greeting": "刚下渡船吗，{playerName}？那就沿着岸边的路往上走：教官玛伦在晨憩营地主持操练，她想先跟你说上几句。等谷地召唤你回去时，敲响我码头尽头的铃，渡航会把你送到东溪镇上。"
      },
      "bursar_wick": {
        "name": "司库威克",
        "title": "镀金保险箱",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "击中要害",
        "text": "欢迎来到试炼之滨，{playerName}。这里的每一课都从同一件事开始：站稳脚，握好刃。营地西南练武场上的草人生来就是挨打的。挑一个，站稳，砍到三个散架为止。它们不会还手。这片海滨之外的东西可会。",
        "completion": "三个倒下，你的手也稳多了。记住这种感觉，{playerName}：站稳脚，抬起眼，全力挥出。谷地的狼比稻草快，但同样的算术也能放倒它们。",
        "objectives": {
          "0": {
            "label": "击倒训练草人"
          }
      ...
      "q_ps_the_wreck_line": {
        "title": "沉船滩",
        "text": "潮水用海货支付这座岛：旧沉船上的漂流货箱，被冲上面向谷地的那片海滩。翻拣它们的掠蟹夹起人来比看上去疼，所以脚下留神。撬开三只货箱，把大海留给我们的东西带回来。",
        "completion": "绳子、焦油，还有半轮大海竟然放过的奶酪。世上到处都是值得弯腰去捡的东西，{playerName}。保持这个习惯：看见，打开，拿走。",
        "objectives": {
          "0": {
            "label": "开启漂流货箱"
          }
      ...
      "q_ps_a_path_of_your_own": {
        "title": "专属之路",
        "text": "挥剑是一回事，{playerName}，明白为什么而挥又是另一回事。到了五级，世界会请你选择一门专精：你这行当的三条道路之一，各有所长。从那以后，每隔几级就会开启一排天赋，一排三选一。再击倒两个草人，趁稻草飞扬的时候，想想你要走哪一条路。",
        "completion": "又倒下两个，挥砍背后也多了几分沉稳。最要紧的是记住这一点，{playerName}：你的任何选择都不是牢笼。天赋面板随时可以打开；等你在五级做出选择之后，只要站在安全的地方，天赋和专精都可以随时重置、重新选择，分文不取。大胆去选，学到了新东西就再选一次。",
        "objectives": {
          "0": {
            "label": "击倒训练草人"
          }
      ...
      "q_ps_the_wheel_of_trades": {
        "title": "百业环轮",
        "text": "一柄剑只能喂饱你一顿，{playerName}，一门手艺却能喂养你一生。每个冒险者在刀剑之外都操持着专业：采矿、伐木、采药、钓鱼，还有把这一切变成价值的制作技艺。军需官芬奇摆过的摊子比我带过的操练还多。去问问她，一门手艺是怎么立起来的。",
        "completion": "玛伦总算给我送来一个值得费口舌的学生。听好了，{playerName}，只说一遍：采集从一件工具开始，矿镐、斧子、镰刀、钓竿，谷地的商人那里都有得卖。你的技艺构成一个环轮：钻研你喜欢的那些，当你调谐到相邻的一对，这两门便成为无上限的主修，环轮对面的一门是你的爱好，其余的则休眠，直到你重新拾起。你学会的东西永远不会失去，等你准备好了，城镇里的技艺大师会向你提供调谐。",
        "objectives": {
          "0": {
            "label": "向军需官芬奇请教百业"
          }
      ...
      "q_ps_pouch_and_purse": {
        "title": "钱囊与背袋",
        "text": "去谷地之前还有最后一课，{playerName}，也是保住冒险者性命的一课：你随身带的东西。你的背包有十六格，旁边还空着四个袋扣；每系上一只袋子，它的空间就并入总容量。去军需官芬奇那里买一只亚麻小袋，把它系上，然后回来找我。",
      ...
      "q_ps_set_sail": {
        "title": "扬帆起航",
        "text": "这片海滨上已经没有你没打倒过、没打开过、没买下过的东西了，{playerName}。你准备好了，而东溪谷有真正的差事在等着。走到旧码头去，告诉渡船人奥多，就说是我说的，你挣到了这趟航程。",
        "completion": "玛伦这么说了？能从一个曾让我练了一星期系缆绳的女人嘴里说出来，这可是极高的评价。等你准备好了就敲响我码头尽头的铃，{playerName}，渡航会把你送到东溪镇的正中央。当心狼群。",
        "objectives": {
          "0": {
            "label": "向渡船人奥多报到"
          }
