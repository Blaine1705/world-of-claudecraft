...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "interfacePage": {
      ...
      "winTalentsBody": "你的天赋树、你手上可分配的点数，以及每一行在每个等级下的效果。",
    ...
    "commandsPage": {
      ...
      "abilities": "你已经学会的技能。",
      "talents": "你的专精，以及你的天赋点在职业树与专精树之间是如何分配的。",
    ...
    "riftsPage": {
      ...
      "floorsHeading": "层层向下",
      "floorsBody": "一道裂隙有若干层，每一层都是当场生成的；而通往下一层的路，要等这一层跟你算清了账才会打开：清掉层里还活着的东西，解开它横在你路上的机关，向下的通道便会撕裂而开。最后一层以一名首领收尾。每一层都有自己的性格，所以一趟下来，你可能刚走出严寒，转身就踏进余烬之中，聊天栏会在你抵达每一层时报出它的名字。这一趟究竟有几层，看你屏幕上的追踪条。有些裂隙开启的则是一处手工搭建的场景，一个叫做焚炎城塞的地方，它有自己固定的长度，而不是生成出来的下行之路。",
      "boundHeading": "一旦见了血",
