...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "刚下渡船吗？欢迎来到试炼之滨。教官玛伦在我身后这条路尽头的晨憩营地主持操练：她想先跟你说上几句。等你准备离开时，敲响我码头尽头的这口铃，渡航就会送你回东溪镇。",
      "noteClose": "明白了"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "击中要害",
        "text": "欢迎来到试炼之滨，{playerName}。这里的每一课都从同一件事开始：站稳脚，握好刃。营地西南练武场上的草人生来就是挨打的。挑一个，站稳，砍到三个散架为止。它们的还击不痛不痒。这片海滨之外的东西下手可重得多。",
