  ...
  "hudChrome": {
    ...
    "raidBossGuide": {
      ...
      "ignivar": {
        ...
        "apocalypse": "末日: 在终焉之心完成20秒施法前将其击杀。",
        "judgment": "熔炉审判: 预警时记住不同的庇护点，地面燃烧后在标记边界内集合。",
        "finale": "最终炼狱: 生命值低于20%后，在45秒内击杀伊格尼瓦尔，同时应对加速的陨石、正面攻击和旋转炼狱。",
        "heroic": "英雄: 熔炉锁链期间成对玩家必须保持靠近；审判期间印记也会惩罚附近玩家。"
      },
      "varkhul": {
        "tanks": "坦克: 制作者印记达到2层时换坦，并让瓦尔库尔保持在近战范围内。",
        "orbs": "烬火宝珠: 被标记者分散到房间边缘。火池会持续整场战斗，释放的宝珠会穿过房间。",
        "pyre": "共享柴堆: 只选择没有炽热金属的玩家。在移动圆圈内，普通需要4人，英雄需要5人。",
        "ray": "淬火射线: 另一名玩家站在瓦尔库尔与目标之间拦截。承受伤害者会获得持续30秒的伤口。",
        "forge": "熔炉柱: 在射线抵达熔炉前阻挡。暴露叠加后轮换阻挡者；热量达到100%时熔炉会崩毁。",
        "adds": "组装阶段: 击杀每波传送门敌人并打断坩埚震击。在重新校准治疗瓦尔库尔前控制或减速烬火工匠。",
        "heroic": "英雄: 击杀太慢会使波次重叠，熔炉热量不会下降，共享柴堆需要5人，20%起世界之火会封锁房间。"
      }
    },
    "auraEffect": {
  ...
  "entities": {
    ...
    "dungeons": {
      ...
      "ignivar_molten_assembly": {
        "name": "熔火装配间",
        "enterText": "熔火装配间内，新的自动机从锻造线上列队而出。",
        "leaveText": "最后一具自动机在你身后归于沉寂。"
      },
