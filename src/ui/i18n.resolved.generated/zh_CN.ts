...
export const zh_CN: EnTranslations = {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "击中要害",
        "text": "欢迎来到试炼之滨，{playerName}。这里的每一课都从同一件事开始：站稳脚，握好刃。营地西南练武场上的草人生来就是挨打的。要是找不到练武场，按 M 打开地图：你身上的每件差事都会标在上面，用不着乱转。走到一个草人跟前，按 Tab 或用鼠标左键点击它，把它设为目标，然后按 1，或者点击屏幕底部动作条上的第一个图标，挥出这一刀。一直打到三个散架为止。它们的还击不痛不痒。这片海滨之外的东西下手可重得多。",
