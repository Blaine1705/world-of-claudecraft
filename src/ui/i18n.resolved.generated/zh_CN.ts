...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "doneTitle": "跑完全程",
      "doneBody": "腿上的功夫就这些了。走回大门处的看守塔姆那里交差：他有话要对你说，还有你的第一份报酬。"
    },
    "widgets": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_the_gauntlet": {
        "title": "跑过试炼跑道",
        "text": "谷地敬重的每一双腿，都是先从这几条跑道跑出来的，{playerName}。沿第一条跑道向西走到旗帜处，好好环顾四周，再沿南边的跑道向左滑步走到第二面旗，再看一圈，最后沿末尾的跑道跑到红旗处。旗帜要按顺序经过；屏幕上方的卡片会随时告诉你该按哪个键。等红旗被你甩在身后，回到大门处找我。",
        "completion": "跑得干净利落，{playerName}。你的双腿已经记住了跑道，剩下的就该干真正的活了：教官玛伦在码头北边沿路而上的晨憩营地主持操练。走到她跟前，直到她的名字显示出来，然后按 F，或者用鼠标左键点击她，她会交给你第一件差事。",
        "objectives": {
          "0": {
            "label": "经过试炼跑道旗帜"
          }
