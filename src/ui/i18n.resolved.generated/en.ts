...
export const en: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "consecration": {
        "name": "Consecration",
        "description": "Consecrate the ground beneath you for 9 sec, dealing {damage} Holy damage with high threat every second. The first impact generates 1 Devotion. Protection Paladins take 5% less damage while standing inside. Ascension increases damage and radius."
      },
      "bastion_sweep": {
        "name": "Bastion Sweep",
      ...
      "righteous_fury": {
        "name": "Burning Oath",
        "description": "Passively increases the threat generated by your Holy damage by 60%. Protection only."
      },
      "retribution_aura": {
        "name": "Requital Aura",
        "description": "Surrounds you and your party with holy energy until death or replacement, dealing 5 Holy damage to any enemy that strikes an affected ally in melee."
      },
      "tame_beast": {
        "name": "Wildbond",
      ...
      "avenging_wrath": {
        "name": "Avenging Wrath",
        "description": "Unfurl wings of holy power, gaining 10 Devotion and doubling Devotion generated by your abilities for 15 sec. Also increases damage dealt by 20%. Retribution: enables Hammer of Wrath against any target."
      },
      "berserk": {
        "name": "Red Haze",
