...
export const en: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "junkBody": "Drops you have no use for still sell to any merchant who trades in coin, so empty your bags whenever you pass through town rather than letting them fill up. The merchant's window even keeps a one-click Sell Junk button that sells every Poor-quality oddment at once. Truly worthless odds and ends can also be discarded outright to make room.",
