...
export const en: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "consecration": {
        "name": "Holy Ground",
        "description": "Consecrate the ground beneath you for 9 sec, dealing {damage} Holy damage with high threat every second. The first impact generates 1 Devotion. Protection Paladins take 5% less damage while standing inside. Ascension increases its damage."
      },
      "bastion_sweep": {
        "name": "Bastion Sweep",
      ...
      "avenging_wrath": {
        "name": "Avenging Wrath",
        "description": "Unfurl physical wings of golden holy power, gaining 10 Devotion and doubling Devotion generated by your abilities for 15 sec. Also increases damage and healing done by 20%. Retribution: enables Hammer of Wrath against any target."
      },
      "berserk": {
        "name": "Red Haze",
