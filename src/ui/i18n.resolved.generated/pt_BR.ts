...
export const pt_BR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      ...
      "editKeysHint": "Clique em um slot na barra de ação e pressione uma tecla para vinculá-lo.",
      "bannerHint": "Clique em um slot e pressione uma tecla para vinculá-lo. Clique em Concluído quando terminar.",
      "bannerCapturing": "Pressione uma tecla para vincular este slot...",
      "boundToKey": "Limitado a {key}.",
      "reset": "Reiniciar",
      "done": "Feito",
      "cancel": "Cancelar",
      "resetConfirmTitle": "Redefinir as teclas da barra de ação?",
      "resetConfirmBody": "A primeira barra retorna às teclas padrão. A segunda e a terceira barras ficam desvinculadas. Isto não pode ser desfeito."
    },
    "mounts": {
      "title": "Montarias",
      "close": "Fechar",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "Nas chaves 1v1 e 2v2 cada lutador usa o kit All-Rounder. Ações que exigem a faixa 3v3 ou maior não podem ser conquistadas aqui.",
      "role": {
        "allrounder": {
          "name": "Polivalente",
      ...
      "practiceUnratedNote": "As lutas de treino não são classificadas: a classificação e o progresso do Livro de Ações não contam.",
      ...
      "briefing": {
        ...
        "unratedNote": "Os bots estão em campo, então esta luta não tem classificação: a classificação não muda e os gols, defesas e jogos sem sofrer golos não contam.",
        "practiceUnratedNote": "Esta é uma luta prática, portanto não é classificada: a classificação não muda e o progresso do Livro de Ações não conta.",
    ...
    "materialHint": {
      "fineGrade": "Ótima nota. Coletado a partir de um veio de camada completa com uma ferramenta classificada acima do material e conta como a versão comum onde quer que seja necessário.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Você precisa de uma vara de pescar de nível {tier} para pescar nessas águas."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Você precisa do Mining {skill} para balançar a picareta que já está em suas malas.",
        "logging": "Você precisa do Logging {skill} para balançar o machado que já está em suas malas.",
        "herbalism": "Você precisa de Herbalismo {skill} para trabalhar a foice que já está em suas malas."
      },
      "wieldUnmetCorpse": "Você precisa reunir habilidades {skill} para colocar sua melhor ferramenta em funcionamento.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Necessário para pescar em águas até o nível {tier}."
        },
        "use": {
      ...
      "emptyHookNote": "Nada no gancho",
      "stateReady": "Disponível",
      "stateCooldown": "Regenerando",
      "stateCooldownTimed": "Reaparece em {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Sua ferramenta refina esse rendimento para uma qualidade fina."
    },
    "archetypeTitle": {
      "label": "Título",
      "none": "Nenhum",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} de {max} cobranças",
      "toolEffectSpent": "Gasto, precisa ser recarregado",
      "toolEffectDepleted": "Efeito da ferramenta gasto",
      "toolEffectRechargePrice": "Recarga: {count} x {material}",
      "toolEffectModeAsk": "Pergunte a cada uso",
      "toolEffectModePrompt": "Pergunta a cada uso",
      "toolEffectConfirmTitle": "Usar {effect}?",
      "toolEffectConfirmBody": "Gastar uma taxa nesta colheita? Declinar ainda acumula, sem o bônus. Cobranças restantes: {charges}.",
      "toolEffectConfirmAccept": "Use uma cobrança",
      "toolEffectConfirmDecline": "Reúna sem",
      "toolEffectName": {
        "gatherersCache": "Esconderijo do Coletor",
        "artisansEye": "Olho de Artesão",
        "quickeningCharm": "Amuleto Primavera"
      },
      "toolEffectSlotButton": "Slot {effect}",
      "toolEffectRechargeButton": "Recarregar",
      "toolEffectSlotted": "{effect} encaixado em {profession}.",
      "toolEffectSlotInvalid": "{effect} não pode ser inserido lá.",
      "toolEffectNoTool": "Você precisa primeiro de uma ferramenta {profession} real.",
      "toolEffectNoCharm": "Você precisa de um amuleto {effect} artesanal em suas malas.",
      "toolEffectNoGain": "{effect} já está encaixado e totalmente carregado.",
      "toolEffectRecharged": "{effect} recarregado: {material} x{count} consumido.",
      "toolEffectRechargeNoSlot": "Nenhum efeito é alocado em {profession}.",
      "toolEffectRechargeFull": "{effect} já está totalmente carregado.",
      "toolEffectRechargeToolCapped": "Leve uma ferramenta {profession} melhor para carregar {effect} ainda mais.",
      "toolEffectRechargeMaterials": "A recarga de {effect} precisa de {material} x{count}.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(gasta {count} nota fina)",
      ...
      "identity": {
        ...
        "colRole": "Papel",
        "colCap": "Limite",
        "allCrafts": "Todos os artesanatos",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Compartilhe desbloqueios de escrituras com companheiros de guilda e seguidores, e cartas de escrituras e obras-primas com o feed do Discord",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "A engenharia constrói as ferramentas que todo coletor sério acaba querendo: as picaretas, machados, foices e varas de pescar de nível 4 e 5 que nenhum contador jamais venderá por moedas, cada um consumindo a ferramenta abaixo dele.",
      ...
      "toolCraftedOrMarks": "Marcas de Aprofundamento criadas ({craft}) ou {marks} após três eliminações de Litania Afogada",
      "toolCraftedOrMarksHeroic": "Marcas de Aprofundamento criadas ({craft}) ou {marks} após a conclusão de uma Litania Afogada Heroica",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Não vendido",
      "priceNone": "Não vendido por moeda",
      ...
      "specimenBody": "Mantenha um pouco de espaço livre para o saco ao cultivar: um ganho inesperado assinado precisa de espaço próprio ou de uma pilha assinada correspondente para pousar, e se nada couber, o rendimento ainda chega, mas a assinatura é perdida. A colheita de cadáveres também tem seu próprio braço de jackpot: cerca de {pct}% de cada componente colhido é raro ou melhor. Uma família com um espécime perfeito para dar (couro, seda, veneno, carne) mantém sua produção normal e cunha o espécime assinado ao lado; todas as outras famílias assinam o rendimento.",
      ...
      "econ": {
        ...
        "trainingNote": "Uma taxa fixa por etapa de receita, cobrada uma vez quando um mestre a ensina; cada degrau da tabela abaixo está em uso hoje, desde as receitas iniciais gratuitas até as lições de vara do fabricante de ferramentas no topo.",
        ...
        "throttleBody": "A produção tem um limite: criar, desencantar, encantar, recuperar e recargas de efeito de ferramenta compartilham um orçamento de {actions} ações bem-sucedidas em cada janela de {seconds} segundos. Uma tentativa negada não custa nada e não gasta orçamento. Você nunca sentirá isso no jogo normal; existe para que um especialista com banco cheio não possa inundar o mercado, independentemente da sua habilidade ou stock.",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAriaBound": "Item desconhecido {id}, quantidade {count}, cópia encadernada",
      "unknownItemAriaInstanced": "Item desconhecido {id}, quantidade {count}, cópia marcada pelo fabricante"
    },
    "equipment": {
      "empty": "Vazio",
      "levelClass": "Nível {level} {className}"
    ...
    "vendor": {
      ...
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Compre {count} de cada vez",
      "qtyCustom": "Personalizado",
      "qtyCustomAria": "Escolha um valor personalizado para comprar",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_thorium_ore": {
        "name": "Minério de Ósmio Fino"
      },
      "fine_ironbark_log": {
        "name": "Tronco fino de casca de ferro"
      },
      "fine_ashwood_log": {
        "name": "Tronco fino de Ashwood"
      },
      "fine_elderwood_log": {
        "name": "Tronco fino de Highpine"
      },
      "fine_silverleaf_herb": {
        "name": "Erva Sheenleaf Fina"
      },
      "fine_goldleaf_herb": {
        "name": "Erva Folha Dourada Fina"
      },
      "fine_sunpetal_herb": {
        "name": "Erva Sunpetal Fina"
      },
      "stormreel_fishing_rod": {
        "name": "Vara de Pesca Stormreel"
      },
      "tidewrought_fishing_rod": {
        "name": "Vara de pesca forjada na maré"
      },
      "duskwisp_essence": {
      ...
      "gatherers_cache": {
        "name": "Esconderijo do Coletor"
      },
      "artisans_eye": {
        "name": "Olho de Artesão"
      },
