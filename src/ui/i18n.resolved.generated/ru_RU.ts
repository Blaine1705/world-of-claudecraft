...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "В категориях 1 на 1 и 2 на 2 каждый игрок выходит как Универсал. Игра вратарём и её деяния требуют категории 3 на 3 или больше.",
      "role": {
        "allrounder": {
          "name": "Универсал",
      ...
      "briefing": {
        ...
        "unratedNote": "На поле есть боты, поэтому этот матч не рейтинговый: счёт и прогресс Книги деяний не засчитываются.",
