...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mountTraining": {
      "title": "Урок верховой езды",
      "mountPrompt": "Садись в седло: нажми {key}, чтобы оседлать учебного Доблестного скакуна.",
      "ridePrompt": "Проезжай размеченную флажками трассу, через все ворота по порядку.",
      "progress": "Ворота {n} из {total}",
      "begin": "Начать урок",
      "abort": "Give Up",
      "thrown": "Тебя сбросили. Успокойся и попробуй снова.",
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_riding_lessons": {
        ...
        "text": "Каждый всадник приходит на своих двоих, {playerName}, как я и сказала в день нашей встречи. Держаться в седле — вот чему я учу, а не чем торгую. Забирайся в седло, когда я подам знак, и проезжай размеченную флажками трассу вокруг моего загона, через все ворота по порядку. Вылетишь из седла или покинешь двор — начнём заново.",
        "completion": "Вот так, хорошо. За весь круг ты ни разу не ухватился за ограду. Доблестный скакун теперь твой, {playerName}: седло, поводья и репутация всадника, который заслужил место в седле, а не купил его.",
        "objectives": {
          "0": {
