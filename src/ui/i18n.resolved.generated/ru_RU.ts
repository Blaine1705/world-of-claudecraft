...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "interfacePage": {
      ...
      "winTalentsBody": "Ваши деревья талантов, очки, которые у вас есть на руках, и что даёт каждая строка на каждом ранге.",
    ...
    "commandsPage": {
      ...
      "talents": "Ваша специализация и то, как ваши очки талантов разошлись между веткой класса и веткой специализации.",
