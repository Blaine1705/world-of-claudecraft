...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "forbiddenReflectionReady": "Следующее подходящее общее умение чернокнижника можно применить повторно",
      ...
      "necromancyHarvestMark": "Смерть может создать 1 осколок души и оставить Эхо смерти для Взрыва трупа",
      ...
      "necromancyDeathEcho": "Взрыв трупа может поглотить это эхо в радиусе {radius} м от точки прицеливания",
  ...
  "entities": {
    "abilities": {
      ...
      "slice_and_dice": {
        ...
        "description": "Завершающий прием, повышающий скорость атаки в ближнем бою на 30% на 12 сек. плюс 4 сек. за каждый прием серии (5 приемов серии: 32 сек.)."
      },
      "sprint": {
        "name": "Быстрые пятки",
      ...
      "kidney_shot": {
        "name": "Подлый удар",
        "description": "Завершающий прием, оглушающий цель на 1 сек. плюс 1 сек. за каждый прием серии (5 приемов серии: 6 сек.)."
      },
      "ambush": {
        "name": "Удар скрытня",
      ...
      "expose_armor": {
        "name": "Пролом брони",
        "description": "Завершающий прием, который оголяет цель на 30 сек.: каждый потраченный прием серии снижает ее броню на 2% (5 приемов серии: {damage}%)."
      },
      "rupture": {
        "name": "Истечение кровью",
        "description": "Завершающий прием, который ранит цель: она истекает кровью каждые 2 сек. в течение 6 сек. плюс 2 сек. за каждый прием серии (5 приемов серии: 16 сек. и {damage} ед. урона в сумме)."
      },
      "vanish": {
        "name": "Дымный шаг",
      ...
      "divine_protection": {
        "name": "Оберег веры",
        "description": "Священный оберег поглощает урон в размере {damage}% вашего максимального здоровья в течение {duration} сек. Enduring Protection усиливает оберег."
      },
      "hammer_of_justice": {
      ...
      "retribution_aura": {
        "name": "Аура возмездия",
        "description": "Окружает вас и вашу группу священной энергией до смерти или замены. Враги, ударившие затронутого союзника в ближнем бою, получают {buff} ед. урона от Света, а затронутые союзники наносят {buff} ед. дополнительного урона от Света автоатаками."
      },
      "tame_beast": {
        "name": "Дикие узы",
      ...
      "sentence": {
        "name": "Приговор",
        "description": "Расходует всё Осуждение и выносит врагу приговор. Урон и дополнительные эффекты усиливаются при 20, 50, 80 и 100 ед. Осуждения."
      },
      "life_tap": {
        "name": "Тяжёлая сделка",
      ...
      "possess_evil_eye": {
        ...
        "description": "Проклинатель овладевает вашим основным дурным глазом на 15 сек. и создаёт 35 ед. Осуждения. «Игла судьбы» применяется за 1 сек. и создаёт ещё 2 ед. Осуждения, «Поглощение» поддерживается в движении, а «Приговор» наносит на 25% больше урона и с задержкой повторяет 60% урона."
      },
      "hour_of_judgment": {
        "name": "Час суда",
      ...
      "swipe": {
        "name": "Разящие когти",
        "description": "Размахивает когтями по ближайшим врагам, нанося {damage} ед. урона. Создает дополнительную угрозу. Только в облике бурого.",
        "specNote_feral": "Каждый попавший удар добавляет 1 стадию Старой крови (максимум 3)."
      },
      "regrowth": {
        "name": "Второй расцвет",
      ...
      "faerie_fire": {
        "name": "Ведьмин огонь",
        "description": "Снижает броню цели на {damage}% на 40 сек."
      },
      "hibernate": {
        "name": "Дремота",
      ...
      "rip": {
        ...
        "description": "Завершающий прием, вызывающий у цели кровотечение каждые 2 сек. в течение 24 сек.: 36 ед. урона плюс 24 за каждый потраченный прием серии (5 приемов серии: {damage} в сумме). Только в облике волка.",
      ...
      "corpse_explosion": {
        "name": "Взрыв останков",
        "description": "Расходует 2 осколка души и высвобождает энергию смерти в выбранной точке, нанося ближайшим противникам {damage} ед. урона от темной магии."
      },
      "funeral_harvest": {
      ...
      "unholy_command": {
        ...
        "description": "Приказывает всем вашим мертвецам наносить на 25% больше урона и действовать на 20% быстрее в течение 12 сек."
      },
      "reaping_command": {
        "name": "Приказ жатвы",
      ...
      "army_of_the_dead": {
        "name": "Армия мертвых",
        "description": "Открывает могильный портал на 20 сек. и временно поднимает все архетипы Власти, которые ещё вам не служат. Выбранные слуги остаются после закрытия портала."
      },
      "metamorphosis": {
        "name": "Метаморфоза",
      ...
      "holy_shield": {
        "name": "Священный щит",
        "description": "Дает 30% блока и щит, поглощающий {damage}% вашего максимального здоровья в течение {duration} сек., и испускает волну угрозы. Вознесение усиливает и продлевает защиту."
      },
      "bestial_wrath": {
        "name": "Звериный гнев",
      ...
      "hemorrhage": {
        "name": "Кровоизлияние",
        "description": "Бьет врага, нанося урон оружием плюс {damage}, вызывает кровотечение на 12 сек. и увеличивает получаемый целью урон от кровотечений на 40%. Дает 1 прием серии. Каждое 2-е применение добавляет 1 этап Сумрака (максимум 3). (знаковое умение Скрытности)"
      },
      "power_infusion": {
        "name": "Придание сил",
      ...
      "summon_infernal": {
        ...
        "description": "Обрушивает Погребального колосса на указанную область и наносит 58-72 ед. урона от огня при падении. Он сражается 30 сек., не заменяя вашего демона, обжигает ближайших врагов раз в 2 сек. и создаёт 1 ед. Разрушения в секунду."
      },
      "summon_doomguard": {
      ...
      "ghostly_strike": {
        ...
        "description": "Наносит противнику урон от оружия плюс {damage} и повышает ваш шанс уклонения на 15% на 7 сек. Дает 1 прием серии. (талант разбойника)"
      },
      "hammer_of_wrath": {
        "name": "Звонкий молот",
      ...
      "rake": {
        "name": "Свежевание",
        "description": "Свежует врага, нанося урон оружием плюс {damage} и вызывая кровотечение в течение 18 сек. Даёт 1 очко серии приёмов. Только в облике волка.",
        "specNote_feral": "Каждый попавший удар добавляет 1 стадию Старой крови (максимум 3)."
      },
      "revive_pet": {
        "name": "Подлатать",
