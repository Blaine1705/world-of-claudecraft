...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "durationAria": "Применение {seconds} с",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "econ": {
        ...
        "castPaceBody": "Действия профессий занимают реальное время: простые полевые рецепты — около полутора секунд, высокие ступени лестницы — несколько секунд, а распыление, наложение чар, разбор и перезарядка эффектов инструментов имеют короткую фиксированную длительность. Отмена посреди применения ничего не тратит. За каждое успешное изготовление также взимается медный сбор, пропорциональный бюджету предмета. Вместе с материалами, станками и потолками навыка этот темп удерживает рынок без отдельной квоты действий.",
