  ...
  "entities": {
    "abilities": {
      ...
      "chain_heal": {
        ...
        "description": "Исцеляет дружественную цель на большую величину, затем перескакивает на 2 ближайших союзников, исцеляя на 40% меньше с каждым прыжком. (Специализация Исцеление)"
      },
      "metamorphosis": {
        "name": "Метаморфоза",
      ...
      "innervate": {
        "name": "Живой сок",
        "description": "Мгновенно восполняет 200 ед. текущего ресурса. (Талант друида)"
      },
      "kick": {
        "name": "Пинок",
