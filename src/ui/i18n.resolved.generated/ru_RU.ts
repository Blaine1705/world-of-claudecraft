...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "unbinding_blessing": {
        "name": "Благословение свободы",
        "description": "Снимает с союзной цели эффекты замедления и обездвиживания."
      },
      "guardian_covenant": {
      ...
      "solar_step": {
        "name": "Солнечный шаг",
        "description": "Заставляет вас стремительно двигаться вперед в течение 2 сек. Направление можно менять, но остановиться раньше нельзя."
      },
      "solar_invocation": {
      ...
      "citadel_of_faith": {
        "name": "Цитадель веры",
        "description": "Уменьшает весь получаемый урон на 40% на 10 сек."
      },
      "devotion_aura": {
        "name": "Аура стойкости",
      ...
      "oath_chain": {
        "name": "Цепь клятвы",
        "description": "Сковывает далекого врага святой цепью, притягивает на расстояние до 3 м и замедляет на 50% на 4 сек. Вознесение не усиливает этот вспомогательный эффект."
      },
      "righteous_fury": {
