...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "paladin": {
      ...
      "devotionValue": "Преданность: {value}/{max}",
      "devotionAscensionCharges": "Преданность: {value}/{max}. Зарядов Вознесения: {charges}.",
      "devotionAscensionLast": "Преданность: {value}/{max}. Последний заряд Вознесения.",
      "ascensionLastAnnouncement": "Последний заряд Вознесения",
      "ascensionSpenderAria": "Ячейка действия {slot}: {ability}. Расходует 1 заряд Вознесения."
    },
    "abilityScaling": {
      "bonus": "(+{value})"
    },
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "oathstrike": "Надежный удар оружием накапливает Рвение для следующего святого натиска.",
      "hammer_of_wrath": "Добивает раненого врага издалека, а при активных крыльях доступен против любой цели.",
      "avenging_wrath": "Накапливает 10 ед. рвения и на пятнадцать секунд удваивает рвение от способностей.",
      "bastion_sweep": "Сметает врагов щитом, набирая угрозу и Рвение.",
      "oath_chain": "Притягивает далекого врага к группе и замедляет его отступление.",
      "veilbound_march": "Проходит сквозь группу врагов, помечая их, ослабляя их урон по вам и закрепляя угрозу.",
      "holy_shield": "Расходует Рвение на активное блокирование, поглощение и импульс угрозы.",
      "consecration": "Удерживает землю постоянным святым уроном и угрозой.",
      "hammer_of_justice": "Ненадолго и надежно оглушает одного врага.",
  ...
  "hud": {
    ...
    "errors": {
      ...
      "notEnoughDevotion": "Недостаточно Рвения!",
  ...
  "entities": {
    "abilities": {
      ...
      "divine_ascension": {
        ...
        "description": "Расходует 20 ед. рвения и дает 5 зарядов вознесения на срок до 25 сек. Отмеченные способности расходуют один заряд и получают дополнительный эффект."
      },
      "devotion_ward": {
        "name": "Аура благочестия",
        "description": "Уменьшает получаемый вами и членами группы урон на 5% до вашей смерти или замены. Только Аура благочестия и Аура воздаяния заменяют друг друга; Сияющее, Рассветное и Милосердное благочестие действуют одновременно."
      },
      "hammer_of_grace": {
        "name": "Молот благодати",
        "description": "Атакует противника оружием и при попадании восстанавливает 70 ед. маны. Имеет общее время восстановления с Молотом Света."
      },
      "hammer_of_light": {
        "name": "Молот Света",
        "description": "Атакует противника оружием и восстанавливает вам здоровье в размере 50% от нанесенного урона. Имеет общее время восстановления с Молотом благодати."
      },
      "hushbrand": {
        "name": "Клеймо безмолвия",
        "description": "Прерывает чтение заклинания и запрещает применять заклинания той же школы в течение 4 сек."
      },
      "guardian_covenant": {
        "name": "Завет хранителя",
        "description": "Защищает союзника, уменьшая получаемый им урон на 20% на 8 сек."
      },
      "solar_step": {
        "name": "Солнечный шаг",
        "description": "Повышает скорость передвижения на 150% на 2 сек."
      },
      "solar_invocation": {
        "name": "Солнечное воззвание",
        "description": "Мгновенно восстанавливает дружественной цели {damage} ед. здоровья. Применение для исцеления накапливает 1 ед. рвения. Во время Вознесения также исцеляет союзных игроков в радиусе 10 м от цели на половину этой величины."
      },
      "radiant_devotion": {
        "name": "Сияющее благочестие",
        "description": "Повышает силу заклинаний у вас и членов группы на 20 на 30 мин."
      },
      "dawn_devotion": {
        "name": "Благочестие рассвета",
        "description": "Повышает силу атаки у вас и членов группы на 40 на 30 мин. Этот эффект действует одновременно с боевым кличем воина."
      },
      "grace_devotion": {
        "name": "Благочестие милости",
        "description": "Вы и члены группы восстанавливаете 15 ед. маны раз в 5 сек., а затраты маны на заклинания уменьшаются на 3% на 30 мин."
      },
      "recall_the_fallen": {
        "name": "Возвращение павших",
        "description": "Возвращает погибшего члена группы к жизни с 35% здоровья и маны."
      },
      "beacon_of_light": {
        "name": "Частица Света",
        "description": "Делает одного члена группы вашей Частицей Света. 75% эффективного исцеления, примененного вами к другим членам группы в радиусе 60 м от Частицы, также исцеляет ее носителя. Действует до смерти паладина или носителя."
      },
      "oathstrike": {
        "name": "Удар клятвы",
        "description": "Наносит урон оружием и еще {damage} ед. урона, накапливая 1 ед. рвения. При вознесении повторяет удар с силой 60%."
      },
      "final_edict": {
        "name": "Последний эдикт",
        "description": "Наносит сокрушительный удар оружием и накапливает 2 ед. рвения. При вознесении также вызывает взрыв Света вокруг вас."
      },
      "dawnfall": {
        "name": "Падение зари",
        "description": "Наносит ближайшим противникам {damage} ед. урона от Света и накапливает 2 ед. рвения. Вознесение увеличивает урон и радиус."
      },
      "faithforged_guard": {
        "name": "Закаленная верой защита",
        "description": "Окружает вас щитом, поглощающим {damage} ед. урона в течение 8 сек. Вознесение усиливает щит на 50%."
      },
      "mercy_lance": {
        "name": "Копье милосердия",
        "description": "Исцеляет союзника или наносит противнику {damage} ед. урона. Применение для исцеления накапливает 1 ед. рвения. При вознесении лечение также исцеляет ближайшего союзника."
      },
      "sacred_form": {
        "name": "Священный облик",
        "description": "До смерти переводит вас в священное состояние, повышая эффективность исцеления на 10%, вероятность критического эффекта заклинаний на 5% и снижая создаваемую угрозу на 50%. Только для специализации Свет."
      },
      "dawns_embrace": {
        "name": "Объятия рассвета",
        "description": "Мощно исцеляет цель и накапливает 2 ед. рвения. При вознесении применяется мгновенно и исцеляет на 35% больше."
      },
      "radiant_chorus": {
        "name": "Сияющий хор",
        "description": "Исцеляет ближайших союзников на {damage} ед. здоровья и накапливает 2 ед. рвения. Вознесение увеличивает лечение и радиус."
      },
      "life_covenant": {
        "name": "Завет жизни",
        "description": "Уменьшает получаемый союзником урон на 40% на 6 сек. При вознесении также дает щит прочностью 120 ед., не расходуя заряд."
      },
      "aegis_first_dawn": {
        "name": "Эгида Первого Рассвета",
        "description": "Поддерживает заклинание 5 сек., создавая священный купол радиусом 10 м. Союзники внутри исцеляются каждую секунду и получают на 50% меньше урона. При полном завершении высвобождает финальное исцеление и повышает скорость передвижения на 30% на 4 сек."
      },
      "vowkeeper_strike": {
        "name": "Удар хранителя клятвы",
        "description": "Наносит удар с повышенной угрозой и накапливает 1 ед. рвения. При вознесении также дает небольшой поглощающий щит."
      },
      "bastion_rite": {
        "name": "Обряд бастиона",
        "description": "Уменьшает получаемый физический урон на 20% на 6 сек. Вознесение продлевает действие до 10 сек."
      },
      "sunward_disc": {
        "name": "Солнечный диск",
        "description": "Бросает сияющий диск, который поражает и отскакивает к 2 противникам, накапливая 2 ед. рвения. При вознесении совершает 5 отскоков."
      },
      "sacred_challenge": {
        "name": "Священный вызов",
        "description": "Вынуждает противника атаковать вас. При вознесении также уменьшает весь получаемый урон на 15% на 4 сек., не расходуя заряд."
      },
      "devotion_aura": {
        "name": "Аура стойкости",
      ...
      "consecration": {
        "name": "Святая земля",
        "description": "Освящает землю под вами на 9 сек., каждую секунду нанося ближайшим врагам {damage} ед. урона от светлой магии и создавая высокий уровень угрозы. Первое попадание дает 1 ед. рвения. Паладины специализации «Защита» получают на 5% меньше урона, находясь в области действия. Вознесение увеличивает урон и радиус."
      },
      "bastion_sweep": {
        "name": "Размах бастиона",
        "description": "Сметает щитом ближайших врагов, наносит {damage} ед. святого урона с высокой угрозой и дает 1 ед. Рвения. Вознесение повышает урон на 30% и радиус до 8 м."
      },
      "oath_chain": {
        "name": "Цепь клятвы",
        "description": "Сковывает далекого врага святой цепью, притягивает на расстояние до 3 м и замедляет на 50% на 4 сек. Во время Вознесения притягивает еще одного ближайшего врага."
      },
      "veilbound_march": {
        "name": "Марш Сквозь Завесу",
        "description": "На 4 сек. паладин становится бесплотным, получает 40% скорости передвижения и 30% брони, а также невосприимчивость к замедлению, обездвиживанию и перемещению. Пройденные насквозь враги получают Метку Завесы на 6 сек.: каждую секунду они получают урон от светлой магии, наносят паладину на 20% меньше урона и создают дополнительную угрозу. Первая метка дает 1 ед. Рвения. В конце марша ближайшие отмеченные враги получают завершающий удар. Вознесение увеличивает его урон на 50% и слегка притягивает врагов."
      },
      "veilbound_mark": {
        "name": "Метка Завесы",
        "description": "Каждую секунду получает урон от светлой магии, наносит отметившему паладину на 20% меньше урона и создает дополнительную угрозу для этого паладина."
      },
      "righteous_fury": {
        "name": "Пылающая клятва",
        "description": "Пассивно повышает угрозу от наносимого вами урона от Света на 60%. Только для специализации «Защита»."
      },
      "retribution_aura": {
        "name": "Аура возмездия",
        "description": "Окружает вас и членов группы священной энергией и наносит 5 ед. урона светлой магией любому врагу, атакующему в ближнем бою. Действует до вашей смерти или смены благочестия."
      },
      "tame_beast": {
        "name": "Дикие узы",
      ...
      "avenging_wrath": {
        ...
        "description": "Расправляет святые крылья, накапливает 10 ед. рвения и на 15 сек. удваивает рвение от способностей. Также увеличивает наносимый урон на 20%. Воздаяние: позволяет применять Молот гнева к любой цели."
      },
      "berserk": {
        "name": "Багровая дымка",
