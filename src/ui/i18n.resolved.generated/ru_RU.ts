  ...
  "entities": {
    "abilities": {
      ...
      "possess_evil_eye": {
        ...
        "description": "Проклинатель овладевает вашим основным дурным глазом на 10 сек. «Игла судьбы» применяется за 1 сек. и создаёт ещё 2 ед. Осуждения, «Поглощение» поддерживается в движении и получает демонический луч, а «Приговор» наносит с задержкой ещё 25% урона."
      },
      "coven": {
        "name": "Ковен",
      ...
      "ruinous_brand": {
        "name": "Гибельное клеймо",
        "description": "Помечает врага на 15 сек. Следующие 3 заклинания прямого урона наносят помеченному врагу ещё 25% урона, а при применении к другой цели копируют в него 50% урона."
      },
      "wrath": {
        "name": "Дикая стрела",
      ...
      "soul_lance": {
        "name": "Копьё душ",
        "description": "Бросает призрачное копьё и наносит {damage} ед. урона от Тьмы. Если на цели есть ваша Метка оссуария, 50% нанесённого урона дополнительно сохраняется в метке."
      },
      "raise_graveguard": {
        "name": "Поднять могильного стража",
        "description": "Поднимает стойкого могильного стража, который всегда остается рядом. Одновременно можно контролировать только одного."
      },
      "raise_skeletal_warrior": {
        "name": "Поднять воина-скелета",
        "description": "Расходует 1 осколок души и поднимает воина-скелета на 30 сек. Можно повелевать не более чем 3 временными мертвецами."
      },
      "raise_bone_mage": {
        "name": "Поднять костяного мага",
        "description": "Расходует 2 осколка души и поднимает костяного мага дальнего боя на 30 сек. Можно повелевать не более чем 3 временными мертвецами."
      },
      "bone_armor": {
      ...
      "ossuary_mark": {
        "name": "Метка оссуария",
        "description": "Помечает врага на 12 сек. и сохраняет 20% урона, нанесённого вами и вашей нежитью. Повторное применение взрывает метку. Если помеченный враг погибает, метка взрывается в радиусе 6 м и создаёт 1 фрагмент души."
      },
      "unholy_command": {
      ...
      "reaping_command": {
        "name": "Приказ жатвы",
        "description": "Расходует 2 осколка души и приказывает всем мёртвым слугам одновременно атаковать цель. Слуги с рассекающими ударами также атакуют ближайших противников."
      },
      "sacrifice_undead": {
        "name": "Жертва мертвеца",
        "description": "Уничтожает одного временного мертвеца и восстанавливает 25% от максимального запаса здоровья."
      },
      "army_of_the_dead": {
        "name": "Армия мертвых",
        "description": "Поднимает двух воинов-скелетов и одного костяного мага для неустанного штурма на 20 сек."
      },
      "metamorphosis": {
        "name": "Облик лича",
        "description": "Вы становитесь личом на 20 сек., создаете 3 осколка души и повышаете урон от заклинаний и скорость их применения на 20%. Ваши мертвецы наносят на 50% больше урона и действуют на 20% быстрее. (знаковое умение некроманта)"
      },
      "holy_shock": {
        "name": "Шок небес",
      ...
      "abyssal_rift": {
        "name": "Разлом Бездны",
        "description": "Открывает разлом в выбранной точке, притягивает противников в радиусе 8 м к центру, наносит {damage} ед. урона от Тьмы и оглушает на 2 сек. Боссы получают урон, но невосприимчивы к притягиванию и оглушению."
      },
      "chaos_bolt": {
      ...
      "dark_pact": {
        "name": "Кровавый завет",
        "description": "Жертвует 10% текущего здоровья и создает на 8 сек. щит, поглощающий урон в размере 30% максимального здоровья."
      },
      "cleansing_verdict": {
      ...
      "sacrilegious_march": {
        ...
        "description": "Повышает скорость передвижения на 35%, но каждую секунду расходует 2% максимального здоровья. Повторное применение отменяет эффект. Эффект отключается при 20% здоровья."
      },
      "spellsteal": {
        "name": "Похищение чар",
