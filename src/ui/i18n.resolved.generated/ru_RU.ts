...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "avenging_wrath": "Расправляет святые крылья и значительно усиливает урон на пятнадцать секунд.",
  ...
  "entities": {
    "abilities": {
      ...
      "devotion_ward": {
        ...
        "description": "Уменьшает получаемый вами и членами группы урон на 5% до вашей смерти или смены благочестия. Вы можете поддерживать только одно благочестие, но эффекты разных паладинов действуют одновременно."
      },
      "hammer_of_grace": {
      ...
      "solar_invocation": {
        ...
        "description": "Мгновенно восстанавливает дружественной цели {damage} ед. здоровья. Эффективное исцеление накапливает 1 ед. рвения. Во время Вознесения также исцеляет союзных игроков в радиусе 10 м от цели на половину этой величины."
      },
      "radiant_devotion": {
      ...
      "grace_devotion": {
        ...
        "description": "Вы и члены группы восстанавливаете 15 ед. маны раз в 5 сек., а затраты маны на заклинания уменьшаются на 6% на 3 мин."
      },
      "recall_the_fallen": {
      ...
      "mercy_lance": {
        ...
        "description": "Исцеляет союзника или наносит противнику {damage} ед. урона. Эффективное исцеление накапливает 1 ед. рвения. При вознесении лечение также исцеляет ближайшего союзника."
      },
      "sacred_form": {
