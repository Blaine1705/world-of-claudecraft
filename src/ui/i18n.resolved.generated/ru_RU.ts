  ...
  "entities": {
    "abilities": {
      ...
      "chain_heal": {
        ...
        "description": "Исцеляет дружественную цель на 120-145, затем перескакивает на 2 ближайших союзников, снижая исцеление вдвое с каждым прыжком. Каждый задетый союзник расходует ваш Поток исцеления для дополнительного всплеска. (Фирменное умение Исцеления духа)"
      },
      "galeheart_weapon": {
      ...
      "tidecall": {
        "name": "Зов прилива",
        "description": "Призывает быструю целительную волну, исцеляя союзника и добавляя рассчитанное исцеление к Потоку исцеления."
      },
      "metamorphosis": {
        "name": "Метаморфоза",
