...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "innervate": {
        "name": "Живой сок",
        "description": "Живой сок наполняет вас в течение 10 сек., волнами восполняя 30 текущего ресурса: ману, ярость или энергию; смена облика его не прерывает. (талант друида)"
      },
      "kick": {
        "name": "Пинок",
