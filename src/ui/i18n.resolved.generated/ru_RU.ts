...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "mouseoverCast": "Каст по наведению на рамки группы",
    ...
    "statInfo": {
      ...
      "desc": {
        ...
        "haste": "Ускоряет удары оружием и произнесение заклинаний. Не сокращает глобальное время восстановления (GCD).",
        "parry": "Ваш шанс полностью парировать фронтальную атаку в ближнем бою, не получая урона. Удар со спины парировать нельзя."
      },
      "effects": {
    ...
    "auraEffect": {
      ...
      "battleStance": "Боевая стойка: генерация ярости больше на 10%",
      "berserkerStance": "Стойка берсерка: критические удары на 3% чаще и на 3% сильнее",
      ...
      "dmgDone": "Наносимый урон увеличен на {pct}%",
      "dmgDoneReduce": "Наносимый урон снижен на {pct}%",
      "crit": "Вероятность критического удара увеличена на {pct}%",
      "rageGen": "Накопление ярости увеличено на {pct}%",
      "reckless": "Вероятность критического удара увеличена на {pct}%, накопление ярости на {ragePct}%",
      ...
      "revengeFree": "Следующая Месть не расходует ярость",
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "revenge": "Размашистая контратака, поражающая всех врагов перед вами; сразу после парирования или уклонения она обходится дешевле.",
      ...
      "hamstring": "Подрезает ноги цели, замедляя её, чтобы она не могла вас догнать.",
  ...
  "entities": {
    "abilities": {
      ...
      "chain_heal": {
        ...
        "description": "Исцеляет цель на {damage}, затем перескакивает не более чем на 2 ближайших союзников, исцеляя каждым скачком вдвое меньше предыдущего."
      },
      "heroic_strike": {
      ...
      "revenge": {
        "name": "Месть",
        "description": "Атака широкой дугой, наносящая физический урон всем врагам перед вами. При более чем 5 целях урон снижается. При уклонении или парировании следующая Месть может не стоить ярости."
      },
      "battle_shout": {
        "name": "Железный рёв",
      ...
      "demoralizing_shout": {
        "name": "Зловещий вой",
        "description": "Издает устрашающий крик, снижая урон, наносимый всеми противниками поблизости, на 20% на 20 сек."
      },
      "charge": {
        "name": "Натиск",
      ...
      "overpower": {
        "name": "Кровавая рука",
        "description": "Мгновенная атака, наносящая урон оружием плюс {damage} и дающая {rage} ед. ярости, усиливает ваш следующий Калечащий удар на 20% (до двух зарядов). От нее нельзя уклониться."
      },
      "execute": {
        "name": "Ранняя могила",
      ...
      "defensive_stance": {
        "name": "Стойка стража",
        "description": "Оборонительная боевая стойка: вы создаете на 30% больше угрозы, но наносите и получаете на 10% меньше урона. Примените Боевую стойку, чтобы вернуться в наступление."
      },
      "battle_stance": {
        "name": "Боевая стойка",
        "description": "Агрессивная боевая стойка: вы создаете на 10% больше ярости. Стойка по умолчанию для Оружия и Защиты."
      },
      "berserker_stance": {
        "name": "Стойка берсерка",
        "description": "Безрассудная боевая стойка: ваши критические удары происходят на 3% чаще и наносят на 3% больше урона. Воин Неистовства всегда сражается в этой стойке."
      },
      "sunder_armor": {
        "name": "Срез брони",
      ...
      "mortal_strike": {
        "name": "Калечащий удар",
        "description": "Жестокий удар, наносящий урон оружием плюс {damage} и снижающий получаемое целью исцеление на 50% на 10 сек. Накладывает Зияющие раны (кровотечение). (фирменная способность Оружия)"
      },
      "sweeping_strikes": {
        "name": "Расширяющаяся дуга",
        "description": "В течение 12 сек ваши атаки по одной цели также поражают 1 ближайшего врага, нанося 75% урона. (Оружие)"
      },
      "deep_wounds": {
        "name": "Зияющие раны",
        "description": "Пассивно: ваш Калечащий удар вызывает у цели кровотечение, нанося физический урон в течение 6 сек. (Оружие)"
      },
      "enrage_passive": {
        "name": "Ярость",
        "description": "Пассивно: в Ярости вы наносите на 11% больше урона, атакуете на 25% быстрее и двигаетесь на 10% быстрее в течение 4 сек. Кровопускание даёт 30% шанс, а Красная жатва всегда вызывает Ярость. (Неистовство)"
      },
      "bloodthirst": {
        "name": "Кровопускание",
        "description": "Мгновенно атакует в кровавом исступлении, нанося {damage}, восполняя 3% максимального здоровья и генерируя 10 ярости. (ключевая способность ветки «Неистовство»)"
      },
      "raging_gale": {
        "name": "Двойной удар",
      ...
      "furious_mending": {
        ...
        "description": "В течение 10 сек получаемый урон снижен на 20%, и все это время ваше «Кровопускание» восполняет 20% максимального здоровья. (ветка «Неистовство»)"
      },
      "emboldening_roar": {
        "name": "Ободряющий рев",
        "description": "Вы издаете ободряющий рев: вы и дружественные игроки в радиусе 40 м получаете эффект «Воодушевление», и ваши следующие 3 способности наносят гарантированный критический удар. (ветка «Неистовство»)"
      },
      "raised_guard": {
        "name": "Поднятый щит",
        "description": "Вы укрываетесь за щитом: в течение 6 сек получаемый физический урон снижен на 50%. (ветка «Защита»)"
      },
      "iron_resolve": {
        "name": "Игнорирование боли",
        "description": "Вы стискиваете зубы и игнорируете боль: расходует всю вашу ярость (минимум 20) и поглощает 4 ед. урона за каждую потраченную единицу ярости, до 10 сек. (ветка «Защита»)"
      },
      "faultline": {
        "name": "Ударная волна",
        "description": "Вы сотрясаете землю ударной волной: противники перед вами в радиусе 8 м получают {damage} урона и оглушаются на 3 сек. (ветка «Защита»)"
      },
      "defiant_bellow": {
        "name": "Вызывающий рев",
        "description": "Вы издаете вызывающий рев: все противники в радиусе 10 м провоцируются и вынуждены атаковать вас в течение 3 сек. (ветка «Защита»)"
      },
      "breachmaker": {
        "name": "Пролом",
        "description": "Вы обрушиваетесь на цель, нанося урон оружием плюс {damage} и проламывая ее защиту: ваши собственные атаки по ней наносят на 20% больше урона в течение 8 сек. (ветка «Оружие»)"
      },
      "measured_fury": {
        "name": "Выверенная ярость",
        "description": "Ваша выверенная ярость оттачивает управление ресурсами: ваши способности стоят на 10% меньше ярости. (ветка «Оружие»)"
      },
      "shield_slam": {
        "name": "Раскол щита",
      ...
      "repentance": {
        "name": "Покаяние",
        "description": "Погружает врага в созерцание на срок до 6 сек. Любой урон прерывает эффект. (знаковое умение Воздаяния)"
      },
      "bestial_wrath": {
        "name": "Звериный гнев",
      ...
      "arcane_power": {
        ...
        "description": "Наполняет вас тайной магией, повышая силу заклинаний на 28 на 12 сек. (знаковое умение Тайной магии)"
      },
      "combustion": {
        "name": "Возгорание",
        "description": "Сосредоточивает магию огня, чтобы следующая атака стала критической. (знаковое умение Огня)"
      },
      "cone_of_cold": {
        "name": "Конус холода",
        "description": "Поражает ближайших врагов холодом, нанося {damage} ед. урона от магии льда. (знаковое умение Льда)"
      },
      "cold_blood": {
        "name": "Хладнокровие",
      ...
      "shamanistic_rage": {
        ...
        "description": "Высвобождает шаманскую ярость и восстанавливает 160 маны. (знаковое умение Совершенствования)"
      },
      "natures_swiftness": {
        "name": "Природная стремительность",
        "description": "Призывает природу, чтобы следующее заклинание стало мгновенным. (знаковое умение Исцеления)"
      },
      "siphon_life": {
      ...
      "fel_domination": {
        ...
        "description": "Подчиняет энергии Скверны, делая следующее заклинание мгновенным. (знаковое умение Демонологии)"
      },
      "conflagrate": {
        "name": "Поджигание",
      ...
      "storm_bolt": {
        "name": "Удар бури",
        "description": "Метает оружие в цель, нанося {damage} и оглушая ее на 3 сек."
      },
      "piercing_howl": {
        "name": "Пронзительный вой",
        "description": "Пронзительный крик, замедляющий всех противников в радиусе 15 м на 50% на 8 сек."
      },
      "die_by_sword": {
        "name": "Смерть от меча",
      ...
      "recklessness": {
        "name": "Безрассудство",
        "description": "Исступление: накопление ярости увеличено на 50%, а вероятность критического удара на 20% на 12 сек."
      },
      "avatar": {
        "name": "Аватара",
        "description": "Превращает вас в колосса на 20 сек, снимая все эффекты контроля и увеличивая наносимый урон на 20%."
      },
      "sanguine_aura": {
        "name": "Кровавая аура",
        "description": "Пропитывает оружие кровью врагов: вы и ваши союзники ближнего боя получаете 10% к скорости атаки и 10% к урону на 20 сек."
      },
      "victory_rush": {
        "name": "Победный рывок",
        "description": "Удар, наносящий урон оружием плюс {damage} и восполняющий 20% вашего максимального здоровья. Можно использовать только в течение 20 сек после убийства врага."
      },
      "bladestorm": {
        "name": "Вихрь клинков",
        "description": "Вы превращаетесь в стальной вихрь, каждую секунду нанося {damage} всем врагам в радиусе 8 м в течение 4 сек."
      },
      "intimidating_shout": {
        "name": "Устрашающий крик",
        "description": "Ужасающий крик, обращающий в паническое бегство до 5 врагов в радиусе 8 м на 8 сек. Урон может прервать эффект."
      },
      "pummel": {
        "name": "Зуботычина",
        "description": "Прерывает произнесение заклинания и блокирует эту школу магии на 4 сек. Дает 10 ед. ярости, если заклинание было прервано."
      },
      "heroic_leap": {
        "name": "Героический прыжок",
        "description": "Прыжок в указанную область, наносящий {damage} урона ближайшим врагам."
      },
      "rallying_cry": {
        "name": "Воодушевляющий крик",
        "description": "Воодушевляющий крик дает вам и членам группы в радиусе 40 м 20% дополнительного максимального здоровья на 10 сек."
      },
      "summon_imp": {
        "name": "Призыв Уголька",
