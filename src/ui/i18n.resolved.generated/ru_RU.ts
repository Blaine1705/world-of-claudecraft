...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "overpower": {
        "name": "Кровавая рука",
        "description": "Мгновенная атака, наносящая урон оружием плюс {damage} и дающая {rage} ед. ярости. От нее нельзя уклониться."
      },
      "execute": {
        "name": "Ранняя могила",
      ...
      "die_by_sword": {
        "name": "Смерть от меча",
        "description": "Защитная способность: получаемый урон снижен на 10% на 8 сек, при здоровье ниже 30% - на 20%."
      },
      "recklessness": {
        "name": "Безрассудство",
