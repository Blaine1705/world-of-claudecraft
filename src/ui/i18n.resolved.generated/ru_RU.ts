  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_riding_lessons": {
        ...
        "text": "Каждый всадник приходит на своих двоих, {playerName}, как я и сказала в день нашей встречи. Держаться в седле, вот чему я учу, а не чем торгую. Заплати за обучение, и когда я подам знак, подзови учебного Доблестного скакуна и заберись в седло. Оставайся при этом у меня во дворе; уйдёшь далеко, начнём заново.",
