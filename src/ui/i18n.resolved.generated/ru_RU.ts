  ...
  "entities": {
    "abilities": {
      ...
      "furious_mending": {
        ...
        "description": "Ярость затягивает ваши раны: восполняет 20% вашего максимального здоровья за 10 сек, и все это время получаемый урон снижен на 20%. (ветка «Неистовство»)"
      },
      "emboldening_roar": {
        "name": "Ободряющий рев",
