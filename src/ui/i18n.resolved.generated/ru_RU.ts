...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mounts": {
      ...
      "stableHint": "Учитесь верховой езде в конюшнях у Хайвотча.",
    ...
    "mountTraining": {
      ...
      "prompt": "Подстраивайся под наклон коня, пока он тебя не сбросил.",
      "leanLeft": "Lean Left",
      "leanRight": "Наклон вправо",
      "steady": "Держать равновесие",
      "cueLeft": "Конь клонится влево.",
      "cueRight": "Конь клонится вправо.",
      "cueSteady": "Конь выравнивается.",
      "begin": "Начать урок",
      "abort": "Give Up",
      "round": "Раунд {n} из {total}",
      "misses": "Промахи {n} из {cap}",
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_riding_lessons": {
        ...
        "text": "Каждый всадник приходит на своих двоих, {playerName}, как я и сказала в день нашей встречи. Держаться в седле — вот чему я учу, а не чем торгую, и за один вечер этому не выучиться. Забирайся, следи за моими руками на поводьях и подстраивайся под наклон Доблестного скакуна, пока он не решил, что возиться с тобой не стоит.",
