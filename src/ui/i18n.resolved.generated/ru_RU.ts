  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        ...
        "greeting": "Истврукская долина принимает всех, друг. А для тех, кто еще нетвердо стоит на ногах, всегда есть Берег Испытаний: круг парома на восточном берегу работает в обе стороны круглый год."
      },
      "instructor_maren": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "Бей верно",
        "text": "Клинок, которым ни разу не взмахнул, всего лишь тяжелая палка, {playerName}. Чучела на площадке к югу от лагеря сделаны, чтобы их били: выбери одно, встань как следует и бей, пока три из них не развалятся. Они не бьют в ответ. То, что ждет за этим берегом, ударит.",
