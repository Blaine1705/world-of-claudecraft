  ...
  "entities": {
    ...
    "npcs": {
      ...
      "quartermaster_finch": {
        ...
        "greeting": "Хлеб, вода и снадобье на случай, если перестараешься на тренировке. Все это покупается за монету, а монета зарабатывается трудом. Вот и вся экономика, {playerName}, и сложнее она не становится. Только больше."
      },
      "ferryman_odo": {
        "name": "Паромщик Одо",
    ...
    "quests": {
      ...
      "q_ps_find_your_feet": {
        "title": "Твердая почва",
        "text": "Добро пожаловать на Берег Испытаний, {playerName}. На этом острове никто не кусается, пока его не попросишь, так что пользуйся тишиной: обойди лагерь и запомни лица. Интендант Финч ведает припасами, а паромщик Одо хранит дорогу домой. Навести обоих и возвращайся ко мне.",
        "completion": "Быстрые ноги: вернулся прежде, чем закипел чайник. Теперь ты знаешь лагерь, {playerName}, а значит, знаешь, куда бежать, когда что-нибудь и вправду укусит.",
        "objectives": {
          "0": {
            "label": "Навестить интенданта Финч"
          },
          "1": {
            "label": "Навестить паромщика Одо"
          }
        }
      },
      "q_ps_strike_true": {
        "title": "Бей верно",
        "text": "Клинок, которым ни разу не взмахнул, всего лишь тяжелая палка, {playerName}. Чучела на площадке к юго-западу от лагеря сделаны, чтобы их били: выбери одно, встань как следует и бей, пока три из них не развалятся. Они не бьют в ответ. То, что ждет за этим берегом, ударит.",
      ...
      "q_ps_tools_of_the_trade": {
        "title": "Орудия ремесла",
        "text": "Монета существует, чтобы ее тратить, {playerName}, а моя лавка честная. Купи у меня целебное снадобье, и я верну тебе больше, чем оно стоило, в уплату за урок: найти торговца, взвесить цену, пересчитать сдачу. А когда доберешься до долины, потрать остаток на инструменты для сбора у тамошних торговцев. Каждое состояние, когда-либо отчеканенное, начиналось ровно с такой малости.",
        "completion": "Одно снадобье, честно купленное, и возврат, как обещано: такую сделку ты нечасто увидишь. Держи его закупоренным до черного дня, {playerName}, и помни: торговцы долины продают кирки, топоры и серпы всякому, кто принесет честную монету.",
        "objectives": {
          "0": {
            "label": "Купить целебное снадобье"
          }
        }
      },
      "q_ps_set_sail": {
