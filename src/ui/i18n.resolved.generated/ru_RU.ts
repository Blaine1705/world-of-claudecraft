...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "avatar": {
        "name": "Облик колосса",
        "description": "Снимает эффекты контроля и превращает вас в колосса, повышая наносимый урон на 20% на 20 сек. (Талант воина)"
      },
      "avenging_wrath": {
      ...
      "bladestorm": {
        "name": "Стальной циклон",
        "description": "Вы становитесь стальным вихрем, каждую секунду нанося ближайшим врагам {damage} ед. урона. (Талант воина)"
      },
      "swordguard": {
        "name": "Защита клинка",
        "description": "Снижает получаемый урон на 10% на 8 сек.; если здоровья меньше 30%, снижение становится 20%. (Талант воина)"
      },
      "triumph_rush": {
        "name": "Триумфальный натиск",
        "description": "После убийства врага в течение 20 сек. наносит урон оружием плюс {damage} и исцеляет вас на 20% максимального здоровья. (Талант воина)"
      },
      "razor_howl": {
        "name": "Бритвенный рев",
      ...
      "cone_of_cold": {
        "name": "Ледяной взмах",
        "description": "Обдает ближайших врагов морозом, нанося {damage} ед. урона от льда. (Талант мага)"
      },
      "counter_shot": {
      ...
      "heroic_leap": {
        "name": "Боевой прыжок",
        "description": "Вы прыгаете в выбранную область, нанося ближайшим врагам {damage} ед. физического урона. (Талант воина)"
      },
      "holy_wrath": {
        "name": "Гнев святого",
      ...
      "pummel": {
        "name": "В челюсть",
        "description": "Прерывает произнесение заклинания и запрещает заклинания этой школы на 4 сек. (Талант воина)"
      },
      "rallying_cry": {
        "name": "Сбор",
        "description": "Издает воодушевляющий клич, повышая силу атаки ближайших союзников на 10 сек. (Талант воина)"
      },
      "rebuke": {
        "name": "Укор",
