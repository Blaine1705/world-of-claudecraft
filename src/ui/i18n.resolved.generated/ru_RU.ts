  ...
  "entities": {
    "abilities": {
      ...
      "collective_reversal": {
        ...
        "description": "Отматывает линию времени каждого погибшего участника группы или рейда и возвращает его к жизни у тела с полным запасом здоровья и маны. Нельзя применять в бою. (Хрономантия)"
      },
      "temporal_rewind": {
        "name": "Rewind",
