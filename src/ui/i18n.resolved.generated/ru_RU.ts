...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "cw_heroic_strike": "Готовит более тяжелый замах, который потратит ярость на следующем ударе.",
      "cw_battle_shout": "Боевой клич, повышающий силу атаки всей группы.",
      "cw_commanding_shout": "Повышает выносливость, так что у всех становится больше запаса прочности в бою.",
      "cw_charge": "Рывок к далекому врагу, открывающий бой коротким оглушением.",
      "cw_rend": "Открывает кровотечение, которое изматывает цель со временем.",
      "cw_thunder_clap": "Бьет по всем вокруг вас и замедляет их атаки.",
  ...
  "classDetails": {
    ...
    "roles": {
      ...
      "warriorClassic": "Танк / ближний DPS",
    ...
    "lore": {
      ...
      "warriorClassic": "Воин ровно таким, каким он был до переработки боя: прежний набор способностей и темп ярости. Играйте на обоих и расскажите, какой вам больше по душе.",
  ...
  "entities": {
    "abilities": {
      ...
      "chain_heal": {
        ...
        "description": "Исцеляет цель на {damage}, затем перескакивает на 2 ближайших союзников, и каждый скачок лечит вдвое меньше предыдущего."
      },
      "heroic_strike": {
      ...
      "slam": {
        "name": "Грубый замах",
        "description": "Бьет противника, нанося 50% урона оружием плюс {damage} и генерируя {rage} ед. ярости."
      },
      "cleave": {
        "name": "Жатвенная дуга",
        "description": "Широкий удар, поражающий всех врагов перед вами на {damage} ед. урона."
      ...
      "raging_gale": {
        "name": "Двойной удар",
        "description": "Мгновенно бьет оружием дважды, каждый удар наносит 40% урона оружием плюс {damage}, и создает {rage} ярости. Хранит до 2 зарядов. (ветка «Неистовство»)"
      },
      "red_harvest": {
        "name": "Кровавая жатва",
      ...
      "holy_shock": {
        "name": "Священный шок",
        "description": "Поражает дружественную цель энергией Света, исцеляя ее на {damage}. (ключевая способность ветки «Свет»)"
      },
      "crusader_strike": {
      ...
      "aura_surge": {
        "name": "Лучезарная волна",
        "description": "Перегружает вашу ауру, укрепляя вас 160 ед. брони на 10 сек. (талант паладина)"
      },
      "holy_shield": {
        "name": "Священная стена",
        "description": "Окружает вас силой Света на 10 сек, повышая броню на 90 и нанося атакующим в ближнем бою 12 ед. урона Святой школы. (ключевая способность ветки «Защита»)"
      },
      "repentance": {
        "name": "Покаяние",
        "description": "Погружает врага в медитацию на срок до 6 сек. Любой урон снимает эффект. (ключевая способность ветки «Воздаяние»)"
      },
      "bestial_wrath": {
        "name": "Воющая ярость",
        "description": "Приводит вас в звериную ярость, повышая силу атаки на 55 на 15 сек. (ключевая способность ветки «Повелитель зверей»)"
      },
      "trueshot_aura": {
        "name": "Аура верного полета",
        "description": "Вдохновляет ближайших союзников, повышая силу атаки на 35 на 5 мин. (ключевая способность ветки «Стрельба»)"
      },
      "wyvern_sting": {
        "name": "Укус виверны",
        "description": "Жалит врага издалека, выводя его из строя на срок до 4 сек. Любой урон снимает эффект. (ключевая способность ветки «Выживание»)"
      },
      "arcane_power": {
        "name": "Прилив эфира",
        "description": "Наполняет вас приливом эфира, повышая силу заклинаний на 28 на 12 сек. (ключевая способность ветки «Тайная магия»)"
      },
      "combustion": {
        "name": "Вспышка пламени",
        "description": "Сосредотачивает вашу магию огня, так что ваша следующая атака станет критическим ударом. (ключевая способность ветки «Огонь»)"
      },
      "icy_veins": {
        "name": "Ледяные жилы",
      ...
      "cold_blood": {
        "name": "Спокойствие убийцы",
        "description": "Сосредотачивает вашу жажду убийства, так что ваша следующая атака станет критическим ударом. (ключевая способность ветки «Ликвидация»)"
      },
      "blade_flurry": {
        "name": "Зеркальные клинки",
        "description": "Обрушивает шквал клинков, повышая скорость атаки на 20% на 12 сек. (ключевая способность ветки «Бой»)"
      },
      "hemorrhage": {
        "name": "Красная лента",
        "description": "Поражает врага на урон оружием плюс {damage} и вызывает кровотечение в течение 12 сек. Дает 1 очко серии. (ключевая способность ветки «Скрытность»)"
      },
      "power_infusion": {
        "name": "Помазание",
        "description": "Наполняет дружественную цель силой, повышая силу заклинаний на 28 на 15 сек. (ключевая способность ветки «Послушание»)"
      },
      "holy_nova": {
        "name": "Кольцо света",
        "description": "Вызывает взрыв Целительного Света, исцеляя ближайших союзников на {damage} и нанося урон ближайшим врагам. (ключевая способность ветки «Свет»)"
      },
      "shadowform": {
        "name": "Сумеречная завеса",
        "description": "Принимает Сумеречную завесу, усиливая магию тьмы, пока вы не выйдете из нее. Примените снова, чтобы вернуться в обычный облик. (ключевая способность ветки «Тьма»)"
      },
      "elemental_mastery": {
        "name": "Первородное мастерство",
        "description": "Призывает первородное мастерство, делая ваше следующее заклинание мгновенным. (ключевая способность ветки «Стихии»)"
      },
      "shamanistic_rage": {
      ...
      "siphon_life": {
        "name": "Иссушение вен",
        "description": "Вытягивает жизнь из врага, нанося {damage} ед. урона от Тьмы за 30 сек и исцеляя вас на нанесенный урон. (ключевая способность ветки «Колдовство»)"
      },
      "fel_domination": {
        "name": "Власть Скверны",
      ...
      "conflagrate": {
        "name": "Испепеление",
        "description": "Поглощает ваш Пылающий договор на враге, воспламеняя его на {damage} ед. урона от огня. (ключевая способность ветки «Разрушение»)"
      },
      "moonkin_form": {
        "name": "Облик лунокрыла",
        "description": "Принимает Облик лунокрыла, усиливая произнесение заклинаний, пока вы не выйдете из него. Примените снова, чтобы вернуться в обычный облик. (ключевая способность ветки «Баланс»)"
      },
      "feral_charge": {
        "name": "Дикий бросок",
        "description": "Бросается к врагу и обездвиживает его на 1 сек. Дальность 8-25 м. (ключевая способность ветки «Сила зверя»)"
      },
      "swiftmend": {
        "name": "Быстрое заживление",
        "description": "Поглощает эффект периодического исцеления на дружественной цели, исцеляя ее на {damage}. (ключевая способность ветки «Восстановление»)"
      },
      "storm_bolt": {
      ...
      "aspect_of_the_wild": {
        ...
        "description": "Вдохновляет находящихся рядом союзников дикой силой, повышая силу атаки на 5 мин. (Талант охотника)"
      },
      "avatar": {
        "name": "Аватара",
        "description": "Превращает вас в колосса на 20 сек, снимая с вас весь контроль и повышая наносимый урон на 20%."
      },
      "avenging_wrath": {
        "name": "Крыло возмездия",
        "description": "Призывает карающую силу, повышая силу атаки и силу заклинаний на 20 сек. (Талант паладина)"
      },
      "berserk": {
        "name": "Багровая дымка",
        "description": "Повышает силу атаки на 15 сек. (Талант друида)"
      },
      "bladestorm": {
        "name": "Клинковая буря",
        "description": "Становится вихрем стали, поражая всех врагов в пределах 8 м на {damage} каждую секунду в течение 4 сек."
      },
      "razor_howl": {
        "name": "Бритвенный рев",
        "description": "Замедляет врагов в радиусе 15 м на 50% на 8 сек. (Талант воина)"
      },
      "stormthrow": {
        "name": "Штормовой бросок",
        "description": "Бросает оружие и оглушает цель на 3 сек. (Талант воина)"
      },
      "reckless_vow": {
        "name": "Безрассудная клятва",
        "description": "Повышает весь прирост ярости на 50%, а шанс критического удара на 20% на 12 сек. (Талант воина)"
      },
      "red_banner": {
        "name": "Красное знамя",
        "description": "Вы и ближайшие союзники получаете на 10% больше скорости атаки и урона на 20 сек. (Талант воина)"
      },
      "blink": {
        "name": "Мерцающий шаг",
        "description": "Переносит вас на 15 м вперед и снимает эффекты обездвиживания. (Талант мага)"
      },
      "bloodlust": {
        "name": "Боевые барабаны",
        "description": "Приводит ближайших союзников в неистовство, повышая скорость атаки на 15 сек. (Талант шамана)"
      },
      "chain_lightning": {
        "name": "Разветвленная молния",
        "description": "Обрушивает молнию на выбранную область, нанося ближайшим врагам {damage} ед. урона. (Талант шамана)"
      },
      "chaos_bolt": {
        "name": "Стрела погибели",
        "description": "Выпускает снаряд хаотического огня, наносящий {damage} ед. урона от огня. (Талант чернокнижника)"
      },
      "cloak_of_shadows": {
        "name": "Плащ теней",
        "description": "Окутывает вас тенями, поглощая урон в течение 5 сек. (Талант разбойника)"
      },
      "cone_of_cold": {
        "name": "Ледяной взмах",
      ...
      "counter_shot": {
        ...
        "description": "Прерывает произнесение заклинания и запрещает заклинания этой школы на 4 сек. (Талант охотника)"
      },
      "counterspell": {
        "name": "Чаролом",
        "description": "Прерывает произнесение заклинания противника и запрещает заклинания этой школы на 6 сек. (Талант мага)"
      },
      "curse_of_exhaustion": {
        "name": "Свинцовое проклятие",
        "description": "Проклинает цель, снижая скорость передвижения на 30% на 12 сек. (Талант чернокнижника)"
      },
      "death_coil": {
        "name": "Могильная спираль",
        "description": "Наносит врагу {damage} ед. темного урона, а затем приводит его в ужас на 3 сек. Это заклинание не исцеляет заклинателя. (Талант чернокнижника)"
      },
      "deep_freeze": {
        "name": "Мертвый мороз",
      ...
      "desperate_prayer": {
        ...
        "description": "Мгновенно исцеляет вас на {damage} ед. (Талант жреца)"
      },
      "deterrence": {
        "name": "Колючий страж",
        "description": "Повышает ваш шанс уклонения на 50% на 10 сек. (Талант охотника)"
      },
      "divine_shield": {
        "name": "Световой оберег",
        "description": "Окружает вас святой защитой, поглощающей огромный урон в течение 8 сек. (Талант паладина)"
      },
      "earthbind": {
        "name": "Хватка земли",
        "description": "Приковывает ближайших врагов к земле, обездвиживая их на 2 сек. (Талант шамана)"
      },
      "evocation": {
      ...
      "frenzied_regeneration": {
        ...
        "description": "Восстанавливает здоровье в течение 10 сек. Только в облике бурого медведя. (Талант друида)"
      },
      "frost_trap": {
        "name": "Инейная ловушка",
        "description": "Замораживает врагов в выбранной области на 3 сек. (Талант охотника)"
      },
      "ghostly_strike": {
        "name": "Призрачный удар",
        "description": "Наносит врагу урон оружием и дополнительно {damage} ед. урона, ненадолго повышая уклонение. Дает 1 очко серии приемов. (Талант разбойника)"
      },
      "hammer_of_wrath": {
        "name": "Звонкий молот",
        "description": "Метает святой молот в раненого врага, нанося {damage} ед. светлого урона. Действует только на цели со здоровьем ниже 20%. (Талант паладина)"
      },
      "healing_stream": {
        "name": "Источник",
        "description": "Исцеляет союзника в течение 12 сек. (Талант шамана)"
      },
      "heroic_leap": {
        "name": "Героический прыжок",
        "description": "Прыгает в указанную область, нанося {damage} ед. урона ближайшим врагам."
      },
      "holy_wrath": {
        "name": "Гнев святого",
        "description": "Высвобождает святую силу, нанося ближайшим врагам {damage} ед. урона. (Талант паладина)"
      },
      "howl_of_terror": {
        "name": "Вой ужаса",
        "description": "Приводит ближайших врагов в ужас на срок до 3 сек. Урон может развеять эффект. (Талант чернокнижника)"
      },
      "ice_block": {
        "name": "Холодный гроб",
      ...
      "inner_focus": {
        "name": "Утихший разум",
        "description": "Ваше следующее заклинание не потребует затрат. Действует 60 сек. (Талант жреца)"
      },
      "innervate": {
        "name": "Живой сок",
        "description": "Живой сок наполняет вас в течение 10 сек., волнами восполняя 20 текущего ресурса: ману, ярость или энергию; смена облика его не прерывает. (талант друида)"
      },
      "kick": {
        "name": "Пинок",
        "description": "Прерывает произнесение заклинания и запрещает заклинания этой школы на 4 сек. (Талант разбойника)"
      },
      "last_stand": {
        "name": "Одиннадцатый час",
        "description": "Временно повышает выносливость на 15 сек., увеличивая максимальный запас здоровья. (Талант воина)"
      },
      "mend_pet": {
        "name": "Перевязка",
      ...
      "meteor": {
        ...
        "description": "Обрушивает метеор на выбранную область, нанося {damage} ед. урона от огня и поджигая землю. (Талант мага)"
      },
      "mind_sear": {
        "name": "Выжигание мыслей",
        "description": "Направляет темную энергию в выбранную область, каждую секунду нанося ближайшим врагам {damage} ед. урона. (Талант жреца)"
      },
      "multi_shot": {
        "name": "Раздвоенный выстрел",
        "description": "Выпускает несколько снарядов, нанося ближайшим врагам {damage} ед. урона. (Талант охотника)"
      },
      "prayer_of_healing": {
        "name": "Хоровое исцеление",
        "description": "Исцеляет ближайших союзников на {damage} ед. (Талант жреца)"
      },
      "preparation": {
        "name": "Запасной план",
        "description": "Мгновенно восстанавливает спринт, уклонение и исчезновение. (Талант разбойника)"
      },
      "presence_of_mind": {
        "name": "Быстрый разум",
      ...
      "psychic_scream": {
        ...
        "description": "Приводит ближайших врагов в ужас на срок до 4 сек. Урон может развеять эффект. (Талант жреца)"
      },
      "pummel": {
        "name": "Тумак",
        "description": "Прерывает произнесение заклинания, не давая произносить заклинания этой школы в течение 4 сек. Создает 10 ярости, когда прерывает произнесение."
      },
      "rallying_cry": {
        "name": "Сплачивающий клич",
        "description": "Издает сплачивающий клич, даруя вам и членам группы в пределах 40 м 20% дополнительного максимального здоровья в течение 10 сек."
      },
      "rebuke": {
        "name": "Укор",
        "description": "Прерывает произнесение заклинания и запрещает заклинания этой школы на 4 сек. (Талант паладина)"
      },
      "shadowstep": {
        "name": "Теневой шаг",
        "description": "Вы проскальзываете сквозь тени к своей цели. (Талант разбойника)"
      },
      "shield_wall": {
        "name": "Бастион",
        "description": "Возводит нерушимую преграду, значительно повышая броню на 10 сек. (Талант воина)"
      },
      "silence": {
        "name": "Безмолвие",
        "description": "Заставляет цель замолчать на 4 сек. (Талант жреца)"
      },
      "skull_bash": {
        "name": "Удар черепом",
        "description": "Прерывает произнесение заклинания и запрещает заклинания этой школы на 4 сек. (Талант друида)"
      },
      "spell_lock": {
        "name": "Приказ заткнуть",
        "description": "Прерывает произнесение заклинания и запрещает заклинания этой школы на 5 сек. (Талант чернокнижника)"
      },
      "tranquility": {
        "name": "Песнь рощи",
        "description": "Направляет восстанавливающую энергию, каждую секунду исцеляя ближайших союзников. (Талант друида)"
      },
      "bear_charge": {
        "name": "Натиск бурого",
