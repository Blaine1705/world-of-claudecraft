  ...
  "entities": {
    "abilities": {
      ...
      "solar_invocation": {
        ...
        "description": "Призывает Свет и восстанавливает {damage} ед. здоровья всем союзным игрокам в радиусе 40 м."
      },
      "radiant_devotion": {
      ...
      "mercy_lance": {
        ...
        "description": "Исцеляет союзника или наносит противнику {damage} ед. урона и накапливает 1 ед. рвения. При вознесении лечение также исцеляет ближайшего союзника."
      },
      "sacred_form": {
      ...
      "bastion_rite": {
        "name": "Обряд бастиона",
        "description": "Уменьшает получаемый физический урон на 20% на 6 сек. и накапливает 1 ед. рвения. Вознесение продлевает действие до 10 сек."
      },
      "sunward_disc": {
        "name": "Солнечный диск",
