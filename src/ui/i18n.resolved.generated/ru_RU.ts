  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        ...
        "greeting": "Истврукская долина принимает всех, друг. А для тех, кто еще нетвердо стоит на ногах, всегда есть Берег Испытаний: круг парома на западном берегу работает в обе стороны круглый год."
      },
      "instructor_maren": {
      ...
      "ferryman_odo": {
        ...
        "greeting": "Пролив спокоен, и лодка крепка, {playerName}. Когда будешь готов отправиться в долину, круг переправы в конце моего причала перенесет тебя."
      },
      "bursar_wick": {
        "name": "Казначей Уик",
        "title": "Золочёный сундук",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        ...
        "text": "Пара слов о том, что ты носишь, {playerName}. В твоем заплечном мешке шестнадцать ячеек, а рядом ждут четыре пустые петли для сумок: каждая пристегнутая сумка добавляет свое место в общий запас. Что не унесешь, то сбережет Золочёный сундук: любой казначей в любом городе открывает одно и то же хранилище, а когда кошелек подрастет, можно докупить и место в хранилище. А теперь закрепим привычку: купи у интенданта Финч льняной мешочек и пристегни его.",
        "completion": "Славный мешочек, и еще шесть ячеек под будущие неприятности. Ценное держи в хранилище, а сумки просторными, {playerName}. Набитый доверху мешок оборвал больше приключений, чем любой волк.",
        "objectives": {
          "0": {
      ...
      "q_ps_set_sail": {
        ...
        "completion": "Марен так сказала? Высокая похвала от женщины, что неделю заставляла меня вязать швартовые узлы. Круг в конце моего причала перенесет тебя в долину, как только в него войдешь, {playerName}. Берегись волков.",
        "objectives": {
          "0": {
