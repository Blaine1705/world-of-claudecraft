...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsNote": "Для любой залежи нужен инструмент своего ремесла в сумках, в том числе для залежей 1 уровня: без кирки нет руды, без удочки нет рыбы. У торговцев есть инструменты с 1 по 3 уровень, и каждый узловой город держит только те уровни, которые нужны его собственным угодьям: инструмент 1 уровня продаётся в любом узловом городе, а ступени выше продаются там, где лежат залежи, которым они нужны. За эти ступени торговцы дополнительно требуют владения ремеслом самого инструмента: {tier2Prof} для 2 уровня и {tier3Prof} для 3 уровня, и строка называет требование. Инструменту достаточно лежать в сумках, ячейки экипировки и прочности у него нет, так что покупка разовая, а то, что уже есть у вас на руках, продолжает работать. Для проверки важен только уровень инструмента: цвет редкости чисто декоративный.\n\nВыше торговой лестницы стоят два создаваемых инструмента, 4 и 5 уровня: их делают инженеры в мастерской, и ни один NPC их не продаёт. Сегодня ни одной залежи не нужно больше 3 уровня, поэтому их ценность сейчас в скорости: лучший инструмент удерживает время сбора на минимуме на низких залежах и станет пропуском, когда появятся угодья более высоких уровней.",
