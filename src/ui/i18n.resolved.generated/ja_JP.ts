  ...
  "entities": {
    ...
    "npcs": {
      ...
      "quartermaster_finch": {
        "name": "補給係フィンチ",
        "title": "野営地の商人",
        "greeting": "パンに水、それに稽古が過ぎたときのための薬。銅貨があれば買えるし、銅貨は働いて稼ぐもの。それが経済のすべてだよ、{playerName}。これ以上難しくはならない。大きくなるだけさ。"
      },
      "ferryman_odo": {
        "name": "渡し守オド",
        "title": "渡し場の番人",
    ...
    "quests": {
      ...
      "q_ps_find_your_feet": {
        "title": "第一歩",
        "text": "ようこそ修練の浜へ、{playerName}。この島では、こちらから手を出さない限り噛みついてくるものはいない。だから静かな今のうちに、野営地を歩いて顔ぶれを覚えておくといい。補給係フィンチが物資を、渡し守オドが帰り道を預かっている。二人を訪ねたら、私のところへ戻っておいで。",
        "completion": "足も速いし、湯が沸く前に戻ってきたね。これで野営地は頭に入った、{playerName}。つまり、本当に噛みつかれたときにどこへ走ればいいかも分かったということだ。",
        "objectives": {
          "0": {
            "label": "補給係フィンチを訪ねる"
          },
      ...
      "q_ps_strike_true": {
        "title": "確かな一撃",
        "text": "振ったことのない剣は、ただの重い棒だよ、{playerName}。野営地の南西の練習場に立つかかしは、打たれるために作られている。ひとつ選んで、構えて、三体崩れるまで打ち込みなさい。かかしは打ち返してこない。この浜の外にいるものは、打ち返してくる。",
      ...
      "q_ps_tools_of_the_trade": {
        "title": "商いの道具",
        "text": "銅貨は使うためにある、{playerName}。そしてうちは正直な店だ。私から治療薬をひと瓶買ってごらん。授業料としてお代より多く払い戻そう。店を見つけ、値段を量り、釣り銭を数える。渓谷に着いたら、残りはあちらの商人の採集道具に使うといい。鋳られた財産というものは、みんなこれくらい小さく始まったのさ。",
        "completion": "ひと瓶、きちんと買って、約束どおりの払い戻し。こんな良い取引にはそうそう出会えないよ。まさかの日のために栓をしたまま取っておきなさい、{playerName}。それから、渓谷の商人はまっとうな銅貨を持つ者になら誰にでも、つるはしも斧も鎌も売ってくれることを覚えておいで。",
        "objectives": {
          "0": {
            "label": "治療薬を購入する"
          }
