...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "battleStance": "戦闘スタンス: 怒りの生成が10%増加",
      "berserkerStance": "バーサーカースタンス: クリティカルが3%増え、3%強く命中",
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "hamstring": "相手の脚を切りつけて減速させ、追いつかれないようにします。",
  ...
  "entities": {
    "abilities": {
      ...
      "defensive_stance": {
        "name": "ガーデッドスタンス",
        "description": "防御用の戦闘スタンスです。脅威生成が30%増加しますが、与えるダメージと受けるダメージが10%低下します。バトルスタンスを使用すると攻撃態勢に戻ります。"
      },
      "battle_stance": {
        "name": "バトルスタンス",
        "description": "攻撃的な戦闘スタンスです。怒りの生成が10%増加します。武器と防御の既定スタンスです。"
      },
      "berserker_stance": {
        "name": "バーサーカースタンス",
        "description": "無謀な戦闘スタンスです。クリティカル発生率が3%上昇し、クリティカルダメージが3%増加します。フュリーの戦士は常にこのスタンスで戦います。"
      },
      "sunder_armor": {
        "name": "装甲切断",
      ...
      "enrage_passive": {
        "name": "激昂",
        "description": "パッシブ：激昂中は与ダメージ11%、攻撃速度25%、移動速度10%上昇（4秒）。ブラッドレットは30%の確率で、レッドハーヴェストは必ず激昂させる。（フューリー）"
      },
      "bloodthirst": {
        "name": "瀉血",
      ...
      "emboldening_roar": {
        "name": "鼓舞の咆哮",
        "description": "鼓舞の咆哮を上げ、自身と40ヤード以内の味方プレイヤーが鼓舞状態になります。次の3回のアビリティが必ずクリティカルヒットになります。（狂怒）"
      },
      "raised_guard": {
        "name": "盾構え",
        "description": "盾を構えて身を守ります：6秒間、受ける物理ダメージが50%減少します。（防御）"
      },
      "iron_resolve": {
        "name": "痛み無視",
        "description": "歯を食いしばって痛みを無視します：怒りをすべて消費し（最低20）、消費した怒り1につき4のダメージを吸収します。最大10秒持続します。（防御）"
      },
      "faultline": {
        "name": "衝撃波",
        "description": "地面に衝撃波を放ちます：前方8ヤード以内の敵に {damage} のダメージを与え、3秒間スタンさせます。（防御）"
      },
      "defiant_bellow": {
        "name": "反抗の雄叫び",
        "description": "反抗の雄叫びを上げます：10ヤード以内のすべての敵を挑発し、3秒間自分を攻撃させます。（防御）"
      },
      "breachmaker": {
        "name": "崩城の一撃",
        "description": "対象を武器ダメージに加えて{damage}で殴りつけ、その防御を打ち砕きます：8秒間、あなた自身の攻撃がその対象に20%多くのダメージを与えます。（武器）"
      },
      "measured_fury": {
        "name": "沈着なる怒り",
        "description": "あなたの沈着な怒りが立ち回りを研ぎ澄まします：あなたの能力の怒り消費が10%減少します。（武器）"
      },
      "shield_slam": {
        "name": "盾砕き",
      ...
      "storm_bolt": {
        "name": "ストームボルト",
        "description": "武器を投げつけて{damage}のダメージを与え、対象を3秒間スタンさせます。"
      },
      "piercing_howl": {
        "name": "ピアシングハウル",
        "description": "鋭い咆哮を上げ、15ヤード以内の敵全員を8秒間50%減速させます。"
      },
      "die_by_sword": {
        "name": "ダイ・バイ・ザ・ソード",
      ...
      "recklessness": {
        "name": "レックレスネス",
        "description": "激怒：12秒間、怒りの生成が50%、クリティカル率が20%増加します。"
      },
      "avatar": {
        "name": "アヴァター",
        "description": "20秒間巨像に変身し、自身へのすべての制御効果を解除し、与えるダメージが20%増加します。"
      },
      "sanguine_aura": {
        "name": "サングインオーラ",
        "description": "敵の血で武器を染め上げます。自身と近接の味方の攻撃速度が10%、ダメージが10%増加します。20秒間持続します。"
      },
      "victory_rush": {
        "name": "ヴィクトリーラッシュ",
        "description": "武器ダメージ+{damage}の一撃を放ち、最大体力の20%を回復します。敵を倒してから20秒以内のみ使用可能です。"
      },
      "bladestorm": {
        "name": "ブレードストーム",
        "description": "鋼鉄の旋風と化し、4秒間、毎秒8ヤード以内のすべての敵に{damage}のダメージを与えます。"
      },
      "intimidating_shout": {
        "name": "威嚇の雄叫び",
        "description": "恐ろしい雄叫びを上げ、8ヤード以内の最大5体の敵を8秒間恐怖で逃げ惑わせます。ダメージで効果が解除されることがあります。"
      },
      "pummel": {
        "name": "パンメル",
        "description": "詠唱を妨害し、その系統の呪文を4秒間詠唱不能にします。詠唱を止めると怒りを10生成します。"
      },
      "heroic_leap": {
        "name": "ヒロイックリープ",
        "description": "目標地点へ跳躍し、周囲の敵に{damage}のダメージを与えます。"
      },
      "rallying_cry": {
        "name": "ラリングクライ",
        "description": "鬨の声を上げ、自身と40ヤード以内のパーティメンバーの最大体力を10秒間20%増加させます。"
      },
      "summon_imp": {
        "name": "エンバーキンの召喚",
