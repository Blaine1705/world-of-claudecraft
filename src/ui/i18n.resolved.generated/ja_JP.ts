...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "渡ってきたばかりかい？ようこそ修練の浜へ。教官マレンが私の後ろの道の先、暁の野営地で稽古を仕切っている。彼女の名前が見えるところまで歩み寄って、Fを押すか、左クリックすれば話ができる。最初の仕事を言いつけてくれるはずだ。発つ支度ができたら、私の桟橋のそばに立つ鐘を鳴らしなさい。渡しがイーストブルックの家まで運んでくれる。",
      "noteClose": "わかった"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "確かな一撃",
        "text": "ようこそ修練の浜へ、{playerName}。ここの稽古はどれも同じところから始まる。足を据え、刃を握ること。W、A、S、Dで歩き、マウス右ボタンを押したまま視線を回しなさい。野営地の南西の練習場に立つかかしは、打たれるために作られている。ひとつに歩み寄ってTabを押すか、左クリックすれば、それが君のターゲットになる。あとは1を押すか、画面下のアクションバーの最初のアイコンをクリックすれば、刃が振れる。三体崩れるまで打ち込みなさい。かかしの打ち返しなど、かすり傷にもならない。この浜の外にいるものは、はるかに強く打ってくる。",
