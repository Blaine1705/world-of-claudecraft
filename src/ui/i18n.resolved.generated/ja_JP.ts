...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "渡ってきたばかりかい？ようこそ修練の浜へ。W、A、S、Dで歩き、マウスの右ボタンを押したままにすれば視点を回せる。教官マレンが私の後ろの道の先、暁の野営地で稽古を仕切っている。彼女の名前が見えるところまで歩み寄って、Fを押すか、左クリックすれば話ができ、最初の仕事を言いつけてくれるはずだ。発つ支度ができたら、私の桟橋のそばに立つ鐘を鳴らしなさい。渡しがイーストブルックの家まで運んでくれる。",
      "noteClose": "わかった"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "確かな一撃",
        "text": "ようこそ修練の浜へ、{playerName}。ここの稽古はどれも同じところから始まる。足を据え、刃を握ること。野営地の南西の練習場に立つかかしは、打たれるために作られている。練習場が見つからないときはMを押して地図を開きなさい。引き受けた仕事はすべてそこに印がつくから、迷い歩く必要はない。かかしのひとつに歩み寄ってTabを押すか、左クリックすれば、それが君のターゲットになる。あとは1を押すか、画面下のアクションバーの最初のアイコンをクリックすれば、刃が振れる。三体崩れるまで打ち込みなさい。かかしの打ち返しなど、かすり傷にもならない。この浜の外にいるものは、はるかに強く打ってくる。",
      ...
      "q_ps_the_wreck_line": {
        "title": "難破の浜",
        "text": "潮はこの島に漂着物で払いをする。古い難破船の木箱が、野営地の南東、渓谷に面した浜辺に打ち上げられるんだ。開けるのは簡単だよ、{playerName}。木箱の名前が見えるところまで歩み寄って、Fを押すか、木箱そのものを左クリックすれば、中身を差し出してくれる。三つで足りる。漂着物を漁る蟹どもは見た目より強く挟むから、足元には気をつけて。それから覚えておきなさい、この先出会うどんな宝箱も、採集場所も、扉も、開けるのは同じFひとつきりだよ。",
