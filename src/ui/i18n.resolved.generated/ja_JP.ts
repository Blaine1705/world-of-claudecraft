  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人ブリン",
        "title": "港の案内人",
        "greeting": "イーストブルック渓谷は来る者を拒まないよ、旅の人。まだ足元がおぼつかないなら、修練の浜がある。東の浜の渡しの円環は、年中どちら向きにも通じているからね。"
      },
      "instructor_maren": {
        "name": "教官マレン",
        "title": "修練の師",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "確かな一撃",
        "text": "振ったことのない剣は、ただの重い棒だよ、{playerName}。野営地の南の練習場に立つかかしは、打たれるために作られている。ひとつ選んで、構えて、三体崩れるまで打ち込みなさい。かかしは打ち返してこない。この浜の外にいるものは、打ち返してくる。",
