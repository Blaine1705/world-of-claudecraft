...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "strafeBody": "横に動く方法はもうひとつある。{strafeKey}を軽く押して最後のレーンに一歩入り、次に{forwardKey}を押したまま{strafeKey}で横歩きし、赤い旗が背後に来るまで進もう。横歩きなら視線を敵に置いたまま動ける。いつか戦いでそう動く日が来る。",
      ...
      "taskStrikeTrueBodyCaster": "藁のかかしに歩み寄り、{targetKey}を押すか、左クリックしてターゲットにしよう。次に{attackKey}を押すか、アクションバーの二番目のボタンをクリックして呪文を唱えよう。一体が崩れるまで唱え続けること。",
      ...
      "taskShellBodyCaster": "浜辺ガニは挟み返してくる。{targetKey}を押すか、左クリックして一匹をターゲットにし、{attackKey}を押して呪文を唱え、離れたまま唱え続けよう。一度に多くに襲われたら、道を引き返して退くこと。連中はすぐ追うのをあきらめるし、休んでいる間に体力は戻ってくる。",
      "taskShellBodyCasterTouch": "浜辺ガニは挟み返してくる。一匹をタップしてターゲットにし、アクションバーの二番目のボタンをタップして呪文を唱え、離れたまま唱え続けよう。一度に多くに襲われたら、道を引き返して退くこと。連中はすぐ追うのをあきらめるし、休んでいる間に体力は戻ってくる。",
      "taskShellBodyCasterPad": "浜辺ガニは挟み返してくる。ターゲットボタンを押し、次に二番目のアクションボタンを押して呪文を唱え、離れたまま唱え続けよう。一度に多くに襲われたら、道を引き返して退くこと。連中はすぐ追うのをあきらめるし、休んでいる間に体力は戻ってくる。",
