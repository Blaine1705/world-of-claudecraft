...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "doneTitle": "走破",
      "doneBody": "体の動かし方はこれで全部だ。門のウォーデン・タムのところへ歩いて戻り、走りの報告をしよう。ねぎらいの言葉と、最初の報酬が待っている。"
    },
    "widgets": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_the_gauntlet": {
        "title": "ガントレットを走れ",
        "text": "渓谷に名を知られた者は皆、まずこのレーンを走った、{playerName}。最初のレーンを西へ旗まで歩き、あたりをよく見回し、南のレーンを左へ滑って二本目の旗へ、もう一度見回してから、最後のレーンを赤い旗まで駆け抜けるんだ。旗は順番どおりに通ること。画面上部のカードが、そのつど必要なボタンを見せてくれる。赤い旗を越えたら、門の私のところへ戻っておいで。",
        "completion": "見事な走りだ、{playerName}。脚はもうレーンを覚えた。残りの体は本物の仕事に出せる。教官マレンが桟橋から北へ道を上った先の暁の野営地で稽古を仕切っている。名前が見えるところまで歩み寄って、Fを押すか、左クリックすれば、最初の仕事を言いつけてくれるよ。",
        "objectives": {
          "0": {
            "label": "ガントレットの旗を通過"
          }
