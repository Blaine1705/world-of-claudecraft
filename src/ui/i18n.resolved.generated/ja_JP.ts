  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人ブリン",
        "title": "港の案内人",
        "greeting": "イーストブルック渓谷は来る者を拒まないよ、旅の人。まだ足元がおぼつかないなら、修練の浜がある。西の浜の渡しの円環は、年中どちら向きにも通じているからね。"
      },
      "instructor_maren": {
        "name": "教官マレン",
        "title": "修練の師",
      ...
      "ferryman_odo": {
        "name": "渡し守オド",
        "title": "渡し場の番人",
        "greeting": "海峡は穏やかで、船も頑丈だ、{playerName}。渓谷へ行く支度ができたら、桟橋の先の渡しの円環がいつでも運んでくれる。"
      },
      "bursar_wick": {
        "name": "出納係ウィック",
        "title": "金張りの金庫",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "ポーチと財布",
        "text": "君の持ち物の話をしよう、{playerName}。背嚢には十六の枠があり、その横に空の鞄留めが四つ待っている。鞄を留めるたびに、その分の空きが全体に加わる仕組みだ。持ちきれないものは金張りの金庫が預かる。どの町のどの出納係も同じ金庫を開けてくれるし、財布が育てば金庫の枠も買い足せる。さあ、習慣づけの練習だ。補給係フィンチから亜麻のポーチを買って、留めてごらん。",
        "completion": "良いポーチだ。厄介ごとを詰める枠が六つ増えたね。値打ち物は金庫へ、鞄には余裕を、{playerName}。狼よりも多くの冒険を終わらせてきたのは、はち切れた背嚢のほうなんだよ。",
        "objectives": {
          "0": {
            "label": "亜麻のポーチを購入する"
          }
      ...
      "q_ps_set_sail": {
        ...
        "completion": "マレンがそう言ったのかい？私に一週間も舫い結びの稽古をさせた人からの、これは大した誉め言葉だ。桟橋の先の円環に足を踏み入れれば、いつでも渓谷へ運んでくれるよ、{playerName}。狼には気をつけて。",
        "objectives": {
          "0": {
            "label": "渡し守オドに報告する"
          }
