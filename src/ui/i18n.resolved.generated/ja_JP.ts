  ...
  "hudChrome": {
    ...
    "statInfo": {
      ...
      "desc": {
        ...
        "healPower": "回復と継続回復効果の回復量、および吸収シールドの量を高めます。呪文威力に、装備とセットボーナスによる治癒力を加えた値です。治癒力は回復のみを高め、ダメージは高めません。",
        "dps": "武器のダメージと速度に攻撃力を組み合わせて算出した、推定の秒間ダメージです。",
        "critChance": "攻撃がクリティカルとなり、ダメージが2倍になる確率です。",
        "spellCrit": "呪文や回復がクリティカルとなり、150%のダメージまたは回復量になる確率です。呪文と回復はクリティカル率の代わりにこの確率を使います。知力はこの確率のみを高め、クリティカルレーティング、タレント、セットボーナスは両方を高めます。",
