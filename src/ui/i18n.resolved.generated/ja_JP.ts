  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人ブリン",
        "title": "港の案内人",
        "greeting": "イーストブルック渓谷は来る者を拒まないよ、旅の人。まだ足元がおぼつかないなら、修練の浜がある。西の浜の渡しの鐘は、年中どちら向きにも鳴るからね。"
      },
      "instructor_maren": {
        "name": "教官マレン",
        "title": "修練の師",
    ...
    "quests": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "ポーチと財布",
        "text": "渓谷へ発つ前にもうひとつ、冒険者の命を守る授業だよ、{playerName}。君の持ち物の話だ。背嚢には十六の枠があり、その横に空の鞄留めが四つ待っている。鞄を留めるたびに、その分の空きが全体に加わる。補給係フィンチから亜麻のポーチを買って留めたら、この授業を金庫机の出納係ウィックのところへ持っていきなさい。彼が預かるのは、どんな鞄にも収まらない残り半分だ。",
        "completion": "マレンがようやく生徒を寄こしたか。ポーチは君のものだ。そして授業の残り半分はこうだよ、{playerName}。持ちきれないものは金張りの金庫が預かる。どの町のどの出納係も同じ金庫を開けてくれるし、財布が育てば金庫の枠も買い足せる。値打ち物は金庫へ、鞄には余裕を。狼よりも多くの冒険を終わらせてきたのは、はち切れた背嚢のほうなんだ。",
        "objectives": {
          "0": {
            "label": "亜麻のポーチを購入する"
          }
