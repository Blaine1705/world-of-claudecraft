...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hill": {
      ...
      "standingLevel": "レベル {level} になるまで、あなたは丘の人数に数えられません"
    },
    "warfareShop": {
  ...
  "guide": {
    ...
    "worldPvpPage": {
      "heading": "ワールドPvP",
      "intro": "オープンワールドの対人戦は任意参加です。PvPフラグを立てると、パーティやレイドに属さないフラグを立てた全プレイヤーがオープンワールドのどこでも敵になります。フラグを下ろすと、少し経てば再び傍観者に戻ります。フラグを立てていない人は攻撃することも攻撃されることもありません。",
      ...
      "introZones": "オープンワールドの対人戦は任意参加で、その意味は足元の土地が決めます。PvPフラグを立てると、パーティ、レイド、ギルドに属さないフラグを立てた全プレイヤーが係争地で敵になります。フラグを下ろすと、少し経てば再び傍観者に戻ります。2つのゾーンはワールドの戦闘が一切起こらない聖域で、レベル上限のゾーンのうち3つは、フラグの有無に関わらずその場の全員が攻撃対象となる無差別戦闘地帯です。パーティとレイドの仲間はどこでも敵になりませんが、グループ外のギルドメンバーは他の誰とも同じく攻撃対象です。",
