...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "見かけない顔だね、旅の人。この道を歩くのが初めてなら、世界の試練に挑む前に腕を磨き、この土地に慣れられる場所がある。修練の浜、海峡の向こうの静かな島だ。渡し船は行きも帰りも出ているし、行っても行かなくても誰も君を軽んじたりはしないよ。",
      "bodyRefresher": "新しい顔でまた来たのかい？なら勝手は分かっているね。それでも旅立つ前におさらいがしたければ、修練の浜は出戻りの生徒を追い返したりしない。渡し船はいつでも出せるよ。",
      "play": "チュートリアルを受ける",
      "skip": "チュートリアルを飛ばす",
      "declineNote": "お好きにどうぞ、旅の人。気が変わったら、私のそばのこの鐘がいつでも修練の浜へ運んでくれる。昼でも夜でもね。狼は待ってくれないが、この鐘は待っていてくれるよ。",
      "bellHomeNote": "もう浜から戻ったのかい？さっき鳴らしたのが渡しの鐘だよ。その双子がちょうど私のそばに立っている。いつでも鳴らせば、渡しが修練の浜へ運び直してくれる。間違って鳴らしたのなら、それはそれで構わないさ。",
      "noteClose": "わかった"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "wayfarer_bryn": {
        "name": "旅人ブリン",
        "title": "港の案内人",
        "greeting": "イーストブルック渓谷は来る者を拒まないよ、旅の人。まだ足元がおぼつかないなら、修練の浜がある。私のそばのこの鐘が年中いつでも向こうへ運んでくれるし、島の双子の鐘が帰り道を鳴らしてくれる。"
      },
      "instructor_maren": {
        "name": "教官マレン",
        "title": "修練の師",
      ...
      "ferryman_odo": {
        "name": "渡し守オド",
        "title": "渡し場の番人",
        "greeting": "渡ってきたばかりかい、{playerName}？なら浜の道を上っていきなさい。教官マレンが暁の野営地で稽古を仕切っていて、何よりも先に君と話したがるはずだ。渓谷が君を呼び戻したら、桟橋の先の鐘を鳴らせば、渡しがイーストブルックの町まで送り届けてくれる。"
      },
      "bursar_wick": {
        "name": "出納係ウィック",
        "title": "金張りの金庫",
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "確かな一撃",
        "text": "ようこそ修練の浜へ、{playerName}。ここの稽古はどれも同じところから始まる。足を据え、刃を握ること。野営地の南西の練習場に立つかかしは、打たれるために作られている。ひとつ選んで、構えて、三体崩れるまで打ち込みなさい。かかしは打ち返してこない。この浜の外にいるものは、打ち返してくる。",
        "completion": "三体倒して、握りももう確かになってきた。その感覚を忘れないで、{playerName}。足を据え、目を上げ、全身で振り抜く。渓谷の狼は藁より速いが、同じ算術で倒れるものだよ。",
        "objectives": {
          "0": {
            "label": "訓練用のかかしを倒す"
          }
      ...
      "q_ps_the_wreck_line": {
        "title": "難破の浜",
        "text": "潮はこの島に漂着物で払いをする。古い難破船の木箱が、渓谷に面した浜に打ち上げられるんだ。それを漁る蟹どもは見た目より強く挟むから、足元には気をつけて。木箱を三つこじ開けて、海が残していったものを持っておいで。",
        "completion": "ロープに、タールに、海がなぜか見逃したチーズが半玉。世の中は身をかがめる価値のあるもので満ちているよ、{playerName}。この習慣を続けなさい。見つけて、開けて、頂く。",
        "objectives": {
          "0": {
            "label": "漂着した木箱を開ける"
          }
      ...
      "q_ps_a_path_of_your_own": {
        "title": "自分だけの道",
        "text": "剣を振るうことと、なぜ振るうのかを知っていることは別物だよ、{playerName}。レベル五になると、世界は君に専門化を選ばせる。君の生業に開かれた三つの道のひとつ、それぞれに持ち味がある。それからは数レベルごとにタレントの段がひとつ開き、三択からひとつを取る。あと二体かかしを倒しながら、藁が舞う間に、どの道を歩むつもりか考えておきなさい。",
        "completion": "さらに二体。振りの奥に、前より確かなものが宿ってきた。何より覚えておいてほしいのはこれだよ、{playerName}。君の選択はどれも檻ではない。タレントの画面はいつでも開ける。五で選んだあとも、安全な場所に立ってさえいれば、タレントも専門化も無料でいつでもやり直せる。大胆に選び、学び直したらまた選びなさい。",
        "objectives": {
          "0": {
            "label": "訓練用のかかしを倒す"
          }
      ...
      "q_ps_the_wheel_of_trades": {
        "title": "生業の輪",
        "text": "剣は一度しか君を食べさせないが、{playerName}、生業は一生君を食べさせる。冒険者は誰でも剣のかたわらに専門を持っている。採掘、伐採、薬草摘み、釣り、そしてそれらを価値に変える製作の技だ。補給係フィンチは、私が積んだ訓練より多くの店を切り盛りしてきた。生業がどう築かれるものか、彼女に聞いておいで。",
        "completion": "マレンがようやく、話す甲斐のある生徒を寄こしたね。一度しか言わないよ、{playerName}。採集は道具から始まる。つるはし、斧、鎌、釣り竿、どれも渓谷の商人が売っている。君の技は輪を成していて、好きなものに励み、隣り合う一対に調律すれば、その二つは上限のない主専攻になり、輪の向こうのひとつが趣味として残り、残りは君が再び手に取るまで眠る。学んだことは決して失われないし、支度ができたら町の職人頭が調律を持ちかけてくれる。",
        "objectives": {
          "0": {
      ...
      "q_ps_pouch_and_purse": {
        "title": "ポーチと財布",
        "text": "渓谷へ発つ前にもうひとつ、冒険者の命を守る授業だよ、{playerName}。君の持ち物の話だ。背嚢には十六の枠があり、その横に空の鞄留めが四つ待っている。鞄を留めるたびに、その分の空きが全体に加わる。補給係フィンチから亜麻のポーチを買って留めたら、私のところへ戻っておいで。",
      ...
      "q_ps_set_sail": {
        "title": "出航",
        "text": "この浜には、君がまだ倒していない、開けていない、買っていないものは何も残っていないよ、{playerName}。準備はできた。イーストブルック渓谷には本物の仕事が待っている。古い桟橋へ下りて、渡し守オドに伝えなさい。マレンが、君は渡りを勝ち取ったと言っていた、とね。",
        "completion": "マレンがそう言ったのかい？私に一週間も舫い結びの稽古をさせた人からの、これは大した誉め言葉だ。支度ができたら桟橋の先の鐘を鳴らしなさい、{playerName}。渡しがイーストブルックの町の真ん中に降ろしてくれる。狼には気をつけて。",
        "objectives": {
          "0": {
            "label": "渡し守オドに報告する"
          }
