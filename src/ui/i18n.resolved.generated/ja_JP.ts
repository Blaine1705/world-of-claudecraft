...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "varkhulCallout": {
      ...
      "artificerApproaches": "火の粉の技工士が鍛冶炉へ接近している！",
    ...
    "raidBossGuide": {
      ...
      "ignivar": {
        ...
        "apocalypse": "黙示録: 20秒の詠唱が終わる前に終焉の心臓を倒す。",
        "judgment": "鍛冶場の審判: 予告中に異なる避難所を覚え、床が燃えたら表示された境界内に集合する。",
        "finale": "最後の業火: 20%未満では45秒以内に倒す。加速した隕石、前方攻撃、回転する業火が続く。",
        "heroic": "英雄: 鍛冶の鎖ではペア同士が近くに留まる。審判中は印が近くの味方も罰する。"
      },
      "varkhul": {
        "tanks": "タンク: 創造者の印が2スタックで交代し、ヴァークルを近接範囲に保つ。",
        "orbs": "灰のオーブ: 対象者は部屋の外周へ散開する。炎の床は戦闘中残り、放たれたオーブは部屋を横切る。",
        "pyre": "共有の火葬: 赤熱した金属がない対象だけを選ぶ。移動する円内に通常4人、英雄5人で集合する。",
        "ray": "焼き入れ光線: 別のプレイヤーがヴァークルと対象の間で遮る。被弾者は30秒の傷を受ける。",
        "forge": "炉の柱: 光線が炉に届く前に遮る。曝露の増加に合わせて担当を交代し、熱が100%になると炉が溶融する。",
        "adds": "組立: 各ポータル波を倒し、るつぼの地震を中断する。再調整で回復される前に灰の技工士を妨害する。",
        "heroic": "英雄: 処理が遅いと波が重なり、炉の熱は下がらない。共有の火葬は5人必要で、20%から世界炎が部屋を閉じる。"
      }
    },
    "auraEffect": {
