...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "taskLongWalkBody": "浜辺の道を南へ進み、たましいの石まで歩いて{interactKey}を押し、ひざまずこう。ここでは何にも襲われないし、これで失うものは何もない。",
      ...
      "taskShellBody": "浜辺ガニは挟み返してくる。左クリックで一匹をターゲットにし、{attackKey}を押して打ち込み、そのまま打ち続けよう。一度に多くに襲われたら、道を引き返して退くこと。連中はすぐ追うのをあきらめるし、休んでいる間に体力は戻ってくる。",
      ...
      "taskShellBodyCaster": "浜辺ガニは挟み返してくる。左クリックで一匹をターゲットにし、{attackKey}を押して呪文を唱え、離れたまま唱え続けよう。一度に多くに襲われたら、道を引き返して退くこと。連中はすぐ追うのをあきらめるし、休んでいる間に体力は戻ってくる。",
