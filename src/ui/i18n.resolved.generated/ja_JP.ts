...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "渡ってきたばかりかい？ようこそ修練の浜へ。教官マレンが私の後ろの道の先、暁の野営地で稽古を仕切っている。何よりも先に君と話したがるはずだ。発つ支度ができたら、この桟橋の先の鐘を鳴らしなさい。渡しがイーストブルックの町まで送り届けてくれる。",
      "noteClose": "わかった"
    },
    "tutorial": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "確かな一撃",
        "text": "ようこそ修練の浜へ、{playerName}。ここの稽古はどれも同じところから始まる。足を据え、刃を握ること。野営地の南西の練習場に立つかかしは、打たれるために作られている。ひとつ選んで、構えて、三体崩れるまで打ち込みなさい。かかしの打ち返しなど、かすり傷にもならない。この浜の外にいるものは、はるかに強く打ってくる。",
