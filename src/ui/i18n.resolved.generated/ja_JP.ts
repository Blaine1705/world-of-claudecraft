...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hostDiag": {
      "title": "システムレポート",
      "intro": "このコンピューターでゲームの動作が重い場合は、システムレポートを作成してサポートチームに送ってください。レポートにはこのコンピューターの構成とゲームの設定が記録されるため、フレームレートが下がる原因を調べるのに役立ちます。",
      "containsTitle": "レポートに含まれる内容",
      "containsHardware": "ハードウェアとドライバー: コンピューターのメーカーと機種、プロセッサー、メモリ、グラフィックカード、ディスクの空き容量。",
      "containsWindows": "Windows のバージョン、電源とバッテリーの状態、グラフィック設定。",
      "containsNvidia": "NVIDIA コントロールパネルの設定 (インストールされている場合)。",
      "containsDisplays": "ディスプレイ構成: 画面の数、解像度、リフレッシュレート。",
      "containsPrograms": "プロセッサーとメモリを最も多く使用しているプログラムの名前。",
      "containsBrowsers": "インストールされているウェブブラウザーとそのバージョン、ハードウェアアクセラレーションが有効かどうか。",
      "containsGame": "ゲームとランチャーのバージョン、現在のグラフィック設定とゾーン、そしてこのレポートをゲームがすでに送信しているパフォーマンスデータと照合するためのセッションコード。",
      "privacy": "あなたのファイル、ユーザー名、アカウント情報は含まれません。コンピューター名も含まれず、代わりにランダムなコードが使われます。自動的に送信されるものはありません。レポートはお使いのコンピューターに保存されるファイルで、誰に渡すかはあなたが決めます。",
      "create": "レポートを作成",
      "running": "システム情報を収集しています... 数秒かかります。",
      "saved": "レポートを {fileName} として保存しました。",
      "savedNoName": "レポートを保存しました。",
      "detailPartial": "一部の情報を収集できませんでした。それでもレポートは役に立ちます。",
      "detailUnavailable": "Windows のシステムスキャンが見つからないか変更されているため、基本情報のみが含まれています。ゲームを再インストールすると復元されます。",
      "detailNativeError": "Windows のシステムスキャンを実行できなかったため、基本情報のみが含まれています。",
      "busy": "レポートはすでに作成中です。",
      "failed": "レポートを作成できませんでした。もう一度お試しください。",
      "sendHint": "保存したファイルを Discord でサポートチームに送るか、サポートへの問い合わせに添付してください。"
    },
    "paperdoll": {
