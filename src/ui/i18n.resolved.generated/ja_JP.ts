...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC の価格情報が回復するまで取引は一時停止中です。オークションのカウントダウンは続行され、価格が健全に戻るまで決済は行われません。",
      "walletBanner": "ウォレットを連携して認証すると、取引所で入札、購入、出品ができます。",
      "rateNote": "現在のレート: 1 USD あたり約 {tokens} $WOC（{time} 時点）。",
      ...
      "sellFeeNote": "売買成立時に 10% の手数料がかかります。90% はあなたへ、3% はバーン、7% はトレジャリーへ。売上は決済トランザクションで直接あなたの連携ウォレットに届きます。",
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "terms_required": "続行するには取引所の決済条件に同意してください。",
      ...
      "quote_expired": "その見積もりは期限切れです。新しい見積もりを取得してください。",
