...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      ...
      "islandArrivalNote": "渡ってきたばかりかい？ようこそ修練の浜へ。ウォーデン・タムが目の前の浜でガントレットを預かっている。まず彼のところへ行けば、そのレーンが体の動かし方を全部教えてくれる。赤い旗を越えたら、桟橋から北へ道を上った先の暁の野営地で、教官マレンが最初の仕事をくれる。名前が見えるところまで歩み寄って、Fを押すか、左クリックすれば話ができる。発つ支度ができたら、私の桟橋のそばに立つ鐘を鳴らしなさい。渡しがイーストブルックの家まで運んでくれる。",
      "noteClose": "わかった"
    },
    "tutorial": {
    ...
    "bootcamp": {
      ...
      "forwardBody": "前方のガントレットの門をくぐり、{forwardKey}を押したまま最初のレーンを西へ、旗まで歩こう。",
      "forwardBodyTouch": "前方のガントレットの門をくぐり、移動スティックを上に倒したまま最初のレーンを西へ、旗まで歩こう。",
      "forwardBodyPad": "前方のガントレットの門をくぐり、左スティックを上に倒したまま最初のレーンを西へ、旗まで歩こう。",
      "cameraTitle": "視点を回す",
      "cameraBody": "旗一本目、よし。次はマウスの右ボタンを押したままドラッグして視点を回そう。南へ延びる柵のレーンを見下ろしてから、元の向きに戻ろう。",
      "cameraBodyTouch": "旗一本目、よし。次は（移動スティックではなく）世界を指でドラッグして視点を回そう。南へ延びる柵のレーンを見下ろしてみて。",
      "cameraBodyPad": "旗一本目、よし。次は右スティックを倒して視点を回そう。南へ延びる柵のレーンを見下ろしてみて。",
      "leftTitle": "左へ滑る",
      "leftBody": "向きはそのままで、{strafeKey}を押したまま南のレーンを左へ横滑りして旗まで進もう。横歩きなら視線を敵に置いたまま動ける。いつか戦いでそう動く日が来る。",
      "leftBodyTouch": "移動スティックを左に倒して、南のレーンを横滑りで旗まで進もう。",
      "leftBodyPad": "左スティックを左に倒して、南のレーンを横滑りで旗まで進もう。",
      "camera2Title": "もう一度見回す",
      "camera2Body": "旗二本目、よし。もう一度右ボタンを押したまま視点を回し、西へ延びる最後のレーンに体を合わせよう。",
      "camera2BodyTouch": "旗二本目、よし。もう一度指でドラッグして、西へ延びる最後のレーンに体を合わせよう。",
      "camera2BodyPad": "旗二本目、よし。もう一度右スティックを倒して、西へ延びる最後のレーンに体を合わせよう。",
      "forward2Title": "駆け抜けろ",
      "forward2Body": "もう一度{forwardKey}を押したまま、最後のレーンを赤い旗まで駆け抜けよう。",
      "forward2BodyTouch": "もう一度移動スティックを上に倒して、最後のレーンを赤い旗まで駆け抜けよう。",
      "forward2BodyPad": "もう一度左スティックを上に倒して、最後のレーンを赤い旗まで駆け抜けよう。",
      "courseProgress": "旗 {current} / {total}",
      "doneTitle": "稽古の準備は万端",
      "doneBody": "体の動かし方はこれで全部だ。教官マレンが桟橋から道を上った先の暁の野営地で稽古を仕切っている。最初の仕事を用意して待っているよ。"
    },
    "widgets": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "warden_tam": {
        "name": "ウォーデン・タム",
        "title": "ガントレットの番人",
        "greeting": "このレーンがガントレットだ、{playerName}。渓谷に名を知られた冒険者は皆ここを走った。最初のレーンを西へ旗まで歩き、あたりをよく見回し、二本目のレーンを左へ滑り、もう一度見回してから、最後のレーンを赤い旗まで駆け抜けるんだ。篝火は夜通し灯っている。赤い旗を越えたら、暁の野営地の教官マレンが最初の仕事をくれる。"
      },
      "tidewatcher_ondrel": {
        "name": "オンドレル・ヴェイン",
        "title": "潮見の番人",
    ...
    "quests": {
      ...
      "q_ps_the_wreck_line": {
        "title": "難破の浜",
        "text": "潮はこの島に漂着物で払いをする。古い難破船の木箱が、練習場の先の遠い浜辺に打ち上げられるんだ。かかしの先へ道なりに進めば、そのまま水際まで案内してくれる。木箱を開けるのは簡単だよ、{playerName}。名前が見えるところまで歩み寄って、Fを押すか、木箱そのものを左クリックすれば、中身を差し出してくれる。三つで足りる。漂着物を漁る蟹どもは見た目より強く挟むから、足元には気をつけて。それから覚えておきなさい、この先出会うどんな宝箱も、採集場所も、扉も、開けるのは同じFひとつきりだよ。",
        "completion": "ロープに、タールに、海がなぜか見逃したチーズが半玉。世の中は身をかがめる価値のあるもので満ちているよ、{playerName}。この習慣を続けなさい。近づいて、Fを押して、自分のものを頂く。",
        "objectives": {
          "0": {
            "label": "漂着した木箱を開ける"
          }
      ...
      "q_ps_the_wheel_of_trades": {
        "title": "生業の輪",
        "text": "剣は一度しか君を食べさせないが、{playerName}、生業は一生君を食べさせる。冒険者は誰でも剣のかたわらに専門を持っている。採掘、伐採、薬草摘み、釣り、そしてそれらを価値に変える製作の技だ。補給係フィンチの露店は私の稽古場から数歩のところにあって、彼女は私が積んだ訓練より多くの店を切り盛りしてきた。彼女に歩み寄ってFを押すか、左クリックすれば話ができる。木箱を開けるのと同じキーが、会話も開くんだよ。",
        "completion": "マレンがようやく、話す甲斐のある生徒を寄こしたね。一度しか言わないよ、{playerName}。採集は道具から始まる。つるはし、斧、鎌、釣り竿、どれも渓谷の商人が売っている。Shiftを押しながらPを押せば専門の手帳が開く。それが君の輪で、覚えた技とその進み具合がすべて並んでいる。好きなものに励み、隣り合う一対に調律すれば、その二つは上限のない主専攻になり、輪の向こうのひとつが趣味として残り、残りは知識を保ったまま眠る。失われるものは何もなく、決まってしまうものも何もない。組み合わせを決めるのは職人頭で、あとから変えたくなったときに変えてくれるのも職人頭だ。イーストブルックなら、鍛冶場の鍛冶頭ダルヴァ、宿の厨房の料理人マーロウ、織機の織り手オティリー、細工場の細工師ギゼル。ほかにフェンブリッジのなめし場に革職人ヘスク、ハイウォッチの薬房に錬金術師ヴェランがいる。",
        "objectives": {
          "0": {
            "label": "補給係フィンチに生業について尋ねる"
          }
        }
      },
      "q_ps_pouch_and_purse": {
        "title": "ポーチと財布",
        "text": "渓谷へ発つ前にもうひとつ、冒険者の命を守る授業だよ、{playerName}。君の持ち物の話だ。背嚢には十六の枠があり、その横に空の鞄留めが四つ待っている。鞄を留めるたびに、その分の空きが全体に加わる。では、補給係フィンチにFを押して店を開き、並んだ品の中の亜麻のポーチを左クリックして買い、それからBを押してバッグを開き、そこのポーチを左クリックして空いた留めに締めなさい。腰に下がったら、私のところへ戻っておいで。",
        "completion": "良いポーチだ。厄介ごとを詰める枠が六つ増えたね。ここからは、どんな鞄にも収まらない残り半分の授業だよ、{playerName}。持ちきれないものは金張りの金庫が預かる。私の後ろの机にいる出納係ウィックが開けてくれるのは、どの町のどの出納係とも共通の金庫で、財布が育てば金庫の枠も買い足せる。値打ち物は金庫へ、鞄には余裕を。狼よりも多くの冒険を終わらせてきたのは、はち切れた背嚢のほうなんだ。",
        "objectives": {
          "0": {
            "label": "亜麻のポーチを購入する"
          }
      ...
      "q_ps_set_sail": {
        "title": "出航",
        "text": "この浜には、君がまだ倒していない、開けていない、買っていないものは何も残っていないよ、{playerName}。準備はできた。イーストブルックには本物の仕事が待っている。道を下って古い桟橋へ行き、渡し守オドにFを押して、マレンが、君は渡りを勝ち取ったと言っていた、と伝えなさい。誰に何を頼まれていたか分からなくなったら、いつでもLを押しなさい。それが君のクエストログだよ。",
