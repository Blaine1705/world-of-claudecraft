...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "questsPage": {
      ...
      "cluesCasketTitle": "小箱",
      "cluesCasketBody": "最後の謎かけを解き、それが示す場所で巻物を使うと、宝の小箱を掘り出せます。開ければ硬貨、自分のクラス向けの装備一つ、いくらかの英雄の証、そして時おり小箱にしか入っていないものが手に入ります。最初の小箱と十個目は功績の書に記録されます。",
    ...
    "factionsPage": {
      ...
      "masteryHeading": "地域の熟達",
      "masteryBody": "各ゾーンには、そこで完了したワールドクエストの数が永久に記録されます。通貨ではなく、何かに使われることもありません。数字は増えるだけで、毎日続ける必要もなく、数週間ぶりに戻っても次のワールドクエストが一つ加わるだけです。定められた節目に達すると偉業の書に偉業が記録されるので、キャラクターのレベル上げが終わって久しくても、古いゾーンを訪れる価値が残ります。評判タブには各ゾーンの数と次の節目が並びます。"
    },
    "deedsPage": {
