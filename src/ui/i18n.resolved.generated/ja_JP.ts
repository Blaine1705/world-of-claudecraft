...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "coachNextBody": "矢印をたどって{npc}のところへ。名前が見えるところまで歩み寄り、{interactKey}を押すか、左クリックして次の仕事を受けよう。",
      "coachNextBodyTouch": "矢印をたどって{npc}のところへ。名前が見えるところまで歩み寄り、相手をタップするか、使用ボタンをタップして次の仕事を受けよう。",
      "coachNextBodyPad": "矢印をたどって{npc}のところへ。名前が見えるところまで歩み寄り、インタラクトボタンを押して次の仕事を受けよう。",
      "coachTaskBody": "矢印をたどって仕事へ向かおう。右側のトラッカーが数を数えてくれるし、道に迷ったら{mapKey}で地図が開ける。",
      "coachTaskBodyTouch": "矢印をたどって仕事へ向かおう。右側のトラッカーが数を数えてくれるし、道に迷ったら地図ボタンが道を示してくれる。",
      "coachTaskBodyPad": "矢印をたどって仕事へ向かおう。右側のトラッカーが数を数えてくれるし、道に迷ったら地図ボタンが道を示してくれる。",
    ...
    "noticeboard": {
      "empty": "何も貼られていないようだ。",
      "listingsBanner": "掲示板には{count}件の貼り紙が出ている。",
