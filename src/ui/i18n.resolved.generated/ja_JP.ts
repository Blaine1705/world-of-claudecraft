...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "abilityHook": {
      ...
      "veilbound_march": "敵群をすり抜けて印を刻み、自分へのダメージを弱めながら脅威を固めます。",
  ...
  "entities": {
    "abilities": {
      ...
      "veilbound_march": {
        "name": "ヴェイルバウンド・マーチ",
        "description": "4秒間エーテル状態となり、移動速度が40%、防御力が30%上昇し、スロウ、ルート、強制移動を無効化します。通り抜けた敵には6秒間ヴェイルの印が付き、毎秒神聖ダメージを受け、あなたに与えるダメージが20%減少し、あなたへの追加脅威を生成します。最初の印で信仰を1獲得します。行進終了時、近くの印付き敵に最後の爆発を与えます。昇天中は爆発ダメージが50%増加し、敵をわずかに引き寄せます。"
      },
      "veilbound_mark": {
        "name": "ヴェイルの印",
        "description": "毎秒神聖ダメージを受け、印を付けたパラディンに与えるダメージが20%減少し、そのパラディンへの追加脅威を生成します。"
      },
      "righteous_fury": {
        "name": "バーニングオース",
