...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "trade": {
      ...
      "woc": {
        ...
        "notInstant": "$WOC の取引は即時ではありません。出品者が承諾するとアイテムはエスクローに移り、支払いが確認され次第、購入者に届きます。",
        ...
        "hintAcceptLocked": "そのアイテムはロックされています。売る前にバッグでロックを解除してください。",
        ...
        "closeSellerHold": "あなたのアイテムは購入者の支払いまで保留されたままです。気が変わった場合は、取引所のアクティビティタブから販売をキャンセルしてください。",
        "closePaymentContinuesBuyer": "あなたの支払いはまだ確認中です。配送は自動的に完了します。",
        "closePaymentContinuesSeller": "購入者の支払いはまだ確認中です。販売は自動的に完了します。",
        "p2pBindingNote": "双方が承諾すると、{duration} 以内に支払う必要があります。支払わなかった場合はマーケット違反が記録されます。",
        "p2pBindingNoteUntimed": "双方が承諾すると、まもなく支払期限を迎えます。支払わなかった場合はマーケット違反が記録されます。",
    ...
    "wocMarket": {
      ...
      "pausedBanner": "$WOC の価格情報が回復するまで取引は一時停止中です。オークションのカウントダウンは続行されます。新しい入札と支払いは価格が健全に戻るまで待機になりますが、すでに送信された支払いはそのまま決済されます。",
      "walletBanner": "ウォレットを連携して認証すると、取引所で入札、購入、出品ができます。",
      "rateNote": "現在のレート: 1 USD あたり約 {tokens} $WOC（外部取引市場の最新の約定価格、{time} 時点）。",
      "estimateNote": "現在のレートで約 {tokens} $WOC。最終的な数量は支払いを要求した時点で確定します。",
      ...
      "detailSales": "最近の取引",
      "detailSaleRow": "{usd}: {seller} から {buyer} へ",
      ...
      "bidBondNote": "入札時に {usd} 相当の返還可能な保証金（$WOC 建て）を預けます。上回られた場合は返還され（次点への譲渡であなたが購入者になる場合を除く）、落札したのに支払わなかった場合にのみ没収されます。",
      "bidBindingNote": "保証金のトランザクションに署名した時点で入札は確定します。入札は取り下げられず、落札して支払わなかった場合は保証金が没収され、アカウントにマーケット違反が記録されます。",
      "bidCloseNote": "終了間際の数分間に保証金が確認された入札は、オークションを数分延長することがあります。終了後に届いた支払いはオークションを再開せず、返金されます。",
      "offerNextNote": "落札者が支払わなかった場合、あなたが自分の入札額で購入者になることがあります。その際は保証金が再び預けられ、決済期間内に支払う必要があります。支払わなかった場合は保証金が没収され、違反が記録されます。",
      "buyNowNote": "「今すぐ購入」はこの出品を短時間あなたのために確保します。支払わずに離れると、しばらくの間「今すぐ購入」が停止されます。",
      ...
      "sellOfferNext": "落札者が支払わなかった場合、次の入札者にアイテムを提示します。",
      "sellSubmit": "出品する",
      "sellSubmitAria": "{item} を取引所に出品する",
      "sellFeeNote": "売買成立時に約 10% の手数料がかかります。3% はバーン、7% はトレジャリーへ、いずれも切り上げで差し引かれ、あなたはその残額（約 90%）を正確に受け取ります。売上は決済トランザクションで直接あなたの連携ウォレットに届きます。",
      "activityListings": "自分の出品",
      "activityBids": "自分の入札",
      "activitySettlements": "自分の決済",
      "activityEmpty": "まだ何もありません。入札、出品、決済がここに表示されます。",
      "activityPayNow": "今すぐ支払う",
      "activityPayNowAria": "決済 {id} を今すぐ支払う",
      "activityDeadline": "支払い期限: あと {duration}",
      "activityStrikes": "マーケット違反回数: {count}",
      "activitySuspended": "未払いの決済があったため、入札が {duration} 停止されます。",
  ...
  "apiError": {
    ...
    "woc_market": {
      ...
      "paused": "価格情報が回復するまで取引所の取引は一時停止中です。オークションのカウントダウンは続行されます。",
      ...
      "suspended": "未払いの決済があったため、取引所での入札が停止されています。",
