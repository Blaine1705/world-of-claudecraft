...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "tutorialGreeting": {
      "bodyFirst": "この土地では、冒険を始める者が修練の浜を訪れるのが習わしだ。海峡の先にある静かな島だよ。あそこなら世界の試練に挑む前に腕を磨き、この土地に慣れることができる。渡し船は行きも帰りも出ているし、行っても行かなくても誰も君を軽んじたりはしないよ。",
      ...
      "islandArrivalNote": "渡ってきたばかりかい？ようこそ修練の浜へ。教官マレンが私の後ろの道の先、暁の野営地で稽古を仕切っている。彼女の名前が見えるところまで歩み寄って、Fを押すか、左クリックすれば話ができ、最初の仕事を言いつけてくれるはずだ。発つ支度ができたら、私の桟橋のそばに立つ鐘を鳴らしなさい。渡しがイーストブルックの家まで運んでくれる。",
      "noteClose": "わかった"
    },
    "tutorial": {
    ...
    "bootcamp": {
      "title": "最初の一歩",
      "moveTitle": "足を慣らす",
      "moveBody": "{moveKeys}で、どの方向へでも数歩歩いてみよう。",
      "moveBodyTouch": "画面下の移動スティックをドラッグして、どの方向へでも数歩歩いてみよう。",
      "moveBodyPad": "左スティックを倒して、どの方向へでも数歩歩いてみよう。",
      "cameraTitle": "視点を回す",
      "cameraBody": "マウスの右ボタンを押したままドラッグして視点を回してみよう。左右をしっかり見渡してみて。",
      "cameraBodyTouch": "（移動スティックではなく）世界を指でドラッグして視点を回してみよう。",
      "cameraBodyPad": "右スティックを倒して視点を回してみよう。",
      "courseTitle": "ガントレットを駆けろ",
      "courseBody": "では二つを合わせよう。桟橋の南の浜にある旗の列を駆け抜けるんだ。{jumpKey}で柵を跳び越え、箱をよじ登り、赤い旗まで全部の旗に触れよう。",
      "courseBodyTouch": "では二つを合わせよう。桟橋の南の浜にある旗の列を駆け抜けるんだ。ジャンプボタンで柵を跳び越え、箱をよじ登り、赤い旗まで全部の旗に触れよう。",
      "courseBodyPad": "では二つを合わせよう。桟橋の南の浜にある旗の列を駆け抜けるんだ。ジャンプボタンで柵を跳び越え、箱をよじ登り、赤い旗まで全部の旗に触れよう。",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "ferryman_odo": {
        "name": "渡し守オド",
        "title": "渡し場の番人",
        "greeting": "渡ってきたばかりかい、{playerName}？なら浜の道を上っていきなさい。教官マレンが暁の野営地で稽古を仕切っている。彼女に歩み寄ってFを押すか、左クリックすれば、最初の仕事を言いつけてくれるよ。渓谷が君を呼び戻したら、私の桟橋のそばに立つ鐘を鳴らせば、渡しがイーストブルックの町まで送り届けてくれる。"
      },
      "bursar_wick": {
        "name": "出納係ウィック",
        "title": "金張りの金庫",
