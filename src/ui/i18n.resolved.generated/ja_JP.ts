...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "stats": {
      ...
      "warfareBodyPets": "ウォーフェアは、プレイヤー同士の戦いでのみ効く唯一のステータスです。あなたとペットが他のプレイヤーやそのペットに与えるダメージを高め、彼らから受けるダメージを下げ、キャラクターシートにはその両面が一行で表示されます。野生のクリーチャー相手にはまったく働きません。名誉で購入するウォーフェアのギアから得られるので、レベリング中に追いかけるものというより、PvPを遊んだことへの報酬です。"
    },
    "progression": {
