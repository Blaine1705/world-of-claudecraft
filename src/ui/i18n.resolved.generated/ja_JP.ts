...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bootcamp": {
      ...
      "strafeBody": "横に動く方法はもうひとつある。マウスの右ボタンを押したままドラッグして視点を回し、下ってきたレーンをさかのぼる北向きになったら、{strafeKey}を押したまま最後のレーンを赤い旗まで横歩きしよう。横歩きなら視線を敵に置いたまま動ける。いつか戦いでそう動く日が来る。",
      "strafeBodyTouch": "横に動く方法はもうひとつある。指でドラッグして視点を回し、北を向いたら、移動スティックを左に倒して最後のレーンを赤い旗まで横滑りしよう。",
      "strafeBodyPad": "横に動く方法はもうひとつある。右スティックを倒して視点を回し、北を向いたら、左スティックを左に倒して最後のレーンを赤い旗まで横滑りしよう。",
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_ps_strike_true": {
        "title": "確かな一撃",
        "text": "足の次は腕だ、{playerName}。練習場は私の後ろの道を上った先にあって、そこの藁のかかしは打たれるために作られている。道に迷ったらMを押して地図を開きなさい。引き受けた仕事はすべてそこに印がつく。かかしに歩み寄ってTabを押すか、左クリックすれば、それが君のターゲットになる。次に1を押すか、画面下のアクションバーの最初のアイコンをクリックすれば、刃が振れる。一体が崩れるまで打ち続けること。かかしは打ち返してこない。かかしとはそういうものだ。訓練長ルークが練習場の東の端から場を見ている。彼にFを押して、討ち取りの報告を納めなさい。",
      ...
      "q_ps_shell_and_claw": {
        "title": "甲羅と爪",
        "text": "藁は気にしないが、{playerName}、今度は気にする相手だ。浜辺ガニが遠い浜の難破の浜で残骸を漁っている。練習場から西へ道なりに進めば、まっすぐ奴らのところへ出る。奴らは挟み返してくるから、体力バーに気を配りつつ打ち続けろ。Tabか左クリックで一匹をターゲットにして、1を押し、甲羅が割れるまで手を止めるな。三匹で足りる。終わったら北の丘へ道を上りなさい。潮守ネルが浜の帳簿をつけていて、君の甲羅も数えてくれる。",
      ...
      "q_ps_the_wreck_line": {
        "title": "難破の浜",
        "text": "潮はこの島に漂着物で払いをするんだ、{playerName}。古い難破船から出た漂着した木箱が、私と暁の野営地のあいだの丘に運ばれて置かれている。私の道を野営地のほうへ辿れば、そのすぐ脇を通る。開けるのは簡単だよ。名前が見えるところまで木箱に歩み寄って、Fを押すか、木箱そのものを左クリックすれば、中身を差し出してくれる。三つで足りる。そしてFは、この先出会うどんな宝箱にも、採集場所にも、扉にも使う同じキーだと覚えておきなさい。補給係フィンチが野営地の露店を構えていて、漂着物なら棒切れ一本でも買い取ってくれる。獲物は彼女に渡すんだ。",
        "completion": "ロープに、タールに、海がなぜか見逃したチーズが半玉。全部引き取ろう。それだけ身をかがめて運べるのなら、{playerName}、生業の授業も聞いておきなさい。採集は道具から始まる。つるはし、斧、鎌、釣り竿、どれも渓谷の商人が売っている。Shiftを押しながらPを押せば専門の手帳が開く。それが君の生業の輪で、覚えた技がすべて並んでいる。隣り合う一対に調律すれば、その二つは上限のない主専攻になり、輪の向こうのひとつが趣味として残り、残りは知識を保ったまま眠る。決まってしまうものは何もない。職人頭が君の一対を定め、頼めばいつでも変えてくれる。イーストブルックの鍛冶場、厨房、織機、細工場、フェンブリッジのなめし場、ハイウォッチの薬房にいるよ。",
        "objectives": {
          "0": {
            "label": "漂着した木箱を開ける"
          }
      ...
      "q_ps_pouch_and_purse": {
        ...
        "completion": "良いポーチだ。厄介ごとを詰める枠が六つ増えたね。ここからは、どんな鞄にも収まらない残り半分の授業だよ、{playerName}。持ちきれないものは金張りの金庫が預かる。出納係ウィックが西の道を上った先に金庫の机を構えていて、どの町のどの出納係とも共通の金庫を開けてくれる。財布が育てば金庫の枠も買い足せる。値打ち物は金庫へ、鞄には余裕を。狼よりも多くの冒険を終わらせてきたのは、はち切れた背嚢のほうなんだ。",
        "objectives": {
          "0": {
            "label": "亜麻のポーチを購入する"
          }
