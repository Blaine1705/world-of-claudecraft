...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hostDiag": {
      "title": "システムレポート",
      "intro": "このパソコンでゲームの動作が重い場合は、システムレポートを作成してサポートチームに送ってください。このパソコンの構成とゲームの設定が記録されるため、フレームレートを妨げている原因を確認できます。",
      "containsTitle": "レポートに含まれる内容",
      "containsHardware": "ハードウェアとドライバー：プロセッサー、メモリ、グラフィックカード。",
      "containsWindows": "Windows の電源設定とグラフィック設定。",
      "containsNvidia": "NVIDIA コントロールパネルがインストールされている場合は、その設定。",
      "containsDisplays": "ディスプレイ構成：画面の数、サイズ、リフレッシュレート。",
      "containsPrograms": "プロセッサー時間とメモリを最も使用しているプログラムの名前。",
      "containsGame": "ゲームとランチャーのバージョン、および現在のグラフィック設定。",
      "privacy": "ファイル、ユーザー名、アカウント情報は含まれません。コンピューター名は匆名のコードに置き換えられます。自動送信は行われません。レポートはお使いのパソコンに保存されるファイルで、誰に渡すかはあなたが決めます。",
      "create": "レポートを作成",
      "running": "システム情報を収集しています。数秒かかります。",
      "saved": "レポートを {fileName} として保存しました。",
      "savedNoName": "レポートを保存しました。",
      "detailPartial": "一部の情報は取得できませんでした。それでもレポートは役に立ちます。",
      "detailUnavailable": "Windows のシステムスキャンが見つからない、または変更されているため、基本的な情報のみが含まれています。ゲームを再インストールすると復元されます。",
      "detailNativeError": "Windows のシステムスキャンを実行できなかったため、基本的な情報のみが含まれています。",
      "busy": "すでにレポートの作成中です。",
      "failed": "レポートを作成できませんでした。もう一度お試しください。",
      "sendHint": "保存したファイルを Discord でサポートチームに送るか、サポート依頼に添付してください。"
    },
    "paperdoll": {
