...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "crafting": {
      ...
      "qtyRowAria": "作成数",
      "qtyDecreaseAria": "作成数を減らす",
      "qtyIncreaseAria": "作成数を増やす",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "econ": {
        ...
        "castPaceBody": "専門職の行動には実際の詠唱時間がかかります。簡単な野外レシピは約1.5秒、上位の梯子レシピは数秒、分解・付魔・解体・道具効果の充填はそれぞれ固定の短い詠唱です。詠唱中にキャンセルしても損失はありません。成功した製作にはアイテム予算に応じた銅貨の手数料もかかります。材料・作業台・技能上限と合わせて、別枠の行動上限がなくても市場を健全に保てます。",
