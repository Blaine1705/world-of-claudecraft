...
export const id_ID: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "toolsHeading": "Alat",
      "toolsNote": "Setiap simpul membutuhkan alat profesinya di tasmu, termasuk simpul tingkat 1: tanpa beliung tidak ada bijih, tanpa joran tidak ada ikan. Tangga penjaja mencakup tingkat 1 hingga 3, dan setiap hub hanya menyediakan tingkat yang dipakai tanahnya sendiri: alat tingkat 1 dijual di setiap hub zona, sedangkan anak tangga di atasnya dijual di tempat urat yang membutuhkannya berada. Untuk anak tangga itu penjaja juga menuntut kecakapan pada profesi alat tersebut, {tier2Prof} untuk tingkat 2 dan {tier3Prof} untuk tingkat 3, dan barisnya menyebutkan syaratnya. Alat hanya perlu ada di tasmu, tidak ada slot perlengkapan dan tidak ada daya tahan, sehingga setiap alat adalah pembelian satu kali, dan apa pun yang sudah kaumiliki tetap berfungsi. Hanya tingkat yang menentukan syarat aksesnya: warna kelangkaan alat bersifat kosmetik.\n\nDi atas tangga penjaja terdapat dua alat buatan, tingkat 4 dan tingkat 5, dibuat di bengkel alat oleh perekayasa dan tidak pernah dijual oleh NPC mana pun. Tidak ada simpul saat ini yang membutuhkan lebih dari tingkat 3, sehingga nilainya sekarang adalah kecepatan: alat teratas mengunci waktu pengumpulan pada batas terendahnya di simpul yang lebih rendah, dan akan menjadi tiket masuk ketika wilayah bertingkat lebih tinggi hadir.",
