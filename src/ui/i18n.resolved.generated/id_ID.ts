...
export const id_ID: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "actionBar": {
      "editKeys": "Edit tombol bilah tindakan",
      "editKeysHint": "Klik slot pada bilah tindakan, lalu tekan tombol untuk mengikatnya.",
      "bannerHint": "Klik slot, lalu tekan tombol untuk mengikatnya. Klik Selesai setelah selesai.",
      "bannerCapturing": "Tekan tombol untuk mengikat slot ini...",
      "boundToKey": "Terikat ke {key}.",
      "reset": "Mengatur ulang",
      "done": "Selesai",
      "cancel": "Membatalkan",
      "resetConfirmTitle": "Setel ulang tombol bilah tindakan?",
      "resetConfirmBody": "Bilah pertama kembali ke kunci defaultnya. Bilah kedua dan ketiga menjadi tidak terikat. Hal ini tidak dapat dibatalkan."
    },
    "mounts": {
      "title": "Tunggangan",
      "close": "Tutup",
    ...
    "vcup": {
      ...
      "rolesSmallBracketNote": "Dalam braket 1v1 dan 2v2, setiap petarung memainkan perlengkapan All-Rounder. Akta yang memerlukan braket 3v3 atau lebih besar tidak dapat diperoleh di sini.",
      "role": {
        "allrounder": {
          "name": "Serba Bisa",
      ...
      "practiceUnratedNote": "Pertarungan latihan tidak diberi peringkat: kedudukan dan kemajuan Buku Akta tidak dihitung.",
      ...
      "briefing": {
        ...
        "unratedNote": "Bot ada di lapangan, jadi laga ini tidak diberi peringkat: kedudukan tidak berubah, dan perbuatan yang menghasilkan gol, penyelamatan, dan clean sheet tidak dihitung.",
        "practiceUnratedNote": "Ini adalah pertarungan latihan, jadi tidak diberi peringkat: kedudukan tidak berubah, dan kemajuan Buku Akta tidak dihitung.",
    ...
    "materialHint": {
      "fineGrade": "Nilai bagus. Dikumpulkan dari urat tingkat penuh dengan alat yang berperingkat di atas material, dan dihitung sebagai versi biasa di mana pun diperlukan.",
    ...
    "gathering": {
      ...
      "toolTierUnmet": {
        ...
        "fishing": "Anda membutuhkan joran tingkat {tier} untuk memancing di perairan ini."
      },
      "toolRequired": {
      ...
      "wieldUnmet": {
        "mining": "Anda memerlukan Mining {skill} untuk mengayunkan pick yang sudah ada di tas Anda.",
        "logging": "Anda memerlukan Logging {skill} untuk mengayunkan kapak yang sudah ada di tas Anda.",
        "herbalism": "Anda membutuhkan Jamu {skill} untuk mengerjakan sabit yang sudah ada di tas Anda."
      },
      "wieldUnmetCorpse": "Anda memerlukan keterampilan mengumpulkan {skill} untuk menggunakan alat terbaik Anda.",
      ...
      "toolTooltip": {
        ...
        "unlocks": {
          ...
          "fishing": "Diperlukan untuk menangkap ikan di perairan hingga tingkat {tier}."
        },
        "use": {
      ...
      "emptyHookNote": "Tidak ada apa-apa",
      "stateReady": "Siap",
      "stateCooldown": "Muncul kembali",
      "stateCooldownTimed": "Muncul kembali di {time}",
      "respawnClock": "{minutes}:{seconds}",
      "fineGradePreview": "Alat Anda menyempurnakan hasil ini hingga tingkat yang bagus."
    },
    "archetypeTitle": {
      "label": "Gelar",
      "none": "Tidak Ada",
    ...
    "professions": {
      ...
      "toolEffectCharges": "{charges} dari {max} biaya",
      "toolEffectSpent": "Habis, perlu diisi ulang",
      "toolEffectDepleted": "Efek alat dihabiskan",
      "toolEffectRechargePrice": "Isi ulang: {count} x {material}",
      "toolEffectModeAsk": "Tanyakan setiap kegunaannya",
      "toolEffectModePrompt": "Tanyakan setiap penggunaan",
      "toolEffectConfirmTitle": "Gunakan {effect}?",
      "toolEffectConfirmBody": "Menghabiskan biaya untuk panen ini? Menurun tetap kumpul, tanpa bonus. Sisa biaya: {charges}.",
      "toolEffectConfirmAccept": "Gunakan Biaya",
      "toolEffectConfirmDecline": "Berkumpul Tanpa",
      "toolEffectName": {
        "gatherersCache": "Tembolok Pengumpul",
        "artisansEye": "Mata Pengrajin",
        "quickeningCharm": "Pesona Musim Semi"
      },
      "toolEffectSlotButton": "Slot {effect}",
      "toolEffectRechargeButton": "Isi ulang",
      "toolEffectSlotted": "{effect} ditempatkan pada {profession}.",
      "toolEffectSlotInvalid": "{effect} tidak dapat ditempatkan di sana.",
      "toolEffectNoTool": "Anda memerlukan alat {profession} asli terlebih dahulu.",
      "toolEffectNoCharm": "Anda membutuhkan jimat {effect} buatan di tas Anda.",
      "toolEffectNoGain": "{effect} sudah ditempatkan dan terisi penuh.",
      "toolEffectRecharged": "{effect} diisi ulang: {material} x{count} dikonsumsi.",
      "toolEffectRechargeNoSlot": "Tidak ada efek yang ditempatkan pada {profession}.",
      "toolEffectRechargeFull": "{effect} sudah terisi penuh.",
      "toolEffectRechargeToolCapped": "Bawalah alat {profession} yang lebih baik untuk mengisi daya {effect} lebih lanjut.",
    ...
    "crafting": {
      ...
      "reagentFineSub": "(menghabiskan {count} nilai bagus)",
    ...
    "deeds": {
      ...
      "broadcastsLabel": "Bagikan pembukaan akta dengan rekan guild dan pengikut, serta kartu akta dan karya besar dengan umpan Discord",
  ...
  "guide": {
    ...
    "professions": {
      ...
      "archetypeSwitchBody": "Deklarasi juga bukan hukuman seumur hidup. Pasangan yang belum pernah Anda pegang hanyalah sebuah pencarian attunement baru, sementara kembali ke pasangan yang Anda tinggalkan meminta Anda untuk menebus kesalahan terlebih dahulu: lima tugas untuk pertama kalinya, dan tiga tugas lagi ditambahkan untuk setiap pengembalian yang telah Anda lakukan (mengambil pasangan baru tidak pernah menambah hitungan). Pilihannya tetap bermakna tanpa pernah mengunci pintu untuk selamanya.",
      "whatHeading": "Sebuah perdagangan di samping pedang",
      "whatBody": "Profesi adalah kehidupan kerja di dunia: empat perdagangan pengumpulan yang menarik bahan mentah langsung dari tanah, dan sepuluh kerajinan tangan yang mengubahnya menjadi perlengkapan, makanan, ramuan, dan peralatan. Semuanya memberi makan sesuatu yang lain di sini. Bijih yang Anda tambang menjadi sebuah bilah, bilah tersebut membutuhkan enchant, dan enchant tersebut membutuhkan debu yang dipecah dari peralatan lama, jadi seorang pengumpul, seorang perajin, dan seorang pengotak-atik semuanya merupakan mata rantai dalam satu rantai.\n\nTidak ada batasan profesi untuk disiksa. Setiap karakter dapat meningkatkan tujuh dari delapan kerajinan yang memiliki konten hari ini dan keempat profesi berkumpul secara berdampingan (Teknik adalah satu-satunya yang bertahan: semua resepnya dimulai dari atas langit-langit bebas, jadi tangganya menunggu sumpah Bombardier); satu-satunya pilihan eksklusif adalah arketipe Anda, identitas yang pada akhirnya Anda sumpah, meskipun begitu Anda menyelaraskan kerajinan yang tidak aktif di belakangnya, ia hanya akan naik ke resep umum, dan keterampilan masa lalu tidak akan naik sama sekali. Keterampilan tidak pernah berkurang, dan tidak ada pembelajaran yang diambil.",
      ...
      "archetypesBody": "Sepuluh pesawat berada di atas roda tetap, dan geografi pada roda itu penting. Setiap dua tetangga membentuk pasangan bernama: Smith untuk Weaponcrafting dan Armorcrafting, Outfitter untuk Leatherworking dan Tailoring, Apothecary untuk Alchemy dan Cooking, Bombardier untuk Engineering dan Alchemy, dan enam orang lainnya di sekitar ring.\n\nMenyesuaikan pasangan adalah sebuah pencarian, bukan klik menu. Empat pasangan dapat bergabung hari ini (Smith, Outfitter, Apothecary, dan Bombardier), masing-masing dipasangkan oleh master residen di Eastbrook yang misi penerimaannya menyatakan seluruh tawaran di muka sebelum Anda mengambilnya. Sampai Anda menyatakannya, setiap kerajinan maju secara bebas pada resep hingga tingkat langka (resep apa pun memerlukan keterampilan 74 atau kurang), sehingga Anda dapat mencoba hampir semuanya sebelum Anda memilih (Teknik sendiri tidak memiliki resep serendah itu, jadi jumlahnya menunggu).\n\nSetelah Anda menyelaraskan, kerajinan dua pasang Anda menjadi jurusan Anda, tanpa batasan apa pun. Sisa rodanya tidak menjadi gelap: satu kerajinan yang berlawanan dengan jurusan Anda tetap menjadi hobi yang terus naik melalui tingkatan langka (pencarian berulang di bengkel Smith Haldren memungkinkan Anda menukar yang mana), dan setiap kerajinan lainnya tidak aktif. Kerajinan yang tidak aktif mempertahankan keterampilan dan resep umumnya, yang terus mengajarkannya pada kurva normal hingga berubah warna menjadi abu-abu pada usia 75; segala sesuatu di atas yang biasa berhenti membayar sekaligus, dan sebuah karya yang tidak aktif tidak akan pernah menghasilkan karya besar saat ia beristirahat.",
      "pairFmt": "{a} dan {b}",
      ...
      "startBody": "Baru saja berangkat ke Eastbrook? Temukan Foreman Odell dan lakukan A Trade for Every Hand: dia akan mengarahkanmu ke urat bijih di sekitar Penggalian Tembaga di tenggara kota dan memberikanmu kapalan pertamamu. Perhatikan penggaliannya sendiri: Penggali Deeprock yang berkemah di atasnya berdiri beberapa tingkat di atas pendatang baru, jadi kerjakan urat-urat terluar terlebih dahulu dan simpan jantung perkemahan ketika Anda sudah naik level sedikit. Sejak saat itu, panen setiap vena, tegakan kayu, dan petak herba yang Anda lewati saat melakukan pencarian; kemahiran datang secara alami kepada wisatawan.\n\nKembali ke kota, tekan T untuk membuka jendela kerajinan dan mengerjakan resep umum yang diketahui setiap karakter sejak awal. Kunjungi para ahli di bengkel, dapur, alat tenun, dan bengkel perkakas untuk melihat apa yang mereka ajarkan, dan terima perintah kerja mereka untuk mendapatkan uang tetap. Pada saat surat Persekutuan sampai kepada Anda, Anda sudah tahu pasangan mana yang terasa seperti di rumah sendiri.",
      "colStation": "Stasiun",
      "colHub": "Hub",
      "colMaster": "Master",
    ...
    "profPages": {
      ...
      "craftIntro": {
        ...
        "engineering": "Rekayasa membuat peralatan yang akhirnya diinginkan oleh setiap pengumpul serius: beliung, kapak, sabit, dan pancing tingkat 4 dan tingkat 5 yang tidak akan pernah dijual oleh counter mana pun untuk mendapatkan koin, masing-masing menggunakan alat di bawahnya.",
        "enchanting": "Mempesona membongkar peralatan dan mengembalikan kekuatannya: hancurkan bagian yang tidak diinginkan menjadi bahan misterius, lalu belanjakan untuk bonus stat permanen untuk bagian yang ingin Anda simpan. Melanggar dan mempesona tidak memerlukan stasiun dan pelatih, dan siapa pun dapat memulainya pada hari pertama; hanya dua resep pesona yang bertanya lebih banyak, yang diajarkan di pabrik perkakas."
      },
      "craftProse": {
        "weaponcrafting": {
          ...
          "materialsBody": "Penambangan adalah tulang punggungnya. Bijih tembaga berasal dari urat tingkat 1 di Eastbrook Vale, bijih besi dari Mirefen Marsh, dan bijih osmium dari Thornpeak Heights, dan setiap anak tangga menaikinya dengan cara yang sama. Penebangan kayu lebih penting dari yang Anda duga: kulit besi mengangkat tombak babi hutan, kayu ash memikul maul, dan sebatang kayu pinus tinggi membentuk staf pertempuran.\n\nSisanya berasal dari perburuan dan counter. Kulit kasar untuk dipegang diambil langsung dari mayat serigala dan babi hutan, pecahan tulang diambil dari mayat yang gelisah atau dari peralatan biasa yang berhasil diselamatkan, dan tangga bengkel membakar Smithing Flux, 20 tembaga per toples dari Darva sendiri. Jika penambangan Anda tertinggal, tidak ada penghitung yang akan menyelamatkan Anda dari bijih itu sendiri: osmium keluar dari urat Thornpeak, dari urat awal setiap zona yang lebih muda kecuali Farshore (yang uratnya menggali besi), atau keluar dari tumpukan pemain lain, melalui perdagangan atau Pasar Dunia. Hanya Glyphsteel Bar yang dibeli dengan koin, dari Tinker Gizzel di pabrik perkakas atau Quartermaster Bree di Highwatch.",
          ...
          "routeBody": "Setiap bagian dengan garis stat nyata, yang pada tangga ini berarti anak tangga besi ke atas, dapat keluar dari landasan sebagai sebuah karya besar selama kualitas yang lebih baik cocok dengan langit-langit tingkat Anda; tembaga milik bersama yang tidak memiliki status tidak pernah diproduksi, karena tidak ada yang perlu diperbaiki. Besi dan osmium dihitung sebagai bahan tingkat 1 untuk bonus karya besar, highpine dan glyphsteel sebagai tingkat 2, dan keterampilan yang berada di atas tingkat resep sendiri menambahkan poinnya sendiri per tingkat, jadi di antara osmium tiga itu adalah kapak perang dan staf pertempuran yang membawa tepi material, dan sebuah anak tangga terus berproses lebih baik setelah Anda melampauinya.\n\nNaiki anak tangga tembaga ke 25, latih anak tangga besi pada hari dibuka dan naik ke 50, lalu osmium berbunyi ke 75. Melewati 75 belum ada kapal yang lebih tinggi, jadi resep osmium memudar menjadi setengah dan kemudian bertambah seperempat: anggarkan sekitar 150 kerajinan lagi untuk mencapai batas 125, dan ingat kecepatan bersama yaitu sepuluh tindakan kerajinan per menit saat Anda duduk untuk melakukan batch.\n\nDanai pendakian saat Anda pergi: Perintah kerja bengkel Darva mengambil delapan bijih tembaga dari tangan Anda setiap 30 menit untuk mendapatkan sedikit koin dan XP, dan anak tangga besi dan osmium dijual dengan jujur ​​​​untuk meratakan jarak dekat. Book of Deeds menandai Edge dan Temper pada skill 50 dan menobatkan Grandmaster Weaponcrafting pada 125."
        },
        "armorcrafting": {
          "identityHeading": "Surat-besi untuk garis depan",
          "identityBody": "Tangga Pembuatan Armor terbaca seperti karier seorang prajurit: korset tembaga terpaku polos, sabaton, dan sarung tangan sebagai permulaan, hauberk tautan besi, pelindung kaki, dan spaulder dengan garis stat asli pertama mereka, dan helm besar, cuirass, dan legging skala osmium yang langka, potongan Kekuatan dan Stamina dengan nomor baju besi di bagian paling atas karya seni perajin.\n\nIa juga memiliki sisi yang lebih tenang: Eastbrook Warded Legging, sebuah field yang diberi status kastor, dan Kilnscale Mantle, bahu surat Intellect dan Spirit yang langka pada keterampilan 75, menjaga pemakai surat yang berpikiran mantra tetap dalam daftar pelanggan. Di atas ring, ia berada di antara Weaponcrafting dan Engineering; pasangan Smith dengan Weaponcrafting disumpah di hadapan Forgemistress Darva, sedangkan pasangan Gearwright dengan Engineering telah disebutkan tetapi belum memiliki misi sumpah.",
          "materialsHeading": "Bijih berlimpah",
          "materialsBody": "Tidak ada kerajinan yang memakan bijih lebih cepat. Ironlink hauberk saja membutuhkan lima bijih besi, dan setiap keping skala osmium menginginkan tiga atau empat osmium ditambah sebatang baja glyph, jadi pembuat baju besi yang serius menambang Mirefen Marsh dan Thornpeak Heights atau membayar seseorang yang melakukannya. Tembaga memberi makan anak tangga pertama, langsung dari urat nadi melalui Penggalian Tembaga.\n\nDi sekitar logam terdapat bagian-bagian lunak: kulit kasar yang diambil dari mayat serigala dan babi hutan, pecahan tulang dari orang mati yang gelisah (atau diselamatkan dari peralatan biasa), dan stoples Smithing Flux (masing-masing 20 tembaga di bengkel) di hampir setiap resep. Tidak ada counter yang menjual osmium: yang tidak sabar membelinya dari pemain lain atau menambangnya sendiri, di Thornpeak atau vena starter di sepuluh dari sebelas zona yang lebih muda (Farshore sendiri yang menggali besi).",
          "ladderHeading": "Belajar di tempa Darva",
          "ladderBody": "Dua barang umum di lapangan, Eastbrook Chainmail Vest dan Warded Legging, dikenal sejak awal dan dibuat di mana saja. Tangga pelatih terdiri dari sembilan resep dalam tiga anak tangga di bengkel Eastbrook: anak tangga tembaga gratis pada keterampilan 0, anak tangga tautan besi berharga 25 perak per resep pada keterampilan 25, dan anak tangga skala osmium masing-masing berharga 1 emas pada keterampilan 50, dengan setiap anak tangga dapat diajarkan saat tingkatan Anda mencapainya.\n\nDi luar tangga ada dua orang spesial. Boundstone Helm adalah salah satu dari dua resep kombinasi Smith (Sarung Tangan Gravewyrm adalah saudaranya di sisi pembuatan senjata), diajarkan oleh pelatih, bebas stasiun, dan hanya dapat diterapkan oleh Smith yang sudah terbiasa dengan kedua kerajinan tersebut pada keterampilan 25. Kilnscale Mantle tidak membutuhkan guru sama sekali: semua orang mengetahuinya sejak awal, dan hanya bengkel dan gerbang material yang mengerjakannya. Keterampilan terdaftarnya sebesar 75 adalah tentang perolehan, bukan izin: dengan Armorcrafting sebagai jurusan, ia membayar perolehan keterampilan penuh dari pukulan palu pertama hingga 99, sehingga Smith dengan sisa osmium dapat bersandar padanya lebih awal. Di bawah batas maksimum jurusan, resep tingkat 3 tidak mengajarkan apa pun, jadi pembuat baju besi yang tidak diumumkan atau yang hobi mengerjakannya berdasarkan bagiannya, bukan poinnya.",
        ...
        "leatherworking": {
          ...
          "materialsBody": "Pengerjaan kulit adalah kerajinan yang rute perataannya dan jalur suplainya sama: kulit kasar dipanen langsung dari mayat yang membawa kulit, terutama serigala dan babi hutan, dan setiap mayat hanya melayani satu pemanen, siapa cepat dia dapat. Gulungan panen yang langka atau lebih baik juga memberikan Pristine Hide, spesimen bertanda tangan yang diminta oleh Mirewarden Jerkin, jadi simpanlah semua yang Anda temukan.\n\nPemeran pendukungnya kecil: kaki laba-laba dan sutra, kain tenunan sendiri dari humanoids, satu bijih osmium di setiap potongan langka mirewarden (enam di batu penjuru Duskhide Wraps), dan Agen Penyamakan seharga 16 tembaga dari konter penyamakan kulit. Osmium sendiri tidak pernah dibeli secara counter: menambangnya sendiri, di Thornpeak atau hampir semua vena starter zona yang lebih muda (Farshore sendiri yang menggali besi), atau membelinya dari pemain lain.",
          "ladderHeading": "Dilatih di Fenbridge",
          "ladderBody": "Inilah masalahnya: penyamakan kulit berdiri di Fenbridge, di jalan Mirefen Marsh, menjadikan Pengerjaan Kulit sebagai satu-satunya kerajinan mendalam yang dilatih di rawa. Tanner Hesk mengajarkan tangga di tongnya: kulit Fenbridge dibunyikan bebas pada keterampilan 0, marshstalker dibunyikan dengan 25 perak resep dari keterampilan 25, dan mirewarden dibunyikan dengan masing-masing 1 emas dari keterampilan 50, setiap anak tangga dibuka saat tingkatan Anda mencapainya.\n\nTiga resep dilewati oleh pelatih: kerajinan lapangan (Tanned Leather Jerkin dan Eastbrook Druid's Hide) di mana saja sejak awal, dan Duskhide Wraps diketahui semua orang tetapi berada pada keterampilan 75, terikat pada penyamakan kulit. Perhatikan bahwa sumpah Penjual Penjual eceran itu sendiri disumpah kembali di Eastbrook bersama Ottilie; hanya pengajaran yang terjadi di rawa.",
          "routeHeading": "Karya besar, dan rute kerja menuju 125",
          "routeBody": "Barang apa pun dengan statistik nyata mendapatkan peluang karya besar selama kualitas yang lebih baik sesuai dengan langit-langit tingkat Anda, termasuk Eastbrook Druid's Hide yang disebutkan, dan Pristine Hide yang ditandatangani di Mirewarden Jerkin memberikan bonus reagen yang ditandatangani secara otomatis; osmium dihitung sebagai bahan tingkat 1 untuk proc. Hide commons yang tidak berstatus tidak dapat diproses.\n\nTingkatkan dengan cara alami: panen setiap serigala dan babi hutan yang Anda bunuh dari level satu, biarkan dua field commons membawa Anda ke 25 di mana pun Anda berdiri, lalu latih anak tangga persembunyian di tong ketika misi tetap menarik Anda ke rawa. Marshstalker membawa Anda ke 50 dan mirewarden ke 75; setelah itu Duskhide Wraps, resep tingkat 3 dengan enam bijih osmium, tiga Kulit Pristine, dua kulit kasar, dan Agen Penyamakan, memberikan keuntungan penuh kepada Penjual Penjual eceran yang sudah selaras hingga 99 dan setengahnya setelahnya, sekitar 75 kerajinan untuk lima puluh poin terakhir hingga batas 125; di bawah batas maksimum jurusan, resep tingkat 3 tidak mengajarkan apa pun.\n\nPenyamakan kulit keliling lebih penting untuk kerajinan ini dibandingkan yang lain: berspesialisasi pada 75 dan sekantong kulit menjadi perlengkapan jadi di api unggun alih-alih berjalan kembali ke Fenbridge. Perintah kerja penyamakan kulit Hesk membeli delapan kulit kasar setiap 30 menit, pengembalian rapi atas kulit yang Anda kumpulkan, dan Book of Deeds menandai Tanner's Trade pada keterampilan 50 dengan Grandmaster Leatherworking sebagai penutupnya."
        },
        "cooking": {
          "identityHeading": "Periuk yang memberi makan kelompok",
          "identityBody": "Makanlah makanan yang sudah dimasak dan itu akan menyembuhkan Anda selama 18 detik istirahat, yang mana di antara tarikan tersebut merupakan penyembuhan termurah dalam permainan. Tangganya dimulai dari Pan-Seared River Perch dengan 90 kesehatan hingga ke Marlow's Grand Roast pada 980, tidak ada yang bisa mengalahkan permainan sit-heal.\n\nDi atas ring, Memasak berada di antara Alkimia dan Pengerjaan Kulit. Pasangan hidup mereka adalah Apoteker, Alkimia dan Memasak, yang disumpah di hadapan Cook Marlow di dapur Eastbrook setelah berburu empat babi hutan untuk diambil pancinya; pasangan Trapper dengan Leatherworking disebutkan di atas ring tetapi belum memiliki misi sumpah.",
          "materialsHeading": "Dapur yang diberi makan oleh joran dan pisau",
          "materialsBody": "Memancing menyediakan bahan-bahan khas, zona demi zona: ikan trout cermin dan ikan tenggeran sungai dari perairan Eastbrook Vale, ikan pike rawa dan belut rawa dari Rawa Mirefen, ikan trout frostgill dan ikan mas slatefin dari Thornpeak Heights. Anak-anak tangga memadukan zona dengan bebas (anak tangga bebas sudah menginginkan marsh pike, anak tangga tengah Thornpeak's frostgill, dan makan malam langka melipat kembali ikan cermin Vale), jadi juru masak yang memancing ke mana pun jalan pergi tidak akan pernah kering.\n\nSisi tukang daging mengeluarkan mayat yang sudah dipanen: daging buruan dari babi hutan dan kerabatnya, dan, pada gulungan panen yang langka atau lebih baik, Prime Cut yang ditandatangani, bagian tengah dari daging panggang besar. Ramuan membumbui hidangan yang lebih enak, satu batang kayu ashwood menghisap belut, dan Garam Masak menghasilkan 8 tembaga per kantong dari kios Marlow sendiri.",
        ...
        "alchemy": {
          ...
          "identityBody": "Kerajinan itu dikerjakan di apotek di Highwatch, rumah Alchemist Verane, Master of the Apothecary, yang mengajarkan tangga resep, menjual Botol Kaca seharga 12 tembaga, dan membayar koin untuk jamu melalui perintah kerjanya.\n\nDi ring kerajinan, Alkimia duduk dengan perdagangan coba-coba, di samping Teknik di satu sisi dan Memasak di sisi lain. Itu memberinya dua pasangan identitas: Bombardier (Teknik dan Alkimia, diambil sebelum Tinker Gizzel di Eastbrook) dan Apoteker (Alkimia dan Memasak, disumpah di hadapan Cook Marlow). Selaraskan dengan salah satu pasangan untuk menjadikan Alkimia sebagai jurusan dan biarkan karya yang Anda tandatangani mengajarkan Anda kembali; pasangan Bombardier juga membuka minuman kombinasinya, Elixir of the Bear, sedangkan pasangan Apothecary belum mengirimkan resep kombinasi. Namun, tangga itu sendiri tidak pernah menunggu, karena setiap resep Alkimia berada di dalam tingkatan langka tempat kerajinan yang tidak diumumkan bekerja, sehingga seluruh pendakian ke tutupnya terbuka sebelum sumpah apa pun.",
          ...
          "ladderBody": "Semua orang mengetahui Ramuan Penyembuhan Kecil sejak awal dan dapat mencampurkannya di mana saja, tidak perlu stasiun. Tangga sebenarnya adalah sembilan resep yang diajarkan oleh Verane di apotek, tiga di setiap anak tangga: keterampilan 0 resep gratis, keterampilan 25 anak tangga berharga 25 perak per resep, dan keterampilan 50 anak tangga berharga 1 emas per resep. Setiap anak tangga adalah draft penyembuhan, draft mana, dan ramuan stamina, mulai dari botol daun kemilau biasa (120 kesehatan, 160 mana) hingga daun emas yang tidak biasa (200 kesehatan, 260 mana) hingga kelopak matahari yang langka (280 kesehatan, 360 mana).\n\nElixir naik dengan cara yang sama: Elixir of the Boar memberikan 6 Stamina selama 10 menit, Vipersear Elixir 9 selama 15 menit, dan Elixir of the Serpent 12 selama 15 menit, Serpent sendiri membuat dua botol per kerajinan. Satu resep lagi ada di samping: Elixir of the Bear, minuman kombinasi yang diajarkan Verane seharga 25 perak setelah Alkimia Anda mencapai 25, dapat dicampur di mana saja, tetapi hanya oleh Bombardier yang terbiasa dengan Alkimia dan Teknik pada usia 25.",
          "routeHeading": "Rute seorang penyeduh hingga 125",
          "routeBody": "Draf dan ramuan tidak pernah menghasilkan karya besar; proc itu milik perlengkapan bantalan stat. Namun, nama Anda masih tetap ada: rancangan kelopak matahari yang langka tiba dengan ditandatangani oleh tanda pembuatnya, begitu pula setiap botol Elixir of the Serpent dalam jumlah ganda, jadi tidak ada barang langka dalam kerajinan ini yang meninggalkan bangkunya tanpa tanda tangan. Pada keterampilan 75 Anda berspesialisasi, dan setiap resep Alkimia membutuhkan bahan 20 persen lebih sedikit sejak saat itu.\n\nAmbil Jamu lebih awal dan pilih saat Anda naik level: daun kemiri ada di mana-mana di Vale, dan begitu Anda mencapai bangku Verane, anak tangga bebas akan membawa Anda dengan bersih ke keterampilan 25 tentang jamu yang tetap akan Anda pilih. Pelajari 25 anak tangga saat menyala, pindahkan pemetikan Anda ke rawa untuk mendapatkan daun emas, dan biarkan perintah kerja Verane (enam Herbal Daun Emas seharga 45 tembaga, dapat diulang setiap 30 menit) mengembalikan sedikit koin saat Anda melakukannya.\n\nMulai usia 50, buatlah sunpetal draft dan Serpent batch dari Thornpeak sunpetal, dengan sedikit tanaman hijau Vale dan rawa yang masih tercampur. Peregangan terakhir dari 100 ke 125 adalah tetesan yang disengaja, jadi buatlah apa yang benar-benar laku daripada membakar herba untuk jumlahnya, dan ingat bahwa bahan habis pakai adalah barang buatan yang dibeli kembali oleh semua orang selamanya. Book of Deeds menandai Strange Brews pada skill 50 dan Grandmaster Alchemy di bagian akhir."
        },
        "engineering": {
          "identityHeading": "Monopoli pembuat alat",
          "identityBody": "Kerajinan itu dikerjakan di pabrik perkakas di sudut barat daya Eastbrook Square, rumah Tinker Gizzel, Master of the Toolworks. Tingkat 1 hingga 3 dari setiap lini alat adalah stok vendor biasa; tingkat 4 dan 5 keluar dari bangku insinyur, atau keluar dari konter pencarian Delve Marks di Litani Tenggelam di belakang gerbang pembersihannya, dan tidak pernah keluar dari kasir untuk mendapatkan koin.\n\nDi atas ring, ia berada dengan perdagangan coba-coba, di samping Alchemy dan Armorcrafting, memberinya dua pasangan identitas: Bombardier (Engineering dan Alchemy, diambil sebelum Gizzel sendiri) dan Gearwright (Armorcrafting dan Engineering, bernama tetapi belum dapat disumpah). Satu peringatan lebih penting di sini daripada di mana pun: setiap anak tangga resep Teknik berada di atas batas tertinggi yang dimiliki oleh para hobi dan perajin yang tidak diumumkan, jadi jumlah keahlian hanya berlaku untuk perajin yang jurusannya meliputi Teknik, yang sekarang berarti Bombardier. Siapapun masih bisa membuat peralatan pertanahan; seorang perajin yang tidak terlatih tidak belajar apa pun dari melakukannya, dan kedua resep batang tersebut juga meminta pengajaran Gizzel.",
          "materialsHeading": "Reagen dan alat sebelumnya",
          "materialsBody": "Setiap resep perkakas tanah menggunakan perkakas satu tingkat di bawahnya ditambah bahan FINE, dan pasangan tersebut adalah keseluruhan tangga tanah: empat Bijih Besi Halus dan satu Pilihan Penambangan Skysilver menjadi Pilihan Penambangan Osmium, lalu dua Batangan Glyphsteel, dua Bijih Osmium Halus, dan satu pilihan osmium tersebut menjadi Pilihan Penambangan Glyphsteel. Garis kapak dan sabit mencerminkan bentuk perkakas halus plus sebelumnya dengan Kayu Ashwood Halus dan Batang Kayu Highpine Halus, Daun Emas Halus, dan Herbal Sunpetal Halus, meskipun anak tangga tingkat 5 mereka tidak meminta Batangan Glyphsteel: pilihannya adalah satu garis yang semakin disukai di bagian atas. Dua resep joran sengaja mematahkan polanya: Stormreel mengambil empat Sunglint Koi dan satu joran Silverstream, Tidewrought dua Koi, delapan Raw Slatefin Carp dan Stormreel itu, sehingga puncak tangga pemancing dibayar di atas air, bukan di vena.\n\nBahan yang bagus tidak dijual di mana pun dan tidak jatuh dari panen biasa: Anda mendapatkannya dengan mengerjakan salah satu urat tingkat penuh suatu zona dengan alat yang berperingkat di atas bahan itu sendiri, yang dalam praktiknya berarti alat yang berada satu anak tangga di bawah yang Anda coba buat (semakin mudah urat yang disimpan suatu zona bagi para pelancong, menghasilkan material biasa apa pun yang Anda ayunkan). Itu disengaja. Pada jalur kerajinan, alat tingkat 5 berasal dari mengayunkan alat tingkat 4, bukan dari perjalanan berbelanja; penghitung Delve Marks adalah satu-satunya cara untuk mengatasinya. Satu-satunya pengecualian adalah Glyphsteel Bar, yang disempurnakan dan hanya untuk vendor, 1 perak 60 tembaga per batang dari Quartermaster Bree di Highwatch atau dari konter Gizzel sendiri, jadi Glyphsteel Mining Pick sendiri memiliki lantai koin tetap yang disertakan dalam biayanya.",
          "ladderHeading": "Tangga alat",
          "ladderBody": "Tangganya terdiri dari delapan resep, semuanya terikat pada stasiun perkakas. Enam resep alat darat diketahui secara otomatis, tidak ada biaya pelatih: beliung, kapak, dan sabit tingkat 4 pada keterampilan 75, dan versi tingkat 5 pada keterampilan 150. Angka kedua itu bukan salah ketik, dan sengaja ditempatkan di atas batas 125 saat ini: persyaratan keterampilan tidak pernah membatasi kerajinan di sini, mereka hanya membentuk perolehan keterampilan, sehingga Anda dapat membuat alat tingkat 5 pada hari Anda memegang reagennya dan pendahulunya tingkat 4. Dua batang yang dibuat adalah pengecualian yang diajarkan: Gizzel mengajarkan Stormreel pada keterampilan 75 untuk 4 emas dan Tidewrought pada keterampilan 125 untuk 16 emas, masing-masing saat tingkat Anda dalam kerajinan mencapai tingkatnya sendiri.\n\nSetiap alat yang sudah jadi memiliki kualitas langka atau epik dan ditandatangani, sehingga nama Anda akan masuk dalam zona sabuk alat pemain lain. Teknik juga menyimpan setengah dari satu resep kombinasi: Ramuan Beruang, yang dibuat oleh Bombardier yang mahir dengan Teknik dan Alkimia pada usia 25.",
        ...
        "enchanting": {
          ...
          "identityBody": "Setiap pesona diketahui sejak awal, siapa pun dapat menghilangkan pesona sejak hari pertama, dan tidak ada yang membutuhkan stasiun; keterampilannya dibatasi hingga 125 seperti setiap kerajinan. Sudut yang diajarkan dalam perdagangan ini adalah sepasang resep jimatnya: Tinker Gizzel mengajari Gatherer's Cache dan Artisan's Eye di pabrik perkakas di sudut barat daya Eastbrook Square, dengan biaya tingkat biasa setelah Enchanting Anda mencapai 25, dan jimat itu sendiri digunakan di stasiunnya.\n\nDi atas ring, ia berada di antara Prasasti dan Pembuatan Permata, jadi dua pasang identitasnya adalah Arcanist (Prasasti dan Mempesona) dan Gembinder (Mempesona dan Membuat Permata). Belum ada yang bisa bersumpah, karena kedua tetangga menunggu resep pertama mereka, jadi hari ini pendakian yang mempesona sebagai keahlian semua orang: gratis ke tingkat langka sebelum sumpah apa pun, dan pilihan hobi alami untuk Bombardier atau Apoteker. Enchanter juga membuat dunia pengumpulan tetap berjalan: dua efek alat yang dapat ditempatkan adalah karya Enchanter, dan perajin asli mengisi ulang efeknya sendiri dengan harga diskon, lebih dalam lagi setelah terspesialisasi.",
          "levelingHeading": "Cara mempesona naik level",
          "levelingBody": "Tiga tindakan menggerakkan keterampilan: menghilangkan pesona sebuah bidak, menerapkan mantra, dan membuat dua jimat, yang menaiki kurva kerajinan biasa. Setiap keberhasilan bernilai hingga satu poin, diukur berdasarkan seberapa serius pekerjaan tersebut: kelangkaan bagian yang Anda pecahkan, atau tingkat reagen dari mantra yang Anda terapkan. Kekecewaan umum dan pesona yang hanya berupa debu dinilai sebagai pekerjaan biasa; kekecewaan yang tidak biasa dan pesona esensi yang tidak biasa; kekecewaan yang langka dan setiap pesona Runed atau Greater dianggap langka; kekecewaan yang epik dan legendaris masih memiliki peringkat yang lebih tinggi, meskipun tidak ada identitas yang mempesona saat ini yang melampaui anak tangga yang langka, sehingga bayarannya sama dengan pekerjaan langka dalam praktik. Satu kejujuran mengatur bangku pemecah: bagian yang keluar dari bangku pemain (dibuat, ditandatangani, atau dikerjakan secara ahli) masih digiling menjadi materi tetapi tidak mengajarkan apa pun, sehingga putaran kerajinan-dan-pecahan tidak akan membuat siapa pun puas, dan pelajarannya ada di dunia.\n\nFade penguasaan yang familiar berlaku pada tingkatan 25 poin, jadi pekerjaan tingkat umum menjadi abu-abu pada keterampilan 75, pekerjaan tidak biasa pada tingkat 100, dan tingkat langka bekerja tepat pada batas 125. Mempesona juga memiliki satu kebaikannya sendiri: masukan di atas batas arketipe Anda dibulatkan ke bawah hingga ke batas tersebut, bukan nol, jadi sebelum Anda menyelaraskan, kekecewaan yang luar biasa akan dinilai sebagai hal yang jarang terjadi, bukan tidak mengajarkan apa pun. Jika Mempesona akhirnya tidak aktif di balik identitas lain, memecahkan dan menerapkan skor sebagai pekerjaan umum dan pendakian terhenti di 75, sementara kedua jimat, menaiki kurva kerajinan di atas langit-langit umum, tidak mengajarkan apa pun kepada penyihir yang tidak aktif; pertahankan sebagai hobi Anda dan pekerjaan tingkat langka tetap membuahkan hasil, hanya lebih lambat dari 75.",
          "marketHeading": "Salinan yang dipesona, asal-usul, dan pasar",
          "marketBody": "Menerapkan enchant akan menghabiskan reagen dan menandai satu salinan spesifik item tersebut. Arahkan ke salinan yang dikantongi dan Anda mendapatkan kembali salinan ajaib yang berbeda; arahkan ke pakaian yang sudah Anda kenakan dan itu akan terpesona di tempatnya, tepat di tempatnya, tanpa tarian yang tidak diperlengkapi dan diperlengkapi kembali. Apa pun pilihannya, bonus akan mengikuti bagian itu selamanya, melalui pelepasan perlengkapan, perjalanan ke bank, dan perdagangan. Satu enchant per bagian: menerapkan enchant yang berbeda ke salinan enchant akan meminta konfirmasi, lalu langsung mengganti enchant lama, menghancurkannya tanpa pengembalian dana atas materialnya. Menjual, membuang, dan mengecewakan semuanya lebih memilih salinan biasa terlebih dahulu, sehingga hasil akhir Anda tidak dimakan secara tidak sengaja.\n\nPerlengkapan karya agung dan pesona adalah sahabat: karya agung tetap dapat terpesona sepenuhnya, dan pesona tersebut ditambahkan di atas bonus karya agung tanpa mengganggunya atau tanda tangan pembuatnya. Menumpuk setiap sumber, karya besar bertanda tangan yang membawa Pesona Lebih Besar adalah karya terbaik yang didapat, dan menurut desain, karya tersebut masih berada di bawah rampasan serangan.\n\nDi pasaran, daftar karya yang disihir atau ditandatangani seperti yang lainnya: ia muncul sebagai daftar salinan tunggalnya sendiri, keterangan alat menunjukkan pesona dan tanda pembuatnya, dan Ravenpost membawanya dengan setia. Bahan-bahannya tetap menjadi bagian tetap dari kerajinan itu: Daftar Debu, Esensi, dan Pecahan bebas, daftar tidak dikenakan biaya apa pun, dan Pedagang hanya mengambil 5 persen dari penjualan yang selesai. Hal ini membuat dua penyihir klasik mendapatkan penghasilan dengan menjual bahan, dan menjual karya jadi: melalui pasar, melalui gagak, atau tatap muka di jendela perdagangan."
        }
      },
      "howHeading": "Cara kerja kerajinan",
      "howBody": "Buka jendela kerajinan (kunci default T) dan setiap resep yang Anda tahu tercantum dengan apa yang dibutuhkan dan apa yang Anda miliki. Resep yang terikat stasiun meminta Anda untuk berdiri dalam jarak 20 yard dari stasiun yang tepat di kota, resep lapangan dibuat di mana saja, dan terobosan dan mempesona yang Memikat tidak memerlukan stasiun sama sekali (hanya dua resep pesonanya yang bekerja di stasiun, di pabrik perkakas). Tidak ada kegagalan: kerajinan dengan bahan di tangan selalu berhasil.\n\nDua gesekan kecil membuat perekonomian tetap jujur. Setiap kerajinan yang berhasil membayar biaya sebesar 2 tembaga per poin dari anggaran stat item, dan tindakan jenis kerajinan berbagi satu kecepatan: paling banyak 10 kerajinan, disenchant, enchant, salvage, atau pengisian ulang alat di setiap jendela 60 detik. Tidak ada yang akan mengganggu sesi normal; keduanya menghentikan spesialis yang sudah maksimal membanjiri pasar.",
      ...
      "masterworkBody": "Setiap kerajinan yang sukses persis seperti yang dijanjikan oleh resepnya, dan terkadang lebih dari itu: sebuah karya besar menyelesaikan karya yang sama satu tingkat kualitas yang lebih baik, dengan statistik bonus yang dimasukkan pada waktu kerajinan. Ini hanya tambahan, tidak pernah diturunkan versinya, dan tetap di bawah tingkat serangan, jadi perlengkapan yang dibuat bisa menjadi sangat baik tanpa menggantikan penurunan serangan.\n\nPeluang dipublikasikan, bukan mistik: {base}% basa, ditambah {perTier}% per tingkat keahlian Anda berada di atas resep, ditambah {signed}% ketika ada reagen yang ditandatangani masuk, ditambah {spec}% setelah Anda terspesialisasi, dengan bahan tingkat yang lebih tinggi menambahkan 1 hingga 2% lebih banyak, semuanya dibatasi pada {cap}%. Hanya bagian dengan statistik nyata yang dapat ditingkatkan, jadi barang bersama, peralatan, dan barang habis pakai yang tidak memiliki status tidak akan pernah diproses; kerajinan yang tidak aktif tidak akan pernah menghasilkannya, dan kerajinan hobi tidak dapat menghasilkan karya besar yang melampaui langit-langitnya yang langka.\n\nKarya bagus membawa pembuatnya. Keluaran yang langka dan lebih baik ditandatangani, setiap salinan (Dibuat oleh; bahan yang dikumpulkan dibawa Dikumpulkan oleh), sebuah karya besar selalu ditandatangani, apa pun kualitasnya. Tanda tangan adalah asal, bukan kunci: perdagangan barang, surat, dan daftar yang ditandatangani di Pasar Dunia secara bebas.",
      "trainingHeading": "Pelatihan",
      "trainingBody": "Resep pelatih berasal dari master residen, yang diajarkan di stasiun mereka. Aturannya adalah satu baris: seorang master mengajarkan sebuah resep setelah tingkat keahlian Anda telah mencapai tingkat resep itu sendiri, dan tidak ada hal lain yang mengaturnya, tidak level Anda, tidak pula arketipe Anda. Perlengkapan dan tangga yang dapat dikonsumsi menjalankan anak tangganya pada keterampilan 0, 25, dan 50; Pelajaran dua batang teknik melanjutkan tangga di 75 dan 125, dan dua resep pesona Mempesona berada di anak tangga ke-25, sehingga anak tangga baru terbuka saat tingkatan Anda naik.\n\nBiayanya satu kali dan tetap per anak tangga: anak tangga awal gratis, keterampilan 25 anak tangga berharga {tier1} satu resep, keterampilan 50 anak tangga {tier2}, dan pelajaran tongkat di atasnya dikenakan biaya sendiri, tercantum di samping setiap resep di tabel. Anda harus berdiri di stasiun master sebenarnya untuk berlatih, dan stasiun bergerak tidak pernah dihitung. Resep-resep lapangan yang umum dan enam resep peralatan tanah yang dibuat tidak memerlukan pelatihan sama sekali; setiap karakter mengenal mereka sejak awal.",
      ...
      "ench": {
        ...
        "enchantsNote": "Pesona datang dalam tiga tingkatan. Tingkat dasar berjalan pada Chime Dust (dengan sedikit Essence di kelas atas) dan mencakup slot senjata ditambah setiap slot armor kecuali yang tidak digunakan, dengan opsi sumbu stat yang cukup sehingga setiap build menemukan sesuatu untuk setiap slot. Tingkat yang Lebih Besar berharga satu Chime Shard ditambah Essence: bonus yang lebih kuat pada slot dengan dampak tertinggi. Selain itu, pecahannya akan memberi makan dua bak cuci lagi, dua resep pesona masing-masing berjumlah lima buah, dan tingkat pengisian ulang efek alat teratas, jadi simpanlah sedikit sebelum Anda membelanjakannya.\n\nDi antara mereka ada lima pesona Runed, satu konsumen per tipe sekunder, jadi tidak ada yang Anda giling yang menemui jalan buntu: Runed Edge (senjata, Kekuatan, mengkonsumsi Baja Resonansi), Runed Sigil (senjata, Kecerdasan, Kayu Resonansi), Runed Weave (dada, Roh, Benang Resonansi), Runed Hide (kaki, Agility, Resonant Hide), dan Runed Links (helm, Stamina, Resonant Links). Masing-masing juga mengambil dua Chime Essence; di mana slot dan stat memiliki basis dan pesona yang lebih besar, bonus Runed mendarat di antara keduanya, sementara Runed Weave adalah pesona Spirit peti terkuat dan Runed Hide adalah satu-satunya pesona Agility kaki yang sama sekali. Semua bonus pastinya ada pada tabel di bawah ini.",
        "colEnchant": "Mantra",
        "colSlot": "Slot",
        "colTier": "Tingkat",
        "colBonus": "Bonus",
      ...
      "gatherIntro": {
        "mining": "Penambangan menarik bijih langsung dari batuan dunia: tembaga di Eastbrook Vale, besi di Mirefen Marsh, dan osmium di Thornpeak Heights, dengan urat-urat awal tersebar di setiap zona muda di luarnya, memberi makan pada kerajinan bengkel. Terbuka untuk semua orang mulai dari level 1: pick penambangan 20 tembaga dari counter Eastbrook, Fenbridge, atau Highwatch membuka setiap vena starter, dan anak tangga yang lebih tinggi dari tangga pick bangun saat counter Anda menghasilkannya. Dilacak di konternya sendiri hingga batas 100.",
        "logging": "Penebangan kayu menebang kayu dari tegakan pohon di seluruh dunia: kulit besi di Eastbrook Vale, kayu ash di Mirefen Marsh, kayu pinus tinggi di Thornpeak Heights, dan tegakan starter di setiap zona yang lebih muda, persediaan mentah untuk tangkai, tongkat, dan bangku insinyur. Terbuka untuk semua orang mulai dari level 1 dengan kapak penebangan di tas Anda (20 tembaga di konter Eastbrook, Fenbridge, dan Highwatch), dilacak di konternya sendiri hingga batas 100.",
        "herbalism": "Jamu mengumpulkan apa yang tumbuh liar: daun kemilau di Eastbrook Vale, daun emas di Mirefen Marsh, kelopak matahari di Thornpeak Heights, dan petak starter di setiap zona yang lebih muda, daun dan batang yang menjaga perdagangan apotek tetap berkembang. Terbuka untuk semua orang mulai dari level 1 dengan sabit jamu di tas Anda (20 tembaga di konter Eastbrook, Fenbridge, dan Highwatch), dilacak di konternya sendiri hingga batas 100.",
        "fishing": "Memancing adalah hal yang paling aneh di antara perdagangan berkumpul, dan yang terdalam: minigame yang sangat seru, meja tangkapannya sendiri di masing-masing dari tiga zona jantung (perairan muda di luar semuanya berfungsi untuk meja Vale untuk saat ini), dan batas kemahiran sebesar 200, dua kali lipat dari yang lainnya. Beli tiang, hadapi perairan terbuka, dan lempar."
      },
      "rhythmHeading": "Ritme pengumpulan",
      "rhythmBody": "Panen adalah hasil jangka pendek yang terlihat, bukan hasil instan: basis {base} detik, tidak pernah di bawah {floor} lantai dua. Membawa alat di atas tingkat simpul, yang memungkinkan Anda menggunakan kemahiran Anda, mempercepat Anda sebesar {tool} detik per tingkat di atasnya, dan setiap pita kemahiran yang Anda lewati memangkas {band} detik lagi; hanya dengan mencocokkan tingkat simpul yang akan membuat Anda masuk, tingkatan di atasnyalah yang membuat Anda cepat.\n\nKantong penuh dengan sopan menolak pemeran sebelum dimulai, jadi tidak ada yang terbuang di tengah ayunan, dan setiap panen menghasilkan sepotong kecil karakter XP, yang diskalakan berdasarkan level node terhadap level Anda sendiri seperti cara membunuh skala XP: node abu-abu yang sepele tidak mengajarkan apa pun kepada karakter yang dibatasi.",
      "gainBody": "Perolehan bersifat deterministik, tidak pernah merupakan peningkatan keterampilan: node pada atau di atas tingkat perolehan Anda mengajarkan satu poin penuh per panen, dan setiap kemahiran {step} adalah satu tingkat yang dicetak terhadap node tersebut. Node tingkat 1 membayar penuh di bawah 25, setengah menjadi 49, seperempat menjadi 74, dan tidak membayar apa pun mulai dari 75; node tingkat 2 membayar penuh ke 49; dua node tingkat 3 dari setiap perdagangan membayar penuh hingga 74 dan setengahnya hingga batas {cap}.\n\nRute yang dituju sederhana: belajar di titik awal Vale, pindah ke rawa, dan selesaikan pendakian di dataran tinggi Thornpeak Heights. Pada akhirnya, pembelajaran berhenti tetapi hasilnya tidak: pengumpul yang terbatas terus memberikan peluang terbaik yang ditawarkan perdagangan selamanya.",
      ...
      "toolsHeading": "Alat",
      "toolsNote": "Setiap node membutuhkan alat perdagangannya di tas Anda, termasuk tingkat 1: tanpa pick, tanpa bijih, dan tanpa tiang, tanpa ikan. Tangga vendor mencakup tingkat 1 hingga 3 di tiga pusat pusat: perkakas tingkat 1 dijual di ketiganya, anak tangga di atasnya adalah tempat dimulainya tempat penggunaannya (Fenbridge menambahkan tingkat 2, Highwatch tingkat 3), dan pemukiman yang lebih muda di luarnya tidak memiliki persediaan peralatan sama sekali, jadi bersiaplah sebelum Anda bepergian. Setiap konter menjual setiap anak tangga yang tersedia secara bebas, dan alat apa pun melalui perdagangan langsung; setiap anak tangga juga terdaftar di Pasar dan dikirim melalui pos kecuali tiga permulaan tanah yang terbuat dari 20 tembaga: yang dibeli di konter atau diserahkan secara langsung, dan tidak pernah dijual kembali, dikirimkan, atau didaftarkan. Apa yang terjaga keamanannya adalah penggunaannya. Peralatan tanah di atas tingkat 1 hanya berfungsi setelah kemahiran Anda dalam perdagangannya telah diperoleh, {tier2Prof} untuk tingkat 2, {tier3Prof} untuk tingkat 3, dan 85 dan 100 untuk dua anak tangga yang dibuat, dan baris vendor, keterangan alat, dan tabel di bawah semuanya menyebutkan persyaratan di awal. Sampai saat itu, alat yang dibeli sebelumnya hanya menunggu di tas Anda, tidak membuka lahan, tidak membeli kecepatan, dan tidak mencetak nilai bagus, lalu digunakan saat penghitung Anda menyentuh nomornya. Satu-satunya pengecualian adalah joran: tidak ada joran yang memiliki persyaratan penggunaan, dan Pedagang Wilkes di Eastbrook dengan sengaja menyediakan joran tingkat 2 dan tingkat 3 untuk dibeli terlebih dahulu oleh pemancing. Sebuah alat tidak pernah menempati slot perlengkapan dan tidak pernah habis, jadi masing-masing merupakan pembelian satu kali, dan hanya tingkatannya yang penting bagi gerbang: alat yang lebih langka dari tingkat yang sama tidak membuka apa pun tambahan. Namun, kelangkaan bukan hanya tentang warna. Itu membuat efek alat berlubang bertahan lebih lama, dan pada batang itu memperlebar jendela gulungan.\n\nAlat yang lebih baik membeli tiga hal, bukan dua. Ini membuka lapisan yang lebih tinggi, memperpendek cetakan, dan meningkatkan apa yang dihasilkan: kerjakan urat dengan alat yang berada di ATAS bahan zona itu sendiri dan panen akan menghasilkan kualitas yang bagus, bukan yang biasa. Vena tersebut harus merupakan salah satu vena yang bermutu penuh di zona tersebut, sehingga vena yang lebih mudah disimpan oleh suatu zona bagi para pelancong tetap menghasilkan material biasa. Bahan halus adalah bahan yang dikonsumsi oleh resep alat kerajinan, dan kualitas bagus dianggap sebagai versi biasa di mana pun resep atau perintah kerja memintanya, jadi peningkatan tidak akan pernah membuat Anda terhambat: itu hanya berarti bijih tembaga Anda tiba sebagai Bijih Tembaga Halus.\n\nDi atas tangga vendor, setiap perdagangan memiliki dua alat yang dibuat, tingkat 4 dan tingkat 5, dibuat di pabrik perkakas (setiap karakter mengetahui resep tanah; keterampilan yang naik untuk pekerjaan itu adalah Teknik), atau dibeli dengan Delve Marks di konter Drowned Litany setelah gerbang penyelesaiannya terpenuhi: tabel di bawah mencantumkan harga Marks dan penyelesaian yang diminta setiap anak tangga. Tidak ada pedagang yang pernah menjualnya untuk mendapatkan koin. Memancing memiliki pasangannya sendiri, dan mereka dipelajari dari pembuat alat, bukan diketahui dari awal. Tidak ada simpul dan tidak ada air saat ini membutuhkan lebih dari tingkat 3, jadi dua anak tangga teratas membeli kecepatan, kemiringan, dan jendela gulungan yang lebih baik daripada akses, dan keduanya akan menjadi tiket masuk ketika tingkat yang lebih tinggi tiba.",
      "toolCrafted": "Dibuat ({craft})",
      "toolCraftedOrMarks": "Dibuat ({craft}) atau {marks} Tanda Delve setelah tiga Litani Tenggelam selesai",
      "toolCraftedOrMarksHeroic": "Dibuat ({craft}) atau {marks} Menggali Tanda setelah Litani Tenggelam Heroik selesai",
      "toolVendor": "{name} ({hub})",
      "toolUnavailable": "Tidak dijual",
      "priceNone": "Tidak dijual untuk koin",
      ...
      "bandsBody": "Kelompok kemahiran adalah tangga 0/100/200 bersama dalam konter perdagangan. Untuk perdagangan tanah, pita tersebut dilintasi pada kecepatan 100 mencukur gips pengumpul, dan topinya menjadikan pita 1 sebagai langit-langit. Kelompok pemancing tidak mencukur apa pun: mereka memilih meja tangkapan (dengan joran yang serasi), hanya pemancingan yang mencapai kelompok 2, dan pendakian itu sendiri yang menarik pemancing ke perairan yang lebih dalam, tempat meja yang lebih baik dan pelajaran selanjutnya hidup.",
      ...
      "specimenBody": "Sediakan sedikit ruang cadangan saat Anda bertani: rejeki nomplok yang ditandatangani memerlukan ruangannya sendiri atau tumpukan bertanda tangan yang cocok untuk ditanam, dan jika tidak ada yang cocok, hasil panen tetap datang tetapi tanda tangannya hilang. Pemanenan mayat juga memiliki keuntungannya sendiri: sekitar {pct}% dari setiap komponen yang dipanen jarang atau lebih baik. Sebuah keluarga dengan spesimen yang sempurna untuk diberikan (kulit, sutra, racun, daging) menjaga hasil panen biasa tetap polos dan mencetak spesimen yang ditandatangani di sampingnya; setiap keluarga lainnya menandatangani hasil itu sendiri.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "Tonggak ke-100 bertuliskan Garam Tua dan ke-200 bertuliskan Master Angler dengan gelarnya, seni pemancing paling atas; Memancing juga diperhitungkan dalam Master Gatherer, yang diperoleh sebesar 100 dalam tiga perdagangan pengumpulan. Ikan pertama dari masing-masing enam zona perairan mengisi halamannya sendiri, tiga zona jantung dan Willowfen, Galecrest, dan Farshore di luarnya, dan Sunglint Koi mencatat Secercah Harapan, sehingga pelancong yang membawa galah mengisi buku mereka lebih cepat dari yang mereka perkirakan."
      },
      "fish": {
        "startHeading": "Memulai",
        "startBody": "Sebuah Alat Pancing Sederhana berharga 20 tembaga dari Nelayan Brandt di Eastbrook (cari Garam Tua di tepi timur kota, di tepi jalan menuju Danau Cermin); Tinker Gizzel, Penyedia Hale di Fenbridge, dan Quartermaster Bree di tiang stok Highwatch juga. Gunakan tiang sambil menghadap air yang cukup dalam untuk menampung ikan, hingga sekitar 24 yard di depan Anda, dan bobber Anda akan berlayar keluar.\n\nAnda tidak dapat melakukan cast saat bertempur, saat berenang, atau saat mati: melakukan cast dari pantai adalah postur yang diinginkan. Namun, air menjadi semakin sulit seiring dengan semakin sulitnya daratan: rawa menginginkan setidaknya Ironreel tingkat 2 dan puncaknya adalah Silverstream tingkat 3, dan garis yang dibuat tanpa batang yang diambil air tidak akan pernah lepas dari tangan Anda. Dua batang berada di atasnya, Stormreel dan Tidewrought: para insinyur membuat batang-batang tersebut di pabrik perkakas dari apa yang ditarik oleh tali, dan konter penyelidikan Drowned Litany menjualnya dengan harga Delve Marks di belakang gerbang pembersihannya, namun tidak pernah dengan harga koin. Tidak ada air yang meminta mereka, jadi mereka membeli waktu tunggu yang lebih singkat dan jendela gulungan yang lebih lebar daripada akses, yang di anak tangga paling atas berarti gigitan dalam tiga detik saja.",
        "biteHeading": "Gigitan dan penarikan",
        "biteBody": "Setelah pemeran, gigitan terjadi pada momen tersembunyi antara {min} dan {max} detik; penundaan ditentukan ketika garis tersebut mendarat, jadi tidak ada dua pemeran yang merasa persis sama. Ketika bobber menggigit, Anda memiliki jendela kedua {reel} untuk menekan tiang lagi dan menariknya ke dalam: gulung ke dalamnya dan hasil tangkapan mendarat, ragu-ragu melewatinya dan ikan lolos tanpa menunjukkan apa pun. Seluruh sesi dibatasi pada {cap} detik, sehingga pemeran yang diam pun dapat menyelesaikannya dengan cepat.\n\nBatang yang lebih baik mempertajam kedua ujung minigame: setiap tingkat batang di atas trim pertama {rod} detik dari waktu tunggu terlama, tidak pernah di bawah lantai tiga detik batang atas sudah merumput, dan menambahkan {reelRod} detik ke jendela gulungan, sehingga Ironreel menurunkan waktu tunggu terburuk menjadi 6,5 detik dengan jendela 3,25 detik, dan Silverstream ke 5 dengan jendela melewati 4, kelangkaannya memperluas gulungan sedikit melebihi tingkatnya saja membayar. Gigitan tercepat tidak pernah mengubah apa pun yang Anda pegang, dan tongkat hanya perlu ada di tas Anda untuk menghitungnya.",
        "scheduleHeading": "Perolehan keahlian",
        "scheduleNote": "Perolehan penangkapan ikan mengikuti jadwal tetap tanpa dadu: poin penuh per tangkapan di bawah kemahiran 50, setengah poin di bawah 100, sepersepuluh di bawah 150, dan tetesan lambat 0,02 dari 150 menjadi 200. Peregangan terakhir itu adalah perjalanan ribuan tangkapan yang disengaja: 200 adalah sebuah pernyataan, bukan perhentian dalam perjalanan menuju sesuatu yang lain.\n\nSampah berhenti mengajar sepenuhnya di {cutoff}: sejak saat itu, rumput liar dan sepatu bot hanyalah rumput liar dan sepatu bot. Perairan itu sendiri juga menutup pelajaran: perairan tingkat 1 di Vale (dan setiap pantai muda di luar jantung daratan) tidak mengajarkan apa pun yang melebihi 100, rawa berhenti di 150, dan hanya sekolah Thornpeak yang menjadi pemancing hingga 200. Setiap tangkapan yang mendarat akan memperoleh keuntungan sesuai dengan kecepatan yang dijadwalkan, jadi ketika penghitung terhenti, jadwal memberitahu Anda untuk mencari air yang lebih dalam.",
        "colProficiency": "Keahlian",
        "colGain": "Perolehan per tangkapan",
        "belowFmt": "Di bawah {below}",
        "tablesHeading": "Tabel tangkapan",
        "tablesNote": "Kemahiran Anda memilih salah satu dari tiga kelompok tangkapan: kelompok 0 dari awal, kelompok 1 pada 100, kelompok 2 pada 200, masing-masing memindahkan beban dari sampah dan kail kosong ke ikan sungguhan, zona demi zona. Setiap band di atas yang pertama juga memerlukan sebuah rod: band 1 menginginkan Ironreel tingkat 2, band 2 menginginkan Silverstream tingkat 3. Pita efektif Anda adalah yang lebih rendah dari apa yang diperoleh keterampilan Anda dan apa yang didukung oleh tongkat Anda, dan tutupnya tidak bersuara: dengan tongkat yang lebih kecil Anda masih menangkap, tepat di luar meja pita bawah, jadi jika tangkapan Anda terasa macet saat keterampilan Anda naik, periksalah tongkat Anda terlebih dahulu.\n\nPerairan masing-masing zona menyimpan sepasang ikan makanannya masing-masing, semakin dalam zona tersebut semakin dalam penyembuhannya, semuanya merupakan bahan untuk memasak dan makanan yang sangat enak untuk dimakan mentah-mentah. Sisa meja adalah pajak pemancing: rumput liar, sepatu bot sesekali, dan kail kosong, yang tidak pernah hilang sepenuhnya. Berapa banyak yang Anda bayar tergantung pada air tempat bobber Anda mendarat, bukan di mana Anda berdiri: gips mencapai hingga 24 yard, dan tongkat yang dibutuhkan air, meja tempat ia mengambil, akta yang dikreditkannya, dan seberapa jauh ia mengajarkan semua jawaban terhadap zona tempat air berada, diputuskan pada saat garis itu mendarat. Perairan setiap zona ditulis untuk pitanya masing-masing, Vale untuk pita 0, rawa untuk pita 1, puncak untuk pita 2, dan memancing satu pita di bawahnya mengubah kira-kira sepertiga gips Anda menjadi kail kosong, dua pita di bawahnya lebih dari setengahnya. Tongkat itu membawa Anda ke air; keahlianlah yang membuatnya terbayar, dan pendakianlah yang menarik pemancing lebih dalam, karena pita yang lebih baik bukan hanya bayaran yang lebih baik: melewati Vale, hanya perairan inilah yang terus mengajar. {rare} adalah satu baris yang menjawab pita tangkapan Anda dan tidak ada yang lain: peluang yang sama di setiap zona, dan enam kali lebih mungkin di pita 2 daripada di pita 0, jadi hal yang paling langka di dermaga adalah yang benar-benar lebih baik dilakukan oleh Pemancing Utama.",
        ...
        "koiBody": "Setiap perairan dalam game menyembunyikan hadiah yang sama: Sunglint Koi, kilauan yang tidak biasa di tali yang bernilai 75 tembaga untuk vendor dan lebih untuk kebanggaan Anda. Peluangnya sesuai dengan pita tangkapan Anda dan tidak ada yang lain, sama di setiap zona: baris 1 persen tabel tangkapan di pita 0, 3 di pita 1, dan 6 di pita 2, digambar pada setiap pemain yang digulung, sehingga koi mendatangi pemancing yang mendapatkan tabel dalam. Landing one mencatat Secercah Harapan di Buku Perbuatan Anda, tanda kolektor yang tidak terkenal. Ketika itu terjadi, log memastikan Anda mengetahuinya."
      },
      "econ": {
        ...
        "trainingNote": "Satu biaya tetap per anak tangga resep, dibebankan satu kali saat master mengajarkannya; setiap anak tangga tabel di bawah ini digunakan langsung saat ini, mulai dari resep pemula gratis hingga pelajaran pembuat alat di bagian atas.",
        ...
        "provenanceBody": "Beberapa item mempunyai nama. Arahkan kursor ke salah satu tooltip dan akan tertulis Dikumpulkan oleh si anu pada bahan mentah, atau Dibuat oleh si anu pada benda jadi: tanda yang sama, sesuai dengan asal muasal benda tersebut. Tanda tangan adalah bagian dari barang itu sendiri, dibawa melalui perdagangan, bank, surat, Pasar Dunia, dan bahkan pembelian kembali oleh vendor, dan tidak pernah pudar.\n\nMengumpulkan tanda-tanda akan menghasilkan hasil terbaik secara otomatis: panen apa pun yang menghasilkan panen langka atau lebih baik akan ditandatangani, dan temuan langka menandakan keseluruhan rejeki nomplok lima kali lipatnya. Gulungan keberuntungan dari hasil panen jenazah menandai hasil panennya ketika keluarga tersebut tidak memiliki spesimen untuk diberikan, dan jika ada, simpanlah hasil panen tersebut dan mencetak spesimen asli yang telah ditandatangani di sampingnya. Membuat tanda-tanda di sepanjang garis yang sama: setiap salinan cetakan yang langka atau lebih baik ditandatangani, dan sebuah karya besar selalu menandatangani apa pun kualitasnya, jadi versi terbaik dari setiap karya selalu menyebutkan nama pembuatnya. Satu-satunya hal yang dapat membuat Anda kehilangan tanda tangan adalah tas yang penuh: unit yang ditandatangani memerlukan ruangannya sendiri, atau tumpukan tanda tangan yang cocok, untuk ditempatkan.\n\nTumpukan item memiliki satu identitas yang sama, jadi dua salinan digabungkan hanya ketika setiap tanda sama persis: item yang sama, penandatangan yang sama, statistik masterwork yang sama, pesona yang sama, ikatan yang sama. Sebuah log yang ditandatangani tidak pernah bergabung dengan tumpukan biasa di kedua arah (penggabungan akan menghapus nama seseorang), tetapi muatan yang identik bergabung dengan bahagia, jadi dua puluh bijih yang ditandatangani oleh pengumpul yang sama duduk di satu tumpukan dan rejeki nomplok tidak merusak tas Anda.\n\nTanda tangan membayar kembali perajin: memegang salinan reagen yang dibutuhkan yang ditandatangani di bangku cadangan, siapa pun yang menandatanganinya, menambahkan 2 poin persentase peluang karya besar, dan memegang reagen yang ditandatangani oleh tangan Anda sendiri akan memotong jumlah reagen yang dibutuhkan sebanyak satu (tidak pernah di bawah satu). Karya langka-atau-lebih baik yang Anda tandatangani bahkan terus mengajari Anda, hari ini hanya melalui botolnya: minum ramuan yang Anda tandatangani dan sedikit keterampilan mengalir kembali ke kerajinan yang membuatnya, selama kerajinan itu adalah salah satu jurusan aktif Anda.",
        ...
        "throttleBody": "Output memiliki batas tertinggi: kerajinan, disenchanting, enchanting, salvaging, dan pengisian ulang efek alat berbagi satu anggaran {actions} tindakan yang berhasil di setiap jendela {seconds} detik. Upaya yang ditolak tidak memerlukan biaya apa pun dan tidak menghabiskan anggaran. Anda tidak akan pernah merasakannya dalam permainan normal; itu ada sehingga spesialis maksimal dengan bank penuh tidak dapat membanjiri Pasar, apa pun keahlian atau persediaannya.",
      ...
      "faq": {
        ...
        "a4": "Anda mendapat rejeki nomplok. Kira-kira 1 panen dalam 90 panen memicu peristiwa pengumpulan yang langka (batang kayu kuno di pohon, urat bijih yang masih asli, mekarnya sinar bulan di tanaman herbal): hal ini melipatgandakan hasil panen lima kali lipat, menandatangani setiap unit dengan nama Anda, dan mengumumkan temuan tersebut ke seluruh zona. Gulungan langka atau lebih baik pada panen biasa juga menandakan hasil panen.\n\nBahan yang ditandatangani layak disimpan atau dijual dengan harga mahal: memegang salinan reagen yang diperlukan yang ditandatangani di bangku cadangan akan menambah 2 poin persentase pada peluang karya besar. Ingatlah bahwa mereka hanya menumpuk salinan yang ditandatangani dengan cara yang sama, jadi mereka menyimpan slot tasnya sendiri.",
        ...
        "a6": "Sembilan resep lapangan yang umum dan enam resep perkakas tanah yang dibuat sudah diketahui semua orang sejak awal, begitu pula tiga batu penjuru yang terikat stasiun (Kilnscale Mantle, Wardweave Cowl, dan Duskhide Wraps), yang tidak memerlukan pelatih, hanya stasiun mereka. Segala sesuatu yang lain diajarkan oleh master residen di stasiun mereka di tiga kota hub: sebagian besar berdiri di Eastbrook, penyamak kulit menyimpan penyamakan kulit di Fenbridge, dan sang alkemis menjaga apotek di Highwatch.\n\nResep pelatih dijalankan dalam beberapa anak tangga: keterampilan 0, 25, dan 50 untuk perlengkapan dan kerajinan yang dapat dikonsumsi, dengan harga gratis, 25 perak, dan 1 emas sebagai biaya satu kali; Dua resep pesona yang mempesona berada di anak tangga ke-25, dan pembuat perkakas mengajarkan dua pancing yang dibuat pada tingkat 75 dan 125 untuk 4 dan 16 emas. Seorang master mengajarkan sebuah resep setelah braket Anda dalam kerajinan itu telah mencapai braket resep itu sendiri, dan Anda harus berdiri di stasiun mereka untuk mempelajarinya: stasiun seluler tidak dihitung.",
        "q7": "Mengapa pengumpulan saya tiba-tiba melambat?",
        "a7": "Pengumpulan pemain dimulai pada 2,5 detik dan dipersingkat dalam dua cara: 0,4 detik untuk setiap tingkat alat yang Anda bawa dan dapat digunakan di atas tingkat simpul itu sendiri, dan 0,15 detik setelah penghitung perdagangan Anda melewati pita 100, dengan batas waktu 1,5 detik. Pindah dari node tingkat 1 ke node tingkat 3 dan kelebihan Anda akan hilang, sehingga pilihan yang sama berayun lebih lambat lagi. Memegang tingkat yang dibutuhkan secara tepat tidak akan menghasilkan kecepatan; itu hanya membuka node.\n\nPerolehan keterampilan memudar seperti halnya kerajinan: sebuah node menjadi abu-abu saat kemahiran Anda melampaui tingkatannya (node ​​​​tingkat 1 tidak mengajarkan apa pun mulai dari kemahiran 75 ke atas), jadi jawaban untuk perolehan yang lambat adalah node tingkat yang lebih tinggi. Alat-alat tersebut membutuhkan setidaknya tingkatannya di tas Anda (tidak ada node yang pernah dikerjakan dengan tangan kosong, termasuk tingkat 1), dan alat darat di atas tingkat 1 juga menginginkan tanda penggunaannya terlebih dahulu, 40/70/85/100 dalam perdagangannya sendiri untuk tingkat 2 hingga 5. Penangkapan ikan mengikuti lancipnya sendiri: perolehan penuh di bawah kemahiran 50, setengah di bawah 100, sedikit 0,1 di bawah 150 dan 0,02 di bawah 200, tangkapan sampah tidak mengajarkan apa pun sejak 100, dan air itu sendiri mengakhiri pelajaran (perairan tingkat 1 berhenti mengajar pada 100, rawa pada 150), jadi counter yang macet juga bisa berarti Anda sudah melampaui batas air.",
        "q8": "Bisakah saya membuat di luar kota?",
        "a8": "Sebagian. Sembilan resep lapangan yang umum (senjata pembuka, baju besi, makanan, dan bahan pokok ramuan) dibuat di mana saja, kapan saja, begitu pula tiga resep kombinasi dari pasangan tersumpah. Segala sesuatu di atasnya terikat pada jenis stasiun: bengkel, dapur, apotek, penyamakan kulit, alat tenun, atau perkakas, dan Anda harus berada dalam jarak 20 meter dari stasiun agar kapal dapat lewat.\n\nDengan 75 keterampilan dalam kerajinan yang Anda spesialisasi, dan bersama dengan diskon bahan sebesar 20 persen, Anda mendapatkan stasiun seluler: letakkan di lapangan dan diamkan selama 10 menit, sajikan resep kerajinan itu seolah-olah Anda benar-benar melakukannya. Stasiun seluler hanya untuk kerajinan: mempelajari resep dan komisi tidak mengikat selalu memerlukan stasiun sebenarnya di kota."
      }
    },
    "economy": {
  ...
  "questUi": {
    "tracker": {
      ...
      "unknownQuest": "Pencarian tidak diketahui ({id})"
    },
    "log": {
      "title": "Catatan Misi",
      ...
      "repeatableStatus": "Dapat diulang",
    ...
    "dialog": {
      ...
      "repeatableQuestAria": "Pencarian berulang: {name}",
  ...
  "itemUi": {
    ...
    "bags": {
      ...
      "unknownItemAria": "Item tidak diketahui {id}, kuantitas {count}",
      "unknownItemAriaMasterwork": "Item tidak diketahui {id}, kuantitas {count}, karya agung",
      "unknownItemAriaEnchanted": "Item tidak diketahui {id}, jumlah {count}, salinan ajaib",
      "unknownItemAriaBound": "Item tidak diketahui {id}, jumlah {count}, salinan terikat",
      "unknownItemAriaInstanced": "Item tidak diketahui {id}, jumlah {count}, salinan bertanda pembuat"
    },
    "equipment": {
      "empty": "Kosong",
      "levelClass": "{className} Level {level}"
    ...
    "vendor": {
      ...
      "qtyRowAria": "Kuantitas pembelian",
      "qtyMultiple": "{count}x",
      "qtyMultipleAria": "Beli {count} sekaligus",
      "qtyCustom": "Kebiasaan",
      "qtyCustomAria": "Pilih jumlah khusus untuk dibeli",
      "buyCountAria": "Beli {count} dari {item} seharga {price}",
      "buyCountAriaWithRequirement": "Beli {count} dari {item} seharga {price}. {requirement}",
      "buyQuantityTitle": "Beli berapa {item}? Hingga {max}.",
      "buyQuantityInput": "Jumlah yang akan dibeli",
      "buyQuantityConfirm": "Membeli",
  ...
  "entities": {
    ...
    "items": {
      ...
      "fine_copper_ore": {
        "name": "Bijih Tembaga Halus"
      },
      "fine_iron_ore": {
        "name": "Bijih Besi Halus"
      },
      "fine_thorium_ore": {
        "name": "Bijih Osmium Halus"
      },
      "fine_ironbark_log": {
        "name": "Batang Kayu Besi Halus"
      },
      "fine_ashwood_log": {
        "name": "Kayu Ashwood Halus"
      },
      "fine_elderwood_log": {
        "name": "Log Highpine Halus"
      },
      "fine_silverleaf_herb": {
        "name": "Ramuan Daun Kemilau Halus"
      },
      "fine_goldleaf_herb": {
        "name": "Ramuan Daun Emas Halus"
      },
      "fine_sunpetal_herb": {
        "name": "Ramuan Sunpetal Halus"
      },
      "stormreel_fishing_rod": {
        "name": "Pancing Stormreel"
      },
      "tidewrought_fishing_rod": {
        "name": "Pancing Pasang Surut"
      },
      "duskwisp_essence": {
        "name": "Sari api senja"
      },
    ...
    "quests": {
      ...
      "q_the_codfather": {
        ...
        "text": "Codfather bukan hanya seekor ikan, {playerName}, dia adalah seorang pembunuh berdarah dingin. Orang-orang tua bersumpah dia makan Mire Prowlers untuk sarapan, dan bahkan para Janda Mirefen tidak akan membuat jaring mereka di dekat Deepfen Shallows karena ketakutan belaka. Dia menguasai perairan itu, dan air rawa membutuhkan Pancing Ironreel, tidak kurang; konter saya menjualnya. Dapatkan satu di tangan, seret iblis tua itu keluar dari perairannya, dan saya akui Anda telah bergabung dengan keluarga.",
      ...
      "q_nythraxis_graves": {
        ...
        "text": "Saya pernah melihat tanda-tanda ini sebelumnya, di tiga kuburan tua di sekitar medan perang utara. Kapten Aldren terletak di lereng barat, Imam Besar Malric lebih jauh ke selatan di sepanjang tepi barat, dan Royal Assassin Voss di tebing timur. Sentuh setiap kuburan dan dengarkan, {playerName}. Orang mati mungkin mengingat apa yang dilupakan orang hidup.",
