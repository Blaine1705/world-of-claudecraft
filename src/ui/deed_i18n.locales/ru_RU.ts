...
export const table: DeedLocaleTable = {
  ...
  hid_dev_tinkerer: {
    desc: 'Добиться слияния пулл-реквеста в открытый репозиторий игры.',
    name: 'Мастеровой исходников',
    title: 'Мастеровой',
  },
  hid_dev_artificer: {
    desc: 'Добиться слияния 5 пулл-реквестов в открытый репозиторий игры.',
    name: 'Искусник исходников',
    title: 'Искусник',
  },
  hid_dev_runesmith: {
    desc: 'Добиться слияния 15 пулл-реквестов в открытый репозиторий игры.',
    name: 'Рунный кузнец исходников',
    title: 'Рунный кузнец',
  },
  hid_dev_architect: {
    desc: 'Добиться слияния 30 пулл-реквестов в открытый репозиторий игры.',
    name: 'Архитектор исходников',
    title: 'Архитектор',
  },
  hid_dev_worldwright: {
    desc: 'Добиться слияния 70 пулл-реквестов в открытый репозиторий игры.',
    name: 'Творец мира исходников',
    title: 'Творец мира',
  },
};
