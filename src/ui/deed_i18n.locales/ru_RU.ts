...
export const table: DeedLocaleTable = {
  ...
  chr_peaks_gatherer: {
    name: 'Жатва высот',
    desc: 'Соберите рудную жилу, деревянную подставку и участок травы в Торнпик-Хайтс.',
  },
  chr_willowfen_gatherer: {
    name: 'Фенланд Баунти',
    desc: 'Соберите рудную жилу, деревянную подставку и участок травы в Ивовых Фенах.',
  },
  chr_willowfen_first_cast: {
    name: 'Рябь в Лилимурсе',
    desc: 'Поймайте рыбу в водах Уиллоуфена.',
  },
  chr_galecrest_gatherer: {
    name: 'Урожай на мысе',
    desc: 'Соберите рудную жилу, деревянную подставку и участок травы в Галекресте.',
  },
  chr_galecrest_first_cast: {
    name: 'Линия в зеркальном Тарне',
    desc: 'Поймайте рыбу в водах Галекреста.',
  },
  chr_farshore_gatherer: {
    name: 'Островные положения',
    desc: 'Соберите рудную жилу, деревянную подставку и участок травы на Дальнем берегу.',
  },
