...
const baseEnTable = {
  ...
  'mechanic.ignivarCinderLance': 'Cinder Lance',
...
const IGNIVAR_DICT: Partial<Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>>> =
  {
    es: {
      ...
      'mechanic.ignivarCinderLance': 'Lanza de ascua',
    ...
    ja_JP: {
      'mechanic.ignivarCinderLance': '灰燼の槍',
    ...
    ko_KR: {
      'mechanic.ignivarCinderLance': '잿불 창',
    ...
    ru_RU: {
      'mechanic.ignivarCinderLance': 'Пепельное копьё',
    ...
    zh_CN: {
      'mechanic.ignivarCinderLance': '烬火长枪',
    ...
    zh_TW: {
      'mechanic.ignivarCinderLance': '燼火長槍',
...
const AURA_NAME_KEY: Record<string, SimMessageKey> = {
  ...
  'Cinder Lance': 'mechanic.ignivarCinderLance',
