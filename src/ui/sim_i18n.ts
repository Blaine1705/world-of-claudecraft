...
const baseEnTable = {
  ...
  // The ferry's mount rule (src/sim/mounts.ts): no mount on a ship's deck.
  'error.mountAboardShip': "You can't mount while aboard a ship.",
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'error.mountAboardShip': 'No puedes montar mientras estás a bordo de un barco.',
  ...
  fr_FR: {
    ...
    'error.mountAboardShip': "Vous ne pouvez pas utiliser de monture à bord d'un navire.",
  ...
  it_IT: {
    ...
    'error.mountAboardShip': 'Non puoi usare una cavalcatura a bordo di una nave.',
  ...
  de_DE: {
    ...
    'error.mountAboardShip': 'An Bord eines Schiffes kannst du nicht aufsitzen.',
  ...
  zh_CN: {
    ...
    'error.mountAboardShip': '在船上无法骑乘坐骑。',
  ...
  zh_TW: {
    ...
    'error.mountAboardShip': '在船上無法騎乘坐騎。',
  ...
  ko_KR: {
    ...
    'error.mountAboardShip': '배에 탄 상태에서는 탈것을 탈 수 없습니다.',
  ...
  ja_JP: {
    ...
    'error.mountAboardShip': '船の上では騎乗できません。',
  ...
  pt_BR: {
    ...
    'error.mountAboardShip': 'Você não pode montar a bordo de um navio.',
  ...
  ru_RU: {
    ...
    'error.mountAboardShip': 'На борту корабля нельзя сесть верхом.',
  ...
  cs_CZ: {
    ...
    'error.mountAboardShip': 'Na palubě lodi nemůžeš nasednout.',
  ...
  nl_NL: {
    ...
    'error.mountAboardShip': 'Je kunt niet opstijgen aan boord van een schip.',
  ...
  pl_PL: {
    ...
    'error.mountAboardShip': 'Na pokładzie statku nie możesz dosiąść wierzchowca.',
  ...
  id_ID: {
    ...
    'error.mountAboardShip': 'Kamu tidak bisa menunggang saat berada di atas kapal.',
  ...
  tr_TR: {
    ...
    'error.mountAboardShip': 'Gemideyken bineğe binemezsin.',
  ...
  sv_SE: {
    ...
    'error.mountAboardShip': 'Du kan inte sitta upp ombord på ett skepp.',
  ...
  vi_VN: {
    ...
    'error.mountAboardShip': 'Bạn không thể cưỡi thú khi đang ở trên tàu.',
  ...
  da_DK: {
    ...
    'error.mountAboardShip': 'Du kan ikke sidde op om bord på et skib.',
