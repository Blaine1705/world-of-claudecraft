...
const baseEnTable = {
  ...
  // The Proving Shore (tutorial island): the greeting's ferry ride, the
  // crossing-circle portal pair, and the startTutorial gate denials
  // (sim/tutorial/greeting.ts + content/proving_shore.ts portal texts).
  'log.provingFerry': 'The ferry sets you down on the Proving Shore.',
  'log.provingEnter': 'The ferry circle flares, and the Proving Shore rises to meet you.',
