...
const baseEnTable = {
  ...
  'log.rareCatch': 'Something golden flashes beneath the surface!',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'log.rareCatch': '¡Algo dorado destella bajo la superficie!',
  ...
  fr_FR: {
    ...
    'log.rareCatch': 'Quelque chose de doré scintille sous la surface !',
  ...
  it_IT: {
    ...
    'log.rareCatch': 'Qualcosa di dorato brilla sotto la superficie!',
  ...
  de_DE: {
    ...
    'log.rareCatch': 'Etwas Goldenes blitzt unter der Oberfläche auf!',
  ...
  ko_KR: {
    ...
    'log.noFish': '입질이 없습니다.',
    'log.rareCatch': '수면 아래에서 무언가 금빛으로 반짝입니다!',
  ...
  ja_JP: {
    ...
    'log.noFish': '魚がかかりません。',
    'log.rareCatch': '水面の下で何かが金色に光っている！',
  ...
  pt_BR: {
    ...
    'log.rareCatch': 'Algo dourado reluz sob a superfície!',
  ...
  ru_RU: {
    ...
    'log.rareCatch': 'Что-то золотое блеснуло под поверхностью воды!',
