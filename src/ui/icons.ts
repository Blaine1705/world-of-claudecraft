...
const ABILITY_RECIPES: Record<string, IconRecipe> = {
  ...
  heroic_leap: r('fury', 'gold', ['boot', { p: 'axe', ...TR }], ['motion']),
  ...
  pummel: r('steel', 'blood', ['fist', { p: 'sigil_rune', ...BR }]),
  rallying_cry: r('fury', 'gold', ['sunburst', { p: 'fist', ...BR }], ['arcs']),
