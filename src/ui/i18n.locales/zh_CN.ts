...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolsNote':
    '每一处节点都需要背包里备有对应行业的工具，1阶节点也不例外：没有采矿镐就采不到矿石，没有鱼竿就钓不上鱼。商人阶梯覆盖1到3阶，而每个主城只备货本地地形用得上的阶级：1阶工具在任意区域主城均有出售，更高的阶级则在需要它们的矿脉所在之处出售。购买那些更高阶级时，商人还会要求你在该工具对应行业上的熟练度，2阶需要{tier2Prof}，3阶需要{tier3Prof}，货架那一行会写明条件。工具只需放在背包里即可，没有装备栏位，也没有耐久，因此每件都是一次性购置，已经拥有的工具照常可用。门槛只看阶级：工具的品质颜色纯属外观。\n\n商人阶梯之上还有两件制作工具，4阶与5阶，由工程师在工坊打造，任何NPC都不出售。目前没有任何节点需要3阶以上的工具，因此它们眼下的价值在于速度：顶级工具能把低阶节点的采集读条压到时间下限；等更高阶的地界开放时，它们便是入场券。',
