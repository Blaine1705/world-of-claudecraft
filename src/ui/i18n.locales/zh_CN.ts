...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.deathless_warguard_gauntlets.name': '不死战卫护手',
  'entities.items.soulrend_handwraps.name': '裂魂缠手',
  'entities.items.scourgehide_grips.name': '灾祸之皮握爪',
  'entities.items.soulforged_gauntlets.name': '铸魂护手',
