...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.iron_resolve.description':
    '咬紧牙关、无视疼痛：消耗最多 40 点怒气（至少 20 点），每消耗 1 点怒气可吸收 4 点伤害，持续最多 10 秒。（防护）',
  ...
  'hudChrome.bootcamp.forwardBody':
    '穿过面前的试炼跑道大门，按住 {forwardKey} 沿第一条跑道向西走到旗帜处。',
  'hudChrome.bootcamp.forwardBodyTouch':
    '穿过面前的试炼跑道大门，把移动摇杆推向上方，沿第一条跑道向西走到旗帜处。',
  'hudChrome.bootcamp.forwardBodyPad':
    '穿过面前的试炼跑道大门，把左摇杆推向上方，沿第一条跑道向西走到旗帜处。',
  'hudChrome.bootcamp.cameraTitle': '转动视角',
  'hudChrome.bootcamp.cameraBody':
    '第一面旗到手。现在按住鼠标右键并拖动来转动视角：看看向南延伸的围栏跑道，然后转回原来的朝向。',
  'hudChrome.bootcamp.cameraBodyTouch':
    '第一面旗到手。现在用手指拖动世界画面（不是移动摇杆）来转动视角：看看向南延伸的围栏跑道。',
  'hudChrome.bootcamp.cameraBodyPad':
    '第一面旗到手。现在推动右摇杆来转动视角：看看向南延伸的围栏跑道。',
  'hudChrome.bootcamp.leftTitle': '向左滑步',
  'hudChrome.bootcamp.leftBody':
    '保持朝向不变，按住 {strafeKey} 沿南边的跑道向左横移，走到旗帜处。横移能让你移动时视线始终锁在目标上：总有一天你会这样作战。',
  'hudChrome.bootcamp.leftBodyTouch': '把移动摇杆推向左边，沿南边的跑道横移到旗帜处。',
  'hudChrome.bootcamp.leftBodyPad': '把左摇杆推向左边，沿南边的跑道横移到旗帜处。',
  'hudChrome.bootcamp.camera2Title': '再看一次',
  'hudChrome.bootcamp.camera2Body':
    '第二面旗到手。再按住右键转动一次视角，对准向西延伸的最后一条跑道。',
  'hudChrome.bootcamp.camera2BodyTouch':
    '第二面旗到手。再用手指拖动一次画面，对准向西延伸的最后一条跑道。',
  'hudChrome.bootcamp.camera2BodyPad':
    '第二面旗到手。再推动一次右摇杆，对准向西延伸的最后一条跑道。',
  'hudChrome.bootcamp.forward2Title': '一口气跑完',
  'hudChrome.bootcamp.forward2Body': '再次按住 {forwardKey}，沿最后一条跑道跑到红旗处。',
  'hudChrome.bootcamp.forward2BodyTouch': '再次把移动摇杆推向上方，沿最后一条跑道跑到红旗处。',
  'hudChrome.bootcamp.forward2BodyPad': '再次把左摇杆推向上方，沿最后一条跑道跑到红旗处。',
  'hudChrome.bootcamp.courseProgress': '旗帜 {current}/{total}',
  'hudChrome.bootcamp.doneTitle': '跑完全程',
  'hudChrome.bootcamp.doneBody':
    '腿上的功夫就这些了。走回大门处的看守塔姆那里交差：他有话要对你说，还有你的第一份报酬。',
  ...
  'entities.quests.q_ps_the_gauntlet.text':
    '谷地敬重的每一双腿，都是先从这几条跑道跑出来的，{playerName}。沿第一条跑道向西走到旗帜处，好好环顾四周，再沿南边的跑道向左滑步走到第二面旗，再看一圈，最后沿末尾的跑道跑到红旗处。旗帜要按顺序经过；屏幕上方的卡片会随时告诉你该按哪个键。等红旗被你甩在身后，回到大门处找我。',
  'entities.quests.q_ps_the_gauntlet.completion':
    '跑得干净利落，{playerName}。你的双腿已经记住了跑道，剩下的就该干真正的活了：教官玛伦在码头北边沿路而上的晨憩营地主持操练。走到她跟前，直到她的名字显示出来，然后按 F，或者用鼠标左键点击她，她会交给你第一件差事。',
  ...
  'entities.quests.q_ps_strike_true.text':
    '欢迎来到试炼之滨，{playerName}。这里的每一课都从同一件事开始：站稳脚，握好刃。营地西南练武场上的草人生来就是挨打的。要是找不到练武场，按 M 打开地图：你身上的每件差事都会标在上面，用不着乱转。走到一个草人跟前，按 Tab 或用鼠标左键点击它，把它设为目标，然后按 1，或者点击屏幕底部动作条上的第一个图标，挥出这一刀。一直打到三个散架为止。它们的还击不痛不痒，这片海滨之外的东西下手可重得多。第三个倒下之后，走回我这儿来，按 F 交还任务、领取报酬：这世上每一件差事，都是这样收尾的。',
  ...
  'entities.quests.q_ps_the_wheel_of_trades.title': '百业环轮',
  'entities.quests.q_ps_the_wheel_of_trades.text':
    '一柄剑只能喂饱你一顿，{playerName}，一门手艺却能喂养你一生。每个冒险者在刀剑之外都操持着专业：采矿、伐木、采药、钓鱼，还有把这一切变成价值的制作技艺。军需官芬奇的货摊就在我这操练场几步之外，而她摆过的摊子比我带过的操练还多。走到她跟前，按 F，或者用鼠标左键点击她，就能与她交谈：开箱子的那个键，同样也开启对话。',
  'entities.quests.q_ps_the_wheel_of_trades.completion':
    '玛伦总算给我送来一个值得费口舌的学生。听好了，{playerName}，只说一遍：采集从一件工具开始，矿镐、斧子、镰刀、钓竿，谷地的商人那里都有得卖。按住 Shift 再按 P，就能打开你的专业手册：那就是你的环轮，上面列着你会的每一门技艺，以及各自练到了哪一步。钻研你喜欢的那些，当你调谐到相邻的一对，这两门便成为无上限的主修，环轮对面的一门留作你的爱好，其余的则连同所学一起休眠。什么都不会失去，什么也都不是定局：技艺大师为你定下这一对，日后你想改，找技艺大师也就改了。他们就在东溪谷：锻炉旁的锻造大师达尔瓦、旅店厨房里的厨师马洛、织机前的织匠奥蒂莉、工坊里的机巧师吉泽尔，还有芬桥制革坊的皮匠赫斯克，和高哨药剂铺的炼金师薇兰。',
  ...
  'entities.quests.q_ps_pouch_and_purse.text':
    '去谷地之前还有最后一课，{playerName}，也是保住冒险者性命的一课：你随身带的东西。你的背包有十六格，旁边还空着四个袋扣；每系上一只袋子，它的空间就并入总容量。所以：对着军需官芬奇按 F，打开她的货摊，在她的货品里用鼠标左键点击亚麻小袋买下它，然后按 B 打开背包，再用鼠标左键点击袋中的亚麻小袋，把它系进一个空着的袋扣。等它挂上腰带，就回来找我。',
  ...
  'entities.quests.q_ps_set_sail.text':
    '这片海滨上已经没有你没打倒过、没打开过、没买下过的东西了，{playerName}。你准备好了，而东溪谷有真正的差事在等着。沿路走到旧码头，对着渡船人奥多按 F，告诉他，就说是我说的，你挣到了这趟航程。什么时候记不清自己欠了谁什么，随时按 L：那是你的任务日志。',
