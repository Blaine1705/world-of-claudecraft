...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.framePresets.saveCurrent': '保存当前预设',
  ...
  'hudChrome.framePresets.load': '加载并刷新',
  ...
  'hudChrome.focusTargets.hint': '点击目标框体或按 {key} 选中此焦点。',
  'hudChrome.focusTargets.clickHint': '点击目标框体选中此焦点。',
