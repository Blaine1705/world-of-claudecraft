...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.worldPvp.groundFfa':
    '怨灵林、常青园与夜绽花野是自由混战地带：无论是否开启旗帜，那里的每个人都能交战。',
  ...
  'guide.worldPvpPage.introZones':
    '开放世界的玩家对战需要主动开启，而你脚下的土地决定了这意味着什么。升起你的 PvP 旗帜后，所有不在你的小队或团队中且同样开启了旗帜的玩家都会在争夺地带成为敌人；降下旗帜后，稍作等待你就会重新成为旁观者。有两座区域是完全不会发生世界战斗的圣域，而三座满级区域是自由混战地带，无论是否开启旗帜，身处其中的每个人都可以被攻击。小队和团队的伙伴在任何地方都不会成为你的敌人；队伍之外的公会成员与其他人一样可以被攻击。',
