...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  'hudChrome.loot.rollWon': '恭喜！你以 {roll} 点赢得了 {item}',
  ...
  'entities.abilities.enrage_passive.description':
    '被动：处于激怒状态时，你造成的伤害提高 7%，攻击速度提高 25%，移动速度提高 10%，持续 4 秒。放血有 30% 几率使你激怒；血色收割则必定触发。（狂怒）',
  ...
  'entities.abilities.sweeping_strikes.description':
    '持续 12 秒，你的单体攻击还会以全额伤害额外打击 1 个附近的敌人。（武器）',
  ...
  'entities.abilities.typhoon.description':
    '一阵狂风将8码内的所有敌人击退并使其昏乱，使其移动速度降低50%，持续4秒。',
  ...
  'hudChrome.wocStore.skins.guildmark_arming_sword.look':
    '发蓝钢剑刃、青铜鱼尾形十字护手、青绿色染皮握柄，以及一枚小巧的公会钢印。',
  'hudChrome.wocStore.skins.guildmark_arming_sword.lore':
    '一般成品剑无名无姓，这一把却有署名。只有当 World Market 的 Merchant 愿为其钢材作保，铠甲匠才有权在剑根刻下自己的印记；Smith Haldren 的印记正有这份担保。剑身经发蓝处理，足以抵御 the Vale 的湿气，平衡精准至毫厘。你付的钱有一半买的是钢印，但它物有所值。',
  'hudChrome.wocStore.skins.brasscap_axe.name': '黄铜帽手斧',
  'hudChrome.wocStore.skins.brasscap_axe.look':
    '抛光钢斧刃，漆制白蜡木柄上装有黄铜顶帽与护木铁，缠带整洁，并刻有匠人钢印。',
  'hudChrome.wocStore.skins.brasscap_axe.lore':
    '带钢印的斧头是握在手里的炫耀。黄铜顶帽和护木铁一半是护甲，一半是签名：既防斧柄劈裂，也映着酒馆灯火，让人人都知道你买的是 Armorer Hode 的作品，不是民兵传下来的旧货。“能砍，我就卖。”Highwatch 的铁匠如此说。这一把确实能砍。',
  'hudChrome.wocStore.skins.tempered_flanged_mace.name': '淬火凸缘锤',
  'hudChrome.wocStore.skins.tempered_flanged_mace.look':
    '六棱淬火蓝钢锤头、黄铜颈环与柄首，以及酒红色皮革握柄。',
  'hudChrome.wocStore.skins.tempered_flanged_mace.lore':
    '六道发蓝淬火钢棱，每一道都磨得足以劈开头盔，再配黄铜端饰与酒红皮革。哪怕用途再残酷，王国的铠甲匠也不肯造丑陋的武器。这一把经 World Market 专门委制，并非货架上的现成货；某处账簿里还写着那位自豪买家的名字，以及他付给 Hode 的价钱。',
  'hudChrome.wocStore.skins.guildmark_dirk.name': '公会印记短剑',
  'hudChrome.wocStore.skins.guildmark_dirk.look':
    '纤细的淬火钢短剑、青铜护手与柄尾螺帽、深绿色绳缠握柄，以及压印徽记。',
  'hudChrome.wocStore.skins.guildmark_dirk.lore':
    '这是有身份者把长剑留在家中时佩戴的武器：纤细、淬火，盖着与整柄长剑同样的认证钢印，挂在腰间，如同一枚带刃的印戒。除非懂得铠甲匠的凭证，否则只会觉得它低调。Quartermaster Bree 在 Highwatch 留着整整一抽屉，专供赢得城墙敬意的军官。',
  'hudChrome.wocStore.skins.brasscrown_staff.name': '黄铜冠手杖',
  'hudChrome.wocStore.skins.brasscrown_staff.look':
    '硬木杖顶装有车制黄铜冠饰，配黄铜杖脚与染色皮带。',
  'hudChrome.wocStore.skins.brasscrown_staff.lore':
    '杖身取自风干硬木，顶上是 Eastbrook 铁匠成百铸造却件件精修的黄铜冠饰。它属于那种无论走到 Fenbridge 城门还是 Highwatch 城墙，都希望被认真对待的旅人。这根手杖从未真正需要支撑步伐；染色皮带与那件一眼便知价值不菲的外套恰好相配。',
  'hudChrome.wocStore.skins.lacquered_wand.name': '漆木短杖',
  'hudChrome.wocStore.skins.lacquered_wand.look':
    '纤细的深红漆杖，饰有两道抛光黄铜环和小巧圆润的黄铜杖头。',
  'hudChrome.wocStore.skins.lacquered_wand.lore':
    '深红漆面耐心涂了七层，再以两道抛光黄铜束起。这正是乡野法师开始收取真金白银后，会从 World Market 买来装点门面的法杖。它引导 Light 的能力并不比白桦枝更强，却能在 Merchant 的柜台上耀眼夺目；小法术向来有一半靠别人相信。',
  'hudChrome.wocStore.skins.fletcher_s_guild_bow.name': '制弓师公会弓',
  'hudChrome.wocStore.skins.fletcher_s_guild_bow.look':
    '漆制胡桃木反曲弓、黄铜弓梢、上蜡亚麻弦，弓把上刻有公会钢印。',
  'hudChrome.wocStore.skins.fletcher_s_guild_bow.lore':
    '弓把上的制弓师钢印，是王国最接近公会凭证的东西；它承诺着弓身内在的品质，就像酿酒师为木桶封印。漆制胡桃木、黄铜弓梢，还有经上蜡、不会在 Mirefen 雨中磨损的亚麻弦，每一处接合都在为价格辩护。越过 Widow Thicket 后拉一次弓，这场辩论便有了答案。',
  'hudChrome.wocStore.skins.cinderbrand_sword.name': '烬痕',
  'hudChrome.wocStore.skins.cinderbrand_sword.look':
    '深色锻钢剑刃，血槽中嵌着橙红发光符文与热裂纹，护手内有一枚阴燃宝石。',
  'hudChrome.wocStore.skins.cinderbrand_sword.lore':
    '这是第一把不用水淬火，而以从 Stormcrag 耙出的 Blessed Embers 淬炼的剑。Highwatch 的铁匠发誓，那些煤火“燃得湛蓝而纯净，因为山仍记得古老的誓言”。火焰被封进血槽后只余橙红暗燃，却永不熄灭；即便在城墙最寒冷的夜晚，符文也能温暖裸手。Cinderbrand 从不需要点燃，它只是拒绝熄灭。',
  'hudChrome.wocStore.skins.emberbite_axe.name': '余烬之噬',
  'hudChrome.wocStore.skins.emberbite_axe.look':
    '熏黑铁斧，斧刃间透出橙红裂光，嵌有一枚封存炭火的宝石，周围热气缭绕。',
  'hudChrome.wocStore.skins.emberbite_axe.lore':
    'Armorer Hode 把一块山火活炭锻进斧刃核心，使刃口在两次挥砍之间也从未真正冷却。下劈时裂纹吐出橙光，仿佛撞击唤醒了初次锻造时沉睡在铁里的东西。有人说一只 Stormcrag 元素为此交出了余烬；Highwatch 起风时，人们总会说出许多故事。',
  'hudChrome.wocStore.skins.smoulderfall_mace.name': '闷燃坠击',
  'hudChrome.wocStore.skins.smoulderfall_mace.look':
    '黑铁锤棱的内侧裂缝泛着橙红光芒，锤头中嵌有熔核宝石。',
  'hudChrome.wocStore.skins.smoulderfall_mace.lore':
    '这柄战锤自带炉火：从那道“以山火铸成”的 Sanctum 封印上凿下一块熔核石，嵌在锤头中发光。锤棱触手温热，落下时更烫；一名 Highwatch 中士发誓，被它击中的瘀伤会微微发亮直到清晨。山中之火终于不再用于封印，而用于破坏。',
  'hudChrome.wocStore.skins.ashspark_dagger.name': '灰火匕',
  'hudChrome.wocStore.skins.ashspark_dagger.look':
    '短小的熏黑刀刃遍布橙红发光纹路，柄首嵌着微小的阴燃宝石，灰烬与火星相随。',
  'hudChrome.wocStore.skins.ashspark_dagger.lore':
    '一把将山火偷藏进柄首宝石的巷战短刀，也是铠甲匠无声的玩笑：就连扒手也能带着初次锻造的一点余烬。刀身熏黑、橙纹密布，在鞘中总比应有的温度更暖。于 Highwatch 下方的黑暗中拔出它，微光恰好能照亮你的手，也足以找到对手守势中的缝隙。',
  'hudChrome.wocStore.skins.forgeheart_staff.name': '炉心法杖',
  'hudChrome.wocStore.skins.forgeheart_staff.look':
    '铁箍法杖顶端囚着发光余烬核心，火焰符文沿杖身攀升，热浪在上方摇曳。',
  'hudChrome.wocStore.skins.forgeheart_staff.lore':
    '一块山火活炭被囚在杖冠的铁笼中。Loremaster Caddis 称它证明了初次锻造之火不仅能用于封印，也能被束缚来服务。热浪化作纤细而无尽的丝带升起；携带它的法师永远不缺锻炉或守夜火。传言这块余烬取自 Voskar the Emberwing 的吐息，自此从未冷却。',
  'hudChrome.wocStore.skins.emberwrought_wand.name': '余烬锻造魔杖',
  'hudChrome.wocStore.skins.emberwrought_wand.look':
    '熏黑金属魔杖，铁爪扣住发光炭火，细微热裂纹间透出温暖内光。',
  'hudChrome.wocStore.skins.emberwrought_wand.lore':
    '正是这根魔杖为整个品级命名。Highwatch 的铠甲匠第一次以铁爪扣住山火余炭，并让它听命于凡人之手时，就连 Light 的祭司也不再称其为异端，转而说它很实用。温暖、耐心，又悄然危险：杖尖的余烬从主人出生前便持续燃烧，从未中断。',
  'hudChrome.wocStore.skins.cinderlatch_crossbow.name': '烬锁',
  'hudChrome.wocStore.skins.cinderlatch_crossbow.look':
    '熏黑钢弩，弩臂裂缝渗出橙红光芒，弩身中封着一块阴燃煤炭。',
  'hudChrome.wocStore.skins.cinderlatch_crossbow.lore':
    '这是余烬锻造中最奇异的一件：把山火灌进一台机械。橙光从弩臂裂缝渗出，弩身内的阴燃煤炭令弓弦在 Thornpeak 的严寒或 Mirefen 的湿气中都不会僵硬。弩矢离槽时已有温度，命中时更为灼热。对于城墙外那些同样不畏严寒的敌人，这是猎人的回答。',
  ...
  'hudChrome.wocStore.skins.glaciersplit_axe.lore':
    '它凿自 Thornpeak 冰川的蓝色核心，两个世纪的重压把寒意压到自行发光。即使静止也拖着白雾，落下时的巨响如同 Stalker Ridge 下方裂开一道冰隙。Highwatch 将阵亡者交给那里的冰雪；因此这件武器生来便要阻挡融雪，以及融雪可能唤醒的一切。',
  'hudChrome.wocStore.skins.rimecrusher_mace.name': '霜碎',
  'hudChrome.wocStore.skins.rimecrusher_mace.look':
    '锯齿状冰晶簇拥着发光的青蓝核心，白霜沿镀银锤柄向下蔓延。',
  'hudChrome.wocStore.skins.rimecrusher_mace.lore':
    '它不是雕刻出来，而是生长而成：匠人诱导 Thornpeak 寒冰包裹青蓝冷核，直到坚硬得不逊于 Hode 最好的钢。白霜沿镀银锤柄爬向手掌，却始终差一点触及。它击中之处水会冻结，停放之处地面会泛白。山峰的墓穴寒意，被缩小到足以挥向那些攀爬城墙之物。',
  'hudChrome.wocStore.skins.frostbite_dagger.name': '霜针',
  'hudChrome.wocStore.skins.frostbite_dagger.look':
    '透明蓝冰制成的极细匕首，中央贯穿青蓝发光脉络，针状霜晶与白霜覆盖刀柄。',
  'hudChrome.wocStore.skins.frostbite_dagger.lore':
    '薄如屏息，却比呼吸冷上两倍：一片 Thornpeak 冰川碎屑被磨成单一发光脉络，锋利到伤口会在血液想起流动前先被冻结。它的名字借自死者从群峰带下的墓穴寒意。它从不需要磨刃；Loremaster Caddis 冷冷地说，冰不会变钝，它只会等待。',
  'hudChrome.wocStore.skins.hoarfrost_vigil_staff.name': '白霜守望',
  'hudChrome.wocStore.skins.hoarfrost_vigil_staff.look':
    '镀银法杖顶端漂浮着缓慢旋转的青蓝冰片，放射霜晶与寒雾。',
  'hudChrome.wocStore.skins.hoarfrost_vigil_staff.lore':
    '这是 Highwatch 城墙上永不沉睡的守望之杖。杖冠是一片青蓝湖冰，脱离银托悬浮，并自行缓缓转动；守卫发誓，它总是指向群峰下正在聚集的寒意。携带这份守望，便是在一夜间站完两百年的岗，并承诺绝不移开目光。',
  ...
  'hudChrome.wocStore.skins.winterbite.lore':
    '这把弓由镀银钢与 Thornpeak 寒冰制成，弓把内的青蓝冷核将箭冻结在弦上。每次拉弓都会重新凝成一支冰川实冰箭；城墙上的弓手不带箭袋，只携寒意。Highwatch 曾靠一把这样的弓守住遭围攻的 Stalker Ridge：据说只有一名弓手，以及一整个冬天取之不尽的箭。',
  'hudChrome.wocStore.skins.solheim_sword.name': 'Solheim，黎明最后之光',
  'hudChrome.wocStore.skins.solheim_sword.look':
    '以陨星锻成的巨剑，熔金核心贯裂剑刃，宇宙黑钢边缘闪着星光，金色碎片环绕护手，极光如带。',
  'hudChrome.wocStore.skins.solheim_sword.lore':
    '那颗星从西方天空坠落，在 Widow Thicket 之外“如锻炉般爆裂”时，Brother Aldric 从 Mirefen 陨坑取出仍在阴燃的星核，恳求王国铁匠加工“并不属于这个世界的东西”。他们将其锻成唯一一柄巨剑：Solheim。熔金核心如黎明撕开夜空般劈开宇宙黑刃，星金碎片沿无人设定的轨道绕护手运行。世上只锻成这一把，也绝不会有第二把。',
  'hudChrome.wocStore.skins.skyrender_axe.name': '裂天者，苍穹之伤',
  'hudChrome.wocStore.skins.skyrender_axe.look':
    '斧头像一块撕裂的夜空，遍布熔金裂缝与星座刻纹，星光碎片悬浮，刃后拖着极光。',
  'hudChrome.wocStore.skins.skyrender_axe.lore':
    '它锻自陨坑边缘，那里坠星从 Mirefen 水面撕走了天空的倒影，留下至今仍冒蒸汽的伤口。斧头像一片被扯下的夜：熔金裂缝、Highwatch 学者也叫不出名字的星座，以及每次挥动都从刃缘流出的极光。Brother Aldric 为它赐福，却拒绝碰触。举起它，就像握住苍穹留下的缺口。',
  'hudChrome.wocStore.skins.starfall_mace.name': '星陨，诸天裁决',
  'hudChrome.wocStore.skins.starfall_mace.look':
    '被囚的熔金星核由轨道碎片环绕，宇宙黑锤棱中流淌星光，极光从接缝溢出。',
  'hudChrome.wocStore.skins.starfall_mace.lore':
    '一颗星核在死亡前一瞬被捕获，随它坠落的残片环绕四周，永远停在湮灭前最后一寸。宇宙黑锤棱中流淌着被困的星光，举起时极光便从接缝溢出。古老的 Light 祭司称流星为裁决，是从天而降、任何盾牌都无意阻挡的判决；此锤便以坠落 Mirefen 的那颗星命名。',
  'hudChrome.wocStore.skins.astravyr_dagger.name': 'Astravyr，陨星之牙',
  'hudChrome.wocStore.skins.astravyr_dagger.look':
    '一片陨星碎屑，宇宙黑金属上燃着熔金刃光，明亮星尘绕柄首运行，并拖出细薄极光。',
  'hudChrome.wocStore.skins.astravyr_dagger.lore':
    '这是 Aldric 从陨坑带回的星体中最小的一片，也有人认为它最危险。异界星核的一缕碎片，熔金刃缘贴着宇宙黑金属，一颗孤独星尘如失去世界的月亮般绕柄首运行。它几乎没有重量，却几乎能切开一切。小到足以藏匿，也亮到能凭自身光芒在黑暗中寻回。',
  'hudChrome.wocStore.skins.cosmarch_staff.name': 'Cosmarch，无尽虚空尖塔',
  'hudChrome.wocStore.skins.cosmarch_staff.look':
    '金色星片环绕熔金核心运行，宇宙黑杖身刻满星座，极光丝带向上盘绕。',
  'hudChrome.wocStore.skins.cosmarch_staff.lore':
    '星金杖身顶着熔金核心，金色碎片沿缓慢而无尽的轨道环行，宛如一座微型宇宙；其星座不属于 Thornpeak 上空的任何天幕。极光如忘记升起的烟，沿杖身向上缠绕。曾持有它的人说能感到虚空在杖中转动，就像 Ysolei 的湖水“饮下月光”：耐心、寒冷，并回望着你。',
  'hudChrome.wocStore.skins.emberwish_wand.name': '余烬之愿，垂死太阳之火种',
  'hudChrome.wocStore.skins.emberwish_wand.look':
    '被囚的熔金垂死星火由火星环绕，宇宙黑杖身刻着发光星座。',
  'hudChrome.wocStore.skins.emberwish_wand.lore':
    '这并非陨星本身，而是一颗垂死恒星最后的微光：一轮早已熄灭的太阳留下的熔金余烬，周围盘旋着它最后的火花。宇宙黑杖身刻有见证其死亡的星座。Mirefen 佃农说，真黄昏时持有它便可许下一个愿望；他们也说，每个持有过它的灵魂都只愿获得更多时间，而 Drowned Moon 从未答应任何人。',
  'hudChrome.wocStore.skins.encore_bow.name': 'Encore，第二颗坠星',
  'hudChrome.wocStore.skins.encore_bow.look':
    '夸张巨大的星炮：宇宙黑炮管刻着金色发光星座，喇叭形炮口内装有熔金彗星弹，配黄铜构件与木质肩托。',
  'hudChrome.wocStore.skins.encore_bow.lore':
    '加工陨星的铁匠造出六件遗物后，还剩下整整一炮管星金；到了那时，学徒们也有了自己的主意。铁砧上诞生的东西，要么是王国第一支火枪，要么是最小的攻城器：一门肩扛星炮，与其说它发射弹丸，不如说它瞄准后请求第二颗星落下。Brother Aldric 拒绝赐福，理由是如此响亮的东西早已被天堂注意。猎人深爱它，射线前方的一切则从未如此。',
  'hudChrome.wocStore.skins.meteorlatch_crossbow.name': '星陨锁扣，苍穹最后的裁决',
  'hudChrome.wocStore.skins.meteorlatch_crossbow.look':
    '陨星金属弩身，熔金核心贯穿弩托，宇宙黑弩臂刻满星座，弦上搭着纯粹星火之矢。',
  'hudChrome.wocStore.skins.meteorlatch_crossbow.lore':
    '它在 Mirefen 陨坑仍发着光时，以“烫得无法触碰”的原始陨星金属锻成；碎片被敲成刻满星座的宇宙黑弩臂，熔金核心沿弩托封存。它不搭弩矢，而是召来一束星火：发射如宣判，落地如判决的终结。当 Highwatch 担心 Nythraxis 的不死王冠或许还不是群峰下最可怕的东西时，他们希望城墙上摆着的正是这件武器。务必瞄准。',
  ...
  'hudChrome.options.overlays': '叠加层',
  ...
  'hudChrome.dungeonDifficulty.resetConfirmBody':
    '此操作会放弃先前所选难度下的空置副本。若有未拾取的战利品，则无法重置。',
  ...
  'hudChrome.dungeonDifficulty.entryMismatchNormal':
    '此副本的难度为普通。使用“重置所有副本”以开始全新的英雄难度副本。',
  'hudChrome.dungeonDifficulty.entryMismatchHeroic':
    '此副本的难度为英雄。使用“重置所有副本”以开始全新的普通难度副本。',
  ...
  'hudChrome.worldPvp.blurb':
    '升起你的 PvP 旗帜，即可在开放世界的任何地方与其他已开启旗帜的玩家作战。击败对方即可分得其钱袋的一部分，并获得用于兑换 PvP 装备的荣誉。战场与竞技场的收益仍然更高。',
  'hudChrome.worldPvp.statusOn': '你的 PvP 旗帜已升起。已开启旗帜的玩家可以攻击你。',
  'hudChrome.worldPvp.statusOff': '你的 PvP 旗帜已降下。你在开放世界中无法攻击他人，也不会被攻击。',
  'hudChrome.worldPvp.statusDisarming': '你的旗帜将在 {time} 后降下，或在当前战斗结束时降下。',
  'hudChrome.worldPvp.stakeLine': '败者支付 {cap} 或钱袋的 {percent}，以较少者为准。',
  ...
  'hudChrome.worldPvp.keepUp': '保持旗帜',
  'hudChrome.worldPvp.confirmBody':
    '其他已开启旗帜的玩家将可以在任何地方攻击你，并在获胜时从你的钱袋中最多拿走 {cap}。你可以再次关闭，但需要 {minutes} 分钟。',
  'hudChrome.worldPvp.confirmAccept': '升起旗帜',
  'hudChrome.worldPvp.confirmCancel': '取消',
  'hudChrome.worldPvp.levelReq': '需要 {level} 级。',
  'hudChrome.worldPvp.pending': '正在等待领域返回你的 PvP 状态。',
  'hudChrome.worldPvp.commandHint': '聊天：/pvp 切换旗帜，/pvp on 与 /pvp off 直接设置。',
  'hudChrome.worldPvp.statusOffFfa':
    '你的 PvP 旗帜已降下，但在自由混战地带你仍然可以攻击他人，也会被攻击。',
  'hudChrome.worldPvp.zoneSanctuary': '圣域：此处没有世界 PvP。',
  'hudChrome.worldPvp.zoneContested': '争夺地带：此处只有已开启旗帜的玩家才能交战。',
  'hudChrome.worldPvp.zoneFfa': '自由混战地带：此处的每个人都可以被攻击。',
  'hudChrome.worldPvp.realmDisabled': '本领域已关闭世界 PvP。',
  'hudChrome.worldPvp.groundSanctuary': '试炼之滨与东溪谷是圣域：完全没有世界 PvP。',
  'hudChrome.worldPvp.groundContested':
    '其余各处都是争夺地带：只有两名都已开启旗帜的玩家才能交战。',
  'hudChrome.worldPvp.groundFfa':
    '龙裔荒原、霜幕之境与琥珀秋境是自由混战地带：无论是否开启旗帜，那里的每个人都能交战。',
  'hudChrome.worldPvp.markLine':
    '在那里攻击未开启旗帜的玩家会升起你自己的旗帜；攻击已开启旗帜的玩家则永远不会。',
  'hudChrome.worldPvp.aidLine': '在世界战斗中为已开启旗帜的玩家治疗、护盾或增益，会升起你的旗帜。',
  'hudChrome.worldPvp.noStakeLine': '未开启旗帜的玩家在自由混战地带被击杀时不会损失金币。',
  'hudChrome.worldPvp.noTakeLine':
    '未开启旗帜的战斗者同样拿不到金币：金币只在两名开启旗帜的玩家之间转移。',
  'hudChrome.worldPvp.repeatLine':
    '反复击杀同一名玩家，收益为 {second}，随后为 {third}，之后归零；计数在首次击杀后 {reset} 重置。',
  ...
  'hudChrome.warfareShop.groupSeason2': '战争第二赛季：先锋',
  'hudChrome.warfareShop.groupEntry': '战争第一赛季',
  ...
  'hudChrome.options.gfxGhostFade': '镜头遮挡透视',
  'hudChrome.options.gfxGhostFadeDithered': '网点',
  ...
  'character.redesignHint':
    '该角色创建于新角色编辑器之前。你有一次免费重新设计的机会，保存时即会消耗。',
  ...
  'itemUi.market.ordersNote':
    '发布你想要的物品，金币由商人代为保管。价格不高于你出价的上架会立即成交；其余部分等待卖家送货。商人向送货者收取 {cut}% 的手续费。你已开启 {used}/{max} 个订单。',
  'itemUi.market.ordersListAria': '未完成的求购订单',
  'itemUi.market.ordersEmpty': '还没有求购订单。发布一个，采集者就能看到你的需求。',
  'itemUi.market.orderCardTitle': '发布订单',
  'itemUi.market.orderPickLabel': '想要的物品',
  'itemUi.market.orderPickEmpty': '在下方搜索物品，或从底部的列表中选择一个。',
  'itemUi.market.orderSearchPlaceholder': '搜索物品...',
  'itemUi.market.orderSearchAria': '搜索要求购的物品',
  'itemUi.market.orderPickNone': '没有匹配的物品。',
  'itemUi.market.orderQuantity': '需求数量',
  'itemUi.market.orderPriceEach': '单价',
  'itemUi.market.orderEscrowLine': '商人代管的金币：{total}',
  'itemUi.market.orderCannotAfford': '你无法为此订单支付 {total}。',
  'itemUi.market.orderAtCap': '没有空余的订单栏位。请先撤回一个。',
  'itemUi.market.orderPlaceButton': '发布订单',
  'itemUi.market.orderConfirmTitle': '确认订单',
  'itemUi.market.orderConfirmBody':
    '以每件 {each} 求购 {item} x{count}？{total} 将由商人保管，直到订单成交或撤回。',
  'itemUi.market.orderWanted': '求购 x{count}',
  'itemUi.market.orderBy': '{buyer} 求购',
  'itemUi.market.orderMine': '你的订单',
  'itemUi.market.orderEach': '每件',
  'itemUi.market.orderDeliver': '送货',
  'itemUi.market.orderDeliverAria': '向 {buyer} 送交 {item}',
  'itemUi.market.orderDeliverNone': '你的背包里没有这件物品。',
  'itemUi.market.orderWithdraw': '撤回',
  'itemUi.market.orderWithdrawAria': '撤回你对 {item} 的订单',
  'itemUi.market.orderDeliverConfirmTitle': '确认送货',
  'itemUi.market.orderDeliverConfirmBody':
    '以 {total}（每件 {each}）向 {buyer} 送交 {item} x{count}？扣除商人手续费后你可领取 {proceeds}。',
  'itemUi.market.unlistedTitle': '市场上没有的',
  'itemUi.market.unlistedNote': '目前没有任何上架的材料。为其中一种发布订单，或者去采集并上架。',
  'itemUi.market.unlistedNone': '目前每种材料都至少有一个上架。',
  'itemUi.market.unlistedStageAria': '求购 {item}',
  'itemUi.logs.orderPlaced': '已发布 {item} x{count} 的订单，单价 {each}。',
  ...
  'itemUi.errors.orderOwn': '这是你自己的订单。请撤回它以取回金币。',
  'itemUi.errors.orderNotYours': '这不是你的订单。',
  ...
  'entities.abilities.divine_protection.description':
    '神圣结界吸收最大生命值的{damage}%伤害，持续{duration}秒。持久守护会提高结界吸收量。',
  ...
  'entities.quests.q_old_cragmaw.text':
    '山民给我斥候找到的爪印起过名字：老裂颚，一只满身伤疤的暴君巨猫，熬死了自己族群的三代。潜猎者涌上我的道路，就是因为它，{playerName}。它的巢穴在南路上方的东侧山脊。带个帮手去，了结那老魔头。',
  ...
  'entities.quests.q_mogger.text':
    '莫格劈裂货车，踏平栅栏，杀死的牲口足以让半个谷地空掉。不要独自面对它。带两名强壮同伴去西边草地，把那蛮兽彻底放倒。',
  ...
  'entities.zones.drakelands.welcome':
    '灼热的风从前方的荒漠滚滚而来。巨龙在龙喉火山上空盘旋，巨魔的篝火在沙丘间燃烧。',
  ...
  'entities.zones.amberfall.welcome':
    '这里每一片叶子都燃烧着金红，却从不飘落。灯湖镇的灯笼已为你点亮。',
  ...
  'guide.home.world.fenBlurb':
    '越过秋色之冠，是一片垂柳与静水的明亮沼泽，还有一座护城河环绕的小镇。',
  ...
  'entities.zones.wraithwood.welcome':
    '树冠像棺盖一样在路上合拢。跟紧绞湖镇的灯火，若林中有声音喊你的名字，千万别回应。',
  ...
  'entities.zones.palmreach.welcome':
    '温暖的沙滩，喧闹的鸟鸣，还有吞没地平线的丛林。漂流港在海滩上为你留着一堆篝火。',
  ...
  'entities.zones.evergarden.welcome':
    '树篱仍有人在修剪，可百年来无人见过园丁。当心迷宫：它也在留意你。',
  ...
  'entities.zones.galecrest.welcome':
    '这里的风从未停过，老灯塔的火也从未熄过。烛港只求你随手关上旅店的门。',
  ...
  'entities.npcs.warden_coalfast.name': '守望者·煤耐',
  'entities.npcs.warden_coalfast.title': '堡垒指挥官',
  'entities.npcs.warden_coalfast.greeting':
    '裂隙才不管鸥港有多小，{className}。我们守住这片海岸，否则就再没有海岸可守。与我们并肩而战，我不会忘记你的付出。',
  'entities.npcs.riftwatch_ollun.name': '裂察·奥伦',
  'entities.npcs.riftwatch_ollun.title': '裂隙学者',
  'entities.npcs.riftwatch_ollun.greeting':
    '每道裂隙开启之前都会歌唱，只要你有听它的耳朵。此刻我能听见岛上三道裂隙正在骚动，其中一道就在近处。',
  'entities.npcs.quartermaster_edda.name': '军需官·艾达',
  'entities.npcs.quartermaster_edda.title': '堡垒军械师',
  'entities.npcs.quartermaster_edda.greeting':
    '钢铁与海盐，{className}，这就是我还能发给你的全部了。拿上它，让那些裂隙后悔在我够得着的地方裂开。',
  'entities.npcs.mender_saul.name': '疗愈者·索尔',
  'entities.npcs.mender_saul.title': '战地外科医',
  'entities.npcs.mender_saul.greeting':
    '这一个月里我接的骨头，比过去十年医治渔民跌伤加起来还多。裂隙夺走的东西，很少留下什么。若你办得到，就囫囵着回来见我。',
  'entities.npcs.bellkeeper_tam.name': '守钟人·塔姆',
  'entities.npcs.bellkeeper_tam.title': '警钟守',
  'entities.npcs.bellkeeper_tam.greeting':
    '这口钟，是裂隙留给我们的唯一预警，{className}。一声,是田野;两声,是断崖;三声,便是它已近得逃也无用。留心听着,它或许能保你全身。',
  'entities.npcs.fisher_nell.name': '受惊的奈尔',
  ...
  'entities.zones.farshore_isle.welcome':
    '越过沙洲，鸥港的警钟会先于这座镇子寻到你。裂隙毫无预兆地撕裂开来，而这座堡垒守着自己的海岸，抵挡从中涌出的一切。他们已经等待像你这样的人很久了。',
  ...
  'entities.npcs.keeper_saelwyn.name': '守护者塞尔文',
  'entities.npcs.keeper_saelwyn.title': '幽谷守护者',
  'entities.npcs.keeper_saelwyn.greeting':
    '你的同族鲜少踏足这片树荫，{className}。轻声慢行，欢迎你的到来。',
  'entities.npcs.loremother_bryn.name': '传识之母布琳',
  'entities.npcs.loremother_bryn.title': '圣祠之声',
  'entities.npcs.loremother_bryn.greeting':
    '这山谷里的每一盏光都铭记着什么，{playerName}。帮我听听它们的低语。',
  'entities.npcs.provisioner_fenna.name': '补给员芬娜',
  'entities.npcs.provisioner_fenna.title': '古辉镇补给员',
  'entities.npcs.provisioner_fenna.greeting': '面包还热着，泉水依然甘甜。幽谷有所馈赠，我也一样。',
  'entities.npcs.wardsmith_orun.name': '结界铁匠欧伦',
  'entities.npcs.wardsmith_orun.title': '古炉看守',
  'entities.npcs.wardsmith_orun.greeting':
    '这些熔炉几百年前就冷了，{className}，但它们锻出的兵刃至今锋利。',
  'entities.npcs.archivist_tullo.name': '档案员图洛',
  'entities.npcs.archivist_tullo.title': '读石者',
  'entities.npcs.archivist_tullo.greeting':
    '外面那些石碑已经许久不曾对人开口。也许它们正等着新的耳朵。',
  'entities.quests.q_veil_thinned.title': '稀薄的帷幕',
  'entities.quests.q_veil_thinned.text':
    '洞穴竟为你敞开了。那么封印比我担心的还要脆弱，{playerName}。帷幕撕裂之处，光灵会变得阴冷黑暗。给我带来八份暮光灵的精华，我便能读出这道伤口有多深。',
  'entities.quests.q_veil_thinned.completion':
    '每一份都是冰冷的。幽谷也许只剩一个季节，裂缝就会变成裂谷。你我有得忙了。',
  ...
  'entities.quests.q_gleaming_antlers.text':
    '帷纱雄鹿在吃草的地方洒下微光，它们蜕下的鹿角能把光留住许多年。从星落盆地的鹿群那里取来五支，我的灯笼整个冬天都不用点油。不必伤害雄鹿，但它们也不会轻易相让。',
  'entities.quests.q_gleaming_antlers.completion':
    '看它们把光留得多好！没有火焰，没有烟，只有光。幽谷自有馈赠。',
  ...
  'entities.quests.q_wisp_lights.text':
    '微光灵身上带着幽谷封印之时落下的古老星光。六粒光尘，圣祠的灯便能燃上一年。只取那些将熄的，幽谷的馈赠足够，无需贪求。',
  'entities.quests.q_wisp_lights.completion':
    '柔和得像最初的星辰。放在祭坛边吧，圣祠会完成剩下的事。',
  ...
  'entities.quests.q_calming_the_deep.text':
    '辉光深处的孢子人本是温和的族群，直到裂缝触到了他们的蘑菇环。被侵蚀夺走的，再也不会归还。让堕落者安息吧，{playerName}：深处北面，十个。',
  'entities.quests.q_calming_the_deep.completion':
    '你做了我不忍做的事。南边的采集者还在歌唱；因为你，他们能一直唱下去。',
  ...
  'entities.quests.q_spore_hearts.text':
    '孢子人堕入黑暗后，心脏仍靠借来的阴影跳动。四颗这样的心，在圣祠净化后，能让我们弄清侵蚀如何蔓延。这活计残酷，{playerName}，却是修补之工。',
  'entities.quests.q_spore_hearts.completion':
    '好了。净化了，也安静了。每一颗都指向同一处：阴影来自沉没王庭。去告诉塞尔文。',
  ...
  'entities.quests.q_monument_tour.text':
    '封印之前的石碑还立着三座：一座在暮落瞭望台，一座在沉没王庭，还有一座失落在无人行走的东北角。替我读一读它们，{playerName}。我的膝盖两百年前就爬不动台阶了。',
  'entities.quests.q_monument_tour.completion':
    '瞭望台、王庭、被遗忘的角落……封印之歌的三段歌词，自吟唱之日起第一次重聚。你让一个老读者非常快乐。',
  ...
  'entities.quests.q_grove_menace.text':
    '入夜后暮光灵开始在我的摊位间游荡，{playerName}，它们的寒气碰什么坏什么。替我清一清：十只，哪里帷幕破了就去哪里。',
  ...
  'entities.quests.q_shards_of_starfall.text':
    '暮光灵飘过水晶原野时，古老星光的碎屑会像芒刺般附在它们身上。六枚碎片，{playerName}，我就能把封印的年代精确到吟唱的那个季节。',
  'entities.quests.q_shards_of_starfall.completion':
    '看这些纹理！秋天。幽谷是在秋天被封印的。两百年的争论，被六块小石头了结。',
  ...
  'entities.quests.q_treant_accord.text':
    '树荫长者们的根被侵蚀啃噬，外层树皮纷纷剥落。四段树皮，我就能为整片林地熬制药膏。你去撬树皮时它们不会道谢，{playerName}，但它们会因此多站立一个世纪。',
  'entities.quests.q_treant_accord.completion':
    '四段都厚实完好。药膏要熬一个星期，药效要过一百年才算完。树木衡量善意的方式不一样。',
  ...
  'entities.quests.q_spore_tide.text':
    '药膏守住了林地，但每到黄昏，侵蚀就把深处逼得更紧。还要让十二个堕落者安息，采集者们才能夺回北面的蘑菇环，{playerName}。',
  ...
  'entities.quests.q_sunken_court.text':
    '布琳读得没错：裂缝贯穿东边的古老王庭，而它的守卫醒得不对了。它们本是为守护封印而造；如今却会碾碎任何靠近的人。清除废墟中的八座。',
  'entities.quests.q_sunken_court.completion':
    '八座守卫，归于沉寂。我还记得它们被立起来的时候，{playerName}。别这么惊讶；幽谷让它的守护者活得很久。',
  ...
  'entities.quests.q_wardens_echoes.text':
    '主人虽已沉默，王庭的守卫仍在重复它最后的命令，像一道不肯消散的回声。封印一日不归位，它们就会不断苏醒，{playerName}。再平息十座，石匠们才能抵达封印石。',
  'entities.quests.q_wardens_echoes.completion':
    '回声一次比一次微弱。很快王庭就只剩下风和常春藤，废墟本该如此。',
  ...
  'entities.quests.q_waking_warden.text':
    '王庭安静了，它的主人却没有。持守封印的守望者在扭曲中苏醒，它不倒下，封印就无法修复。这一战不会轻松；能找到一个朋友就带上一个，{playerName}。能找到两个就带上两个。',
  'entities.quests.q_waking_warden.completion':
    '它钟鸣般的嗓音沉寂了。我在这里都感觉到了，像有重担从整座山谷卸下。',
  ...
  'entities.quests.q_seal_restored.text':
    '带上守望者之印，去王庭中心的封印石那里，把它放回被击落的位置。那时幽谷便能开始愈合，而你，{playerName}，将完成你的同族从未做到的事。',
  'entities.quests.q_seal_restored.completion':
    '我在这里感觉到它合拢了，温柔如暮色。幽谷会记得它的朋友，{playerName}。无论你走多远，大树下总会为你留一盏灯。',
  ...
  'entities.quests.q_the_codfather.text':
    '鳕鱼教父不只是一条鱼，{playerName}，它是个冷血杀手。老人们发誓说它拿湿地徘徊者当早饭，就连米尔芬寡妇也会因恐惧而不敢在深沼浅滩附近结网。那片水域归它统治，而沼泽水域非得用一根铁轮钓竿不可，我柜台上就有卖。拿上一根，把那个老恶魔从它的水域里拖出来，我就承认你入了这个家族。',
  ...
  'entities.quests.q_nythraxis_graves.text':
    '我以前见过这些标记，就在北方战场周围的三座旧坟上。奥德伦队长葬在西侧高地，马尔里克大祭司在西侧边缘更往南处，皇家刺客沃斯则在东侧峭壁边。触碰每座坟墓并倾听，{playerName}。死者或许记得生者遗忘的事。',
  ...
  'entities.quests.q_nythraxis_sealed_crypt.text':
    '幻象指向东侧峭壁中的废弃墓穴。古老传说称，那座墓穴曾安置一位国王。也许在马尔里克的仪式把他扭曲成不死之物后，荆峰将他封在了下面。进入墓穴，看看里面还剩下什么。',
  ...
  // 优质材料：工具等级高于材料时采集所得（D8）。前缀统一为“优质”。
  ...
  'guide.reliquaryPage.retiredNote':
    '这些圣物已无法再获得。此页致敬仍持有它们的老兵，不计入达成或策展人等级。',
  ...
  'guide.howToPlay.step2Body':
    '红溪元帅正在新手镇等候，手上有一个任务《门前之狼》，附近的工头奥德尔也有活儿要交给你。与两人中的任意一位交谈，即可接下你的第一个任务。',
  ...
  'guide.glossary.readyCheckDef':
    '队长输入 /ready 对小队或团队发起的确认：每个人选择“准备就绪”或“未准备”，全队都会看到统计结果。',
  'guide.glossary.readyCheckTerm': '准备确认',
  'guide.glossary.renownDef':
    '你的功绩累计而成的终身分数。它只增不减，王国会在功绩之书中记录它的排行。',
  ...
  'guide.glossary.worldBossDef':
    '一个以稳定节奏在开放世界中崛起的团队级首领，由闻讯聚集而来的所有人共同讨伐，而非一支固定的队伍。',
  ...
  'guide.combat.queueBody':
    '你不必把按键时机掐到毫厘。当前技能还在施放时按下下一个技能，它便会进入队列，在施法完成的那一刻立即发动，让娴熟的操作行云流水、毫无间隙。一些近战打击也是同理，会随你的下一次武器挥击一并打出。',
  ...
  'guide.gear.itemLevelBody':
    '如果你想快速比较两件装备，可以在选项中开启“显示物品等级”。有明确来源的装备，无论来自敌人、任务还是制作专业，都会显示一个物品等级，一个根据其来源大致衡量强度的单一数值，让你一眼就能看出哪件升级更有分量，即便是不同部位之间也能比较。没有这类来源的物品，比如普通的商人基础货和新手装备，则不显示物品等级，因此没有数值是正常现象，并非缺陷。',
  ...
  'guide.worldPage.marshPlaceNotes':
    '芬桥守着唯一一条干燥的道路。潜行者芦苇荡与深沼浅滩里满是沼泽野兽和泥鳍；寡妇密林被蛛网织得密不透风；溺亡礼拜堂与巨魔土丘藏着更古老的危险，而这片湿地自己的探秘，溺亡连祷，就在土丘以北不远处开放；唤墓者营地是邪教的盘踞之处，沉没堡垒则是这片湿地的副本核心。',
  ...
  'guide.worldPage.duskBlurb':
    '一座笼罩在永恒暮色中的山谷，坐落于古辉巨树之下，水晶废墟泛着微光，空气中回荡着古老的魔力。',
  'guide.worldPage.emberBlurb':
    '一片被风暴照亮、遍布灰烬与血玻璃的荒漠，巨龙在火山口上空盘旋，巨魔的篝火在沙丘间燃烧，由门镇望龙哨守望着。',
  'guide.worldPage.frostBlurb':
    '极光之下，白雪与黑松一片静谧，寒冷本身仿佛苏醒了，唯有冰幔镇的炉火长燃不熄。',
  'guide.worldPage.amberBlurb': '一场永恒的秋天，金红的叶子从不飘落，环绕着灯火通明的灯湖镇。',
  'guide.worldPage.fenBlurb':
    '一片明亮而嗡鸣不息的湿地，睡莲漂浮在缓缓的水面上，从桥镇桥湖镇踏上古旧的木栈道即可穿行其间。',
  'guide.worldPage.nightBlurb':
    '一片星光璀璨的午夜国度，花朵照亮小径，月栖镇在梦境般的夜空下静静守望。',
  'guide.worldPage.hauntBlurb':
    '一片被巨大树冠笼罩的闹鬼森林，路上唯一可信的光亮，便是绞湖镇的灯笼。',
  'guide.worldPage.galeBlurb':
    '海崖与呼啸的丘陵，这里的风从不停歇，老灯塔的火从未熄灭，烛港的家家户户都把门关得严严实实。',
  'guide.worldPage.jungleBlurb':
    '棕榈、白沙与喧闹鸟鸣交织的热带丛林，海滨小镇漂流港在沙滩上燃着一堆长明的篝火。',
  'guide.worldPage.gardenBlurb':
    '一座树篱迷宫般的花园国度，至今仍被修剪得整整齐齐，却无人见过园丁；经由篱苑镇及其喷泉庭院方可进入。',
  'guide.worldPage.emberGreeting':
    '荒漠吹来灼热的风，巨龙盘旋在龙喉火山上空，巨魔的篝火在沙丘间燃烧。出发之前，先喝口水吧。',
  'guide.worldPage.emberGreeter': '守关人，望龙哨',
  'guide.worldPage.frostGreeting':
    '出了墙外，白雪吞没一切声响。若天上的光开始舞动，就压低嗓音，别让火堆熄灭。',
  'guide.worldPage.frostGreeter': '守炉人，冰幔镇',
  'guide.worldPage.amberGreeting':
    '这里每一片叶子都燃烧着金红，却从不飘落。灯笼已为你点亮；上山路过融金隘口时可要当心。',
  'guide.worldPage.amberGreeter': '灯匠，灯湖镇',
  'guide.worldPage.fenGreeting':
    '沼泽里蜻蜓与蜜蜂嗡嗡作响。跨过桥来歇歇脚，过了水池就别离开木栈道。',
  'guide.worldPage.fenGreeter': '守桥人，桥湖镇',
  'guide.worldPage.nightGreeting':
    '越过夜门，连空气都在做梦。沿着花光前行，别忘了留意悬在天上沉睡的世界。',
  ...
  'guide.worldPage.galeGreeting':
    '这里的风从未停过一刻，老灯塔的火也从未熄过一次。进来后记得随手关上旅店的门。',
  'guide.worldPage.galeGreeter': '守塔人，烛港',
  'guide.worldPage.jungleGreeting':
    '温暖的沙滩，喧闹的鸟鸣，还有吞没地平线的丛林。我们在海滩上留着一堆篝火；可要记得回到火边来。',
  ...
  'guide.worldPage.emberPlaceNotes':
    '望龙哨扼守着大门。门林是荒漠前最后一片绿意；烬沙丘随风飘着灰烬，还有更糟的东西；巨魔集会是沙丘巨魔燃起篝火聚集之处；血玻璃原野闪烁着锋利的碎片；而龙喉火山口则是群龙盘旋其上的冒烟王冠。',
  'guide.worldPage.frostPlaceNotes':
    '冰幔镇守着最后一座温暖的炉火。雪线隘口标记着积雪接管一切的地方；冰川湖是冰层之下漆黑而静止的水；极光台阶在舞动的光芒下向上攀升；颤栗沼泽是一片从未真正沉睡的冰封泥沼；而呼啸台地每到夜里都名副其实。',
  'guide.worldPage.amberPlaceNotes':
    '灯湖镇在丰收之地的中心闪着光。融金隘口是那条覆着琥珀的进山之路；鎏金果园与丰收谷藏着最甜的果实和最大胆的窃贼；大湖倒映着燃烧的秋叶；烬枫坡上的枫树最高也最红；而斜碑还记得比秋天更古老的事。',
  ...
  'guide.worldPage.galePlaceNotes':
    '烛港迎风而立。风道是进来的悬崖之路；啸风丘陵在狂风下光秃起伏；老灯塔燃烧的岁月已无人能说清；断崖直落入海；沉船滩让人不敢小看这段海岸；而镜湖是整个国度里唯一静止的东西。',
  'guide.worldPage.junglePlaceNotes':
    '漂流港在海滩上燃着篝火。缠木隘口是大河汇入绿墙之处；棕榈长滩沿着浪缘铺展，洁白而温暖；翠绿丛林与垂藤林吞没了内陆；蓝宝石潟湖清澈而幽深地发着光；而沉没神像则在水下静静注视。',
  'guide.worldPage.gardenPlaceNotes':
    '篱苑镇候在花园之门前。花坛步道绽放着修剪齐整的色彩；晨曦堡在新筑的城墙后操练骑士；花瓣池终年漂着粉色的花瓣；老磨坊在自己的环形花坛上转动；大迷宫会为每一位客人重新排布自己的礼数，拱门有绿叶狐狸守望；北望哨守着出口之路；睡莲池在这一切之外静卧；而喷泉庭院仍在花园中心流淌着清泉。',
  ...
  'guide.worldPage.worldBossBody':
    '在荆峰高地的高处，风暴岩上空的风暴时而会凝聚成形。“觉醒之峰”桑扎尔以稳定的节奏在那里崛起，这是一头在开放世界中由所有响应号召者共同讨伐的团队级元素生物，而与他对峙的挑战者越多，他就越发强大。每一位参战者都能掷得属于自己的一份战利品，按团队副本锁定的规矩结算；他倒下后也会停留足够久，让阵亡者来得及跑尸回来领取应得之物。集结的刀剑，要比你自以为需要的更多。',
  ...
  'hudChrome.auraEffect.varkhulCrucibleExposure':
    '拦截坩埚光束时，每秒受到的最大生命值伤害都会提高。离开光束后，普通难度10秒、英雄难度60秒后重置层数。',
  ...
  'hudChrome.raidBossGuide.varkhul.pyreResponse':
    '让至少{players}名玩家在圆圈内集合，并跟随目标移动直到施法结算。',
  ...
  'hudChrome.raidBossGuide.varkhul.anvil':
    '铁砧敕令: 瓦尔库尔移动到巨型熔炉并敲击三次，造成团队伤害。英雄模式还会落下标记陨石。',
  'hudChrome.raidBossGuide.varkhul.ray':
    '淬火射线: 另一名玩家通常由坦克在长时间预警结束前拦截移动射线。承受伤害者会获得淬火创伤。',
  'hudChrome.raidBossGuide.varkhul.forge':
    '熔炉柱: 在射线抵达熔炉前阻挡，并在坩埚暴露叠加后轮换。热量满时会触发熔炉熔毁。',
  'hudChrome.raidBossGuide.varkhul.assembly':
    '大师组装: 阻挡两道熔炉射线，击杀所有传送门波次，打断坩埚震击，并阻止烬火工匠治疗瓦尔库尔。',
  ...
  'entities.items.vanguard_warrior_arms_helmet.name': '刃痕巨盔',
  'entities.items.vanguard_warrior_arms_shoulder.name': '刃痕肩甲',
  'entities.items.vanguard_warrior_arms_chest.name': '刃痕锁甲衫',
  'entities.items.vanguard_warrior_arms_legs.name': '刃痕板腿甲',
  'entities.items.vanguard_warrior_arms_gloves.name': '刃痕碎击护手',
  'entities.items.vanguard_warrior_fury_helmet.name': '血征面甲',
  'entities.items.vanguard_warrior_fury_shoulder.name': '血征护肩',
  'entities.items.vanguard_warrior_fury_chest.name': '血征链甲',
  'entities.items.vanguard_warrior_fury_legs.name': '血征护腿',
  'entities.items.vanguard_warrior_fury_gloves.name': '血征握套',
  'entities.items.vanguard_warrior_prot_helmet.name': '铁征头盔',
  'entities.items.vanguard_warrior_prot_shoulder.name': '铁征肩铠',
  'entities.items.vanguard_warrior_prot_chest.name': '铁征护胸',
  'entities.items.vanguard_warrior_prot_legs.name': '铁征腿甲',
  'entities.items.vanguard_warrior_prot_gloves.name': '铁征护手甲',
  'entities.items.vanguard_paladin_holy_helmet.name': '日守头环',
  'entities.items.vanguard_paladin_holy_shoulder.name': '日守肩篷',
  'entities.items.vanguard_paladin_holy_chest.name': '日守锁甲衫',
  'entities.items.vanguard_paladin_holy_legs.name': '日守链腿甲',
  'entities.items.vanguard_paladin_holy_gloves.name': '日守手套',
  'entities.items.vanguard_paladin_protection_helmet.name': '盾誓头盔',
  'entities.items.vanguard_paladin_protection_shoulder.name': '盾誓肩甲',
  'entities.items.vanguard_paladin_protection_chest.name': '盾誓胸甲',
  'entities.items.vanguard_paladin_protection_legs.name': '盾誓板腿甲',
  'entities.items.vanguard_paladin_protection_gloves.name': '盾誓护手',
  'entities.items.vanguard_paladin_retribution_helmet.name': '光印冠冕',
  'entities.items.vanguard_paladin_retribution_shoulder.name': '光印肩铠',
  'entities.items.vanguard_paladin_retribution_chest.name': '光印胸铠',
  'entities.items.vanguard_paladin_retribution_legs.name': '光印腿甲',
  'entities.items.vanguard_paladin_retribution_gloves.name': '光印护手',
  'entities.items.vanguard_hunter_beast_mastery_helmet.name': '群守头巾',
  'entities.items.vanguard_hunter_beast_mastery_shoulder.name': '群守肩铠',
  'entities.items.vanguard_hunter_beast_mastery_chest.name': '群守短皮衣',
  'entities.items.vanguard_hunter_beast_mastery_legs.name': '群守腿甲',
  'entities.items.vanguard_hunter_beast_mastery_gloves.name': '群守护手',
  'entities.items.vanguard_hunter_marksmanship_helmet.name': '远见头巾',
  'entities.items.vanguard_hunter_marksmanship_shoulder.name': '远见肩铠',
  'entities.items.vanguard_hunter_marksmanship_chest.name': '远见短皮衣',
  'entities.items.vanguard_hunter_marksmanship_legs.name': '远见腿甲',
  'entities.items.vanguard_hunter_marksmanship_gloves.name': '远见护手',
  'entities.items.vanguard_hunter_survival_helmet.name': '陷牙头巾',
  'entities.items.vanguard_hunter_survival_shoulder.name': '陷牙肩铠',
  'entities.items.vanguard_hunter_survival_chest.name': '陷牙短皮衣',
  'entities.items.vanguard_hunter_survival_legs.name': '陷牙腿甲',
  'entities.items.vanguard_hunter_survival_gloves.name': '陷牙护手',
  'entities.items.vanguard_rogue_assassination_helmet.name': '夜斩风帽',
  'entities.items.vanguard_rogue_assassination_shoulder.name': '夜斩肩垫',
  'entities.items.vanguard_rogue_assassination_chest.name': '夜斩外衣',
  'entities.items.vanguard_rogue_assassination_legs.name': '夜斩马裤',
  'entities.items.vanguard_rogue_assassination_gloves.name': '夜斩手套',
  'entities.items.vanguard_rogue_combat_helmet.name': '斗印风帽',
  'entities.items.vanguard_rogue_combat_shoulder.name': '斗印肩垫',
  'entities.items.vanguard_rogue_combat_chest.name': '斗印外衣',
  'entities.items.vanguard_rogue_combat_legs.name': '斗印马裤',
  'entities.items.vanguard_rogue_combat_gloves.name': '斗印手套',
  'entities.items.vanguard_rogue_subtlety_helmet.name': '影行风帽',
  'entities.items.vanguard_rogue_subtlety_shoulder.name': '影行肩垫',
  'entities.items.vanguard_rogue_subtlety_chest.name': '影行外衣',
  'entities.items.vanguard_rogue_subtlety_legs.name': '影行马裤',
  'entities.items.vanguard_rogue_subtlety_gloves.name': '影行手套',
  'entities.items.vanguard_priest_discipline_helmet.name': '幕颂兜帽',
  'entities.items.vanguard_priest_discipline_shoulder.name': '幕颂肩篷',
  'entities.items.vanguard_priest_discipline_chest.name': '幕颂长袍',
  'entities.items.vanguard_priest_discipline_legs.name': '幕颂护腿',
  'entities.items.vanguard_priest_discipline_gloves.name': '幕颂缠手布',
  'entities.items.vanguard_priest_holy_helmet.name': '恩翼兜帽',
  'entities.items.vanguard_priest_holy_shoulder.name': '恩翼肩篷',
  'entities.items.vanguard_priest_holy_chest.name': '恩翼长袍',
  'entities.items.vanguard_priest_holy_legs.name': '恩翼护腿',
  'entities.items.vanguard_priest_holy_gloves.name': '恩翼缠手布',
  'entities.items.vanguard_priest_shadow_helmet.name': '暮颂兜帽',
  'entities.items.vanguard_priest_shadow_shoulder.name': '暮颂肩篷',
  'entities.items.vanguard_priest_shadow_chest.name': '暮颂长袍',
  'entities.items.vanguard_priest_shadow_legs.name': '暮颂护腿',
  'entities.items.vanguard_priest_shadow_gloves.name': '暮颂缠手布',
  'entities.items.vanguard_shaman_elemental_helmet.name': '风暴律令头巾',
  'entities.items.vanguard_shaman_elemental_shoulder.name': '风暴律令肩甲',
  'entities.items.vanguard_shaman_elemental_chest.name': '风暴律令锁甲衫',
  'entities.items.vanguard_shaman_elemental_legs.name': '风暴律令链腿甲',
  'entities.items.vanguard_shaman_elemental_gloves.name': '风暴律令护手',
  'entities.items.vanguard_shaman_enhancement_helmet.name': '疾风头盔',
  'entities.items.vanguard_shaman_enhancement_shoulder.name': '疾风肩铠',
  'entities.items.vanguard_shaman_enhancement_chest.name': '疾风链甲',
  'entities.items.vanguard_shaman_enhancement_legs.name': '疾风腿甲',
  'entities.items.vanguard_shaman_enhancement_gloves.name': '疾风握套',
  'entities.items.vanguard_shaman_restoration_helmet.name': '潮守头环',
  'entities.items.vanguard_shaman_restoration_shoulder.name': '潮守肩篷',
  'entities.items.vanguard_shaman_restoration_chest.name': '潮守锁甲衫',
  'entities.items.vanguard_shaman_restoration_legs.name': '潮守战裙',
  'entities.items.vanguard_shaman_restoration_gloves.name': '潮守缠手布',
  'entities.items.vanguard_mage_arcane_helmet.name': '缚时者风帽',
  'entities.items.vanguard_mage_arcane_shoulder.name': '缚时者披肩',
  'entities.items.vanguard_mage_arcane_chest.name': '缚时者长袍',
  'entities.items.vanguard_mage_arcane_legs.name': '缚时者长裤',
  'entities.items.vanguard_mage_arcane_gloves.name': '缚时者手套',
  'entities.items.vanguard_mage_fire_helmet.name': '烬鞭兜帽',
  'entities.items.vanguard_mage_fire_shoulder.name': '烬鞭肩篷',
  'entities.items.vanguard_mage_fire_chest.name': '烬鞭法袍',
  'entities.items.vanguard_mage_fire_legs.name': '烬鞭护腿',
  'entities.items.vanguard_mage_fire_gloves.name': '烬鞭手套',
  'entities.items.vanguard_mage_frost_helmet.name': '霜卫风帽',
  'entities.items.vanguard_mage_frost_shoulder.name': '霜卫肩垫',
  'entities.items.vanguard_mage_frost_chest.name': '霜卫祭袍',
  'entities.items.vanguard_mage_frost_legs.name': '霜卫缠腿布',
  'entities.items.vanguard_mage_frost_gloves.name': '霜卫连指手套',
  'entities.items.vanguard_warlock_affliction_helmet.name': '恐羽风帽',
  'entities.items.vanguard_warlock_affliction_shoulder.name': '恐羽肩篷',
  'entities.items.vanguard_warlock_affliction_chest.name': '恐羽长袍',
  'entities.items.vanguard_warlock_affliction_legs.name': '恐羽护腿',
  'entities.items.vanguard_warlock_affliction_gloves.name': '恐羽缠手布',
  'entities.items.vanguard_warlock_demonology_helmet.name': '髓缚兜帽',
  'entities.items.vanguard_warlock_demonology_shoulder.name': '髓缚肩铠',
  'entities.items.vanguard_warlock_demonology_chest.name': '髓缚长袍',
  'entities.items.vanguard_warlock_demonology_legs.name': '髓缚护腿',
  'entities.items.vanguard_warlock_demonology_gloves.name': '髓缚握套',
  'entities.items.vanguard_warlock_destruction_helmet.name': '渣冕风帽',
  'entities.items.vanguard_warlock_destruction_shoulder.name': '渣冕肩篷',
  'entities.items.vanguard_warlock_destruction_chest.name': '渣冕法袍',
  'entities.items.vanguard_warlock_destruction_legs.name': '渣冕护腿',
  'entities.items.vanguard_warlock_destruction_gloves.name': '渣冕手套',
  'entities.items.vanguard_druid_balance_helmet.name': '星卫头饰',
  'entities.items.vanguard_druid_balance_shoulder.name': '星卫肩铠',
  'entities.items.vanguard_druid_balance_chest.name': '星卫背心',
  'entities.items.vanguard_druid_balance_legs.name': '星卫马裤',
  'entities.items.vanguard_druid_balance_gloves.name': '星卫手套',
  'entities.items.vanguard_druid_feral_helmet.name': '血鬃头盔',
  'entities.items.vanguard_druid_feral_shoulder.name': '血鬃肩垫',
  'entities.items.vanguard_druid_feral_chest.name': '血鬃外衣',
  'entities.items.vanguard_druid_feral_legs.name': '血鬃腿甲',
  'entities.items.vanguard_druid_feral_gloves.name': '血鬃握套',
  'entities.items.vanguard_druid_restoration_helmet.name': '蓟花冠冕',
  'entities.items.vanguard_druid_restoration_shoulder.name': '蓟花肩篷',
  'entities.items.vanguard_druid_restoration_chest.name': '蓟花背心',
  'entities.items.vanguard_druid_restoration_legs.name': '蓟花护腿',
  'entities.items.vanguard_druid_restoration_gloves.name': '蓟花手套',
  'entities.items.vanguard_verdict_greatsword.name': '先锋裁决',
  'entities.items.vanguard_oath_blade.name': '先锋誓约',
  'entities.items.vanguard_fang_dagger.name': '先锋之牙',
  'entities.items.vanguard_warstaff.name': '先锋战杖',
  ...
  'entities.itemSets.benison_dawnweave.bonus2':
    '使用低语祈祷、庄严祈祷或紧急祈祷恢复生命值后，下一次圣歌愈疗的治疗量提高10%，最多叠加3层。每次施法最多获得一层。圣歌愈疗完成施法时消耗所有层数。受到伤害不再延迟施法。',
  'entities.itemSets.benison_dawnweave.bonus4':
    '在3层效果下完成圣歌愈疗施法后，60秒内使用的下一次低语祈祷变为瞬发，治疗量提高100%。此效果不叠加；再次获得时刷新持续时间。',
  ...
  'entities.itemSets.vanguard_warrior_arms.name': '刃痕战装',
  'entities.itemSets.vanguard_warrior_arms.bonus2': '致残打击使突进的剩余冷却时间缩短 1 秒。',
  'entities.itemSets.vanguard_warrior_arms.bonus4':
    '突进还会使你的下一次致残打击强化 20%（1 层血手强化）。',
  'entities.itemSets.vanguard_warrior_fury.name': '血征怒装',
  'entities.itemSets.vanguard_warrior_fury.bonus2': '英勇飞跃的冷却时间缩短 8 秒。',
  'entities.itemSets.vanguard_warrior_fury.bonus4': '英勇飞跃落地时使你激怒。',
  'entities.itemSets.vanguard_warrior_prot.name': '铁征壁垒',
  'entities.itemSets.vanguard_warrior_prot.bonus2': '地裂的冷却时间缩短 5 秒。',
  'entities.itemSets.vanguard_warrior_prot.bonus4': '地裂还会使你受到的伤害降低 10%，持续 6 秒。',
  'entities.itemSets.vanguard_paladin_holy.name': '日守华服',
  'entities.itemSets.vanguard_paladin_holy.bonus2': '生命契约的冷却时间缩短 30 秒。',
  'entities.itemSets.vanguard_paladin_holy.bonus4':
    '生命契约还会为该盟友提供相当于其最大生命值 8% 的护盾，持续 6 秒。',
  'entities.itemSets.vanguard_paladin_protection.name': '盾誓堡垒',
  'entities.itemSets.vanguard_paladin_protection.bonus2': '誓约锁链的冷却时间缩短 2 秒。',
  'entities.itemSets.vanguard_paladin_protection.bonus4':
    '被誓约锁链拉动的敌人施法速度降低 30%，持续 4 秒；当誓约锁链束缚一个可被拉动的敌人时，还会使你获得烈阳反击。',
  'entities.itemSets.vanguard_paladin_retribution.name': '光印战甲',
  'entities.itemSets.vanguard_paladin_retribution.bonus2': '瓦尔基里的召唤的冷却时间缩短 15 秒。',
  'entities.itemSets.vanguard_paladin_retribution.bonus4':
    '瓦尔基里的召唤会重置终末敕令的冷却时间，且落地后 6 秒内的下一次终末敕令造成的伤害提高 15%。',
  'entities.itemSets.vanguard_hunter_beast_mastery.name': '群守猎装',
  'entities.itemSets.vanguard_hunter_beast_mastery.bonus2': '震颤射击的冷却时间缩短 4 秒。',
  'entities.itemSets.vanguard_hunter_beast_mastery.bonus4':
    '震颤射击使狂野怒火的剩余冷却时间缩短 1 秒。',
  'entities.itemSets.vanguard_hunter_marksmanship.name': '远见猎装',
  'entities.itemSets.vanguard_hunter_marksmanship.bonus2': '断迹的冷却时间缩短 4 秒。',
  'entities.itemSets.vanguard_hunter_marksmanship.bonus4':
    '断迹使你在 6 秒内的下一次引弓长射变为瞬发。每 15 秒最多触发一次。',
  'entities.itemSets.vanguard_hunter_survival.name': '陷牙猎装',
  'entities.itemSets.vanguard_hunter_survival.bonus2': '血钩的冷却时间缩短 3 秒。',
  'entities.itemSets.vanguard_hunter_survival.bonus4': '血钩提供 1 点狩猎势能。',
  'entities.itemSets.vanguard_rogue_assassination.name': '夜斩皮甲',
  'entities.itemSets.vanguard_rogue_assassination.bonus2': '下作一击的能量消耗降低 10 点。',
  'entities.itemSets.vanguard_rogue_assassination.bonus4':
    '下作一击还会使你在 6 秒内的下一次攻击必定暴击。',
  'entities.itemSets.vanguard_rogue_combat.name': '斗印皮甲',
  'entities.itemSets.vanguard_rogue_combat.bonus2': '疾足的冷却时间缩短 60 秒。',
  'entities.itemSets.vanguard_rogue_combat.bonus4':
    '疾足生效期间，邪恶斩击和大摆拳额外提供 1 个连击点数。',
  'entities.itemSets.vanguard_rogue_subtlety.name': '影行皮甲',
  'entities.itemSets.vanguard_rogue_subtlety.bonus2': '烟遁的冷却时间缩短 60 秒。',
  'entities.itemSets.vanguard_rogue_subtlety.bonus4':
    '在烟遁状态下使用击腹拳时，额外提供 2 个连击点数。',
  'entities.itemSets.vanguard_priest_discipline.name': '幕颂衣装',
  'entities.itemSets.vanguard_priest_discipline.bonus2': '心灵尖啸的冷却时间缩短 3 秒。',
  'entities.itemSets.vanguard_priest_discipline.bonus4':
    '你的守护圣咏被完全消耗时，受护盟友的移动速度提高 20%，持续 3 秒。每 8 秒最多触发一次。',
  'entities.itemSets.vanguard_priest_holy.name': '恩翼衣装',
  'entities.itemSets.vanguard_priest_holy.bonus2': '帷幕步的冷却时间缩短 6 秒。',
  'entities.itemSets.vanguard_priest_holy.bonus4':
    '帷幕步还会为你提供相当于你最大生命值 8% 的护盾，持续 6 秒。',
  'entities.itemSets.vanguard_priest_shadow.name': '暮颂华服',
  'entities.itemSets.vanguard_priest_shadow.bonus2':
    '悲苦连祷在你引导期间还会使目标的移动速度降低 30%。',
  'entities.itemSets.vanguard_priest_shadow.bonus4':
    '召唤什一魔还会为你提供相当于你最大生命值 10% 的护盾，持续 8 秒。',
  'entities.itemSets.vanguard_shaman_elemental.name': '风暴律令战锁甲',
  'entities.itemSets.vanguard_shaman_elemental.bonus2': '释放武器的冷却时间缩短 3 秒。',
  'entities.itemSets.vanguard_shaman_elemental.bonus4':
    '释放武器使你可以在移动中施法，并使你的移动速度提高 20%，持续 4 秒。每 20 秒最多触发一次。',
  'entities.itemSets.vanguard_shaman_enhancement.name': '疾风战链甲',
  'entities.itemSets.vanguard_shaman_enhancement.bonus2':
    '先祖打击使目标的移动速度降低 30%，持续 4 秒。',
  'entities.itemSets.vanguard_shaman_enhancement.bonus4':
    '先祖打击使元素恍惚的剩余冷却时间缩短 4 秒。',
  'entities.itemSets.vanguard_shaman_restoration.name': '潮守链甲',
  'entities.itemSets.vanguard_shaman_restoration.bonus2':
    '对生命值低于 50% 的盟友施放治愈之水时，施法时间缩短 0.5 秒。',
  'entities.itemSets.vanguard_shaman_restoration.bonus4':
    '潮汐召唤还会为其目标提供相当于你最大生命值 5% 的护盾，持续 6 秒。',
  'entities.itemSets.vanguard_mage_arcane.name': '缚时者圣袍',
  'entities.itemSets.vanguard_mage_arcane.bonus2': '时光屏障的冷却时间缩短 2 秒。',
  'entities.itemSets.vanguard_mage_arcane.bonus4':
    '时光屏障还会使受护目标的移动速度提高 20%，持续 3 秒。',
  'entities.itemSets.vanguard_mage_fire.name': '烬鞭华服',
  'entities.itemSets.vanguard_mage_fire.bonus2': '余烬坠的充能恢复速度加快 3 秒。',
  'entities.itemSets.vanguard_mage_fire.bonus4': '施放余烬坠会使炽热屏障的剩余冷却时间缩短 2 秒。',
  'entities.itemSets.vanguard_mage_frost.name': '霜卫装束',
  'entities.itemSets.vanguard_mage_frost.bonus2': '冰缚的冷却时间缩短 2 秒。',
  'entities.itemSets.vanguard_mage_frost.bonus4': '施放冰缚会使轻掠步的剩余冷却时间缩短 5 秒。',
  'entities.itemSets.vanguard_warlock_affliction.name': '恐羽圣袍',
  'entities.itemSets.vanguard_warlock_affliction.bonus2': '惊惧的施法时间缩短 0.3 秒。',
  'entities.itemSets.vanguard_warlock_affliction.bonus4':
    '吞噬的治疗效果提高 30%，并且可以在移动中引导。',
  'entities.itemSets.vanguard_warlock_demonology.name': '髓缚华服',
  'entities.itemSets.vanguard_warlock_demonology.bonus2': '骸骨护甲的冷却时间缩短 10 秒。',
  'entities.itemSets.vanguard_warlock_demonology.bonus4':
    '收割号令使骸骨护甲的剩余冷却时间缩短 2 秒。',
  'entities.itemSets.vanguard_warlock_destruction.name': '渣冕圣袍',
  'entities.itemSets.vanguard_warlock_destruction.bonus2': '熔渣皮肤的冷却时间缩短 30 秒。',
  'entities.itemSets.vanguard_warlock_destruction.bonus4':
    '每施放两次燃尽，你在 8 秒内的下一次毁灭箭变为瞬发。',
  'entities.itemSets.vanguard_druid_balance.name': '星卫衣装',
  'entities.itemSets.vanguard_druid_balance.bonus2': '缠握根须的施法时间缩短 0.5 秒。',
  'entities.itemSets.vanguard_druid_balance.bonus4':
    '施放缠握根须使你可以在移动中施法，并使你的移动速度提高 20%，持续 4 秒。每 20 秒最多触发一次。',
  'entities.itemSets.vanguard_druid_feral.name': '血鬃兽皮甲',
  'entities.itemSets.vanguard_druid_feral.bonus2': '巨熊冲锋的冷却时间缩短 3 秒。',
  'entities.itemSets.vanguard_druid_feral.bonus4':
    '巨熊冲锋为你提供相当于你最大生命值 6% 的护盾，持续 6 秒。',
  'entities.itemSets.vanguard_druid_restoration.name': '蓟花祭袍',
  'entities.itemSets.vanguard_druid_restoration.bonus2': '迅捷治愈的冷却时间缩短 1 秒。',
  'entities.itemSets.vanguard_druid_restoration.bonus4':
    '迅捷治愈还会使你的移动速度提高 30%，持续 3 秒。',
  ...
  'entities.letters.woc_market_delivery.body':
    '交易已结清，货物归你所有。随信的包裹装着你所购买的那一件物品：自挂单之时起，它便由交易所托管，直到你的付款结清为止。\n\n这笔交易的记录已存入交易所账册。\n\n- 交易所经纪人',
  ...
  'entities.letters.woc_market_return.body':
    '你的挂单结束，交易未能完成：拍卖无人问津、底价未达、挂单被撤回，或中标者未能付款。你的货物随信原样奉还，与托管之时分毫不差。\n\n- 交易所经纪人',
  ...
  'entities.letters.woc_market_sold.body':
    '你的挂单已售出，买家已足额付款。所得款项在结算交易中直接汇入你绑定的钱包（已扣除交易所费用）；交易所从未经手你的钱款。\n\n这笔交易的记录已存入交易所账册。\n\n- 交易所经纪人',
  ...
  'hudChrome.wocMarket.bidCloseNote':
    '若某笔出价的保证金在最后 2 分钟内获得确认，拍卖会延长到该出价后 2 分钟，最多延至原定结束后 30 分钟。拍卖结束后才确认的保证金不计入，并会退款。',
  'hudChrome.wocMarket.offerNextNote':
    '若中标者未付款，你可能按自己的出价成为买家：保证金会再次被冻结（若已退还则会再次收取），且须在 {duration} 内付款。',
  'hudChrome.wocMarket.buyNowNote':
    '“立即购买”会在你付款期间为你保留这份挂单约四分半钟。若未按时付款，30 分钟内你无法再次尝试这份挂单；一小时内三次未付款的“立即购买”会暂停你的“立即购买”，直到最早的一次满一小时。',
  ...
  'hudChrome.wocMarket.sellFeeNote':
    '成交后会从价格中扣除交易所手续费：一部分销毁，一部分进入国库，其余随结算交易进入你绑定的钱包。你输入价格后，对应的手续费会显示在这里；拍卖的手续费按最终成交价计算。',
  ...
  'hudChrome.archetypePair.tailoring+inscription': '织墨师',
  ...
  'guide.economy.bankSockets':
    '在格位阶梯之上，司库还出售最多四个背包插槽，按顺序解锁，价格逐级走高。把携带的闲置背包装入插槽，它的格位便并入保险库空间：普通背包扩充整个仓储，而材料袋只为制作材料增添空间。点击背包栏中的背包即可装入，点击插槽即可取回。取回背包绝不会损失任何存放之物：若保险库因此超出缩减后的空间，一切物品原地保留，新的存入只需等待腾出空间。',
  ...
  'hudChrome.bank.vaultSearchAria': '按名称搜索仓库材料',
  'hudChrome.bank.vaultSearchNoMatch': '仓库中没有与搜索匹配的材料。',
  'hudChrome.bank.vaultLockedIntro':
    '解锁材料仓库，在银行旁囤积制造材料。每种材料都有自己的空间，最多可存{cap}个。',
  ...
  'hudChrome.bank.vaultDepositAllTooltip':
    '一次性将背包中的所有材料存入仓库，每种材料存至其上限为止。装备、工具、任务物品和消耗品不会被移动。',
  ...
  'hudChrome.epic.benefits':
    '在 Epic 桌面客户端中关联你的 Epic 账号，将你获得的功绩同步为 Epic 成就。',
  ...
  'guide.bestiary.flavor.sethrael_palecoil':
    '一条骨色苍白的巨蛇，游弋于微光湖的深处暗礁，是它所占据水域的沉默守卫。与它共享此湖的泅水者，鲜有能再浮出水面的。',
  'guide.combat.metersBody':
    '想知道一场战斗打得如何？按 Shift+H 打开小队仪表盘，它会逐场统计你队伍的伤害、治疗与威胁。',
  ...
  'guide.glossary.metersDef':
    '当前战斗的小队记分板窗口：造成的伤害、完成的治疗，以及谁承受着最高威胁，均按遭遇战分别记录。用其快捷键打开（默认为 Shift+H）。',
  'guide.glossary.metersTerm': '伤害统计',
  'guide.glossary.petBarDef':
    '猎人或术士的宠物会额外添加的指令栏：攻击、停止、嘲讽、防御和主动，默认绑定为 Ctrl 加 1 到 5。',
  'guide.glossary.petBarTerm': '宠物栏',
  'guide.glossary.restedDef':
    '你的角色在客栈中脱离战斗休息时积攒的奖励经验。接下来的击杀会获得额外经验，直到这池经验耗尽。',
  ...
  'hudChrome.auraEffect.benisonPrayers': '下一次圣歌愈疗的治疗量提高{pct}%，并消耗所有层数。',
  'hudChrome.auraEffect.benisonWhisper':
    '下一次低语祈祷变为瞬发，治疗量提高{pct}%。请在此效果结束前使用。',
  ...
  'entities.abilities.cone_of_cold.description':
    '以寒霜冲击附近的敌人，造成 {damage} 点冰霜伤害。（冰霜专精标志技能）',
  ...
  'devCommand.actions.hillend.description': '让当前的山丘立即消失。',
  'devCommand.actions.hillend.label': '结束山丘',
  'devCommand.actions.hillnow.description': '立即升起一座山丘并站在上面。',
  'devCommand.actions.hillnow.label': '立即升起山丘',
  'devCommand.actions.hillrise.description': '让已通告的山丘立即升起。',
  'devCommand.actions.hillrise.label': '跳过山丘倒计时',
  'devCommand.actions.hillwarn.description': '立即通告一座山丘；完整的预警结束后它会升起。',
  ...
  'entities.npcs.forgemistress_darva.name': '达尔瓦锻造师',
  'entities.npcs.forgemistress_darva.title': '熔炉大师',
  'entities.npcs.forgemistress_darva.greeting':
    '熔炉听我的话，{className}。带来好矿石，它也会听你的。',
  'entities.npcs.cook_marlow.name': '马洛厨师',
  ...
  'entities.npcs.tinker_gizzel.name': '吉泽尔修补匠',
  'entities.npcs.tinker_gizzel.title': '工坊大师',
  'entities.npcs.tinker_gizzel.greeting':
    '弹簧、齿轮、锋利的刃口，{className}：你手上缺什么，工坊里就有什么。',
  'entities.npcs.tanner_hesk.name': '赫斯克制革匠',
  'entities.npcs.tanner_hesk.title': '制革坊大师',
  'entities.npcs.tanner_hesk.greeting': '皮子的好坏全看鞣制，{className}。鞣槽已经备好，就等你了。',
  'entities.npcs.alchemist_verane.name': '韦兰炼金术士',
  ...
  'hudChrome.professions.toolEffectRechargeToolCapped':
    '携带更好的{profession}工具才能继续为{effect}充能。',
  ...
  'hudChrome.professions.toolEffectConfirmBody':
    '本次采集消耗 1 次充能（剩余 {charges} 次）？拒绝后仍会采集，只是没有加成。',
  ...
  'hudChrome.reliquary.sharedUniquesNote':
    '总计中每件圣物只计一次；书架与页面的数字按格位统计，出现在多个页面上的圣物会被每个页面分别计入。',
  ...
  // Professions 2.0 attunement quests + master tier letters (zh_CN M16 fills).
  ...
  'guide.profPages.craftIntro.weaponcrafting':
    '武器锻造是东溪锻造坊的兵器台：斧、锤、刃、矛，乃至法师的法杖，从铜制入门武器一路到精良的锇金与铭钢之作。武器是每个等级段最有感的单件升级，所以武器锻造者是人人都记得结交的朋友。',
  'guide.profPages.craftIntro.armorcrafting':
    '护甲锻造锤出锁甲，那是工匠能打造的最重护甲，从铆接铜甲基础款到精良的锇鳞套装，旁边还有两件法系属性件。它的客户是那些站在挨打最前线的人。',
  'guide.profPages.craftIntro.tailoring':
    '裁缝织就施法者赖以生存的智力与精神布甲，从家纺基础款经鎏金织套装爬到精良的日织系列，并缝制Silkspun Satchel，一只十格背包，没有人会拒绝。',
  ...
  'guide.profPages.craftProse.tailoring.ladderBody':
    '两件野外普通件（Eastbrook Wool Trousers与Ritual Vestments）随处可做。训练师梯子在Eastbrook水井南侧的织机：homespun档技能0免费，鎏金织档（含Silkspun Satchel）技能25每个25银，精良档技能50每个1金。\n\nWardweave Cowl无需训练师：人人都会，但要技能75且绑定织机，是本行业的三层压轴。如同其他行业，Ottilie在你的裁缝档位达到配方档位的那一刻便会传授。',
  ...
  'hudChrome.cooldownManager.intro':
    '为你选择的法术显示浮动按钮。按钮不可点击：每个按钮显示冷却时间，无法施放时变暗，就绪时亮起。',
  ...
  'hudChrome.cooldownManager.combatOnly': '仅在战斗中播放声音',
  'hudChrome.cooldownManager.dragHint':
    '此菜单打开时，所有分组都会显示在屏幕上，你可以拖动它们来移动位置。',
  'hudChrome.cooldownManager.addSingle': '添加单个按钮',
  'hudChrome.cooldownManager.addGrid': '添加按钮组',
  'hudChrome.cooldownManager.addLine': '添加法术条',
  'hudChrome.cooldownManager.groupsFull': '分组数量已达上限。删除一个分组后才能添加新的。',
  'hudChrome.cooldownManager.noGroups': '添加一个单独按钮、一组按钮或一条法术条来开始。',
  'hudChrome.cooldownManager.groupSingle': '单个按钮 {index}',
  'hudChrome.cooldownManager.groupGrid': '按钮组 {index}',
  'hudChrome.cooldownManager.groupLine': '法术条 {index}',
  'hudChrome.cooldownManager.groupName': '组名称',
  'hudChrome.cooldownManager.spellCount': '{count} / {max} 个法术',
  'hudChrome.cooldownManager.orientation': '方向',
  ...
  'hudChrome.cooldownManager.dirRight': '向右',
  'hudChrome.cooldownManager.dirLeft': '向左',
  'hudChrome.cooldownManager.dirDown': '向下',
  'hudChrome.cooldownManager.dirUp': '向上',
  ...
  'hudChrome.cooldownManager.visHiddenHint': '隐藏的分组仍会播放声音并点亮你的动作条。',
  ...
  'hudChrome.cooldownManager.deleteGroup': '删除分组',
  'hudChrome.cooldownManager.deleteGroupAria': '删除{group}',
  'hudChrome.cooldownManager.trackedTitle': '追踪的法术',
  ...
  'hudChrome.cooldownManager.aurasTitle': '触发、引擎与增益',
  'hudChrome.cooldownManager.aurasHint':
    '引擎资源及其层数、触发效果，以及你的法术施加在你身上的增益。其他曾出现在你身上的效果也会显示在这里。',
  'hudChrome.cooldownManager.auraFallback': '光环',
  'hudChrome.cooldownManager.onlyWhileActive': '仅在生效时显示',
  ...
  'hudChrome.cooldownManager.alertStacksHint':
    '光环达到此层数时，按钮会亮起、闪烁并发出提示音。“获得时”表示一出现就提醒。',
  'hudChrome.cooldownManager.auraSoundHint': '光环出现时，或达到你设定的层数时播放。',
  ...
  'hudChrome.cooldownManager.group': '分组',
  'hudChrome.cooldownManager.groupFullOption': '{group}（已满）',
  'hudChrome.cooldownManager.notInGroupHint': '将此法术放入一个分组以显示它的按钮。',
  'hudChrome.cooldownManager.moveEarlier': '将{spell}前移',
  'hudChrome.cooldownManager.moveLater': '将{spell}后移',
  'hudChrome.cooldownManager.glowWhenReady': '就绪时亮起',
  'hudChrome.cooldownManager.glowWhenReadyHint': '法术可以施放时，按钮会变亮并显示边框。',
  'hudChrome.cooldownManager.hotbarGlow': '快捷栏高亮',
  'hudChrome.cooldownManager.hotbarGlowHint': '法术就绪时，同时点亮它在动作条上的按钮。',
  'hudChrome.cooldownManager.onlyWhenReady': '仅在就绪时显示',
  'hudChrome.cooldownManager.sound': '就绪音效',
  'hudChrome.cooldownManager.soundHint': '法术就绪时，或按钮在就绪状态下变为另一个法术时播放。',
  ...
  'hudChrome.trade.woc.hintGoldOffered':
    '请先移除你的金币报价：一笔交易只能用金币或 $WOC，不能兼有。',
  ...
  'guide.arenaPage.vanguardHeading': '先锋装备：战争第二赛季',
  'guide.arenaPage.vanguardBody':
    '先锋装备是战争装备的第二赛季，由同样的两位军需官出售，陈列在原有装备之上，原有装备也继续出售。每个专精都有自己的一套五件先锋套装，包括头部、肩部、胸部、腿部和手部，商店只会列出你的职业能穿的三套，以及你能使用的先锋武器。先锋装备带有与原有装备相同的战争等级，但物品等级更高；每套都有两件和四件两档奖励，会改变你专精的一个技能。与原有套装不同，这些奖励在任何地方都生效，对怪物也一样，但它们是为对抗玩家而设计的，所以在团队副本里，团队套装仍是更好的选择。',
  ...
  'guide.interfacePage.framesGovernedUnitTooltip':
    '“编辑框体”也会松开提示框体，也就是鼠标停留对象的卡片显示位置：生物的等级和类型，或其他玩家的头衔、公会、等级、职业，以及带职责的专精。把它拖到任意位置，卡片会从那里展开，并避开最近的屏幕边缘。在框体设置的“显示或隐藏框体”中取消勾选“提示框”，即可完全隐藏该卡片。',
  ...
  'hudChrome.mapAtlas.collapseHint': '折叠地图侧栏',
