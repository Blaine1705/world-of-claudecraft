...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.crossHotbarEditHint': '整理中：确认键拿起一个技能并放到下一个格子，取消键清空格子。',
  ...
  'hudChrome.controller.crossHotbarExpandHelp': '按住一个扳机键时轻按另一个扳机键，即可切换到第二组。',
  'hudChrome.controller.crossHotbarSetPrimary': '第一组',
  'hudChrome.controller.crossHotbarSetExpanded': '第二组',
  'hudChrome.controller.crossHotbarResetLayout': '重置十字热键栏',
  'hudChrome.controller.crossHotbarSlot': '动作条 {slot}',
  'hudChrome.controller.crossHotbarOverlay': '十字热键栏',
