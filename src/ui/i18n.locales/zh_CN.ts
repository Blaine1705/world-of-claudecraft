...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.realmSubtitle': '{realm} 服务器',
  ...
  'playerCard.shareText':
    '我正在 World of ClaudeCraft 中铸就传说：{level}级 {className}{tierBit}。加入我的服务器：',
  ...
  'entities.abilities.flash_of_light.description':
    '快速而高效的圣光，为一个友方目标恢复 {damage} 点生命值。',
  ...
  'entities.abilities.swipe.description':
    '横扫附近敌人，造成 {damage} 点伤害。造成额外威胁值。仅限熊形态。',
  ...
  'entities.abilities.summon_succubus.description':
    '召唤一只听从术士命令的魅魔。魅魔是一种脆弱的恶魔，会快速出手并在近战中造成重创。召唤新的恶魔会驱散你当前的恶魔。你同时只能拥有一只恶魔。',
  'entities.abilities.summon_felhunter.name': '召唤地狱猎犬',
  'entities.abilities.summon_felhunter.description':
    '召唤一只听从术士命令的地狱猎犬。地狱猎犬会用暗影撕咬从远处骚扰敌人，擅长猎杀施法者。召唤新的恶魔会驱散你当前的恶魔。你同时只能拥有一只恶魔。',
  'entities.abilities.summon_felguard.name': '召唤恶魔卫士',
  'entities.abilities.summon_felguard.description':
    '召唤一只听从术士命令的恶魔卫士。恶魔卫士是一种坚韧的近战恶魔，会冲入战斗并独当一面。召唤新的恶魔会驱散你当前的恶魔。你同时只能拥有一只恶魔。',
  'entities.abilities.summon_infernal.name': '召唤地狱火',
  'entities.abilities.summon_infernal.description':
    '将一只地狱火束缚于你的意志之下——这是一头庞大的破坏巨兽，拥有毁灭性的近战能力，以及所有恶魔中最深厚的生命与护甲。漫长的冷却时间限制了它的原始威力。召唤新的恶魔会驱散你当前的恶魔。你同时只能拥有一只恶魔。',
  'entities.abilities.summon_doomguard.name': '召唤末日守卫',
  'entities.abilities.summon_doomguard.description':
    '将一只末日守卫束缚于你的意志之下——这是一种精英恶魔，会从远处倾泻沉重的暗影伤害。漫长的冷却时间限制了它的毁灭性威力。召唤新的恶魔会驱散你当前的恶魔。你同时只能拥有一只恶魔。',
  ...
  'entities.quests.q_spiders.text':
    '网木潜伏者的丝能做药敷，但它们已经太多。杀死6只，再取4枚丝腺。',
  ...
  'entities.quests.q_murlocs.text':
    '我在镜湖打了二十年鱼，直到那些鱼人爬出浅滩。击退8个泥鳍潜伏者，小心它们成群而来。',
  ...
  'entities.quests.q_mine.text':
    '我们刚挖到好铜脉，地道鼠就从山坡里涌出来。放倒10个地道鼠掘地者，让矿工回去开工。',
  ...
  'entities.quests.q_rite.text':
    '必须开启礼拜堂下的墓穴，但只有束缚仪式能让生者通过。我需要4块祝福油脂和6份幽魂精华。',
  ...
  'entities.quests.q_gravecallers_trail.completion':
    '莫森写信给北方湿地的一名唤雾者。{playerName}，教派并未死去，只是在等待。',
  ...
  'entities.quests.q_fenbridge_muster.text':
    '莫森的书信提到北方沼泽里有一位主人。{playerName}，取下芬桥门柱上的集结令，交给守望者。',
  ...
  'entities.quests.q_deepfen.text':
    '深沼鱼人二十年都待在浅滩，如今却从湖底拖东西上来。击杀12个钳咬鱼人。',
  ...
  'entities.quests.q_deepfen_purge.text':
    '这些神像是邪教造物，鱼人正一捧一捧把湿地旧恶挖上来。回浅滩再杀14个。',
  ...
  'entities.quests.q_summoners.completion':
    '每份密文都由执事沃斯副署，并递往堡垒里的唤雾者。莫森的主人，{playerName}，我们找到他了。',
  ...
  'entities.quests.q_bastion_door.text':
    '沉没堡垒就是唤雾者唱颂溺水圣歌的地方。邪教用墓石封住门，{playerName}，带回一块护符石。',
  ...
  'entities.quests.q_olen.text':
    '奥伦守着堡垒直到沉没，如今却被唤雾者当傀儡守门。这耻辱该结束了，{playerName}。带四名同伴下去，给他应得的安息。',
  ...
  'entities.quests.q_mistcaller.text':
    '维尔在堡垒底部等待，他的声音淹死百名旅人来筑军。带四名同伴，终结他，{playerName}。',
  ...
  'entities.quests.q_glowing_wax.text':
    '凯迪斯给我看了一支从掘地者身上拿来的蜡，{playerName}，发光又温热如心跳。带回6块发光蜡块。',
  ...
  'entities.npcs.warden_coalfast.greeting': '裂隙才不管鸥港有多小，{className}。我们守住这片海岸，否则就再没有海岸可守。与我们并肩而战，我不会忘记你的付出。',
  'entities.npcs.riftwatch_ollun.name': '裂察·奥伦',
  'entities.npcs.riftwatch_ollun.title': '裂隙学者',
  'entities.npcs.riftwatch_ollun.greeting': '每道裂隙开启之前都会歌唱，只要你有听它的耳朵。此刻我能听见岛上三道裂隙正在骚动，其中一道就在近处。',
  'entities.npcs.quartermaster_edda.name': '军需官·艾达',
  'entities.npcs.quartermaster_edda.title': '堡垒军械师',
  'entities.npcs.quartermaster_edda.greeting': '钢铁与海盐，{className}，这就是我还能发给你的全部了。拿上它，让那些裂隙后悔在我够得着的地方裂开。',
  'entities.npcs.mender_saul.name': '疗愈者·索尔',
  'entities.npcs.mender_saul.title': '战地外科医',
  'entities.npcs.mender_saul.greeting': '这一个月里我接的骨头，比过去十年医治渔民跌伤加起来还多。裂隙夺走的东西，很少留下什么。若你办得到，就囫囵着回来见我。',
  'entities.npcs.bellkeeper_tam.name': '守钟人·塔姆',
  'entities.npcs.bellkeeper_tam.title': '警钟守',
  'entities.npcs.bellkeeper_tam.greeting': '这口钟，是裂隙留给我们的唯一预警，{className}。一声,是田野;两声,是断崖;三声,便是它已近得逃也无用。留心听着,它或许能保你全身。',
  'entities.npcs.fisher_nell.name': '受惊的奈尔',
  'entities.npcs.fisher_nell.title': '鸥港渔民',
  'entities.npcs.fisher_nell.greeting': '它就在晾网的地方裂开了。就在那儿，我这辈子每天清晨都站着的地方。我再也不下到海岸去了。如今我哪儿都不太去了。',
  ...
  'entities.zones.eastbrook_vale.pois.10.label': '远岸沙洲堤道',
  ...
  'entities.items.kingsbane_last_oath.name': '弑王者，荆峰的最后誓言',
  'entities.items.crownforged_dreadhelm.name': '铸冠恐惧头盔',
  'entities.items.crownforged_warspaulders.name': '铸冠战肩甲',
  'entities.items.nighttalon_crown.name': '夜爪之冠',
  'entities.items.nighttalon_shoulderguards.name': '夜爪护肩',
  'entities.items.soulflame_cowl.name': '魂焰兜帽',
  'entities.items.soulflame_mantle.name': '魂焰披肩',
  'entities.items.stormcallers_crown.name': '唤雷者之冠',
  ...
  'guide.home.world.marshBlurb': '沉没的沼泽与遭潮水侵蚀的废墟,鱼人与更可怕之物的栖身之所。',
  ...
  'guide.home.faq.a3': '可以。浏览器中有即开即玩的单人模式,此外还有共享的在线服务器。',
  'guide.home.faq.q4': '升到满级要多久?',
  'guide.home.faq.a4': '等级上限为 {cap} 级,需横跨三大区域,通过任务、地下城与探索逐步达成。',
  'guide.home.community.heading': '加入这片国度',
  ...
  'guide.howToPlay.onlineBody':
    '在共享的在线服务器与其他所有人一同游玩,或在浏览器中开启一个即开即玩的离线世界来熟悉门道。',
  ...
  'guide.family.kobold.desc': '头顶蜡烛的掘地者，在矿洞与地穴中繁衍，凶狠地守护着自己的矿石。',
  ...
  'guide.abilityHook.divine_protection': '一道快速的神圣护盾，在局势吃紧时吸收伤害。',
  ...
  'guide.abilityHook.seal_of_righteousness': '为你的挥击附加神圣伤害，再用审判将其释放出去。',
  ...
  'guide.abilityHook.summon_imp': '召唤一只小鬼，从远处向敌人投掷火焰箭。',
  ...
  'guide.petHook.doomguard': '一只精英施法者，从远处倾泻沉重的暗影伤害。',
  'guide.petHook.felguard': '一名耐打的近战猛士，能召唤它之后就是全能的选择。',
  'guide.petHook.felhunter': '一名暗影游击手，专门纠缠敌方施法者。',
  'guide.petHook.imp': '一只远程火焰箭恶魔，从安全距离外消磨敌人。',
  'guide.petHook.infernal': '一头近战极具破坏力的庞然巨兽，为追求纯粹的力量而召唤。',
  'guide.petHook.succubus': '一只快速的近战恶魔，输出凶猛，但承压能力很差。',
  'guide.petHook.voidwalker': '一只结实的恶魔，能嘲讽并吸收伤害，让你安心施法。',
  'guide.related': '相关内容',
  ...
  'guide.bestiary.flavor.mirejaw_frenzy':
    '一只沼泽鱼人，会在战斗中将自己鞭策进狂乱的扑腾，是一支喧闹而极具地盘意识的鱼群中嗓门最大的那个。',
  ...
  'guide.worldPage.marshPlaceNotes':
    '芬桥守着唯一一条干燥的道路。潜行者芦苇荡与深沼浅滩里满是沼泽野兽和鱼人；寡妇密林被蛛网织得密不透风；溺亡礼拜堂与巨魔土丘藏着更古老的危险；唤墓者营地是邪教的盘踞之处，沉没堡垒则是这片湿地的副本核心。',
  ...
  'hudChrome.auraEffect.imbueRange': '武器已附魔：审判时附加 {min} 到 {max} 点额外伤害',
  'hudChrome.auraEffect.stealth': '已隐匿；移动速度降低 {pct}%',
  'hudChrome.auraEffect.formBear': '熊形态：生命值和护甲提高',
  'hudChrome.auraEffect.formCat': '猫形态：近战伤害与能量',
  'hudChrome.auraEffect.formTravel': '旅行形态：移动速度提高 {pct}%',
  'hudChrome.auraEffect.defensiveStance': '防御姿态：受到的伤害降低，威胁值提高',
  'hudChrome.auraEffect.righteousFury': '正义之怒：神圣伤害产生的威胁值大幅提高',
