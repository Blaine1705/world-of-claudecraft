...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.plurals.noticeboardGuildStats.one': '{count}名成员，{xp}终身经验',
  'hudChrome.plurals.noticeboardGuildStats.few': '{count}名成员，{xp}终身经验',
  'hudChrome.plurals.noticeboardGuildStats.many': '{count}名成员，{xp}终身经验',
  'hudChrome.plurals.noticeboardGuildStats.other': '{count}名成员，{xp}终身经验',
