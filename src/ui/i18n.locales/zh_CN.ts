...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.frostveil.pois.1.label': '霜心洞窟',
  ...
  'entities.npcs.keeper_saelwyn.greeting': '你的同族鲜少踏足这片树荫，{className}。轻声慢行，欢迎你的到来。',
  'entities.npcs.loremother_bryn.name': '传识之母布琳',
  'entities.npcs.loremother_bryn.title': '圣祠之声',
  'entities.npcs.loremother_bryn.greeting': '这山谷里的每一盏光都铭记着什么，{playerName}。帮我听听它们的低语。',
  ...
  'entities.npcs.wardsmith_orun.greeting': '这些熔炉几百年前就冷了，{className}，但它们锻出的兵刃至今锋利。',
  'entities.npcs.archivist_tullo.name': '档案员图洛',
  'entities.npcs.archivist_tullo.title': '读石者',
  'entities.npcs.archivist_tullo.greeting': '外面那些石碑已经许久不曾对人开口。也许它们正等着新的耳朵。',
