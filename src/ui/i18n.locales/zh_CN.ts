...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.drakelands.pois.4.label': '血玻璃原野',
  'entities.zones.drakelands.pois.5.label': '龙喉火山口',
  ...
  'entities.zones.evergarden.pois.3.label': '野蔷薇丛',
  ...
  'entities.mobs.orkadia_axethrower.name': '血牙掷斧手',
  'entities.mobs.orkadia_fel_shaman.name': '灰骨邪能萨满',
  'entities.mobs.orkadia_beast_handler.name': '铁皮战兽驯兽师',
  'entities.mobs.orkadia_siege_brute.name': '奥卡迪亚攻城蛮兵',
  'entities.mobs.orkadia_banner_captain.name': '黑旗队长',
  ...
  'guide.worldPage.gardenPlaceNotes':
    '篱苑镇候在花园之门前。雕像步道有它沉默的伙伴相随；野蔷薇丛早已长出了花圃之外；花瓣池终年漂着粉色的花瓣；大迷宫会为每一位客人重新排布自己的礼数；而喷泉庭院仍在花园中心流淌着清泉。',
  ...
  'hudChrome.finder.mech.necrotic_shockwave': '死灵冲击波（高额范围伤害）',
  ...
  'hudChrome.mounts.requiresLevel': '需要等级{level}',
  'hudChrome.mounts.pickFirst': '选择一个要骑乘的坐骑。',
  'hudChrome.mounts.keybindHint': '按下骑乘 / 下骑键即可骑乘。',
