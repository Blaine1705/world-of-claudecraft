...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.revenge.description':
    '以宽阔的弧线攻击，对你面前的所有敌人造成物理伤害。目标超过 5 个时，伤害会降低。当你躲闪或招架时，你的下一次复仇可能不消耗怒气。',
  ...
  'entities.abilities.enrage_passive.description':
    '被动：处于狂怒时，你造成的伤害提高11%，攻击速度提高25%，移动速度提高10%，持续4秒。嗜血有30%几率触发，浴血则必定触发。（狂怒）',
  ...
  'entities.abilities.furious_mending.description':
    '10 秒内你受到的伤害降低 20%，持续期间你的放血将为你恢复最大生命值的 20%。（狂怒）',
  ...
  'entities.abilities.raised_guard.description': '举盾自守：6 秒内受到的物理伤害降低 50%。（防护）',
  'entities.abilities.iron_resolve.name': '无视疼痛',
  'entities.abilities.iron_resolve.description':
    '咬牙硬撑，无视疼痛：消耗你的全部怒气（至少 20 点），每消耗 1 点怒气便吸收 4 点伤害，最多持续 10 秒。（防护）',
  'entities.abilities.faultline.name': '震荡波',
  'entities.abilities.faultline.description':
    '向地面轰出一道震荡波：你面前 8 码内的敌人受到 {damage} 点伤害并被击晕 3 秒。（防护）',
  'entities.abilities.defiant_bellow.name': '挑衅怒吼',
  'entities.abilities.defiant_bellow.description':
    '发出挑衅的怒吼：10 码内的所有敌人都被嘲讽，被迫攻击你，持续 3 秒。（防护）',
  'entities.abilities.breachmaker.name': '破防重击',
  'entities.abilities.breachmaker.description':
    '重击目标，造成武器伤害外加 {damage} 点伤害，并击碎其防御：你自己对其造成的伤害提高 20%，持续 8 秒。（武器）',
  'entities.abilities.measured_fury.name': '沉稳之怒',
  'entities.abilities.measured_fury.description':
    '你沉稳的怒火磨砺了资源运用：你的技能怒气消耗降低 10%。（武器）',
  ...
  'guide.abilityHook.hamstring': '割裂目标的双腿使其减速，让它无法追上你。',
  ...
  'hudChrome.auraEffect.battleStance': '战斗姿态：怒气生成提高 10%',
  ...
  'entities.abilities.storm_bolt.description': '将武器掷向目标，造成 {damage}，并使其昏迷 3 秒。',
  ...
  'entities.abilities.heroic_leap.description': '跃向目标区域，对附近敌人造成 {damage} 点伤害。',
