...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_ps_a_path_of_your_own.title': '专属之路',
  'entities.quests.q_ps_a_path_of_your_own.text':
    '挥剑是一回事，{playerName}，明白为什么而挥又是另一回事。到了五级，世界会请你选择一门专精：你这行当的三条道路之一，各有所长。从那以后，每隔几级就会开启一排天赋，一排三选一。再击倒两个草人，趁稻草飞扬的时候，想想你要走哪一条路。',
  'entities.quests.q_ps_a_path_of_your_own.completion':
    '又倒下两个，挥砍背后也多了几分沉稳。最要紧的是记住这一点，{playerName}：你的任何选择都不是牢笼。天赋面板随时可以打开；等你在五级做出选择之后，只要站在安全的地方，天赋和专精都可以随时重置、重新选择，分文不取。大胆去选，学到了新东西就再选一次。',
  'entities.quests.q_ps_a_path_of_your_own.objectives.0.label': '击倒训练草人',
  'entities.quests.q_ps_the_wheel_of_trades.title': '百业环轮',
  'entities.quests.q_ps_the_wheel_of_trades.text':
    '一柄剑只能喂饱你一顿，{playerName}，一门手艺却能喂养你一生。每个冒险者在刀剑之外都操持着专业：采矿、伐木、采药、钓鱼，还有把这一切变成价值的制作技艺。军需官芬奇摆过的摊子比我带过的操练还多。去问问她，一门手艺是怎么立起来的。',
  'entities.quests.q_ps_the_wheel_of_trades.completion':
    '玛伦总算给我送来一个值得费口舌的学生。听好了，{playerName}，只说一遍：采集从一件工具开始，矿镐、斧子、镰刀、钓竿，谷地的商人那里都有得卖。你的技艺构成一个环轮：钻研你喜欢的那些，当你调谐到相邻的一对，这两门便成为无上限的主修，环轮对面的一门是你的爱好，其余的则休眠，直到你重新拾起。你学会的东西永远不会失去，等你准备好了，城镇里的技艺大师会向你提供调谐。',
