...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.guildRanks.tab': '职位',
  'hudChrome.guildRanks.introEdit':
    '为公会职位命名，并选择每个职位可以做什么。保存后，改动会应用于该职位的所有成员。',
  'hudChrome.guildRanks.introView': '每个职位的名称及其权限。只有会长可以修改。',
  'hudChrome.guildRanks.colRank': '职位',
  'hudChrome.guildRanks.colTitle': '名称',
  'hudChrome.guildRanks.colMembers': '成员',
  'hudChrome.guildRanks.colActions': '排序',
  'hudChrome.guildRanks.numbered': '职位 {n}',
  ...
  'hudChrome.guildRanks.perm.officerChat': '官员频道',
  'hudChrome.guildRanks.perm.motd': '公告板',
  'hudChrome.guildRanks.perm.events': '日历',
  'hudChrome.guildRanks.permHint.invite': '邀请玩家加入公会，并处理他们的宣誓。',
  'hudChrome.guildRanks.permHint.remove': '移除职位低于自己的成员。',
  'hudChrome.guildRanks.permHint.promote':
    '晋升或降级职位低于自己的成员，最高可晋升至比自己低一级的职位。',
  'hudChrome.guildRanks.permHint.bank': '在公会银行存取铜币和物品。所有成员都可以查看。',
  'hudChrome.guildRanks.permHint.officerChat': '阅读并发言于官员频道。',
  'hudChrome.guildRanks.permHint.motd': '编辑公会公告板。',
  'hudChrome.guildRanks.permHint.events': '添加或删除公会日历活动。',
  'hudChrome.guildRanks.titleLabel': '{rank}的名称',
  'hudChrome.guildRanks.permLabel': '{rank}的{perm}权限',
  'hudChrome.guildRanks.leaderLocked': '会长始终拥有所有权限。',
  'hudChrome.guildRanks.add': '添加职位',
  'hudChrome.guildRanks.save': '保存职位',
  'hudChrome.guildRanks.moveUp': '上移{rank}',
  'hudChrome.guildRanks.moveDown': '下移{rank}',
  'hudChrome.guildRanks.remove': '移除{rank}',
  'hudChrome.guildRanks.full': '一个公会最多只能有 {max} 个职位。',
  'hudChrome.guildRanks.invalidTitle':
    '职位名称只能使用字母、数字、空格、撇号和连字符，最多 {max} 个字符。',
  'hudChrome.guildRanks.removeConfirm': '担任{rank}的成员将变为{fallback}。要移除此职位吗？',
  'hudChrome.guildRanks.removeAccept': '移除职位',
  'hudChrome.guildRanks.promoteTo': '将 {name} 晋升为{rank}',
  'hudChrome.guildRanks.demoteTo': '将 {name} 降级为{rank}',
  ...
  'hud.meters.resetAll': '重置所有数据',
  'hud.meters.criticals': '暴击：{count}',
  'hud.meters.hits': '命中：{count}',
  'hud.meters.topAbility': '主要：{name}',
  'hud.meters.activity': '活跃度：{pct}',
  ...
  'hud.meters.damageTakenShort': '承伤',
  ...
  'hud.meters.groupTotal': '总量：{total}（{rate}）',
};
