...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.woc_market.paused': '价格恢复期间交易所暂停交易。拍卖倒计时照常进行。',
  ...
  'apiError.woc_market.item_mismatch': '这不是买家同意购买的那件物品。请重新发起一笔交易。',
  ...
  'hudChrome.wocMarket.tabActivity': '动态',
  ...
  'hudChrome.wocMarket.pausedBanner':
    '$WOC 价格恢复期间交易暂停。拍卖倒计时照常进行；价格恢复健康之前不会有任何成交。',
  'hudChrome.wocMarket.walletBanner': '绑定并验证钱包后即可在交易所出价、购买或出售。',
  'hudChrome.wocMarket.rateNote': '当前汇率：约每美元 {tokens} $WOC（{time} 更新）。',
  'hudChrome.wocMarket.estimateNote': '按当前汇率约 {tokens} $WOC。最终数额在请求付款时才会确定。',
  ...
  'hudChrome.wocMarket.detailSaleRow': '{usd}，由 {seller} 售予 {buyer}',
  ...
  'hudChrome.wocMarket.bidBondNote':
    '出价时会冻结 {usd} 的可退还保证金（以 $WOC 支付）。被超越时退还；只有当你中标却未付款时才会被没收。',
  ...
  'hudChrome.wocMarket.settlementFailConfirmingOverdue': '这笔付款确认耗时过长，正在接受审核。',
  ...
  'hudChrome.wocMarket.quoteBurn': '销毁：{tokens} $WOC',
  'hudChrome.wocMarket.quoteTreasury': '国库：{tokens} $WOC',
  ...
  'hudChrome.wocMarket.sellSelectAria': '选择要挂单的 {item}',
  ...
  'hudChrome.wocMarket.sellClearTitle': '清除所选',
  ...
  'hudChrome.wocMarket.sellDurationHours': '{hours} 小时',
  'hudChrome.wocMarket.sellOfferNext': '若中标者未付款，将物品转售给下一位出价者。',
  'hudChrome.wocMarket.sellSubmit': '上架物品',
  'hudChrome.wocMarket.sellSubmitAria': '将 {item} 上架到交易所',
  'hudChrome.wocMarket.sellFeeNote':
    '成交后收取 10% 手续费：90% 归你，3% 销毁，7% 进入国库。收益随结算交易直接进入你绑定的钱包。',
  ...
  'hudChrome.wocMarket.activityEmpty': '暂无记录。出价、挂单和结算会显示在这里。',
  ...
  'hudChrome.wocMarket.activitySuspended': '因未付款结算，竞拍资格暂停 {duration}。',
  ...
  'hudChrome.trade.woc.variableWarning':
    '$WOC 金额仅为预览，并非固定价格。买家付款时将以最新报价确定确切数量。',
  'hudChrome.trade.woc.feeLine': '交易所手续费 {fee}',
  ...
  'hudChrome.trade.woc.notInstant':
    '$WOC 交易并非即时完成。对方接受后你的物品将进入托管，付款验证通过后送达对方。',
  ...
  'hudChrome.trade.woc.hintOneItem': '$WOC 交易一次只包含一件物品。请只保留要出售的那一件。',
  'hudChrome.trade.woc.sendOffer': '出价 $WOC',
  'hudChrome.trade.woc.incomingAccept': '{name} 出价 {price} 购买你的物品。',
  'hudChrome.trade.woc.hintAcceptLocked': '该物品已锁定。出售前请先在背包中解锁。',
  ...
  'hudChrome.trade.woc.ineligibleNote': '有 {count} 件暂存物品无法出售换取 $WOC。',
  'hudChrome.trade.woc.incomingTitle': '来自 {name} 的 $WOC 报价',
  'hudChrome.trade.woc.incomingBody': '{name} 提出以 {price} 将 {item} 出售给你。',
  'hudChrome.trade.woc.moneyUsd': '{usd} 美元',
  'hudChrome.trade.woc.moneyTokens': '(约 {tokens} $WOC)',
  ...
  'hudChrome.trade.woc.settled': '已付款。物品将通过邮件送达。',
  ...
  'hudChrome.trade.woc.statusPayingSeller': '已收到付款。正在网络上确认……',
  'hudChrome.trade.woc.closedCancelled': '本次交易已取消。物品将通过邮件退还卖家。',
  'hudChrome.trade.woc.closedSuspended': '本次交易已被游戏管理员中止。物品将通过邮件退还卖家。',
  'hudChrome.trade.woc.closedUnpaid': '本次交易因未付款而结束。物品将通过邮件退还卖家。',
  ...
  'hudChrome.trade.woc.dealAwaitsPayment': '你的 $WOC 购买尚未付款。请再次与卖家交易以付款；否则交易将自动过期。',
  'hudChrome.trade.woc.paymentConfirmed': '付款已确认。配送完成后物品将通过邮件送达。',
