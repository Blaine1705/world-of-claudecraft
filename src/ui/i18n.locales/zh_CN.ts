...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_riding_lessons.text':
    '每个骑手都是两条腿走进来的，{playerName}，就像我们初次见面那天我说的那样。我教的是怎么坐稳，不是拿来卖的东西。等我发话就翻身上鞍，沿着我围场里插旗的赛道，按顺序穿过每一道门。要是从鞍上摔下来，或者跑出了院子，我们就从头再来。',
  ...
  'hudChrome.mounts.keybindHint': '按下骑乘 / 下骑键(默认Z)即可骑乘。',
  ...
  'hudChrome.mountTraining.mountPrompt': '上马吧：按 {key} 键骑上训练用英勇战马。',
  'hudChrome.mountTraining.ridePrompt': '沿着插旗的赛道骑行，按顺序穿过每一道门。',
  'hudChrome.mountTraining.progress': '第 {n} 道门，共 {total} 道',
