...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.hoard_cast_hex': '妖术',
  ...
  'abilityUi.cast.hoard_goblin_escape': '逃跑',
  'abilityUi.cast.hoard_cast_mole_rake': '利爪耙击',
  'abilityUi.cast.hoard_cast_burrow': '钻地',
  'abilityUi.cast.hoard_cast_tunnel': '地下潜行',
  'abilityUi.cast.hoard_cast_emerge': '破土而出',
  'abilityUi.cast.hoard_cast_collapse': '洞顶坍塌',
  'abilityUi.cast.hoard_cast_bat_dive_aim': '俯冲',
  'abilityUi.cast.hoard_cast_bat_dive': '俯冲中',
  'abilityUi.cast.hoard_cast_screech': '震耳尖啸',
  'abilityUi.cast.hoard_cast_mimic_bite': '贪婪撕咬',
  'abilityUi.cast.hoard_cast_mimic_leap': '碾压跳跃',
  'abilityUi.cast.hoard_cast_coin_spit': '诅咒金币',
  ...
  'entities.items.treasure_map_common.name': '风化的藏宝图',
  'entities.items.treasure_map_rare.name': '墨绘藏宝图',
  'entities.items.treasure_map_epic.name': '鎏金藏宝图',
  'entities.items.treasure_map_legendary.name': '至尊藏宝图',
  'entities.items.cartographers_ink.name': '制图师的墨水',
  'hudChrome.riftTracker.hoardTitle': '埋藏的宝藏',
  'hudChrome.riftTracker.hoardGoal': '击败宝藏守护者',
  'hudChrome.treasureMap.close': '关闭藏宝图',
  'hudChrome.treasureMap.zone': '{zone}的某处',
  'hudChrome.treasureMap.hint':
    '找到这张地图所示的地方，站在 X 标记上，再次使用地图进行挖掘。一处埋藏的宝藏将为你和你的队伍开启。',
  'hudChrome.treasureMap.upgradeNote':
    '将其重绘为{rarity}地图需要 {inks} 瓶制图师的墨水（你持有 {held} 瓶）。各阵营军需官均有出售。',
  'hudChrome.treasureMap.upgradeMaxed': '没有哪位制图师能让这张地图更进一步。',
  'hudChrome.treasureMap.rarity.common': '普通',
  'hudChrome.treasureMap.rarity.rare': '稀有',
  'hudChrome.treasureMap.rarity.epic': '史诗',
  'hudChrome.treasureMap.rarity.legendary': '传说',
  'sim.rift.hoardEnter': '你向下爬进了{name}。',
  'sim.rift.hoardNotYours': '这处宝藏是另一支队伍挖出的。',
  'questUi.logs.treasureMapEarned': '今日所有世界任务均已完成：你找到了一张{map}。',
  'questUi.logs.treasureMapLost': '今日所有世界任务均已完成，但你的背包没有空间放藏宝图。',
  'questUi.logs.treasureMapRead': '你研究了{map}。X 标记位于{zone}的某处。',
  'questUi.logs.treasureMapUpgraded': '地图以更精细的墨水重绘：现在它是一张{map}。',
  'questUi.logs.treasureVaultOpened': '地面塌陷。一处埋藏的宝藏在你面前敞开。',
  'questUi.logs.treasureVaultLooted': '宝藏中有{money}和{items}。',
  'questUi.logs.treasureVaultCapped': '你今天已经分享了足够多的宝藏；这一处不会给你任何奖励。',
  'questUi.logs.hoardGoblinSighted': '哥布林窃贼出现了！',
  'questUi.logs.hoardGoblinSightedHint': '在它带着金币逃走前干掉它！',
  'questUi.logs.hoardGoblinExplain':
    '一只背着一袋赃金的哥布林窃贼藏在这处宝藏里。它从不还手，只会逃跑。你的第一次攻击会开启{seconds}秒的逃跑计时条：计时条走完时它若还活着，就会打开传送门带着金币消失。如果没人碰它，它会在{minutes}分钟后自行离开。及时击杀它，房间里的所有人都能获得金币。',
  ...
  'entities.mobs.hoard_brood_egg.name': '虫卵群',
  'entities.mobs.hoard_brood_hatchling.name': '维斯卡的幼蛛',
  ...
  'entities.mobs.hoard_coinsack_scurrier.name': '钱袋窜贼',
  'entities.mobs.hoard_boss_mushroom.name': '蘑菇之母',
  'entities.mobs.hoard_sporeling.name': '孢子仔',
  'entities.mobs.hoard_bloat_cap.name': '膨胀菌盖',
  'entities.mobs.hoard_boss_mole.name': '深耙',
  'entities.mobs.hoard_boss_bat.name': '巨型蝙蝠',
  ...
  'sim.rift.yell.mushroomEngage': '孢子会吞没你。',
  'sim.rift.yell.mushroomSummon': '生长吧，我的孩子们！',
  'sim.rift.yell.moleEngage': '这片大地归我所有。',
  'sim.rift.yell.moleSummon': '给我下来！',
  'sim.rift.yell.batEngage': '吱吱吱！',
  'sim.rift.yell.batSummon': '到我身边来，我的族群！',
  'sim.rift.yell.mimicEngage': '饿……好饿……',
  'sim.rift.yell.mimicSummon': '更多金子，更多金子！',
  'sim.rift.yell.frostBigCast': '白风已起。',
  'sim.rift.yell.frostDeathZoneCast': '寒霜将你吞噬。',
  'sim.rift.yell.frostDeathZoneStrike': '深寒之中，无物可存。',
  'sim.rift.yell.frostEngage': '寒冷终将带走一切。',
  'sim.rift.yell.frostEnrage': '冻结吧！',
  'sim.rift.yell.emberBigCast': '燃烧！',
  'sim.rift.yell.emberDeathZoneCast': '岩浆涌起。',
  'sim.rift.yell.emberDeathZoneStrike': '熔炉吞噬一切！',
  'sim.rift.yell.emberEngage': '熔炉饥渴难耐。',
  'sim.rift.yell.emberSummon': '从熔渣中崛起！',
  'sim.rift.yell.emberEnrage': '化为灰烬与余火！',
  'sim.rift.yell.venomBigCast': '淹没在毒液之中吧！',
  'sim.rift.yell.venomDeathZoneCast': '溺毙于剧毒之中。',
  'sim.rift.yell.venomDeathZoneStrike': '你逃不过我的孩子们！',
  'sim.rift.yell.venomEngage': '我的孩子们永远饥饿。',
  'sim.rift.yell.venomSummon': '饱餐吧，小家伙们！',
  'sim.rift.yell.necroBigCast': '你们的灵魂归我了。',
  'sim.rift.yell.necroDeathZoneCast': '你的灵魂归我了。',
  'sim.rift.yell.necroDeathZoneStrike': '死亡吞噬一切！',
  'sim.rift.yell.necroEngage': '死亡只是开始。',
  'sim.rift.yell.necroSummon': '起来！',
  'sim.rift.yell.bruteBigCast': '我要打碎你！',
  'sim.rift.yell.bruteDeathZoneCast': '大地崩裂！',
  'sim.rift.yell.bruteDeathZoneStrike': '你将葬身于此！',
  'sim.rift.yell.bruteEngage': '我会碾碎你！',
  'sim.rift.yell.bruteEnrage': '吼啊啊啊！',
  'sim.rift.yell.arcaneBigCast': '见证真正的力量吧。',
  'sim.rift.yell.arcaneDeathZoneCast': '现实正在撕裂。',
  'sim.rift.yell.arcaneDeathZoneStrike': '灰飞烟灭！',
  'sim.rift.yell.arcaneEngage': '你不该来这里。',
  'sim.rift.yell.arcaneEnrage': '跪下！',
  'sim.rift.yell.stormBigCast': '苍穹回应了！',
  'sim.rift.yell.stormDeathZoneCast': '苍穹回应你的呼唤。',
  'sim.rift.yell.stormDeathZoneStrike': '风暴吞噬一切！',
  'sim.rift.yell.stormEngage': '风暴听命于我！',
  'sim.rift.yell.stormEnrage': '天穹崩塌！',
  'sim.rift.yell.tideDeathZoneCast': '深渊将你带走。',
  'sim.rift.yell.tideDeathZoneStrike': '坠入深渊吧！',
  'sim.rift.yell.tideEngage': '深渊将你吞没。',
  'sim.rift.yell.tideSummon': '从深处崛起！',
  'sim.rift.yell.ritualistBigCast': '契约已以烈火封印！',
  'sim.rift.yell.ritualistEngage': '你擅闯了受缚之地。',
  'sim.rift.yell.ritualistSummon': '回应我，地底之物！',
  'sim.rift.yell.pitlordBigCast': '深坑将你吞噬！',
  'sim.rift.yell.pitlordEngage': '跪下，或者燃烧。',
  'sim.rift.yell.pitlordEnrage': '要塞吞噬一切！',
  'sim.rift.place.hoardFloor': '{theme}埋藏宝藏',
  'sim.rift.place.sanctumFloor': '{theme}圣所：第{depth}层',
  'sim.rift.place.reachesFloor': '{theme}疆域：第{depth}层',
  'sim.rift.place.upgradedFloor': '{title}：{theme}第{depth}层',
  'sim.rift.place.hoardPlan': '埋藏的{noun}宝藏',
  'sim.rift.place.riftPlan': '{noun}{suffix}',
  'sim.rift.place.citadelPlan': '{noun}要塞',
  'sim.rift.place.infernalCitadel': '炼狱要塞',
  'sim.rift.place.hoardEntrance': '埋藏宝藏入口',
  'sim.rift.place.theme.frost': '霜缚',
  'sim.rift.place.theme.ember': '烬炉',
  'sim.rift.place.theme.venom': '毒林',
  'sim.rift.place.theme.bone': '骸骨场',
  'sim.rift.place.theme.brute': '战营',
  'sim.rift.place.theme.void': '虚痕',
  'sim.rift.place.theme.storm': '风暴尖塔',
  'sim.rift.place.theme.tide': '沉没',
  'sim.rift.place.theme.spore': '孢子洞穴',
  'sim.rift.place.theme.burrow': '幽深地穴',
  'sim.rift.place.theme.roost': '蝙蝠栖巢',
  'sim.rift.place.theme.mimic': '伪宝库',
  'sim.rift.place.theme.infernal': '炼狱要塞',
  'sim.rift.place.noun.rime': '白霜',
  'sim.rift.place.noun.hoarfrost': '雾凇',
  'sim.rift.place.noun.glacier': '冰川',
  'sim.rift.place.noun.frost': '寒霜',
  'sim.rift.place.noun.ember': '余烬',
  'sim.rift.place.noun.cinder': '焦烬',
  'sim.rift.place.noun.magma': '熔岩',
  'sim.rift.place.noun.ash': '灰烬',
  'sim.rift.place.noun.venom': '毒液',
  'sim.rift.place.noun.thorn': '荆棘',
  'sim.rift.place.noun.bramble': '荆丛',
  'sim.rift.place.noun.spider': '蜘蛛',
  'sim.rift.place.noun.bone': '骸骨',
  'sim.rift.place.noun.marrow': '骨髓',
  'sim.rift.place.noun.ossuary': '藏骨堂',
  'sim.rift.place.noun.grave': '墓穴',
  'sim.rift.place.noun.war': '战争',
  'sim.rift.place.noun.skull': '颅骨',
  'sim.rift.place.noun.iron': '钢铁',
  'sim.rift.place.noun.blood': '鲜血',
  'sim.rift.place.noun.void': '虚空',
  'sim.rift.place.noun.shadow': '暗影',
  'sim.rift.place.noun.umbral': '幽影',
  'sim.rift.place.noun.dusk': '暮光',
  'sim.rift.place.noun.storm': '风暴',
  'sim.rift.place.noun.tempest': '暴风',
  'sim.rift.place.noun.thunder': '雷霆',
  'sim.rift.place.noun.gale': '疾风',
  'sim.rift.place.noun.sunken': '沉没',
  'sim.rift.place.noun.abyssal': '渊狱',
  'sim.rift.place.noun.drowned': '溺亡',
  'sim.rift.place.noun.tide': '潮汐',
  'sim.rift.place.noun.spore': '孢子',
  'sim.rift.place.noun.toadstool': '毒蕈',
  'sim.rift.place.noun.mould': '霉菌',
  'sim.rift.place.noun.mycelium': '菌丝',
  'sim.rift.place.noun.burrow': '地穴',
  'sim.rift.place.noun.tunnel': '隧道',
  'sim.rift.place.noun.delve': '深掘',
  'sim.rift.place.noun.loam': '沃土',
  'sim.rift.place.noun.roost': '栖巢',
  'sim.rift.place.noun.echo': '回响',
  'sim.rift.place.noun.guano': '蝠粪',
  'sim.rift.place.noun.hollow': '空洞',
  'sim.rift.place.noun.coffer': '宝匣',
  'sim.rift.place.noun.strongbox': '铁箱',
  'sim.rift.place.noun.tithe': '什一税',
  'sim.rift.place.noun.gilt': '鎏金',
  'sim.rift.place.noun.brimstone': '硫磺',
  'sim.rift.place.noun.pitfire': '坑焰',
  'sim.rift.place.noun.pactbound': '契缚',
  'sim.rift.place.suffix.abyss': '深渊',
  'sim.rift.place.suffix.depths': '深处',
  'sim.rift.place.suffix.descent': '坠道',
  'sim.rift.place.suffix.hollow': '幽谷',
  'sim.rift.place.suffix.labyrinth': '迷宫',
  'sim.rift.place.suffix.warren': '巢穴',
  'sim.rift.place.suffix.sanctum': '圣所',
  'sim.rift.place.suffix.rift': '裂隙',
  ...
  'entities.items.collapsar_band_of_nyxaris.name': '尼克萨里斯的坍缩星指环',
  'entities.items.rare_collapsar_band_of_nyxaris.name': '失色的尼克萨里斯的坍缩星指环',
  'entities.items.legendary_collapsar_band_of_nyxaris.name': '至尊尼克萨里斯的坍缩星指环',
  'entities.items.orb_collapsing_void.name': '坍缩虚空宝珠',
  'entities.items.rare_orb_collapsing_void.name': '失色的坍缩虚空宝珠',
  'entities.items.legendary_orb_collapsing_void.name': '至尊坍缩虚空宝珠',
  'entities.items.cowl_of_event_horizon.name': '事件视界兜帽',
  'entities.items.rare_cowl_of_event_horizon.name': '失色的事件视界兜帽',
  'entities.items.legendary_cowl_of_event_horizon.name': '至尊事件视界兜帽',
  'entities.items.mantle_of_singularity.name': '奇点披肩',
  'entities.items.rare_mantle_of_singularity.name': '失色的奇点披肩',
  'entities.items.legendary_mantle_of_singularity.name': '至尊奇点披肩',
  'entities.items.glacier_hewn_bulwark.name': '冰川凿成的壁垒',
  'entities.items.rare_glacier_hewn_bulwark.name': '失色的冰川凿成的壁垒',
  'entities.items.legendary_glacier_hewn_bulwark.name': '至尊冰川凿成的壁垒',
  'entities.items.permafrost_legguards.name': '永冻护腿',
  'entities.items.rare_permafrost_legguards.name': '失色的永冻护腿',
  'entities.items.legendary_permafrost_legguards.name': '至尊永冻护腿',
  'entities.items.frostbitten_rime_slippers.name': '霜噬白霜便鞋',
  'entities.items.rare_frostbitten_rime_slippers.name': '失色的霜噬白霜便鞋',
  'entities.items.legendary_frostbitten_rime_slippers.name': '至尊霜噬白霜便鞋',
  'entities.items.rime_crusted_grips.name': '覆霜护手',
  'entities.items.rare_rime_crusted_grips.name': '失色的覆霜护手',
  'entities.items.legendary_rime_crusted_grips.name': '至尊覆霜护手',
  'entities.items.ember_wrought_crown.name': '余烬锻造之冠',
  'entities.items.rare_ember_wrought_crown.name': '失色的余烬锻造之冠',
  'entities.items.legendary_ember_wrought_crown.name': '至尊余烬锻造之冠',
  'entities.items.cinder_stitched_robes.name': '灰烬缝制长袍',
  'entities.items.rare_cinder_stitched_robes.name': '失色的灰烬缝制长袍',
  'entities.items.legendary_cinder_stitched_robes.name': '至尊灰烬缝制长袍',
  'entities.items.chained_ember_choker.name': '锁链余烬项圈',
  'entities.items.rare_chained_ember_choker.name': '失色的锁链余烬项圈',
  'entities.items.legendary_chained_ember_choker.name': '至尊锁链余烬项圈',
  'entities.items.molten_clinker_girdle.name': '熔渣腰带',
  'entities.items.rare_molten_clinker_girdle.name': '失色的熔渣腰带',
  'entities.items.legendary_molten_clinker_girdle.name': '至尊熔渣腰带',
  'entities.items.storm_tuned_buckler.name': '风暴调谐圆盾',
  'entities.items.rare_storm_tuned_buckler.name': '失色的风暴调谐圆盾',
  'entities.items.legendary_storm_tuned_buckler.name': '至尊风暴调谐圆盾',
  'entities.items.hauberk_tempest_gale.name': '暴风烈风锁甲',
  'entities.items.rare_hauberk_tempest_gale.name': '失色的暴风烈风锁甲',
  'entities.items.legendary_hauberk_tempest_gale.name': '至尊暴风烈风锁甲',
  'entities.items.gale_strider_boots.name': '疾风行者长靴',
  'entities.items.rare_gale_strider_boots.name': '失色的疾风行者长靴',
  'entities.items.legendary_gale_strider_boots.name': '至尊疾风行者长靴',
  'entities.items.tempest_strike_grips.name': '暴风打击护手',
  'entities.items.rare_tempest_strike_grips.name': '失色的暴风打击护手',
  'entities.items.legendary_tempest_strike_grips.name': '至尊暴风打击护手',
  'entities.items.breastplate_tectonic_might.name': '地壳之力胸甲',
  'entities.items.rare_breastplate_tectonic_might.name': '失色的地壳之力胸甲',
  'entities.items.legendary_breastplate_tectonic_might.name': '至尊地壳之力胸甲',
  'entities.items.band_mountains_weight.name': '山岳之重指环',
  'entities.items.rare_band_mountains_weight.name': '失色的山岳之重指环',
  'entities.items.legendary_band_mountains_weight.name': '至尊山岳之重指环',
  'entities.items.monolithic_shoulderguards.name': '巨石护肩',
  'entities.items.rare_monolithic_shoulderguards.name': '失色的巨石护肩',
  'entities.items.legendary_monolithic_shoulderguards.name': '至尊巨石护肩',
  'entities.items.earthshaker_warboots.name': '撼地战靴',
  'entities.items.rare_earthshaker_warboots.name': '失色的撼地战靴',
  'entities.items.legendary_earthshaker_warboots.name': '至尊撼地战靴',
  'entities.items.silkstalker_woven_vest.name': '丝猎者的编织背心',
  'entities.items.rare_silkstalker_woven_vest.name': '失色的丝猎者的编织背心',
  'entities.items.legendary_silkstalker_woven_vest.name': '至尊丝猎者的编织背心',
  'entities.items.spun_venom_spaulders.name': '纺毒护肩',
  'entities.items.rare_spun_venom_spaulders.name': '失色的纺毒护肩',
  'entities.items.legendary_spun_venom_spaulders.name': '至尊纺毒护肩',
  'entities.items.broodmother_chitin_cowl.name': '育母的甲壳兜帽',
  'entities.items.rare_broodmother_chitin_cowl.name': '失色的育母的甲壳兜帽',
  'entities.items.legendary_broodmother_chitin_cowl.name': '至尊育母的甲壳兜帽',
  'entities.items.venom_etched_waistcord.name': '蚀毒腰绳',
  'entities.items.rare_venom_etched_waistcord.name': '失色的蚀毒腰绳',
  'entities.items.legendary_venom_etched_waistcord.name': '至尊蚀毒腰绳',
  'entities.items.bone_studded_pauldrons.name': '镶骨肩铠',
  'entities.items.rare_bone_studded_pauldrons.name': '失色的镶骨肩铠',
  'entities.items.legendary_bone_studded_pauldrons.name': '至尊镶骨肩铠',
  'entities.items.legguards_of_the_ossuary.name': '藏骨堂护腿',
  'entities.items.rare_legguards_of_the_ossuary.name': '失色的藏骨堂护腿',
  'entities.items.legendary_legguards_of_the_ossuary.name': '至尊藏骨堂护腿',
  'entities.items.seal_of_the_cryptwalker.name': '墓穴行者之印',
  'entities.items.rare_seal_of_the_cryptwalker.name': '失色的墓穴行者之印',
  'entities.items.legendary_seal_of_the_cryptwalker.name': '至尊墓穴行者之印',
  'entities.items.ossuary_bone_crown.name': '藏骨堂骨冠',
  'entities.items.rare_ossuary_bone_crown.name': '失色的藏骨堂骨冠',
  'entities.items.legendary_ossuary_bone_crown.name': '至尊藏骨堂骨冠',
  'entities.items.chalice_of_living_tides.name': '活潮圣杯',
  'entities.items.rare_chalice_of_living_tides.name': '失色的活潮圣杯',
  'entities.items.legendary_chalice_of_living_tides.name': '至尊活潮圣杯',
  'entities.items.pendant_continuous_flow.name': '不息流动吊坠',
  'entities.items.rare_pendant_continuous_flow.name': '失色的不息流动吊坠',
  'entities.items.legendary_pendant_continuous_flow.name': '至尊不息流动吊坠',
  'entities.items.coral_encrusted_girdle.name': '珊瑚镶嵌腰带',
  'entities.items.rare_coral_encrusted_girdle.name': '失色的珊瑚镶嵌腰带',
  'entities.items.legendary_coral_encrusted_girdle.name': '至尊珊瑚镶嵌腰带',
  'entities.items.riptide_handwraps.name': '激流裹手',
  'entities.items.rare_riptide_handwraps.name': '失色的激流裹手',
  ...
  'hudChrome.mapAtlas.railToggle': '侧边栏',
  'hudChrome.mapAtlas.railToggleAria': '显示或隐藏地图侧边栏',
  ...
  'questUi.worldQuest.wispMaze.startHard': '进入迷宫：困难（{shadows} 个暗影，额外钱袋）',
  ...
  'questUi.worldQuest.puzzleBonusCharged':
    '秘藏因奖励充能而嗡鸣：奖励关卡 {level}/{total} 正等着你。再次触碰魔网秘藏即可获得额外金币。',
  'questUi.worldQuest.puzzleBonusPaid': '获得奖励钱袋！',
  'questUi.worldQuest.puzzleBonusDone': '所有奖励关卡均已通关。秘藏将静候下一次机会。',
  ...
  'abilityUi.cast.hoard_cast_silk_snare': '丝网陷阱',
  'abilityUi.cast.hoard_cast_void_empower': '虚空强化',
  'abilityUi.cast.hoard_cast_webbing': '蛛网缠绕',
  'entities.items.allied_hearthstone.name': '盟约炉石',
  'entities.items.allied_vanguard_duffel.name': '盟约先锋行囊',
  'entities.items.clockwork_shock_bomb.name': '发条震荡炸弹',
  'entities.items.clockwork_target_dummy.name': '发条训练假人',
  'entities.items.dawn_battle_standard.name': '黎明战旗',
  'entities.items.dense_sharpening_stone.name': '致密磨刀石',
  'entities.items.elixir_of_mana_regeneration.name': '法力回复药剂',
  'entities.items.formula_enchant_feet_shadowstride.name': '配方：附魔靴子 - 影行',
  'entities.items.formula_enchant_gloves_forged_might.name': '配方：附魔手套 - 锻造之力',
  'entities.items.formula_enchant_offhand_spirit.name': '配方：附魔副手 - 精神',
  'entities.items.pattern_reinforced_armor_kit.name': '图样：强化护甲片',
  'entities.items.plans_dense_sharpening_stone.name': '设计图：致密磨刀石',
  'entities.items.potion_of_invisibility.name': '隐形药水',
  'entities.items.recipe_elixir_of_mana_regeneration.name': '配方：法力回复药剂',
  'entities.items.recipe_potion_of_invisibility.name': '配方：隐形药水',
  'entities.items.reinforced_armor_kit.name': '强化护甲片',
  'entities.items.rift_feather_glider.name': '裂隙羽翼滑翔翼',
  'entities.items.schematic_clockwork_shock_bomb.name': '结构图：发条震荡炸弹',
  'entities.mobs.rift_marrow_golem.name': '骨髓魔像',
  'hudChrome.currencies.automatonCog': '机械齿轮',
  'hudChrome.currencies.automatonCogNote': '机械造物区域的世界任务',
  'hudChrome.currencies.churchOrderCrest': '修会徽记',
  'hudChrome.currencies.churchOrderCrestNote': '教会修会区域的世界任务',
  'hudChrome.currencies.riftWatchMark': '裂隙守望徽章',
  'hudChrome.currencies.riftWatchMarkNote': '裂隙守望区域的世界任务',
  'hudChrome.enchantName.enchant_feet_shadowstride': '靴子蚀刻：影行',
  'hudChrome.enchantName.enchant_gloves_forged_might': '手套蚀刻：锻造之力',
  'hudChrome.enchantName.enchant_offhand_spirit': '副手蚀刻：精神',
  'hudChrome.factionRewards.alliedHearthstoneAttuned': '已校准至：{hub}',
  'hudChrome.factionRewards.alliedHearthstoneUse':
    '使用：将你传送至已校准的阵营据点。（施法 10 秒，冷却 15 分钟）',
  'hudChrome.factionRewards.armorKitUse': '使用：强化你的胸甲，使护甲提高 12 点，持续 1 小时。',
  'hudChrome.factionRewards.battleStandardUse':
    '使用：插下神圣黎明战旗，持续 5 分钟，大幅提高附近所有盟友的非战斗生命与法力恢复。在其附近停留 10 秒还会获得黎明祝福（所有属性提高 5%，持续 30 分钟）。（冷却 5 分钟）',
  'hudChrome.factionRewards.hub_automatons': '南境（机械铸造厂）',
  'hudChrome.factionRewards.hub_church_order': '东溪谷（教会修会）',
  'hudChrome.factionRewards.hub_none': '无（在阵营据点附近使用以校准）',
  'hudChrome.factionRewards.hub_rift_watch': '漂流港（裂隙守望）',
  'hudChrome.factionRewards.invisibilityUse': '使用：使你进入潜行状态，持续 6 秒。（冷却 2 分钟）',
  'hudChrome.factionRewards.manaElixirUse': '使用：精神提高 6 点，持续 1 小时。',
  'hudChrome.factionRewards.riftGliderUse':
    '使用：展开滑翔翼，降低下落速度，持续 30 秒。着陆或受到伤害会取消该效果。（冷却 2 分钟）',
  'hudChrome.factionRewards.sharpeningStoneUse':
    '使用：打磨你的主手武器，使攻击强度提高 6 点，持续 30 分钟。',
  'hudChrome.factionRewards.shockBombUse':
    '使用：向最远 30 码处投掷一枚震荡炸弹，对 5 码内的所有敌人造成 120 到 160 点自然伤害。（冷却 1 分钟）',
  'hudChrome.factionRewards.targetDummyUse':
    '使用：在野外部署一个机械训练假人，持续 2 分钟，用于练习战斗技能。（冷却 5 分钟）',
  'sim.factionVendor.currencyRequired': '你需要 {amount} 个{currency}才能购买。',
};
