...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hostDiag.intro':
    '如果游戏在这台电脑上运行不流畅，请创建一份系统报告并发送给支持团队。报告会说明这台电脑的配置和游戏的设置，帮助我们找出拖慢帧率的原因。',
  'hudChrome.hostDiag.containsTitle': '报告包含的内容',
  'hudChrome.hostDiag.containsHardware':
    '硬件和驱动程序：电脑品牌和型号、处理器、内存、显卡以及可用磁盘空间。',
  'hudChrome.hostDiag.containsWindows': 'Windows 版本、电源和电池状态以及图形设置。',
  ...
  'hudChrome.hostDiag.privacy':
    '报告不包含你的文件、用户名或账号信息。你的电脑名称也不会包含在内，而是由一个随机代码代替。不会自动发送任何内容：报告是保存在你电脑上的一个文件，由你决定发给谁。',
  'hudChrome.hostDiag.create': '创建报告',
  'hudChrome.hostDiag.running': '正在收集系统信息... 需要几秒钟。',
  'hudChrome.hostDiag.saved': '报告已保存为 {fileName}。',
  'hudChrome.hostDiag.savedNoName': '报告已保存。',
  'hudChrome.hostDiag.detailPartial': '部分信息未能收集。这份报告仍然有用。',
  'hudChrome.hostDiag.detailUnavailable':
    'Windows 系统扫描工具缺失或已被更改，因此只包含了基本信息。重新安装游戏即可恢复。',
  'hudChrome.hostDiag.detailNativeError': 'Windows 系统扫描无法运行，因此只包含了基本信息。',
  'hudChrome.hostDiag.busy': '报告正在创建中。',
  'hudChrome.hostDiag.failed': '无法创建报告。请重试。',
  'hudChrome.hostDiag.sendHint':
    '请通过 Discord 将保存的文件发送给支持团队，或将其附加到你的支持请求中。',
