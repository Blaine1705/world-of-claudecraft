...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.currencies.riftWatchMark': '裂隙守望印记',
  'hudChrome.currencies.riftWatchMarkNote': '裂隙守望区域的世界任务',
  'hudChrome.currencies.churchOrderCrest': '教会徽记',
  ...
  'hudChrome.enchantName.enchant_feet_shadowstride': '长靴蚀刻：暗影漫步',
  'hudChrome.enchantName.enchant_gloves_forged_might': '手套蚀刻：锻造力量',
  'hudChrome.factionRewards.alliedHearthstoneUse':
    '使用：将你传送至已协调的阵营据点。（10秒施法时间，15分钟冷却时间）',
  'hudChrome.factionRewards.alliedHearthstoneAttuned': '已协调至：{hub}',
  'hudChrome.factionRewards.hub_none': '无（在阵营据点附近使用以进行协调）',
  ...
  'hudChrome.factionRewards.riftGliderUse':
    '使用：展开滑翔器，使坠落速度减缓，持续30秒。着陆或受到伤害会取消此效果。（2分钟冷却时间）',
  'hudChrome.factionRewards.targetDummyUse':
    '使用：在野外放置一个机械训练假人，持续2分钟，用于练习战斗技能。（5分钟冷却时间）',
  'hudChrome.factionRewards.battleStandardUse':
    '使用：放置神圣晨曦战旗，持续5分钟，显著提高附近所有盟友的非战斗生命与法力回复速度。在其附近停留10秒还会获得晨曦祝福（所有属性提高5%，持续30分钟）。（5分钟冷却时间）',
  'hudChrome.factionRewards.shockBombUse':
    '使用：向最多30码的目标投掷一枚震击炸弹，对5码内的所有敌人造成120至160点自然伤害。（1分钟冷却时间）',
  'hudChrome.factionRewards.invisibilityUse': '使用：使你进入潜行状态，持续6秒。（2分钟冷却时间）',
  'hudChrome.factionRewards.armorKitUse': '使用：加固你的胸甲，使其护甲值提高12点，持续1小时。',
  'hudChrome.factionRewards.sharpeningStoneUse':
    '使用：打磨你的主手武器，使其攻击强度提高6点，持续30分钟。',
  'hudChrome.factionRewards.manaElixirUse': '使用：使精神提高6点，持续1小时。',
  'entities.items.allied_hearthstone.name': '盟友炉石',
  'entities.items.allied_vanguard_duffel.name': '盟友先锋行李袋',
  'entities.items.rift_feather_glider.name': '裂隙羽毛滑翔器',
  'entities.items.formula_enchant_feet_shadowstride.name': '配方：附魔长靴 - 暗影漫步',
  'entities.items.recipe_potion_of_invisibility.name': '配方：隐形药水',
  'entities.items.potion_of_invisibility.name': '隐形药水',
  'entities.items.pattern_reinforced_armor_kit.name': '图样：加固护甲片',
  'entities.items.reinforced_armor_kit.name': '加固护甲片',
  'entities.items.dawn_battle_standard.name': '晨曦战旗',
  ...
  'entities.items.clockwork_target_dummy.name': '发条假人',
  'entities.items.schematic_clockwork_shock_bomb.name': '结构图：发条震击炸弹',
  'entities.items.clockwork_shock_bomb.name': '发条震击炸弹',
  'entities.items.plans_dense_sharpening_stone.name': '设计图：致密磨刀石',
  'entities.items.dense_sharpening_stone.name': '致密磨刀石',
  'entities.items.formula_enchant_gloves_forged_might.name': '配方：附魔手套 - 锻造力量',
