...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.veiled_hollow.welcome': 'Воздух гудит от древней магии. Найдите хранительницу Сэльвин под великим древом Элдерглима.',
  ...
  'guide.home.world.emberBlurb': 'За Бледной дамбой зелень уступает пеплу, и пустошами правит нечто древнее.',
  'guide.home.world.frostName': 'Морозный Предел',
  'guide.home.world.frostBlurb': 'Заснеженная высь, которой нет ни на одной карте. Её видно лишь в танцующем сиянии.',
  'entities.zones.drakelands.name': 'Земли Драконов',
  'entities.zones.drakelands.welcome': 'Горячий ветер несётся с пустошей. Драконы кружат над Дрейкмо, а в дюнах горят костры троллей.',
  ...
  'entities.zones.frostveil.welcome': 'Снег глотает каждый звук. Под танцующим сиянием сам холод кажется живым.',
  ...
  'entities.zones.willowfen.welcome': 'Над топью гудят стрекозы и пчёлы. Перейди мост в Бриджмир и дай ногам отдых.',
  ...
  'guide.home.world.fenBlurb': 'За осенней короной лежит светлая топь ив и тихой воды, и городок за рвом.',
  'guide.home.world.amberName': 'Янтарная Падь',
  'guide.home.world.amberBlurb': 'За западными утёсами длится вечная осень, и на золотом озере горят фонари.',
  ...
  'entities.zones.wraithwood.welcome': 'Кроны смыкаются над дорогой, как крышка гроба. Держись фонарей Гэллоумира, и если лес позовёт тебя по имени, не отвечай.',
  ...
  'entities.zones.palmreach.welcome': 'Тёплый песок, громкие птицы и джунгли, пожирающие горизонт. Дрифтхейвен держит для тебя костёр на берегу.',
  ...
  'entities.npcs.loremother_bryn.greeting': 'Каждый огонёк в этой долине что-то помнит, {playerName}. Помоги мне вслушаться.',
  'entities.npcs.provisioner_fenna.name': 'Снабженец Фенна',
  'entities.npcs.provisioner_fenna.title': 'Снабженец Элдерглима',
  'entities.npcs.provisioner_fenna.greeting': 'Хлеб ещё тёплый, вода всё так же сладка. Лощина даёт, и я даю.',
  'entities.npcs.wardsmith_orun.name': 'Кузнец-оберегов Орун',
  'entities.npcs.wardsmith_orun.title': 'Хранитель старых горнов',
  'entities.npcs.wardsmith_orun.greeting': 'Эти горны остыли столетия назад, {className}, но их работа до сих пор держит остроту.',
  'entities.npcs.archivist_tullo.name': 'Архивариус Тулло',
  'entities.npcs.archivist_tullo.title': 'Чтец камней',
  'entities.npcs.archivist_tullo.greeting': 'Тамошние монументы давно никому не говорили ни слова. Быть может, они ждали свежие уши.',
  'entities.quests.q_veil_thinned.title': 'Истончившаяся завеса',
  'entities.quests.q_veil_thinned.text': 'Значит, пещера открылась тебе. Тогда печать слабее, чем я боялась, {playerName}. Там, где рвётся завеса, огоньки становятся тёмными и холодными. Принеси мне восемь сущностей сумеречных огоньков, и я прочту, как глубока рана.',
  'entities.quests.q_veil_thinned.completion': 'Холодные, все до единой. У Лощины, пожалуй, есть одно время года, прежде чем разрыв станет разломом. Нам с тобой предстоит работа.',
  ...
  'entities.quests.q_gleaming_antlers.text': 'Скрытые олени роняют свет там, где пасутся, а сброшенные рога хранят его годами. Пять рогов от стад у Котловины Звездопада, и мои фонари прогорят всю зиму без масла. Оленей можно не трогать, но задаром они рога не отдадут.',
  'entities.quests.q_gleaming_antlers.completion': 'Только посмотри, как они держат свет! Ни пламени, ни дыма, лишь сияние. Лощина даёт.',
  'entities.quests.q_gleaming_antlers.objectives.0.label': 'Сияющий рог',
  'entities.quests.q_wisp_lights.title': 'Огни отмелей',
  'entities.quests.q_wisp_lights.text': 'Мерцающие огоньки несут пылинки старого звёздного света, упавшего сюда при запечатывании Лощины. Шесть пылинок, и лампады святилища прогорят год. Бери лишь у тех, что угасают: Лощина даёт довольно и без жадности.',
  'entities.quests.q_wisp_lights.completion': 'Мягкие, как первые звёзды. Положи их у алтаря; святилище довершит остальное.',
  'entities.quests.q_wisp_lights.objectives.0.label': 'Звёздная пылинка',
  'entities.quests.q_calming_the_deep.title': 'Утишить чащу',
  'entities.quests.q_calming_the_deep.text': 'Спорёныши Мерцающей глуби были кротким народом, пока разрыв не коснулся их колец. Что порча забрала, того не вернёт. Даруй осквернённым покой, {playerName}: десятерым, на севере глуби.',
  'entities.quests.q_calming_the_deep.completion': 'Ты сделал то, чего я не могла вынести. Собиратели в южных кольцах всё ещё поют; благодаря тебе они будут петь и дальше.',
  ...
  'entities.quests.q_spore_hearts.text': 'Когда спорёныш падает во тьму, его сердце продолжает биться заёмной тенью. Четыре таких сердца, очищенных в святилище, покажут нам, как расползается порча. Мрачная работа, {playerName}, но это работа исцеления.',
  'entities.quests.q_spore_hearts.completion': 'Вот так. Очищены и тихи. На каждом одна и та же метка: тень течёт из Затонувшего двора. Скажи Сэльвин.',
  'entities.quests.q_spore_hearts.objectives.0.label': 'Споровое сердце',
  'entities.quests.q_monument_tour.title': 'Что помнят камни',
  'entities.quests.q_monument_tour.text': 'Со времён до запечатывания стоят три монумента: один на Сумеречной смотровой площадке, один в Затонувшем дворе, а один потерян на северо-востоке, где никто не ходит. Прочти их за меня, {playerName}. Мои колени сдались лестницам два столетия назад.',
  'entities.quests.q_monument_tour.completion': 'Смотровая площадка, двор и забытый угол... все три строфы песни запечатывания вместе, впервые с тех пор, как её спели. Ты осчастливил старого чтеца.',
  ...
  'entities.quests.q_grove_menace.text': 'После заката сумеречные огоньки повадились плыть между моими прилавками, {playerName}, а их стужа портит всё, чего коснётся. Проредите их для меня: десяток, где бы ни рвалась завеса.',
  'entities.quests.q_grove_menace.completion': 'Ночной рынок снова может открыться. Считай, у тебя пожизненный покупатель. Ну или хотя бы скидка.',
  ...
  'entities.quests.q_shards_of_starfall.text': 'Когда сумеречные огоньки проплывают над хрустальными полями, к ним, как репьи, липнут осколки старого звёздного света. Шесть осколков, {playerName}, и я датирую запечатывание до самого времени года, когда его спели.',
  'entities.quests.q_shards_of_starfall.completion': 'Взгляни на прожилки! Осень. Лощину запечатали осенью. Двести лет споров решили шесть камешков.',
  ...
  'entities.quests.q_treant_accord.text': 'Старейшины Рощи сбрасывают внешнюю кору, пока порча грызёт их корни. Четыре пласта, и я сварю бальзам на всю Рощу. Пока будешь отдирать кору, спасибо не скажут, {playerName}, зато простоят на столетие дольше.',
  'entities.quests.q_treant_accord.completion': 'Все четыре толстые и крепкие. Бальзам варится неделю, а действует сто лет. Деревья меряют доброту иначе.',
  ...
  'entities.quests.q_spore_tide.text': 'Бальзам держит Рощу, но порча с каждыми сумерками сильнее давит на глубь. Ещё двенадцать осквернённых должны обрести покой, прежде чем собиратели вернут свои северные кольца, {playerName}.',
  'entities.quests.q_spore_tide.completion': 'Северные кольца этой ночью снова поют. Тихо, но поют.',
  ...
  'entities.quests.q_sunken_court.text': 'Брин прочла сердца верно: разрыв идёт через старый двор на востоке, и его стражи пробудились неправильно. Их строили защищать печать; теперь они сокрушат всякого, кто приблизится. Убери восьмерых из руин.',
  'entities.quests.q_sunken_court.completion': 'Восемь стражей утихли. Я помню, как их поднимали, {playerName}. Не удивляйся: Лощина долго хранит своих хранителей.',
  ...
  'entities.quests.q_wardens_echoes.text': 'Хозяин умолк, но стражи двора повторяют его последний приказ, как эхо, что не желает стихать. Пока печать не вернётся на место, они будут просыпаться снова и снова, {playerName}. Утихомирь ещё десятерых, чтобы каменщики добрались до печатного камня.',
  'entities.quests.q_wardens_echoes.completion': 'Эхо с каждым разом всё слабее. Скоро во дворе останутся лишь ветер и плющ, как и положено руинам.',
  ...
  'entities.quests.q_waking_warden.text': 'Двор затих, но его хозяин нет. Смотритель, держащий печать, пробудился искажённым, и пока он стоит, печать не срастить. Легко он не падёт; возьми друга, если найдёшь одного, {playerName}. Возьми двоих, если найдёшь двоих.',
  'entities.quests.q_waking_warden.completion': 'Колокол его голоса умолк. Я почувствовала это отсюда, будто с целой долины сняли тяжесть.',
  ...
  'entities.quests.q_seal_restored.text': 'Отнеси печать Смотрителя к печатному камню в сердце двора и вложи её туда, откуда её выбили. Тогда Лощина начнёт исцеляться, а ты, {playerName}, совершишь то, чего никто из вашего рода не совершал.',
  'entities.quests.q_seal_restored.completion': 'Я почувствовала, как она сомкнулась, мягко, как сумерки. Лощина помнит своих друзей, {playerName}. Как бы далеко ты ни странствовал, под великим древом для тебя всегда будет гореть огонёк.',
  ...
  'guide.worldPage.duskGreeting': 'Немногие из вашего рода стояли под этими ветвями. Ступайте мягко, и добро пожаловать.',
  'guide.worldPage.duskGreeter': 'Хранительница Сэльвин, Элдерглим',
  'guide.worldPage.duskPlaceNotes': 'Элдерглим собрался под великим древом. Сумеречная пещера и её смотровая площадка служат входом и первым видом на долину; Древняя роща и Котловина Звездопада хранят тихий юг; Затонувший двор скрывает заросшие руины на востоке; а Мерцающая глубь и Хрустальные отмели светятся на севере.',
