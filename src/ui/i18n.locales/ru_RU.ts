...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.retribution_aura.description':
    'Окружает вас и вашу группу священной энергией до смерти или замены. Враги, атакующие пораженного союзника в ближнем бою, получают {buff} ед. урона светлой магией, а пораженные союзники наносят автоатаками дополнительно {buff} ед. урона светлой магией.',
