...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.furious_mending.description':
    'В течение 10 сек получаемый урон снижен на 20%, и все это время ваше «Кровопускание» восполняет 20% максимального здоровья. (ветка «Неистовство»)',
  ...
  'hudChrome.options.mouseoverCast': 'Каст по наведению на рамки группы',
