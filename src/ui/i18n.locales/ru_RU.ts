...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.deathless_warguard_gauntlets.name': 'Рукавицы бессмертного стража',
  'entities.items.soulrend_handwraps.name': 'Обмотки разрыва души',
  'entities.items.scourgehide_grips.name': 'Хваты бичевой шкуры',
  'entities.items.soulforged_gauntlets.name': 'Душекованые рукавицы',
