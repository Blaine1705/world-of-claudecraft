...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_riding_lessons.text':
    'Каждый всадник приходит на своих двоих, {playerName}, как я и сказала в день нашей встречи. Держаться в седле — вот чему я учу, а не чем торгую. Забирайся в седло, когда я подам знак, и проезжай размеченную флажками трассу вокруг моего загона, через все ворота по порядку. Вылетишь из седла или покинешь двор — начнём заново.',
