...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.fine_ashwood_log.name': 'Feiner Eschenholzscheit',
  'entities.items.fine_copper_ore.name': 'Feines Kupfererz',
  'entities.items.fine_elderwood_log.name': 'Feiner Hochkiefernstamm',
  'entities.items.fine_goldleaf_herb.name': 'Feines Blattgoldkraut',
  'entities.items.fine_iron_ore.name': 'Feines Eisenerz',
  'entities.items.fine_ironbark_log.name': 'Feiner Eisenrindenscheit',
  'entities.items.fine_silverleaf_herb.name': 'Feines Sheenleaf-Kraut',
  'entities.items.fine_sunpetal_herb.name': 'Feines Sonnenblütenkraut',
  'entities.items.fine_thorium_ore.name': 'Feines Osmiumerz',
  'entities.items.gatherers_cache.name': 'Vorrat des Sammlers',
  'entities.items.stormreel_fishing_rod.name': 'Sturmspulen-Angelrute',
  'entities.items.tidewrought_fishing_rod.name': 'Gezeitengeformte Angelrute',
  'entities.quests.q_nythraxis_graves.text':
    'Ich habe diese Zeichen schon einmal auf drei alten Gräbern rund um das nördliche Schlachtfeld gesehen. Kapitän Aldren liegt auf der westlichen Anhöhe, Hohepriester Malric weiter südlich am westlichen Rand und Royal Assassin Voss an der östlichen Klippe. Berühre jedes Grab und höre zu, {playerName}. Die Toten erinnern sich vielleicht daran, was die Lebenden vergessen haben.',
  'entities.quests.q_the_codfather.text':
    'Der Codfather ist nicht nur ein Fisch, {playerName}, er ist ein kaltblütiger Killer. Alte Leute schwören, dass er Mire Prowlers zum Frühstück isst, und selbst die Mirefen-Witwen werden aus reiner Angst nicht ihre Netze in der Nähe der Deepfen-Untiefen spinnen. Er beherrscht diese Gewässer, und im Sumpfwasser braucht es eine Eisenrollen-Angelrute, nicht weniger; Meine Theke verkauft sie. Nehmen Sie einen in die Hand, ziehen Sie den alten Teufel aus seinen Gewässern, und ich gebe zu, dass Sie der Familie beigetreten sind.',
  'guide.profPages.bandsBody':
    'Kompetenzstufen sind die gemeinsame 0/100/200-Rangliste über den Zähler eines Handels. Für die Landgeschäfte überschritt die Bande die 100 Rasur des Gather-Casts, und ihre Obergrenze macht Band 1 zur Obergrenze. Die Angel-Bands haben nichts zu bieten: Sie wählen die Fangplätze aus (mit einer passenden Rute), nur das Angeln erreicht Band 2, und der Aufstieg selbst ist es, was einen Angler in tieferes Wasser zieht, wo sowohl die besseren Tische als auch die weiteren Lektionen leben.',
  'guide.profPages.colWield': 'Verwendung bei',
  'guide.profPages.craftIntro.enchanting':
    'Durch Verzaubern wird die Ausrüstung auseinandergenommen und die Kraft wieder eingesetzt: Zerlegen Sie unerwünschte Teile in arkane Materialien und geben Sie sie dann für einen dauerhaften Statusbonus für ein Teil aus, das Sie behalten möchten. Das Brechen und Verzaubern benötigt keine Station und keinen Trainer, und jeder kann vom ersten Tag an beginnen; Nur die beiden Zauberrezepte verlangen mehr, die in der Werkzeugfabrik gelehrt werden.',
  'guide.profPages.craftIntro.engineering':
    'Die Ingenieurskunst stellt die Werkzeuge her, die sich jeder ernsthafte Sammler am Ende wünscht: die Spitzhacken der Stufen 4 und 5, Äxte, Sicheln und Angelruten, die kein Laden jemals für Münzen verkaufen kann, wobei jedes einzelne das Werkzeug darunter verbraucht.',
  'guide.profPages.craftProse.alchemy.identityBody':
    'Das Handwerk wird in der Apotheke in Highwatch ausgeübt, der Heimat der Alchemistin Verane, Meisterin der Apotheke, die die Rezeptleiter lehrt, Glasfläschchen für 12 Kupfer verkauft und über ihren Arbeitsauftrag Münzen für Kräuter bezahlt.\n\nIm Handwerksring sitzt Alchemie mit den Trial-and-Error-Handwerken neben Ingenieurwesen auf der einen und Kochen auf der anderen Seite. Daraus ergeben sich zwei Identitätspaare: der Bombardier (Ingenieurwesen und Alchemie, aufgenommen vor Tinker Gizzel in Eastbrook) und der Apotheker (Alchemie und Kochen, vereidigt vor Cook Marlow). Stimmen Sie sich auf eines der beiden Paare ein, um Alchemie zu einem Hauptfach zu machen, und lassen Sie sich von Ihrer eigenen signierten Arbeit zurücklernen; Das Bombardier-Paar eröffnet auch sein Kombinationsgebräu, das Elixier des Bären, während das Apothecary-Paar noch kein Kombinationsrezept ausliefert. Die Leiter selbst wartet jedoch nie, da sich jedes Alchemierezept innerhalb der seltenen Stufe befindet, unter der nicht deklarierte Handwerke arbeiten, sodass der gesamte Aufstieg zur Obergrenze vor jedem Schwur offen ist.',
  'guide.profPages.craftProse.alchemy.ladderBody':
    'Jeder kennt den kleinen Heiltrank von Anfang an und kann ihn überall mischen, ohne dass eine Station erforderlich ist. Die eigentliche Leiter besteht aus neun Rezepten, die Verane in der Apotheke gelehrt hat, drei auf jeder Stufe: Die Rezepte der Fertigkeit 0 sind kostenlos, die Stufe der Fertigkeit 25 kostet 25 Silber pro Rezept und die Stufe der Fertigkeit 50 kostet 1 Gold pro Rezept. Jede Sprosse besteht aus einem Heiltrank, einem Manatrank und einem Ausdauerelixier und reicht von gewöhnlichen Glanzblattflaschen (120 Gesundheit, 160 Mana) über ungewöhnliches Blattgold (200 Gesundheit, 260 Mana) bis hin zu seltenen Sonnenblütenblättern (280 Gesundheit, 360 Mana).\n\nDie Elixiere steigen auf die gleiche Weise: Das Elixier des Ebers gewährt 10 Minuten lang 6 Ausdauer, das Vipersear-Elixier 15 Minuten lang 9 und das Elixier der Schlange 15 Minuten lang 12, wobei die Schlange allein zwei Flaschen pro Herstellung braut. Ein weiteres Rezept steht daneben: das Elixier des Bären, ein Kombinationsgebräu, das Verane für 25 Silber lehrt, sobald Ihre Alchemie 25 erreicht, und überall mischbar ist, aber nur von einem eingestimmten Bombenschützen mit Alchemie und Technik bei 25.',
  'guide.profPages.craftProse.alchemy.routeBody':
    'Entwürfe und Elixiere sind niemals Meisterwerke; Dieser Proc gehört zur stattragenden Ausrüstung. Ihr Name ist jedoch immer noch im Umlauf: Die seltenen Sonnenblütentöpfe kommen signiert mit einem Herstellerzeichen an, ebenso wie jede Flasche des Doppelchargen-Elixiers der Schlange, sodass nichts Seltenes in diesem Handwerk ohne Signatur auf dem Tisch bleibt. Bei Fertigkeit 75 spezialisieren Sie sich und jedes Alchemierezept kostet von da an 20 Prozent weniger Materialien.\n\nBeginnen Sie früh mit Kräuterkunde und pflücken Sie, während Sie aufsteigen: Sheenleaf ist überall im Tal zu finden, und sobald Sie Veranes Bank erreicht haben, gelangen Sie über die freie Sprosse sauber auf Fertigkeitsstufe 25 bei Kräutern, die Sie sowieso gepflückt hätten. Lernen Sie die 25er-Sprosse kennen, sobald sie eingeschaltet wird, pflücken Sie im Sumpf Blattgold und lassen Sie sich von Veranes Arbeitsauftrag (sechs Blattgoldkräuter für 45 Kupfer, alle 30 Minuten wiederholbar) eine kleine Münze zurückgeben.\n\nBrauen Sie ab 50 Sonnenblütenblätter und Serpent-Chargen aus Dornengipfel-Sonnenblättern, mit noch etwas Tal- und Sumpfgrün in der Mischung. Der letzte Abschnitt von 100 auf 125 ist ein bewusster Rinnsal, also brauen Sie, was sich tatsächlich verkauft, anstatt Kräuter für die Menge zu verbrennen, und denken Sie daran, dass es sich bei Verbrauchsmaterialien um hergestellte Güter handelt, die jeder für immer wieder kauft. Das Buch der Taten markiert Strange Brews bei Fertigkeit 50 und Grandmaster Alchemy bei der Obergrenze.',
  'guide.profPages.craftProse.armorcrafting.identityBody':
    'Die Leiter des Rüstungshandwerks liest sich wie die Karriere eines Soldaten: Der schlichte genietete Kupfergürtel, die Sabatons und die Panzerhandschuhe für den Anfang, das Eisenketten-Halsbergen, die Beinschützer und die Schulterschienen mit ihren ersten echten Statuslinien und der seltene Osmium-Großhelm, der Kürass und die Gamaschen, Stärke- und Ausdauerstücke mit Rüstungsnummern, die ganz oben in der Kunst eines Handwerkers stehen.\n\nEs hat auch eine ruhigere Seite: Die Eastbrook-Schutzgamaschen, ein von Zauberern gerüstetes Feldkommando, und der Ofenschuppen-Mantel, eine seltene Intellekt- und Geist-Panzerschulter mit Fertigkeit 75, sorgen dafür, dass die zauberbegeisterten Kettenträger auf der Kundenliste bleiben. Auf dem Ring liegt es zwischen Waffenbau und Ingenieurskunst; Das Smith-Paar mit Waffenkunst wird vor Schmiedemeisterin Darva geschworen, während das Gearwright-Paar mit Ingenieurskunst einen Namen hat, aber noch keine Eidquest hat.',
  'guide.profPages.craftProse.armorcrafting.ladderBody':
    'Zwei Feld-Commons, die Eastbrook Chainmail Vest und die Warded Leggings, sind von Anfang an bekannt und werden überall hergestellt. Die Trainerleiter besteht aus neun Rezepten in drei Stufen in der Eastbrook-Schmiede: Die Kupfersprosse ist bei Fertigkeit 0 kostenlos, die Eisenverbindungssprosse kostet bei Fertigkeit 25 25 Silber pro Rezept und die Osmiumschuppensprosse kostet bei Fertigkeit 50 jeweils 1 Gold, wobei jede Sprosse lehrbar ist, sobald Ihre Stufe sie erreicht.\n\nHinter der Leiter sitzen zwei Specials. Der Boundstone-Helm ist eines der beiden Smith-Kombinationsrezepte (die Gravewyrm Gauntlets sind seine Geschwister auf der Seite der Waffenherstellung), er wird vom Trainer unterrichtet, benötigt keine Station und kann nur von einem geschulten Smith mit Fertigkeitsstufe 25 in beiden Handwerken bearbeitet werden. Der Kilnscale Mantle braucht überhaupt keinen Lehrer: Jeder kennt ihn von Anfang an und nur die Schmiede und die Materialtore bearbeiten ihn. Bei der aufgeführten Fertigkeit von 75 geht es um Gewinn, nicht um Erlaubnis: Mit Rüstungsherstellung als Hauptfach zahlt es den vollen Fertigkeitszuwachs vom allerersten Hammerschlag bis 99, sodass ein Schmied, der Osmium übrig hat, frühzeitig darauf zurückgreifen kann. Unterhalb der Obergrenze eines Majors lehrt das Rezept der Stufe 3 nichts, sodass ein nicht deklarierter oder Hobby-Rüstungsschmied es für das Teil ausarbeitet, nicht für die Punkte.',
  'guide.profPages.craftProse.armorcrafting.materialsBody':
    'Kein Handwerk frisst Erz schneller. Allein das Eisenketten-Halsbergk braucht fünf Eisenerz, und jedes Osmiumschuppenstück benötigt drei oder vier Osmium plus einen Glyphenstahlbarren, also baut ein ernsthafter Rüstungsschmied Mirefen Marsh und Thornpeak Heights ab oder bezahlt jemanden, der das tut. Kupfer speist die erste Sprosse, direkt aus den Adern des Copper Dig.\n\nUm das Metall herum befinden sich die weichen Teile: grobe Häute von Wolfs- und Eberkadavern, Knochenfragmente von ruhelosen Toten (oder aus gewöhnlicher Ausrüstung geborgen) und Schmiedeflussgläser (jeweils 20 Kupferstücke in der Schmiede) in fast jedem Rezept. Kein Schalter verkauft Osmium: Die Ungeduldigen kaufen es anderen Spielern ab oder bauen es selbst ab, auf Thornpeak oder den Starteradern von zehn der elf jüngeren Zonen (allein Farshore fördert Eisen).',
  'guide.profPages.craftProse.cooking.identityBody':
    'Essen Sie eine gekochte Mahlzeit und es heilt Sie über 18 Sekunden Pause, was zwischen den Zügen die günstigste Heilung im Spiel ist. Die Leiter reicht von einem in der Pfanne gebratenen Flussbarsch mit 90 Lebenspunkten bis hin zu Marlows Grand Roast mit 980 Lebenspunkten, einem Sit-Heal-Wert, den nichts im Spiel übertrifft.\n\nAuf dem Ring liegt Kochen zwischen Alchemie und Lederverarbeitung. Sein lebendes Paar ist der Apotheker, die Alchemie und das Kochen, die vor Koch Marlow in der Küche von Eastbrook geschworen wurden, nachdem sie vier Wildschweine für den Topf gejagt hatten; Das Trapper-Paar mit Lederverarbeitung ist auf dem Ring benannt, hat aber noch keine Eid-Quest.',
  'guide.profPages.craftProse.cooking.materialsBody':
    'Die Fischbestände sind Zone für Zone die typischen Zutaten: Spiegelforelle und Flussbarsch aus den Gewässern von Eastbrook Vale, Sumpfhecht und Sumpfaal aus Mirefen Marsh, Frostkiemenforelle und Schieferkarpfen aus Thornpeak Heights. Die Sprossen mischen die Zonen frei (die freie Sprosse will bereits Sumpfhecht, die mittlere Sprosse die Frostkieme von Dorngipfel und das seltene Abendessen faltet die Spiegelforelle des Tals wieder ein), so dass ein Koch, der überall fischt, wo der Weg hingeht, niemals trocken geht.\n\nDie Seite des Metzgers besteht aus geernteten Leichen: Wildfleisch von Wildschweinen und deren Verwandten und, auf einem seltenen oder besseren Erntebrötchen, ein signierter Prime Cut, das Herzstück des großen Bratens. Kräuter würzen die besseren Gerichte, ein Eschenholzscheit räuchert den Aal und Kochsalz kostet 8 Kupfer pro Beutel aus Marlows eigenem Stand.',
  'guide.profPages.craftProse.enchanting.identityBody':
    'Jede Verzauberung ist von Anfang an bekannt, jeder kann sie vom ersten Tag an entzaubern und keiner von beiden benötigt jemals eine Station; Die Fertigkeit ist wie bei jedem Handwerk auf 125 begrenzt. Die einzige erlernte Ecke des Handwerks sind die beiden Zauberrezepte: Tinker Gizzel lehrt den Vorrat des Sammlers und das Auge des Handwerkers in der Werkzeugfabrik in der südwestlichen Ecke des Eastbrook Square für die normale Stufengebühr, sobald Ihr Verzauberkunstgrad 25 erreicht, und die Zauber selbst werden an seiner Station bearbeitet.\n\nAuf dem Ring steht es zwischen Inschrift und Juwelierkunst, daher sind seine beiden Identitätspaare der Arkanist (Inschrift und Verzauberung) und der Edelsteinbinder (Verzauberung und Juwelenarbeit). Keiner von beiden kann noch geschworen werden, da beide Nachbarn auf ihre ersten Rezepte warten, also steigen heute Zauberhafte Anstiege wie jedermanns Handwerk: kostenlos bis zur seltenen Stufe vor jedem Eid und eine natürliche Hobbyauswahl für einen Bombenschützen oder einen Apotheker. Verzauberer halten auch die Versammlungswelt am Laufen: Die beiden steckbaren Werkzeugeffekte sind Arbeit der Verzauberer, und ein Original-Handwerker lädt seine eigenen Effekte mit einem Rabatt auf, der nach der Spezialisierung sogar noch tiefer ausfällt.',
  'guide.profPages.craftProse.enchanting.levelingBody':
    'Drei Aktionen bewegen die Fertigkeit: Entzaubern eines Teils, Anwenden einer Verzauberung und Herstellen der beiden Amulette, die die normale Herstellungskurve hinaufsteigen. Jeder Erfolg ist bis zu einem Punkt wert, abhängig davon, wie ernst die Arbeit ist: der Seltenheit des Teils, das du zerbrichst, oder der Reagenzstufe der Verzauberung, die du anwendest. Gewöhnliche Entzauberungen und reine Staubverzauberungen werden als gewöhnliche Arbeit gewertet; Ungewöhnlich entzaubert und Essenz verzaubert als ungewöhnlich; seltene Entzauberungen und jede Runen- oder größere Verzauberung als selten; Epische und legendäre Entzauberungen rangieren auf der Tabelle noch weiter oben, obwohl heute keine bezaubernde Identität über die seltene Stufe hinausreicht, sodass sie in der Praxis den gleichen Lohn zahlen wie seltene Arbeiten. Eine Ehrlichkeit regiert die Bruchbank: Ein Stück, das von einer Spielerbank stammt (angefertigt, signiert oder meisterhaft), lässt sich immer noch in Materialien fräsen, lehrt aber nichts, sodass eine Bastel-und-Break-Schleife niemanden nivelliert, und die Lektionen erfolgen in weltweit gefundener Ausrüstung.\n\nDer bekannte Meisterschaftsschwund gilt für 25-Punkte-Stufen, so dass gewöhnliche Arbeit bei Fertigkeitsstufe 75 grau wird, ungewöhnliche Arbeit bei 100 und seltene Arbeit genau bei der Obergrenze von 125. Verzaubern hat auch einen ganz eigenen Vorteil: Eingaben, die über Ihrer Obergrenze für den Archetyp liegen, werden auf diese Obergrenze abgerundet statt auf Null gesetzt, sodass eine epische Entzauberung vor der Einstimmung einfach als selten gewertet wird, anstatt nichts zu lehren. Wenn die Verzauberkunst hinter einer anderen Identität schlummert, Punkte bricht und als gemeinsame Arbeit anwendet und der Aufstieg bei 75 ins Stocken gerät, während die beiden Zauber, die auf der Handwerkskurve über der gemeinsamen Obergrenze reiten, einem ruhenden Verzauberer überhaupt nichts beibringen; Behalten Sie es, denn Ihr Hobby und Ihre seltene Arbeit lohnt sich immer noch, nur langsamer über 75 hinaus.',
  'guide.profPages.craftProse.enchanting.marketBody':
    'Beim Anwenden einer Verzauberung werden die Reagenzien verbraucht und eine bestimmte Kopie des Gegenstands markiert. Richten Sie es auf eine verpackte Kopie und Sie erhalten eine einzigartige verzauberte Kopie zurück; Richten Sie es auf ein Teil, das Sie bereits tragen, und es wird an Ort und Stelle verzaubert, genau dort, wo es sitzt, ohne den Tanz aus- und wieder auszurüsten. In jedem Fall folgt der Bonus diesem Teil für immer, durch Ausrüsten, Bankreisen und Tauschen. Eine Verzauberung pro Stück: Das Anwenden einer anderen Verzauberung auf eine verzauberte Kopie erfordert eine Bestätigung, ersetzt dann die alte Verzauberung vollständig und zerstört sie ohne Rückerstattung der Materialien. Beim Verkaufen, Entsorgen und Entzaubern werden zunächst einfache Kopien bevorzugt, damit Ihr fertiges Stück nicht versehentlich aufgefressen wird.\n\nMeisterwerksausrüstung und Verzaubern sind Freunde: Ein Meisterwerksstück bleibt vollständig verzauberbar, und die Verzauberung erhöht den Meisterwerksbonus, ohne ihn oder die Signatur des Herstellers zu beeinträchtigen. Wenn man alle Quellen betrachtet, ist ein signiertes Meisterwerk mit einer größeren Verzauberung das Beste, was ein gefertigtes Stück bekommen kann, und es liegt von Natur aus immer noch unter der Raid-Beute.\n\nAuf dem Markt ist ein verzaubertes oder signiertes Stück wie alles andere: Es erscheint als Einzelexemplar, der Tooltip zeigt die Verzauberung und das Zeichen des Herstellers und der Rabenpost trägt es genauso getreu. Die Materialien bleiben die feste Hälfte des Handwerks: Staub, Essenz und Splitter werden kostenlos angeboten, die Auflistung kostet nichts und der Händler erhält nur 5 Prozent eines abgeschlossenen Verkaufs. Das macht den Verkauf von Materialien und den Verkauf fertiger Arbeiten zu den beiden klassischen Verzauberern: auf dem Markt, per Rabe oder persönlich in einem Schaufenster.',
  'guide.profPages.craftProse.engineering.identityBody':
    'Das Handwerk wird in der Werkzeugfabrik in der südwestlichen Ecke des Eastbrook Square betrieben, der Heimat von Tinker Gizzel, dem Meister der Werkzeugfabrik. Bei den Stufen 1 bis 3 jeder Werkzeugreihe handelt es sich um gewöhnliche Lieferantenbestände; Die Stufen 4 und 5 kommen von der Werkbank eines Ingenieurs oder aus dem Tiefenmarken-Zähler der Ertrunkene Litanei hinter den Toren der Räumung und niemals aus einer Kasse, um Münzen zu erhalten.\n\nAuf dem Ring steht es mit den Trial-and-Error-Gewerken neben Alchemie und Rüstungsherstellung, was ihm zwei Identitätspaare verleiht: den Bombardier (Ingenieurwesen und Alchemie, vor Gizzel selbst übernommen) und den Getriebebauer (Rüstungsherstellung und Ingenieurskunst, benannt, aber noch nicht schwörbar). Eine Warnung ist hier wichtiger als anderswo: Jede einzelne Rezeptstufe für Ingenieurswesen liegt über der seltenen Obergrenze, unter der Hobbys und nicht deklarierte Handwerker arbeiten, sodass sich die Fertigkeitszahl nur für einen Handwerker bewegt, zu dessen Hauptfach Ingenieurswesen gehört, was heute den Bombenschützen bedeutet. Jeder kann immer noch die Landwerkzeuge bauen; Ein ungeübter Handwerker lernt dadurch einfach nichts, und die beiden Rutenrezepte verlangen außerdem nach Gizzels Lehren.',
  'guide.profPages.craftProse.engineering.ladderBody':
    'Die Leiter besteht aus acht Rezepten, die alle an die Toolworks-Station gebunden sind. Die sechs Rezepte für Landwerkzeuge sind automatisch bekannt, es fällt nie eine Trainergebühr an: die Spitzhacke, die Axt und die Sichel der Stufe 4 bei Fertigkeit 75 und die Versionen der Stufe 5 bei Fertigkeit 150. Diese zweite Zahl ist kein Tippfehler und liegt absichtlich über der aktuellen Obergrenze von 125: Fertigkeitsanforderungen schließen hier nie ein Fahrzeug ab, sie bestimmen nur den Fertigkeitsgewinn, sodass Sie ein Werkzeug der Stufe 5 an dem Tag bauen können, an dem Sie seine Reagenzien und seinen Vorgänger der Stufe 4 besitzen. Die beiden hergestellten Ruten bilden die erlernte Ausnahme: Gizzel lehrt die Stormreel auf Fertigkeit 75 für 4 Gold und die Tidewrought auf Fertigkeit 125 für 16 Gold, jeweils in dem Moment, in dem Ihre Handwerksstufe ihre eigene erreicht.\n\nJedes fertige Werkzeug ist von seltener oder epischer Qualität und wird signiert geliefert, sodass Ihr Name auf den Werkzeuggürteln anderer Spieler zu finden ist. Die Ingenieurskunst hält auch die Hälfte eines Kombinationsrezepts bereit: das Elixier des Bären, gebraut von einem eingestimmten Bombardier mit Ingenieurskunst und Alchemie bei 25.',
  'guide.profPages.craftProse.engineering.materialsBody':
    'Jedes Rezept für Landwerkzeuge verbraucht das Werkzeug eine Stufe darunter plus ein FEINES Material, und diese Paarung ergibt die gesamte Landleiter: Vier feines Eisenerz und ein Himmelssilber-Bergbauspitz werden zum Osmium-Bergbauspitz, dann werden zwei Glyphsteel-Barren, zwei feines Osmiumerz und dieser Osmiumspitz zum Glyphsteel-Bergbauspitz. Die Axt- und Sichellinien spiegeln die Form „Fein plus vorheriges Werkzeug“ mit edlem Eschenholz und edlen Hochkiefernstämmen, edlem Blattgold und edlen Sonnenblütenkräutern wider, obwohl für ihre Stufe-5-Sprossen keine Glyphstahlbarren erforderlich sind: Die Spitzhacke ist die einzige Linie, die an der Spitze teurer wird. Die beiden Rutenrezepte durchbrechen das Muster absichtlich: Die Stormreel nimmt vier Sunglint-Koi und eine Silverstream-Rute auf, die Tidewrought zwei Koi, acht Raw Slatefin Carp und die Stormreel, sodass die Spitze der Anglerleiter auf dem Wasser und nicht an einer Ader bezahlt wird.\n\nEin feines Material wird nirgendwo verkauft und fällt auch nicht aus einer gewöhnlichen Ernte: Sie erhalten es, indem Sie eine der vollwertigen Adern einer Zone mit einem Werkzeug bearbeiten, das über dem Material selbst liegt, was in der Praxis bedeutet, dass das Werkzeug eine Stufe unter dem liegt, das Sie bauen möchten (je einfachere Adern eine Zone für Reisende bereithält, desto einfacheres Material erhalten Sie, egal, was Sie schwingen). Das ist Absicht. Auf der Handwerksroute entsteht ein Werkzeug der Stufe 5 durch das tatsächliche Schwingen des Werkzeugs der Stufe 4, nicht durch einen Einkaufsbummel; Der Tiefenmarken-Zähler ist die einzige Möglichkeit, dies zu umgehen. Die einzige Ausnahme ist der Glyphsteel-Barren, raffiniert und nur beim Händler erhältlich, 1 Silber 60 Kupfer pro Barren von Quartiermeister Bree in Highwatch oder von Gizzels eigenem Tresen, daher hat der Glyphsteel Mining Pick allein eine feste Münzuntergrenze, die in seinen Kosten integriert ist.',
  'guide.profPages.craftProse.leatherworking.ladderBody':
    'Hier liegt der Haken: Die Gerberei befindet sich in Fenbridge, an der Mirefen Marsh Road, und macht die Lederverarbeitung zum einzigen Handwerk, das im Sumpfgebiet ausgebildet wird. Tanner Hesk lehrt die Leiter an seinen Bottichen: Die Leitersprosse des Fenbridge-Hauts ist ab Fertigkeit 0 kostenlos, die Sumpfpirscher-Sprosse kostet ab Fertigkeit 25 25 Silber (ein Rezept) und die Sumpfwächter-Sprosse kostet ab Fertigkeit 50 jeweils 1 Gold, wobei sich jede Sprosse öffnet, wenn Ihre Stufe sie erreicht.\n\nDrei Rezepte überspringen den Trainer: Die Feld-Commons (das gegerbte Lederwams und das Fell des Eastbrook-Druiden) können von Anfang an überall hergestellt werden, und die Duskhide Wraps sind jedem bekannt, liegen aber bei Fertigkeitsstufe 75 und sind an die Gerberei gebunden. Beachten Sie, dass der Ausrüstereid selbst in Eastbrook bei Ottilie geschworen wird; nur der Unterricht findet im Sumpf statt.',
  'guide.profPages.craftProse.leatherworking.materialsBody':
    'Lederverarbeitung ist das Handwerk, bei dem Ihre Aufstiegsroute und Ihre Versorgungslinie dasselbe sind: Rohleder wird direkt von hauttragenden Leichen, vor allem von Wölfen und Wildschweinen, geerntet, und jede Leiche dient nur einem Ernter, wer zuerst kommt, mahlt zuerst. Ein seltener oder besserer Erntewurf gewährt außerdem ein makelloses Fell, ein signiertes Exemplar, nach dem der Düsterwächter Wams verlangt. Sparen Sie also jedes Exemplar, das Sie finden.\n\nDie unterstützende Besetzung ist klein: Spinnenbeine und Seide, selbstgesponnener Stoff von Humanoiden, ein einzelnes Osmiumerz in jedem seltenen Mirewarden-Stück (sechs im Deckstein von Duskhide Wraps) und ein Gerbstoff für 16 Kupfer von der Gerbereitheke. Osmium selbst wird niemals gegengekauft: Bauen Sie es selbst ab, auf Thornpeak oder in den Starteradern fast aller jüngeren Zonen (nur Farshore fördert Eisen) oder kaufen Sie es einem anderen Spieler ab.',
  'guide.profPages.craftProse.leatherworking.routeBody':
    'Jedes Stück mit echten Werten würfelt mit der Meisterwerk-Chance, solange die feinere Qualität innerhalb Ihrer Stufenobergrenze liegt, einschließlich des stattlichen Eastbrook-Druidenfells, und ein signiertes Makelloses Fell in einem Mirewarden-Wams bietet automatisch den signierten Reagenzienbonus; Osmium zählt als Material der Stufe 1 für den Prozess. Die statuslosen Fell-Commons können nicht ausgelöst werden.\n\nLeveln Sie es auf natürliche Weise: Erlegen Sie jeden Wolf und jedes Wildschwein, das Sie ab Level 1 töten, lassen Sie sich von den beiden Feld-Commons auf Stufe 25 tragen, wo auch immer Sie stehen, und trainieren Sie dann die Verstecksprosse an den Bottichen, wenn die Quests Sie sowieso in den Sumpf ziehen. Marshstalker bringt Sie auf 50 und Mirewarden auf 75; Darüber hinaus zahlen die Duskhide Wraps, ein Rezept der Stufe 3 mit sechs Osmiumerz, drei makellosen Häuten, zwei groben Häuten und einem Gerbstoff, einem eingestimmten Ausstatter den vollen Gewinn von 99 und der Hälfte danach, etwa 75 Handwerke für die letzten fünfzig Punkte bis zur Obergrenze von 125; Unterhalb der Obergrenze eines Majors lehrt das Rezept der Stufe 3 nichts.\n\nDie mobile Gerberei ist für dieses Handwerk wichtiger als für jedes andere: Spezialisieren Sie sich mit 75 und eine Satteltasche voller Häute wird am Lagerfeuer zur fertigen Ausrüstung, anstatt einen Spaziergang zurück nach Fenbridge zu machen. Hesks Gerberei-Arbeitsauftrag kauft alle 30 Minuten acht Rohhäute, eine ordentliche Rendite für die Felle, die Sie trotzdem gesammelt haben, und im Buch der Taten ist Gerbers Handwerk auf Fertigkeitsstufe 50 mit Großmeister-Lederverarbeitung an der Obergrenze markiert.',
  'guide.profPages.craftProse.weaponcrafting.materialsBody':
    'Der Bergbau ist das Rückgrat. Kupfererz stammt aus den Adern der Stufe 1 von Eastbrook Vale, Eisenerz aus Mirefen Marsh und Osmiumerz aus Thornpeak Heights, und jede Sprosse der Leiter steigt auf die gleiche Weise an. Der Holzeinschlag ist wichtiger, als Sie vielleicht erwarten: Eisenrinde trägt den Eberspeer, Eschenholz schultert den Hammer und ein einzelner Hochkiefernholzstamm bildet den Kampfstab.\n\nDer Rest kommt von der Jagd und der Theke. Rohes Fell für Griffe wird direkt von Wolfs- und Eberkadavern geerntet, Knochenfragmente stammen von ruhelosen Toten oder aus geborgener gewöhnlicher Ausrüstung, und auf der Schmiedeleiter wird Schmiedefluss verbrannt, 20 Kupfer pro Glas von Darva selbst. Wenn Ihr eigener Abbau hinterherhinkt, wird Sie kein Zähler beim Erz selbst retten: Osmium kommt aus den Thornpeak-Adern, aus den Starter-Adern aller jüngeren Zonen außer Farshore (in deren Adern Eisen gefördert wird) oder aus dem Stapel eines anderen Spielers, durch Handel oder den Weltmarkt. Nur der Glyphsteel-Barren kann für Münzen bei Tinker Gizzel in der Werkzeugfabrik oder bei Quartermaster Bree in Highwatch gekauft werden.',
  'guide.profPages.craftProse.weaponcrafting.routeBody':
    'Jedes Stück mit einer echten Stat-Linie, was auf dieser Leiter die Eisensprosse aufwärts bedeutet, kann als Meisterwerk vom Amboss kommen, solange die feinere Qualität innerhalb Ihrer Stufenobergrenze passt; Die statuslosen Kupfer-Commons werden nie ausgelöst, weil es dort nichts zu verbessern gibt. Eisen und Osmium gelten als Materialien der Stufe 1 für den Meisterarbeitsbonus, Hochkiefer und Glyphenstahl als Stufe 2, und Fertigkeiten, die über der eigenen Stufe eines Rezepts liegen, addieren ihren eigenen Punkt pro Stufe, so dass es bei Osmium drei die Kriegsaxt und der Kampfstab sind, die den Materialvorteil tragen, und eine Sprosse entwickelt sich immer besser, nachdem man ihr entwachsen ist.\n\nFahren Sie mit der Kupfersprosse auf 25, trainieren Sie die Eisensprosse an dem Tag, an dem sie sich öffnet, und fahren Sie sie auf 50, dann die Osmiumsprosse auf 75. Nach 75 gibt es noch keine höheren Schiffe, also verblassen die Osmiumrezepte auf die Hälfte und dann auf ein Viertel des Gewinns: Planen Sie etwa 150 weitere Schiffe ein, um die 125-Obergrenze zu erreichen, und denken Sie an die gemeinsame Drosselung von zehn Handwerksaktionen pro Minute, wenn Sie sich zum Stapeln hinsetzen.\n\nFinanzieren Sie den Aufstieg, während Sie fortfahren: Darvas Arbeitsauftrag für die Schmiede nimmt Ihnen alle 30 Minuten acht Kupfererz für ein wenig Münze und XP ab, und die Eisen- und Osmiumsprossen verkaufen sich ehrlich an den Level-Nahkampf. Das Buch der Taten markiert Schneid und Temperament mit Fertigkeit 50 und krönt die Waffenkunst zum Großmeister mit Fertigkeit 125.',
  'guide.profPages.econ.provenanceBody':
    'Manche Artikel tragen einen Namen. Bewegen Sie den Mauszeiger darüber und der Tooltip lautet „Von so und so gesammelt“ auf einem Rohmaterial oder „Hergestellt von so und so“ auf einem fertigen Stück: das gleiche Zeichen, das angibt, wie der Artikel entstanden ist. Eine Signatur ist Teil des Artikels selbst, wandert mit ihm durch den Handel, die Bank, die Post, den Weltmarkt und sogar einen Rückkauf bei einem Händler und verblasst nie.\n\nDas Sammeln signiert seine beste Arbeit automatisch: Jede Ernte, die selten oder besser ausfällt, kommt signiert an, und seltene Funde signieren ihren gesamten fünffachen Glücksfall. Die Glücksrolle einer Leichenernte signiert den Ertrag dort, wo die Familie kein Exemplar zum Verschenken hat, und wenn sie es tut, hält sie den Ertrag schlicht und prägt das signierte makellose Exemplar daneben. Bei der Herstellung von Zeichen geht es nach dem gleichen Prinzip: Jedes Exemplar einer seltenen oder besseren Ausgabe wird signiert, und ein Meisterwerk signiert immer, unabhängig von seiner Qualität, sodass die beste Version eines Stücks immer seinen Hersteller nennt. Das Einzige, was Sie eine Signatur kosten kann, ist ein voller Beutel: Eine signierte Einheit benötigt einen eigenen Platz oder einen passenden signierten Stapel, um darin zu landen.\n\nEin Stapel von Gegenständen hat dieselbe Identität, sodass zwei Kopien nur dann zusammengeführt werden, wenn alle Markierungen genau übereinstimmen: gleicher Gegenstand, gleicher Unterzeichner, gleiche Meisterwerkswerte, gleiche Verzauberung, gleiche Bindung. Ein signierter Baumstamm fügt sich niemals in beide Richtungen zu einem einfachen Stapel zusammen (durch das Zusammenführen würde jemandes Namen gelöscht), aber identische Nutzlasten verschmelzen reibungslos, sodass zwanzig vom selben Sammler signierte Erze auf einem Stapel liegen und ein Glücksfall Ihre Taschen nicht zerfetzt.\n\nUnterschriften zahlen den Handwerkern etwas zurück: Das Halten einer unterzeichneten Kopie eines benötigten Reagenzes an der Werkbank, egal, wer es unterschrieben hat, erhöht die Chance auf Meisterarbeit um 2 Prozentpunkte, und das Halten eines eigenhändig unterzeichneten Reagenzes verringert die erforderliche Menge dieses Reagenzes um eins (niemals unter eins). Ihr eigenes signiertes „Raritäts-oder-besser“-Werk lehrt Sie sogar weiterhin, heute allein durch die Flasche: Trinken Sie einen Trank, den Sie signiert haben, und ein kleiner Tropfen Geschicklichkeit fließt zurück zu dem Handwerk, das ihn gebraut hat, solange dieses Handwerk zu Ihren aktiven Hauptfächern gehört.',
  'guide.profPages.econ.throttleBody':
    'Die Ausgabe hat eine Obergrenze: Herstellung, Entzauberung, Verzauberung, Bergung und Wiederaufladung von Werkzeugeffekten teilen sich ein Budget von {actions} erfolgreichen Aktionen in jedem {seconds}-Sekundenfenster. Ein abgelehnter Versuch kostet nichts und gibt kein Budget aus. Im normalen Spiel werden Sie es nie spüren; Es existiert, damit ein maximaler Spezialist mit einer vollen Bank den Markt nicht überschwemmen kann, unabhängig von seinen Fähigkeiten oder seinem Vorrat.',
  'guide.profPages.econ.trainingNote':
    'Eine Pauschalgebühr pro Rezeptsprosse, die einmal erhoben wird, wenn ein Meister es lehrt; Jeder Abschnitt der folgenden Tabelle wird heute live verwendet, von den kostenlosen Starterrezepten bis zu den Rutenlektionen für den Werkzeugmacher oben.',
  'guide.profPages.ench.enchantsNote':
    'Verzauberungen gibt es in drei Stufen. Die Basisstufe läuft auf Chime Dust (mit etwas Essenz am oberen Ende) und deckt den Waffenplatz sowie jeden Rüstungsplatz außer der Nebenhand ab, mit genügend Stat-Achsen-Optionen, dass jeder Build für jeden Platz etwas findet. Die höhere Stufe kostet einen Glockensplitter plus Essenz: stärkere Boni auf den Plätzen mit der höchsten Wirkung. Scherben ernähren außerdem zwei weitere Waschbecken, die beiden Zauberrezepte zu je fünf Stück und die oberste Stufe der Werkzeugeffekt-Aufladungen. Sparen Sie also ein paar, bevor Sie sie ausgeben.\n\nDazwischen sitzen die fünf Runenverzauberungen, ein Verbraucher pro typisierter Sekundärseite, sodass nichts, was Sie mahlen, jemals eine Sackgasse ist: Runenkante (Waffe, Stärke, verbraucht Resonanzstahl), Runensiegel (Waffe, Intelligenz, Resonanzholz), Runengewebe (Brust, Geist, Resonanzfaden), Runenhaut (Beine, Beweglichkeit, Resonanzhaut) und Runenverbindungen (Helm, Ausdauer, Resonanzverbindungen). Jeder nimmt außerdem zwei Glockenspiel-Essenz; Wenn ein Slot und ein Wert sowohl eine Basis- als auch eine größere Verzauberung haben, landet der Runenbonus dazwischen, während Runengewebe die stärkste Brustgeistverzauberung überhaupt ist und Runenhaut die einzige Beweglichkeitsverzauberung für Beine überhaupt ist. Die genauen Boni finden Sie alle in der Tabelle unten.',
  'guide.profPages.faq.a4':
    'Du hast einen Glücksfall erwischt. Ungefähr eine von 90 Ernten löst ein seltenes Sammelereignis aus (uraltes Kernholz an einem Baum, eine makellose Ader an Erz, eine mondbeschienene Blüte an Kräutern): Es vervielfacht den Ertrag um das Fünffache, signiert jede Einheit mit Ihrem Namen und gibt den Fund der gesamten Zone bekannt. Ein seltener oder besserer Seltenheitswurf bei einer gewöhnlichen Ernte zeigt ebenfalls den Ertrag an.\n\nEs lohnt sich, signierte Materialien aufzubewahren oder teuer zu verkaufen: Das Halten einer signierten Kopie eines benötigten Reagenzes an der Werkbank erhöht die Chance auf ein Meisterwerk um 2 Prozentpunkte. Denken Sie daran, dass sie nur mit identisch signierten Kopien gestapelt werden, sodass sie ihren eigenen Taschenplatz behalten.',
  'guide.profPages.faq.a6':
    'Die neun gewöhnlichen Feldrezepte und die sechs hergestellten Landwerkzeugrezepte sind jedem von Anfang an bekannt, ebenso wie drei stationäre Decksteine ​​(der Ofenschuppen-Mantel, die Wardweave Cowl und die Duskhide Wraps), die keinen Trainer, sondern nur ihre Station benötigen. Alles andere wird von den ortsansässigen Meistern an ihren Stationen in den drei Hauptstädten unterrichtet: Die meisten stehen in Eastbrook, der Gerber betreibt die Gerberei in Fenbridge und der Alchemist betreibt die Apotheke in Highwatch.\n\nTrainerrezepte gibt es in Stufen: Fertigkeit 0, 25 und 50 für Ausrüstung und Verbrauchsmaterialien, kostenlos, 25 Silber und 1 Gold als einmalige Gebühr; Die beiden Zauberrezepte von Enchanting befinden sich auf der 25. Sprosse, und der Werkzeugmacher bringt die beiden gefertigten Angelruten bei 75 und 125 für 4 und 16 Gold bei. Ein Meister lehrt ein Rezept, sobald Ihre Klasse in diesem Handwerk die eigene Klasse des Rezepts erreicht hat, und Sie müssen an seiner Station stehen, um zu lernen: Eine mobile Station zählt nicht.',
  'guide.profPages.faq.a7':
    'Der Sammelzauber beginnt bei 2,5 Sekunden und wird auf zwei Arten verkürzt: 0,4 Sekunden für jede Werkzeugstufe, die Sie tragen und über der eigenen Stufe des Knotens führen können, und 0,15 Sekunden, sobald der Zähler Ihres Handels seinen 100er-Bereich überschreitet, mit einer Untergrenze von 1,5 Sekunden. Wenn Sie von Knoten der Stufe 1 zu Knoten der Stufe 3 wechseln, verschwindet Ihr Überschuss, sodass die gleiche Auswahl wieder langsamer schwingt. Das Halten genau der erforderlichen Stufe bringt keine Geschwindigkeit mit sich; es öffnet nur den Knoten.\n\nDer Fertigkeitsgewinn lässt auf die gleiche Weise nach wie beim Herstellen: Ein Knoten wird ausgegraut, wenn Ihre Fertigkeit über seine Stufe hinaussteigt (Knoten der Stufe 1 lehren ab Fertigkeit 75 nichts mehr). Die Antwort auf langsame Zuwächse sind also Knoten höherer Stufen. Diese benötigen ein Werkzeug mindestens ihrer Stufe in Ihren Taschen (kein Knoten wird jemals mit bloßen Händen bearbeitet, Stufe 1 eingeschlossen), und ein Landwerkzeug über Stufe 1 möchte ebenfalls zuerst seine Einsatzmarke haben, 40/70/85/100 in seinem eigenen Handel für die Stufen 2 bis 5. Angeln folgt seiner eigenen Verjüngung: volle Steigerung unter 50 Fertigkeit, die Hälfte unter 100, ein Rinnsal von 0,1 unter 150 und 0,02 darunter 200, Junk-Fänge lehren ab 100 überhaupt nichts mehr, und das Wasser selbst begrenzt die Lektion (Gewässer der Stufe 1 hören bei 100 auf, das Sumpfgebiet bei 150 zu unterrichten), sodass ein ins Stocken geratener Zähler auch bedeuten kann, dass Sie dem Wasser entwachsen sind.',
  'guide.profPages.faq.a8':
    'Teilweise. Die neun allgemeinen Feldrezepte (Starterwaffe, Rüstung, Nahrung und Tränke) können überall und jederzeit hergestellt werden, ebenso wie die drei Kombinationsrezepte der geschworenen Paare. Alles andere über ihnen ist an einen Stationstyp gebunden: Schmiede, Küche, Apotheke, Gerberei, Webstuhl oder Werkzeugfabrik, und Sie müssen sich innerhalb von 20 Metern von der Station befinden, damit das Fahrzeug durchfahren kann.\n\nBei einer Fertigkeit von 75 in einem Handwerk, auf das Sie sich spezialisieren, und zusammen mit einem Materialrabatt von 20 Prozent erhalten Sie eine mobile Station: Platzieren Sie sie auf dem Feld und sie steht 10 Minuten lang bereit und serviert die Rezepte dieses Handwerks, als wären Sie vor Ort. Die mobile Station dient nur zum Basteln: Das Erlernen von Rezepten und das Lösen von Aufträgen erfordert immer die echte Station in der Stadt.',
  'guide.profPages.fish.biteBody':
    'Nach dem Wurf kommt es zu einem verborgenen Zeitpunkt zwischen {min} und {max} Sekunden; Die Verzögerung wird entschieden, wenn die Leine landet, sodass sich keine zwei Würfe ganz gleich anfühlen. Wenn der Bobber anbeißt, haben Sie ein {reel} zweites Fenster, in dem Sie erneut auf die Rute drücken und einholen können: Rollen Sie hinein und der Fang landet, zögern Sie daran vorbei und der Fisch kommt mit nichts zu zeigen davon. Eine ganze Sitzung ist auf {cap} Sekunden begrenzt, sodass sich selbst ein stiller Zauber schnell auflöst.\n\nBessere Ruten schärfen beide Enden des Minispiels: Jede Rutenstufe über der ersten Trimmung verkürzt die längstmögliche Wartezeit um {rod} Sekunden, nie unterhalb der Drei-Sekunden-Ebene streift die oberste Rute bereits und verlängert das Rollenfenster um {reelRod} Sekunden, so dass die Ironreel die schlechteste Wartezeit auf 6,5 Sekunden mit einem 3,25-Sekunden-Fenster und die Silverstream auf 5 mit einem Fenster über 4 herunterzieht, wobei ihre Seltenheit die Rolle etwas über das hinaus verbreitert Nur die Stufe zahlt sich aus. Die schnellsten Bisse verändern nie das, was Sie halten, und eine Rute muss nur in Ihrer Tasche sein, um zu zählen.',
  'guide.profPages.fish.koiBody':
    'Jedes Gewässer im Spiel birgt den gleichen Preis: den Sunglint Koi, einen ungewöhnlichen Schimmer auf der Linie, der für einen Verkäufer 75 Kupfer und für Ihren Stolz noch etwas mehr wert ist. Seine Chancen hängen von Ihrem Fangband ab und von nichts anderem, sie sind in jeder Zone gleich: eine 1-Prozent-Reihe der Fangtabelle bei Band 0, 3 bei Band 1 und 6 bei Band 2, gezogen bei jedem eingeholten Wurf, sodass der Koi zu dem Angler kommt, der sich die tiefen Tische verdient hat. Wenn Sie einen Eintrag „Glimmer of Hope“ in Ihrem „Book of Deeds“ landen, handelt es sich um ein Sammlerzeichen ohne Renommee. Wenn es passiert, stellt das Protokoll sicher, dass Sie Bescheid wissen.',
  'guide.profPages.fish.scheduleNote':
    'Der Angelgewinn folgt einem festen Zeitplan ohne Würfel: ein voller Punkt pro Fang unter 50 Fähigkeiten, ein halber Punkt unter 100, ein Zehntel unter 150 und ein langsames 0,02-Risseln von 150 auf 200. Diese letzte Strecke ist absichtlich eine Reise mit Tausenden von Fängen: 200 ist eine Aussage, kein Stopp auf dem Weg zu etwas anderem.\n\nJunk hört bei {cutoff} ganz auf zu unterrichten: Von da an sind Unkraut und Stiefel nur noch Unkraut und Stiefel. Auch das Wasser selbst rundet die Lektion ab: Die Gewässer der Stufe 1 des Vale (und jedes junge Ufer jenseits des Landesinneren) lehren nichts über 100, das Sumpfgebiet hört bei 150 auf und nur Thornpeaks schult einen Angler bis zur 200. Ansonsten gewinnt jeder angelandete Fang mit der geplanten Rate an Wert, wenn also der Zähler stehen bleibt, sagt Ihnen der Zeitplan, dass Sie tieferes Wasser aufsuchen sollen.',
  'guide.profPages.fish.startBody':
    'Eine einfache Angelrute kostet 20 Kupfer bei Fisherman Brandt in Eastbrook (suchen Sie nach Old Salt am östlichen Rand der Stadt, an der Straße zum Mirror Lake); Bastler Gizzel, Versorger Hale in Fenbridge und Quartiermeister Bree auch in Highwatch Stock Poles. Benutzen Sie die Rute, während Sie auf das Wasser blicken, das tief genug ist, um Fische aufzunehmen, und zwar bis zu etwa 24 Yards vor Ihnen, und Ihr Bobber segelt hinaus.\n\nWährend des Kampfes, beim Schwimmen oder im toten Zustand kann man nicht werfen; die vorgesehene Haltung ist das Werfen vom Ufer aus. Allerdings wird das Wasser härter als das Land: Das Sumpfgebiet braucht mindestens den Ironreel der Stufe 2 und die Gipfel den Silverstream der Stufe 3, und eine Leine, die ohne die Rute geworfen wird, die das Wasser braucht, geht nie aus der Hand. Darüber sitzen zwei Stäbe, der Stormreel und der Tidewrought: Ingenieure fertigen sie in der Werkzeugfabrik aus dem, was eine Schnur hochzieht, und der Tauchschalter der Ertrunkene Litanei verkauft sie für Tiefenmarken hinter den Toren der Clearings, jedoch nie für Münzen. Da kein Wasser nach ihnen verlangt, erkaufen sie sich eine kürzere Wartezeit und ein breiteres Rollenfenster anstelle des Zugangs, was auf der obersten Sprosse einen Biss in nur drei Sekunden bedeutet.',
  'guide.profPages.fish.tablesNote':
    'Ihre Fähigkeiten wählen eine von drei Fangbereichen aus: Band 0 von Anfang an, Band 1 bei 100, Band 2 bei 200, wobei sich das Gewicht Zone für Zone von Müll und leeren Haken auf echten Fisch verlagert. Jede Band über der ersten benötigt auch eine Rute: Band 1 möchte die Ironreel der Stufe 2, Band 2 die Silverstream der Stufe 3. Ihr effektives Band ist das niedrigere aus dem, was Ihre Fertigkeit verdient hat, und dem, was Ihre Rute unterstützt, und die Obergrenze ist still: Mit einer geringeren Rute fangen Sie immer noch, knapp über dem Tisch des unteren Bandes. Wenn sich Ihre Fänge also festklemmen, während Ihre Fertigkeit steigt, überprüfen Sie zuerst Ihre Rute.\n\nIn den Gewässern jeder Zone gibt es ein eigenes Paar Speisefische, die umso besser heilen, je tiefer die Zone ist. Sie alle sind Kochzusätze und eignen sich hervorragend zum Sitzen und Essen, roh von der Angel. Der Rest der Tabelle ist die Steuer des Anglers: Gras, der gelegentliche Stiefel und der leere Haken, der nie ganz verschwindet. Wie viel Sie zahlen, hängt von dem Wasser ab, in dem Ihr Bobber landet, und nicht davon, wo Sie stehen: Ein Wurf reicht bis zu 24 Yards, und die Rute, die das Wasser benötigt, der Tisch, von dem es zieht, die Urkunde, die es gutschreibt, und wie weit es alle Antworten auf die Zone lehrt, zu der das Wasser gehört, wird in dem Moment entschieden, in dem die Angelschnur landet. Das Wasser jeder Zone ist für ein eigenes Band geschrieben, das Tal für Band 0, das Sumpfgebiet für Band 1, die Gipfel für Band 2, und wenn Sie unter einem Band angeln, werden etwa ein Drittel Ihrer Würfe zu leeren Haken, zwei Bänder darunter sind mehr als die Hälfte. Die Rute bringt dich zum Wasser; Es ist die Fähigkeit, die es auszahlt, und der Aufstieg ist es, der den Angler tiefer in die Tiefe zieht, denn bessere Angelplätze bedeuten nicht nur bessere Bezahlung: Jenseits des Tals sind sie die einzigen Gewässer, die weiterhin Unterricht geben. Der {rare} ist die einzige Reihe, die Ihrem Fangband entspricht und nichts anderes: die gleichen Chancen in jeder Zone und sechsmal wahrscheinlicher bei Band 2 als bei Band 0, also ist das Seltenste auf dem Dock das, in dem ein Meisterangler wirklich besser ist.',
  'guide.profPages.gainBody':
    'Der Gewinn ist deterministisch, niemals ein Fähigkeitsaufstiegswurf: Ein Knoten auf oder über Ihrer Gewinnstufe lehrt einen vollen Punkt pro Ernte, und jede {step}-Kenntnis ist eine Stufe, die gegen den Knoten gewertet wird. Knoten der Stufe 1 zahlen unter 25 den vollen Betrag, bis 49 die Hälfte, bis 74 ein Viertel und ab 75 nichts; Tier-2-Knoten zahlen vollständig bis 49; Die beiden Tier-3-Knoten jedes Handels zahlen den vollen Betrag von 74,5 bis zur Obergrenze von {cap}.\n\nDie geplante Route ist klar: Lernen Sie an den Startknotenpunkten des Vale, gehen Sie zum Sumpfgebiet und beenden Sie den Aufstieg auf der Anhöhe von Thornpeak Heights. Bei der Obergrenze hört das Lernen auf, die Erträge jedoch nicht: Ein Sammler mit Obergrenze rollt für immer die besten Quoten aus, die der Handel bietet.',
  'guide.profPages.gatherDeeds.fishing':
    'Der 100. Meilenstein trägt die Aufschrift „Old Salt“ und der 200. zeigt „Master Angler“ mit seinem Titel, der absoluten Spitze der Anglerkunst; Angeln zählt auch für den Meistersammler, der bei 100 in drei beliebigen Sammelberufen verdient wird. Ein erster Fisch aus jedem der Gewässer der sechs Zonen füllt eine eigene Seite, die drei Kernlandzonen und das Weidenmoor, das Galecrest und das Farshore dahinter sowie der Sunglint Koi zeichnen Glimmer of Hope auf, sodass Reisende mit einer Angelrute im Rucksack ihr Buch schneller füllen, als sie erwarten.',
  'guide.profPages.gatherIntro.fishing':
    'Das Fischen ist unter den Sammelberufen das seltsamste und tiefgründigste: ein echtes Minispiel zum Anbeißen und Rollen, eigene Fangtabellen in jeder der drei Kernlandzonen (die jungen Gewässer dahinter dienen vorerst alle dem Tisch des Tals) und eine Fähigkeitsobergrenze von 200, doppelt so hoch wie die der anderen. Kaufen Sie eine Angelrute, blicken Sie ins offene Wasser und werfen Sie aus.',
  'guide.profPages.gatherIntro.herbalism':
    'Die Kräuterkunde sammelt, was wild wächst: Glanzblatt in Eastbrook Vale, Goldblatt in Mirefen Marsh, Sonnenblütenblatt in Thornpeak Heights und Starterbeete in jeder jüngeren Zone, die Blätter und Stängel, die das Apothekergewerbe am Laufen halten. Offen für alle ab Level 1 mit einer Kräutersichel im Gepäck (20 Kupfer an den Schaltern in Eastbrook, Fenbridge und Highwatch), verfolgt an einem eigenen Schalter bis zu einer Obergrenze von 100.',
  'guide.profPages.gatherIntro.logging':
    'Der Holzeinschlag fällt Holz aus Baumbeständen auf der ganzen Welt: Eisenrinde in Eastbrook Vale, Eschenholz in Mirefen Marsh, Hochkiefern in Thornpeak Heights und Starterbestände in allen jüngeren Zonen, das Rohholz für Stiele, Dauben und die Ingenieursbank. Offen für alle ab Level 1 mit einer Holzfälleraxt in der Tasche (20 Kupfer an den Schaltern in Eastbrook, Fenbridge und Highwatch), verfolgt an einem eigenen Schalter bis zu einer Obergrenze von 100.',
  'guide.profPages.gatherIntro.mining':
    'Der Bergbau fördert Erz direkt aus dem Gestein der Welt: Kupfer in Eastbrook Vale, Eisen in Mirefen Marsh und Osmium in Thornpeak Heights, wobei Starteradern in jeder jüngeren Zone dahinter verstreut sind und die Schmiedehandwerke versorgen. Ab Level 1 für alle zugänglich: Ein 20-Kupfer-Minenpickel von einem Eastbrook-, Fenbridge- oder Highwatch-Schalter öffnet jede Starterader, und die höheren Sprossen der Pickleiter erwachen, wenn Ihr eigener Zähler sie verdient. Wird auf einem eigenen Zähler bis zu einer Obergrenze von 100 verfolgt.',
  'guide.profPages.howBody':
    'Öffne das Herstellungsfenster (Standardtaste T) und jedes Rezept, das du kennst, wird mit dem, was es benötigt und was du zur Hand hast, aufgelistet. Stationsgebundene Rezepte erfordern, dass Sie sich in einem Umkreis von 20 Metern um die richtige Station in der Stadt aufhalten, Feldrezepte können überall hergestellt werden, und für das Brechen und Verzaubern von Verzauberungen ist überhaupt keine Station erforderlich (nur die beiden Zauberrezepte sind Stationsarbeit in der Werkzeugfabrik). Es gibt keinen Misserfolgswurf: Ein Handwerk mit den vorhandenen Materialien gelingt immer.\n\nZwei kleine Reibungen halten die Wirtschaft ehrlich. Für jede erfolgreiche Herstellung wird eine Gebühr von 2 Kupfer pro Punkt des Stat-Budgets des Gegenstands gezahlt, und Handwerksaktionen teilen sich ein Tempo: höchstens 10 Herstellungen, Entzauberungen, Verzauberungen, Wiederverwertungen oder Werkzeugaufladungen in jedem 60-Sekunden-Fenster. Beides wird eine normale Sitzung nicht stören; Beide verhindern, dass ein maximaler Spezialist den Markt überschwemmt.',
  'guide.profPages.masterworkBody':
    'Jedes erfolgreiche Handwerk hält genau das, was das Rezept verspricht, und manchmal noch ein bisschen mehr: Ein Meisterwerk vollendet das gleiche Stück um eine Qualitätsstufe besser, wobei die Bonuswerte beim Herstellen integriert werden. Es handelt sich nur um Add-Ons, niemals um ein Downgrade, und es bleibt unterhalb der Raid-Ebene, sodass hergestellte Ausrüstung ausgezeichnet sein kann, ohne einen Raid-Drop zu ersetzen.\n\nDie Chance wird veröffentlicht und ist nicht mystisch: {base}% Basis, plus {perTier}% pro Stufe, auf der Ihre Fertigkeit über dem Rezept steht, plus {signed}%, wenn ein signiertes Reagenz eingesetzt wird, plus {spec}%, sobald Sie spezialisiert sind, wobei höherstufige Materialien 1 bis 2 % mehr hinzufügen, alles auf {cap}% begrenzt. Nur ein Teil mit echten Werten kann sich verbessern, daher werden Güter, Werkzeuge und Verbrauchsgüter ohne Status nie ausgelöst. Ein ruhendes Handwerk bringt niemals eines hervor, und ein Hobbyhandwerk kann seine seltene Obergrenze nicht überschreiten.\n\nGute Arbeit trägt ihren Schöpfer. Seltenere und bessere Ausgaben werden signiert, jedes Exemplar (hergestellt von; gesammelte Materialien werden gesammelt von), ein Meisterwerk wird unabhängig von seiner Qualität immer signiert. Eine Unterschrift ist die Herkunft, kein Schloss: Unterschriebene Waren können frei gehandelt, verschickt und auf den Weltmarkt gebracht werden.',
  'guide.profPages.priceNone': 'Nicht gegen Münze verkauft',
  'guide.profPages.rhythmBody':
    'Bei einer Ernte handelt es sich um einen kurzen, sichtbaren Wurf, nicht um einen sofortigen Zugriff: {base} Sekundenbasis, niemals unter einem {floor} zweiten Stock. Das Tragen eines Werkzeugs über der Stufe des Knotens, eines, das Sie aufgrund Ihrer Fähigkeiten verwenden können, beschleunigt Sie um {tool} Sekunden pro Stufe darüber, und jede Fähigkeitsstufe, die Sie überschreiten, verkürzt sich um weitere {band} Sekunden; Allein die Anpassung an die Stufe des Knotens bringt Sie in die Tür, die Stufen darüber machen Sie schnell.\n\nEin voller Beutel lehnt den Zauber höflich ab, bevor er beginnt, sodass mitten im Schwung nichts verschwendet wird und jede Ernte einen kleinen Anteil an Charakter-XP einbringt, skaliert durch die Stufe des Knotens im Vergleich zu Ihrer eigenen, so wie Tötungs-XP skaliert: Ein trivialer grauer Knoten bringt einem Charakter mit einer Obergrenze nichts bei.',
  'guide.profPages.specimenBody':
    'Halten Sie beim Farmen etwas Platz für den Beutel frei: Ein signierter Glücksfall braucht Platz oder einen passenden signierten Stapel, um darin zu landen, und wenn nichts hineinpasst, kommt der Ertrag trotzdem an, aber die Signatur geht verloren. Die Leichenernte hat auch ihren eigenen Jackpot-Arm: Etwa {pct} % jeder geernteten Komponente kommt selten oder besser heraus. Eine Familie, die ein perfektes Exemplar zu verschenken hat (Haut, Seide, Gift, Fleisch), behält ihren gewöhnlichen Ertrag bei und prägt das signierte Exemplar daneben; jede zweite Familie unterschreibt die Rendite selbst.',
  'guide.profPages.toolCraftedOrMarks':
    'Hergestellt ({craft}) oder {marks} Tiefenmarken nach drei Ertrunkene Litanei-Abschlüssen',
  'guide.profPages.toolCraftedOrMarksHeroic':
    'Hergestellt ({craft}) oder {marks} Tiefenmarken nach einem heroischen Ertrunkene Litanei klar',
  'guide.profPages.toolsNote':
    'Jeder Knoten benötigt das Werkzeug seines Handels in Ihren Taschen, einschließlich Stufe 1: keine Spitzhacke, kein Erz und keine Stange, kein Fisch. Die Händlerleiter deckt die Stufen 1 bis 3 in den drei Kernlandzentren ab: Das Werkzeug der Stufe 1 wird an allen drei Standorten verkauft, die Sprossen darüber beginnen dort, wo der Boden beginnt, auf dem es verwendet wird (Fenbridge fügt Stufe 2 hinzu, Highwatch Stufe 3), und in den jüngeren Siedlungen dahinter gibt es überhaupt keine Werkzeuge, also rüsten Sie sich aus, bevor Sie reisen. Jeder Schalter verkauft jede Sprosse, die er vorrätig hat, frei, und jedes Werkzeug wird direkt gehandelt. Jede Sprosse ist auch auf dem Markt gelistet und wird per Post verschickt, mit Ausnahme der drei 20-Kupfer-Landstarter: Diese werden an einem Schalter gekauft oder von Hand zu Hand weitergegeben und niemals zurückverkauft, verschickt oder gelistet. Was eingezäunt ist, ist das Ausüben. Ein Landwerkzeug über Stufe 1 funktioniert nur, wenn Sie es durch Ihre Kenntnisse in seinem eigenen Handwerk verdient haben, {tier2Prof} für Stufe 2, {tier3Prof} für Stufe 3 und 85 und 100 für die beiden hergestellten Sprossen, und die Anbieterzeile, der Tooltip und die Tabelle unten nennen alle die Anforderungen im Voraus. Bis dahin wartet ein im Voraus gekauftes Werkzeug einfach in Ihren Taschen, öffnet keinen Boden, kauft keine Geschwindigkeit und prägt keine guten Qualitäten und wird dann eingesetzt, sobald Ihr Zähler seine Nummer berührt. Angelruten sind die einzige Ausnahme: Für keine Rute ist eine Handhabung erforderlich, und Trader Wilkes in Eastbrook hat bewusst die Ruten der Stufen 2 und 3 für Angler vorrätig, die im Voraus kaufen. Ein Werkzeug belegt niemals einen Ausrüstungsplatz und nutzt sich nie ab, daher handelt es sich bei jedem Werkzeug um einen einmaligen Kauf, und für das Tor ist nur die Stufe von Bedeutung: Ein selteneres Werkzeug derselben Stufe eröffnet keine zusätzlichen Vorteile. Seltenheit ist jedoch nicht nur Farbe. Dadurch hält der Effekt eines geschlitzten Werkzeugs länger an und bei einer Rute wird das Rollenfenster erweitert.\n\nMit einem besseren Werkzeug lassen sich drei Dinge kaufen, nicht zwei. Es erschließt höherstufiges Gelände, verkürzt den Wurf und verbessert das, was dabei herauskommt: Bearbeiten Sie eine Ader mit einem Werkzeug, das ÜBER dem eigenen Material der Zone liegt, und die Ernte liefert die feine Qualität davon anstelle der einfachen. Der Erzgang muss einer der vollwertigen Erzgänge der Zone sein, sodass die einfacheren Erzgänge, die eine Zone für Reisende bereithält, immer noch das gewöhnliche Material liefern. Feine Materialien werden von den Rezepten für hergestellte Werkzeuge verbraucht, und eine feine Qualität gilt überall dort, wo ein Rezept oder ein Arbeitsauftrag danach verlangt, als gewöhnliche Version, so dass Sie mit der Aufwertung nie im Stich gelassen werden: Es bedeutet lediglich, dass Ihr Kupfererz als Feinkupfererz ankommt.\n\nOberhalb der Händlerleiter hat jeder Beruf zwei gefertigte Werkzeuge, Stufe 4 und Stufe 5, die in der Werkzeugfabrik hergestellt werden (jeder Charakter kennt die Rezepte des Landes; die Fertigkeit, die für die Arbeit aufsteigt, ist die des Ingenieurswesens) oder mit Tiefenmarken am Ertrunkene Litanei-Schalter gekauft werden, sobald die Punkte erreicht sind: In der Tabelle unten sind der Markenpreis und die für jede Stufe geforderten Anzahl an Gegenständen aufgeführt. Kein Händler verkauft sie jemals gegen Münzen. Beim Angeln gibt es ein eigenes Paar, und sie werden vom Werkzeugmacher gelernt und sind nicht von Anfang an bekannt. Heutzutage benötigt kein Knotenpunkt und kein Wasser mehr als Stufe 3, daher kaufen die obersten beiden Sprossen Geschwindigkeit, Steigung und ein günstigeres Rollenfenster anstelle von Zugang, und sie werden die Eintrittskarte sein, wenn höherstufiger Boden eintrifft.',
  'guide.profPages.trainingBody':
    'Die Trainerrezepte stammen von den ansässigen Meistern und werden an ihren Stationen unterrichtet. Die Regel besteht aus einer Zeile: Ein Meister lehrt ein Rezept, sobald Ihre Handwerksstufe die eigene Stufe des Rezepts erreicht hat, und nichts anderes grenzt es ein, weder Ihre Stufe noch Ihr Archetyp. Die Ausrüstungs- und Verbrauchsleitern laufen auf den Stufen 0, 25 und 50; Die beiden Rutenlektionen von Engineering setzen die Leiter bei 75 und 125 fort, und die beiden Zauberrezepte von Enchanting befinden sich auf der 25. Sprosse, sodass eine neue Sprosse geöffnet wird, wenn Ihre Stufen aufsteigen.\n\nDie Gebühren sind einmalig und pauschal pro Sprosse: Die Startsprosse ist kostenlos, die Fertigkeit 25 Sprosse kostet {tier1} ein Rezept, die Fertigkeit 50 Sprosse {tier2} und für die darüber liegenden Rutenstunden fallen eigene Gebühren an, die neben jedem Rezept in der Tabelle aufgeführt sind. Sie müssen zum Trainieren an der tatsächlichen Station des Masters stehen, und eine mobile Station zählt nie. Die gewöhnlichen Feldrezepte und die sechs hergestellten Landwerkzeugrezepte erfordern überhaupt keine Schulung; Jeder Charakter kennt sie von Anfang an.',
  'guide.profPages.wieldNone': 'Beliebig',
  'guide.professions.archetypeSwitchBody':
    'Eine Erklärung ist auch keine lebenslange Haftstrafe. Ein Paar, das Sie noch nie gehalten haben, ist lediglich eine neue Einstimmungsquest, während Sie bei der Rückkehr zu einem Paar, von dem Sie weggegangen sind, zuerst aufgefordert werden, es wieder gut zu machen: fünf Aufgaben beim ersten Mal und drei weitere für jede Rückkehr, die Sie bereits gemacht haben (die Aufnahme eines brandneuen Paares erhöht die Anzahl nie). Die Wahl bleibt sinnvoll, ohne jemals eine Tür endgültig zu verschließen.',
  'guide.professions.archetypesBody':
    'Die zehn Handwerke sitzen auf einem festen Rad, und die Geographie auf diesem Rad ist von Bedeutung. Jeweils zwei Nachbarn bilden ein benanntes Paar: Schmied für Waffen- und Rüstungsherstellung, Ausrüster für Lederverarbeitung und Schneiderei, Apotheker für Alchemie und Kochen, Bombardier für Technik und Alchemie und sechs weitere im Ring.\n\nDas Einstimmen auf ein Paar ist eine Aufgabe und kein Menüklick. Heute können vier Paare zusammengeschlossen werden (Smith, Outfitter, Apothecary und Bombardier), die jeweils von einem in Eastbrook ansässigen Meister verankert werden, dessen Annahmequest den gesamten Handel im Voraus beschreibt, bevor Sie ihn annehmen. Bis du es deklarierst, schreitet jedes Handwerk mit Rezepten bis zur seltenen Stufe frei voran (jedes Rezept erfordert Fertigkeit 74 oder weniger), sodass du fast alles ausprobieren kannst, bevor du dich entscheidest (In der Ingenieurskunst allein gibt es kein Rezept, das so niedrig ist, daher wartet die Anzahl).\n\nSobald Sie sich darauf eingestellt haben, werden Ihre zwei Paar-Handwerke zu Ihren Hauptfächern, wobei keine Obergrenze unter der Obergrenze liegt. Der Rest des Rades wird nicht dunkel: Ein Handwerk gegenüber Ihren Hauptfächern bleibt als Hobby bestehen, das immer weiter in der seltenen Stufe aufsteigt (eine wiederholbare Quest in Smith Haldrens Schmiede ermöglicht es Ihnen, welches zu tauschen), und alle anderen Handwerke gehen in den Ruhezustand. Ein ruhendes Handwerk behält seine Fertigkeit und seine allgemeinen Rezepte, die ihm auf der normalen Kurve weiter beibringen, bis sie bei 75 ergrauen; Alles, was über dem Normalen liegt, hört auf einmal auf, sich zu lohnen, und ein ruhendes Handwerk erweist sich nie als Meisterwerk, solange es ruht.',
  'guide.professions.startBody':
    'Frisch von der Straße in Eastbrook? Finden Sie Vorarbeiter Odell und nehmen Sie „A Trade for Every Hand“ an: Er zeigt Ihnen die Erzadern rund um die Copper Dig südöstlich der Stadt und reicht Ihnen Ihre ersten Schwielen. Achten Sie auf die Ausgrabung selbst: Die Deeprock Diggers, die dort ihr Lager aufgeschlagen haben, stehen ein paar Ebenen über einem Neuankömmling, bearbeiten Sie also zuerst die äußeren Adern und bewahren Sie das Herzstück des Lagers auf, wenn Sie ein wenig eingeebnet sind. Von da an ernten Sie jede Ader, jeden Holzbestand und jedes Kräuterbeet, an dem Sie während der Quest vorbeikommen. Kompetenz ist für Reisende eine Selbstverständlichkeit.\n\nZurück in der Stadt drücken Sie T, um das Handwerksfenster zu öffnen und die üblichen Rezepte auszuarbeiten, die jeder Charakter von Anfang an kennt. Besuchen Sie die Meister in der Schmiede, in der Küche, am Webstuhl und in der Werkzeugfabrik, um zu sehen, was sie unterrichten, und nehmen Sie ihre Arbeitsaufträge gegen eine feste Münze entgegen. Wenn der Brief der Gilde Sie erreicht, wissen Sie bereits, welches Paar sich wie zu Hause fühlt.',
  'guide.professions.whatBody':
    'Berufe sind das Arbeitsleben der Welt: vier Sammelberufe, die Rohstoffe direkt aus dem Land holen, und ein Ring aus zehn Handwerken, die daraus Ausrüstung, Mahlzeiten, Tränke und Werkzeuge herstellen. Hier nährt alles etwas anderes. Das abgebaute Erz wird zu einer Klinge, die Klinge wird verzaubert und für die Verzauberung muss Staub aus alter Ausrüstung herausgebrochen werden. Ein Sammler, ein Handwerker und ein Tüftler sind also alle Glieder einer Kette.\n\nEs gibt keine Berufsgrenze, über die man sich den Kopf zerbrechen muss. Jeder Charakter kann sieben der acht Handwerke erlernen, die heute Inhalt haben, und alle vier Sammelberufe nebeneinander (die Ingenieurskunst ist die einzige Ausnahme: Ihre Rezepte beginnen alle oberhalb der freien Obergrenze, daher wartet ihre Leiter auf den Eid des Bombenschützen); Die einzige exklusive Wahl ist Ihr Archetyp, die Identität, auf die Sie schließlich schwören. Sobald Sie jedoch die Handwerke, die dahinter schlummern, eingestimmt haben, greifen Sie nur auf ihre gemeinsamen Rezepte zurück und über Fertigkeit 75 hinaus überhaupt nicht. Die Fähigkeiten gehen niemals verloren, und nichts, was Sie gelernt haben, wird jemals wieder weggenommen.',
  'hudChrome.actionBar.bannerCapturing': 'Drücken Sie eine Taste, um diesen Slot zu binden ...',
  'hudChrome.actionBar.bannerHint':
    'Klicken Sie auf einen Steckplatz und drücken Sie dann eine Taste, um ihn zu binden. Klicken Sie auf Fertig, wenn Sie fertig sind.',
  'hudChrome.actionBar.boundToKey': 'Gebunden an {key}.',
  'hudChrome.actionBar.cancel': 'Stornieren',
  'hudChrome.actionBar.done': 'Erledigt',
  'hudChrome.actionBar.editKeys': 'Bearbeiten Sie die Tasten der Aktionsleiste',
  'hudChrome.actionBar.editKeysHint':
    'Klicken Sie auf einen Slot in der Aktionsleiste und drücken Sie dann eine Taste, um ihn zu binden.',
  'hudChrome.actionBar.reset': 'Zurücksetzen',
  'hudChrome.actionBar.resetConfirmBody':
    'Der erste Takt kehrt zu seinen Standardtonarten zurück. Der zweite und dritte Balken werden ungebunden. Dies kann nicht rückgängig gemacht werden.',
  'hudChrome.actionBar.resetConfirmTitle': 'Aktionsleistentasten zurücksetzen?',
  'hudChrome.bags.filterTool': 'Werkzeuge',
  'hudChrome.crafting.identity.allCrafts': 'Alles Kunsthandwerk',
  'hudChrome.crafting.identity.skillListAria': 'Handwerkliche Fähigkeiten',
  'hudChrome.crafting.reagentFineSub': '(gibt {count} Feinstufe aus)',
  'hudChrome.deeds.broadcastsLabel':
    'Teilen Sie freigeschaltete Taten mit Gildenmitgliedern und Anhängern sowie Taten- und Meisterwerkskarten mit dem Discord-Feed',
  'hudChrome.gathering.emptyHookNote': 'Nichts am Haken',
  'hudChrome.gathering.fineGradePreview':
    'Ihr Werkzeug verfeinert diese Ausbeute zu einer feinen Qualität.',
  'hudChrome.gathering.respawnClock': '{minutes}:{seconds}',
  'hudChrome.gathering.stateCooldownTimed': 'Respawnt in {time}',
  'hudChrome.gathering.toolTierUnmet.fishing':
    'Zum Angeln in diesen Gewässern benötigen Sie eine Angelrute der Stufe {tier}.',
  'hudChrome.gathering.toolTooltip.unlocks.fishing':
    'Erforderlich zum Fischen in Gewässern bis Stufe {tier}.',
  'hudChrome.gathering.wieldUnmet.herbalism':
    'Sie benötigen Herbalism {skill}, um die Sichel bereits in Ihren Taschen zu bearbeiten.',
  'hudChrome.gathering.wieldUnmet.logging':
    'Sie benötigen Logging {skill}, um die Axt bereits in Ihren Taschen zu schwingen.',
  'hudChrome.gathering.wieldUnmet.mining':
    'Sie benötigen Mining {skill}, um die Spitzhacke bereits in Ihren Taschen zu schwingen.',
  'hudChrome.gathering.wieldUnmetCorpse':
    'Sie benötigen die Fähigkeit {skill}, Ihr bestes Werkzeug zum Einsatz zu bringen.',
  'hudChrome.materialHint.fineGrade':
    'Feine Note. Wird aus einer vollstufigen Ader mit einem Werkzeug gewonnen, das über dem Material liegt, und gilt als die gewöhnliche Version, wo immer eine benötigt wird.',
  'hudChrome.professions.toolEffectCharges': '{charges} von {max} Gebühren',
  'hudChrome.professions.toolEffectConfirmAccept': 'Benutze eine Ladung',
  'hudChrome.professions.toolEffectConfirmBody':
    'Für diese Ernte eine Gebühr ausgeben? Ablehnend sammelt sich immer noch, ohne den Bonus. Verbleibende Gebühren: {charges}.',
  'hudChrome.professions.toolEffectConfirmDecline': 'Ohne sammeln',
  'hudChrome.professions.toolEffectConfirmTitle': '{effect} verwenden?',
  'hudChrome.professions.toolEffectDepleted': 'Werkzeugeffekt verbraucht',
  'hudChrome.professions.toolEffectModeAsk': 'Fragen Sie jeden Einsatz',
  'hudChrome.professions.toolEffectModePrompt': 'Fragt jeden Einsatz',
  ...
  'hudChrome.professions.toolEffectName.quickeningCharm': 'Rückfederungs-Charme',
  'hudChrome.professions.toolEffectNoCharm':
    'Sie benötigen einen handgefertigten {effect}-Anhänger in Ihren Taschen.',
  'hudChrome.professions.toolEffectNoGain':
    '{effect} ist bereits eingesteckt und vollständig aufgeladen.',
  'hudChrome.professions.toolEffectNoTool': 'Sie benötigen zunächst ein echtes {profession}-Tool.',
  'hudChrome.professions.toolEffectRechargeButton': 'Aufladen',
  'hudChrome.professions.toolEffectRechargeFull': '{effect} ist bereits vollständig aufgeladen.',
  'hudChrome.professions.toolEffectRechargeMaterials':
    'Das Aufladen von {effect} erfordert {material} x{count}.',
  'hudChrome.professions.toolEffectRechargeNoSlot': 'Auf {profession} ist kein Effekt geslotet.',
  ...
  'hudChrome.professions.toolEffectRechargeToolCapped':
    'Nehmen Sie ein besseres {profession}-Werkzeug mit, um {effect} weiter aufzuladen.',
  'hudChrome.professions.toolEffectRecharged':
    '{effect} aufgeladen: {material} x{count} verbraucht.',
  'hudChrome.professions.toolEffectSlotButton': 'Steckplatz {effect}',
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} kann dort nicht geslotet werden.',
  'hudChrome.professions.toolEffectSlotted': '{effect} geschlitzt auf {profession}.',
  'hudChrome.professions.toolEffectSpent': 'Verbraucht, muss aufgeladen werden',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    'Dies ist ein Übungskampf, daher wird er nicht gewertet: Die Rangliste ändert sich nicht und der Fortschritt im Buch der Taten zählt nicht.',
  'hudChrome.vcup.briefing.unratedNote':
    'Bots sind auf dem Spielfeld, daher wird dieser Kampf nicht gewertet: Die Rangliste ändert sich nicht und Taten für Tore, Paraden und Gegentreffer zählen nicht.',
  'hudChrome.vcup.practiceUnratedNote':
    'Übungskämpfe werden nicht gewertet: Platzierungen und Fortschritte im Book of Deeds zählen nicht.',
  'hudChrome.vcup.rolesSmallBracketNote':
    'In den Klassen 1v1 und 2v2 spielt jeder Kämpfer das Allrounder-Kit. Taten, die die Stufe 3 gegen 3 oder höher erfordern, können hier nicht verdient werden.',
  'itemUi.bags.unknownItem': 'Unbekannter Artikel',
  'itemUi.bags.unknownItemAria': 'Unbekannter Artikel {id}, Menge {count}',
  'itemUi.bags.unknownItemAriaBound':
    'Unbekannter Artikel {id}, Menge {count}, gebundenes Exemplar',
  'itemUi.bags.unknownItemAriaEnchanted':
    'Unbekannter Artikel {id}, Menge {count}, verzauberte Kopie',
  'itemUi.bags.unknownItemAriaInstanced':
    'Unbekannter Artikel {id}, Menge {count}, vom Hersteller gekennzeichnetes Exemplar',
  'itemUi.bags.unknownItemAriaMasterwork': 'Unbekannter Artikel {id}, Menge {count}, Meisterwerk',
  'itemUi.kind.fineMaterial': 'Feines Material',
  'itemUi.vendor.buyCountAria': 'Kaufen Sie {count} von {item} für {price}',
  'itemUi.vendor.buyCountAriaWithRequirement':
    'Kaufen Sie {count} von {item} für {price}. {requirement}',
  ...
  'itemUi.vendor.qtyCustom': 'Brauch',
  'itemUi.vendor.qtyCustomAria': 'Wählen Sie einen benutzerdefinierten Kaufbetrag',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Kaufen Sie jeweils {count}',
