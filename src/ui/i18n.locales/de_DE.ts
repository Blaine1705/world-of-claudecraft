...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolsNote':
    'Jeder Knoten verlangt das Werkzeug seines Berufs in deinen Taschen, Stufe 1 eingeschlossen: ohne Spitzhacke kein Erz, ohne Angel kein Fisch. Die Händlerleiter deckt Stufe 1 bis 3 ab, und jeder Knotenpunkt führt nur die Stufen, die sein eigenes Gelände braucht: Das Werkzeug der Stufe 1 wird in jedem Zonenknotenpunkt verkauft, die Sprossen darüber werden dort verkauft, wo die passenden Vorkommen liegen. Für diese Sprossen verlangen Händler außerdem Fertigkeit im jeweiligen Beruf, {tier2Prof} für Stufe 2 und {tier3Prof} für Stufe 3, und die Zeile nennt die Voraussetzung. Ein Werkzeug muss nur in deinen Taschen sein, es gibt keinen Ausrüstungsplatz und keine Haltbarkeit, sodass jedes ein Einmalkauf ist, und was du bereits besitzt, funktioniert weiter. Nur die Stufe ist für die Voraussetzung relevant: Die Seltenheitsfarbe eines Werkzeugs ist kosmetisch.\n\nOberhalb der Händlerleiter sitzen zwei hergestellte Werkzeuge, Stufe 4 und Stufe 5, gefertigt in der Werkzeugmacherei von Ingenieuren und von keinem NSC verkauft. Kein Knoten benötigt heute mehr als Stufe 3, daher liegt ihr Wert im Moment in der Geschwindigkeit: Ein Spitzenwerkzeug fixiert die Sammelzeit bei niedrigeren Knoten auf ihrem Minimum, und es wird die Eintrittskarte sein, wenn höherstufiges Gelände erscheint.',
