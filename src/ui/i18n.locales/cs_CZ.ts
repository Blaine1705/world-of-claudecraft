...
export const cs_CZ: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.artisans_eye.name': 'Oko řemeslníka',
  'entities.items.fine_ashwood_log.name': 'Jemný Ashwood Log',
  'entities.items.fine_copper_ore.name': 'Jemná měděná ruda',
  'entities.items.fine_elderwood_log.name': 'Jemný Highpine Log',
  'entities.items.fine_goldleaf_herb.name': 'Jemná zlatolistá bylina',
  'entities.items.fine_iron_ore.name': 'Jemná železná ruda',
  'entities.items.fine_ironbark_log.name': 'Jemný protokol Ironbark',
  'entities.items.fine_silverleaf_herb.name': 'Jemná listová bylina',
  'entities.items.fine_sunpetal_herb.name': 'Jemná slunečnicová bylina',
  'entities.items.fine_thorium_ore.name': 'Jemná Osmium Ruda',
  'entities.items.gatherers_cache.name': 'Sběratelská mezipaměť',
  'entities.items.stormreel_fishing_rod.name': 'Rybářský prut Stormreel',
  'entities.items.tidewrought_fishing_rod.name': 'Tidewrought rybářský prut',
  'entities.quests.q_nythraxis_graves.text':
    'Tyto značky jsem viděl již dříve, na třech starých hrobech kolem severního bojiště. Kapitán Aldren leží na západním svahu, velekněz Malric dále na jih podél západního okraje a Royal Assassin Voss u východního útesu. Dotkněte se každého hrobu a poslouchejte, {playerName}. Mrtví si mohou pamatovat to, co živí zapomněli.',
  'entities.quests.q_the_codfather.text':
    'Codfather není jen ryba, {playerName}, je to chladnokrevný zabiják. Starobylí přísahají, že snídá Mire Prowlers, a dokonce ani Mirefen Widows nebudou spřádat své sítě poblíž Deepfen Shallows z čiré hrůzy. Vládne těmto vodám a bažinatá voda si vezme Ironreel Fishing Rod, ne méně; můj pult je prodává. Vezměte si jednoho do ruky, vytáhněte toho starého ďábla z jeho vod a přiznám se, že jste se přidali k rodině.',
  'guide.profPages.bandsBody':
    'Pásma odbornosti jsou sdíleným žebříčkem 0/100/200 nad obchodním pultem. V případě pozemkových obchodů překročila skupina 100 oholení a jejich čepice dělá z kapely 1 strop. Rybářské kapely nic neholí: vybírají tabulky úlovků (s odpovídajícím prutem), pouze rybaření dosahuje pásma 2 a samotné stoupání táhne rybáře do hlubší vody, kde žijí lepší stoly a další lekce.',
  'guide.profPages.colWield': 'Použijte při',
  'guide.profPages.craftIntro.enchanting':
    'Enchanting rozebere výbavu a vloží sílu zpět: rozbijte nechtěné kousky na tajemné materiály a poté je utraťte za permanentní statový bonus za díl, který si chcete ponechat. Lámání a čarování nepotřebuje žádnou stanici ani trenéra a kdokoli může začít v první den; jen dva kouzelné recepty vyžadují více, učil je v nástrojárně.',
  'guide.profPages.craftIntro.engineering':
    'Inženýrství vyrábí nástroje, které každý seriózní sběrač nakonec potřebuje: trsátka 4. a 5. úrovně, sekery, srpy a rybářské pruty, které žádný pult nikdy neprodá za mince, přičemž každý spotřebovává nástroj pod ním.',
  'guide.profPages.craftProse.alchemy.identityBody':
    'Řemeslo se vyrábí v lékárně v Highwatch, domovu Alchymisty Verane, mistryně lékárny, která učí žebříček receptů, prodává skleněné lahvičky za 12 mědi a platí mincemi za bylinky prostřednictvím svého pracovního příkazu.\n\nNa řemeslném kruhu sedí Alchymie s řemesly pokus-omyl, vedle inženýrství na jedné straně a vaření na straně druhé. To mu dává dvě párové identity: Bombardier (inženýrství a alchymie, ujal se před Tinker Gizzel v Eastbrooku) a lékárník (Alchymie a vaření, přísahal před Cookem Marlowem). Nalaďte se na jeden z párů, abyste z alchymie udělali hlavní obor a nechte se svým vlastním podepsaným dílem učit zpět; dvojice Bombardier také otevírá svůj kombinovaný nápoj, Medvědí elixír, zatímco dvojice Apothecary zatím nedodává žádný kombinovaný recept. Žebřík sám o sobě však nikdy nepočká, protože každý recept na alchymii se nachází ve vzácné vrstvě, pod kterou pracují nehlášená řemesla, takže celý výstup na čepici je otevřený před jakoukoli přísahou.',
  'guide.profPages.craftProse.alchemy.ladderBody':
    'Každý zná Minor Healing Potion od začátku a může ho namíchat kdekoli, není potřeba žádná stanice. Skutečným žebříčkem je devět receptů, které Verane učí v lékárně, tři na každé příčce: dovednost 0 receptů je zdarma, dovednost 25 příčka stojí 25 stříbrných za recept a dovednost 50 příček stojí 1 zlato za recept. Každá příčka je léčivý tah, mana a elixír výdrže, od běžných lahví s listovým listem (120 zdraví, 160 many) přes neobvyklý zlatý list (200 zdraví, 260 many) až po vzácný okvětní lístek (280 zdraví, 360 many).\n\nElixíry šplhají stejným způsobem: elixír kance poskytuje 6 vytrvalosti na 10 minut, elixír zmije 9 na 15 minut a elixír hada 12 na 15 minut, sám had vaří dvě lahve na plavidlo. Ještě jeden recept sedí stranou: Medvědí elixír, kombinovaný nápoj, který Verane učí za 25 stříbrných, jakmile vaše alchymie dosáhne 25, lze míchat kdekoli, ale pouze vyladěným Bombardierem s alchymií a inženýrstvím na 25.',
  'guide.profPages.craftProse.alchemy.routeBody':
    'Návrhy a elixíry nikdy nepřeválcují mistrovská díla; že proc patří mezi stat-ložisek ozubení. Vaše jméno však stále putuje: vzácné návrhy slunečních okvětních lístků přicházejí podepsané značkou výrobce a stejně tak každá láhev dvojitého elixíru hada, takže nic vzácného v tomto řemesle nenechá lavici nepodepsané. V dovednosti 75 se specializujete a každý recept na alchymii od té doby stojí o 20 procent méně materiálů.\n\nVezměte Herbalism brzy a sbírejte, jak budete levelovat: Sheenleaf je všude ve Vale, a jakmile se dostanete na Veraneovu lavičku, volná příčka vás čistě přenese na dovednost 25 na bylinky, které byste si natrhali tak jako tak. Naučte se 25 příčku ve chvíli, kdy se zapne, přesuňte svůj sběr do bažiny pro zlatý list a nechte Veraneův pracovní příkaz (šest Goldleaf Herbs za 45 mědi, opakovatelné každých 30 minut), aby vám za pochodu vrátil malou minci.\n\nOd 50 let připravujte okvětní lístky okvětních lístků a hadí várky z okvětního lístku Thornpeak, s trochou Vale a bahenní zelení stále v mixu. Poslední úsek od 100 do 125 je záměrný pramínek, takže raději uvařte to, co se skutečně prodává, než abyste pálili bylinky za číslo, a pamatujte, že spotřební materiál je ten, co si každý znovu kupuje navždy. The Book of Deeds označuje Strange Brews na dovednosti 50 a Grandmaster Alchemy na čepici.',
  'guide.profPages.craftProse.armorcrafting.identityBody':
    'Žebřík Armorcraftingu se čte jako kariéra vojáka: obyčejný nýtovaný měděný pás, sabatony a rukavice na začátek, železný háček, legguardi a spauldery s prvními skutečnými statickými liniemi a vzácná osmiumová přilba, kyrys a legíny, Síla a Síla a artová čísla s čísly pro vojáky.\n\nMá to i tišší stránku: Eastbrook Warded Leggings, obyčejné pole sesílatelem, a Kilnscale Mantle, vzácné rameno Intellectu a Ducha s dovedností 75, udržují nositele pošty s kouzly na seznamu zákazníků. Na prstenu sedí mezi Weaponcrafting a Engineering; dvojice Smith s výrobou zbraní složila přísahu před Forgemistress Darvou, zatímco dvojice Gearwright s inženýrstvím je pojmenována, ale zatím nemá žádnou přísahu.',
  'guide.profPages.craftProse.armorcrafting.ladderBody':
    'Dva field commons, Eastbrook Chainmail Vest a Warded Leggings, jsou známé od samého začátku a vyrábějí se kdekoli. Trenérský žebříček má devět receptů na třech příčkách v Eastbrookské kovárně: měděná příčka je zdarma při dovednosti 0, příčka s železným článkem stojí 25 stříbrných za recept při dovednosti 25 a příčka v osmimetrové stupnici stojí každý 1 zlato při dovednosti 50, přičemž každá příčka se dá naučit v okamžiku, kdy ji dosáhne vaše úroveň.\n\nZa žebříkem sedí dva speciály. Boundstone Helm je jedním ze dvou receptů Smithových kombinací (Gravewyrmské rukavice jsou jeho sourozenci na straně výroby zbraní), učí ho cvičitel, je bez stanice a pracuje pouze s vyladěným Smithem s oběma řemesly na úrovni 25. Kilnscale Mantle nepotřebuje vůbec žádného učitele: každý to zná od začátku a nic jiného než jeho kovárna a brána materiálů. Jeho uvedená dovednost 75 je o zisku, ne o povolení: s Armorcraftingem jako majorem platí plný zisk dovedností od úplně prvního úderu kladivem do 99, takže Smith s osmiem nazbyt se o něj může brzy opřít. Pod stropem majora recept úrovně 3 nic nenaučí, takže nedeklarovaný nebo hobby armorcrafter to dělá pro kus, ne pro body.',
  'guide.profPages.craftProse.armorcrafting.materialsBody':
    'Žádné řemeslo nejí rudu rychleji. Samotný ironlink hauberk potřebuje pět železné rudy a každý kus osmium chce tři nebo čtyři osmia plus glyphsteel bar, takže seriózní armorcrafter těží Mirefen Marsh a Thornpeak Heights nebo platí někoho, kdo to dělá. Měď napájí první příčku, přímo ze žil u Copper Dig.\n\nKolem kovu jsou měkké části: hrubá kůže sklizená z vlčích a kančích mrtvol, úlomky kostí z neklidných mrtvých (nebo zachráněných z běžné výbavy) a sklenice Smithing Flux (v kovárně každá 20 měděných) téměř v každém receptu. Žádné počítadlo osmium neprodává: netrpěliví ho kupují od ostatních hráčů nebo ho sami těží na Thornpeaku nebo na startovacích žilách deseti z jedenácti mladších zón (samotný Farshore těží železo).',
  'guide.profPages.craftProse.cooking.identityBody':
    "Snězte vařené jídlo a uzdraví vás to přes 18 sekund odpočinku, což je mezi tahy nejlevnější léčení ve hře. Žebřík vede od 90-health Pan-Seared River Perch až po Marlow's Grand Roast na 980, sit-heal nic ve hře nepřekoná.\n\nVaření je na kruhu mezi Alchymií a Leatherworkingem. Jeho žijící pár je Lékárník, Alchymie a Vaření, přísahající před Cookem Marlowem v kuchyni Eastbrooku poté, co ulovil čtyři divočáky pro hrnec; dvojice Trapperů s Leatherworkingem je uvedena na prstenu, ale zatím nemá žádnou přísahu.",
  'guide.profPages.craftProse.cooking.materialsBody':
    "Rybářské populace charakteristické ingredience, zónu po zóně: ​​zrcadlový pstruh a říční okoun z vod Eastbrook Vale, štika bahenní a úhoř bahenní z Mirefen Marsh, pstruh obecný a kapr slatefin z Thornpeak Heights. Příčky volně mísí zóny (volná příčka už chce bahenní štiku, střední příčka Thornpeak's frostgill a vzácná večeře složí zpět zrcadlového pstruha Vale), takže kuchař, který loví všude tam, kde cesta vede, nikdy nevyschne.\n\nŘezníkova strana pochází z sklizených mrtvol: zvěřiny z kanců a jejich příbuzných a na vzácném nebo lepším sklizňovém kotouči podepsaný Prime Cut, středobod velké pečeně. Bylinky okoření lepší jídla, jedno poleno jasanového dřeva udí úhoře a kuchyňská sůl má 8 měděných váčků z Marlowova vlastního stánku.",
  'guide.profPages.craftProse.enchanting.identityBody':
    'Každé kouzlo je známé od začátku, každý může odčarovat od prvního dne a ani jeden nepotřebuje stanici; dovednost dosahuje 125 jako každé řemeslo. Jediným naučeným zákoutím řemesla je jeho dvojice kouzelných receptů: Tinker Gizzel učí Sběratelskou mezipaměť a Oko řemeslníka v továrně na nářadí v jihozápadním rohu Eastbrook Square za běžný poplatek, jakmile vaše Očarování dosáhne 25, a samotná kouzla se zpracovávají na jeho stanici.\n\nNa prstenu sedí mezi Inscription a Jewelcrafting, takže jeho dvě párové identity jsou Arcanist (Inscription a Enchanting) a Gembinder (Enchanting a Jewelcrafting). Ani jedno se zatím nedá odpřísáhnout, protože oba sousedé čekají na své první recepty, takže dnes se Enchanting šplhá jako řemeslo každého: zdarma na vzácnou úroveň před jakoukoli přísahou a přirozený koníček pro Bombardiera nebo Apothecary. Zaklínači také udržují shromažďovací svět v chodu: dva efekty štěrbinového nástroje jsou dílem Zaklínače a originální crafter dobíjí své vlastní efekty se slevou, hlouběji ještě jednou specializovanou.',
  'guide.profPages.craftProse.enchanting.levelingBody':
    'Tři akce posouvají dovednost: odčarování figurky, použití očarování a vytvoření dvou kouzel, která šplhají po běžné křivce. Každý úspěch má hodnotu až do jednoho bodu, škálováno podle toho, jak vážná je práce: vzácnost kousku, který rozbijete, nebo úroveň reagencií očarování, které použijete. Běžné disenchanty a dust-only enchanty bodují jako běžné dílo; neobvyklé odčaruje a esence okouzlí jako neobvyklé; rare disenchants a každý Runed nebo Greater enchant jako vzácný; epické a legendární odčarování jsou na stole stále vyšší, ačkoli žádná okouzlující identita dnes nedosahuje vzácné příčky, takže v praxi platí stejně jako vzácná práce. Jedna upřímnost vládne lavičce: kus, který vyšel z hráčské lavice (vyrobený, podepsaný nebo mistrovsky zpracovaný), se stále zpracovává na materiály, ale nic nenaučí, takže smyčka craft-and-break nikoho nevyrovná a lekce jsou ve světoznámém vybavení.\n\nZnámé vyblednutí mistrovství platí na 25bodových úrovních, takže běžná práce zešedne na dovednost 75, neobvyklá na 100 a práce na vzácné úrovni přesně na 125. Očarování má také jednu vlastní laskavost: vstup nad stropem vašeho archetypu je zaokrouhlen dolů k tomuto stropu namísto vynulování, takže než se naladíte, epické odčarování jednoduše zaboduje jako vzácné, místo aby nic nenaučilo. Pokud Enchanting skončí dřímající za jinou identitou, rozbije a použije skóre jako běžnou práci a stoupání se zastaví na 75, zatímco dvě kouzla, jedoucí po craftovací křivce nad společným stropem, neučí spícího kouzelníka vůbec nic; ponechte si to jako svůj koníček a práci na vzácné úrovni stále platí, jen pomaleji po 75.',
  'guide.profPages.craftProse.enchanting.marketBody':
    'Použití enchantu spotřebuje reagencie a označí jednu konkrétní kopii předmětu. Namiřte ji na kopii v pytlích a dostanete zpět zřetelnou očarovanou kopii; namiřte jej na kousek, který již máte na sobě, a okouzlí se na místě, přesně tam, kde sedí, bez vybavování a opětovného tance. V každém případě bonus následuje tento kus navždy, prostřednictvím nevybavení, bankovních výletů a obchodů. Jeden enchant na kus: použití jiného enchantu na očarovanou kopii si vyžádá potvrzení, pak nahradí staré enchanty a zničí ho bez náhrady jeho materiálů. Prodej, vyřazení a odčarování, to vše dává přednost obyčejným kopiím, aby se váš hotový kus náhodou nesežral.\n\nMistrovské vybavení a kouzlení jsou přátelé: mistrovské dílo zůstává plně očarovatelné a kouzlo se přidává k bonusu za mistrovské dílo, aniž by narušilo jeho nebo podpis tvůrce. Seskupení každého zdroje, podepsané mistrovské dílo nesoucí Greater enchant je to nejlepší, co vytvořený kousek dostane, a stále leží pod raidovou kořistí.\n\nOčarovaný nebo podepsaný kusový seznam na trhu jako cokoliv jiného: jde nahoru jako jeho vlastní jednokopiový výpis, tooltip ukazuje kouzlo a značku výrobce a Ravenpost je nese stejně věrně. Materiály zůstávají stálou polovinou řemesla: Prach, esence a úlomky seznam volně, zařazení nic nestojí a obchodník si vezme pouze 5 procent z dokončeného prodeje. Díky tomu mají dva klasické kouzelníci příjmy z prodeje materiálů a prodeje hotové práce: přes trh, havranem nebo tváří v tvář v obchodním okně.',
  'guide.profPages.craftProse.engineering.identityBody':
    'Řemeslo se zpracovává v nástrojárně v jihozápadním rohu Eastbrook Square, kde sídlí Tinker Gizzel, Master of the Toolworks. Vrstvy 1 až 3 každé nástrojové řady jsou běžné zásoby dodavatele; úrovně 4 a 5 vycházejí z inženýrské lavice nebo z počítadla ponorů Utopené litanie pro Delve Marks za jejími čistými branami a nikdy z žádné pokladny pro mince.\n\nNa prstenu sedí s řemesly pokus-omyl, vedle alchymie a armorcraftingu, což mu dává dvě párové identity: Bombardier (inženýrství a alchymie, převzatý před samotným Gizzelem) a Gearwright (armorcrafting a inženýrství, pojmenované, ale ještě nesmějí přísahat). Jedno varování je zde důležitější než kdekoli jinde: všechny příčky inženýrských receptů jsou umístěny nad stropem vzácných vrstev, pod kterým pracují hobby a nedeklarovaní řemeslníci, takže číslo dovednosti se pohybuje pouze u řemeslníka, mezi jehož hlavní obory patří inženýrství, což dnes znamená Bombardier. Pozemní nástroje může stále stavět kdokoli; Nenaladěný řemeslník se z toho prostě nic nenaučí a dva recepty na pruty navíc vyžadují Gizzelovo učení.',
  'guide.profPages.craftProse.engineering.ladderBody':
    'V žebříčku je osm receptů, všechny svázané s nástrojárnou. Šest receptů na pozemní nástroje je známo automaticky, žádný školitelský poplatek nikdy není: trsátko, sekera a srp úrovně 4 u dovednosti 75 a verze 5. úrovně u dovednosti 150. Toto druhé číslo není překlep a záměrně se nachází nad současnou hranicí 125: požadavky na dovednosti zde nikdy nebrání řemeslu, pouze utvářejí jeho předchůdce, takže si můžete vytvořit 4. úroveň předchůdce. Dva vyrobené pruty jsou naučenou výjimkou: Gizzel učí Stormreel na dovednost 75 za 4 zlaté a Tidewrought na dovednost 125 za 16 zlatých, každý ve chvíli, kdy vaše úroveň v řemesle dosáhne svého.\n\nKaždý hotový nástroj je vzácný nebo impozantní kvality a vychází podepsaný, takže vaše jméno visí na pásech ostatních hráčů. Engineering také obsahuje polovinu jednoho kombinovaného receptu: Medvědí elixír, který uvařil vyladěný Bombardier s inženýrstvím i alchymií ve 25 letech.',
  'guide.profPages.craftProse.engineering.materialsBody':
    'Každý recept na pozemní nástroj spotřebuje nástroj o jednu úroveň pod sebou plus materiál JEMNÝ, a toto párování je celým žebříčkem země: čtyři Jemné železné rudy a Skysilver Mining Pick se stanou Osmium Mining Pick, poté dva Glyphsteel Bars, dva Fine Osmium Ore a tento osmium se stanou Glyphsteel Mining Pick. Linie sekery a srpu odrážejí tvar jemného a předchozího nástroje s jemným jasanovým dřevem a jemným polenem Highpine, jemným zlatým listem a jemnými slunečnicovými bylinami, ačkoli jejich příčky 5. úrovně nevyžadují žádné glyphsteel bars: trsátko je ta jediná linie, která je nahoře dražší. Dva receptury prutů záměrně porušují vzorec: Stormreel má čtyři Sunglint Koi a prut Silverstream, Tidewrought dva Koi, osm Raw Slatefin Carp a ten Stormreel, takže za vrchol rybářského žebříčku se platí spíše na vodě než na žíle.\n\nJemný materiál se nikde neprodává a neopadává z běžné sklizně: získáte ho opracováním jedné z plnohodnotných žil zóny nástrojem umístěným nad materiálem samotným, což v praxi znamená, že nástroj je o příčku pod tím, který se snažíte postavit (snazší žíly, které zóna pro cestovatele udržuje, dávají prostý materiál, ať švihnete). To je záměrné. Na řemeslné cestě pochází nástroj 5. úrovně ze skutečného zhoupnutí prvního stupně 4, nikoli z nákupního výletu; počítadlo Delve Marks je jediným způsobem, jak to obejít. Jedinou výjimkou je Glyphsteel Bar, rafinovaný a pouze pro prodejce, 1 stříbrná 60 měď na bar od Quartermaster Bree v Highwatch nebo z vlastního pultu Gizzel, takže samotný Glyphsteel Mining Pick nese pevnou podlahu na mince zabudovanou do své ceny.',
  'guide.profPages.craftProse.leatherworking.ladderBody':
    "Tady je vráska: koželužna stojí ve Fenbridge, na silnici Mirefen Marsh, díky čemuž je kožedělné zpracování jediným řemeslem vycvičeným v bažině. Tanner Hesk učí žebřík na svých kádích: Fenbridge skrýt příčku zdarma na dovednost 0, marshstalker příčku za 25 stříbrných recept z dovednosti 25 a příčku mirewarden po 1 zlatě každý od dovednosti 50, každá příčka se otevírá, jakmile jí dosáhne vaše úroveň.\n\nTři recepty přeskakují trenéra: Field Commons (Tanned Leather Jerkin a Eastbrook Druid's Hide) craftí kdekoli od začátku a Duskhide Wraps zná každý, ale sedí u dovednosti 75 a jsou vázaní na koželužny. Všimněte si, že samotná přísaha konfekce je složena zpět v Eastbrooku s Ottilie; pouze vyučování se děje v bažině.",
  'guide.profPages.craftProse.leatherworking.materialsBody':
    'Práce s kůží je řemeslo, kde je vaše nivelační trasa a vaše zásobovací čára totéž: hrubá kůže se sklízí přímo z mrtvol, vlků a kanců, především, a každá mrtvola slouží pouze jednomu kombajnu, kdo dřív přijde, je dřív na řadě. Vzácný nebo lepší sklizňový hod také uděluje Pristine Hide, podepsaný exemplář, po kterém Mirewarden Jerkin požaduje, takže uložte všechny, které najdete.\n\nNosný odlitek je malý: pavoučí nohy a hedvábí, podomácku tkaná látka z humanoidů, jedna osmiová ruda v každém vzácném kousku mirewarden (šest v horním kameni Duskhide Wraps) a Tanning Agent za 16 mědi z pultu koželužny. Osmium samotné se nikdy nekupuje proti: těžte si ho sami na Thornpeaku nebo na startovacích žilách téměř jakékoli mladší zóny (samotný Farshore těží železo), nebo ho kupte od jiného hráče.',
  'guide.profPages.craftProse.leatherworking.routeBody':
    "Jakýkoli kus se skutečnými statistikami hází šanci na mistrovské dílo, pokud se lepší kvalita vejde do stropu vaší úrovně, včetně úkrytu Eastbrook Druid's Hide a podepsaného Pristine Hide v mirewardenském kazajce automaticky poskytuje bonus k podepsanému činidlu; osmium se počítá jako materiál úrovně 1 pro proc. Bezstavové skrýt commons nemůže proc.\n\nVyrovnejte to přirozeným způsobem: sklízejte každého vlka a kance, které zabijete, od úrovně jedna, nechte dvě polní družiny, ať vás přenesou na 25, ať stojíte kdekoli, a pak trénujte skrýš u kádí, když vás questy stejně zatáhnou do močálu. Marshstalker vás přenese na 50 a mirewarden na 75; minulé Duskhide Wraps, recept 3. úrovně na šest osmiové rudy, tři Pristine Hide, dvě drsné kůže a Tanning Agent, zaplatí vyladěnému Outfitterovi plný zisk na 99 a polovinu poté, asi 75 řemesel za posledních padesát bodů do 125 čepice; pod stropem majora recept úrovně 3 nic nenaučí.\n\nMobilní koželužna je pro toto řemeslo důležitější než kterákoli jiná: specializujte se na 75 let a sedlový pytel kůží se stane hotovým vybavením u táborového ohně místo procházky zpět do Fenbridge. Heskův koželužný pracovní příkaz kupuje každých 30 minut osm hrubých kůží, bez ohledu na to, zda se vám vrátí kůží, které jste sbírali, a Book of Deeds označuje Tanner's Trade na dovednost 50 s Grandmaster Leatherworking na čepici.",
  'guide.profPages.craftProse.weaponcrafting.materialsBody':
    'Těžba je páteří. Měděná ruda pochází ze žil 1. úrovně v Eastbrook Vale, železná ruda z Mirefen Marsh a osmiová ruda z Thornpeak Heights a každá příčka žebříku stoupá stejným způsobem. Na těžbě dřeva záleží víc, než byste čekali: železná kůra nese kančí kopí, jasan na ramenou maul a jediný kmen z vysoké borovice tvoří bitevní hůl.\n\nZbytek pochází z lovu a počítadla. Z mrtvol vlků a kanců se sklízí hrubá kůže na sevření, úlomky kostí se oddělují z neklidných mrtvých nebo ze zachráněných společných věcí a kovářský žebřík spálí Smithing Flux, 20 měděnou nádobu od Darvy samotné. Pokud vaše vlastní těžba zaostává, na samotné rudě vás nezachrání žádný žeton: osmium pochází z žil Thornpeak, ze startovacích žil každé mladší zóny kromě Farshore (jehož žíly kopou železo) nebo ze zásobníku jiného hráče, obchodem nebo ze světového trhu. Pouze Glyphsteel Bar se kupuje za mince, od Tinker Gizzel v továrně na nářadí nebo Quartermaster Bree v Highwatch.',
  'guide.profPages.craftProse.weaponcrafting.routeBody':
    'Jakýkoli kus se skutečnou statickou čárou, což na tomto žebříčku znamená železnou příčku a nahoru, se může odlepit od kovadliny jako mistrovské dílo, pokud se lepší kvalita vejde do stropu vaší řady; bezstavové měděné commons nikdy neproc, protože v nich není co zlepšovat. Železo a osmium se počítají jako materiály úrovně 1 pro bonus za mistrovské dílo, highpine a glyphsteel jako úroveň 2 a dovednost sedící nad vlastní úrovní receptu přidává svůj vlastní bod za úroveň, takže mezi osmiem tři je to válečná sekera a bitevní hůl, které nesou výhodu materiálu, a příčka pokračuje lépe poté, co ji přerostete.\n\nJezděte na měděné příčce na 25, trénujte na železné příčce v den, kdy se otevře, a jeďte na ní na 50, pak na osmiové příčce na 75. Posledních 75 zatím nic vyššího lodí, takže recepty na osmium zeslábnou na polovinu a pak na čtvrtinový zisk: rozpočítejte si zhruba 150 dalších řemesel, abyste dosáhli 125 stropu, a pamatujte si na sdílený plyn při deseti řemeslných akcích za minutu.\n\nFinancujte stoupání za pochodu: Darvův kovářský pracovní příkaz vám každých 30 minut odebere osm měděné rudy za malou minci a XP a železné a osmiové příčky se poctivě prodávají do vyrovnávacích bojů na blízko. Kniha skutků označuje Edge a Temper dovednostmi 50 a korunuje velmistr Weaponcrafting na 125.',
  'guide.profPages.econ.provenanceBody':
    'Některé položky nesou název. Umístěte kurzor myši na jeden a nápověda říká Shromážděno tím a tak na surovém materiálu nebo Vytvořeno tak a tak na hotovém kusu: stejná značka, formulovaná tak, jak předmět vznikl. Podpis je součástí samotného předmětu, prochází s ním obchody, bankou, poštou, světovým trhem a dokonce i zpětným odkupem prodejce a nikdy nezmizí.\n\nShromažďování znamení své nejlepší práce automaticky: každá sklizeň, která se kutálí vzácně nebo lépe, je podepsána a vzácné nálezy podepisují celý pětinásobný zisk. Šťastná role sklizně mrtvol podepisuje svůj výnos tam, kde rodina nemá žádný exemplář, který by mohla dát, a tam, kde ano, udržuje výnos prostý a razí podepsaný nedotčený exemplář vedle něj. Vytváření znamení ve stejné linii: každá kopie vzácného nebo lepšího výstupu je podepsána a mistrovské dílo se vždy podepíše bez ohledu na jeho kvalitu, takže nejlepší verze každého kusu vždy jmenuje svého výrobce. Jediná věc, která vás může stát podpis, je plný pytel: podepsaná jednotka potřebuje k přistání svůj vlastní prostor nebo odpovídající podepsaný balíček.\n\nHromada předmětů sdílí jednu identitu, takže dvě kopie se spojí pouze tehdy, když se každá značka přesně shoduje: stejný předmět, stejný signatář, stejné statistiky mistrovského díla, stejné očarování, stejné pouto. Podepsaný protokol se nikdy nepřipojí k obyčejné hromadě v žádném směru (sloučením by se vymazalo něčí jméno), ale identické užitečné zátěže se šťastně spojují, takže dvacet rud podepsaných stejným sběračem sedí v jedné hromádce a hromada neočekávaných dávek neroztrhne vaše pytle.\n\nPodpisy platí řemeslníkům zpět: držení jakékoli podepsané kopie potřebného činidla na lavici, ať už ji podepsal kdokoli, přidává 2 procentní body šance na mistrovské dílo a držení činidla podepsaného vlastní rukou snižuje požadované množství tohoto činidla o jednu (nikdy pod jednu). Vaše vlastnoručně podepsaná vzácná nebo lepší práce vás dokonce učí, dnes pouze prostřednictvím baňky: vypijte lektvar, který jste podepsali, a malý pramínek dovednosti proudí zpět k řemeslu, které ho vyrobilo, pokud je toto řemeslo jedním z vašich aktivních majorů.',
  'guide.profPages.econ.throttleBody':
    'Výstup má svůj strop: craftování, odčarování, okouzlování, zachraňování a dobíjení pomocí efektů nástrojů sdílí jeden rozpočet {actions} úspěšných akcí v každém {seconds}sekundovém okně. Odmítnutý pokus nic nestojí a nevynakládá žádný rozpočet. Při normální hře to nikdy nepocítíte; existuje, takže maximální specialista s plnou bankou nemůže zaplavit trh, bez ohledu na jeho dovednosti nebo zásoby.',
  'guide.profPages.econ.trainingNote':
    'Jeden paušální poplatek za příčku receptu, účtovaný jednou, když to mistr učí; každá příčka níže uvedené tabulky se dnes živě používá, od bezplatných startovacích receptů až po lekce pro nástrojáře nahoře.',
  'guide.profPages.ench.enchantsNote':
    'Kouzelníci přicházejí ve třech úrovních. Základní úroveň běží na Chime Dust (s trochou Essence na horním konci) a pokrývá slot pro zbraně plus každý slot pro zbroj kromě off hand, s dostatečnými možnostmi stat-axis, že každá sestava najde něco pro každý slot. Větší úroveň stojí jeden Chime Shard plus Essence: silnější bonusy na automatech s nejvyšším dopadem. Střepy krmí další dvě umyvadla, dva kouzelné recepty po pěti za kus a horní příčku dobíjení efektu nástroje, takže si jich složte, než utratíte.\n\nMezi nimi sedí pět Runed enchantů, jeden konzument na napsanou sekundární, takže nic z toho, co frézujete, není nikdy slepá ulička: Runed Edge (zbraň, síla, spotřebovává rezonanční ocel), Runed Sigil (zbraň, intelekt, rezonanční dřevo), Runed Weave (hruď, duch, rezonanční vlákno), Runed Hide (nohy, Hideshel, Resonant Runmet), Resoned Link Odkazy). Každý také bere dvě Chime Essence; tam, kde slot a statistika mají jak základ, tak větší kouzlo, bonus Runed přistane mezi nimi, zatímco Runed Weave je nejsilnější přímočarý spirituální enchant na hrudi a Runed Hide je jedinou nohou, kterou Agility okouzlí vůbec. Přesné bonusy jsou všechny v tabulce níže.',
  'guide.profPages.faq.a4':
    'Narazil jsi na neočekávaný. Zhruba 1 sklizeň z 90 spustí vzácnou událost sběru (starověké jádrové dřevo na stromě, nedotčená žíla na rudě, měsíční květ na bylinkách): pětkrát znásobí výnos, podepíše každou jednotku vaším jménem a oznámí nález celé zóně. Vzácná nebo lepší rarita při běžné sklizni se také podepisuje na výnosu.\n\nPodepsané materiály se vyplatí uschovat nebo prodat, vážení: držení jakékoli podepsané kopie potřebného činidla na stole přidává 2 procentní body k šanci na mistrovské dílo. Jen si pamatujte, že se skládají pouze s identicky podepsanými kopiemi, takže si ponechávají svůj vlastní slot na tašky.',
  'guide.profPages.faq.a6':
    'Devět běžných polních receptů a šest vytvořených receptů na pozemní nástroje zná každý od začátku, stejně jako tři základní kameny (Kilnscale Mantle, Wardweave Cowl a Duskhide Wraps), které nepotřebují žádného trenéra, pouze svou stanici. Vše ostatní vyučují místní mistři na svých stanicích napříč třemi hlavními městy: většina stojí v Eastbrooku, koželuh má koželužnu ve Fenbridge a alchymista má lékárníka v Highwatch.\n\nTrenérské recepty běží po příčkách: dovednost 0, 25 a 50 pro vybavení a spotřební řemesla, cena zdarma, 25 stříbrných a 1 zlato jako jednorázové poplatky; Dva kouzelné recepty Enchantingu sedí na 25 příčce a výrobce nástrojů učí dva vyrobené rybářské pruty na 75 a 125 za 4 a 16 zlatých. Mistr učí recept, jakmile vaše svorka v tomto plavidle dosáhne vlastní svorky receptu a vy musíte stát na jejich stanovišti, abyste se učili: mobilní stanice se nepočítá.',
  'guide.profPages.faq.a7':
    'Seskupení začíná na 2,5 sekundách a je oholeno dvěma způsoby: 0,4 sekundy pro každou úroveň nástroje, kterou nosíte a můžete ji ovládat nad vlastní úrovní uzlu, a 0,15 sekundy, jakmile počítadlo vašeho obchodu překročí pásmo 100, s minimem 1,5 sekundy. Přesuňte se z uzlů 1. úrovně do uzlů 3. úrovně a váš přebytek zmizí, takže stejný výběr se opět houpe pomaleji. Přesné držení požadované úrovně neznamená žádnou rychlost; pouze otevře uzel.\n\nZisk dovedností mizí stejně jako crafting: uzel zešedne, když vaše odbornost překročí úroveň (uzly úrovně 1 nenaučí nic od úrovně 75), takže odpovědí na pomalé zisky jsou uzly vyšší úrovně. Ti potřebují nástroj alespoň jejich úrovně ve vašich taškách (žádný uzel se nikdy nepracuje holýma rukama, včetně úrovně 1) a pozemní nástroj nad úrovní 1 také chce svou značku ovládání jako první, 40/70/85/100 ve svém vlastním obchodu pro úrovně 2 až 5. Rybolov se řídí svým vlastním zúžením: plný zisk pod 50 15 5 pod úroveň 0.0 0,02 pod 200, nevyžádané úlovky od 100 nenaučí vůbec nic a samotná voda završí lekci (vody 1. úrovně přestanou učit na 100, bažiny na 150), takže zablokované počítadlo může také znamenat, že jste přerostli vodu.',
  'guide.profPages.faq.a8':
    'Částečně. Devět běžných polních receptů (startovací zbraň, brnění, jídlo a sponky lektvaru) se vyrábí kdekoli a kdykoli, stejně jako tříkombinační recepty přísahaných dvojic. Vše ostatní nad nimi je vázáno na typ stanice: kovárna, kuchyně, lékárna, koželužna, tkalcovský stav nebo nástrojárna, a aby plavidlo mohlo projít, musíte být do 20 yardů od stanice.\n\nSe 75 dovednostmi v řemesle, na které se specializujete, a spolu s 20procentní slevou na materiál získáte mobilní stanici: umístěte ji na pole a stojí 10 minut a podává recepty tohoto řemesla, jako byste byli u skutečné věci. Mobilní stanice je pouze pro crafting: učení receptů a uvolnění provizí vždy vyžaduje skutečnou stanici ve městě.',
  'guide.profPages.fish.biteBody':
    'Po kousnutí přichází kousnutí ve skrytém okamžiku mezi {min} a {max} sekundami; o zpoždění se rozhoduje, když čára přistane, takže žádné dva vrhy se necítí úplně stejné. Když bobber kousne, máte {reel} druhé okénko na opětovné stisknutí tyče a navinutí: naviňte se dovnitř a úlovek dopadne, zaváhejte kolem něj a ryba uteče, aniž by byla co ukázat. Celá relace je omezena na {cap} sekund, takže i tiché obsazení se rychle vyřeší.\n\nLepší pruty vylepšují oba konce minihry: každá řada prutů nad prvními trimy zkrátí {rod} sekund z nejdelšího možného čekání, nikdy pod třísekundovým patrem se horní prut už odře a přidá {reelRod} sekund k okénku navijáku, takže Ironreel stáhne nejhorší čekací dobu na 6,5 sekundy s oknem 3,25 sekundy a 3,25 sekundovým oknem. rozšíření kotouče trochu nad rámec toho, co platí samotná úroveň. Nejrychlejší záběry nikdy nezmění, co držíte, a prut stačí mít ve vašich taškách, abyste mohli počítat.',
  'guide.profPages.fish.koiBody':
    'Každá vodní plocha ve hře skrývá stejnou cenu: Sunglint Koi, neobvyklý lesk na lince v hodnotě 75 mědi pro prodejce a mnohem více pro vaši hrdost. Jeho šance odpovídají vašemu úlovku a ničemu jinému, stejné v každé zóně: ​​1procentní řádek tabulky úlovků v pásmu 0, 3 v pásmu 1 a 6 v pásmu 2, vylosovaný při každém navinutém náhozu, takže koi přichází k rybáři, který si vysloužil hluboké stoly. Přistání jednoho zaznamenává Glimmer of Hope do vaší Knihy činů, sběratelskou známku s nulovým věhlasem. Když se to stane, protokol se ujistí, že to víte.',
  'guide.profPages.fish.scheduleNote':
    'Zisk rybolovu se řídí pevným plánem bez kostek: plný bod za úlovek pod 50, půl bodu pod 100, desetina pod 150 a pomalý 0,02 pramínek ze 150 na 200. Tento poslední úsek je záměrná cesta tisíce úlovků: 200 je prohlášení, ne zastávka na cestě k něčemu jinému.\n\nJunk úplně přestane učit na {cutoff}: od té doby jsou plevel a boty jen plevel a boty. Lekce je zakončena i samotnou vodou: vody úrovně 1 ve Vale (a každý mladý břeh za srdcem země) nenaučí nic nad 100, zastávka v močálech na 150 a pouze škola Thornpeak je rybářem celou cestu na 200. Každý vyloděný úlovek jinak získává plánovaným tempem, takže když se počítadlo zastaví, rozvrh vám řekne, abyste hledali hlubší vodu.',
  'guide.profPages.fish.startBody':
    'Jednoduchá rybářská hůl stojí 20 mědi od Fisherman Brandt v Eastbrooku (hledejte Old Salt na východním okraji města, u silnice k Mirror Lake); Tinker Gizzel, Provisioner Hale ve Fenbridge a Quartermaster Bree v Highwatch akciových pólech. Použijte tyč čelem k vodě dostatečně hluboké na to, abyste udrželi ryby, až asi 24 yardů před vámi, a váš bobber vyplul.\n\nNemůžete házet v boji, při plavání nebo mrtví: zamýšlená pozice je házení ze břehu. Voda je však tvrdší jako země: bažina chce alespoň Ironreel 2. úrovně a vrcholy Silverstream 3. úrovně a vlasec nahozený bez prutu, který voda bere, nikdy neopustí vaši ruku. Nad nimi jsou umístěny dva pruty, Stormreel a Tidewrought: inženýři je vyrobí v nástrojárně z toho, co vytáhne řada, a počítadlo ponorů Drowned Litany je prodává za Delve Marks za svými čistými branami, i když nikdy za mince. Žádná voda se jich neptá, a tak si místo přístupu kupují kratší čekání a širší okno navijáku, což na horní příčce znamená kousnutí za tři vteřiny.',
  'guide.profPages.fish.tablesNote':
    'Vaše odbornost si vybere jedno ze tří pásem úlovku: pásmo 0 od začátku, pásmo 1 na 100, pásmo 2 na 200, každé přesouvá váhu z harampádí a prázdné háčky na skutečnou rybu, zónu po zóně. Každá skupina nad první také vyžaduje prut: skupina 1 chce Ironreel úrovně 2, skupina 2 úroveň 3 Silverstream. Vaše efektivní řemínek je nižší z toho, co vaše dovednost vydělala a co váš prut podporuje, a čepice je tichá: s menším prutem stále chytáte, těsně mimo stůl spodního řemene, takže pokud máte pocit, že se vaše úlovky zaseklo, zatímco vaše dovednosti šplhají, zkontrolujte nejprve svůj prut.\n\nVody v každé zóně obsahují svůj vlastní pár krmných ryb, které se léčí tím více, čím hlouběji je zóna, všechny z nich vaří vstupy a dokonale dobré sedni a sněz syrové jídlo mimo linku. Zbytek tabulky je rybářova daň: tráva, občasná bota a prázdný háček, který nikdy úplně nezmizí. Kolik zaplatíte, závisí na vodě, ve které váš bobber dopadne, ne na tom, kde stojíte: nához dosahuje až 24 yardů a prut, který voda vyžaduje, stůl, ze kterého čerpá, skutek, který připisuje, a jak daleko to všechno naučí odpovědět na zónu, do které voda patří, rozhodl okamžik, kdy šňůra dopadne. Voda každé zóny je napsána pro vlastní pásmo, Vale pro pásmo 0, močál pro pásmo 1, vrcholy pro pásmo 2 a lov jednoho pásma pod tím promění zhruba třetinu vašich náhozů na prázdné háčky, dva pásy pod ním více než polovinu. Prut vás dostane k vodě; díky dovednostem se to vyplatí a stoupání je to, co táhne rybáře hlouběji, protože lepší kapely nejsou jen lepší plat: za údolím jsou to jediné vody, které stále učí. {rare} je jediný řádek, který odpovídá vašemu úlovku a ničemu jinému: stejný kurz v každé zóně a šestkrát pravděpodobnější v pásmu 2 než v pásmu 0, takže nejvzácnější věc na doku je ta, ve které je mistr rybář opravdu lepší.',
  'guide.profPages.gainBody':
    'Zisk je deterministický, nikdy to není hod na zlepšení dovedností: uzel na nebo nad vaší úrovní zisku učí plný bod za sklizeň a každá odbornost {step} je bodovaná o jednu úroveň proti uzlu. Uzly úrovně 1 platí v plné výši pod 25, polovinu na 49, čtvrtinu na 74 a od 75 dále nic; uzly úrovně 2 platí v plné výši až 49; dva uzly úrovně 3 každého obchodu platí v plné výši 74 a polovinu až do stropu {cap}.\n\nZamýšlená trasa je jednoduchá: naučte se na startovacích uzlech Vale, přesuňte se do bažiny a dokončete výstup na vyvýšeném místě Thornpeak Heights. Na konci se učení zastaví, ale výnosy nikoli: omezený sběrač neustále valí nejlepší kurzy, které obchod nabízí.',
  'guide.profPages.gatherDeeds.fishing':
    '100 milník zapisuje Old Salt a 200 zapisuje Master Rybář svým titulem, samotný vrchol rybářova umění; Rybolov se také započítává do Master Gatherer, který získal 100 v jakýchkoli třech sběracích obchodech. První ryba z každé z vod šesti zón zaplní svou vlastní stránku, tři srdeční zóny a Willowfen, Galecrest a Farshore za nimi a Sunglint Koi zaznamená Záblesk naděje, takže cestovatelé s tyčí ve své smečce zaplní svou knihu rychleji, než by čekali.',
  'guide.profPages.gatherIntro.fishing':
    'Rybaření je mezi shromažďovacími řemesly zvláštní a nejhlubší: skutečná minihra na kousání a navíjení, vlastní stoly úlovků v každé ze tří srdečních zón (mladé vody za nimi zatím všechny slouží stolu Vale) a limit 200, dvojnásobek ostatních. Kupte si tyč, postavte se do otevřené vody a vrhněte.',
  'guide.profPages.gatherIntro.herbalism':
    'Bylinkářství shromažďuje to, co roste divoce: listový list v Eastbrook Vale, zlatý list v Mirefen Marsh, okvětní lístek v Thornpeak Heights a zárodečné skvrny v každé mladší zóně, listy a stonky, které udržují lékárnické řemeslo v neustálém vaření. Otevřeno pro každého od úrovně 1 s bylinkovým srpem v taškách (20 mědi na přepážkách Eastbrook, Fenbridge a Highwatch), sledovaným na vlastním pultu až do 100.',
  'guide.profPages.gatherIntro.logging':
    'Těžbou se kácí dřevo z porostů stromů po celém světě: železná kůra v Eastbrook Vale, jasan v Mirefen Marsh, borovice v Thornpeak Heights a startovací stojany v každé mladší zóně, surový materiál pro násady, hole a inženýrská lavice. Otevřeno pro každého od úrovně 1 s těžařskou sekerou v taškách (20 měděných na přepážkách Eastbrook, Fenbridge a Highwatch), sledované na vlastním pultu až po strop 100.',
  'guide.profPages.gatherIntro.mining':
    'Těžba těží rudu přímo ze světové skály: měď v Eastbrook Vale, železo v Mirefen Marsh a osmium v ​​Thornpeak Heights, se startovacími žilami roztroušenými v každé mladší zóně za nimi a živí řemesla v kovárně. Otevřeno pro každého od úrovně 1: 20 měděný trsátko z počítadla Eastbrook, Fenbridge nebo Highwatch otevře každou startovací žílu a vyšší příčky žebříku se probudí, když je vydělá váš vlastní žeton. Sledováno na vlastním počítadle do limitu 100.',
  'guide.profPages.howBody':
    'Otevřete okno tvorby (výchozí klávesa T) a každý recept, který znáte, je uveden s tím, co potřebuje a co máte po ruce. Recepty na stanici vás požadují, abyste stáli do 20 yardů od správné stanice ve městě, polní recepty se vyrábějí kdekoli a lámání a čarování v Enchantingu nepotřebuje vůbec žádnou stanici (pouze dva jeho recepty na kouzlo jsou práce na stanici, v továrně na nářadí). Neexistuje žádný hod na selhání: řemeslo s materiály v ruce vždy uspěje.\n\nDvě malé třenice udržují ekonomiku poctivou. Za každé úspěšné řemeslo se platí poplatek 2 měďáky za bod ze statistického rozpočtu položky a akce typu řemesla sdílejí jedno tempo: maximálně 10 řemesel, odčarování, očarování, záchrany nebo dobití nástrojů v každém 60sekundovém okně. Ani jedno nebude vadit při normální relaci; oba brání maximálnímu specialistovi, aby zaplavil trh.',
  'guide.profPages.masterworkBody':
    'Každé úspěšné řemeslo je přesně to, co slibuje recept, a někdy i trochu víc: mistrovské dílo dokončí stejný kus o jednu kvalitní úroveň jemnější, s bonusovými statistikami zapečenými v době řemesla. Jedná se pouze o doplněk, nikdy se nejedná o downgrade, a zůstává pod nájezdovou podlahou, takže vytvořené vybavení může být vynikající, aniž by nahradilo nájezdový drop.\n\nŠance je zveřejněná, ne mystická: {base}% základ, plus {perTier}% na úroveň, vaše dovednosti leží nad receptem, plus {signed}%, když vstoupí jakékoli podepsané činidlo, plus {spec}%, jakmile se specializujete, s materiály vyšší úrovně přidají o 1 až 2 % více, vše omezeno na {cap} %. Pouze kus se skutečnými statistikami se může zlepšit, takže bezstavové společné položky, nástroje a spotřební doplňky nikdy neproc; spící řemeslo nikdy nevyrábí a hobby řemeslo nemůže zvládnout svůj vzácný strop.\n\nJemná práce nese svého tvůrce. Vzácné a lepší výstupy jsou podepsány, každá kopie (Crafted by; shromážděné materiály nesou Gathered by), mistrovské dílo je vždy podepsáno bez ohledu na jeho kvalitu. Podpis je provenience, ne zámek: podepsaný obchod se zbožím, poštou a seznamem na světovém trhu volně.',
  'guide.profPages.priceNone': 'Neprodává se za mince',
  'guide.profPages.rhythmBody':
    'Sklizeň je krátký, viditelný nádech, ne okamžitý úlovek: základna {base} sekund, nikdy pod {floor} druhým podlažím. Nosíte-li nástroj nad úrovní uzlu, takový, který vám vaše odbornost umožní ovládat, zrychlí vás o {tool} sekund na úroveň nad ním a každé pásmo odbornosti, které překročíte, zkrátí dalších {band} sekund; pouhé sladění úrovně uzlu vás dostane do dveří, jsou to úrovně nad nimi, které vás urychlí.\n\nPlný pytel zdvořile odmítne obsazení předtím, než začne, takže nic nepřijde nazmar a každá sklizeň zaplatí malou část XP postavy, přepočtené úrovní uzlu proti vaší vlastní, jak se měří stupnice zabití XP: triviální šedý uzel nenaučí postavu s čepicí nic.',
  'guide.profPages.specimenBody':
    'Když farmaříte, mějte volný prostor pro pytel: podepsaný neočekávaný výtěžek potřebuje svůj vlastní prostor nebo odpovídající podepsaný zásobník, aby mohl přistát, a pokud nic nesedí, výnos stále přichází, ale podpis se ztratí. Sklízení mrtvol má také své vlastní jackpotové rameno: asi {pct}% každé sklizené složky se vyskytuje vzácně nebo lépe. Rodina s dokonalým exemplářem k darování (kůže, hedvábí, jed, maso) si zachovává svůj obyčejný výnos a razí podepsaný exemplář vedle něj; každá druhá rodina podepisuje výnos sám.',
  'guide.profPages.toolCraftedOrMarks':
    'Vytvořeno ({craft}) nebo {marks} Delve Marks po třech utopených litaniích',
  'guide.profPages.toolCraftedOrMarksHeroic':
    'Vytvořeno ({craft}) nebo {marks} Ponořte se do znamení po vymazání Heroic Drowned Litanie',
  'guide.profPages.toolsNote':
    'Každý uzel potřebuje svůj obchodní nástroj ve vašich taškách, včetně úrovně 1: žádný krumpáč, žádná ruda a žádný kůl, žádné ryby. Žebříček prodejců pokrývá úrovně 1 až 3 napříč třemi středisky: nástroj úrovně 1 se prodává ve všech třech, příčky nad ním, kde začíná půda, která je používá (Fenbridge přidává úroveň 2, úroveň Highwatch 3) a mladší osady za nimi nemají vůbec žádné nástroje, takže se před cestou připravte. Každý pult prodává každou příčku, kterou má na skladě, a jakýkoli nástroj prochází přímým obchodem; každá příčka je také uvedena na trhu a putuje poštou kromě tří 20-měděných startérů: ty se kupují u přepážky nebo se předávají z ruky do ruky a nikdy se neprodávají, neposílají ani neevidují. Co je brané, je ovládání. Pozemkový nástroj nad úrovní 1 funguje pouze tehdy, když si to vydobyla vaše odbornost ve vlastním obchodě, {tier2Prof} pro úroveň 2, {tier3Prof} pro úroveň 3 a 85 a 100 pro dvě vytvořené příčky a řádek dodavatele, popisek a tabulka níže pojmenují požadavek dopředu. Do té doby nástroj zakoupený dopředu jednoduše čeká ve vašich taškách, neotvírá žádnou půdu, nekupuje žádnou rychlost a nerazí žádné jemné známky, a pak vládne v okamžiku, kdy se váš počítadlo dotkne jeho čísla. Rybářské pruty jsou jedinou výjimkou: žádný prut nesplňuje požadavky na ovládání a obchodník Wilkes v Eastbrooku záměrně zásobuje pruty 2. a 3. úrovně pro rybáře, kteří nakupují dopředu. Nástroj nikdy nezabírá slot pro vybavení a nikdy se neopotřebuje, takže každý je jednorázový nákup a pro bránu záleží pouze na úrovni: vzácnější nástroj stejné úrovně neotevírá nic navíc. Vzácnost však není jen barva. Prodlužuje výdrž štěrbinového nástroje a na prutu rozšiřuje okénko navijáku.\n\nLepší nástroj kupuje tři věci, ne dvě. Otevírá půdu vyšší úrovně, zkracuje nához a vylepšuje to, co vychází: zpracujte žílu nástrojem umístěným NAD vlastním materiálem zóny a sklizeň přinese její jemný stupeň místo obyčejné. Žíla musí být jednou z plnohodnotných žil, takže snazší žíly, které zóna uchovává pro cestovatele, stále poskytují běžný materiál. Ušlechtilé materiály jsou to, co spotřebovávají receptury vytvořených nástrojů, a kvalitní jakost se počítá jako běžná verze všude, kde si ji recept nebo pracovní příkaz vyžádají, takže modernizace vás nikdy neurazí: znamená to jen, že vaše měděná ruda dorazí jako jemná měděná ruda.\n\nNad žebříčkem prodejců má každý obchod dva vytvořené nástroje, úroveň 4 a úroveň 5, vyrobené v továrně na nářadí (každá postava zná receptury země; dovednost, která šplhá k práci, je inženýrská), nebo koupené za Delve Marks na přepážce Drowned Litany, jakmile jsou splněny jeho čisté brány: tabulka níže nese cenu značek a vymaže každou příčku, kterou si vyžádá. Žádný obchodník je nikdy neprodává za mince. Rybaření má své vlastní dvojice a ty se učí spíše od výrobce nástrojů, než aby je znali od začátku. Žádný uzel a žádná voda dnes nepotřebuje více než úroveň 3, takže první dvě příčky nakupují rychlost, stupeň a laskavější okno navijáku spíše než přístup a budou vstupní vstupenkou, až přijde půda vyšší úrovně.',
  'guide.profPages.trainingBody':
    'Recepty trenérů pocházejí od místních mistrů, kteří se učí na jejich stanicích. Pravidlo je jednořádkové: mistr učí recept, jakmile vaše úroveň v řemesle dosáhne vlastní úrovně receptu, a nic jiného jej nebrání, ani vaše úroveň, ani váš archetyp. Žebříky s vybavením a spotřebním materiálem se pohybují na úrovni dovedností 0, 25 a 50; Inženýrské dvě lekce s prutem pokračují v žebříčku na 75 a 125 a dva kouzelné recepty Enchanting sedí na 25. příčce, takže se nová příčka otevírá, když vaše úrovně stoupají.\n\nPoplatky jsou jednorázové a paušální po příčce: počáteční příčka je zdarma, dovednost 25 příček stojí {tier1} recept, dovednost 50 příček {tier2} a lekce s prutem nad nimi mají vlastní poplatky, uvedené u každého receptu v tabulce. Chcete-li trénovat, musíte stát na skutečné stanici velitele a mobilní stanice se nikdy nepočítá. Běžné polní receptury a šest vytvořených receptů na pozemní nástroje nepotřebují vůbec žádné školení; každá postava je zná od začátku.',
  'guide.profPages.wieldNone': 'Žádný',
  'guide.professions.archetypeSwitchBody':
    'Prohlášení také není doživotí. Dvojice, kterou jste nikdy nedrželi, je prostě nová výprava za naladěním, zatímco návrat ke dvojici, od které jste odešli, vás požádá, abyste se nejprve napravili: pět úkolů poprvé a tři další přidané za každý návrat, který jste již provedli (přijetí zbrusu nového páru nikdy nezvyšuje počet). Volba zůstává smysluplná, aniž byste kdy nadobro zamykali dveře.',
  'guide.professions.archetypesBody':
    'Deset řemesel sedí na pevném kole a na geografii na tomto kole záleží. Každý dva sousedé tvoří pojmenovanou dvojici: Smith pro výrobu zbraní a armorcrafting, konfekce pro zpracování kůže a krejčovství, lékárník pro alchymii a vaření, Bombardier pro strojírenství a alchymii a šest dalších kolem ringu.\n\nNaladění na pár je úkol, nikoli klikání v nabídce. Dnes je možné připojit čtyři páry (Smith, Outfitter, Apothecary a Bombardier), z nichž každý je ukotven rezidentním mistrem v Eastbrooku, jehož výzva k přijetí uvádí celou dohodu předem, než ji vezmete. Dokud to neprohlásíte, každé řemeslo volně postupuje podle receptů až po vzácnou úroveň (jakýkoli recept vyžadující dovednost 74 nebo méně), takže můžete vyzkoušet téměř vše, než si vyberete (samotné inženýrství nemá žádný recept tak nízký, takže jeho počet počká).\n\nJakmile se naladíte, vaše dva páry řemesel se stanou vašimi hlavními obory, bez stropu. Zbytek kola neztmavne: jedno plavidlo naproti vašim majorům zůstává jako koníček, který neustále šplhá přes vzácnou úroveň (opakovatelný úkol v kovárně Smitha Haldrena vám umožní vyměnit který z nich) a každé další plavidlo bude nečinné. Spící řemeslo si zachovává svou dovednost a své běžné recepty, které ho učí na normální křivce, dokud v 75 nezšediví; vše, co je nad obyčejné, okamžitě přestane platit a spící řemeslo se nikdy nestane mistrovským dílem, dokud odpočívá.',
  'guide.professions.startBody':
    'Čerstvý z cesty v Eastbrooku? Najděte Foremana Odella a vezměte si A Trade for Every Hand: nasměruje vás na rudné žíly kolem Copper Dig jihovýchodně od města a předá vám vaše první mozoly. Pozor na samotný výkop: Deeprock Diggers, kteří se na něm utábořili, stojí několik úrovní nad nově příchozím, takže nejprve zpracujte odlehlé žíly a uchovejte srdce tábora, až se trochu vyrovnáte. Od té doby sklízejte každou žílu, dřevěnou porost a bylinkovou záplatu, kterou projdete při hledání; znalost je pro cestovatele přirozená.\n\nZpátky ve městě stiskněte T, abyste otevřeli okno tvorby a pracujte podle běžných receptů, které každá postava zná od začátku. Navštivte mistry v kovárně, kuchyních, tkalcovských stavech a nástrojárnách, abyste viděli, co učí, a přijměte jejich pracovní příkazy za stálou minci. V době, kdy si vás dopis Gildy najde, už budete vědět, která dvojice se cítí jako doma.',
  'guide.professions.whatBody':
    'Profese jsou pracovním životem světa: čtyři sběratelská řemesla, která vytahují surovinu přímo ze země, a okruh deseti řemesel, která je proměňují ve výstroj, pokrmy, lektvary a nástroje. Všechno tu živí něco jiného. Ruda, kterou těžíte, se stává čepelí, čepel přijímá kouzlo a kouzlo potřebuje prach vylomený ze starého vybavení, takže sběrač, řemeslník a dráteník jsou všechny články v jednom řetězu.\n\nNeexistuje žádný limit profese, který by se dal trápit. Každá postava může vychovat sedm z osmi řemesel, která mají dnes obsah, a všechny čtyři shromažďovací profese vedle sebe (Inženýrství je jediná vychytávka: všechny její recepty začínají nad volným stropem, takže její žebřík čeká na přísahu Bombardiera); jedinou exkluzivní volbou je váš archetyp, identita, na kterou nakonec přísaháte, i když jakmile se naladíte na řemesla, která za ní dřímají, lezou pouze na jejich běžné recepty a minulá dovednost 75 už vůbec ne. Dovednosti nikdy neklesají a nic, co se naučíte, vám nikdy neodeberou.',
  'hudChrome.actionBar.bannerCapturing': 'Stisknutím klávesy svážete tento slot...',
  'hudChrome.actionBar.bannerHint':
    'Klikněte na slot a poté jej svažte stisknutím klávesy. Po dokončení klepněte na Hotovo.',
  'hudChrome.actionBar.boundToKey': 'Vázáno na {key}.',
  'hudChrome.actionBar.cancel': 'Zrušit',
  'hudChrome.actionBar.done': 'Hotovo',
  'hudChrome.actionBar.editKeys': 'Upravit klávesy na panelu akcí',
  'hudChrome.actionBar.editKeysHint':
    'Klikněte na slot na panelu akcí a poté jej svažte stisknutím klávesy.',
  'hudChrome.actionBar.reset': 'Resetovat',
  'hudChrome.actionBar.resetConfirmBody':
    'První pruh se vrátí na výchozí klávesy. Druhý a třetí pruh se stanou nevázané. Toto nelze vrátit zpět.',
  'hudChrome.actionBar.resetConfirmTitle': 'Resetovat klávesy na panelu akcí?',
  'hudChrome.bags.filterTool': 'Nástroje',
  'hudChrome.crafting.identity.allCrafts': 'Všechna řemesla',
  'hudChrome.crafting.identity.skillListAria': 'Řemeslné dovednosti',
  'hudChrome.crafting.reagentFineSub': '(útrata {count} v dobré kvalitě)',
  'hudChrome.deeds.broadcastsLabel':
    'Sdílejte odemknutí listin s cechovními kolegy a následovníky a karty listin a mistrovských děl pomocí kanálu Discord',
  'hudChrome.gathering.emptyHookNote': 'Nic na háku',
  'hudChrome.gathering.fineGradePreview': 'Váš nástroj zjemní tento výnos na jemnou třídu.',
  'hudChrome.gathering.respawnClock': '{minutes}:{seconds}',
  'hudChrome.gathering.stateCooldownTimed': 'Znovu se objeví v {time}',
  'hudChrome.gathering.toolTierUnmet.fishing':
    'K rybaření v těchto vodách potřebujete rybářský prut úrovně {tier}.',
  'hudChrome.gathering.toolTooltip.unlocks.fishing':
    'Vyžaduje se pro lov ve vodách do úrovně {tier}.',
  'hudChrome.gathering.wieldUnmet.herbalism':
    'Potřebujete Herbalism {skill}, abyste mohli pracovat se srpem, který už máte ve svých taškách.',
  'hudChrome.gathering.wieldUnmet.logging':
    'K tomu, abyste máchli sekerou, kterou už máte v taškách, potřebujete protokolování {skill}.',
  'hudChrome.gathering.wieldUnmet.mining':
    'Potřebujete Mining {skill}, abyste mohli mít trsátko ve svých taškách.',
  'hudChrome.gathering.wieldUnmetCorpse':
    'Abyste mohli používat svůj nejlepší nástroj, potřebujete získat dovednosti {skill}.',
  'hudChrome.materialHint.fineGrade':
    'Dobrá známka. Shromážděné z plné žíly s nástrojem nadřazeným materiálem a počítá se jako běžná verze všude tam, kde je potřeba.',
  'hudChrome.professions.toolEffectCharges': '{charges} z {max} poplatků',
  'hudChrome.professions.toolEffectConfirmAccept': 'Použijte poplatek',
  'hudChrome.professions.toolEffectConfirmBody':
    'Utratit poplatek za tuto sklizeň? Klesající se stále shromažďují, bez bonusu. Zbývající poplatky: {charges}.',
  'hudChrome.professions.toolEffectConfirmDecline': 'Shromáždit bez',
  'hudChrome.professions.toolEffectConfirmTitle': 'Použít {effect}?',
  'hudChrome.professions.toolEffectDepleted': 'Spotřebovaný efekt nástroje',
  'hudChrome.professions.toolEffectModeAsk': 'Zeptejte se každého použití',
  'hudChrome.professions.toolEffectModePrompt': 'Ptá se každého použití',
  'hudChrome.professions.toolEffectName.artisansEye': 'Oko řemeslníka',
  'hudChrome.professions.toolEffectName.gatherersCache': 'Sběratelská mezipaměť',
  'hudChrome.professions.toolEffectName.quickeningCharm': 'Springback kouzlo',
  'hudChrome.professions.toolEffectNoCharm':
    'Ve svých taškách potřebujete vytvořené kouzlo {effect}.',
  'hudChrome.professions.toolEffectNoGain': '{effect} je již zasunuto a plně nabito.',
  'hudChrome.professions.toolEffectNoTool': 'Nejprve potřebujete skutečný nástroj {profession}.',
  'hudChrome.professions.toolEffectRechargeButton': 'Dobít',
  'hudChrome.professions.toolEffectRechargeFull': '{effect} je již plně nabitá.',
  'hudChrome.professions.toolEffectRechargeMaterials':
    'Nabíjení {effect} vyžaduje {material} x{count}.',
  'hudChrome.professions.toolEffectRechargeNoSlot': 'Na {profession} není umístěn žádný efekt.',
  'hudChrome.professions.toolEffectRechargePrice': 'Dobití: {count} x {material}',
  'hudChrome.professions.toolEffectRechargeToolCapped':
    'Noste lepší nástroj {profession} k dalšímu nabíjení {effect}.',
  'hudChrome.professions.toolEffectRecharged': '{effect} dobito: {material} x{count} spotřebováno.',
  'hudChrome.professions.toolEffectSlotButton': 'Slot {effect}',
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} tam nelze umístit.',
  'hudChrome.professions.toolEffectSlotted': '{effect} umístěno na {profession}.',
  'hudChrome.professions.toolEffectSpent': 'Vybitý, potřebuje dobít',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    'Jedná se o cvičný zápas, takže není hodnocen: pořadí se nehýbe a postup v Book of Deeds se nepočítá.',
  'hudChrome.vcup.briefing.unratedNote':
    'Na hřišti jsou boti, takže tento zápas nemá hodnocení: pořadí se nehýbe a skutky za góly, zákroky a čisté konto se nepočítají.',
  'hudChrome.vcup.practiceUnratedNote':
    'Tréninkové zápasy jsou neohodnoceny: pořadí a postup v Book of Deeds se nepočítají.',
  'hudChrome.vcup.rolesSmallBracketNote':
    'V závorkách 1v1 a 2v2 hraje každý bojovník sadu All-Rounder. Skutky, které vyžadují 3v3 nebo větší, zde nelze získat.',
  'itemUi.bags.unknownItem': 'Neznámá položka',
  'itemUi.bags.unknownItemAria': 'Neznámá položka {id}, množství {count}',
  'itemUi.bags.unknownItemAriaBound': 'Neznámá položka {id}, množství {count}, vázaná kopie',
  'itemUi.bags.unknownItemAriaEnchanted': 'Neznámá položka {id}, množství {count}, okouzlená kopie',
  'itemUi.bags.unknownItemAriaInstanced':
    'Neznámá položka {id}, množství {count}, kopie označená výrobcem',
  'itemUi.bags.unknownItemAriaMasterwork':
    'Neznámá položka {id}, množství {count}, mistrovské dílo',
  'itemUi.kind.fineMaterial': 'Jemný Materiál',
  'itemUi.vendor.buyAriaWithRequirement': 'Koupit {item} za {price}. {requirement}',
  'itemUi.vendor.buyCountAria': 'Koupit {count} z {item} za {price}',
  'itemUi.vendor.buyCountAriaWithRequirement': 'Kupte {count} z {item} za {price}. {requirement}',
  'itemUi.vendor.buyQuantityConfirm': 'Nakoupit',
  'itemUi.vendor.buyQuantityInput': 'Množství k nákupu',
  'itemUi.vendor.buyQuantityTitle': 'Kolik {item} koupit? Až {max}.',
  'itemUi.vendor.qtyCustom': 'Zvyk',
  'itemUi.vendor.qtyCustomAria': 'Vyberte si vlastní částku k nákupu',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Nakupujte {count} najednou',
  'itemUi.vendor.qtyRowAria': 'Nákupní množství',
  'questUi.dialog.repeatableQuestAria': 'Opakovatelný úkol: {name}',
  'questUi.log.cooldownStatus': 'Brzy opět k dispozici',
  'questUi.log.repeatableStatus': 'Opakovatelné',
