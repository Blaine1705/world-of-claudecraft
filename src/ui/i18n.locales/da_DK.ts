...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolsNote':
    'Enhver ressourcekilde kræver sit fags værktøj i dine tasker, også niveau 1: ingen hakke, ingen malm, og ingen stang, ingen fisk. Forhandlerstigen dækker niveau 1 til 3, og hver hub-by fører kun de niveauer, dens eget terræn bruger: værktøjet på niveau 1 sælges i enhver hub-by, mens trinnene over det sælges dér, hvor de årer ligger, der kræver dem. Til de trin kræver handlende desuden færdighed i værktøjets eget fag, {tier2Prof} til niveau 2 og {tier3Prof} til niveau 3, og rækken nævner kravet. Et værktøj skal blot være i dine tasker, der er ingen udstyringsplads og ingen holdbarhed, så hvert enkelt er et engangskøb, og det, du allerede ejer, virker fortsat. Kun niveauet betyder noget for adgangsbetingelsen: et værktøjs sjældenhedsfarve er kosmetisk.\n\nOver forhandlerstigen sidder to fremstillede værktøjer, niveau 4 og niveau 5, lavet på værkstedet af ingeniører og aldrig solgt af nogen NPC. Ingen ressourcekilde i dag kræver mere end niveau 3, så deres værdi lige nu er fart: et topværktøj fastholder kastet ved dets gulv på lavere ressourcekilder, og det vil være adgangskortet, når terræn af højere niveau ankommer.',
