...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.fine_ashwood_log.name': 'Fin Ashwood Log',
  'entities.items.fine_copper_ore.name': 'fin kobbermalm',
  'entities.items.fine_elderwood_log.name': 'Fin Highpine Log',
  'entities.items.fine_goldleaf_herb.name': 'Fin bladguld urt',
  'entities.items.fine_iron_ore.name': 'Fin jernmalm',
  'entities.items.fine_ironbark_log.name': 'Fin Ironbark Log',
  'entities.items.fine_silverleaf_herb.name': 'Fin sheenleaf urt',
  'entities.items.fine_sunpetal_herb.name': 'Fin solbladsurt',
  'entities.items.fine_thorium_ore.name': 'Fin Osmiummalm',
  'entities.items.gatherers_cache.name': 'Samlers cache',
  'entities.items.stormreel_fishing_rod.name': 'Stormreel fiskestang',
  'entities.items.tidewrought_fishing_rod.name': 'Tidewrought fiskestang',
  ...
  'hudChrome.actionBar.bannerHint':
    'Klik på en plads, og tryk derefter på en tast for at binde den. Klik på Udført, når du er færdig.',
  'hudChrome.actionBar.boundToKey': 'Bundet til {key}.',
  'hudChrome.actionBar.cancel': 'Ophæve',
  'hudChrome.actionBar.done': 'Færdig',
  'hudChrome.actionBar.editKeys': 'Rediger handlingslinjetaster',
  ...
  'hudChrome.actionBar.resetConfirmBody':
    'Den første bjælke vender tilbage til standardtasterne. Anden og tredje takt bliver ubundet. Dette kan ikke fortrydes.',
  'hudChrome.actionBar.resetConfirmTitle': 'Nulstille handlingslinjetasterne?',
  'hudChrome.bags.filterTool': 'Værktøjer',
  'hudChrome.crafting.identity.allCrafts': 'Alt håndværk',
  'hudChrome.crafting.identity.skillListAria': 'Håndværksfærdigheder',
  'hudChrome.crafting.reagentFineSub': '(bruger {count} fine karakter)',
  'hudChrome.deeds.broadcastsLabel':
    'Del skødoplåsninger med guildmates og følgere og skøde- og mesterværkskort med Discord-feedet',
  'hudChrome.gathering.emptyHookNote': 'Intet på krogen',
  'hudChrome.gathering.fineGradePreview': 'Dit værktøj forfiner dette udbytte til finkvalitet.',
  'hudChrome.gathering.respawnClock': '{minutes}:{seconds}',
  'hudChrome.gathering.stateCooldownTimed': 'Genopretter i {time}',
  'hudChrome.gathering.toolTierUnmet.fishing':
    'Du skal bruge en tier {tier} fiskestang for at fiske disse farvande.',
  'hudChrome.gathering.toolTooltip.unlocks.fishing':
    'Påkrævet for at fiske vand op til niveau {tier}.',
  'hudChrome.gathering.wieldUnmet.herbalism':
    'Du har brug for Herbalism {skill} for at bearbejde seglen allerede i dine tasker.',
  'hudChrome.gathering.wieldUnmet.logging':
    'Du skal bruge Logging {skill} for at svinge øksen allerede i dine tasker.',
  'hudChrome.gathering.wieldUnmet.mining':
    'Du har brug for Mining {skill} for at svinge picken allerede i dine tasker.',
  'hudChrome.gathering.wieldUnmetCorpse':
    'Du har brug for at samle færdigheder {skill} for at få dit bedste værktøj til at fungere.',
  'hudChrome.materialHint.fineGrade':
    'Fin karakter. Samlet fra en hel-tier vene med et værktøj rangeret over materialet, og tæller som den almindelige version, hvor end det er nødvendigt.',
  'hudChrome.professions.toolEffectCharges': '{charges} af {max} debiteringer',
  'hudChrome.professions.toolEffectConfirmAccept': 'Brug en Charge',
  'hudChrome.professions.toolEffectConfirmBody':
    'Brug en afgift på denne høst? Faldende samler stadig, uden bonus. Afgifter tilbage: {charges}.',
  'hudChrome.professions.toolEffectConfirmDecline': 'Saml uden',
  'hudChrome.professions.toolEffectConfirmTitle': 'Vil du bruge {effect}?',
  'hudChrome.professions.toolEffectDepleted': 'Værktøjseffekt brugt',
  'hudChrome.professions.toolEffectModeAsk': 'Spørg hver brug',
  'hudChrome.professions.toolEffectModePrompt': 'Spørger hver brug',
  'hudChrome.professions.toolEffectName.artisansEye': 'Håndværkerens øje',
  'hudChrome.professions.toolEffectName.gatherersCache': 'Samlers cache',
  'hudChrome.professions.toolEffectName.quickeningCharm': 'Springback charme',
  'hudChrome.professions.toolEffectNoCharm':
    'Du skal bruge en udformet {effect} charm i dine tasker.',
  'hudChrome.professions.toolEffectNoGain': '{effect} er allerede spaltet og fuldt opladet.',
  'hudChrome.professions.toolEffectNoTool': 'Du skal først have et rigtigt {profession} værktøj.',
  ...
  'hudChrome.professions.toolEffectRechargeNoSlot': 'Der er ingen effekt på {profession}.',
  'hudChrome.professions.toolEffectRechargePrice': 'Genopladning: {count} x {material}',
  'hudChrome.professions.toolEffectRechargeToolCapped':
    'Medbring et bedre {profession}-værktøj for at oplade {effect} yderligere.',
  ...
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} kan ikke placeres der.',
  'hudChrome.professions.toolEffectSlotted': '{effect} indsat på {profession}.',
  'hudChrome.professions.toolEffectSpent': 'Brugt, trænger til genopladning',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    'Dette er en træningskamp, ​​så den er ikke bedømt: Stillingen flytter sig ikke, og fremskridt i gerningsbogen tæller ikke.',
  'hudChrome.vcup.briefing.unratedNote':
    'Bots er på banen, så denne kamp er ikke vurderet: Stillingen flytter sig ikke, og målsager, redninger og clean sheets tæller ikke.',
  'hudChrome.vcup.practiceUnratedNote':
    'Øvelseskampe er ikke bedømte: stillinger og fremskridt i Bog of Deeds tæller ikke.',
  'hudChrome.vcup.rolesSmallBracketNote':
    'I 1v1 og 2v2 parentes spiller hver fighter All-Rounder kittet. Skøder, der kræver 3v3-beslaget eller større, kan ikke optjenes her.',
  'itemUi.bags.unknownItem': 'Ukendt vare',
  'itemUi.bags.unknownItemAria': 'Ukendt vare {id}, antal {count}',
  'itemUi.bags.unknownItemAriaBound': 'Ukendt vare {id}, antal {count}, indbundet kopi',
  'itemUi.bags.unknownItemAriaEnchanted': 'Ukendt vare {id}, antal {count}, fortryllet kopi',
  'itemUi.bags.unknownItemAriaInstanced': 'Ukendt vare {id}, antal {count}, producent-mærket kopi',
  'itemUi.bags.unknownItemAriaMasterwork': 'Ukendt vare {id}, antal {count}, mesterværk',
  'itemUi.kind.fineMaterial': 'fint materiale',
  'itemUi.vendor.buyAriaWithRequirement': 'Køb {item} for {price}. {requirement}',
  'itemUi.vendor.buyCountAria': 'Køb {count} af {item} for {price}',
  'itemUi.vendor.buyCountAriaWithRequirement': 'Køb {count} af {item} for {price}. {requirement}',
  'itemUi.vendor.buyQuantityConfirm': 'Købe',
  'itemUi.vendor.buyQuantityInput': 'Mængde at købe',
  'itemUi.vendor.buyQuantityTitle': 'Køb hvor mange {item}? Op til {max}.',
  'itemUi.vendor.qtyCustom': 'Skik',
  'itemUi.vendor.qtyCustomAria': 'Vælg et brugerdefineret beløb for at købe',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Køb {count} ad gangen',
  'itemUi.vendor.qtyRowAria': 'Købsmængde',
  'questUi.dialog.repeatableQuestAria': 'Gentagelig quest: {name}',
  'questUi.log.cooldownStatus': 'Snart tilgængelig igen',
  'questUi.log.repeatableStatus': 'Gentagelig',
  'questUi.tracker.unknownQuest': 'Ukendt mission ({id})',
};
