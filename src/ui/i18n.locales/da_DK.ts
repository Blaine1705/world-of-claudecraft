...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.tooltip.requiresStealthSkulduggery': 'Kræver snigen (ikke nødvendigt ved 3 Tusmørke eller under Skyggesløret)',
  'abilityUi.tooltip.ruinCost': '{cost} Ruin',
  'entities.abilities.abyssal_rift.description': 'Åbner en rift på det valgte sted, trækker fjender inden for 8 m ind mod dens centrum, giver {damage} Skyggeskade og bedøver dem i 2 sek. Bosser tager skade, men modstår trækket og bedøvelsen.',
  'entities.abilities.abyssal_rift.name': 'Abyssal Rift',
  'entities.abilities.ambush.description': 'Slå til fra skyggerne for 250% våbenskade plus {damage}. Skal være i snigen og bag målet. Kræver en dolk. Giver 1 combopoint.',
  'entities.abilities.ambush.specNote_subtlety': 'Brugt fra Skumringsslør tilføjer dette 1 Tusmørke (maks. 3). Ved 3 Tusmørke kan du bruge den UDEN snigen og fra enhver vinkel: den brug koster intet, forbruger alle 3 Tusmørke, starter det 6 sek. lange Skyggesløret og rammer dobbelt.',
  'entities.abilities.army_of_the_dead.description': 'Åbner en gravportal og rejser en midlertidig Skeletkriger, Knoglemagiker og Gravvinge i 20 sek., der fylder de pladser, dine stående Herredømme-tjenere lader stå tomme.',
  'entities.abilities.army_of_the_dead.name': 'Army of the Dead',
  'entities.abilities.backstab.description': 'Stød din dolk ind i målets ryg for 150% våbenskade plus {damage}. Skal være bag målet. Kræver en dolk. Giver 1 combopoint.',
  'entities.abilities.backstab.specNote_assassination': 'Hvert slag tilføjer 1 Giftritual (maks. 6) og gendanner 15 energi. Ved 6 Giftritual bliver Gravsøvn til Giftflænge (den giver al din resterende blødningsskade på én gang).',
  'entities.abilities.blade_flurry.description': 'Slipper en klingebyge løs, der øger angrebshastigheden med 20% i 12 sek. (Thuggery-motoren)',
  'entities.abilities.bone_armor.description': 'Hyller dig i knogler og opsuger skade svarende til 20% af dit maksimale helbred.',
  'entities.abilities.bone_armor.name': 'Bone Armor',
  'entities.abilities.cheap_shot.description': 'Slå målet for {damage} skade og bedøv det i 4 sek. Skal være i snigen. Giver 2 combopoint.',
  'entities.abilities.cheap_shot.specNote_subtlety': 'Brugt fra Skumringsslør tilføjer dette 1 Tusmørke (maks. 3). Ved 3 Tusmørke kan du bruge den UDEN snigen: den brug koster intet, forbruger alle 3 Tusmørke og starter det 6 sek. lange Skyggesløret.',
  'entities.abilities.cinderhide.description': 'Hærder din hud til afkølende slagge i 10 sek. og reducerer al skade modtaget med 25%.',
  'entities.abilities.cinderhide.name': 'Cinderhide',
  'entities.abilities.claw.description': 'Klo fjenden for våbenskade plus {damage}. Giver 1 combopoint. Kun i Ulveform.',
  'entities.abilities.claw.specNote_feral': 'Hvert slag, der rammer, tilføjer 1 Gammelt Blod (maks. 3).',
  'entities.abilities.cold_blood.description': 'Fokuserer din dræberinstinkt, så dit næste angreb rammer kritisk. (Knifework-motoren)',
  'entities.abilities.corpse_explosion.description': 'Ofrer først en Knoglemagiker, dernæst en Skeletkriger, og en Gravvinge kun som sidste udvej. Blandt dubletter vælges den med kortest resterende varighed, dernæst den svageste, for at give {damage} Skyggeskade på det valgte sted.',
  'entities.abilities.corpse_explosion.name': 'Corpse Explosion',
  'entities.abilities.coven.description': 'Skaber sekundære Evil Eye på op til 4 nærliggende fjender i 15 sek. De fodrer den delte Fordømmelse-pulje med 50%, og Sentence ekkoer til dem for 35% skade.',
  'entities.abilities.coven.name': 'Coven',
  'entities.abilities.cruel_pact.description': 'Ofrer 12% af dit maksimale helbred for at genoprette 1,5% af din maksimale mana og generere 20 Fordømmelse. Kan ikke bruges ved eller under 20% helbred.',
  'entities.abilities.cruel_pact.name': 'Cruel Pact',
  'entities.abilities.cursed_accomplice.description': 'Forbinder dit Maledict Eye, når ingen allieret er valgt, så dets Gaze genererer 2 Fordømmelse. At forbinde ét valgt gruppemedlem gør i stedet, at kun deres skade til dit Evil Eye genererer 3. Et nyt bånd erstatter det forrige og kan udløses højst én gang hvert 2. sek.',
  'entities.abilities.cursed_accomplice.name': 'Cursed Accomplice',
  'entities.abilities.dark_pact.description': 'Ofrer 10% af dit nuværende helbred for at opsuge skade svarende til 30% af dit maksimale helbred i 8 sek.',
  'entities.abilities.dark_pact.name': 'Sanguine Covenant',
  'entities.abilities.elemental_trance.description': 'Gå i elementær trance i 15 sek., hvilket reducerer skade modtaget med 30% og omdanner 20% af al skade, du gør, til mana. (Krigsånd-motoren)',
  'entities.abilities.elemental_trance.name': 'Elemental Trance',
  'entities.abilities.evil_eye.description': 'Mærker én fjende som fokus for dine forbandelser. At flytte Øjet bevarer Fordømmelse, men fornyer ikke dets 20 sek. udløb.',
  'entities.abilities.evil_eye.name': 'Evil Eye',
  'entities.abilities.eviscerate.description': 'Afsluttende manøvre, der giver {damage}.',
  'entities.abilities.eviscerate.specNote_assassination': 'Ved 6 Giftritual bliver denne knap til Giftflænge: et slag, der øjeblikkeligt giver al den skade, dine blødninger stadig ville have givet, planter et frisk giftsår og gendanner 20 energi.',
  'entities.abilities.eviscerate.specNote_combat': 'At lande dette med 4 eller flere combopoint starter Redline i 8 sek.: Ondsindet Hug bliver til Kropsstød, og denne knap bliver til Knockoutstød (45 plus 35 pr. combopoint, der rammer 25% hårdere for hvert opbygget Redline-hak, og gendanner 25 energi). Brug det, før Redline slutter.',
  'entities.abilities.expose_armor.description': 'Afsluttende manøvre, der blotter målet i 30 sek.: hvert brugt combopoint reducerer dets rustning med 2% (5 combopoint: {damage}%).',
  'entities.abilities.faerie_fire.description': 'Reducerer målets rustning med {damage}% i 40 sek.',
  'entities.abilities.ferocious_bite.description': 'Afsluttende manøvre, der giver {damage}. Kun i Ulveform.',
  'entities.abilities.ferocious_bite.specNote_feral': 'Hvert slag, der rammer, tilføjer 1 Gammelt Blod; ved 3 Gammelt Blod bliver denne knap til Rød Høst: et bid for 70 plus 43 pr. combopoint, der også øjeblikkeligt giver al den skade, dine Flæns og Sønderriv stadig ville have givet, og gendanner 30 energi.',
  'entities.abilities.funeral_harvest.description': 'Når en fjende, du eller dine udøde for nylig har skadet, dør, får du 1 Sjælesplint. Dette kan ske højst én gang hvert 3. sek.',
  'entities.abilities.funeral_harvest.name': 'Funeral Harvest',
  'entities.abilities.garrote.description': 'Løkker en tråd om fjendens strube og giver {damage} skade nu samt {overTime} blødningsskade over 18 sek. Skal være i snigen. Giver 1 combopoint.',
  'entities.abilities.garrote.specNote_subtlety': 'Brugt fra Skumringsslør tilføjer dette 1 Tusmørke (maks. 3). Ved 3 Tusmørke kan du bruge den UDEN snigen: den brug koster intet, forbruger alle 3 Tusmørke og starter det 6 sek. lange Skyggesløret.',
  'entities.abilities.ghostly_strike.description': 'Slår fjenden for våbenskade plus {damage} og øger din undvigelseschance med 15% i 7 sek. Giver 1 combopoint. (slyngeltalent)',
  'entities.abilities.hemorrhage.description': 'Slår fjenden for våbenskade plus {damage}, giver blødningsskade over 12 sek. og øger blødningsskade modtaget med 40%. Giver 1 combopoint. Hver 2. brug tilføjer 1 Tusmørke (maks. 3). (Skulduggery-motoren)',
  'entities.abilities.hex_of_violence.description': 'Forhekser fjenden i 8 sek. Dens næste 3 skadevoldende handlinger genererer hver 7 Fordømmelse og pisker den for 16 Skyggeskade.',
  'entities.abilities.hex_of_violence.name': 'Hex of Violence',
  'entities.abilities.hour_of_judgment.description': 'Kalder dom over dit primære Evil Eye i 15 sek., giver 40 Fordømmelse og 3 Skæbnetråde, aktiverer Besættelse, fordobler Fordømmelse genereret gennem det primære Øje og øger Sentence-skade med 20%. Den første Sentence refunderer 50 Fordømmelse.',
  'entities.abilities.hour_of_judgment.name': 'Hour of Judgment',
  'entities.abilities.kidney_shot.description': 'Afsluttende manøvre, der bedøver målet i 1 sek. plus 1 sek. pr. combopoint (5 combopoint: 6 sek.).',
  'entities.abilities.litany_of_guilt.description': 'Forbander dit primære Evil Eye i 6 sek. Fordømmelsesgevinster udløser en bølge, der skader op til 2 andre fjender inden for 8 m, højst én gang pr. sekund. Rang 2 forlænger den til 8 sek. og 4 fjender.',
  'entities.abilities.litany_of_guilt.name': 'Litany of Guilt',
  'entities.abilities.maledict_gaze.description': 'Dit Maledict Eye angriber dit valgte primære Evil Eye hvert 2,5 sek for Skyggeskade. Possess the Evil Eye fordobler dets angrebshastighed.',
  'entities.abilities.maledict_gaze.name': 'Maledict Gaze',
  'entities.abilities.maul.description': 'Et knusende angreb, der øger nærkampsskaden med {damage} og forårsager en stor mængde trussel. Aktiveres ved dit næste sving. Kun i Bruin-form.',
  'entities.abilities.maul.specNote_feral': 'Hvert slag, der rammer, tilføjer 1 Gammelt Blod; ved 3 Gammelt Blod bliver denne knap til Marvbrækker: et slag for 78 til 96 skade med høj trussel; under halvt helbred beskytter det dig i stedet med et skjold på 18% af dit maksimale helbred og refunderer 15 raseri.',
  'entities.abilities.moonfire.description': 'Brænder fjenden med månebrand for {damage} arkan skade plus skade over tid.',
  'entities.abilities.moonfire.specNote_balance': 'Hold den brændende: Månefrø forlænger den med 6 sek.',
  'entities.abilities.needle_of_fate.description': 'Gennemborer fjenden for {damage} Skyggeskade og genererer 5 Fordømmelse, hvis den bærer dit Evil Eye. Hvert træf på dit primære Evil Eye tilføjer en Skæbnetråd i 12 sek., op til 3. Findes intet Evil Eye, mærker Needle of Fate først sit mål.',
  'entities.abilities.needle_of_fate.name': 'Needle of Fate',
  'entities.abilities.ossuary_mark.description': 'Mærker en fjende i 12 sek. og opbevarer 20% af skaden, du og dine udøde gør. Kast igen for at detonere det. Hvis det mærkede mål dør, eksploderer det inden for 6 m og skaber 1 Sjælesplint.',
  'entities.abilities.ossuary_mark.name': 'Ossuary Mark',
  'entities.abilities.possess_evil_eye.description': 'Maledictor besætter dit primære Evil Eye i 15 sek. og genererer 35 Fordømmelse. Needle of Fate kastes på 1 sek. og genererer 2 ekstra Fordømmelse, Fortær kan kanaliseres, mens du bevæger dig, og Sentence gør 25% mere skade og udløser et forsinket ekko for 60% skade, aftagende til 30% hen over niveau 17 til 20.',
  'entities.abilities.possess_evil_eye.name': 'Possess the Evil Eye',
  'entities.abilities.raise_bone_mage.description': 'Bruger 2 Sjælesplinter for at tilføje en vedvarende Knoglemagiker på afstand til dit 2-plads Herredømme. Kun én kan tjene dig ad gangen. Dens angreb blotter målet for 5% mere magisk skade i 6 sek., og Reaping Command hæver den svaghed til 8%.',
  'entities.abilities.raise_bone_mage.name': 'Raise Bone Mage',
  'entities.abilities.raise_graveguard.description': 'Rejser en permanent defensiv følgesvend. Gravvogteren håner automatisk, opsuger 20% af din skade gennem Gravherredømmet, og Reaping Command får den til at håne og tage 30% mindre skade i 4 sek.',
  'entities.abilities.raise_graveguard.name': 'Raise Graveguard',
  'entities.abilities.raise_gravewing.description': 'Bruger 2 Sjælesplinter for at tilføje en vedvarende Gravvinge til dit 2-plads Herredømme. Kun én kan tjene dig ad gangen. Den kløver nærliggende fjender for 65% skade hvert 5. sek., og Reaping Command får hver ramt fjende til at tage 8% mere skade i 5 sek.',
  'entities.abilities.raise_gravewing.name': 'Raise Gravewing',
  'entities.abilities.raise_skeletal_warrior.description': 'Bruger 1 Sjælesplint for at tilføje en vedvarende Skeletkriger til dit 2-plads Herredømme. Kun én kan tjene dig ad gangen. Den kløver nærliggende fjender for 45% skade hvert 6. sek., og Reaping Command nedsætter dens måls bevægelse med 40% i 4 sek.',
  'entities.abilities.raise_skeletal_warrior.name': 'Raise Skeletal Warrior',
  'entities.abilities.rake.description': 'Flæns fjenden for våbenskade plus {damage} og giv blødningsskade over 18 sek. Giver 1 combopoint. Kun i Ulveform.',
  'entities.abilities.rake.specNote_feral': 'Hvert slag, der rammer, tilføjer 1 Gammelt Blod (maks. 3).',
  'entities.abilities.reaping_command.description': 'Bruger 2 Sjælesplinter for at befale alle udøde tjenere at slå til i samlet flok. Gravvogtere håner og forbereder sig, Krigere fastholder, Knoglemagikere blotter magiske forsvar, og Gravvingen flænger alle ramte fjender.',
  ...
  'entities.abilities.regrowth.specNote_restoration': 'At plante en NY blomstring tilføjer 1 Grønske (maks. 5).',
  'entities.abilities.rejuvenation.description': 'Helbreder målet for {damage} over 12 sek.',
  'entities.abilities.rejuvenation.specNote_restoration': 'At plante en NY blomstring tilføjer 1 Grønske (maks. 5). Ved 5 Grønske bliver Hurtig heling til Overblomstring.',
  'entities.abilities.rip.description': 'Afsluttende manøvre, der får målet til at bløde hvert 2. sek. i 24 sek.: 36 skade plus 24 pr. brugt combopoint (5 combopoint: {damage} i alt). Kun i Ulveform.',
  'entities.abilities.rip.specNote_feral': 'Det ramte slag tilføjer 1 Gammelt Blod (maks. 3).',
  'entities.abilities.ruinous_brand.description': 'Brænder en fjende i 15 sek. Dine næste 3 direkte besværgelser ekkoer for 25% skade mod den brændemærkede fjende, eller kopierer 50% skade til den, når de kastes mod et andet mål.',
  'entities.abilities.ruinous_brand.name': 'Ruinous Brand',
  'entities.abilities.rupture.description': 'Afsluttende manøvre, der sårer målet: det bløder hvert 2. sek. i 6 sek. plus 2 sek. pr. combopoint (5 combopoint: 16 sek. og {damage} skade i alt).',
  'entities.abilities.sacrifice_undead.description': 'Destruerer én Herredømme-tjener for at genoprette 25% af dit maksimale helbred.',
  'entities.abilities.sacrifice_undead.name': 'Sacrifice Undead',
  'entities.abilities.sacrilegious_march.description': 'Øger bevægelseshastigheden med 35%, men ofrer 2% af dit maksimale helbred hvert sekund. Kast igen for at annullere. Den slår fra ved 20% helbred.',
  'entities.abilities.sacrilegious_march.name': 'Sacrilegious March',
  'entities.abilities.sentence.description': 'Forbruger al Fordømmelse og alle Skæbnetråde for at afsige dom over fjenden. Hver Tråd øger skaden med 6%. Ekstra effekter eskalerer ved 20, 50, 80 og 100 Fordømmelse. Dens skadesskalering flader ud efter niveau 16.',
  'entities.abilities.sentence.name': 'Sentence',
  'entities.abilities.sinister_strike.description': 'Et øjeblikkeligt slag for våbenskade plus {damage}. Giver 1 combopoint.',
  'entities.abilities.sinister_strike.specNote_assassination': 'Tilføjer 1 Giftritual (maks. 6).',
  'entities.abilities.sinister_strike.specNote_combat': 'Mens Redline er aktiv, bliver denne knap til Kropsstød: 130% våbenskade plus 10, giver 2 combopoint og tilføjer 1 Redline (maks. 4).',
  'entities.abilities.slice_and_dice.description': 'Afsluttende manøvre, der øger nærkampsangrebshastigheden med 30% i 12 sek. plus 4 sek. pr. combopoint (5 combopoint: 32 sek.).',
  'entities.abilities.soul_harvest.description': 'River i fjendens sjæl for {damage} Skyggeskade og skaber 1 Sjælesplint, op til 5.',
  'entities.abilities.soul_harvest.name': 'Essence Reap',
  'entities.abilities.soul_lance.description': 'Kaster en spøgelseslanse for {damage} Skyggeskade. Mod dit Ossuary Mark tilføjes 50% af dens skade til mærket.',
  'entities.abilities.soul_lance.name': 'Soul Lance',
  'entities.abilities.soulwell.description': 'Tilkalder en Soulwell i 3 min. Uden for kamp kan gruppemedlemmer genopfylde deres Sjælesten op til 3. En Sjælesten genopretter 25% af maksimalt helbred og deler afkøling med Helbredelsesdrikke.',
  'entities.abilities.soulwell.name': 'Soulwell',
  'entities.abilities.starfire.description': 'Nedkalder et stråleglimt af stjerneild og giver {damage} arkan skade.',
  'entities.abilities.starfire.specNote_balance': 'I Månekinform tilføjer hver fuldført besværgelse 1 Måneflod (maks. 3). Ved 3 Måneflod bliver denne knap til Solspor: et øjeblikkeligt slag for 80 til 100 naturskade plus en forbrænding på 45 over 9 sek., der gendanner 35 mana og forbruger alle 3.',
  'entities.abilities.stealth.description': 'Skjuler dig i skyggerne: fjender lægger næsten ikke mærke til dig, men du bevæger dig 50% langsommere. At angribe eller tage skade bryder Skumringsslør. Kast igen for at træde frem.',
  'entities.abilities.stealth.specNote_subtlety': 'Hver åbner, du bruger fra Skumringsslør, tilføjer 1 Tusmørke (maks. 3).',
  ...
  'entities.abilities.swipe.description': 'Fej dine kløer gennem nærliggende fjender for {damage} skade. Forårsager ekstra trussel. Kun i Bruin-form.',
  'entities.abilities.swipe.specNote_feral': 'Hvert slag, der rammer, tilføjer 1 Gammelt Blod (maks. 3).',
  'entities.abilities.umbral_anchor.description': 'Første kast: forankrer din skygge ved dine fødder i 5 min. Kast igen inden for 40 m for at vende tilbage dertil, hvilket forbruger ankeret og starter en 45 sek. nedkøling.',
  'entities.abilities.umbral_anchor.name': 'Umbral Anchor',
  'entities.abilities.unholy_command.description': 'Bruger 3 Sjælesplinter for at befale alle dine udøde at gøre 25% mere skade og handle 20% hurtigere i 12 sek.',
  'entities.abilities.unholy_command.name': 'Unholy Command',
  'entities.abilities.venom_dart.specNote_assassination': 'Tilføjer 1 Giftritual og forlænger dit giftsår med 6 sek. (såret kommer aldrig over 20 sek.).',
  'entities.abilities.vicarious_suffering.description': 'Forbinder din lidelse i 8 sek. og genererer op til 15 Fordømmelse fra fjendtlige træf. På dig selv reducerer det skade modtaget med 20%. På en allieret omdirigerer det op til 20% til dig, uden at bringe dig under 15% helbred.',
  'entities.abilities.vicarious_suffering.name': 'Vicarious Suffering',
  'entities.abilities.wrath.description': 'Kaster et lyn af naturenergi for {damage} naturskade.',
  'entities.abilities.wrath.specNote_balance': 'I Månekinform tilføjer hver fuldført besværgelse 1 Måneflod (maks. 3). Ved 3 Måneflod bliver Månefrø til Månebølge, og Himmelfald bliver til Solspor.',
  'entities.items.boneglass_shiv.name': 'Knogleglas-Dolk',
  'entities.items.duskwhisper.name': 'Skumringshvisken',
  'entities.items.marrowpoint.name': 'Marvspids',
  'entities.items.rimefang.name': 'Rimhugtand',
  'entities.items.soul_stone.name': 'Sjælesten',
  'entities.mobs.graveguard.name': 'Gravvogter',
  'entities.mobs.necromancy_bone_mage.name': 'Knoglemagiker',
  'entities.mobs.necromancy_gravewing.name': 'Gravvinge',
  'entities.mobs.necromancy_skeletal_warrior.name': 'Skeletkriger',
  'guide.abilityHook.evil_eye': 'Navngiver den fjende, hvis handlinger og lidelse vil fodre din Fordømmelse.',
  'hud.pet.abyssalChain': 'Afgrundskæde',
  'hud.pet.abyssalChainDesc': 'Befal Gloomshaden at trække en normal fjende mere end 8 og op til 20 m tilbage til sig selv. Bosser kan ikke trækkes. 15 sekunders nedkøling. Højreklik, langt tryk eller tryk Shift+Enter for at slå automatisk kast til/fra.',
  'hud.pet.abyssalChainTitle': 'Afgrundskæde',
  'hud.pet.autocastOff': 'Automatisk kast er slået fra. Højreklik, langt tryk eller tryk Shift+Enter for at slå det til.',
  'hud.pet.autocastOn': 'Automatisk kast er slået til. Højreklik, langt tryk eller tryk Shift+Enter for at slå det fra.',
  'hud.pet.felbolt': 'Dæmonlyn',
  'hud.pet.felboltDesc': 'Befal Emberkinen at affyre endnu et dæmonprojektil mod dit mål. 8 sekunders nedkøling. Højreklik, langt tryk eller tryk Shift+Enter for at slå automatisk kast til/fra.',
  'hud.pet.felboltTitle': 'Dæmonlyn',
  'hudChrome.auraEffect.afflictionAccomplice': 'Kvalificerende skade giver {value} Fordømmelse, højst én gang hvert {interval}. sek',
  'hudChrome.auraEffect.afflictionConsumeThreads': 'Fortær forbruger {stacks} Skæbnetråde for {doom} ekstra Fordømmelse pr. tik',
  'hudChrome.auraEffect.afflictionEye': 'Maledict Gaze angriber hvert {interval}. sek; effekter ved dette Øje genererer {pct}% Fordømmelse',
  'hudChrome.auraEffect.afflictionEyeSecondary': 'Effekter ved dette Øje genererer {doomPct}% Fordømmelse; Sentence ekkoer hertil for {echoPct}% skade',
  'hudChrome.auraEffect.afflictionFateThreads': '{stacks} Skæbnetråde: Sentence gør {sentencePct}% mere skade, eller Fortær får {doom} ekstra Fordømmelse pr. tik',
  'hudChrome.auraEffect.afflictionJudgment': 'Det primære Øje genererer {eyePct}% mere Fordømmelse; Sentence gør {sentencePct}% mere skade, og den første refunderer {refund} Fordømmelse',
  'hudChrome.auraEffect.afflictionLitany': 'Fordømmelsesgevinster gør {damage} Skyggeskade til op til {targets} fjender inden for {radius} m, én gang pr. sek',
  'hudChrome.auraEffect.afflictionPossession': 'Styrker Needle of Fate, Fortær, Maledict Gaze og Sentence',
  'hudChrome.auraEffect.afflictionVicarious': 'Omdirigerer eller reducerer {pct}% af indkommende skade og kan generere op til {max} Fordømmelse',
  'hudChrome.auraEffect.afflictionViolence': '{charges} gengældelser tilbage; et fjendtligt angreb giver {doom} Fordømmelse og giver {damage} Skyggeskade tilbage',
  'hudChrome.auraEffect.aoeEcho': '{charges} ekkoer tilbage: enkeltmålsevner gør {pct}% skade til op til {targets} nærliggende fjender',
  'hudChrome.auraEffect.arcaneCharge': '{stacks} Arkane Ladninger: Arkan kraft gør {damagePct}% mere skade, kastes {castPct}% hurtigere og koster {costMult}x mana',
  'hudChrome.auraEffect.bleedVuln': 'Øger blødningsskade modtaget med {pct}%',
  'hudChrome.auraEffect.brainFreeze': 'Din næste Vinterpisk er øjeblikkelig og ignorerer sin nedkøling',
  'hudChrome.auraEffect.castShield': 'Kast kan ikke afbrydes eller forsinkes af skade',
  'hudChrome.auraEffect.cauterizeFatigue': 'Kauterisering kan ikke forhindre endnu et dræbende slag',
  'hudChrome.auraEffect.cooldownCap': '{used} af {cap} sek. nedkølingsreduktion brugt i dette vindue',
  'hudChrome.auraEffect.desolation': '{charges} ladninger: dit næste Undergangslyn kastes {castPct}% hurtigere, eller din næste Ildregn lander øjeblikkeligt',
  'hudChrome.auraEffect.duskfireClaim': 'Død giver {value} Ruin',
  'hudChrome.auraEffect.elementalTrance': 'Skade modtaget reduceret med {pct}%. {mana}% af al skade, du gør, omdannes til mana',
  'hudChrome.auraEffect.energyRegen': 'Øger energiregenerering med {pct}%',
  'hudChrome.auraEffect.enrage': 'Skade gjort øget med {damagePct}%, angrebshastighed med {hastePct}%, og bevægelseshastighed med {movePct}%',
  'hudChrome.auraEffect.fingersOfFrost': '{charges} ladninger: Islanse behandler sit mål som frosset og gør {pct}% frossen skade',
  'hudChrome.auraEffect.forbiddenReflectionLock': 'Forbudt Spejling kan ikke forberedes igen endnu',
  'hudChrome.auraEffect.forbiddenReflectionReady': 'Din næste kvalificerede Heksemester-nedkøling kan kastes igen',
  'hudChrome.auraEffect.formLich': 'Soul Lance rammer også op til {targets} nærliggende fjender for {pct}% skade',
  'hudChrome.auraEffect.formMetamorph': 'Dæmonform: kropsstørrelse øget med {pct}%; andre bonusser følger separate buffs',
  'hudChrome.auraEffect.formMoonkin': 'Månekinform: besværgelsesskade øget med {pct}% og rustning øget med {armorPct}%',
  'hudChrome.auraEffect.formShadow': 'Skyggeform: Skyggeskade øget med {pct}%',
  'hudChrome.auraEffect.freeExecute': 'Din næste kvalificerede henrettelsesevne koster ingenting',
  'hudChrome.auraEffect.funeralHarvestLock': 'Funeral Harvest kan ikke skabe endnu en Sjælesplint lige nu',
  'hudChrome.auraEffect.galeheartWeapon': 'At fuldføre Krigsåndens {steps}-træfs kadence ekkoer slaget {count} gange for {pct}% af dets skade som naturskade',
  'hudChrome.auraEffect.healEcho': 'At falde under {threshold}% helbred genopretter {value} helbred',
  'hudChrome.auraEffect.icicles': '{value} af {max} Istapper; ved {max} kan Gletsjerspyd kastes',
  'hudChrome.auraEffect.internalCooldown': 'Denne effekt kan ikke udløses igen, før timeren udløber',
  'hudChrome.auraEffect.leadenHexLock': 'Blytung forbandelse kan ikke rodfæste dette mål igen lige nu',
  'hudChrome.auraEffect.necromancyDeathEcho': 'Gammelt Dødsekko; ingen nuværende evne forbruger det',
  'hudChrome.auraEffect.necromancyHarvestMark': 'Død kan skabe 1 Sjælesplint',
  'hudChrome.auraEffect.necromancyOssuaryMark': 'Opbevarer {storedPct}% af din og dine udødes skade, plus {lancePct}% af Soul Lance-skade; kast igen for at detonere. Død eksploderer inden for {radius} m og skaber 1 Sjælesplint',
  'hudChrome.auraEffect.nextAttackCrit': 'Dit næste angreb rammer garanteret kritisk',
  'hudChrome.auraEffect.overpowerCharge': '{stacks} ladninger: dit næste Lemlæstende Slag gør {pct}% mere skade',
  'hudChrome.auraEffect.perfectMoment': 'Æterpile forbruger ikke Arkane Ladninger',
  'hudChrome.auraEffect.petDamage': 'Øger kæledyrsskade med {pct}%',
  ...
  'hudChrome.auraEffect.pyreGuardian': 'Genererer {ruin} Ruin hvert {ruinInterval}. sek og gør {damage} Ildskade inden for {radius} m hvert {damageInterval}. sek',
  'hudChrome.auraEffect.resourceCount': '{value} af {max}',
  'hudChrome.auraEffect.resourceSap': 'Genopretter {value} af din nuværende ressource hvert {interval}. sek',
  'hudChrome.auraEffect.ruinousBrand': '{charges} kopier tilbage: direkte besværgelser kopierer {otherPct}% skade hertil, eller {selfPct}% når dette er deres mål',
  'hudChrome.auraEffect.sated': 'For udmattet til at få gavn af endnu et gruppehast-udbrud',
  'hudChrome.auraEffect.sourceVuln': 'Tager {pct}% mere skade fra den, der påførte denne effekt',
  'hudChrome.auraEffect.spellDamage': 'Øger besværgelsesskade med {pct}%',
  'hudChrome.auraEffect.spellHaste': 'Øger besværgelseshastighed med {pct}%',
  'hudChrome.auraEffect.stasis': 'Immun og ude af stand til at handle',
  'hudChrome.auraEffect.suddenDeath': 'Din næste Tidlig Grav koster intet Raseri og ignorerer sit helbredskrav',
  'hudChrome.auraEffect.sureCrit': '{charges} skadevoldende evnekast er garanteret kritiske slag',
  'hudChrome.auraEffect.sweepingStrikes': 'Enkeltmålsslag rammer også {targets} nærliggende fjende for {pct}% skade',
  'hudChrome.auraEffect.temporalEcho': 'Kasterens Arkane skade helbreder dig for {singlePct}% af enkeltmåls- eller {areaPct}% af områdeskade',
  'hudChrome.auraEffect.warlockAnchor': 'Kast igen inden for {range} m for at vende tilbage hertil og forbruge ankeret',
  'hudChrome.auraEffect.wintersChill': '{charges} ladninger: kompatible besværgelser behandler dette mål som frosset',
  ...
  'hudChrome.warlock.fateThreadsConsumeReady': 'Tre Skæbnetråde: Fortær kan flette dem ind i yderligere Fordømmelse.',
  'hudChrome.warlock.fateThreadsLabel': 'Skæbnetråde',
  'hudChrome.warlock.fateThreadsSentenceReady': 'Tre Skæbnetråde: Sentence kan forbruge dem for 18% øget skade.',
  'hudChrome.warlock.fateThreadsStatus': '{value} af {max} Skæbnetråde.',
  'itemUi.tooltip.useHealingPotionPct': 'Brug: Genopretter øjeblikkeligt {percent}% af maksimalt helbred. Brugbar i kamp. 2 min afkøling.',
};
