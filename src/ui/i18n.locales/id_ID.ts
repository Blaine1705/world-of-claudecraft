...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.artisans_eye.name': 'Mata Pengrajin',
  'entities.items.fine_ashwood_log.name': 'Kayu Ashwood Halus',
  'entities.items.fine_copper_ore.name': 'Bijih Tembaga Halus',
  'entities.items.fine_elderwood_log.name': 'Log Highpine Halus',
  'entities.items.fine_goldleaf_herb.name': 'Ramuan Daun Emas Halus',
  'entities.items.fine_iron_ore.name': 'Bijih Besi Halus',
  'entities.items.fine_ironbark_log.name': 'Batang Kayu Besi Halus',
  'entities.items.fine_silverleaf_herb.name': 'Ramuan Daun Kemilau Halus',
  'entities.items.fine_sunpetal_herb.name': 'Ramuan Sunpetal Halus',
  'entities.items.fine_thorium_ore.name': 'Bijih Osmium Halus',
  'entities.items.gatherers_cache.name': 'Tembolok Pengumpul',
  'entities.items.stormreel_fishing_rod.name': 'Pancing Stormreel',
  'entities.items.tidewrought_fishing_rod.name': 'Pancing Pasang Surut',
  ...
  'hudChrome.professions.toolEffectRechargeNoSlot':
    'Tidak ada efek yang ditempatkan pada {profession}.',
  ...
  'hudChrome.professions.toolEffectRechargeToolCapped':
    'Bawalah alat {profession} yang lebih baik untuk mengisi daya {effect} lebih lanjut.',
  'hudChrome.professions.toolEffectRecharged':
    '{effect} diisi ulang: {material} x{count} dikonsumsi.',
  'hudChrome.professions.toolEffectSlotButton': 'Slot {effect}',
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} tidak dapat ditempatkan di sana.',
  'hudChrome.professions.toolEffectSlotted': '{effect} ditempatkan pada {profession}.',
  'hudChrome.professions.toolEffectSpent': 'Habis, perlu diisi ulang',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    'Ini adalah pertarungan latihan, jadi tidak diberi peringkat: kedudukan tidak berubah, dan kemajuan Buku Akta tidak dihitung.',
  'hudChrome.vcup.briefing.unratedNote':
    'Bot ada di lapangan, jadi laga ini tidak diberi peringkat: kedudukan tidak berubah, dan perbuatan yang menghasilkan gol, penyelamatan, dan clean sheet tidak dihitung.',
  'hudChrome.vcup.practiceUnratedNote':
    'Pertarungan latihan tidak diberi peringkat: kedudukan dan kemajuan Buku Akta tidak dihitung.',
  'hudChrome.vcup.rolesSmallBracketNote':
    'Dalam braket 1v1 dan 2v2, setiap petarung memainkan perlengkapan All-Rounder. Akta yang memerlukan braket 3v3 atau lebih besar tidak dapat diperoleh di sini.',
  'itemUi.bags.unknownItem': 'Barang tidak diketahui',
  'itemUi.bags.unknownItemAria': 'Item tidak diketahui {id}, kuantitas {count}',
  'itemUi.bags.unknownItemAriaBound': 'Item tidak diketahui {id}, jumlah {count}, salinan terikat',
  'itemUi.bags.unknownItemAriaEnchanted':
    'Item tidak diketahui {id}, jumlah {count}, salinan ajaib',
  'itemUi.bags.unknownItemAriaInstanced':
    'Item tidak diketahui {id}, jumlah {count}, salinan bertanda pembuat',
  'itemUi.bags.unknownItemAriaMasterwork':
    'Item tidak diketahui {id}, kuantitas {count}, karya agung',
  'itemUi.kind.fineMaterial': 'Bahan Halus',
  'itemUi.vendor.buyAriaWithRequirement': 'Beli {item} seharga {price}. {requirement}',
  'itemUi.vendor.buyCountAria': 'Beli {count} dari {item} seharga {price}',
  'itemUi.vendor.buyCountAriaWithRequirement':
    'Beli {count} dari {item} seharga {price}. {requirement}',
  'itemUi.vendor.buyQuantityConfirm': 'Membeli',
  'itemUi.vendor.buyQuantityInput': 'Jumlah yang akan dibeli',
  'itemUi.vendor.buyQuantityTitle': 'Beli berapa {item}? Hingga {max}.',
  'itemUi.vendor.qtyCustom': 'Kebiasaan',
  'itemUi.vendor.qtyCustomAria': 'Pilih jumlah khusus untuk dibeli',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Beli {count} sekaligus',
  'itemUi.vendor.qtyRowAria': 'Kuantitas pembelian',
  'questUi.dialog.repeatableQuestAria': 'Pencarian berulang: {name}',
  'questUi.log.cooldownStatus': 'Segera tersedia lagi',
  'questUi.log.repeatableStatus': 'Dapat diulang',
  'questUi.tracker.unknownQuest': 'Pencarian tidak diketahui ({id})',
};
