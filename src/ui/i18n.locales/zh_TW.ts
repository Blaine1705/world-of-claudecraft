...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.framePresets.saveCurrent': '儲存目前預設',
  ...
  'hudChrome.framePresets.save': '儲存',
  'hudChrome.framePresets.load': '載入並重新整理',
  ...
  'hudChrome.focusTargets.hint': '點擊目標框架或按 {key} 選取此焦點。',
  'hudChrome.focusTargets.clickHint': '點擊目標框架選取此焦點。',
