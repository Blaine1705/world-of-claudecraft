...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  'hudChrome.loot.rollWon': '恭喜！你以 {roll} 點贏得了 {item}',
  ...
  'hudChrome.options.targetAurasBelowFrame': '目標光環顯示在框體下方',
  'hudChrome.options.version': 'v{version}（{build}）',
  'hudChrome.options.overlays': '疊加層',
  ...
  'hudChrome.guildRanks.tab': '階級',
  'hudChrome.guildRanks.introEdit':
    '命名你的公會階級，並選擇每個階級可以做什麼。儲存後，變更會套用到持有該階級的所有成員。',
  'hudChrome.guildRanks.introView': '每個階級名稱及其權限。只有公會會長可以變更它們。',
  'hudChrome.guildRanks.colRank': '階級',
  'hudChrome.guildRanks.colTitle': '名稱',
  'hudChrome.guildRanks.colMembers': '成員',
  'hudChrome.guildRanks.colActions': '順序',
  'hudChrome.guildRanks.numbered': '階級 {n}',
  'hudChrome.guildRanks.perm.invite': '邀請',
  'hudChrome.guildRanks.perm.remove': '移除',
  'hudChrome.guildRanks.perm.promote': '晉升',
  'hudChrome.guildRanks.perm.bank': '公會銀行',
  'hudChrome.guildRanks.perm.officerChat': '幹部聊天',
  'hudChrome.guildRanks.perm.motd': '公告欄',
  'hudChrome.guildRanks.perm.events': '行事曆',
  'hudChrome.guildRanks.permHint.invite': '邀請玩家加入公會並處理他們的申請。',
  'hudChrome.guildRanks.permHint.remove': '移除低於自己階級的成員。',
  'hudChrome.guildRanks.permHint.promote':
    '晉升和降級低於自己階級的成員，最高只能升到比自己低一級。',
  'hudChrome.guildRanks.permHint.bank': '在公會銀行存入和取出銅幣與物品。所有成員都可以查看。',
  'hudChrome.guildRanks.permHint.officerChat': '閱讀並使用幹部聊天。',
  'hudChrome.guildRanks.permHint.motd': '編輯公會公告欄。',
  'hudChrome.guildRanks.permHint.events': '新增和移除公會行事曆事件。',
  'hudChrome.guildRanks.titleLabel': '{rank} 的名稱',
  'hudChrome.guildRanks.permLabel': '{rank} 的{perm}',
  'hudChrome.guildRanks.leaderLocked': '公會會長始終擁有所有權限。',
  'hudChrome.guildRanks.add': '新增階級',
  'hudChrome.guildRanks.save': '儲存階級',
  'hudChrome.guildRanks.moveUp': '上移 {rank}',
  'hudChrome.guildRanks.moveDown': '下移 {rank}',
  'hudChrome.guildRanks.remove': '移除 {rank}',
  'hudChrome.guildRanks.full': '一個公會最多可有 {max} 個階級。',
  'hudChrome.guildRanks.invalidTitle':
    '階級名稱可使用字母、數字、空格、撇號和連字號，最多 {max} 個字元。',
  'hudChrome.guildRanks.removeConfirm': '持有 {rank} 的成員會變為 {fallback}。要移除此階級嗎？',
  'hudChrome.guildRanks.removeAccept': '移除階級',
  'hudChrome.guildRanks.promoteTo': '將 {name} 晉升為 {rank}',
  'hudChrome.guildRanks.demoteTo': '將 {name} 降為 {rank}',
  ...
  'hudChrome.townFocus.preferenceHint':
    '專注會提高你採集材料的品級和數量。若只想採集一種材料，請在野外工具包或專業視窗中設定採集偏好。',
  'hudChrome.townFocus.pendingLine': '已儲存。切換到此分配將在{time}後完成。',
  ...
  'hudChrome.warfareShop.groupSeason2': '戰爭第二賽季：先鋒',
  'hudChrome.warfareShop.groupEntry': '戰爭第一賽季',
  ...
  'hudChrome.charSheet.ratings': '評分',
  ...
  'hudChrome.options.gfxGhostFade': '鏡頭遮擋透視',
  'hudChrome.options.gfxGhostFadeDithered': '網點',
  ...
  'itemUi.market.ordersTab': '求購',
  'itemUi.market.ordersNote':
    '發布你想要的物品，金幣由商人代為保管。價格不高於你出價的上架會立即成交；其餘部分等待賣家送貨。商人向送貨者收取 {cut}% 的手續費。你已開啟 {used}/{max} 個訂單。',
  'itemUi.market.ordersListAria': '未完成的求購訂單',
  'itemUi.market.ordersEmpty': '還沒有求購訂單。發布一個，採集者就能看到你的需求。',
  'itemUi.market.orderCardTitle': '發布訂單',
  'itemUi.market.orderPickLabel': '想要的物品',
  'itemUi.market.orderPickEmpty': '在下方搜尋物品，或從底部的列表中選擇一個。',
  'itemUi.market.orderSearchPlaceholder': '搜尋物品...',
  'itemUi.market.orderSearchAria': '搜尋要求購的物品',
  'itemUi.market.orderPickNone': '沒有符合的物品。',
  'itemUi.market.orderQuantity': '需求數量',
  'itemUi.market.orderPriceEach': '單價',
  'itemUi.market.orderEscrowLine': '商人代管的金幣：{total}',
  'itemUi.market.orderCannotAfford': '你無法為此訂單支付 {total}。',
  'itemUi.market.orderAtCap': '沒有空餘的訂單欄位。請先撤回一個。',
  'itemUi.market.orderPlaceButton': '發布訂單',
  'itemUi.market.orderConfirmTitle': '確認訂單',
  'itemUi.market.orderConfirmBody':
    '以每件 {each} 求購 {item} x{count}？{total} 將由商人保管，直到訂單成交或撤回。',
  'itemUi.market.orderWanted': '求購 x{count}',
  'itemUi.market.orderBy': '{buyer} 求購',
  'itemUi.market.orderMine': '你的訂單',
  'itemUi.market.orderEach': '每件',
  'itemUi.market.orderDeliver': '送貨',
  'itemUi.market.orderDeliverAria': '向 {buyer} 送交 {item}',
  'itemUi.market.orderDeliverNone': '你的背包裡沒有這件物品。',
  'itemUi.market.orderWithdraw': '撤回',
  'itemUi.market.orderWithdrawAria': '撤回你對 {item} 的訂單',
  'itemUi.market.orderDeliverConfirmTitle': '確認送貨',
  'itemUi.market.orderDeliverConfirmBody':
    '以 {total}（每件 {each}）向 {buyer} 送交 {item} x{count}？扣除商人手續費後你可領取 {proceeds}。',
  'itemUi.market.unlistedTitle': '市場上沒有的',
  'itemUi.market.unlistedNote': '目前沒有任何上架的材料。為其中一種發布訂單，或者去採集並上架。',
  'itemUi.market.unlistedNone': '目前每種材料都至少有一個上架。',
  'itemUi.market.unlistedStageAria': '求購 {item}',
  'itemUi.logs.orderPlaced': '已發布 {item} x{count} 的訂單，單價 {each}。',
  ...
  'itemUi.errors.orderOwn': '這是你自己的訂單。請撤回它以取回金幣。',
  ...
  'entities.items.vanguard_warrior_arms_chest.name': '刃痕鎖甲衫',
  'entities.items.vanguard_warrior_arms_legs.name': '刃痕板腿甲',
  'entities.items.vanguard_warrior_arms_gloves.name': '刃痕碎擊護手',
  'entities.items.vanguard_warrior_fury_helmet.name': '血征面甲',
  'entities.items.vanguard_warrior_fury_shoulder.name': '血征護肩',
  'entities.items.vanguard_warrior_fury_chest.name': '血征鏈甲',
  'entities.items.vanguard_warrior_fury_legs.name': '血征護腿',
  'entities.items.vanguard_warrior_fury_gloves.name': '血征握套',
  'entities.items.vanguard_warrior_prot_helmet.name': '鐵征頭盔',
  'entities.items.vanguard_warrior_prot_shoulder.name': '鐵征肩鎧',
  'entities.items.vanguard_warrior_prot_chest.name': '鐵征護胸',
  'entities.items.vanguard_warrior_prot_legs.name': '鐵征腿甲',
  'entities.items.vanguard_warrior_prot_gloves.name': '鐵征護手甲',
  'entities.items.vanguard_paladin_holy_helmet.name': '日守頭環',
  'entities.items.vanguard_paladin_holy_shoulder.name': '日守肩篷',
  'entities.items.vanguard_paladin_holy_chest.name': '日守鎖甲衫',
  'entities.items.vanguard_paladin_holy_legs.name': '日守鏈腿甲',
  'entities.items.vanguard_paladin_holy_gloves.name': '日守手套',
  'entities.items.vanguard_paladin_protection_helmet.name': '盾誓頭盔',
  ...
  'entities.items.vanguard_paladin_protection_gloves.name': '盾誓護手',
  'entities.items.vanguard_paladin_retribution_helmet.name': '光印冠冕',
  'entities.items.vanguard_paladin_retribution_shoulder.name': '光印肩鎧',
  'entities.items.vanguard_paladin_retribution_chest.name': '光印胸鎧',
  'entities.items.vanguard_paladin_retribution_legs.name': '光印腿甲',
  'entities.items.vanguard_paladin_retribution_gloves.name': '光印護手',
  'entities.items.vanguard_hunter_beast_mastery_helmet.name': '群守頭巾',
  'entities.items.vanguard_hunter_beast_mastery_shoulder.name': '群守肩鎧',
  'entities.items.vanguard_hunter_beast_mastery_chest.name': '群守短皮衣',
  'entities.items.vanguard_hunter_beast_mastery_legs.name': '群守腿甲',
  'entities.items.vanguard_hunter_beast_mastery_gloves.name': '群守護手',
  'entities.items.vanguard_hunter_marksmanship_helmet.name': '遠見頭巾',
  'entities.items.vanguard_hunter_marksmanship_shoulder.name': '遠見肩鎧',
  'entities.items.vanguard_hunter_marksmanship_chest.name': '遠見短皮衣',
  'entities.items.vanguard_hunter_marksmanship_legs.name': '遠見腿甲',
  'entities.items.vanguard_hunter_marksmanship_gloves.name': '遠見護手',
  'entities.items.vanguard_hunter_survival_helmet.name': '陷牙頭巾',
  'entities.items.vanguard_hunter_survival_shoulder.name': '陷牙肩鎧',
  'entities.items.vanguard_hunter_survival_chest.name': '陷牙短皮衣',
  'entities.items.vanguard_hunter_survival_legs.name': '陷牙腿甲',
  'entities.items.vanguard_hunter_survival_gloves.name': '陷牙護手',
  'entities.items.vanguard_rogue_assassination_helmet.name': '夜斬風帽',
  'entities.items.vanguard_rogue_assassination_shoulder.name': '夜斬肩墊',
  'entities.items.vanguard_rogue_assassination_chest.name': '夜斬外衣',
  'entities.items.vanguard_rogue_assassination_legs.name': '夜斬馬褲',
  'entities.items.vanguard_rogue_assassination_gloves.name': '夜斬手套',
  'entities.items.vanguard_rogue_combat_helmet.name': '鬥印風帽',
  'entities.items.vanguard_rogue_combat_shoulder.name': '鬥印肩墊',
  'entities.items.vanguard_rogue_combat_chest.name': '鬥印外衣',
  'entities.items.vanguard_rogue_combat_legs.name': '鬥印馬褲',
  'entities.items.vanguard_rogue_combat_gloves.name': '鬥印手套',
  'entities.items.vanguard_rogue_subtlety_helmet.name': '影行風帽',
  'entities.items.vanguard_rogue_subtlety_shoulder.name': '影行肩墊',
  'entities.items.vanguard_rogue_subtlety_chest.name': '影行外衣',
  'entities.items.vanguard_rogue_subtlety_legs.name': '影行馬褲',
  'entities.items.vanguard_rogue_subtlety_gloves.name': '影行手套',
  'entities.items.vanguard_priest_discipline_helmet.name': '幕頌兜帽',
  'entities.items.vanguard_priest_discipline_shoulder.name': '幕頌肩篷',
  'entities.items.vanguard_priest_discipline_chest.name': '幕頌長袍',
  'entities.items.vanguard_priest_discipline_legs.name': '幕頌護腿',
  'entities.items.vanguard_priest_discipline_gloves.name': '幕頌纏手布',
  'entities.items.vanguard_priest_holy_helmet.name': '恩翼兜帽',
  'entities.items.vanguard_priest_holy_shoulder.name': '恩翼肩篷',
  'entities.items.vanguard_priest_holy_chest.name': '恩翼長袍',
  'entities.items.vanguard_priest_holy_legs.name': '恩翼護腿',
  'entities.items.vanguard_priest_holy_gloves.name': '恩翼纏手布',
  'entities.items.vanguard_priest_shadow_helmet.name': '暮頌兜帽',
  'entities.items.vanguard_priest_shadow_shoulder.name': '暮頌肩篷',
  'entities.items.vanguard_priest_shadow_chest.name': '暮頌長袍',
  'entities.items.vanguard_priest_shadow_legs.name': '暮頌護腿',
  'entities.items.vanguard_priest_shadow_gloves.name': '暮頌纏手布',
  'entities.items.vanguard_shaman_elemental_helmet.name': '風暴律令頭巾',
  'entities.items.vanguard_shaman_elemental_shoulder.name': '風暴律令肩甲',
  'entities.items.vanguard_shaman_elemental_chest.name': '風暴律令鎖甲衫',
  'entities.items.vanguard_shaman_elemental_legs.name': '風暴律令鏈腿甲',
  'entities.items.vanguard_shaman_elemental_gloves.name': '風暴律令護手',
  'entities.items.vanguard_shaman_enhancement_helmet.name': '疾風頭盔',
  'entities.items.vanguard_shaman_enhancement_shoulder.name': '疾風肩鎧',
  'entities.items.vanguard_shaman_enhancement_chest.name': '疾風鏈甲',
  'entities.items.vanguard_shaman_enhancement_legs.name': '疾風腿甲',
  'entities.items.vanguard_shaman_enhancement_gloves.name': '疾風握套',
  'entities.items.vanguard_shaman_restoration_helmet.name': '潮守頭環',
  'entities.items.vanguard_shaman_restoration_shoulder.name': '潮守肩篷',
  'entities.items.vanguard_shaman_restoration_chest.name': '潮守鎖甲衫',
  'entities.items.vanguard_shaman_restoration_legs.name': '潮守戰裙',
  'entities.items.vanguard_shaman_restoration_gloves.name': '潮守纏手布',
  'entities.items.vanguard_mage_arcane_helmet.name': '縛時者風帽',
  'entities.items.vanguard_mage_arcane_shoulder.name': '縛時者披肩',
  'entities.items.vanguard_mage_arcane_chest.name': '縛時者長袍',
  'entities.items.vanguard_mage_arcane_legs.name': '縛時者長褲',
  'entities.items.vanguard_mage_arcane_gloves.name': '縛時者手套',
  'entities.items.vanguard_mage_fire_helmet.name': '燼鞭兜帽',
  'entities.items.vanguard_mage_fire_shoulder.name': '燼鞭肩篷',
  'entities.items.vanguard_mage_fire_chest.name': '燼鞭法袍',
  'entities.items.vanguard_mage_fire_legs.name': '燼鞭護腿',
  'entities.items.vanguard_mage_fire_gloves.name': '燼鞭手套',
  'entities.items.vanguard_mage_frost_helmet.name': '霜衛風帽',
  'entities.items.vanguard_mage_frost_shoulder.name': '霜衛肩墊',
  'entities.items.vanguard_mage_frost_chest.name': '霜衛祭袍',
  'entities.items.vanguard_mage_frost_legs.name': '霜衛纏腿布',
  'entities.items.vanguard_mage_frost_gloves.name': '霜衛連指手套',
  'entities.items.vanguard_warlock_affliction_helmet.name': '恐羽風帽',
  'entities.items.vanguard_warlock_affliction_shoulder.name': '恐羽肩篷',
  'entities.items.vanguard_warlock_affliction_chest.name': '恐羽長袍',
  'entities.items.vanguard_warlock_affliction_legs.name': '恐羽護腿',
  'entities.items.vanguard_warlock_affliction_gloves.name': '恐羽纏手布',
  'entities.items.vanguard_warlock_demonology_helmet.name': '髓縛兜帽',
  'entities.items.vanguard_warlock_demonology_shoulder.name': '髓縛肩鎧',
  'entities.items.vanguard_warlock_demonology_chest.name': '髓縛長袍',
  'entities.items.vanguard_warlock_demonology_legs.name': '髓縛護腿',
  'entities.items.vanguard_warlock_demonology_gloves.name': '髓縛握套',
  'entities.items.vanguard_warlock_destruction_helmet.name': '渣冕風帽',
  ...
  'entities.items.vanguard_warlock_destruction_legs.name': '渣冕護腿',
  'entities.items.vanguard_warlock_destruction_gloves.name': '渣冕手套',
  'entities.items.vanguard_druid_balance_helmet.name': '星衛頭飾',
  'entities.items.vanguard_druid_balance_shoulder.name': '星衛肩鎧',
  'entities.items.vanguard_druid_balance_chest.name': '星衛背心',
  'entities.items.vanguard_druid_balance_legs.name': '星衛馬褲',
  'entities.items.vanguard_druid_balance_gloves.name': '星衛手套',
  'entities.items.vanguard_druid_feral_helmet.name': '血鬃頭盔',
  'entities.items.vanguard_druid_feral_shoulder.name': '血鬃肩墊',
  ...
  'entities.items.vanguard_druid_restoration_helmet.name': '薊花冠冕',
  'entities.items.vanguard_druid_restoration_shoulder.name': '薊花肩篷',
  'entities.items.vanguard_druid_restoration_chest.name': '薊花背心',
  'entities.items.vanguard_druid_restoration_legs.name': '薊花護腿',
  'entities.items.vanguard_druid_restoration_gloves.name': '薊花手套',
  'entities.items.vanguard_verdict_greatsword.name': '先鋒裁決',
  'entities.items.vanguard_oath_blade.name': '先鋒誓約',
  'entities.items.vanguard_fang_dagger.name': '先鋒之牙',
  'entities.items.vanguard_warstaff.name': '先鋒戰杖',
  ...
  'entities.itemSets.vanguard_warrior_fury.bonus2': '英勇飛躍的冷卻時間縮短 8 秒。',
  ...
  'entities.itemSets.vanguard_paladin_retribution.bonus4':
    '女武神的召喚會重置終末敕令的冷卻時間，且落地後 6 秒內的下一次終末敕令造成的傷害提高 15%。',
  'entities.itemSets.vanguard_hunter_beast_mastery.name': '群守獵裝',
  'entities.itemSets.vanguard_hunter_beast_mastery.bonus2': '震顫射擊的冷卻時間縮短 4 秒。',
  'entities.itemSets.vanguard_hunter_beast_mastery.bonus4':
    '震顫射擊使狂野怒火的剩餘冷卻時間縮短 1 秒。',
  'entities.itemSets.vanguard_hunter_marksmanship.name': '遠見獵裝',
  'entities.itemSets.vanguard_hunter_marksmanship.bonus2': '斷跡的冷卻時間縮短 4 秒。',
  'entities.itemSets.vanguard_hunter_marksmanship.bonus4':
    '斷跡使你在 6 秒內的下一次長弓引射變為瞬發。每 15 秒最多觸發一次。',
  'entities.itemSets.vanguard_hunter_survival.name': '陷牙獵裝',
  ...
  'entities.itemSets.vanguard_rogue_combat.bonus2': '疾風之足的冷卻時間縮短 60 秒。',
  'entities.itemSets.vanguard_rogue_combat.bonus4':
    '疾風之足生效期間，邪惡揮斬和重磅擺拳額外提供 1 個連擊點數。',
  'entities.itemSets.vanguard_rogue_subtlety.name': '影行皮甲',
  'entities.itemSets.vanguard_rogue_subtlety.bonus2': '煙遁步的冷卻時間縮短 60 秒。',
  ...
  'entities.itemSets.vanguard_priest_holy.bonus4':
    '帷幕步還會為你提供相當於你最大生命值 8% 的護盾，持續 6 秒。',
  'entities.itemSets.vanguard_priest_shadow.name': '暮頌華服',
  'entities.itemSets.vanguard_priest_shadow.bonus2':
    '哀禍連禱在你引導期間還會使目標的移動速度降低 30%。',
  'entities.itemSets.vanguard_priest_shadow.bonus4':
    '召喚什一魔還會為你提供相當於你最大生命值 10% 的護盾，持續 8 秒。',
  ...
  'entities.itemSets.vanguard_mage_arcane.bonus2': '時光屏障的冷卻時間縮短 2 秒。',
  'entities.itemSets.vanguard_mage_arcane.bonus4':
    '時光屏障還會使受護目標的移動速度提高 20%，持續 3 秒。',
  'entities.itemSets.vanguard_mage_fire.name': '燼鞭華服',
  'entities.itemSets.vanguard_mage_fire.bonus2': '燼焰墜的充能恢復速度加快 3 秒。',
  'entities.itemSets.vanguard_mage_fire.bonus4': '施放燼焰墜會使烈焰屏障的剩餘冷卻時間縮短 2 秒。',
  'entities.itemSets.vanguard_mage_frost.name': '霜衛裝束',
  'entities.itemSets.vanguard_mage_frost.bonus2': '縛冰術的冷卻時間縮短 2 秒。',
  'entities.itemSets.vanguard_mage_frost.bonus4': '施放縛冰術會使輕掠步的剩餘冷卻時間縮短 5 秒。',
  ...
  'entities.itemSets.vanguard_warlock_demonology.bonus4':
    '收割號令使骸骨護甲的剩餘冷卻時間縮短 2 秒。',
  'entities.itemSets.vanguard_warlock_destruction.name': '渣冕聖袍',
  'entities.itemSets.vanguard_warlock_destruction.bonus2': '熔渣皮膚的冷卻時間縮短 30 秒。',
  'entities.itemSets.vanguard_warlock_destruction.bonus4':
    '每施放兩次燃盡，你在 8 秒內的下一次毀滅箭變為瞬發。',
  ...
  'entities.itemSets.vanguard_druid_feral.bonus4':
    '巨熊衝鋒為你提供相當於你最大生命值 6% 的護盾，持續 6 秒。',
  'entities.itemSets.vanguard_druid_restoration.name': '薊花祭袍',
  'entities.itemSets.vanguard_druid_restoration.bonus2': '迅癒的冷卻時間縮短 1 秒。',
  'entities.itemSets.vanguard_druid_restoration.bonus4':
    '迅癒還會使你的移動速度提高 30%，持續 3 秒。',
  ...
  'hudChrome.cooldownManager.title': '冷卻管理器',
  'hudChrome.cooldownManager.intro':
    '為你選擇的法術顯示浮動按鈕。按鈕無法點擊：每個按鈕會顯示冷卻時間，無法施放時變暗，就緒時亮起。',
  'hudChrome.cooldownManager.generalTitle': '一般',
  'hudChrome.cooldownManager.enabled': '顯示冷卻管理器',
  'hudChrome.cooldownManager.idleOpacity': '未就緒時的不透明度',
  'hudChrome.cooldownManager.combatOnly': '僅在戰鬥中播放聲音',
  'hudChrome.cooldownManager.dragHint':
    '此選單開啟時，所有群組都會顯示在畫面上，你可以拖曳它們來移動位置。',
  'hudChrome.cooldownManager.addSingle': '新增單一按鈕',
  'hudChrome.cooldownManager.addGrid': '新增按鈕群組',
  'hudChrome.cooldownManager.addLine': '新增法術列',
  'hudChrome.cooldownManager.groupsFull': '群組數量已達上限。刪除一個群組後才能新增。',
  'hudChrome.cooldownManager.noGroups': '新增一個單一按鈕、一組按鈕或一條法術列來開始。',
  'hudChrome.cooldownManager.groupSingle': '單一按鈕 {index}',
  'hudChrome.cooldownManager.groupGrid': '按鈕群組 {index}',
  'hudChrome.cooldownManager.groupLine': '法術列 {index}',
  'hudChrome.cooldownManager.groupName': '群組名稱',
  'hudChrome.cooldownManager.spellCount': '{count} / {max} 個法術',
  'hudChrome.cooldownManager.orientation': '方向',
  'hudChrome.cooldownManager.horizontal': '水平',
  'hudChrome.cooldownManager.vertical': '垂直',
  'hudChrome.cooldownManager.columns': '欄數',
  'hudChrome.cooldownManager.rows': '列數',
  'hudChrome.cooldownManager.direction': '圖示方向',
  ...
  'hudChrome.cooldownManager.iconSize': '圖示大小',
  'hudChrome.cooldownManager.iconPadding': '圖示間距',
  'hudChrome.cooldownManager.opacity': '不透明度',
  'hudChrome.cooldownManager.visibility': '可見性',
  'hudChrome.cooldownManager.visAlways': '永遠顯示',
  'hudChrome.cooldownManager.visCombat': '戰鬥中',
  'hudChrome.cooldownManager.visHidden': '隱藏',
  'hudChrome.cooldownManager.visHiddenHint': '隱藏的群組仍會播放聲音並點亮你的快捷列。',
  'hudChrome.cooldownManager.showTimer': '顯示計時',
  'hudChrome.cooldownManager.positionX': '水平位置',
  'hudChrome.cooldownManager.positionY': '垂直位置',
  'hudChrome.cooldownManager.resetPosition': '重設為預設位置',
  'hudChrome.cooldownManager.deleteGroup': '刪除群組',
  'hudChrome.cooldownManager.deleteGroupAria': '刪除{group}',
  'hudChrome.cooldownManager.trackedTitle': '追蹤的法術',
  ...
  'hudChrome.cooldownManager.selectSpell': '選取{spell}',
  'hudChrome.cooldownManager.group': '群組',
  'hudChrome.cooldownManager.groupFullOption': '{group}（已滿）',
  'hudChrome.cooldownManager.notInGroupHint': '將此法術放入群組以顯示它的按鈕。',
  'hudChrome.cooldownManager.moveEarlier': '將{spell}前移',
  'hudChrome.cooldownManager.moveLater': '將{spell}後移',
  'hudChrome.cooldownManager.glowWhenReady': '就緒時亮起',
  'hudChrome.cooldownManager.glowWhenReadyHint': '法術可以施放時，按鈕會變亮並顯示外框。',
  'hudChrome.cooldownManager.hotbarGlow': '快捷列高亮',
  'hudChrome.cooldownManager.hotbarGlowHint': '法術就緒時，同時點亮它在快捷列上的按鈕。',
  'hudChrome.cooldownManager.onlyWhenReady': '僅在就緒時顯示',
  'hudChrome.cooldownManager.sound': '就緒音效',
  'hudChrome.cooldownManager.soundHint': '法術就緒時，或按鈕在就緒狀態下變成另一個法術時播放。',
  ...
  'hudChrome.options.actionCamShoulderCenter': '置中',
  ...
  'guide.arenaPage.vanguardHeading': '先鋒裝備：戰爭第二賽季',
  'guide.arenaPage.vanguardBody':
    '先鋒裝備是戰爭裝備的第二賽季，由同樣的兩位軍需官販售，陳列在原有裝備之上，原有裝備也繼續販售。每個專精都有自己的一套五件先鋒套裝，包括頭部、肩部、胸部、腿部和手部，商店只會列出你的職業能穿的三套，以及你能使用的先鋒武器。先鋒裝備帶有與原有裝備相同的戰爭等級，但物品等級更高；每套都有兩件和四件兩檔獎勵，會改變你專精的一個技能。與原有套裝不同，這些獎勵在任何地方都生效，對怪物也一樣，但它們是為對抗玩家而設計的，所以在團隊副本裡，團隊套裝仍是更好的選擇。',
  ...
  'guide.interfacePage.framesGovernedUnitTooltip':
    '「編輯框體」也會鬆開提示框體，也就是滑鼠停留物件的卡片顯示位置：生物的等級和類型，或其他玩家的頭銜、公會、等級、職業，以及帶職責的專精。把它拖到任意位置，卡片會從那裡展開，並避開最近的螢幕邊緣。在框體設定的「顯示或隱藏框體」中取消勾選「提示框」，即可完全隱藏該卡片。',
