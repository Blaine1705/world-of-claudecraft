...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.currencies.riftWatchMark': '裂隙守望印記',
  'hudChrome.currencies.riftWatchMarkNote': '裂隙守望區域的世界任務',
  'hudChrome.currencies.churchOrderCrest': '教會徽記',
  ...
  'hudChrome.enchantName.enchant_feet_shadowstride': '長靴蝕刻：暗影漫步',
  'hudChrome.enchantName.enchant_gloves_forged_might': '手套蝕刻：鍛造力量',
  'hudChrome.factionRewards.alliedHearthstoneUse':
    '使用：將你傳送至已協調的陣營據點。（10秒施法時間，15分鐘冷卻時間）',
  'hudChrome.factionRewards.alliedHearthstoneAttuned': '已協調至：{hub}',
  'hudChrome.factionRewards.hub_none': '無（在陣營據點附近使用以進行協調）',
  ...
  'hudChrome.factionRewards.riftGliderUse':
    '使用：展開滑翔器，減緩墜落速度，持續30秒。著陸或受到傷害會取消此效果。（2分鐘冷卻時間）',
  'hudChrome.factionRewards.targetDummyUse':
    '使用：在野外放置一個機械訓練假人，持續2分鐘，用於練習戰鬥技能。（5分鐘冷卻時間）',
  'hudChrome.factionRewards.battleStandardUse':
    '使用：放置神聖晨曦戰旗，持續5分鐘，顯著提高附近所有盟友的非戰鬥生命與法力回復速度。在其附近停留10秒還會獲得晨曦祝福（所有屬性提高5%，持續30分鐘）。（5分鐘冷卻時間）',
  'hudChrome.factionRewards.shockBombUse':
    '使用：向最多30碼的目標投擲一枚震擊炸彈，對5碼內的所有敵人造成120至160點自然傷害。（1分鐘冷卻時間）',
  'hudChrome.factionRewards.invisibilityUse': '使用：使你進入潛行狀態，持續6秒。（2分鐘冷卻時間）',
  'hudChrome.factionRewards.armorKitUse': '使用：加固你的胸甲，使其護甲值提高12點，持續1小時。',
  'hudChrome.factionRewards.sharpeningStoneUse':
    '使用：打磨你的主手武器，使其攻擊強度提高6點，持續30分鐘。',
  'hudChrome.factionRewards.manaElixirUse': '使用：使精神提高6點，持續1小時。',
  'entities.items.allied_hearthstone.name': '盟友爐石',
  'entities.items.allied_vanguard_duffel.name': '盟友先鋒行李袋',
  'entities.items.rift_feather_glider.name': '裂隙羽毛滑翔器',
  'entities.items.formula_enchant_feet_shadowstride.name': '配方：附魔長靴 - 暗影漫步',
  'entities.items.recipe_potion_of_invisibility.name': '配方：隱形藥水',
  'entities.items.potion_of_invisibility.name': '隱形藥水',
  'entities.items.pattern_reinforced_armor_kit.name': '圖樣：加固護甲片',
  'entities.items.reinforced_armor_kit.name': '加固護甲片',
  'entities.items.dawn_battle_standard.name': '晨曦戰旗',
  ...
  'entities.items.clockwork_target_dummy.name': '發條假人',
  'entities.items.schematic_clockwork_shock_bomb.name': '結構圖：發條震擊炸彈',
  'entities.items.clockwork_shock_bomb.name': '發條震擊炸彈',
  'entities.items.plans_dense_sharpening_stone.name': '設計圖：緻密磨刀石',
  'entities.items.dense_sharpening_stone.name': '緻密磨刀石',
  'entities.items.formula_enchant_gloves_forged_might.name': '配方：附魔手套 - 鍛造力量',
