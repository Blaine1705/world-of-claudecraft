...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.plurals.noticeboardGuildStats.one': '{count}名成員，{xp}終身經驗',
  'hudChrome.plurals.noticeboardGuildStats.few': '{count}名成員，{xp}終身經驗',
  'hudChrome.plurals.noticeboardGuildStats.many': '{count}名成員，{xp}終身經驗',
  'hudChrome.plurals.noticeboardGuildStats.other': '{count}名成員，{xp}終身經驗',
