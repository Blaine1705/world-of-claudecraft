...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.deathless_warguard_gauntlets.name': '不死戰衛護手',
  'entities.items.soulrend_handwraps.name': '裂魂纏手',
  'entities.items.scourgehide_grips.name': '災禍之皮握爪',
  'entities.items.soulforged_gauntlets.name': '鑄魂護手',
