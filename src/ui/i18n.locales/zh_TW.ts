...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocMarket.quoteBondFor': '你 {usd} 出價的保證金',
  ...
  'hudChrome.trade.woc.hintStageItem': '請將你要出售的物品放入你這邊的交易欄。',
  'hudChrome.trade.woc.hintNoEligible': '你暫存的物品均無法出售換取 $WOC。',
  ...
  'hudChrome.trade.woc.accept': '接受並付款',
