...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.core.mapMarkerLabels.availableWorldQuest': '可用世界任務：{name}',
  'hud.core.mapMarkerLabels.activeWorldQuest': '進行中的世界任務：{name}',
  'hud.core.mapMarkerLabels.worldBoss': '世界首領：{name}',
  ...
  'abilityUi.cast.hoard_ice_age': '冰河時代',
  'abilityUi.cast.hoard_pulsar_overload': '脈衝星過載',
  'abilityUi.cast.hoard_rolling_boulder': '滾石',
  'abilityUi.cast.hoard_goblin_escape': '逃跑',
  'abilityUi.cast.hoard_cast_mole_rake': '利爪耙擊',
  'abilityUi.cast.hoard_cast_burrow': '鑽地',
  'abilityUi.cast.hoard_cast_tunnel': '地下潛行',
  'abilityUi.cast.hoard_cast_emerge': '破土而出',
  'abilityUi.cast.hoard_cast_collapse': '洞頂坍塌',
  'abilityUi.cast.hoard_cast_bat_dive_aim': '俯衝',
  'abilityUi.cast.hoard_cast_bat_dive': '俯衝中',
  'abilityUi.cast.hoard_cast_screech': '震耳尖嘯',
  'abilityUi.cast.hoard_cast_mimic_bite': '貪婪撕咬',
  'abilityUi.cast.hoard_cast_mimic_leap': '碾壓跳躍',
  'abilityUi.cast.hoard_cast_coin_spit': '詛咒金幣',
  ...
  'questUi.worldQuest.unknown': '未知世界任務（{id}）',
  'questUi.worldQuest.itemReward': '物品獎勵：{name}',
  'questUi.worldQuest.rewardLine': '獎勵：{reward}',
  'questUi.worldQuest.availableStatus': '可用世界任務',
  ...
  'questUi.worldQuest.puzzleBeamReach': '已連接水晶：{count}',
  'questUi.worldQuest.puzzleVictoryTitle': '完美校準',
  'questUi.worldQuest.puzzleVictoryDetail': '魔網光束已抵達目的地。',
  'questUi.worldQuest.puzzleDefeatTitle': '校準失敗',
  'questUi.worldQuest.puzzleDefeatDetail': '能量已經消散，儀式尚未完成。',
  'questUi.worldQuest.puzzleReturn': '返回世界',
  'questUi.worldQuest.puzzleResultAnnouncement': '{title}。{detail} {reach}。',
  'questUi.worldQuest.puzzleInstructions': '旋轉拼塊，將光束從起點引導至終點。',
  'questUi.worldQuest.puzzleRotateTile': '旋轉拼塊{tile}',
  'questUi.worldQuest.puzzleConnectors': '連接方向：{connectors}。',
  'questUi.worldQuest.puzzlePowered': '光束已到達此拼塊。',
  'questUi.worldQuest.puzzleUnpowered': '光束尚未到達此拼塊。',
  'questUi.worldQuest.puzzleClose': '關閉魔網光束謎題',
  'questUi.worldQuest.puzzleSource': '起點',
  'questUi.worldQuest.puzzleTarget': '終點',
  'questUi.worldQuest.puzzleSourceEndpoint': '起點：{direction}。',
  'questUi.worldQuest.puzzleTargetEndpoint': '終點：{direction}。',
  'questUi.worldQuest.matchConfections': '配對魔法糖果',
  ...
  'questUi.worldQuest.match3Moves': '步數：{current}/{total}',
  'questUi.worldQuest.match3Cleared': '已消除糖果：{current}/{total}',
  'questUi.worldQuest.match3Cell': '第 {row} 行，第 {column} 列：{candy}',
  'questUi.worldQuest.match3Selected': '已選擇',
  'questUi.worldQuest.match3Reset': '重新開始關卡',
  'questUi.worldQuest.match3VictoryTitle': '甜蜜的勝利',
  'questUi.worldQuest.match3VictoryDetail': '魔法糖果已收集完畢。',
  'questUi.worldQuest.match3DefeatTitle': '苦澀的敗北',
  'questUi.worldQuest.match3DefeatDetail': '步數已用盡。新一盤糖果正等著你。',
  'questUi.worldQuest.match3TryAgain': '再試一次',
  'questUi.worldQuest.match3Close': '關閉糖果謎題',
  'questUi.worldQuest.match3OutOfMoves': '沒有剩餘步數。重新開始關卡再試一次。',
  ...
  'questUi.worldQuest.match3Candy.grape': '葡萄方塊',
  ...
  'entities.mobs.eastbrook_freight_caravan.name': '東溪貨運商隊',
  ...
  'hudChrome.riftTracker.hoardChestGoal': '打開寶藏箱',
  'hudChrome.riftTracker.hoardClaimedGoal': '寶藏歸你了',
  'entities.items.treasure_map_common.name': '風化的藏寶圖',
  'entities.items.treasure_map_rare.name': '墨繪藏寶圖',
  'entities.items.treasure_map_epic.name': '鎏金藏寶圖',
  'entities.items.treasure_map_legendary.name': '至尊藏寶圖',
  'entities.items.cartographers_ink.name': '製圖師的墨水',
  'hudChrome.riftTracker.hoardTitle': '埋藏的寶藏',
  'hudChrome.riftTracker.hoardGoal': '擊敗寶藏守護者',
  'hudChrome.treasureMap.close': '關閉藏寶圖',
  'hudChrome.treasureMap.zone': '{zone}的某處',
  'hudChrome.treasureMap.hint':
    '找到這張地圖所示的地方，站在 X 標記上，再次使用地圖進行挖掘。一處埋藏的寶藏將為你和你的隊伍開啟。',
  'hudChrome.treasureMap.upgradeNote':
    '將其重繪為{rarity}地圖需要 {inks} 瓶製圖師的墨水（你持有 {held} 瓶）。各陣營軍需官均有出售。',
  'hudChrome.treasureMap.upgradeMaxed': '沒有哪位製圖師能讓這張地圖更進一步。',
  'hudChrome.treasureMap.rarity.common': '普通',
  'hudChrome.treasureMap.rarity.rare': '稀有',
  'hudChrome.treasureMap.rarity.epic': '史詩',
  'hudChrome.treasureMap.rarity.legendary': '傳說',
  'sim.rift.hoardEnter': '你向下爬進了{name}。',
  'sim.rift.hoardNotYours': '這處寶藏是另一支隊伍挖出的。',
  'questUi.logs.treasureMapEarned': '今日所有世界任務均已完成：你找到了一張{map}。',
  'questUi.logs.treasureMapLost': '今日所有世界任務均已完成，但你的背包沒有空間放藏寶圖。',
  'questUi.logs.treasureMapRead': '你研究了{map}。X 標記位於{zone}的某處。',
  'questUi.logs.treasureMapUpgraded': '地圖以更精細的墨水重繪：現在它是一張{map}。',
  ...
  'hudChrome.wqLadder.title': '世界任務排行榜',
  'hudChrome.wqLadder.subtitle': '每位英雄的最佳成績，每個獎牌世界任務各有一個排行榜。',
  'hudChrome.wqLadder.close': '關閉世界任務排行榜',
  'hudChrome.wqLadder.rankedBy.waves': '依堅守波數排名',
  'hudChrome.wqLadder.rankedBy.seconds': '依最快時間排名',
  'hudChrome.wqLadder.rankedBy.points': '依最高分排名',
  'hudChrome.wqLadder.rankedByMedal.waves': '依獎牌排名，其次堅守波數',
  'hudChrome.wqLadder.rankedByMedal.seconds': '依獎牌排名，其次最快時間',
  'hudChrome.wqLadder.rankedByMedal.points': '依獎牌排名，其次最高分',
  'hudChrome.wqLadder.podiumLabel': '前三名',
  'hudChrome.wqLadder.unclaimed': '虛位以待',
  'hudChrome.wqLadder.totalOne': '1 位英雄上榜',
  'hudChrome.wqLadder.totalMany': '{count} 位英雄上榜',
  'hudChrome.wqLadder.selfLabel': '你的最佳成績',
  'hudChrome.wqLadder.selfRank': '第 {rank} 名',
  'hudChrome.wqLadder.selfNone': '你在此榜單上還沒有成績。完成該世界任務即可上榜。',
  ...
  'hudChrome.auraEffect.carryingFreight': '你正在搬運貨物。移動速度降低 {pct}%。',
  ...
  'entities.mobs.hoard_brood_egg.name': '蟲卵群',
  ...
  'entities.mobs.hoard_brood_cocoon.name': '育雛之繭',
  'entities.mobs.hoard_coinsack_scurrier.name': '錢袋竄賊',
  'entities.mobs.hoard_boss_mushroom.name': '蘑菇之母',
  'entities.mobs.hoard_sporeling.name': '孢子仔',
  'entities.mobs.hoard_bloat_cap.name': '膨脹菌蓋',
  ...
  'sim.rift.yell.mushroomEngage': '孢子會吞沒你。',
  'sim.rift.yell.mushroomSummon': '生長吧，我的孩子們！',
  'sim.rift.yell.moleEngage': '這片大地歸我所有。',
  'sim.rift.yell.moleSummon': '給我下來！',
  'sim.rift.yell.batEngage': '吱吱吱！',
  'sim.rift.yell.batSummon': '到我身邊來，我的族群！',
  'sim.rift.yell.mimicEngage': '餓……好餓……',
  'sim.rift.yell.mimicSummon': '更多金子，更多金子！',
  'sim.rift.yell.frostBigCast': '白風已起。',
  'sim.rift.yell.frostDeathZoneCast': '寒霜將你吞噬。',
  'sim.rift.yell.frostDeathZoneStrike': '深寒之中，無物可存。',
  'sim.rift.yell.frostEngage': '寒冷終將帶走一切。',
  'sim.rift.yell.frostEnrage': '凍結吧！',
  'sim.rift.yell.emberBigCast': '燃燒！',
  'sim.rift.yell.emberDeathZoneCast': '岩漿湧起。',
  'sim.rift.yell.emberDeathZoneStrike': '熔爐吞噬一切！',
  'sim.rift.yell.emberEngage': '熔爐飢渴難耐。',
  'sim.rift.yell.emberSummon': '從熔渣中崛起！',
  'sim.rift.yell.emberEnrage': '化為灰燼與餘火！',
  'sim.rift.yell.venomBigCast': '淹沒在毒液之中吧！',
  'sim.rift.yell.venomDeathZoneCast': '溺斃於劇毒之中。',
  'sim.rift.yell.venomDeathZoneStrike': '你逃不過我的孩子們！',
  'sim.rift.yell.venomEngage': '我的孩子們永遠飢餓。',
  'sim.rift.yell.venomSummon': '飽餐吧，小傢伙們！',
  'sim.rift.yell.necroBigCast': '你們的靈魂歸我了。',
  'sim.rift.yell.necroDeathZoneCast': '你的靈魂歸我了。',
  'sim.rift.yell.necroDeathZoneStrike': '死亡吞噬一切！',
  'sim.rift.yell.necroEngage': '死亡只是開始。',
  'sim.rift.yell.necroSummon': '起來！',
  'sim.rift.yell.bruteBigCast': '我要打碎你！',
  'sim.rift.yell.bruteDeathZoneCast': '大地崩裂！',
  'sim.rift.yell.bruteDeathZoneStrike': '你將葬身於此！',
  'sim.rift.yell.bruteEngage': '我會碾碎你！',
  'sim.rift.yell.bruteEnrage': '吼啊啊啊！',
  'sim.rift.yell.arcaneBigCast': '見證真正的力量吧。',
  'sim.rift.yell.arcaneDeathZoneCast': '現實正在撕裂。',
  'sim.rift.yell.arcaneDeathZoneStrike': '灰飛煙滅！',
  'sim.rift.yell.arcaneEngage': '你不該來這裡。',
  'sim.rift.yell.arcaneEnrage': '跪下！',
  'sim.rift.yell.stormBigCast': '蒼穹回應了！',
  'sim.rift.yell.stormDeathZoneCast': '蒼穹回應你的呼喚。',
  'sim.rift.yell.stormDeathZoneStrike': '風暴吞噬一切！',
  'sim.rift.yell.stormEngage': '風暴聽命於我！',
  'sim.rift.yell.stormEnrage': '天穹崩塌！',
  'sim.rift.yell.tideDeathZoneCast': '深淵將你帶走。',
  'sim.rift.yell.tideDeathZoneStrike': '墜入深淵吧！',
  'sim.rift.yell.tideEngage': '深淵將你吞沒。',
  'sim.rift.yell.tideSummon': '從深處崛起！',
  'sim.rift.yell.ritualistBigCast': '契約已以烈火封印！',
  'sim.rift.yell.ritualistEngage': '你擅闖了受縛之地。',
  'sim.rift.yell.ritualistSummon': '回應我，地底之物！',
  'sim.rift.yell.pitlordBigCast': '深坑將你吞噬！',
  'sim.rift.yell.pitlordEngage': '跪下，或者燃燒。',
  'sim.rift.yell.pitlordEnrage': '要塞吞噬一切！',
  'sim.rift.place.hoardFloor': '{theme}埋藏寶藏',
  'sim.rift.place.sanctumFloor': '{theme}聖所：第{depth}層',
  'sim.rift.place.reachesFloor': '{theme}疆域：第{depth}層',
  'sim.rift.place.upgradedFloor': '{title}：{theme}第{depth}層',
  'sim.rift.place.hoardPlan': '埋藏的{noun}寶藏',
  'sim.rift.place.riftPlan': '{noun}{suffix}',
  'sim.rift.place.citadelPlan': '{noun}要塞',
  'sim.rift.place.infernalCitadel': '煉獄要塞',
  'sim.rift.place.hoardEntrance': '埋藏寶藏入口',
  'sim.rift.place.theme.frost': '霜縛',
  'sim.rift.place.theme.ember': '燼爐',
  'sim.rift.place.theme.venom': '毒林',
  'sim.rift.place.theme.bone': '骸骨場',
  'sim.rift.place.theme.brute': '戰營',
  'sim.rift.place.theme.void': '虛痕',
  'sim.rift.place.theme.storm': '風暴尖塔',
  'sim.rift.place.theme.tide': '沉沒',
  'sim.rift.place.theme.spore': '孢子洞穴',
  'sim.rift.place.theme.burrow': '幽深地穴',
  'sim.rift.place.theme.roost': '蝙蝠棲巢',
  'sim.rift.place.theme.mimic': '偽寶庫',
  'sim.rift.place.theme.infernal': '煉獄要塞',
  'sim.rift.place.noun.rime': '白霜',
  'sim.rift.place.noun.hoarfrost': '霧凇',
  'sim.rift.place.noun.glacier': '冰川',
  'sim.rift.place.noun.frost': '寒霜',
  'sim.rift.place.noun.ember': '餘燼',
  'sim.rift.place.noun.cinder': '焦燼',
  'sim.rift.place.noun.magma': '熔岩',
  'sim.rift.place.noun.ash': '灰燼',
  'sim.rift.place.noun.venom': '毒液',
  'sim.rift.place.noun.thorn': '荊棘',
  'sim.rift.place.noun.bramble': '荊叢',
  ...
  'sim.rift.place.noun.war': '戰爭',
  'sim.rift.place.noun.skull': '顱骨',
  'sim.rift.place.noun.iron': '鋼鐵',
  'sim.rift.place.noun.blood': '鮮血',
  'sim.rift.place.noun.void': '虛空',
  'sim.rift.place.noun.shadow': '暗影',
  'sim.rift.place.noun.umbral': '幽影',
  'sim.rift.place.noun.dusk': '暮光',
  'sim.rift.place.noun.storm': '風暴',
  'sim.rift.place.noun.tempest': '暴風',
  'sim.rift.place.noun.thunder': '雷霆',
  'sim.rift.place.noun.gale': '疾風',
  'sim.rift.place.noun.sunken': '沉沒',
  'sim.rift.place.noun.abyssal': '淵獄',
  'sim.rift.place.noun.drowned': '溺亡',
  'sim.rift.place.noun.tide': '潮汐',
  'sim.rift.place.noun.spore': '孢子',
  'sim.rift.place.noun.toadstool': '毒蕈',
  'sim.rift.place.noun.mould': '黴菌',
  'sim.rift.place.noun.mycelium': '菌絲',
  'sim.rift.place.noun.burrow': '地穴',
  'sim.rift.place.noun.tunnel': '隧道',
  'sim.rift.place.noun.delve': '深掘',
  'sim.rift.place.noun.loam': '沃土',
  'sim.rift.place.noun.roost': '棲巢',
  'sim.rift.place.noun.echo': '迴響',
  'sim.rift.place.noun.guano': '蝠糞',
  'sim.rift.place.noun.hollow': '空洞',
  'sim.rift.place.noun.coffer': '寶匣',
  'sim.rift.place.noun.strongbox': '鐵箱',
  'sim.rift.place.noun.tithe': '什一稅',
  'sim.rift.place.noun.gilt': '鎏金',
  'sim.rift.place.noun.brimstone': '硫磺',
  'sim.rift.place.noun.pitfire': '坑焰',
  'sim.rift.place.noun.pactbound': '契縛',
  'sim.rift.place.suffix.abyss': '深淵',
  'sim.rift.place.suffix.depths': '深處',
  'sim.rift.place.suffix.descent': '墜道',
  'sim.rift.place.suffix.hollow': '幽谷',
  'sim.rift.place.suffix.labyrinth': '迷宮',
  'sim.rift.place.suffix.warren': '巢穴',
  'sim.rift.place.suffix.sanctum': '聖所',
  ...
  'entities.items.collapsar_band_of_nyxaris.name': '尼克薩里斯的坍縮星指環',
  'entities.items.rare_collapsar_band_of_nyxaris.name': '失色的尼克薩里斯的坍縮星指環',
  'entities.items.legendary_collapsar_band_of_nyxaris.name': '至尊尼克薩里斯的坍縮星指環',
  'entities.items.orb_collapsing_void.name': '坍縮虛空寶珠',
  'entities.items.rare_orb_collapsing_void.name': '失色的坍縮虛空寶珠',
  'entities.items.legendary_orb_collapsing_void.name': '至尊坍縮虛空寶珠',
  'entities.items.cowl_of_event_horizon.name': '事件視界兜帽',
  'entities.items.rare_cowl_of_event_horizon.name': '失色的事件視界兜帽',
  'entities.items.legendary_cowl_of_event_horizon.name': '至尊事件視界兜帽',
  'entities.items.mantle_of_singularity.name': '奇點披肩',
  'entities.items.rare_mantle_of_singularity.name': '失色的奇點披肩',
  'entities.items.legendary_mantle_of_singularity.name': '至尊奇點披肩',
  'entities.items.glacier_hewn_bulwark.name': '冰川鑿成的壁壘',
  'entities.items.rare_glacier_hewn_bulwark.name': '失色的冰川鑿成的壁壘',
  'entities.items.legendary_glacier_hewn_bulwark.name': '至尊冰川鑿成的壁壘',
  'entities.items.permafrost_legguards.name': '永凍護腿',
  'entities.items.rare_permafrost_legguards.name': '失色的永凍護腿',
  'entities.items.legendary_permafrost_legguards.name': '至尊永凍護腿',
  ...
  'entities.items.rime_crusted_grips.name': '覆霜護手',
  'entities.items.rare_rime_crusted_grips.name': '失色的覆霜護手',
  'entities.items.legendary_rime_crusted_grips.name': '至尊覆霜護手',
  'entities.items.ember_wrought_crown.name': '餘燼鍛造之冠',
  'entities.items.rare_ember_wrought_crown.name': '失色的餘燼鍛造之冠',
  'entities.items.legendary_ember_wrought_crown.name': '至尊餘燼鍛造之冠',
  'entities.items.cinder_stitched_robes.name': '灰燼縫製長袍',
  'entities.items.rare_cinder_stitched_robes.name': '失色的灰燼縫製長袍',
  'entities.items.legendary_cinder_stitched_robes.name': '至尊灰燼縫製長袍',
  'entities.items.chained_ember_choker.name': '鎖鏈餘燼項圈',
  'entities.items.rare_chained_ember_choker.name': '失色的鎖鏈餘燼項圈',
  'entities.items.legendary_chained_ember_choker.name': '至尊鎖鏈餘燼項圈',
  'entities.items.molten_clinker_girdle.name': '熔渣腰帶',
  'entities.items.rare_molten_clinker_girdle.name': '失色的熔渣腰帶',
  'entities.items.legendary_molten_clinker_girdle.name': '至尊熔渣腰帶',
  'entities.items.storm_tuned_buckler.name': '風暴調諧圓盾',
  'entities.items.rare_storm_tuned_buckler.name': '失色的風暴調諧圓盾',
  'entities.items.legendary_storm_tuned_buckler.name': '至尊風暴調諧圓盾',
  'entities.items.hauberk_tempest_gale.name': '暴風烈風鎖甲',
  'entities.items.rare_hauberk_tempest_gale.name': '失色的暴風烈風鎖甲',
  'entities.items.legendary_hauberk_tempest_gale.name': '至尊暴風烈風鎖甲',
  'entities.items.gale_strider_boots.name': '疾風行者長靴',
  'entities.items.rare_gale_strider_boots.name': '失色的疾風行者長靴',
  'entities.items.legendary_gale_strider_boots.name': '至尊疾風行者長靴',
  'entities.items.tempest_strike_grips.name': '暴風打擊護手',
  'entities.items.rare_tempest_strike_grips.name': '失色的暴風打擊護手',
  'entities.items.legendary_tempest_strike_grips.name': '至尊暴風打擊護手',
  'entities.items.breastplate_tectonic_might.name': '地殼之力胸甲',
  'entities.items.rare_breastplate_tectonic_might.name': '失色的地殼之力胸甲',
  'entities.items.legendary_breastplate_tectonic_might.name': '至尊地殼之力胸甲',
  'entities.items.band_mountains_weight.name': '山嶽之重指環',
  'entities.items.rare_band_mountains_weight.name': '失色的山嶽之重指環',
  'entities.items.legendary_band_mountains_weight.name': '至尊山嶽之重指環',
  'entities.items.monolithic_shoulderguards.name': '巨石護肩',
  'entities.items.rare_monolithic_shoulderguards.name': '失色的巨石護肩',
  'entities.items.legendary_monolithic_shoulderguards.name': '至尊巨石護肩',
  'entities.items.earthshaker_warboots.name': '撼地戰靴',
  'entities.items.rare_earthshaker_warboots.name': '失色的撼地戰靴',
  'entities.items.legendary_earthshaker_warboots.name': '至尊撼地戰靴',
  'entities.items.silkstalker_woven_vest.name': '絲獵者的編織背心',
  'entities.items.rare_silkstalker_woven_vest.name': '失色的絲獵者的編織背心',
  'entities.items.legendary_silkstalker_woven_vest.name': '至尊絲獵者的編織背心',
  'entities.items.spun_venom_spaulders.name': '紡毒護肩',
  'entities.items.rare_spun_venom_spaulders.name': '失色的紡毒護肩',
  'entities.items.legendary_spun_venom_spaulders.name': '至尊紡毒護肩',
  'entities.items.broodmother_chitin_cowl.name': '育母的甲殼兜帽',
  'entities.items.rare_broodmother_chitin_cowl.name': '失色的育母的甲殼兜帽',
  'entities.items.legendary_broodmother_chitin_cowl.name': '至尊育母的甲殼兜帽',
  'entities.items.venom_etched_waistcord.name': '蝕毒腰繩',
  'entities.items.rare_venom_etched_waistcord.name': '失色的蝕毒腰繩',
  'entities.items.legendary_venom_etched_waistcord.name': '至尊蝕毒腰繩',
  'entities.items.bone_studded_pauldrons.name': '鑲骨肩鎧',
  'entities.items.rare_bone_studded_pauldrons.name': '失色的鑲骨肩鎧',
  'entities.items.legendary_bone_studded_pauldrons.name': '至尊鑲骨肩鎧',
  'entities.items.legguards_of_the_ossuary.name': '藏骨堂護腿',
  'entities.items.rare_legguards_of_the_ossuary.name': '失色的藏骨堂護腿',
  'entities.items.legendary_legguards_of_the_ossuary.name': '至尊藏骨堂護腿',
  ...
  'entities.items.chalice_of_living_tides.name': '活潮聖杯',
  'entities.items.rare_chalice_of_living_tides.name': '失色的活潮聖杯',
  'entities.items.legendary_chalice_of_living_tides.name': '至尊活潮聖杯',
  'entities.items.pendant_continuous_flow.name': '不息流動吊墜',
  'entities.items.rare_pendant_continuous_flow.name': '失色的不息流動吊墜',
  'entities.items.legendary_pendant_continuous_flow.name': '至尊不息流動吊墜',
  'entities.items.coral_encrusted_girdle.name': '珊瑚鑲嵌腰帶',
  'entities.items.rare_coral_encrusted_girdle.name': '失色的珊瑚鑲嵌腰帶',
  'entities.items.legendary_coral_encrusted_girdle.name': '至尊珊瑚鑲嵌腰帶',
  ...
  'entities.items.leyline_cache.name': '微型魔網秘藏',
  'entities.items.confection_game_box.name': '糖果師的遊戲盒',
  'entities.items.eastbrook_freight_crate.name': '東溪貨運箱',
  'entities.items.eastbrook_freight_wagon.name': '東溪貨運馬車',
  ...
  'questUi.worldQuest.calligraphyTitle': '秘法書法',
  'questUi.worldQuest.traceOutline': '用腳步描繪輪廓',
  'questUi.worldQuest.traceRoundInstruction': '第{round}/{total}輪：{shape}。{instruction}',
  'questUi.worldQuest.traceShape.triangle': '三角形',
  'questUi.worldQuest.traceShape.square': '正方形',
  'questUi.worldQuest.traceShape.star': '星形',
  'questUi.worldQuest.traceReady': '與導師交談開始練習。',
  'questUi.worldQuest.tracePreview': '觀察輪廓，金色光點會為你引路。',
  'questUi.worldQuest.traceStart': '走到起點標記，任選一個方向描繪。',
  'questUi.worldQuest.traceDrawing': '沿金色光點走向明亮的轉角。藍色標記你的足跡。',
  'questUi.worldQuest.traceSuccess': '輪廓完成！',
  'questUi.worldQuest.traceRetry': '與導師交談重試。',
  'questUi.worldQuest.traceOffPath': '你偏離了輪廓。與導師交談重試。',
  'questUi.worldQuest.traceMovement': '請下坐騎並留在地面上。與導師交談重試。',
  'questUi.worldQuest.traceTimeout': '時間已到。與導師交談重試。',
  'questUi.worldQuest.traceCombat': '脫離戰鬥後，與導師交談重試。',
  'entities.npcs.calligraphy_instructor.name': '導師埃利安',
  'entities.npcs.calligraphy_instructor.title': '秘法書法',
  'entities.npcs.calligraphy_instructor.greeting':
    '步伐穩，線條才穩。教我的學徒描繪三角形、正方形和進階符文吧。',
  'entities.npcs.calligraphy_apprentice_1.name': '學徒泰莎',
  'entities.npcs.calligraphy_apprentice_1.title': '書法學徒',
  'entities.npcs.calligraphy_apprentice_1.greeting': '我總是轉彎太早。你能教我在哪裡轉彎嗎？',
  'entities.npcs.calligraphy_apprentice_2.name': '學徒皮普',
  'entities.npcs.calligraphy_apprentice_2.title': '書法學徒',
  'entities.npcs.calligraphy_apprentice_2.greeting':
    '先畫三角形，再畫正方形，最後畫符文。一步一步穩穩地走！',
  'questUi.worldQuest.traceShape.hourglass': '沙漏',
  'questUi.worldQuest.traceShape.lightning': '閃電符文',
  'questUi.worldQuest.traceShape.spiral': '折角螺旋',
  'questUi.worldQuest.traceShape.double-triangle': '雙三角印記',
  ...
  'questUi.worldQuest.traceScoreResult':
    '完成！{rating}：{score}/{total}。基礎獎勵不變。金牌：功績、稱號、+10 聲望。',
  'questUi.worldQuest.traceCompletionLog': '{completion} {result}',
  'questUi.worldQuest.traceUnavailable': '此符文需要更新遊戲版本。',
  'questUi.worldQuest.traceReaction.tessaTriangle': '三個角，每個都在正確的位置！',
  'questUi.worldQuest.traceReaction.pipSquare': '四條邊！我想我也能做到！',
  'questUi.worldQuest.traceReaction.elianFinal':
    '最後一道符文。線條可能交叉或再次經過同一點；跟隨亮起的標記前往下一個轉角。',
  'questUi.worldQuest.traceReaction.elianGold': '描繪得真漂亮！你的腳步贏得了金色的榮耀。',
  'questUi.worldQuest.traceReaction.elianComplete': '符文完成了！用心練習，下次一定會更好。',
  ...
  'entities.items.riftwarden_voidblade.name': '裂隙守衛者虛空之刃',
  'entities.items.champion_rift_band.name': '勇士裂隙指環',
  'entities.items.order_prayer_beads.name': '教團祈禱念珠',
  'entities.items.vestments_of_the_acolyte.name': '侍僧法衣',
  'entities.items.templar_dawn_shield.name': '聖殿騎士黎明之盾',
  'entities.items.dawnkeeper_consecrated_mace.name': '黎明守護者祝聖錘',
  'entities.items.champion_dawn_medallion.name': '勇士黎明勳章',
  'entities.items.automaton_cog_ring.name': '機械齒輪指環',
  'entities.items.clockwork_tinkers_pack.name': '發條工匠背包',
  ...
  'entities.npcs.npc_wq_taskmaster.name': '監工凱倫',
  'entities.npcs.npc_wq_taskmaster.title': '世界任務監工',
  'entities.npcs.npc_wq_taskmaster.greeting':
    '各盟友陣營每天都會在全境發布任務。若某項任務不適合你的技能，你每天可以申請一次重新分配。',
  'hudChrome.charSidebar.gathering': '採集',
  'hudChrome.charSidebar.crafting': '製作',
  'hudChrome.charSidebar.openProfessions': '開啟專業',
  'hudChrome.currencies.intro': '這些都不佔背包空間。金幣照舊放在背包裡。',
  'hudChrome.currencies.activities': '活動',
  'hudChrome.currencies.factions': '陣營',
  'hudChrome.currencies.honor': '榮譽',
  ...
  'hudChrome.currencies.wocPreview': '預覽餘額，尚未驗證',
  'hudChrome.currencies.lifetime': '累計 {amount}',
  'hudChrome.currencies.factionPending': '陣營貨幣：待第二階段',
  'hudChrome.reputation.intro': '三個陣營同時推進：每個世界任務都會計入其所在區域的陣營。',
  'hudChrome.reputation.faction.rift_watch': '裂隙守望',
  'hudChrome.reputation.faction.church_order': '教會修會',
  'hudChrome.reputation.faction.automatons': '機械造物',
  'hudChrome.reputation.hub.rift_watch': '漂流港',
  'hudChrome.reputation.hub.church_order': '奧德里克修士',
  'hudChrome.reputation.hub.automatons': '望龍哨',
  'hudChrome.reputation.tier.unknown': '陌生',
  'hudChrome.reputation.tier.recognized': '初識',
  'hudChrome.reputation.tier.trusted': '信任',
  'hudChrome.reputation.tier.proven': '認可',
  'hudChrome.reputation.tier.vanguard': '先鋒',
  'hudChrome.reputation.tier.champion': '冠軍',
  ...
  'hudChrome.reputation.factionTitle.rift_watch.vanguard': '裂隙守衛',
  'hudChrome.reputation.factionTitle.rift_watch.champion': '冠軍',
  'hudChrome.reputation.factionTitle.church_order.unknown': '局外人',
  'hudChrome.reputation.factionTitle.church_order.recognized': '侍僧',
  'hudChrome.reputation.factionTitle.church_order.trusted': '守護人',
  'hudChrome.reputation.factionTitle.church_order.proven': '聖殿騎士',
  'hudChrome.reputation.factionTitle.church_order.vanguard': '晨曦守護者',
  'hudChrome.reputation.factionTitle.church_order.champion': '冠軍',
  'hudChrome.reputation.factionTitle.automatons.unknown': '局外人',
  'hudChrome.reputation.factionTitle.automatons.recognized': '操作員',
  'hudChrome.reputation.factionTitle.automatons.trusted': '機械師',
  'hudChrome.reputation.factionTitle.automatons.proven': '工匠',
  'hudChrome.reputation.factionTitle.automatons.vanguard': '鍛造大師',
  'hudChrome.reputation.factionTitle.automatons.champion': '冠軍',
  'hudChrome.reputation.next': '下一級：{tier}',
  'hudChrome.reputation.maxed': '已達最高聲望',
  'hudChrome.reputation.cappedByLevel': '聲望在{tier}停留，直到 16 級',
  'hudChrome.reputation.today': '今日',
  'hudChrome.reputation.questsDone': '已完成的世界任務',
  'hudChrome.reputation.resetsIn': '任務板',
  'hudChrome.reputation.resetsUnknown': '今日沒有任務板',
  ...
  'hudChrome.mapAtlas.worldQuests.heading': '今日世界任務',
  'hudChrome.mapAtlas.worldQuests.empty': '今日沒有世界任務',
  'hudChrome.mapAtlas.worldQuests.replacement': '替換',
  'hudChrome.mapAtlas.worldQuests.state.active': '進行中',
  'hudChrome.mapAtlas.worldQuests.state.completed': '已完成',
  'hudChrome.mapAtlas.worldQuests.reroll': '替換任務',
  'hudChrome.mapAtlas.worldQuests.rerollNote': '今日還可替換一次',
  'hudChrome.mapAtlas.worldQuests.rerollUsed': '今日已使用替換',
  'hudChrome.mapAtlas.worldQuests.rerollReason.noCycle': '今日沒有任務板',
  'hudChrome.mapAtlas.worldQuests.rerollReason.usedToday': '今日已使用替換',
  'hudChrome.mapAtlas.worldQuests.rerollReason.completed': '已完成的任務無法替換',
  'hudChrome.mapAtlas.worldQuests.rerollReason.inProgress': '進行中的任務無法替換',
  'hudChrome.mapAtlas.worldQuests.rerollReason.notActive': '此任務不在你的任務板上',
  'hudChrome.mapAtlas.worldQuests.rerollReason.noAlternative': '今日該區域沒有其他可用任務',
  'hudChrome.mapAtlas.worldQuests.rerollReason.unknown': '此任務今日無法替換',
  'hudChrome.mapAtlas.worldQuests.confirmTitle': '要替換這個世界任務嗎？',
  'hudChrome.mapAtlas.worldQuests.confirmBody':
    '每天只能替換一個世界任務，且無法復原。{quest}將被換成該區域的另一個任務。',
  'hudChrome.mapAtlas.worldQuests.confirmOk': '替換',
  ...
  'hudChrome.vehicle.title': '北方哨站砲台',
  'hudChrome.vehicle.objective': '守衛北方哨站',
  'hudChrome.vehicle.lastKeepTitle': '最後的堡壘砲台',
  'hudChrome.vehicle.lastKeepObjective': '守住通往最後的堡壘的要道',
  'hudChrome.vehicle.cannonball': '實心砲彈',
  'hudChrome.vehicle.grapeshot': '霰彈',
  'hudChrome.vehicle.incendiary': '燃燒彈',
  'hudChrome.vehicle.integrity': '砲台耐久',
  'hudChrome.vehicle.exit': '離開砲台',
  'hudChrome.vehicle.endlessWave': '無盡波次 {wave}（第 {round} 輪）',
  'hudChrome.vehicle.resultWaves': '堅守波數：{waves}。',
  'hudChrome.vehicle.enemies': '剩餘敵人：{count}',
  'hudChrome.vehicle.countdown': '準備：{seconds}',
  'hudChrome.vehicle.hint': '選擇一種砲彈，然後點擊地面開火。',
  'hudChrome.vehicle.aim': '點擊開火。按右鍵或 Esc 取消瞄準。',
  'hudChrome.vehicle.sapperWarning': '工兵來襲！在爆破兵抵達防線前攔下他。',
  'hudChrome.vehicle.chargeWarning': '指揮官下令衝鋒！所有存活的敵人移動速度提高。',
  'hudChrome.vehicle.armorHint': '先用實心砲彈擊破銀色盾牌，再發射燃燒彈。',
  'hudChrome.vehicle.exposedHint': '護甲已破：燃燒彈造成雙倍傷害。',
  'hudChrome.vehicle.barrelHint': '敵人聚集在標記的火藥桶周圍時，射擊火藥桶。',
  'hudChrome.vehicle.barrelRules':
    '直接命中會引燃火藥桶：對 {radius} 碼內造成 {damage} 點傷害，並引發連鎖爆炸。',
  'hudChrome.vehicle.armorRules':
    '裝甲部隊受到的傷害降低 {reduction}，直到實心砲彈擊破其護甲。護甲破損後受到的火焰傷害提高 {bonus}。',
  'hudChrome.vehicle.shake': '鏡頭震動',
  'hudChrome.vehicle.gold': '金牌',
  'hudChrome.vehicle.silver': '銀牌',
  'hudChrome.vehicle.bronze': '銅牌',
  'hudChrome.vehicle.failed': '防守失敗',
  'hudChrome.vehicle.result': '{medal}：耐久 {integrity}，命中率 {accuracy}。',
  'hudChrome.vehicle.medalRules':
    '金牌：耐久至少 {goldIntegrity} 且命中率至少 {goldAccuracy}。銀牌：{silverIntegrity} 與 {silverAccuracy}。其他勝利一律獲得銅牌。命中敵人或火藥桶皆計入；每發砲彈只計算一次。獎牌不提供額外金錢。',
  'hudChrome.vehicle.shotDamage': '對落點 {radius} 碼內的每個敵人造成 {damage} 點傷害。',
  'hudChrome.vehicle.shotSlow': '使被命中的敵人減速 {amount}，持續 {seconds} 秒。',
  'hudChrome.vehicle.shotBurn':
    '留下持續 {seconds} 秒的火焰，每秒對站在其中的敵人造成 {damage} 點傷害。',
  'hudChrome.vehicle.shotTiming':
    '冷卻時間：{cooldown} 秒。{flight} 秒後命中。所有砲彈共用 {recovery} 秒的恢復時間。',
  'hudChrome.vehicle.shotRules': '在標記區域內瞄準。不消耗法力。傷害不隨裝備或天賦提升。',
  'hudChrome.leaderboard.tabWorldQuests': '世界任務',
  'hudChrome.leaderboard.wqBoardsLabel': '世界任務計分榜',
  'hudChrome.leaderboard.wqMedal': '獎牌',
  'hudChrome.leaderboard.wqWaves': '堅守波數',
  'hudChrome.leaderboard.wqPoints': '分數',
  'hudChrome.leaderboard.wqMedals.silver': '銀牌',
  'hudChrome.leaderboard.wqMedals.bronze': '銅牌',
  'hudChrome.leaderboard.wqEmpty': '此榜單尚無成績。完成該世界任務即可上榜。',
  'apiError.world_quests.unknown_board': '沒有該名稱的計分榜。',
  'questUi.worldQuest.banner.riftOpens': '海灘上撕開了一道裂隙！掠奪者正衝著殘骸物資而來。',
  'questUi.worldQuest.banner.captainSteps': '掠奪者隊長穿過裂隙現身了！',
  'questUi.worldQuest.banner.riftRouted': '掠奪者潰逃了。海灘重新歸你們所有。',
  'questUi.worldQuest.banner.championRises': '額外戰利品！一名勇士在此地崛起。齊心協力擊倒它。',
  'questUi.worldQuest.banner.championFallen':
    '額外戰利品！勇士倒下了：所有參戰者都獲得一份額外錢袋。',
  'questUi.worldQuest.banner.endlessBegins':
    '防線守住了！無盡波次開始，一波比一波更難。你可以隨時離開砲台。',
  'questUi.worldQuest.shadow.title': '暗影掩護',
  'questUi.worldQuest.shadow.objective': '在不被發現的情況下偷走四份密封命令',
  'questUi.worldQuest.shadow.cloak': '暮織斗篷',
  'questUi.worldQuest.shadow.pickpocket': '扒竊',
  'questUi.worldQuest.shadow.leave': '脫下斗篷',
  'questUi.worldQuest.shadow.stealTip': '從背後接近，取走命令時保持不動。避開提燈的光束。',
  'questUi.worldQuest.shadow.leaveTip': '脫下斗篷。已取回的命令會保留。',
  'questUi.worldQuest.shadow.documents': '已取回命令：{count}/4',
  'questUi.worldQuest.shadow.suspicion': '警覺度：{value}',
  'questUi.worldQuest.shadow.safe': '從背後行竊。提燈守衛的寬廣光束能看穿斗篷；等待空檔再行動。',
  'questUi.worldQuest.shadow.behind': '先繞到守衛背後再行竊。',
  'questUi.worldQuest.shadow.danger': '你快被發現了！快躲起來！',
  'questUi.worldQuest.shadow.channel': '行竊中……{seconds}秒',
  'questUi.worldQuest.shadow.noTarget': '靠近一名攜帶命令的守衛。',
  'questUi.worldQuest.shadow.start': '與斥候薇拉莉交談，向她借斗篷。',
  'questUi.worldQuest.shadow.caught':
    '被抓到了！回到斥候薇拉莉那裡再借一件斗篷。你的命令都還安全。',
  'questUi.worldQuest.shadow.complete': '四份命令已全部取回。',
  'questUi.worldQuest.investigation.title': '借來的臉孔',
  'questUi.worldQuest.investigation.objective': '揭穿並擊敗潛伏者',
  'questUi.worldQuest.investigation.briefing':
    '有個怪物偷走了一名士兵的臉。閱讀常備命令和守備日誌，詢問全部四名守衛，然後回來指出說法與紀錄矛盾的那一個。',
  'questUi.worldQuest.investigation.instructions':
    '閱讀常備命令和守備日誌，然後詢問全部四名守衛。將他們的說法與紀錄對照。',
  'questUi.worldQuest.investigation.confront': '向中士艾瑞克回報，指出說法與紀錄矛盾的守衛。',
  'questUi.worldQuest.investigation.name': '我的守衛之中，誰戴著借來的臉孔？',
  'questUi.worldQuest.investigation.accuseOption': '指控{name}',
  'questUi.worldQuest.investigation.cleared':
    '中士艾瑞克：那名士兵的行蹤清楚。把其他人的說法和我們的紀錄對照，再試一次。',
  'questUi.worldQuest.investigation.guardCleared': '中士艾瑞克已經確認過這名士兵的行蹤。',
  'questUi.worldQuest.investigation.revealed': '怪物已經褪下這張臉孔。擊敗它。',
  'questUi.worldQuest.investigation.defeat': '擊敗現形的潛伏者。',
  'questUi.worldQuest.investigation.heard': '已詢問守衛：{count}/4',
  'questUi.worldQuest.investigation.clues': '已查閱紀錄：{count}/2',
  'questUi.worldQuest.investigation.clueNames.c0': '常備命令',
  'questUi.worldQuest.investigation.clueNames.c1': '守備日誌',
  'questUi.worldQuest.investigation.variants.v0.clue0': '南橋自黎明起封閉。所有巡邏隊必須走西路。',
  'questUi.worldQuest.investigation.variants.v0.clue1':
    '奧林被派駐城門。奈拉、布蘭姆和泰莎在西路巡邏。',
  'questUi.worldQuest.investigation.variants.v0.guard0': '今天早上我的巡邏隊走的是西路。',
  'questUi.worldQuest.investigation.variants.v0.guard1': '我晨間巡邏時經過了南橋。',
  'questUi.worldQuest.investigation.variants.v0.guard2': '我和奈拉、泰莎一起在西路巡邏。',
  'questUi.worldQuest.investigation.variants.v0.guard3': '南橋封閉了。我們走的是西路。',
  'questUi.worldQuest.investigation.variants.v1.clue0':
    '今天的口令是「蘆葦哨」。昨天的口令「提燈」已經失效。',
  'questUi.worldQuest.investigation.variants.v1.clue1': '四名守衛都在黎明時聽取了新口令的簡報。',
  'questUi.worldQuest.investigation.variants.v1.guard0': '蘆葦哨。我在黎明時學到了新口令。',
  'questUi.worldQuest.investigation.variants.v1.guard1':
    '「提燈」是昨天的口令。今天我們用「蘆葦哨」。',
  'questUi.worldQuest.investigation.variants.v1.guard2': '我們四個人都參加了黎明的簡報。',
  'questUi.worldQuest.investigation.variants.v1.guard3':
    '今天的口令是「提燈」。我在黎明的簡報上聽到的。',
  'questUi.worldQuest.investigation.variants.v2.clue0':
    '所有駐軍補給箱都必須蓋有藍色蠟封。拒收任何紅色封印的箱子。',
  'questUi.worldQuest.investigation.variants.v2.clue1':
    '今天的貨物已經檢查過：每個箱子的藍色蠟封都完好無損。',
  'questUi.worldQuest.investigation.variants.v2.guard0':
    '我檢查了今天的貨物。每個箱子都蓋著紅色蠟封。',
  'questUi.worldQuest.investigation.variants.v2.guard1': '我們只收藍色蠟封的箱子。',
  'questUi.worldQuest.investigation.variants.v2.guard2': '日誌上記載今天的貨物蓋的是藍色封印。',
  'questUi.worldQuest.investigation.variants.v2.guard3': '今天沒有收下任何紅色封印的箱子。',
  'questUi.worldQuest.investigation.variants.v3.clue0':
    '夜間守衛在黃昏時重新點亮東方烽火。西方烽火在渡船發出信號前保持熄滅。',
  'questUi.worldQuest.investigation.variants.v3.clue1':
    '奈拉和奧林整夜把守城門。布蘭姆和泰莎巡視堤道，並在黃昏時重新點亮了東方烽火。',
  'questUi.worldQuest.investigation.variants.v3.guard0':
    '我和奧林整夜守著城門。除了霧氣，什麼也沒進來。',
  'questUi.worldQuest.investigation.variants.v3.guard1':
    '和奈拉一起守城門。我們依照命令，看著東方烽火在黃昏時亮起。',
  'questUi.worldQuest.investigation.variants.v3.guard2':
    '我和泰莎巡視堤道。我們在黃昏時點亮了西方烽火，好讓渡船看見我們。',
  'questUi.worldQuest.investigation.variants.v3.guard3':
    '和布蘭姆一起巡視堤道。太陽一下山，我們就重新點亮了東方烽火。',
  'questUi.worldQuest.investigation.variants.v4.clue0':
    '軍需官的馬車正午經北路抵達。沼澤氾濫期間，不會有補給從水路運來。',
  'questUi.worldQuest.investigation.variants.v4.clue1':
    '正午已從北路收到貨物。泰莎簽收；布蘭姆和奈拉卸貨；奧林在井邊。',
  'questUi.worldQuest.investigation.variants.v4.guard0':
    '正午時我幫布蘭姆卸下馬車上的貨。鹹豬肉和燈油，老樣子。',
  'questUi.worldQuest.investigation.variants.v4.guard1':
    '正午那批貨是我親手卸的，直接從補給駁船上搬下來。',
  'questUi.worldQuest.investigation.variants.v4.guard2':
    '我和奈拉把箱子搬了進來。泰莎在日誌上簽了名。',
  'questUi.worldQuest.investigation.variants.v4.guard3': '馬車正午從北路上來。是我簽收的。',
  'questUi.worldQuest.investigation.variants.v5.clue0':
    '上次突襲的陣亡者安葬在禮拜堂地窖。沒有中士的鑰匙，任何人不得進入地窖。',
  'questUi.worldQuest.investigation.variants.v5.clue1':
    '突襲之後，中士的鑰匙從未離開他的腰帶。奈拉、奧林和布蘭姆守城牆；泰莎看守庭院。',
  'questUi.worldQuest.investigation.variants.v5.guard0':
    '我在城牆上站崗。突襲之後地窖一直鎖著；只有中士有鑰匙。',
  'questUi.worldQuest.investigation.variants.v5.guard1':
    '和奈拉、布蘭姆一起守城牆。很安靜，除了青蛙叫。',
  'questUi.worldQuest.investigation.variants.v5.guard2': '一整天都在城牆上。沒有人靠近過地窖。',
  'questUi.worldQuest.investigation.variants.v5.guard3':
    '我看守庭院，今天早上還去地窖看了一眼。陣亡者都安息著。',
  'questUi.worldQuest.horde.title': '最後的路障',
  'questUi.worldQuest.horde.objective': '守住路障並擊敗敵群指揮官',
  'questUi.worldQuest.horde.ready': '與路障隊長交談以開始。',
  'questUi.worldQuest.horde.countdown': '敵群將在 {seconds} 秒後來襲！',
  'questUi.worldQuest.horde.status': '剩餘 {seconds} 秒。擊殺：{kills}。路障：{barrier}%。',
  'questUi.worldQuest.horde.upgrade': '武器：{weapon}',
  'questUi.worldQuest.horde.loadout': '彈數：{count} | 速度 +{speed}% | {weapon}',
  'questUi.worldQuest.horde.exit': '離開防守',
  'questUi.worldQuest.horde.gained': '強化：{upgrade}',
  'questUi.worldQuest.horde.killBurst': '擊倒 +{count}！',
  'questUi.worldQuest.horde.choices.projectile': '彈數 +1',
  'questUi.worldQuest.horde.choices.haste': '射速 +25%',
  'questUi.worldQuest.horde.choices.pierce': '穿透射擊',
  'questUi.worldQuest.horde.choices.explosive': '爆裂射擊',
  'questUi.worldQuest.horde.choices.double': '彈數 x2',
  'questUi.worldQuest.horde.weapons.0': '連發弩',
  'questUi.worldQuest.horde.weapons.2': '穿透射擊',
  'questUi.worldQuest.horde.weapons.3': '爆裂射擊',
  'questUi.worldQuest.horde.controls': '自動開火。A/D、方向鍵或搖桿移動。後退：離開。',
  'questUi.worldQuest.horde.supplies': '打破一個箱子進行選擇。另一個會消失！',
  'questUi.worldQuest.horde.result': '{rating}！分數：{score}。',
  'questUi.worldQuest.horde.resultStats': '擊殺：{kills}。路障：{barrier}%。',
  'questUi.worldQuest.horde.failed': '防守失敗。再試一次！',
  'questUi.worldQuest.horde.replay': '與隊長交談以重試。每輪只能領取一次獎勵。',
  'questUi.worldQuest.horde.medals.silver': '銀牌',
  'questUi.worldQuest.horde.medals.bronze': '銅牌',
  'questUi.worldQuest.wispMaze.leave': '離開迷宮',
  'questUi.worldQuest.wispMaze.title': '微光林迷宮',
  'questUi.worldQuest.wispMaze.objective': '從迷宮中找回所有失竊的錢袋',
  'questUi.worldQuest.wispMaze.ready': '與迷宮守護者交談以開始。',
  'questUi.worldQuest.wispMaze.controls':
    '在迷宮中移動以拾取錢袋。避開暗影。光輝微光能讓你在短時間內驅散暗影。',
  'questUi.worldQuest.wispMaze.collected': '錢袋：{count}/{total}',
  'questUi.worldQuest.wispMaze.lives': '生命：{count}/3',
  'questUi.worldQuest.wispMaze.power': '微光之力：{seconds}秒',
  'questUi.worldQuest.wispMaze.countdown': '{seconds}秒後開始',
  'questUi.worldQuest.wispMaze.collect': '拾取錢袋。避開暗影。',
  'questUi.worldQuest.wispMaze.powered': '力量湧現！觸碰暗影即可驅散它們。',
  ...
  'questUi.worldQuest.forge.countdown': '準備好雙手！{seconds}秒後開始。',
  'questUi.worldQuest.forge.preparing': '做得好！下一個要求……',
  'questUi.worldQuest.forge.fuel': '柴堆',
  'questUi.worldQuest.forge.metal': '錠材箱',
  'questUi.worldQuest.forge.tools': '鐵砧',
  'questUi.worldQuest.forge.request.fuel': '把火燒旺！添點木柴！',
  'questUi.worldQuest.forge.request.metal': '還要金屬！打開錠材箱！',
  'questUi.worldQuest.forge.request.water': '冷卻一下！去井邊打水！',
  'questUi.worldQuest.forge.request.tools': '把它敲打成形！用鐵砧！',
  'questUi.worldQuest.forge.sequence': '{instruction} 然後點擊{next}。',
  'questUi.worldQuest.forge.round': '要求 {round}/{total}：步驟 {step}/{steps}',
  'questUi.worldQuest.forge.thresholds': '金牌：{gold}秒以內。銀牌：{silver}秒以內。',
  'questUi.worldQuest.forge.starting': '準備中……',
  'questUi.worldQuest.forge.finished': '好手藝！這面盾牌配得上駐軍！',
  'questUi.worldQuest.forge.failed': '失誤太多！金屬裂開了。與瑪拉交談再試一次。',
  'questUi.worldQuest.forge.wrong': '拿錯工具了！+{penalty}秒。試試她要的東西。',
  'questUi.worldQuest.forge.correct': '就是這樣！繼續。',
  'questUi.worldQuest.forge.result': '{rating}！{seconds}秒。失誤：{mistakes}。',
  'questUi.worldQuest.forge.replay': '與瑪拉交談再試一次。每輪只能領取一次獎勵。',
  'questUi.worldQuest.forge.medals.silver': '銀牌',
  'questUi.worldQuest.forge.medals.bronze': '銅牌',
  'questUi.worldQuest.forge.strike': '敲擊',
  'questUi.worldQuest.forge.strikeTip':
    '鍛打工件。在指針劃過深色區間時按下；每次成功敲擊後，區間會變窄，指針也會加快。敲在區間外或在冷爐上敲擊，會多花三秒。',
  'questUi.worldQuest.forge.stoke': '添柴',
  'questUi.worldQuest.forge.stokeTip':
    '往火裡添木柴。熔爐會持續降溫；讓爐溫保持在 {floor} 以上，否則你的敲擊會落在冷鐵上。',
  'questUi.worldQuest.forge.strikes': '敲擊：{count}/{total}',
  'questUi.worldQuest.forge.heat': '爐溫：{value}（保持在 {floor} 以上）',
  'questUi.worldQuest.forge.mistakes': '失誤：{count}',
  'questUi.worldQuest.forge.meterAria': '鍛打時機量表',
  'questUi.worldQuest.forge.hintStrike': '盯著指針。在深色區間內敲擊！',
  'questUi.worldQuest.forge.hintStoke': '熔爐在降溫！敲擊前先添柴。',
  'questUi.worldQuest.forge.hit': '漂亮的一擊！區間變窄了。',
  'questUi.worldQuest.forge.miss': '沒敲中區間！+{penalty}秒。',
  'questUi.worldQuest.forge.cold': '冷打！先把火燒旺。+{penalty}秒。',
  'questUi.worldQuest.glider.title': '御風者迴旋賽',
  'questUi.worldQuest.glider.boost': '額外加速',
  'questUi.worldQuest.glider.boostTip':
    '飛行速度提高 {speed} 碼/秒，最高 {maximum} 碼/秒。飛行時可用。{seconds} 秒後充能。',
  'questUi.worldQuest.glider.objective': '穿越風環，並降落在標記區域',
  'questUi.worldQuest.glider.ready': '與飛行管理員澤菲爾交談以起飛。',
  'questUi.worldQuest.glider.countdown': '{count} 秒後起飛……抓穩了！',
  'questUi.worldQuest.glider.flying':
    '風環：{rings}/{total} | 時間：{time}秒 | 速度：{speed} 碼/秒',
  'questUi.worldQuest.glider.climb': '爬升',
  'questUi.worldQuest.glider.climbTip':
    '按住拉起機頭，以速度換取高度。輕點可微調。飛得太慢會失去升力。',
  'questUi.worldQuest.glider.diveTip': '按住壓低機頭以加速。輕點可微調。',
  'questUi.worldQuest.glider.controls':
    '按住滑鼠右鍵向上看可爬升，但會降低速度；向下看可俯衝加速。飛得太慢會失去升力。左右轉向；後退減速。跳躍或上浮/下潛鍵也能控制俯仰。向前飛過風道可獲得加速，每次挑戰每條風道限一次。',
  'questUi.worldQuest.glider.landed': '{rating}！在 {time} 秒內穿過 {rings}/{total} 個風環。',
  'questUi.worldQuest.glider.failed': '降落失敗！偏離航道降落，或錯過太多風環。',
  'questUi.worldQuest.glider.retry': '與澤菲爾交談以重試，或找降落區旁的絲凱返回起飛點。',
  'questUi.worldQuest.glider.nextRing':
    '沿著峽谷瞄準下一個風環穿過。至少穿過 {minimum} 個風環，然後降落在標記區域。',
  'questUi.worldQuest.glider.landing': '所有風環已穿越！轉向前方的降落區。',
  'questUi.worldQuest.glider.complete': '降落完成！',
  'questUi.worldQuest.glider.score': '分數：{score}。',
  'questUi.worldQuest.glider.medals.silver': '銀牌',
  'questUi.worldQuest.glider.medals.bronze': '銅牌',
  'questUi.worldQuest.traceShape.diamond': '菱形',
  'questUi.worldQuest.traceShape.pentagon': '五邊形',
  'questUi.worldQuest.traceShape.arrow': '箭矢符文',
  'questUi.worldQuest.traceShape.zigzag': '鋸齒印記',
  ...
  'entities.npcs.glider_instructor.greeting':
    '今天從斷崖峭壁呼嘯而出的熱氣流特別猛烈。準備好綁上機械滑翔翼，在迴旋賽道上試試你的翅膀了嗎？',
  'entities.npcs.glider_apprentice.title': '澤菲爾的學徒',
  'entities.npcs.glider_apprentice.greeting':
    '沿著峽谷飛下來的那一趟真漂亮。需要魔法上升氣流送你回斷崖找澤菲爾時，隨時來找我。',
  'entities.npcs.shadow_cloak_scout.name': '斥候薇拉莉',
  'entities.npcs.shadow_cloak_scout.title': '秘密行動',
  'entities.npcs.shadow_cloak_scout.greeting':
    '借我的暮織斗篷去用吧。悄悄溜到每個傳令兵背後，摸走他的命令。避開提燈的光束：提燈守衛能直接看穿這層附魔，而且只要你擦碰到傳令兵，他就會察覺到你。',
  'entities.npcs.shadow_guard_north.name': '傳令守衛',
  'entities.npcs.shadow_guard_north.title': '傳令兵',
  'entities.npcs.shadow_guard_north.greeting': '這些密封命令是給隊長的。離遠一點。',
  'entities.npcs.shadow_guard_south.name': '傳令守衛',
  'entities.npcs.shadow_guard_south.title': '傳令兵',
  'entities.npcs.shadow_guard_south.greeting': '我有急件要送。別擋路。',
  'entities.npcs.shadow_guard_east.name': '傳令守衛',
  'entities.npcs.shadow_guard_east.title': '傳令兵',
  'entities.npcs.shadow_guard_east.greeting': '不得延誤。守備隊正等著這些命令。',
  'entities.npcs.shadow_guard_west.name': '傳令守衛',
  'entities.npcs.shadow_guard_west.title': '傳令兵',
  'entities.npcs.shadow_guard_west.greeting': '公務在身。請讓開道路。',
  'entities.npcs.shadow_sentry_south.name': '提燈哨兵',
  'entities.npcs.shadow_sentry_south.title': '真實視界',
  'entities.npcs.shadow_sentry_south.greeting': '我的提燈照出的不只是暗影。待在我看得見的地方。',
  'entities.npcs.shadow_sentry_north.name': '提燈哨兵',
  'entities.npcs.shadow_sentry_north.title': '真實視界',
  'entities.npcs.shadow_sentry_north.greeting': '沒有什麼能溜過提燈守望。',
  'entities.npcs.shadow_watch_west.name': '提燈守夜人',
  'entities.npcs.shadow_watch_west.title': '真實視界',
  'entities.npcs.shadow_watch_west.greeting': '站住。提燈看得見肉眼看漏的東西。',
  'entities.npcs.shadow_watch_east.name': '提燈守夜人',
  'entities.npcs.shadow_watch_east.title': '真實視界',
  'entities.npcs.shadow_watch_east.greeting': '沒有人能不被發現地穿過我的燈光。',
  'entities.npcs.forge_instructor.name': '鐵匠瑪拉',
  'entities.npcs.forge_instructor.title': '望龍哨鐵匠',
  'entities.npcs.forge_instructor.greeting':
    '幫我完成一面盾牌！點擊我喊出的材料。手腳越快，獎牌越好。',
  'entities.npcs.infiltrator_captain.name': '中士艾瑞克',
  'entities.npcs.infiltrator_captain.title': '芬橋守備隊',
  'entities.npcs.infiltrator_captain.greeting':
    '有個怪物偷走了一名士兵的臉。閱讀常備命令和守備日誌，詢問全部四名守衛，然後回來指出說法與紀錄矛盾的那一個。',
  'entities.npcs.infiltrator_nella.name': '衛兵奈拉',
  'entities.npcs.infiltrator_nella.title': '芬橋守備隊',
  'entities.npcs.infiltrator_nella.greeting': '前來報到執勤。',
  'entities.npcs.infiltrator_orin.name': '衛兵奧林',
  'entities.npcs.infiltrator_orin.title': '芬橋守備隊',
  'entities.npcs.infiltrator_orin.greeting': '前來報到執勤。',
  'entities.npcs.infiltrator_bram.name': '衛兵布蘭姆',
  'entities.npcs.infiltrator_bram.title': '芬橋守備隊',
  'entities.npcs.infiltrator_bram.greeting': '前來報到執勤。',
  'entities.npcs.infiltrator_tessa.name': '衛兵泰莎',
  'entities.npcs.infiltrator_tessa.title': '芬橋守備隊',
  'entities.npcs.infiltrator_tessa.greeting': '前來報到執勤。',
  'entities.npcs.wisp_maze_keeper.name': '守護者莉歐拉',
  'entities.npcs.wisp_maze_keeper.title': '樹籬迷宮看守',
  'entities.npcs.wisp_maze_keeper.greeting':
    '盜賊把偷來的金幣藏遍了我的迷宮，現在由暗影看守著。找回每一個錢袋。避開守衛者，或者拿一團光輝微光去驅散它們。失去三條生命會把你送回入口，但你已收集的錢袋仍會安全保留。',
  'entities.zones.farshore_isle.pois.5.label': '沉船殘骸',
  ...
  'abilityUi.cast.hoard_cast_silk_snare': '絲網陷阱',
  'abilityUi.cast.hoard_cast_void_empower': '虛空強化',
  'abilityUi.cast.hoard_cast_webbing': '蛛網纏繞',
  'entities.items.allied_hearthstone.name': '盟約爐石',
  'entities.items.allied_vanguard_duffel.name': '盟約先鋒行囊',
  'entities.items.clockwork_shock_bomb.name': '發條震盪炸彈',
  'entities.items.clockwork_target_dummy.name': '發條訓練假人',
  'entities.items.dawn_battle_standard.name': '黎明戰旗',
  'entities.items.dense_sharpening_stone.name': '緻密磨刀石',
  'entities.items.elixir_of_mana_regeneration.name': '法力回復藥劑',
  'entities.items.formula_enchant_feet_shadowstride.name': '配方：附魔靴子 - 影行',
  'entities.items.formula_enchant_gloves_forged_might.name': '配方：附魔手套 - 鍛造之力',
  'entities.items.formula_enchant_offhand_spirit.name': '配方：附魔副手 - 精神',
  'entities.items.pattern_reinforced_armor_kit.name': '圖樣：強化護甲片',
  'entities.items.plans_dense_sharpening_stone.name': '設計圖：緻密磨刀石',
  'entities.items.potion_of_invisibility.name': '隱形藥水',
  'entities.items.recipe_elixir_of_mana_regeneration.name': '配方：法力回復藥劑',
  'entities.items.recipe_potion_of_invisibility.name': '配方：隱形藥水',
  'entities.items.reinforced_armor_kit.name': '強化護甲片',
  'entities.items.rift_feather_glider.name': '裂隙羽翼滑翔翼',
  'entities.items.schematic_clockwork_shock_bomb.name': '結構圖：發條震盪炸彈',
  'entities.mobs.rift_marrow_golem.name': '骨髓魔像',
  'hudChrome.currencies.automatonCog': '機械齒輪',
  'hudChrome.currencies.automatonCogNote': '機械造物區域的世界任務',
  'hudChrome.currencies.churchOrderCrest': '修會徽記',
  'hudChrome.currencies.churchOrderCrestNote': '教會修會區域的世界任務',
  'hudChrome.currencies.riftWatchMark': '裂隙守望徽章',
  'hudChrome.currencies.riftWatchMarkNote': '裂隙守望區域的世界任務',
  'hudChrome.enchantName.enchant_feet_shadowstride': '靴子蝕刻：影行',
  'hudChrome.enchantName.enchant_gloves_forged_might': '手套蝕刻：鍛造之力',
  'hudChrome.enchantName.enchant_offhand_spirit': '副手蝕刻：精神',
  'hudChrome.factionRewards.alliedHearthstoneAttuned': '已校準至：{hub}',
  'hudChrome.factionRewards.alliedHearthstoneUse':
    '使用：將你傳送至已校準的陣營據點。（施法 10 秒，冷卻 15 分鐘）',
  'hudChrome.factionRewards.armorKitUse': '使用：強化你的胸甲，使護甲提高 12 點，持續 1 小時。',
  'hudChrome.factionRewards.battleStandardUse':
    '使用：插下神聖黎明戰旗，持續 5 分鐘，大幅提高附近所有盟友的非戰鬥生命與法力恢復。在其附近停留 10 秒還會獲得黎明祝福（所有屬性提高 5%，持續 30 分鐘）。（冷卻 5 分鐘）',
  'hudChrome.factionRewards.hub_automatons': '南境（機械鑄造廠）',
  'hudChrome.factionRewards.hub_church_order': '東溪谷（教會修會）',
  'hudChrome.factionRewards.hub_none': '無（在陣營據點附近使用以校準）',
  'hudChrome.factionRewards.hub_rift_watch': '漂流港（裂隙守望）',
  'hudChrome.factionRewards.invisibilityUse': '使用：使你進入潛行狀態，持續 6 秒。（冷卻 2 分鐘）',
  'hudChrome.factionRewards.manaElixirUse': '使用：精神提高 6 點，持續 1 小時。',
  'hudChrome.factionRewards.riftGliderUse':
    '使用：展開滑翔翼，降低下落速度，持續 30 秒。著陸或受到傷害會取消該效果。（冷卻 2 分鐘）',
  'hudChrome.factionRewards.sharpeningStoneUse':
    '使用：打磨你的主手武器，使攻擊強度提高 6 點，持續 30 分鐘。',
