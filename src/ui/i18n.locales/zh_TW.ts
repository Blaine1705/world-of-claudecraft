...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.woc_market.paused': '價格恢復期間交易所暫停交易。拍賣倒數照常進行。',
  ...
  'apiError.woc_market.suspended': '因未支付結算款項，你的交易所競標資格已被暫停。',
  ...
  'hudChrome.wocMarket.tabActivity': '動態',
  ...
  'hudChrome.wocMarket.pausedBanner':
    '$WOC 價格恢復期間交易暫停。拍賣倒數照常進行；新的出價和付款需等價格恢復健康後再進行，已送出的付款仍會照常結算。',
  'hudChrome.wocMarket.walletBanner': '綁定並驗證錢包後即可在交易所出價、購買或出售。',
  'hudChrome.wocMarket.rateNote': '目前匯率：約每美元 {tokens} $WOC，取自外部交易市場最新成交價（{time}）。',
  ...
  'hudChrome.wocMarket.bidBondNote': '出價時會凍結 {usd} 的可退還保證金（以 $WOC 支付）。被超越時退還（除非二次機會轉讓讓你成為買家）；只有當你得標卻未付款時才會被沒收。',
  ...
  'hudChrome.wocMarket.termsLink': '查看市場條款',
  ...
  'hudChrome.wocMarket.bidCloseNote': '在拍賣臨近結束的幾分鐘內保證金獲得確認的出價，可能使拍賣延長幾分鐘。拍賣結束後，遲到的付款不會重新開啟拍賣，而是會被退款。',
  'hudChrome.wocMarket.offerNextNote': '若得標者未付款，你可能按自己的出價成為買家：保證金會再次被凍結，且須在結算期限內付款。屆時未付款將沒收保證金並記一次違約。',
  'hudChrome.wocMarket.buyNowNote': '「立即購買」會為你短暫保留這份掛單。若未付款就離開，你的「立即購買」會暫停一段時間。',
  ...
  'hudChrome.wocMarket.quoteBurn': '銷毀：{tokens} $WOC',
  'hudChrome.wocMarket.quoteTreasury': '國庫：{tokens} $WOC',
  ...
  'hudChrome.wocMarket.sellClearTitle': '清除所選',
  ...
  'hudChrome.wocMarket.sellReserveNote': '對出價者隱藏；只顯示已達或未達。',
  'hudChrome.wocMarket.sellBuyNowPrice': '直購價（美元）',
  'hudChrome.wocMarket.sellDuration': '時長',
  'hudChrome.wocMarket.sellDurationHours': '{hours} 小時',
  ...
  'hudChrome.wocMarket.sellFeeNote':
    '成交後收取約 10% 手續費：3% 銷毀、7% 進入國庫，兩項均向上取整，你收到扣除後的確切餘額（約 90%）。收益隨結算交易直接進入你綁定的錢包。',
  ...
  'hudChrome.wocMarket.activityEmpty': '暫無紀錄。出價、掛單和結算會顯示在這裡。',
  ...
  'hudChrome.wocMarket.activitySuspended': '因未付款結算，競標資格暫停 {duration}。',
  ...
  'hudChrome.trade.woc.notInstant': '$WOC 交易並非即時完成。賣家接受後物品進入託管，付款核實後送達買家。',
  ...
  'hudChrome.trade.woc.closeSellerHold': '你的物品仍為買家的付款保留中。如果改變主意，可在交易所的活動頁籤取消出售。',
  ...
  'hudChrome.trade.woc.p2pBindingNote': '雙方接受後，須在 {duration} 內付款。未付款會記一次市場違約。',
  'hudChrome.trade.woc.p2pBindingNoteUntimed': '雙方接受後，須在短時間內付款。未付款會記一次市場違約。',
