...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocMarket.rateNote': '目前匯率：約每美元 {tokens} $WOC，取自交易所最新成交價（{time}）。',
  ...
  'hudChrome.wocMarket.bidCloseNote': '在拍賣臨近結束的幾分鐘內確認的付款可能使拍賣延長幾分鐘。拍賣結束後，遲到的付款不會重新開啟拍賣，而是會被退款。',
  'hudChrome.wocMarket.offerNextNote': '若得標者未付款，賣家可以按下一位出價者自己的出價將物品轉讓給對方。',
  ...
  'hudChrome.wocMarket.settlementFailConfirmingOverdue': '這筆付款確認耗時過長，正在接受審核。',
  ...
  'hudChrome.trade.woc.settled': '已付款。物品將透過郵件送達。',
  ...
  'hudChrome.trade.woc.closedCancelled': '本次交易已取消。物品將透過郵件退還賣家。',
  'hudChrome.trade.woc.closedSuspended': '本次交易已被遊戲管理員中止。物品將透過郵件退還賣家。',
  'hudChrome.trade.woc.closedUnpaid': '本次交易因未付款而結束。物品將透過郵件退還賣家。',
  ...
  'hudChrome.trade.woc.dealAwaitsPayment': '你的 $WOC 購買尚未付款。請再次與賣家交易以付款；否則交易將自動過期。',
  'hudChrome.trade.woc.paymentConfirmed': '付款已確認。配送完成後物品將透過郵件送達。',
  ...
  'hudChrome.trade.woc.termsLabel': '我接受市場條款。',
