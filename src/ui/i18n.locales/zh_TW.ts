...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mountTraining.mountPrompt': '上馬吧：按 {key} 鍵騎上訓練用英勇戰馬。',
  'hudChrome.mountTraining.ridePrompt': '沿著插旗的賽道騎行，依序穿過每一道門。',
  'hudChrome.mountTraining.progress': '第 {n} 道門，共 {total} 道',
