...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.guildRanks.introEdit':
    '為公會階級命名，並選擇每個階級可以做什麼。儲存後，變更會套用到該階級的所有成員。',
  'hudChrome.guildRanks.introView': '每個階級的名稱及其權限。只有會長可以修改。',
  ...
  'hudChrome.guildRanks.perm.officerChat': '幹部頻道',
  'hudChrome.guildRanks.perm.motd': '公告板',
  'hudChrome.guildRanks.perm.events': '日曆',
  'hudChrome.guildRanks.permHint.invite': '邀請玩家加入公會，並處理他們的宣誓。',
  'hudChrome.guildRanks.permHint.remove': '移除階級低於自己的成員。',
  'hudChrome.guildRanks.permHint.promote':
    '晉升或降級階級低於自己的成員，最高可晉升至比自己低一級的階級。',
  'hudChrome.guildRanks.permHint.bank': '在公會銀行存取銅幣和物品。所有成員都可以查看。',
  'hudChrome.guildRanks.permHint.officerChat': '閱讀並發言於幹部頻道。',
  'hudChrome.guildRanks.permHint.motd': '編輯公會公告板。',
  'hudChrome.guildRanks.permHint.events': '新增或刪除公會日曆活動。',
  'hudChrome.guildRanks.titleLabel': '{rank}的名稱',
  'hudChrome.guildRanks.permLabel': '{rank}的{perm}權限',
  'hudChrome.guildRanks.leaderLocked': '會長永遠擁有所有權限。',
  ...
  'hudChrome.guildRanks.full': '一個公會最多只能有 {max} 個階級。',
  'hudChrome.guildRanks.invalidTitle':
    '階級名稱只能使用字母、數字、空格、撇號和連字號，最多 {max} 個字元。',
  'hudChrome.guildRanks.removeConfirm': '擔任{rank}的成員將變為{fallback}。要移除此階級嗎？',
  'hudChrome.guildRanks.removeAccept': '移除階級',
  'hudChrome.guildRanks.promoteTo': '將 {name} 晉升為{rank}',
  'hudChrome.guildRanks.demoteTo': '將 {name} 降級為{rank}',
  ...
  'hud.meters.selectSegment': '選擇戰鬥片段',
  'hud.meters.selectMode': '選擇統計模式',
  'hud.meters.back': '返回',
  'hud.meters.resetFight': '重設目前戰鬥',
  'hud.meters.resetAll': '重設所有資料',
  'hud.meters.criticals': '致命一擊：{count}',
  'hud.meters.hits': '命中：{count}',
  'hud.meters.topAbility': '主要：{name}',
  'hud.meters.activity': '活躍度：{pct}',
  'hud.meters.newWindow': '新建視窗',
  ...
  'hud.meters.damageTaken': '承受傷害',
  'hud.meters.damageTakenShort': '承傷',
  'hud.meters.interrupts': '斷法',
  'hud.meters.interruptsShort': '斷法',
  'hud.meters.dispels': '驅散',
  'hud.meters.dispelsShort': '驅散',
  'hud.meters.deaths': '死亡',
  'hud.meters.deathsShort': '死亡',
  'hud.meters.reset': '重設統計',
  'hud.meters.resetHint': '重設戰鬥資料',
  'hud.meters.groupTotal': '總量：{total}（{rate}）',
};
