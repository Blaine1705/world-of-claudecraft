...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hostDiag.intro':
    '如果遊戲在這台電腦上執行不順暢，請建立一份系統報告並傳送給支援團隊。報告會說明這台電腦的配置和遊戲的設定，協助我們找出拖慢影格率的原因。',
  'hudChrome.hostDiag.containsTitle': '報告包含的內容',
  'hudChrome.hostDiag.containsHardware':
    '硬體和驅動程式：電腦品牌和型號、處理器、記憶體、顯示卡以及可用磁碟空間。',
  'hudChrome.hostDiag.containsWindows': 'Windows 版本、電源和電池狀態以及圖形設定。',
  ...
  'hudChrome.hostDiag.privacy':
    '報告不包含你的檔案、使用者名稱或帳號資訊。你的電腦名稱也不會包含在內，而是由一組隨機代碼取代。不會自動傳送任何內容：報告是儲存在你電腦上的一個檔案，由你決定要給誰。',
  'hudChrome.hostDiag.create': '建立報告',
  'hudChrome.hostDiag.running': '正在收集系統資訊... 需要幾秒鐘。',
  'hudChrome.hostDiag.saved': '報告已儲存為 {fileName}。',
  'hudChrome.hostDiag.savedNoName': '報告已儲存。',
  'hudChrome.hostDiag.detailPartial': '部分資訊未能收集。這份報告仍然有用。',
  'hudChrome.hostDiag.detailUnavailable':
    'Windows 系統掃描工具遺失或已遭變更，因此只包含了基本資訊。重新安裝遊戲即可復原。',
  'hudChrome.hostDiag.detailNativeError': 'Windows 系統掃描無法執行，因此只包含了基本資訊。',
  'hudChrome.hostDiag.busy': '報告正在建立中。',
  'hudChrome.hostDiag.failed': '無法建立報告。請再試一次。',
  'hudChrome.hostDiag.sendHint':
    '請透過 Discord 將儲存的檔案傳送給支援團隊，或將其附加到你的支援請求中。',
