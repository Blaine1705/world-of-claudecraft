...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'questUi.dialog.clueTalk': '詢問線索。',
  'questUi.dialog.clueTalkAria': '詢問線索：{name}',
  'questUi.dialog.clueDeliver': '交出{count}個{item}。',
  'questUi.dialog.clueDeliverAria': '交出{count}個{item}給{name}',
  ...
  'entities.npcs.weekly_emissary.greeting':
    '山谷記著一本功績簿，而我掌管這本簿子。選一項本週的委託，把它完成，錢袋就是你的。',
  ...
  'hudChrome.weekly.title': '每週任務',
  'hudChrome.weekly.close': '關閉每週任務',
  'hudChrome.weekly.subtitle': '從四項委託中選擇一項。它',
  'hudChrome.weekly.resetsIn': '將在{time}後重置。',
  'hudChrome.weekly.anyDifficulty': '任意難度',
  'hudChrome.weekly.choose': '選擇任務',
  'hudChrome.weekly.inProgress': '進行中（{count}/{required}）',
  'hudChrome.weekly.completed': '本週已完成',
  'hudChrome.weekly.lockedThisWeek': '本週已鎖定',
  'hudChrome.weekly.footerPick': '你一次只能持有一項每週委託。點擊卡片閱讀條款。',
  'hudChrome.weekly.footerHeld': '本週的委託已定。其餘三項將在重置時解鎖。',
  'hudChrome.weekly.dialogHeading': '每週任務：{category}',
  'hudChrome.weekly.objectives': '任務目標',
  ...
  'hudChrome.weekly.cacheDesc':
    '開啟後獲得一件你職業可用的普通團隊副本裝備（不含套裝），外加{count}個{item}。',
  ...
  'hudChrome.weekly.kinds.dungeons.lore':
    '王國的深處從不安寧：廢棄機甲再度躁動，空心地穴甦醒。召集盟友，肅清地下城中的腐化。',
  'hudChrome.weekly.kinds.dungeons.goal': '在任意難度下完成{count}個地下城。',
  'hudChrome.weekly.kinds.dungeons.goalLabel': '已完成的地下城',
  'hudChrome.weekly.kinds.raid.category': '團隊副本',
  'hudChrome.weekly.kinds.raid.lore':
    '遠古力量在最後火焰熔爐和荊峰高地甦醒。直面伊格尼瓦或尼斯拉克西斯，擊倒敵軍統帥。',
  'hudChrome.weekly.kinds.raid.goal': '在任意難度下參與{count}次團隊副本。',
  'hudChrome.weekly.kinds.raid.goalLabel': '已完成的團隊副本',
  'hudChrome.weekly.kinds.battlegrounds.category': '戰場',
  'hudChrome.weekly.kinds.battlegrounds.lore':
    '戰旗在荊谷原野上飄揚。與你的陣營並肩作戰，守住旗幟，在戰鬥中證明自己；無論勝負，每場比賽都算數。',
  'hudChrome.weekly.kinds.battlegrounds.goal': '完成{count}場戰場。',
  'hudChrome.weekly.kinds.battlegrounds.goalLabel': '已完成的戰場',
  'hudChrome.weekly.kinds.worldboss.category': '世界首領',
  'hudChrome.weekly.kinds.worldboss.lore':
    '強大的敵人在荒野遊蕩，每一個都足以抗衡整支軍隊。加入附近的玩家，擊倒一隻巨大的畸變體。',
  'hudChrome.weekly.kinds.worldboss.goal': '在荒野中擊敗{count}隻世界首領。',
  'hudChrome.weekly.kinds.worldboss.goalLabel': '已擊敗的世界首領',
  ...
  'hudChrome.weeklyRewards.title': '每週寶庫',
  'hudChrome.weeklyRewards.tab': '每週獎勵',
  'hudChrome.weeklyRewards.intro':
    '每達成一個里程碑即可獲得一個寶庫。熔爐重置後，逐一打開寶庫擲出戰利品，然後為本週選擇一件物品。已打開的獎勵會被保存，未領取的週次仍可繼續領取。',
  'hudChrome.weeklyRewards.approachKeeper': '站到寶庫管理員附近即可查看你的每週獎勵。',
  'hudChrome.weeklyRewards.nextReset': '熔爐每週重置',
  'hudChrome.weeklyRewards.countdown': '{days}天 {hours}小時 {minutes}分 {seconds}秒',
  'hudChrome.weeklyRewards.progress': '{count} / {max}',
  'hudChrome.weeklyRewards.milestone': '1次戰利品表擲骰',
  'hudChrome.weeklyRewards.lockedRoll': '解鎖1次戰利品表擲骰',
  'hudChrome.weeklyRewards.earned': '下次重置後可用的寶庫：{count}',
  ...
  'hudChrome.weeklyRewards.viewPossibleLoot': '查看可能的戰利品',
  'hudChrome.weeklyRewards.heroicUpgradeOne': '再通關{count}次英雄地城即可升級',
  'hudChrome.weeklyRewards.heroicUpgradeMany': '再通關{count}次英雄地城即可升級',
  'hudChrome.weeklyRewards.completedTask.raidOne': '已擊敗{count}個團隊副本首領',
  'hudChrome.weeklyRewards.completedTask.raidMany': '已擊敗{count}個團隊副本首領',
  'hudChrome.weeklyRewards.completedTask.dungeonOne': '已通關{count}個地城',
  'hudChrome.weeklyRewards.completedTask.dungeonMany': '已通關{count}個地城',
  'hudChrome.weeklyRewards.completedTask.worldOne': '已完成{count}個世界任務',
  ...
  'hudChrome.weeklyRewards.requiredTask.dungeonMany': '通關{count}個地城',
  'hudChrome.weeklyRewards.requiredTask.worldOne': '完成{count}個世界任務',
  ...
  'hudChrome.weeklyRewards.openRewards': '打開你獲得的寶庫',
  'hudChrome.weeklyRewards.openedCount': '已打開{count}/{total}個寶庫。全部打開後即可選擇獎勵。',
  'hudChrome.weeklyRewards.openingSavedReward': '正在打開寶庫並保存你的獎勵...',
  'hudChrome.weeklyRewards.rewardNumber': '獎勵{count}',
  'hudChrome.weeklyRewards.openVault': '打開寶庫：{name}',
  'hudChrome.weeklyRewards.inspectItem': '查看{name}',
  'hudChrome.weeklyRewards.selectItem': '選擇{name}',
  'hudChrome.weeklyRewards.revealed': '已揭曉',
  'hudChrome.weeklyRewards.revealedItem': '已揭曉：{name}',
  'hudChrome.weeklyRewards.chooseReward': '選擇一件獎勵',
  'hudChrome.weeklyRewards.confirmTitle': '領取{name}？',
  'hudChrome.weeklyRewards.confirmClaim': '確認領取',
  'hudChrome.weeklyRewards.backToChoices': '返回選項',
  'hudChrome.weeklyRewards.claimRequested': '已送出領取請求。若背包已滿，請騰出空間後重新選擇。',
  'hudChrome.weeklyRewards.waiting': '暫無可領取的獎勵。本週獲得的寶庫將在下次重置時解鎖。',
  'hudChrome.weeklyRewards.chooseOne': '請謹慎選擇：拿走一件物品即放棄該週的其他所有選項。',
  'hudChrome.weeklyRewards.itemLevel': '物品等級{level}',
  'hudChrome.weeklyRewards.backlogFull': '你保存的週次已滿。請領取獎勵，為之後的週次騰出空間。',
  'hudChrome.weeklyRewards.claim': '拿走所選物品',
  'hudChrome.weeklyRewards.poolSize': '查看{count}件物品',
  'hudChrome.weeklyRewards.poolRule':
    '列出的每件物品機率均等。物品符合你的職業限制。已擊敗的團隊副本會依該難度解鎖其戰利品。不包含傳說物品。',
  'hudChrome.weeklyRewards.rare': '稀有',
  'hudChrome.weeklyRewards.epic': '史詩',
  'hudChrome.weeklyRewards.unavailable': '尚未開放',
  'hudChrome.weeklyRewards.worldUnavailable': '輪換世界任務上線後，世界任務獎勵即可使用。',
  'hudChrome.weeklyRewards.category.raid': '團隊副本',
  'hudChrome.weeklyRewards.category.dungeon': '地城',
  'hudChrome.weeklyRewards.category.world': '世界任務',
  'hudChrome.weeklyRewards.category.pvp': 'PvP',
  'hudChrome.weeklyRewards.task.raid':
    '擊敗不同的團隊副本首領。每個首領只計一次；英雄難度通關會提升其紀錄。',
  'hudChrome.weeklyRewards.task.dungeon': '通關地城。你的最佳通關紀錄決定每個里程碑的獎勵難度。',
  'hudChrome.weeklyRewards.task.world': '完成輪換的世界任務。劇情任務不計入。',
  'hudChrome.weeklyRewards.task.pvp': '贏得積分競技場或積分戰場比賽。練習賽和棄權不計入。',
  'hudChrome.weeklyRewards.pool.raid': '普通團隊副本戰利品',
  'hudChrome.weeklyRewards.pool.raid_heroic': '英雄團隊副本戰利品',
  'hudChrome.weeklyRewards.pool.dungeon': '普通地城戰利品',
  'hudChrome.weeklyRewards.pool.dungeon_heroic': '英雄地城戰利品',
  'hudChrome.weeklyRewards.pool.world': '世界任務戰利品',
  'hudChrome.weeklyRewards.pool.pvp': '戰爭裝備',
  // The Weekly Vault keeper (PR 4052), the NPC record in src/sim/content/zone1.ts.
  'entities.npcs.eastbrook_vault_keeper.name': '寶庫管理員',
