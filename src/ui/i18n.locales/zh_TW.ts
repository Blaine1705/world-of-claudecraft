...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.specPanel.primaryAttr': '主屬性',
  ...
  'hudChrome.specPanel.viewTalents': '查看天賦',
  ...
  'entities.abilities.revenge.description':
    '以寬闊的弧線攻擊，對你面前的所有敵人造成物理傷害。目標超過 5 個時，傷害會降低。當你閃避或招架時，你的下一次復仇可能不消耗怒氣。',
  ...
  'hudChrome.options.mouseoverCast': '滑鼠懸停施法（隊伍框體）',
  'hudChrome.options.showTargetOfTarget': '顯示目標的目標',
  'hudChrome.talentRows.tab': '選擇',
  'hudChrome.talentRows.defaultLoadout': '預設配置',
  'hudChrome.talentRows.comingSoon': '即將推出',
  'hud.errors.nothingToConsume': '沒有可消耗的效果。',
  'entities.abilities.storm_bolt.name': '風暴之錘',
  'entities.abilities.storm_bolt.description': '將武器擲向目標，造成 {damage}，並使其昏迷 3 秒。',
  ...
  'entities.abilities.heroic_leap.description': '躍向目標區域，對附近敵人造成 {damage} 點傷害。',
  ...
  'entities.abilities.chain_heal.description':
    '治療目標 {damage}，隨後躍向至多 2 名附近的盟友，每次跳躍的治療量減半。',
  'hudChrome.auraEffect.dmgDone': '造成的傷害提高 {pct}%',
  'hudChrome.auraEffect.dmgDoneReduce': '造成的傷害降低 {pct}%',
  'hudChrome.auraEffect.crit': '爆擊機率提高 {pct}%',
  'hudChrome.auraEffect.rageGen': '怒氣獲取提高 {pct}%',
  'hudChrome.auraEffect.reckless': '爆擊機率提高 {pct}%，怒氣獲取提高 {ragePct}%',
