...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.showAuraCaster': '在提示中顯示光環施放者',
  ...
  'itemUi.market.buyQuantityAria': '要購買多少個{item}（共 {total} 個）',
  'itemUi.market.buyQuantityBtnAria': '購買這麼多個{item}',
  ...
  'itemUi.market.buyConfirmBodyPartial':
    '以 {price} 購買 {count} 個{item}（共上架 {total} 個，每個 {each}）？',
  ...
  'itemUi.market.history': '歷史記錄',
  'itemUi.market.historyEmpty': '尚無銷售記錄。你在世界市場出售的物品會顯示在這裡。',
  'itemUi.market.historyNote': '你在世界市場的近期銷售記錄。',
  ...
  'guide.settingsPage.ifShowAuraCaster':
    '在每個增益／減益提示中加上一行「施放者」，說明是誰施加的。便於分辨多名騎士的祝福等同名增益。',
