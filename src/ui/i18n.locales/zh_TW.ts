...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.crossHotbarEditHint': '整理中：確認鍵拿起一個技能並放到下一個格子，取消鍵清空格子。',
  ...
  'hudChrome.controller.crossHotbarExpandHelp': '按住一個扳機鍵時輕按另一個扳機鍵，即可切換到第二組。',
  'hudChrome.controller.crossHotbarSetPrimary': '第一組',
  'hudChrome.controller.crossHotbarSetExpanded': '第二組',
  'hudChrome.controller.crossHotbarResetLayout': '重置十字熱鍵欄',
  'hudChrome.controller.crossHotbarSlot': '動作條 {slot}',
  'hudChrome.controller.crossHotbarOverlay': '十字熱鍵欄',
