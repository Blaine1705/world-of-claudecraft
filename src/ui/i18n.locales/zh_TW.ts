...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hostDiag.intro':
    '如果遊戲在這台電腦上執行不順，請產生一份系統報告並寄給支援團隊。報告會說明這台電腦的配備以及遊戲的設定，方便我們查出幀率受限的原因。',
  'hudChrome.hostDiag.containsTitle': '報告包含的内容',
  'hudChrome.hostDiag.containsHardware': '硬體與驅動程式：處理器、記憶體和顯示卡。',
  'hudChrome.hostDiag.containsWindows': 'Windows 的電源與圖形設定。',
  'hudChrome.hostDiag.containsNvidia': '若已安裝 NVIDIA 控制面板，則包含其設定。',
  'hudChrome.hostDiag.containsDisplays': '你的顯示器配置：螢幕數量、尺寸和更新率。',
  'hudChrome.hostDiag.containsPrograms': '占用處理器時間和記憶體最多的程式名稱。',
  'hudChrome.hostDiag.containsGame': '遊戲與啟動器版本，以及你目前的圖形設定。',
  'hudChrome.hostDiag.privacy':
    '報告不包含你的檔案、使用者名稱或帳號資料。你的電腦名稱會被替換為匆名代碼。報告不會自動上傳：它只是一個儲存在你電腦上的檔案，由你決定寄給誰。',
  'hudChrome.hostDiag.create': '產生報告',
  'hudChrome.hostDiag.running': '正在收集系統資訊，需要幾秒鐘。',
  'hudChrome.hostDiag.saved': '報告已儲存為 {fileName}。',
  'hudChrome.hostDiag.savedNoName': '報告已儲存。',
  'hudChrome.hostDiag.detailPartial': '部分資訊未能收集到。該報告仍然可用。',
  'hudChrome.hostDiag.detailUnavailable':
    'Windows 系統掃描程式遺失或已被修改，因此報告只包含基本資訊。重新安裝遊戲即可修復。',
  'hudChrome.hostDiag.detailNativeError': 'Windows 系統掃描無法執行，因此報告只包含基本資訊。',
  'hudChrome.hostDiag.busy': '已有一份報告正在產生中。',
  'hudChrome.hostDiag.failed': '無法產生報告，請重試。',
  'hudChrome.hostDiag.sendHint': '請將儲存的檔案透過 Discord 寄給支援團隊，或附在你的支援請求中。',
