...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.veiled_hollow.welcome': '空氣中迴盪著古老魔法的低鳴。到古輝鎮的巨樹下尋找守護者塞爾文吧。',
  ...
  'entities.zones.drakelands.welcome': '灼熱的風從前方的荒漠滾滾而來。巨龍在龍喉火山上空盤旋，巨魔的篝火在沙丘間燃燒。',
  ...
  'entities.zones.drakelands.pois.5.label': '龍喉火山口',
  ...
  'guide.home.world.fenBlurb': '越過秋色之冠，是一片垂柳與靜水的明亮沼澤，還有一座護城河環繞的小鎮。',
  ...
  'entities.zones.nightbloom.welcome': '越過夜門，連空氣都在做夢。沿著花光走向月棲鎮，別忘了看看懸在天上沉睡的世界。',
  ...
  'entities.zones.wraithwood.welcome': '樹冠像棺蓋一樣在路上合攏。跟緊絞湖鎮的燈火，若林中有聲音喊你的名字，千萬別回應。',
  ...
  'entities.zones.palmreach.welcome': '溫暖的沙灘，喧鬧的鳥鳴，還有吞沒地平線的叢林。漂流港在海灘上為你留著一堆篝火。',
  ...
  'entities.mobs.hollow_spirit.name': '幽谷之靈',
  ...
  'entities.npcs.loremother_bryn.greeting': '這山谷裡的每一盞光都銘記著什麼，{playerName}。幫我聽聽它們的低語。',
  ...
  'entities.npcs.wardsmith_orun.greeting': '這些熔爐幾百年前就冷了，{className}，但它們鍛出的兵刃至今鋒利。',
  'entities.npcs.archivist_tullo.name': '檔案員圖洛',
  'entities.npcs.archivist_tullo.title': '讀石者',
  'entities.npcs.archivist_tullo.greeting': '外面那些石碑已經許久不曾對人開口。也許它們正等著新的耳朵。',
  'entities.quests.q_veil_thinned.title': '稀薄的帷幕',
  'entities.quests.q_veil_thinned.text': '洞穴竟為你敞開了。那麼封印比我擔心的還要脆弱，{playerName}。帷幕撕裂之處，光靈會變得陰冷黑暗。給我帶來八份暮光靈的精華，我便能讀出這道傷口有多深。',
  'entities.quests.q_veil_thinned.completion': '每一份都是冰冷的。幽谷也許只剩一個季節，裂縫就會變成裂谷。你我有得忙了。',
  'entities.quests.q_veil_thinned.objectives.0.label': '暮光靈精華',
  'entities.quests.q_gleaming_antlers.title': '輝光鹿角',
  'entities.quests.q_gleaming_antlers.text': '帷紗雄鹿在吃草的地方灑下微光，牠們蛻下的鹿角能把光留住許多年。從星落盆地的鹿群那裡取來五支，我的燈籠整個冬天都不用點油。不必傷害雄鹿，但牠們也不會輕易相讓。',
  'entities.quests.q_gleaming_antlers.completion': '看牠們把光留得多好！沒有火焰，沒有煙，只有光。幽谷自有饋贈。',
  'entities.quests.q_gleaming_antlers.objectives.0.label': '輝光鹿角',
  'entities.quests.q_wisp_lights.title': '淺灘之光',
  'entities.quests.q_wisp_lights.text': '微光靈身上帶著幽谷封印之時落下的古老星光。六粒光塵，聖祠的燈便能燃上一年。只取那些將熄的，幽谷的饋贈足夠，無需貪求。',
  'entities.quests.q_wisp_lights.completion': '柔和得像最初的星辰。放在祭壇邊吧，聖祠會完成剩下的事。',
  'entities.quests.q_wisp_lights.objectives.0.label': '光塵',
  'entities.quests.q_calming_the_deep.title': '安撫幽深',
  'entities.quests.q_calming_the_deep.text': '輝光深處的孢子人本是溫和的族群，直到裂縫觸到了他們的蘑菇環。被侵蝕奪走的，再也不會歸還。讓墮落者安息吧，{playerName}：深處北面，十個。',
  'entities.quests.q_calming_the_deep.completion': '你做了我不忍做的事。南邊的採集者還在歌唱；因為你，他們能一直唱下去。',
  'entities.quests.q_calming_the_deep.objectives.0.label': '墮落的孢子人：已安息',
  'entities.quests.q_spore_hearts.title': '蘑菇環之心',
  'entities.quests.q_spore_hearts.text': '孢子人墮入黑暗後，心臟仍靠借來的陰影跳動。四顆這樣的心，在聖祠淨化後，能讓我們弄清侵蝕如何蔓延。這活計殘酷，{playerName}，卻是修補之工。',
  'entities.quests.q_spore_hearts.completion': '好了。淨化了，也安靜了。每一顆都指向同一處：陰影來自沉沒王庭。去告訴塞爾文。',
  'entities.quests.q_spore_hearts.objectives.0.label': '孢子之心',
  'entities.quests.q_monument_tour.title': '石碑的記憶',
  'entities.quests.q_monument_tour.text': '封印之前的石碑還立著三座：一座在暮落瞭望台，一座在沉沒王庭，還有一座失落在無人行走的東北角。替我讀一讀它們，{playerName}。我的膝蓋兩百年前就爬不動台階了。',
  'entities.quests.q_monument_tour.completion': '瞭望台、王庭、被遺忘的角落……封印之歌的三段歌詞，自吟唱之日起第一次重聚。你讓一個老讀者非常快樂。',
  ...
  'entities.quests.q_grove_menace.text': '入夜後暮光靈開始在我的攤位間遊蕩，{playerName}，牠們的寒氣碰什麼壞什麼。替我清一清：十隻，哪裡帷幕破了就去哪裡。',
  ...
  'entities.quests.q_shards_of_starfall.text': '暮光靈飄過水晶原野時，古老星光的碎屑會像芒刺般附在牠們身上。六枚碎片，{playerName}，我就能把封印的年代精確到吟唱的那個季節。',
  'entities.quests.q_shards_of_starfall.completion': '看這些紋理！秋天。幽谷是在秋天被封印的。兩百年的爭論，被六塊小石頭了結。',
  'entities.quests.q_shards_of_starfall.objectives.0.label': '星落碎片',
  'entities.quests.q_treant_accord.title': '樹人之約',
  'entities.quests.q_treant_accord.text': '樹蔭長者們的根被侵蝕啃噬，外層樹皮紛紛剝落。四段樹皮，我就能為整片林地熬製藥膏。你去撬樹皮時它們不會道謝，{playerName}，但它們會因此多站立一個世紀。',
  'entities.quests.q_treant_accord.completion': '四段都厚實完好。藥膏要熬一個星期，藥效要過一百年才算完。樹木衡量善意的方式不一樣。',
  'entities.quests.q_treant_accord.objectives.0.label': '長者樹皮',
  'entities.quests.q_spore_tide.title': '抵禦孢子之潮',
  'entities.quests.q_spore_tide.text': '藥膏守住了林地，但每到黃昏，侵蝕就把深處逼得更緊。還要讓十二個墮落者安息，採集者們才能奪回北面的蘑菇環，{playerName}。',
  ...
  'entities.quests.q_sunken_court.text': '布琳讀得沒錯：裂縫貫穿東邊的古老王庭，而它的守衛醒得不對了。它們本是為守護封印而造；如今卻會碾碎任何靠近的人。清除廢墟中的八座。',
  'entities.quests.q_sunken_court.completion': '八座守衛，歸於沉寂。我還記得它們被立起來的時候，{playerName}。別這麼驚訝；幽谷讓它的守護者活得很久。',
  'entities.quests.q_sunken_court.objectives.0.label': '上古守衛：已沉寂',
  'entities.quests.q_wardens_echoes.title': '守望者的迴響',
  'entities.quests.q_wardens_echoes.text': '主人雖已沉默，王庭的守衛仍在重複它最後的命令，像一道不肯消散的迴聲。封印一日不歸位，它們就會不斷甦醒，{playerName}。再平息十座，石匠們才能抵達封印石。',
  'entities.quests.q_wardens_echoes.completion': '迴聲一次比一次微弱。很快王庭就只剩下風和常春藤，廢墟本該如此。',
  'entities.quests.q_wardens_echoes.objectives.0.label': '上古守衛：已沉寂',
  'entities.quests.q_waking_warden.title': '甦醒的守望者',
  'entities.quests.q_waking_warden.text': '王庭安靜了，它的主人卻沒有。持守封印的守望者在扭曲中甦醒，它不倒下，封印就無法修復。這一戰不會輕鬆；能找到一個朋友就帶上一個，{playerName}。能找到兩個就帶上兩個。',
  'entities.quests.q_waking_warden.completion': '它鐘鳴般的嗓音沉寂了。我在這裡都感覺到了，像有重擔從整座山谷卸下。',
  'entities.quests.q_waking_warden.objectives.0.label': '已擊敗甦醒的守望者',
  'entities.quests.q_seal_restored.title': '封印重鑄',
  'entities.quests.q_seal_restored.text': '帶上守望者之印，去王庭中心的封印石那裡，把它放回被擊落的位置。那時幽谷便能開始癒合，而你，{playerName}，將完成你的同族從未做到的事。',
  'entities.quests.q_seal_restored.completion': '我在這裡感覺到它合攏了，溫柔如暮色。幽谷會記得它的朋友，{playerName}。無論你走多遠，大樹下總會為你留一盞燈。',
  ...
  'guide.worldPage.duskPlaceNotes': '古輝鎮聚居在巨樹之下。暮落洞穴與其瞭望台是入口，也是初見山谷的地方；古木林地與星落盆地守著寧靜的南方；沉沒王庭在東面藏著草木蔓生的廢墟；輝光深處與水晶淺灘則在北方閃著微光。',
