...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolsNote':
    'Cada nó exige a ferramenta do ofício correspondente nas bolsas, incluindo os de nível 1: sem picareta, sem minério; sem vara, sem peixe. A escada de vendedores cobre os níveis 1 a 3, e cada cidade principal estoca apenas os níveis que o próprio terreno dela usa: a ferramenta de nível 1 é vendida em toda cidade principal, enquanto os degraus acima dela são vendidos onde estão os veios que os exigem. Para esses degraus os vendedores também exigem perícia no ofício da ferramenta, {tier2Prof} para o nível 2 e {tier3Prof} para o nível 3, e a linha informa o requisito. Uma ferramenta só precisa estar nas suas bolsas, não há espaço de equipamento nem durabilidade, então cada uma é uma compra única, e o que você já possui continua funcionando. Apenas o nível importa para o requisito de acesso: a cor de raridade de uma ferramenta é cosmética.\n\nAcima da escada de vendedores ficam duas ferramentas criadas, de nível 4 e nível 5, feitas na oficina de ferramentas por engenheiros e nunca vendidas por nenhum NPC. Nenhum nó hoje exige mais que o nível 3, então seu valor agora é velocidade: uma ferramenta de topo fixa o lançamento em seu mínimo nos nós inferiores, e será o ingresso de entrada quando terrenos de nível mais alto chegarem.',
