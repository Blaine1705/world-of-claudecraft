...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_ps_a_path_of_your_own.title': '나만의 길',
  'entities.quests.q_ps_a_path_of_your_own.text':
    '칼을 휘두르는 것과 왜 휘두르는지 아는 것은 별개예요, {playerName}. 5레벨이 되면 세상은 당신에게 전문화를 고르라 할 겁니다. 당신의 소명에 놓인 세 갈래 길 중 하나, 저마다의 강점이 있죠. 그때부터는 몇 레벨마다 특성 한 줄이 열리고, 셋 중 하나를 고릅니다. 허수아비 둘을 더 쓰러뜨리면서, 짚이 흩날리는 동안 어느 길을 걸을지 생각해 보세요.',
  'entities.quests.q_ps_a_path_of_your_own.completion':
    '둘을 더 쓰러뜨렸고, 휘두름 뒤에 전보다 단단한 것이 생겼네요. 무엇보다 이것만은 기억하세요, {playerName}. 당신의 어떤 선택도 감옥이 아닙니다. 특성 창은 언제든 열 수 있고, 5레벨에 선택한 뒤에도 안전한 곳에 서 있기만 하면 특성과 전문화 모두 비용 없이 언제든 초기화하고 다시 고를 수 있어요. 담대하게 고르고, 더 배우면 다시 고르세요.',
  'entities.quests.q_ps_a_path_of_your_own.objectives.0.label': '훈련용 허수아비 쓰러뜨리기',
  'entities.quests.q_ps_the_wheel_of_trades.title': '생업의 바퀴',
  'entities.quests.q_ps_the_wheel_of_trades.text':
    '칼은 한 끼를 먹여 주지만, {playerName}, 생업은 평생을 먹여 줍니다. 모험가라면 누구나 칼 곁에 전문 기술을 둡니다. 채광, 벌목, 약초 채집, 낚시, 그리고 그 모두를 값어치로 바꾸는 제작 기술이죠. 보급관 핀치는 내가 치른 훈련보다 많은 좌판을 꾸려 왔어요. 가서 생업이 어떻게 세워지는지 물어보세요.',
