...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocMarket.tabActivity': '활동',
  ...
  'hudChrome.wocMarket.rateNote': '현재 환율: 1 USD당 약 {tokens} $WOC (외부 거래 시장의 최신 체결 가격, {time} 기준).',
  ...
  'hudChrome.wocMarket.detailSaleRow': '{usd}: {seller}에서 {buyer}에게',
  ...
  'hudChrome.wocMarket.bidBondNote': '입찰 시 {usd} 상당의 환불 가능한 보증금($WOC)을 예치합니다. 상회 입찰이 나오면 반환되며(차순위 제안으로 당신이 구매자가 되는 경우 제외), 낙찰 후 결제하지 않은 경우에만 몰수됩니다.',
  ...
  'hudChrome.wocMarket.bidCloseNote': '마감 직전 몇 분 사이에 보증금이 확인된 입찰은 경매를 몇 분 연장할 수 있습니다. 경매가 끝난 뒤 도착한 결제는 경매를 다시 열지 않고 환불됩니다.',
  'hudChrome.wocMarket.offerNextNote': '낙찰자가 결제하지 않으면 당신이 자신의 입찰가로 구매자가 될 수 있습니다. 이때 보증금이 다시 예치되며 정산 기간 안에 결제해야 합니다. 결제하지 않으면 보증금이 몰수되고 위반이 기록됩니다.',
  'hudChrome.wocMarket.buyNowNote': '즉시 구매는 이 매물을 잠시 당신을 위해 확보합니다. 결제하지 않고 떠나면 한동안 즉시 구매가 중지됩니다.',
  ...
  'hudChrome.wocMarket.quoteBurn': '소각: {tokens} $WOC',
  'hudChrome.wocMarket.quoteTreasury': '트레저리: {tokens} $WOC',
  ...
  'hudChrome.wocMarket.sellClearTitle': '선택 해제',
  ...
  'hudChrome.wocMarket.activityEmpty': '아직 없습니다. 입찰, 등록, 정산 내역이 여기에 표시됩니다.',
  ...
  'hudChrome.trade.woc.variableWarning': '$WOC 금액은 미리보기이며 고정 가격이 아닙니다. 정확한 수량은 결제 시점의 최신 견적으로 정해집니다.',
  ...
  'hudChrome.trade.woc.notInstant': '$WOC 거래는 즉시 완료되지 않습니다. 판매자가 수락하면 아이템이 에스크로로 이동하고, 결제가 확인되면 구매자에게 전달됩니다.',
  ...
  'hudChrome.trade.woc.p2pBindingNote': '양측이 수락하면 {duration} 안에 결제해야 합니다. 결제하지 않으면 마켓 위반이 기록됩니다.',
  'hudChrome.trade.woc.p2pBindingNoteUntimed': '양측이 수락하면 곧 결제 기한이 됩니다. 결제하지 않으면 마켓 위반이 기록됩니다.',
