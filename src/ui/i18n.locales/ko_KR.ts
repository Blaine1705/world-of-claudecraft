...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.deathless_warguard_gauntlets.name': '불사 전쟁수호 건틀릿',
  'entities.items.soulrend_handwraps.name': '영혼분열 손싸개',
  'entities.items.scourgehide_grips.name': '재앙가죽 손아귀',
  'entities.items.soulforged_gauntlets.name': '혼주조 건틀릿',
