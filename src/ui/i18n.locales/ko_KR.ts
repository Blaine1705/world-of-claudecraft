...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.plurals.noticeboardGuildStats.one': '{count}명 회원, 누적 경험치 {xp}',
  'hudChrome.plurals.noticeboardGuildStats.few': '{count}명 회원, 누적 경험치 {xp}',
  'hudChrome.plurals.noticeboardGuildStats.many': '{count}명 회원, 누적 경험치 {xp}',
  'hudChrome.plurals.noticeboardGuildStats.other': '{count}명 회원, 누적 경험치 {xp}',
