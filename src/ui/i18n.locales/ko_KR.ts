...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.trade.woc.settled': '결제 완료. 아이템이 우편으로 전달됩니다.',
  ...
  'hudChrome.trade.woc.closedCancelled': '이 거래가 취소되었습니다. 아이템은 우편으로 판매자에게 반환됩니다.',
  'hudChrome.trade.woc.closedSuspended': '이 거래는 게임 마스터에 의해 중단되었습니다. 아이템은 우편으로 판매자에게 반환됩니다.',
  'hudChrome.trade.woc.closedUnpaid': '이 거래는 결제 없이 종료되었습니다. 아이템은 우편으로 판매자에게 반환됩니다.',
  ...
  'hudChrome.trade.woc.dealAwaitsPayment':
    '$WOC 구매가 아직 결제되지 않았습니다. 판매자와 다시 거래하여 결제하세요. 결제하지 않으면 거래는 자동으로 만료됩니다.',
  'hudChrome.trade.woc.paymentConfirmed': '결제가 확인되었습니다. 전달이 완료되면 아이템이 우편으로 도착합니다.',
