...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_ps_strike_true.text':
    '수련의 해안에 온 걸 환영해요, {playerName}. 이곳의 모든 가르침은 같은 것에서 시작합니다. 발을 딛고, 칼자루를 쥐는 것. W, A, S, D로 걷고, 마우스 오른쪽 버튼을 누른 채 시점을 돌리세요. 야영지 남서쪽 수련장의 허수아비들은 맞으라고 만든 것들입니다. 하나에게 다가가 Tab을 누르거나 왼쪽 클릭하면 대상으로 잡힙니다. 그런 다음 1을 누르거나, 화면 아래쪽 행동 단축바의 첫 번째 아이콘을 클릭해 내리치세요. 셋이 쓰러질 때까지 계속 내리치세요. 허수아비의 반격은 따끔한 정도죠. 이 해안 너머의 것들은 훨씬 세게 때린답니다.',
  ...
  'entities.quests.q_ps_the_wreck_line.text':
    '조수는 이 섬에 표류물로 값을 치릅니다. 옛 난파선의 표류 상자들이 야영지 남동쪽, 골짜기를 마주한 바닷가로 밀려오죠. 여는 건 간단해요, {playerName}. 상자 이름이 보일 때까지 바짝 다가가 F를 누르거나 상자를 왼쪽 클릭하면, 품고 있던 것을 내어 줍니다. 셋이면 충분합니다. 표류물을 뒤지는 게들은 보기보다 세게 꼬집으니 발밑을 조심하고, 이것만은 기억하세요. 앞으로 만날 모든 상자와 채집물과 문은 전부 같은 F 하나로 엽니다.',
  ...
  'entities.quests.q_ps_the_wheel_of_trades.completion':
    '마렌이 드디어 말 걸 만한 학생을 보냈군요. 한 번만 말할 테니 잘 들어요, {playerName}. 채집은 도구에서 시작합니다. 곡괭이, 도끼, 낫, 낚싯대, 전부 골짜기 상인들이 팔죠. 당신의 기술은 바퀴를 이룹니다. 좋아하는 것을 갈고닦다가 인접한 한 쌍에 조율하면 그 둘은 상한 없는 주 전공이 되고, 바퀴 건너편 하나는 취미로 남고, 나머지는 다시 잡을 때까지 잠듭니다. 배운 것은 결코 사라지지 않고, 준비가 되면 마을의 장인들이 조율을 권해 올 거예요.',
