...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.reliquaryPage.intro':
    '성유물 보관소는 목록에 올린 고유 전리품의 박물관입니다. 던전 추격 장비, 전문 기술 트로피, 탈것, 무기 스킨, 칭호. 공적 책과의 관계는 트로피 홀과 업적 책과 같습니다.',
  'guide.reliquaryPage.howHeading': '수집 작동 방식',
  'guide.reliquaryPage.howBody':
    '게임에서 성유물 보관소를 엽니다(기본 Shift+X). 각 선반에 고유 성유물 페이지가 있습니다. 캐릭터가 그 조각을 처음 얻으면 실루엣이 채워지고, 페이지의 모든 성유물이 채워지면 페이지가 밝혀집니다. 실시간 발견은 알림과 열린 창 새로고침으로 이어집니다. 진행도는 캐릭터 단위이며 무기 스킨만 계정 장식입니다.',
  'guide.reliquaryPage.ranksHeading': '큐레이터 등급',
  'guide.reliquaryPage.ranksBody':
    '큐레이터 등급은 목록에 올린 고유 채움에 따라 오르며 장식 칭호와 테두리만 줍니다. 전투 능력, 드롭률, 천장 보정은 없습니다. 계정 무기 스킨은 큐레이터 등급에 들어가지 않아 명성은 캐릭터에 남습니다.',
  'guide.reliquaryPage.catalogHeading': '페이지 목록',
  'guide.reliquaryPage.catalogBody':
    '작성된 모든 성유물 보관소 페이지와 그 성유물 이름입니다. 스포일러 안전 이름만 있으며, 진행도·클리어 수·실루엣은 게임 속 성유물 보관소에서 확인하세요.',
