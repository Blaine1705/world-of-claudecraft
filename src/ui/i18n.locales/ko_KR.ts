...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.tutorialGreeting.islandArrivalNote':
    '방금 건너오셨나요? 수련의 해안에 온 것을 환영합니다. W, A, S, D로 걷고, 마우스 오른쪽 버튼을 누른 채로 시점을 돌리세요. 제 뒤 길을 따라 새벽쉼터 야영지에서 교관 마렌이 훈련을 이끌고 있어요. 이름이 보일 때까지 바짝 다가가 F를 누르거나 왼쪽 클릭하면 이야기할 수 있고, 첫 번째 임무를 내줄 겁니다. 그리고 떠날 준비가 되면 제 부두 옆에 선 종을 울리세요. 건너기가 이스트브룩의 집으로 데려다줄 겁니다.',
