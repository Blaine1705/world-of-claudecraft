...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'questUi.worldQuest.match3DefeatDetail': '이동 횟수를 모두 사용했습니다. 새로운 과자가 기다립니다.',
  ...
  'questUi.worldQuest.traceDrawing': '금빛 반짝임을 따라 빛나는 꼭짓점으로 가세요. 파란색은 지나온 길입니다.',
  ...
  'questUi.worldQuest.traceMovement': '탈것에서 내려 땅 위를 걸으세요. 교관에게 말을 걸어 다시 도전하세요.',
  ...
  'entities.npcs.calligraphy_instructor.greeting': '차분한 걸음이 반듯한 선을 만들지. 제자들에게 삼각형과 정사각형, 고급 룬을 그리는 법을 가르쳐 주게.',
  'entities.npcs.calligraphy_apprentice_1.name': '견습생 테사',
  'entities.npcs.calligraphy_apprentice_1.title': '서예 학생',
  'entities.npcs.calligraphy_apprentice_1.greeting': '자꾸 너무 일찍 방향을 틀어요. 어디가 꼭짓점인지 보여 주실래요?',
  'entities.npcs.calligraphy_apprentice_2.name': '견습생 핍',
  'entities.npcs.calligraphy_apprentice_2.title': '서예 학생',
  'entities.npcs.calligraphy_apprentice_2.greeting': '삼각형 먼저, 그다음은 정사각형, 마지막은 룬. 한 걸음씩 차분하게!',
  ...
  'questUi.worldQuest.traceReaction.elianGold': '멋지게 그렸군! 자네의 발걸음은 금빛 평가에 어울리네.',
  'questUi.worldQuest.traceReaction.elianComplete': '룬 완성! 정성을 다해 연습하면 다음에는 더 멋지게 그릴 걸세.',
};
