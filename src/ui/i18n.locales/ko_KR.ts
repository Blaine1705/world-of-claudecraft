...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.reliquaryPage.howBody':
    '게임에서 성물고를 엽니다(기본 Shift+X). 각 선반에 고유 성유물 페이지가 있습니다. 캐릭터가 그 조각을 처음 얻으면 실루엣이 채워지고, 페이지의 모든 성유물이 채워지면 페이지가 밝혀집니다. 실시간 발견은 알림과 열린 창 새로고침으로 이어집니다. 진행도는 캐릭터 단위이며 무기 스킨만 계정 장식입니다.',
  ...
  'hudChrome.reliquary.sourceRift': '{rank} 등급 균열 클리어 보상',
  ...
  'hudChrome.reliquary.sourceActivityMasterworkCraft': '명작 제작으로 획득',
