...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.revenge.description':
    '넓은 호를 그리며 공격하여 전방의 모든 적에게 물리 피해를 입힙니다. 대상이 5명을 초과하면 피해가 감소합니다. 회피하거나 무기막기에 성공하면 다음 복수의 분노 소모가 없어질 수 있습니다.',
  ...
  'entities.abilities.breachmaker.name': '붕괴 일격',
  'entities.abilities.breachmaker.description':
    '대상을 무기 공격력에 더해 {damage}만큼 강타하고 방어를 부숴, 8초 동안 자신의 공격이 그 대상에게 20% 더 큰 피해를 입힙니다. (무기)',
  'entities.abilities.measured_fury.name': '침착한 분노',
  'entities.abilities.measured_fury.description':
    '침착한 분노가 자원 운용을 벼립니다: 당신의 능력의 분노 소모가 10% 감소합니다. (무기)',
  ...
  'guide.abilityHook.hamstring': '대상의 다리를 베어 이동 속도를 늦춰 추격하지 못하게 합니다.',
  ...
  'hudChrome.auraEffect.avatar': '거인: 입히는 피해가 {pct}% 증가합니다',
  ...
  'hudChrome.auraEffect.revengeFree': '다음 복수에 분노가 소모되지 않습니다',
