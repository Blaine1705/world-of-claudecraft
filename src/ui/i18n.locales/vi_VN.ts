...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolsNote':
    'Mọi điểm tài nguyên đều cần công cụ của nghề tương ứng nằm trong túi, kể cả bậc 1: không có cuốc thì không có quặng, không có cần câu thì không có cá. Thang bán của người bán bao gồm bậc 1 đến 3, và mỗi thị trấn trung tâm chỉ trữ những bậc mà vùng đất của chính nó dùng đến: công cụ bậc 1 được bán ở mọi thị trấn trung tâm, còn các bậc cao hơn được bán ở nơi có những mạch cần đến chúng. Với các bậc đó, người bán còn đòi hỏi trình độ trong chính nghề của công cụ, {tier2Prof} cho bậc 2 và {tier3Prof} cho bậc 3, và dòng hàng sẽ nêu rõ yêu cầu. Công cụ chỉ cần có trong túi, không có ô trang bị và không có độ bền, nên mỗi cái chỉ cần mua một lần, và những gì bạn đã có vẫn dùng được. Chỉ bậc mới quan trọng cho yêu cầu: màu độ hiếm của công cụ chỉ là trang trí.\n\nCao hơn thang bán của người bán là hai công cụ chế tạo, bậc 4 và bậc 5, được làm tại xưởng dụng cụ bởi các kỹ sư và không bao giờ được bán bởi NPC nào. Không có điểm tài nguyên nào hiện tại cần hơn bậc 3, nên giá trị của chúng hiện tại là tốc độ: công cụ hàng đầu giữ thời gian thu thập ở mức sàn trên các điểm tài nguyên thấp hơn, và nó sẽ là vé vào cửa khi xuất hiện vùng đất bậc cao hơn.',
