...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.gravewyrm_bone_quiver.name': "Ống tên xương Gravewyrm",
  'entities.items.direfang_quiver.name': "Ống tên Direfang",
  'entities.items.sharp_claw.name': "Vuốt sắc",
  'entities.items.curved_tusk.name': "Ngà cong",
  'entities.items.pristine_claw.name': "Vuốt nguyên vẹn",
};
