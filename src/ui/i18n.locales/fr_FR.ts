...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolCraftedOrMarks':
    'Crafted ({craft}) or {marks} Marques de Gouffre after three Litanie Noyée clears',
  'guide.profPages.toolCraftedOrMarksHeroic':
    'Crafted ({craft}) or {marks} Marques de Gouffre after a Heroic Litanie Noyée clear',
  ...
  'hudChrome.crafting.identity.skillListAria': 'Compétences artisanales',
  'hudChrome.crafting.reagentFineSub': '(dépense {count} en qualité fine)',
  'hudChrome.deeds.broadcastsLabel':
    "Partagez les exploits déverrouillés avec les membres de la guilde et les adeptes, ainsi que les cartes d'exploits et de chefs-d'œuvre avec le flux Discord.",
  'hudChrome.gathering.emptyHookNote': 'Rien sur le crochet',
  'hudChrome.gathering.fineGradePreview':
    "Votre outil affine ce rendement jusqu'à obtenir une qualité fine.",
  ...
  'hudChrome.gathering.toolTierUnmet.fishing':
    "Vous avez besoin d'une canne à pêche de niveau {tier} pour pêcher ces eaux.",
  'hudChrome.gathering.toolTooltip.unlocks.fishing':
    'Nécessaire pour pêcher les eaux jusqu’au niveau {tier}.',
  'hudChrome.gathering.wieldUnmet.herbalism':
    "Vous avez besoin d'Herboristerie {skill} pour travailler la faucille déjà dans vos sacs.",
  'hudChrome.gathering.wieldUnmet.logging':
    'Vous avez besoin de Logging {skill} pour balancer la hache déjà dans vos sacs.',
  'hudChrome.gathering.wieldUnmet.mining':
    'Vous avez besoin de Mining {skill} pour balancer la pioche déjà dans vos sacs.',
  'hudChrome.gathering.wieldUnmetCorpse':
    'Vous avez besoin de rassembler la compétence {skill} pour mettre en œuvre votre meilleur outil.',
  'hudChrome.materialHint.fineGrade':
    "Belle qualité. Réuni à partir d'une veine de niveau complet avec un outil classé au-dessus du matériau, et compte comme la version ordinaire partout où on en a besoin.",
  'hudChrome.professions.toolEffectCharges': '{charges} sur {max} frais',
  'hudChrome.professions.toolEffectConfirmAccept': 'Utiliser une charge',
  'hudChrome.professions.toolEffectConfirmBody':
    'Dépenser une charge pour cette récolte ? Le déclin rassemble toujours, sans le bonus. Charges restantes : {charges}.',
  'hudChrome.professions.toolEffectConfirmDecline': 'Rassemblez-vous sans',
  'hudChrome.professions.toolEffectConfirmTitle': 'Utiliser {effect} ?',
  'hudChrome.professions.toolEffectDepleted': "Effet d'outil dépensé",
  'hudChrome.professions.toolEffectModeAsk': 'Poser à chaque utilisation',
  'hudChrome.professions.toolEffectModePrompt': 'Demande à chaque utilisation',
  'hudChrome.professions.toolEffectName.artisansEye': "Oeil de l'artisan",
  'hudChrome.professions.toolEffectName.gatherersCache': 'Cache du récolteur',
  'hudChrome.professions.toolEffectName.quickeningCharm': 'Charme élastique',
  'hudChrome.professions.toolEffectNoCharm':
    'Vous avez besoin d’une breloque {effect} artisanale dans vos sacs.',
  'hudChrome.professions.toolEffectNoGain': '{effect} est déjà inséré et complètement chargé.',
  'hudChrome.professions.toolEffectNoTool':
    'Vous avez d’abord besoin d’un véritable outil {profession}.',
  'hudChrome.professions.toolEffectRechargeButton': 'Recharger',
  'hudChrome.professions.toolEffectRechargeFull': '{effect} est déjà complètement chargé.',
  'hudChrome.professions.toolEffectRechargeMaterials':
    'La recharge de {effect} nécessite {material} x{count}.',
  'hudChrome.professions.toolEffectRechargeNoSlot': "Aucun effet n'est placé sur {profession}.",
  ...
  'hudChrome.professions.toolEffectRechargeToolCapped':
    'Emportez un meilleur outil {profession} pour charger davantage {effect}.',
  'hudChrome.professions.toolEffectRecharged': '{effect} rechargé : {material} x{count} consommé.',
  'hudChrome.professions.toolEffectSlotButton': 'Emplacement {effect}',
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} ne peut pas y être inséré.',
  'hudChrome.professions.toolEffectSlotted': '{effect} inséré sur {profession}.',
  'hudChrome.professions.toolEffectSpent': 'Dépensé, doit être rechargé',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    "Il s'agit d'un combat d'entraînement, il n'est donc pas classé : le classement ne bouge pas et la progression du Livre des Actes ne compte pas.",
  'hudChrome.vcup.briefing.unratedNote':
    "Les robots sont sur le terrain, donc ce combat n'est pas classé : le classement ne bouge pas, et les actes de buts, les arrêts et les feuilles blanches ne comptent pas.",
  'hudChrome.vcup.practiceUnratedNote':
    "Les combats d'entraînement ne sont pas classés : le classement et la progression du Livre des Actes ne comptent pas.",
  'hudChrome.vcup.rolesSmallBracketNote':
    'Dans les tranches 1v1 et 2v2, chaque combattant joue le kit All-Rounder. Les exploits qui nécessitent le support 3v3 ou plus ne peuvent pas être gagnés ici.',
  'itemUi.bags.unknownItem': 'Objet inconnu',
  'itemUi.bags.unknownItemAria': 'Article inconnu {id}, quantité {count}',
  'itemUi.bags.unknownItemAriaBound': 'Article inconnu {id}, quantité {count}, copie reliée',
  'itemUi.bags.unknownItemAriaEnchanted': 'Objet inconnu {id}, quantité {count}, copie enchantée',
  'itemUi.bags.unknownItemAriaInstanced':
    'Article inconnu {id}, quantité {count}, copie marquée par le fabricant',
  'itemUi.bags.unknownItemAriaMasterwork': "Article inconnu {id}, quantité {count}, chef-d'œuvre",
  'itemUi.kind.fineMaterial': 'Matériau fin',
  'itemUi.vendor.buyCountAria': 'Achetez {count} sur {item} pour {price}',
  'itemUi.vendor.buyCountAriaWithRequirement':
    'Achetez {count} sur {item} pour {price}. {requirement}',
  'itemUi.vendor.buyQuantityConfirm': 'Acheter',
  'itemUi.vendor.buyQuantityInput': 'Quantité à acheter',
  'itemUi.vendor.buyQuantityTitle': "Acheter combien de {item} ? Jusqu'à {max}.",
  'itemUi.vendor.qtyCustom': 'Coutume',
  'itemUi.vendor.qtyCustomAria': 'Choisissez un montant personnalisé à acheter',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Achetez {count} à la fois',
  'itemUi.vendor.qtyRowAria': 'Quantité achetée',
  'questUi.dialog.repeatableQuestAria': 'Quête répétable : {name}',
  'questUi.log.cooldownStatus': 'Bientôt à nouveau disponible',
