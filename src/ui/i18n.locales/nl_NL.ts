...
export const nl_NL: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.artisans_eye.name': 'Ambachtelijk oog',
  'entities.items.fine_ashwood_log.name': 'Fijn essenhoutblok',
  'entities.items.fine_copper_ore.name': 'Fijn kopererts',
  'entities.items.fine_elderwood_log.name': 'Fijne Highpine-stam',
  'entities.items.fine_goldleaf_herb.name': 'Fijn bladgoudkruid',
  'entities.items.fine_iron_ore.name': 'Fijn ijzererts',
  'entities.items.fine_ironbark_log.name': 'Fijne ijzerschorsstam',
  'entities.items.fine_silverleaf_herb.name': 'Fijn Sheenbladkruid',
  'entities.items.fine_sunpetal_herb.name': 'Fijn zonnebloemkruid',
  'entities.items.fine_thorium_ore.name': 'Fijn osmiumerts',
  'entities.items.gatherers_cache.name': 'Verzamelaarscache',
  'entities.items.stormreel_fishing_rod.name': 'Stormreel hengel',
  'entities.items.tidewrought_fishing_rod.name': 'Getijdenwrochte hengel',
  'entities.quests.q_nythraxis_graves.text':
    'Ik heb deze sporen eerder gezien, op drie oude graven rond het noordelijke slagveld. Kapitein Aldren ligt aan de westelijke helling, hogepriester Malric verder naar het zuiden langs de westelijke rand, en Royal Assassin Voss bij de oostelijke klif. Raak elk graf aan en luister, {playerName}. De doden kunnen zich herinneren wat de levenden vergeten zijn.',
  ...
  'hudChrome.actionBar.editKeysHint':
    'Klik op een slot op de actiebalk en druk vervolgens op een toets om het te binden.',
  'hudChrome.actionBar.reset': 'Opnieuw instellen',
  'hudChrome.actionBar.resetConfirmBody':
    'De eerste balk keert terug naar de standaardtoetsen. De tweede en derde maat worden ongebonden. Dit kan niet ongedaan worden gemaakt.',
  'hudChrome.actionBar.resetConfirmTitle': 'Actiebalktoetsen opnieuw instellen?',
  'hudChrome.bags.filterTool': 'Hulpmiddelen',
  'hudChrome.crafting.identity.allCrafts': 'Alle ambachten',
  'hudChrome.crafting.identity.skillListAria': 'Ambachtelijke vaardigheden',
  'hudChrome.crafting.reagentFineSub': '(besteedt {count} fijn)',
  'hudChrome.deeds.broadcastsLabel':
    'Deel akte-ontgrendelingen met gildeleden en volgers, en akte- en meesterwerkkaarten met de Discord-feed',
  'hudChrome.gathering.emptyHookNote': 'Niets aan de haak',
  'hudChrome.gathering.fineGradePreview':
    'Uw gereedschap verfijnt deze opbrengst tot een fijn niveau.',
  'hudChrome.gathering.respawnClock': '{minutes}:{seconds}',
  'hudChrome.gathering.stateCooldownTimed': 'Komt terug in {time}',
  'hudChrome.gathering.toolTierUnmet.fishing':
    'Om in deze wateren te vissen, heb je een hengel van niveau {tier} nodig.',
  'hudChrome.gathering.toolTooltip.unlocks.fishing':
    'Vereist voor het vissen in wateren tot niveau {tier}.',
  'hudChrome.gathering.wieldUnmet.herbalism':
    'Je hebt Herbalism {skill} nodig om de sikkel al in je zakken te laten werken.',
  'hudChrome.gathering.wieldUnmet.logging':
    'Je hebt logboekregistratie {skill} nodig om de bijl die al in je koffer zit te zwaaien.',
  'hudChrome.gathering.wieldUnmet.mining':
    'Je hebt Mining {skill} nodig om de houweel die al in je koffer zit te zwaaien.',
  'hudChrome.gathering.wieldUnmetCorpse':
    'Je moet vaardigheden {skill} verzamelen om je beste gereedschap aan het werk te kunnen zetten.',
  'hudChrome.materialHint.fineGrade':
    'Fijne kwaliteit. Verzameld uit een volledige ader met een gereedschap dat boven het materiaal staat, en telt als de gewone versie waar dat nodig is.',
  'hudChrome.professions.toolEffectCharges': '{charges} van {max} kosten',
  'hudChrome.professions.toolEffectConfirmAccept': 'Gebruik een lading',
  'hudChrome.professions.toolEffectConfirmBody':
    'Een vergoeding uitgeven aan deze oogst? Dalen komt nog steeds voor, zonder de bonus. Resterende kosten: {charges}.',
  'hudChrome.professions.toolEffectConfirmDecline': 'Verzamel zonder',
  'hudChrome.professions.toolEffectConfirmTitle': 'Gebruik {effect}?',
  'hudChrome.professions.toolEffectDepleted': 'Gereedschapseffect uitgegeven',
  'hudChrome.professions.toolEffectModeAsk': 'Vraag elk gebruik',
  'hudChrome.professions.toolEffectModePrompt': 'Vraagt ​​elk gebruik',
  'hudChrome.professions.toolEffectName.artisansEye': 'Ambachtelijk oog',
  'hudChrome.professions.toolEffectName.gatherersCache': 'Verzamelaarscache',
  'hudChrome.professions.toolEffectName.quickeningCharm': 'Terugverende charme',
  'hudChrome.professions.toolEffectNoCharm':
    'Je hebt een handgemaakte {effect}-bedel in je tas nodig.',
  ...
  'hudChrome.professions.toolEffectNoTool':
    'Je hebt eerst een echt {profession}-gereedschap nodig.',
  ...
  'hudChrome.professions.toolEffectRechargeMaterials':
    'Voor het opladen van {effect} is {material} x{count} nodig.',
  'hudChrome.professions.toolEffectRechargeNoSlot': 'Er is geen effect op {profession}.',
  'hudChrome.professions.toolEffectRechargePrice': 'Opladen: {count} x {material}',
  'hudChrome.professions.toolEffectRechargeToolCapped':
    'Neem een ​​beter {profession}-apparaat mee om {effect} verder op te laden.',
  'hudChrome.professions.toolEffectRecharged': '{effect} opgeladen: {material} x{count} verbruikt.',
  'hudChrome.professions.toolEffectSlotButton': 'Sleuf {effect}',
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} kan daar niet worden geplaatst.',
  'hudChrome.professions.toolEffectSlotted': '{effect} sleuf op {profession}.',
  'hudChrome.professions.toolEffectSpent': 'Opgebruikt, moet worden opgeladen',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    'Dit is een oefengevecht en heeft dus geen beoordeling: de standen veranderen niet en de voortgang in het Boek der Daden telt niet mee.',
  'hudChrome.vcup.briefing.unratedNote':
    'Er zijn bots op het veld, dus dit gevecht heeft geen rating: het klassement verandert niet en daden voor doelpunten, reddingen en schone lakens tellen niet mee.',
  'hudChrome.vcup.practiceUnratedNote':
    'Oefengevechten worden niet beoordeeld: het klassement en de voortgang in het Boek der Daden tellen niet mee.',
  'hudChrome.vcup.rolesSmallBracketNote':
    'In de 1v1- en 2v2-beugels speelt elke vechter de All-Rounder-kit. Daden waarvoor de 3v3-beugel of groter nodig is, kunnen hier niet worden verdiend.',
  'itemUi.bags.unknownItem': 'Onbekend artikel',
  'itemUi.bags.unknownItemAria': 'Onbekend artikel {id}, aantal {count}',
  'itemUi.bags.unknownItemAriaBound': 'Onbekend item {id}, aantal {count}, ingebonden exemplaar',
  'itemUi.bags.unknownItemAriaEnchanted': 'Onbekend item {id}, aantal {count}, betoverde kopie',
  'itemUi.bags.unknownItemAriaInstanced':
    'Onbekend item {id}, aantal {count}, door de maker gemarkeerd exemplaar',
  'itemUi.bags.unknownItemAriaMasterwork': 'Onbekend item {id}, aantal {count}, meesterwerk',
  'itemUi.kind.fineMaterial': 'Fijn materiaal',
  'itemUi.vendor.buyAriaWithRequirement': 'Koop {item} voor {price}. {requirement}',
  'itemUi.vendor.buyCountAria': 'Koop {count} van {item} voor {price}',
  'itemUi.vendor.buyCountAriaWithRequirement':
    'Koop {count} van {item} voor {price}. {requirement}',
  'itemUi.vendor.buyQuantityConfirm': 'Kopen',
  'itemUi.vendor.buyQuantityInput': 'Hoeveelheid om te kopen',
  'itemUi.vendor.buyQuantityTitle': 'Hoeveel {item} kopen? Tot {max}.',
  'itemUi.vendor.qtyCustom': 'Aangepast',
  'itemUi.vendor.qtyCustomAria': 'Kies een aangepast bedrag om te kopen',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Koop {count} per keer',
  'itemUi.vendor.qtyRowAria': 'Aankoophoeveelheid',
  'questUi.dialog.repeatableQuestAria': 'Herhaalbare zoektocht: {name}',
  'questUi.log.cooldownStatus': 'Binnenkort weer beschikbaar',
  'questUi.log.repeatableStatus': 'Herhaalbaar',
  'questUi.tracker.unknownQuest': 'Onbekende zoektocht ({id})',
};
