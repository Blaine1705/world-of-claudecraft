...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.artisans_eye.name': 'Zanaatkarın Gözü',
  'entities.items.fine_ashwood_log.name': 'İnce Dişbudak Kütüğü',
  'entities.items.fine_copper_ore.name': 'İnce Bakır Cevheri',
  'entities.items.fine_elderwood_log.name': 'İnce Yüksek Çam Kütüğü',
  'entities.items.fine_goldleaf_herb.name': 'İnce Altınyaprak Bitkisi',
  'entities.items.fine_iron_ore.name': 'İnce Demir Cevheri',
  'entities.items.fine_ironbark_log.name': 'İnce Demir Kabuğu Günlüğü',
  'entities.items.fine_silverleaf_herb.name': 'İnce Yapraklı Bitki',
  'entities.items.fine_sunpetal_herb.name': 'Güzel Günçiçeği Bitkisi',
  'entities.items.fine_thorium_ore.name': 'İnce Osmiyum Cevheri',
  'entities.items.gatherers_cache.name': 'Toplayıcı Önbelleği',
  'entities.items.stormreel_fishing_rod.name': 'Stormreel Olta',
  'entities.items.tidewrought_fishing_rod.name': 'Tidewrought Olta',
  'entities.quests.q_nythraxis_graves.text':
    'Bu işaretleri daha önce kuzeydeki savaş alanının çevresindeki üç eski mezarda görmüştüm. Yüzbaşı Aldren batıdaki yükselişte, Baş Rahip Malric batı kenarı boyunca daha güneyde ve Kraliyet Suikastçısı Voss doğudaki uçurumun yanında yatıyor. Her mezara dokunun ve dinleyin, {playerName}. Yaşayanların unuttuğunu ölüler hatırlayabilir.',
  'entities.quests.q_the_codfather.text':
    "Morina Baba sadece bir balık değil, {playerName}, o soğukkanlı bir katil. Eskiler onun kahvaltıda Mire Prowlers'ı yediğine yemin ederler ve Mirefen Dulları bile sırf korkudan Deepfen Sığlıkları yakınında ağlarını öremezler. Bu suları o yönetiyor ve bataklık suyu bir Demir Makara Oltasını alıyor; tezgahım onları satıyor. Eline bir tane al, o yaşlı şeytanı sularından çıkar, ben de aileye katıldığını kabul edeceğim.",
  ...
  'hudChrome.professions.toolEffectName.artisansEye': 'Zanaatkarın Gözü',
  'hudChrome.professions.toolEffectName.gatherersCache': 'Toplayıcı Önbelleği',
  'hudChrome.professions.toolEffectName.quickeningCharm': 'Geri Yaylanma Cazibesi',
  'hudChrome.professions.toolEffectNoCharm':
    'Çantalarınızda el yapımı bir {effect} charmına ihtiyacınız var.',
  'hudChrome.professions.toolEffectNoGain':
    '{effect} zaten yuvaya yerleştirilmiş ve tamamen şarj edilmiş durumda.',
  'hudChrome.professions.toolEffectNoTool':
    'Öncelikle gerçek bir {profession} aracına ihtiyacınız var.',
  'hudChrome.professions.toolEffectRechargeButton': 'Yeniden şarj et',
  'hudChrome.professions.toolEffectRechargeFull': '{effect} zaten tamamen şarj oldu.',
  'hudChrome.professions.toolEffectRechargeMaterials':
    "{effect}'nin şarj edilmesi için {material} x{count} gerekiyor.",
  'hudChrome.professions.toolEffectRechargeNoSlot':
    '{profession} üzerinde herhangi bir efekt yerleştirilmemiştir.',
  'hudChrome.professions.toolEffectRechargePrice': 'Şarj: {count} x {material}',
  'hudChrome.professions.toolEffectRechargeToolCapped':
    "{effect}'yi daha fazla şarj etmek için daha iyi bir {profession} aleti taşıyın.",
  'hudChrome.professions.toolEffectRecharged':
    '{effect} şarj edildi: {material} x{count} tüketildi.',
  'hudChrome.professions.toolEffectSlotButton': 'Yuva {effect}',
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} oraya yerleştirilemez.',
  'hudChrome.professions.toolEffectSlotted': "{effect}, {profession}'ye yerleştirildi.",
  'hudChrome.professions.toolEffectSpent': 'Harcandı, yeniden şarj edilmesi gerekiyor',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    'Bu bir antrenman maçı olduğundan derecelendirilmez: sıralamalar değişmez ve Tapu Kitabı ilerlemesi sayılmaz.',
  'hudChrome.vcup.briefing.unratedNote':
    'Botlar sahada olduğundan bu maç derecelendirilmiyor: sıralamalar değişmiyor ve goller, kurtarışlar ve gol yememeler sayılmıyor.',
  'hudChrome.vcup.practiceUnratedNote':
    'Alıştırma maçları derecelendirilmez: sıralamalar ve Tapu Kitabı ilerlemesi sayılmaz.',
  'hudChrome.vcup.rolesSmallBracketNote':
    '1v1 ve 2v2 braketlerinde her dövüşçü Çok Yönlü formayı oynar. 3v3 veya daha fazlasını gerektiren işler burada kazanılamaz.',
  'itemUi.bags.unknownItem': 'Bilinmeyen öğe',
  'itemUi.bags.unknownItemAria': 'Bilinmeyen öğe {id}, miktar {count}',
  'itemUi.bags.unknownItemAriaBound': 'Bilinmeyen öğe {id}, miktar {count}, ciltli kopya',
  'itemUi.bags.unknownItemAriaEnchanted': 'Bilinmeyen öğe {id}, miktar {count}, büyülü kopya',
  'itemUi.bags.unknownItemAriaInstanced':
    'Bilinmeyen öğe {id}, miktar {count}, üretici markalı kopya',
  'itemUi.bags.unknownItemAriaMasterwork': 'Bilinmeyen öğe {id}, miktar {count}, şaheser',
  'itemUi.kind.fineMaterial': 'İnce Malzeme',
  'itemUi.vendor.buyAriaWithRequirement': '{price} karşılığında {item} satın alın. {requirement}',
  'itemUi.vendor.buyCountAria': '{price} karşılığında {count} / {item} satın alın',
  'itemUi.vendor.buyCountAriaWithRequirement':
    '{price} karşılığında {count} veya {item} satın alın. {requirement}',
  'itemUi.vendor.buyQuantityConfirm': 'Satın almak',
  'itemUi.vendor.buyQuantityInput': 'Satın alınacak miktar',
  'itemUi.vendor.buyQuantityTitle': "Kaç tane {item} satın alın? {max}'e kadar.",
  'itemUi.vendor.qtyCustom': 'Gelenek',
  'itemUi.vendor.qtyCustomAria': 'Satın almak için özel bir miktar seçin',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Tek seferde {count} satın alın',
  'itemUi.vendor.qtyRowAria': 'Satın alma miktarı',
  'questUi.dialog.repeatableQuestAria': 'Tekrarlanabilir görev: {name}',
  'questUi.log.cooldownStatus': 'Yakında tekrar kullanılabilir',
