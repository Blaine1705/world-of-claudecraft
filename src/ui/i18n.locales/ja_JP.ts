...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocMarket.detailSaleRow': '{usd}: {seller} から {buyer} へ',
  ...
  'hudChrome.wocMarket.buyNowNote': '「今すぐ購入」はこの出品を短時間あなたのために確保します。支払わずに離れると、しばらくの間この出品を再び購入できなくなり、繰り返すと「今すぐ購入」自体がしばらく停止されます。',
  ...
  'hudChrome.wocMarket.sellClearTitle': '選択を解除',
  ...
  'hudChrome.wocMarket.activityEmpty': 'まだ何もありません。入札、出品、決済がここに表示されます。',
