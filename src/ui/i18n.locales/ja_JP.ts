...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_ps_strike_true.text':
    'ようこそ修練の浜へ、{playerName}。ここの稽古はどれも同じところから始まる。足を据え、刃を握ること。野営地の南西の練習場に立つかかしは、打たれるために作られている。練習場が見つからないときはMを押して地図を開きなさい。引き受けた仕事はすべてそこに印がつくから、迷い歩く必要はない。かかしのひとつに歩み寄ってTabを押すか、左クリックすれば、それが君のターゲットになる。あとは1を押すか、画面下のアクションバーの最初のアイコンをクリックすれば、刃が振れる。三体崩れるまで打ち込みなさい。かかしの打ち返しなど、かすり傷にもならないが、この浜の外にいるものは、はるかに強く打ってくる。三体目が倒れたら、ここへ戻ってFを押し、任務を納めて報酬を受け取りなさい。この世のどの依頼も、そうやって終わるものだよ。',
  'entities.quests.q_ps_strike_true.completion':
    '三体倒して、握りももう確かになってきた。その感覚を忘れないで、{playerName}。狙いを定め、打ち込み、そのまま打ち続けること。渓谷の狼は藁より速いが、同じ算術で倒れるものだよ。',
  ...
  'entities.quests.q_ps_the_wheel_of_trades.text':
    '剣は一度しか君を食べさせないが、{playerName}、生業は一生君を食べさせる。冒険者は誰でも剣のかたわらに専門を持っている。採掘、伐採、薬草摘み、釣り、そしてそれらを価値に変える製作の技だ。補給係フィンチの露店は私の稽古場から数歩のところにあって、彼女は私が積んだ訓練より多くの店を切り盛りしてきた。彼女に歩み寄ってFを押すか、左クリックすれば話ができる。木箱を開けるのと同じキーが、会話も開くんだよ。',
  'entities.quests.q_ps_the_wheel_of_trades.completion':
    'マレンがようやく、話す甲斐のある生徒を寄こしたね。一度しか言わないよ、{playerName}。採集は道具から始まる。つるはし、斧、鎌、釣り竿、どれも渓谷の商人が売っている。Shiftを押しながらPを押せば専門の手帳が開く。それが君の輪で、覚えた技とその進み具合がすべて並んでいる。好きなものに励み、隣り合う一対に調律すれば、その二つは上限のない主専攻になり、輪の向こうのひとつが趣味として残り、残りは知識を保ったまま眠る。失われるものは何もなく、決まってしまうものも何もない。組み合わせを決めるのは職人頭で、あとから変えたくなったときに変えてくれるのも職人頭だ。イーストブルックなら、鍛冶場の鍛冶頭ダルヴァ、宿の厨房の料理人マーロウ、織機の織り手オティリー、細工場の細工師ギゼル。ほかにフェンブリッジのなめし場に革職人ヘスク、ハイウォッチの薬房に錬金術師ヴェランがいる。',
  ...
  'entities.quests.q_ps_pouch_and_purse.text':
    '渓谷へ発つ前にもうひとつ、冒険者の命を守る授業だよ、{playerName}。君の持ち物の話だ。背嚢には十六の枠があり、その横に空の鞄留めが四つ待っている。鞄を留めるたびに、その分の空きが全体に加わる。では、補給係フィンチにFを押して店を開き、並んだ品の中の亜麻のポーチを左クリックして買い、それからBを押してバッグを開き、そこのポーチを左クリックして空いた留めに締めなさい。腰に下がったら、私のところへ戻っておいで。',
  ...
  'entities.quests.q_ps_set_sail.text':
    'この浜には、君がまだ倒していない、開けていない、買っていないものは何も残っていないよ、{playerName}。準備はできた。イーストブルックには本物の仕事が待っている。道を下って古い桟橋へ行き、渡し守オドにFを押して、マレンが、君は渡りを勝ち取ったと言っていた、と伝えなさい。誰に何を頼まれていたか分からなくなったら、いつでもLを押しなさい。それが君のクエストログだよ。',
