...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.reliquary.markFind.masterwork_first': '初めての名作',
  'hudChrome.reliquary.markFind.masterwork_weaponcrafting': '武器製作の名作',
  'hudChrome.reliquary.markFind.masterwork_armorcrafting': '防具製作の名作',
  'hudChrome.reliquary.markFind.masterwork_tailoring': '裁縫の名作',
  'hudChrome.reliquary.markFind.masterwork_leatherworking': '皮革細工の名作',
  'hudChrome.reliquary.markFind.masterwork_engineering': '工学の名作',
  ...
  'hudChrome.reliquary.sourceRift': '{rank}ランク・リフトのクリア報酬',
  ...
  'hudChrome.reliquary.sourceActivityMasterworkCraft': '名作の製作で入手',
