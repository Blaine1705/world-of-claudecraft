...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.controller.crossHotbarEditHint': '配置変更中：決定でアクションを持ち上げ次のマスに置き、キャンセルでマスを空にします。',
  ...
  'hudChrome.controller.crossHotbarExpandHelp': '一方のトリガーを押しながらもう一方を軽く押すと、2つ目のセットに切り替わります。',
  'hudChrome.controller.crossHotbarSetPrimary': '1つ目のセット',
  'hudChrome.controller.crossHotbarSetExpanded': '2つ目のセット',
  'hudChrome.controller.crossHotbarResetLayout': 'クロスホットバーをリセット',
  'hudChrome.controller.crossHotbarSlot': 'アクションバー {slot}',
  'hudChrome.controller.crossHotbarOverlay': 'クロスホットバー',
