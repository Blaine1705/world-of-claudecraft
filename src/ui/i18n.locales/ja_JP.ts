...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.commandsPage.talents': 'あなたのスペシャライゼーションと、タレントポイントがクラスツリーとスペックツリーにどう振り分けられているかを表示します。',
  ...
  'guide.interfacePage.winTalentsBody': 'タレントツリー、使えるポイント、そして各行がランクごとに何をするのかが分かります。',
  ...
  'guide.talentsPage.loadoutNote': 'ビルドを一つに決めてしまう必要はありません。パネルで名前をつけた構成を保存すると、タレントの選択とアクションバーの両方が記憶されるので、別の構成へ移るのはクリック一回です。条件は振り直しと同じで、戦闘外であること、そしてアリーナの試合や戦場の最中でないことです。',
