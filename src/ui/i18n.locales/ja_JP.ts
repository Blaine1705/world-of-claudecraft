...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.calligraphy_instructor.greeting': '安定した足取りは安定した線を生む。弟子たちに三角形、四角形、高度なルーンを教えてくれ。',
  'entities.npcs.calligraphy_apprentice_1.name': '見習いテッサ',
  'entities.npcs.calligraphy_apprentice_1.title': '書道の生徒',
  'entities.npcs.calligraphy_apprentice_1.greeting': 'いつも早く曲がりすぎちゃうの。どこが角なのか教えてくれる？',
  'entities.npcs.calligraphy_apprentice_2.name': '見習いピップ',
  'entities.npcs.calligraphy_apprentice_2.title': '書道の生徒',
  'entities.npcs.calligraphy_apprentice_2.greeting': 'まず三角形、次は四角形、それからルーン。一歩ずつしっかり歩こう！',
  ...
  'questUi.worldQuest.traceReaction.elianComplete': 'ルーンが完成した！丁寧に練習すれば次はもっと上手くなる。',
};
