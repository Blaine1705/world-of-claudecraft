...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.plurals.noticeboardGuildStats.one': '{count}人のメンバー、累計経験値{xp}',
  'hudChrome.plurals.noticeboardGuildStats.few': '{count}人のメンバー、累計経験値{xp}',
  'hudChrome.plurals.noticeboardGuildStats.many': '{count}人のメンバー、累計経験値{xp}',
  'hudChrome.plurals.noticeboardGuildStats.other': '{count}人のメンバー、累計経験値{xp}',
