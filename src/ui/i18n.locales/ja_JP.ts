...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_ps_strike_true.text':
    'ようこそ修練の浜へ、{playerName}。ここの稽古はどれも同じところから始まる。足を据え、刃を握ること。野営地の南西の練習場に立つかかしは、打たれるために作られている。練習場が見つからないときはMを押して地図を開きなさい。引き受けた仕事はすべてそこに印がつくから、迷い歩く必要はない。かかしのひとつに歩み寄ってTabを押すか、左クリックすれば、それが君のターゲットになる。あとは1を押すか、画面下のアクションバーの最初のアイコンをクリックすれば、刃が振れる。三体崩れるまで打ち込みなさい。かかしの打ち返しなど、かすり傷にもならない。この浜の外にいるものは、はるかに強く打ってくる。',
