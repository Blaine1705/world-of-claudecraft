...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.toolsNote':
    'どのノードにも、その職の道具をバッグに入れておくことが必要です。ティア1も例外ではありません。ピッケルがなければ鉱石は掘れず、竿がなければ魚も釣れません。商人が扱うのはティア1から3までで、各拠点はその土地で使うティアだけを置いています。ティア1の道具はどのゾーンの拠点でも購入でき、それより上のティアは、それを必要とする鉱脈のある土地で売られます。上のティアを買うときは、商人はその道具の職の熟練度も求めます。ティア2なら{tier2Prof}、ティア3なら{tier3Prof}で、条件は品目の行に表示されます。道具はバッグにあればよく、装備枠も耐久度もないため、購入は一度きりで、すでに持っている道具はそのまま使えます。採集の可否を決めるのはティアだけで、道具のレアリティの色は見た目だけのものです。\n\n商人の品揃えの上には、製作でしか手に入らない道具がティア4と5の二つあります。工作場で工作の職人が作るもので、NPCは決して売りません。今のところティア3を超える道具を求めるノードはないため、その価値は速さにあります。最上位の道具は低いティアのノードでの採集詠唱を最短の秒数に固定し、より高いティアの土地が現れたときには入場券にもなります。',
