...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.avatar.name': '巨像化',
  'entities.abilities.avatar.description':
    '操作不能効果を解除して巨像となり、20秒間、与えるダメージが20%増加します。（ウォリアータレント）',
  ...
  'entities.items.deathless_warguard_gauntlets.name': '不死の戦衛ガントレット',
  'entities.items.soulrend_handwraps.name': 'ソウルレンドの手甲',
  'entities.items.scourgehide_grips.name': 'スカージハイドのグリップ',
  'entities.items.soulforged_gauntlets.name': '魂鍛のガントレット',
