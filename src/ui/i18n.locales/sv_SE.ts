...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.fine_ashwood_log.name': 'Fin Ashwood stock',
  'entities.items.fine_copper_ore.name': 'Fin kopparmalm',
  'entities.items.fine_elderwood_log.name': 'Fin Highpine stock',
  ...
  'guide.profPages.specimenBody':
    'Ha ett litet påsrum över när du odlar: en signerad vindfall behöver sitt eget rum eller en matchande signerad stack att landa i, och om inget passar kommer avkastningen fortfarande men signaturen går förlorad. Corpse Harvesting har också sin egen jackpotarm: cirka {pct}% av varje skördad komponent kommer upp sällsynt eller bättre. En familj med ett perfekt exemplar att ge (hud, siden, gift, kött) behåller sin ordinarie avkastning och präglar det signerade exemplaret bredvid sig; varannan familj undertecknar själva avkastningen.',
  'guide.profPages.toolCraftedOrMarks':
    'Tillverkad ({craft}) eller {marks} Delve Marks efter tre Drowned Litany clears',
  'guide.profPages.toolCraftedOrMarksHeroic':
    'Tillverkad ({craft}) eller {marks} fördjupa märken efter en heroisk drunknad litany.',
  ...
  'hudChrome.professions.toolEffectRechargeMaterials':
    'Att ladda {effect} kräver {material} x{count}.',
  'hudChrome.professions.toolEffectRechargeNoSlot': 'Ingen effekt är placerad på {profession}.',
  'hudChrome.professions.toolEffectRechargePrice': 'Ladda: {count} x {material}',
  'hudChrome.professions.toolEffectRechargeToolCapped':
    'Bär ett bättre {profession}-verktyg för att ladda {effect} ytterligare.',
  'hudChrome.professions.toolEffectRecharged': '{effect} laddad: {material} x{count} förbrukad.',
  'hudChrome.professions.toolEffectSlotButton': 'Fack {effect}',
  'hudChrome.professions.toolEffectSlotInvalid': '{effect} kan inte placeras där.',
  'hudChrome.professions.toolEffectSlotted': '{effect} placerad på {profession}.',
  'hudChrome.professions.toolEffectSpent': 'Förbrukad, behöver laddas',
  'hudChrome.vcup.briefing.practiceUnratedNote':
    'Det här är en träningsmatch, så den är inte betygsatt: ställningen rör sig inte och framstegen i Gärningsboken räknas inte.',
  'hudChrome.vcup.briefing.unratedNote':
    'Botar finns på planen, så den här matchen är inte betygsatt: ställningen rör sig inte, och mål, räddningar och nollan räknas inte.',
  'hudChrome.vcup.practiceUnratedNote':
    'Träningsmatcher är inte betygsatta: ställning och framsteg i gärningsboken räknas inte.',
  'hudChrome.vcup.rolesSmallBracketNote':
    'I 1v1 och 2v2 parentes spelar varje fighter All-Rounder kit. Handlingar som kräver 3v3-fästet eller större kan inte tjänas in här.',
  'itemUi.bags.unknownItem': 'Okänt föremål',
  'itemUi.bags.unknownItemAria': 'Okänd artikel {id}, kvantitet {count}',
  'itemUi.bags.unknownItemAriaBound': 'Okänd artikel {id}, kvantitet {count}, inbunden kopia',
  'itemUi.bags.unknownItemAriaEnchanted': 'Okänd artikel {id}, kvantitet {count}, förtrollad kopia',
  'itemUi.bags.unknownItemAriaInstanced':
    'Okänd artikel {id}, kvantitet {count}, tillverkarmärkt kopia',
  'itemUi.bags.unknownItemAriaMasterwork': 'Okänd artikel {id}, kvantitet {count}, mästerverk',
  ...
  'itemUi.vendor.buyQuantityConfirm': 'Köpa',
  'itemUi.vendor.buyQuantityInput': 'Kvantitet att köpa',
  'itemUi.vendor.buyQuantityTitle': 'Köpa hur många {item}? Upp till {max}.',
  'itemUi.vendor.qtyCustom': 'Beställnings',
  'itemUi.vendor.qtyCustomAria': 'Välj ett anpassat belopp att köpa',
  'itemUi.vendor.qtyMultiple': '{count}x',
  'itemUi.vendor.qtyMultipleAria': 'Köp {count} åt gången',
  'itemUi.vendor.qtyRowAria': 'Inköpskvantitet',
  'questUi.dialog.repeatableQuestAria': 'Upprepad uppdrag: {name}',
  'questUi.log.cooldownStatus': 'Snart tillgänglig igen',
  'questUi.log.repeatableStatus': 'Repeterbar',
