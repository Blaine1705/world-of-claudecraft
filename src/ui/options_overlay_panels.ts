// Options > Auras and Options > Cooldown Manager: the two on-screen overlay
// sub-panels, composed by the Options window as one sibling module rather than
// two inline render methods (options_window.ts is on the monolith ratchet).
//
...
export type OverlayPanelView = 'auras' | 'cooldowns';
