...
// 34 = NPC-started combat World Quests add a start command/event, combat progress
// readouts, and public enemy-role identity. Older clients cannot start or present them.
