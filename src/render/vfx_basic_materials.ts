...
export function stoneboundShellMaterialOptions(): THREE.MeshBasicMaterialParameters {
  return {
...
export function stoneboundShardMaterialOptions(): THREE.MeshBasicMaterialParameters {
  return {
...
export function buildCastVfxBasicStandIns(): THREE.Group {
  ...
  const standIns: [string, THREE.MeshBasicMaterialParameters, THREE.BufferGeometry][] = [
    ...
    ['weapon-stonebound-shell', stoneboundShellMaterialOptions(), geometry],
    ['weapon-stonebound-shard', stoneboundShardMaterialOptions(), geometry],
  ];
