...
function ribbonMaterial(color: number): THREE.ShaderMaterial {
 ...
 *  instance colour. */
function glowMaterial(color: number, instanced: boolean): THREE.ShaderMaterial {
...
function strip(segments: number): {
