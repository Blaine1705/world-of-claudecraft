...
const BEAMS = [
  ...
  { x: 10, z: 3950, rot: 0.5, w: 55, h: 100, phase: 3.4 },
  { x: 90, z: 3920, rot: -0.2, w: 50, h: 95, phase: 4.7 }, // the Vigil
  { x: -20, z: 4040, rot: 0.15, w: 65, h: 115, phase: 2.6 }, // the Barrow
] as const;
...
const BLOSSOM_FIELDS = [
  { x: -84, z: 3876, r: 34 }, // Gloamfield
  { x: 62, z: 3768, r: 26 }, // the Moonwell's shore
  { x: -20, z: 3720, r: 24 }, // the Nightgate meadows
  { x: 30, z: 3900, r: 28 }, // the midrealm saddle
  { x: 6, z: 4046, r: 22 }, // the barrow downs
] as const;
