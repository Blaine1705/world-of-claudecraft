...
const BEACON = { x: 498, z: 3248 };
// stacks stand in the water off the Shear's cliffs
const SEA_STACKS = [
  { x: 496, z: 3452, r: 4.2, h: 22 },
  { x: 510, z: 3486, r: 3.4, h: 17 },
  { x: 488, z: 3516, r: 5.0, h: 26 },
  { x: 522, z: 3432, r: 2.8, h: 13 },
  { x: 504, z: 3548, r: 3.8, h: 19 },
  { x: 474, z: 3556, r: 3.0, h: 15 },
] as const;
// hull ribs on the Wreckfields beach: position, heading, rib count, size
const WRECKS = [
  { x: 322, z: 3596, rot: 0.7, ribs: 7, r: 5.2 },
  { x: 356, z: 3606, rot: -0.9, ribs: 5, r: 3.8 },
  { x: 300, z: 3574, rot: 2.2, ribs: 6, r: 4.4 },
] as const;
