...
const SPOTS = [
  { name: 'wolves west', x: -25, z: 65, radius: 31 },
  { name: 'wolves east', x: 28, z: 70, radius: 29 },
  { name: 'boars south', x: 64, z: 22, radius: 29 },
  { name: 'boars ridge', x: 80, z: -26, radius: 26 },
  { name: 'spiders', x: -69, z: 5, radius: 31 },
  { name: 'murlocs', x: -75, z: 57, radius: 14 },
  { name: 'rats', x: -82, z: -62, radius: 35 },
  { name: 'bandits west', x: 52, z: -69, radius: 31 },
  { name: 'bandits east', x: 90, z: -90, radius: 16 },
  { name: 'bones', x: 82, z: 78, radius: 33 },
