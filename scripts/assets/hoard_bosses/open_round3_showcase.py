...
the new forge gauntlets.
  ...
  blender --python open_round3_showcase.py -- <warden fixed dir> <ember gauntlets.glb> [--save file.blend]
"""
import sys
...
# ---- Emberforge and his gauntlets, beside him
for o in load(ember):
    if o.parent is None:
        o.location = Vector((0.0, -1.35, 0.5))
...
bpy.ops.mesh.primitive_plane_add(size=6, location=(0, -0.6, 0))
