export const SEEKER_GENESIS_TOKEN_MINT_AUTHORITY =
  'GT2zuHVaZQYZSyQMgJPLzvkmyztfyXg2NJunqFp4p3A4';
export const SEEKER_GENESIS_TOKEN_METADATA_ADDRESS =
  'GT22s89nU4iWFkNXj1Bw6uYhJJWDRPpShHt4Bk8f99Te';
export const SEEKER_GENESIS_TOKEN_GROUP_ADDRESS =
  'GT22s89nU4iWFkNXj1Bw6uYhJJWDRPpShHt4Bk8f99Te';
 ...
 */
export function isSeekerGenesisToken(
  descriptor: SeekerGenesisTokenDescriptor,
): boolean {
  return (
