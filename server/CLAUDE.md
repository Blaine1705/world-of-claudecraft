...
| `movement_position.ts` | validates grounded display-position samples against elapsed run-speed budget, swept collision, and a short authority window before adopting them into the authoritative sim |
