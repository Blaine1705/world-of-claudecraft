  ...
  private broadcastSnapshots(): void {
    ...
    forEachGuarded(
      ...
      ({ session, anchor: anchorEntity, anchorMeta, anchorSession, stableTimerWire }) => {
        ...
        this.sendRaw(
          session,
          `${head}${timerWireJson}${petSpecialWireJson},"self":${selfJson},"ents":[${ents.join(',')}]${frostRingsJson}${ignivarMeteorsJson}${temporalHourglassesJson}${consecrationsJson}${keepJson}}`,
        );
      },
      (err, resolved) =>
        console.error(
